...
public final class ObservableConcatMapSingle<T, R> extends k<R> {
    ...
    public final k<T> f71391b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public final o<? super T, ? extends v<? extends R>> f71392c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public final ErrorMode f71393d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public final int f71394e;
        ...
        */
        public void drain() {
            ...
            L5a:
                ...
                goto L98
            L5d:
                dm.o<? super T, ? extends xl.v<? extends R>> r6 = r10.mapper     // Catch: java.lang.Throwable -> L73
                ...
                xl.v r6 = (xl.v) r6     // Catch: java.lang.Throwable -> L73
                r10.state = r4
    ...
    public ObservableConcatMapSingle(k<T> kVar, o<? super T, ? extends v<? extends R>> oVar, ErrorMode errorMode, int i10) {
        this.f71391b = kVar;
        this.f71392c = oVar;
        this.f71393d = errorMode;
        this.f71394e = i10;
    }

    @Override // xl.k
    public void subscribeActual(r<? super R> rVar) {
        if (lm.a.c(this.f71391b, this.f71392c, rVar)) {
            return;
        }
        this.f71391b.subscribe(new ConcatMapSingleMainObserver(rVar, this.f71392c, this.f71394e, this.f71393d));
    }
}
