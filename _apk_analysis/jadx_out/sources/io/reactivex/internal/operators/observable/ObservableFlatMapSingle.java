...
public final class ObservableFlatMapSingle<T, R> extends mm.a<T, R> {

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public final o<? super T, ? extends v<? extends R>> f71481c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public final boolean f71482d;
    ...
    public static final class FlatMapSingleObserver<T, R> extends AtomicInteger implements r<T>, b {
        ...
        public FlatMapSingleObserver(r<? super R> rVar, o<? super T, ? extends v<? extends R>> oVar, boolean z10) {
        ...
        public void drainLoop() {
            ...
            while (!this.cancelled) {
                ...
                i iVarPoll = aVar != null ? aVar.poll() : null;
        ...
        */
        public void innerSuccess(io.reactivex.internal.operators.observable.ObservableFlatMapSingle.FlatMapSingleObserver<T, R>.InnerObserver r3, R r4) {
            /*
                r2 = this;
                bm.a r0 = r2.set
                r0.delete(r3)
    ...
    public ObservableFlatMapSingle(p<T> pVar, o<? super T, ? extends v<? extends R>> oVar, boolean z10) {
        super(pVar);
        this.f71481c = oVar;
        this.f71482d = z10;
    }
    ...
    public void subscribeActual(r<? super R> rVar) {
        this.f74327b.subscribe(new FlatMapSingleObserver(rVar, this.f71481c, this.f71482d));
    }
}
