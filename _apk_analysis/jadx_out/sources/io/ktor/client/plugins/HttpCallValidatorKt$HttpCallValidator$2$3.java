...
@d(c = "io.ktor.client.plugins.HttpCallValidatorKt$HttpCallValidator$2$3", f = "HttpCallValidator.kt", l = {135}, m = "invokeSuspend")
public final class HttpCallValidatorKt$HttpCallValidator$2$3 extends SuspendLambda implements q<cl.b, Throwable, hn.c<? super Throwable>, Object> {
    ...
    public HttpCallValidatorKt$HttpCallValidator$2$3(List<? extends i> list, hn.c<? super HttpCallValidatorKt$HttpCallValidator$2$3> cVar) {
        super(3, cVar);
    ...
    public final Object invoke(cl.b bVar, Throwable th2, hn.c<? super Throwable> cVar) {
        ...
        return httpCallValidatorKt$HttpCallValidator$2$3.invokeSuspend(r.f5635a);
    }
