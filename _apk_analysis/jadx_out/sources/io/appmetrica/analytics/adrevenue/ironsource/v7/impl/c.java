...
public final class c implements ImpressionDataListener {
    ...
    public final ClientContext f64428a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final b f64429b = new b();

    public c(ClientContext clientContext) {
        this.f64428a = clientContext;
    }

    public final void onImpressionSuccess(ImpressionData impressionData) {
        ModuleAdType moduleAdType;
        if (impressionData != null) {
            InternalClientModuleFacade internalClientModuleFacade = this.f64428a.getInternalClientModuleFacade();
            this.f64429b.getClass();
