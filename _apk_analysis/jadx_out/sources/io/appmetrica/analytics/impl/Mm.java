...
public final class Mm extends Sm {
    ...
    public final ProtobufStateStorage a(Context context, IBinaryDataHelper iBinaryDataHelper) {
        ...
        return new Nf("preload_info_data", iBinaryDataHelper, new B8(c4887jf, new AESEncrypter(AESEncrypter.DEFAULT_ALGORITHM, bArrA, bArrA2)), new C4810gf());
    }
