...
public final class Ke {
    ...
    public final Rn a(PluginErrorDetails pluginErrorDetails) {
        ...
        String str = (String) this.f65484a.f65633b.a();
        Boolean bool = (Boolean) this.f65484a.f65634c.a();
        if (stacktrace != null) {
            arrayList = new ArrayList(cn.x.x(stacktrace, 10));
