...
public enum EnumC4703cb {
    ...
    /* JADX INFO: Fake field, exist only in values array */
    EVENT_TYPE_UPDATE_PRE_ACTIVATION_CONFIG(InputDeviceCompat.SOURCE_TOUCHSCREEN, "Request referrer"),
    ...
    EVENT_TYPE_ANR(5968, com.ironsource.Z7.f30787k),
    ...
    static {
        for (EnumC4703cb enumC4703cb : values()) {
            K.put(Integer.valueOf(enumC4703cb.f66524a), enumC4703cb);
        }
    }

    EnumC4703cb(int i10, String str) {
        this.f66524a = i10;
        this.f66525b = str;
    }

    public static EnumC4703cb a(int i10) {
        EnumC4703cb enumC4703cb = (EnumC4703cb) K.get(Integer.valueOf(i10));
        return enumC4703cb == null ? EVENT_TYPE_UNDEFINED : enumC4703cb;
    }
