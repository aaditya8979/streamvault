...
public class AESRSAEncrypter implements Encrypter {
    ...
    public AESRSAEncrypter(int i10) {
        this.f64745a = AESEncrypter.DEFAULT_ALGORITHM;
        this.f64746b = C3984da.f31483b;
    }
    ...
    public final byte[] a(byte[] bArr, byte[] bArr2, byte[] bArr3, PublicKey publicKey) {
        ...
        try {
            ...
            cipher = Cipher.getInstance(this.f64746b);
        ...
        try {
            ...
            byte[] bArrEncrypt = new AESEncrypter(this.f64745a, bArr2, bArr3).encrypt(bArr);
            if (bArrEncrypt != null) {
