...
public final class BillingLibraryMonitor implements BillingMonitor, n {
    ...
    private final Executor f64590b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private final Executor f64591c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private final BillingInfoSender f64592d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private final BillingInfoManager f64593e;

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private final UpdatePolicy f64594f;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    private BillingConfig f64595g;
    ...
    public BillingLibraryMonitor(@NotNull Context context, @NotNull Executor executor, @NotNull Executor executor2, @NotNull BillingInfoStorage billingInfoStorage, @NotNull BillingInfoSender billingInfoSender, @NotNull BillingInfoManager billingInfoManager, @NotNull UpdatePolicy updatePolicy) {
        ...
        this.f64590b = executor;
        this.f64591c = executor2;
        this.f64592d = billingInfoSender;
        this.f64593e = billingInfoManager;
        this.f64594f = updatePolicy;
    }
    ...
    public synchronized void onBillingConfigChanged(@Nullable BillingConfig billingConfig) {
        try {
            if (p.f(this.f64595g, billingConfig)) {
                return;
            }
            this.f64595g = billingConfig;
            if (billingConfig != null && !this.f64596h) {
                this.f64596h = true;
                BillingClient billingClientBuild = BillingClient.newBuilder(this.f64589a).setListener(new l()).enablePendingPurchases().build();
    ...
    public void onSessionResumed() {
        try {
            BillingConfig billingConfig = this.f64595g;
            if (billingConfig != null && !this.f64596h) {
                this.f64596h = true;
                BillingClient billingClientBuild = BillingClient.newBuilder(this.f64589a).setListener(new l()).enablePendingPurchases().build();
                billingClientBuild.startConnection(new b(billingConfig, billingClientBuild, new BillingLibraryMonitor$updateBilling$1(this), new d(billingClientBuild), this));
