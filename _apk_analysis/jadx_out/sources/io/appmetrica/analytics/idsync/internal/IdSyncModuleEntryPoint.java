...
public final class IdSyncModuleEntryPoint extends ModuleServiceEntryPoint<IdSyncConfig> implements RemoteConfigUpdateListener<IdSyncConfig> {
    ...
    private final d f64943a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final c f64944b;
    ...
    private final IdSyncModuleEntryPoint$remoteConfigExtensionConfiguration$1 f64947e;
    ...
    public IdSyncModuleEntryPoint() {
        e eVar = new e();
        this.f64943a = new d(eVar);
        this.f64944b = new c(eVar);
        this.identifier = "id-sync";
        this.f64947e = new RemoteConfigExtensionConfiguration<IdSyncConfig>() { // from class: io.appmetrica.analytics.idsync.internal.IdSyncModuleEntryPoint$remoteConfigExtensionConfiguration$1
            @Override // io.appmetrica.analytics.modulesapi.internal.service.RemoteConfigExtensionConfiguration
            @NotNull
            public Map<String, Integer> getBlocks() {
                return p0.g(bn.h.a("is", 1));
            }
    ...
    public synchronized void onRemoteConfigUpdated(@NotNull ModuleRemoteConfig<IdSyncConfig> moduleRemoteConfig) {
        h hVar;
        IdSyncConfig featuresConfig = moduleRemoteConfig.getFeaturesConfig();
        if (featuresConfig != null && (hVar = this.f64945c) != null) {
            hVar.b(featuresConfig);
        }
    }
}
