...
public class VersionWrapperImpl extends BaseVersionWrapper {
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f68655a[AdsFormat.Banner_320x50.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f68655a[AdsFormat.Banner_728x90.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f68655a[AdsFormat.Banner_300x250.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f68655a[AdsFormat.Interstitial.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f68655a[AdsFormat.InterstitialStatic.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f68655a[AdsFormat.InterstitialVideo.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f68655a[AdsFormat.Rewarded.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f68655a[AdsFormat.RewardedStatic.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f68655a[AdsFormat.RewardedVideo.ordinal()] = 10;
    ...
    public InternalAd createAd(@NonNull NetworkParams networkParams, @NonNull TaskExecutor taskExecutor, @NonNull AdsFormat adsFormat, @NonNull Waterfall.Configuration.AdUnit adUnit, @NonNull InternalAdListener internalAdListener) {
        switch (a.f68655a[adsFormat.ordinal()]) {
            case 1:
            case 2:
                return new xh.a(networkParams, taskExecutor, adsFormat, adUnit, internalAdListener, AdSize.BANNER);
            case 3:
                return new xh.a(networkParams, taskExecutor, adsFormat, adUnit, internalAdListener, AdSize.LEADERBOARD);
            case 4:
                return new xh.a(networkParams, taskExecutor, adsFormat, adUnit, internalAdListener, AdSize.MEDIUM_RECTANGLE);
            case 5:
            case 6:
            case 7:
