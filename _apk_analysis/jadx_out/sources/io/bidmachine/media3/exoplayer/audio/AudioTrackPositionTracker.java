...
public final class AudioTrackPositionTracker {
    ...
    @Nullable
    private n audioTimestampPoller;
    ...
    private void maybePollAndCheckTimestamp(long j10) {
        n nVar = (n) Assertions.checkNotNull(this.audioTimestampPoller);
        if (nVar.maybePollTimestamp(j10)) {
    ...
    public void expectRawPlaybackHeadReset() {
        ...
        n nVar = this.audioTimestampPoller;
        if (nVar != null) {
            nVar.expectTimestampFramePositionReset();
        }
    }
    ...
    public long getCurrentPositionUs(boolean z10) {
        ...
        long jNanoTime = this.clock.nanoTime() / 1000;
        n nVar = (n) Assertions.checkNotNull(this.audioTimestampPoller);
        boolean zHasAdvancingTimestamp = nVar.hasAdvancingTimestamp();
        if (zHasAdvancingTimestamp) {
            playbackHeadPositionUs = Util.sampleCountToDurationUs(nVar.getTimestampPositionFrames(), this.outputSampleRate) + Util.getMediaDurationForPlayoutDuration(jNanoTime - nVar.getTimestampSystemTimeUs(), this.audioTrackPlaybackSpeed);
        } else {
    ...
    public boolean pause() {
        resetSyncParams();
        if (this.stopTimestampUs == -9223372036854775807L) {
            ((n) Assertions.checkNotNull(this.audioTimestampPoller)).reset();
            return true;
        }
        this.stopPlaybackHeadPosition = getPlaybackHeadPosition();
        return false;
    ...
    public void setAudioTrack(AudioTrack audioTrack, boolean z10, int i10, int i11, int i12) {
        ...
        this.bufferSize = i12;
        this.audioTimestampPoller = new n(audioTrack);
