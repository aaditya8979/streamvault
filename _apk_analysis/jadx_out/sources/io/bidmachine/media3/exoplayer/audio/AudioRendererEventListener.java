...
public interface AudioRendererEventListener {
    ...
    public static final class EventDispatcher {
        ...
        public void audioCodecError(final Exception exc) {
            ...
            if (handler != null) {
                handler.post(new Runnable() { // from class: qi.d
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f78287b.lambda$audioCodecError$9(exc);
                    }
                });
            }
        }
        ...
        public void audioSinkError(final Exception exc) {
            ...
            if (handler != null) {
                handler.post(new Runnable() { // from class: qi.c
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f78285b.lambda$audioSinkError$8(exc);
                    }
                });
            }
        }
        ...
        public void audioTrackInitialized(final AudioSink.AudioTrackConfig audioTrackConfig) {
            ...
            if (handler != null) {
                handler.post(new Runnable() { // from class: qi.i
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f78300b.lambda$audioTrackInitialized$10(audioTrackConfig);
                    }
                });
            }
        }
        ...
        public void audioTrackReleased(final AudioSink.AudioTrackConfig audioTrackConfig) {
            ...
            if (handler != null) {
                handler.post(new Runnable() { // from class: qi.b
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f78283b.lambda$audioTrackReleased$11(audioTrackConfig);
                    }
                });
            }
        }
        ...
        public void decoderInitialized(final String str, final long j10, final long j11) {
            ...
            if (handler != null) {
                handler.post(new Runnable() { // from class: qi.f
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f78292b.lambda$decoderInitialized$1(str, j10, j11);
                    }
                });
            }
        }
        ...
        public void decoderReleased(final String str) {
            ...
            if (handler != null) {
                handler.post(new Runnable() { // from class: qi.m
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f78310b.lambda$decoderReleased$5(str);
                    }
                });
            }
        }
        ...
        public void disabled(final DecoderCounters decoderCounters) {
            ...
            Handler handler = this.handler;
            if (handler != null) {
                handler.post(new Runnable() { // from class: qi.g
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f78296b.lambda$disabled$6(decoderCounters);
                    }
                });
            }
        }
        ...
        public void enabled(final DecoderCounters decoderCounters) {
            Handler handler = this.handler;
            if (handler != null) {
                handler.post(new Runnable() { // from class: qi.h
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f78298b.lambda$enabled$0(decoderCounters);
                    }
                });
            }
        }
        ...
        public void inputFormatChanged(final Format format, @Nullable final DecoderReuseEvaluation decoderReuseEvaluation) {
            ...
            if (handler != null) {
                handler.post(new Runnable() { // from class: qi.e
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f78289b.lambda$inputFormatChanged$2(format, decoderReuseEvaluation);
                    }
                });
            }
        }
        ...
        public void positionAdvancing(final long j10) {
            ...
            if (handler != null) {
                handler.post(new Runnable() { // from class: qi.j
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f78302b.lambda$positionAdvancing$3(j10);
                    }
                });
            }
        }
        ...
        public void skipSilenceEnabledChanged(final boolean z10) {
            ...
            if (handler != null) {
                handler.post(new Runnable() { // from class: qi.k
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f78304b.lambda$skipSilenceEnabledChanged$7(z10);
                    }
                });
            }
        }
        ...
        public void underrun(final int i10, final long j10, final long j11) {
            ...
            if (handler != null) {
                handler.post(new Runnable() { // from class: qi.l
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f78306b.lambda$underrun$4(i10, j10, j11);
                    }
                });
            }
        }
