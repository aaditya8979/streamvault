...
public final class b implements MediaPeriod, MediaPeriod.Callback {
    ...
    public b(CompositeSequenceableLoaderFactory compositeSequenceableLoaderFactory, long[] jArr, MediaPeriod... mediaPeriodArr) {
        ...
        for (int i10 = 0; i10 < mediaPeriodArr.length; i10++) {
            long j10 = jArr[i10];
            if (j10 != 0) {
                this.periods[i10] = new f(mediaPeriodArr[i10], j10);
            }
        }
    }
    ...
    public MediaPeriod getChildPeriod(int i10) {
        ...
        return mediaPeriod instanceof f ? ((f) mediaPeriod).getWrappedMediaPeriod() : mediaPeriod;
    }
    ...
    public void onPrepared(MediaPeriod mediaPeriod) {
        ...
        while (true) {
            ...
            while (i14 < i13) {
                ...
                TrackGroup trackGroup2 = new TrackGroup(i11 + StringUtils.PROCESS_POSTFIX_DELIMITER + trackGroup.f69799id, formatArr);
    ...
    public long selectTracks(ExoTrackSelection[] exoTrackSelectionArr, boolean[] zArr, SampleStream[] sampleStreamArr, boolean[] zArr2, long j10) {
        ...
        while (true) {
            ...
            if (exoTrackSelection != null) {
                String str = exoTrackSelection.getTrackGroup().f69799id;
        ...
        while (i12 < this.periods.length) {
            for (int i13 = i10; i13 < exoTrackSelectionArr.length; i13++) {
                ...
                if (iArr2[i13] == i12) {
                    ...
                    objArr[i13] = new a(exoTrackSelection2, (TrackGroup) Assertions.checkNotNull(this.childTrackGroupByMergedTrackGroup.get(exoTrackSelection2.getTrackGroup())));
                } else {
                    objArr[i13] = num;
                }
            }
        ...
        this.compositeSequenceableLoader = this.compositeSequenceableLoaderFactory.create(arrayList3, Lists.m(arrayList3, new y7.e() { // from class: aj.r
            @Override // y7.e
            public final Object apply(Object obj) {
                return io.bidmachine.media3.exoplayer.source.b.lambda$selectTracks$0((MediaPeriod) obj);
            }
        }));
        return j11;
    }
