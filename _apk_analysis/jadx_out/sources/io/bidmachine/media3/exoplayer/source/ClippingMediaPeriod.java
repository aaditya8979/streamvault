    ...
    */
    public long seekToUs(long r6) {
        /*
            ...
            io.bidmachine.media3.exoplayer.source.ClippingMediaPeriod$a[] r0 = r5.sampleStreams
            int r1 = r0.length
            r2 = 0
            r3 = r2
        Lc:
        ...
        L15:
            ...
            goto Lc
        L18:
            io.bidmachine.media3.exoplayer.source.MediaPeriod r0 = r5.mediaPeriod
        ...
        L35:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: io.bidmachine.media3.exoplayer.source.ClippingMediaPeriod.seekToUs(long):long");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public long selectTracks(io.bidmachine.media3.exoplayer.trackselection.ExoTrackSelection[] r13, boolean[] r14, io.bidmachine.media3.exoplayer.source.SampleStream[] r15, boolean[] r16, long r17) {
        /*
            r12 = this;
            r0 = r12
            r1 = r15
            int r2 = r1.length
            io.bidmachine.media3.exoplayer.source.ClippingMediaPeriod$a[] r2 = new io.bidmachine.media3.exoplayer.source.ClippingMediaPeriod.a[r2]
            r0.sampleStreams = r2
            int r2 = r1.length
            io.bidmachine.media3.exoplayer.source.SampleStream[] r9 = new io.bidmachine.media3.exoplayer.source.SampleStream[r2]
            r10 = 0
            r2 = r10
        Lc:
            int r3 = r1.length
            r11 = 0
            if (r2 >= r3) goto L21
            io.bidmachine.media3.exoplayer.source.ClippingMediaPeriod$a[] r3 = r0.sampleStreams
            r4 = r1[r2]
            io.bidmachine.media3.exoplayer.source.ClippingMediaPeriod$a r4 = (io.bidmachine.media3.exoplayer.source.ClippingMediaPeriod.a) r4
            r3[r2] = r4
            if (r4 == 0) goto L1c
            io.bidmachine.media3.exoplayer.source.SampleStream r11 = r4.childStream
        L1c:
            r9[r2] = r11
            int r2 = r2 + 1
            goto Lc
        L21:
            io.bidmachine.media3.exoplayer.source.MediaPeriod r2 = r0.mediaPeriod
            r3 = r13
            r4 = r14
            r5 = r9
            r6 = r16
        ...
        L63:
            r4 = 1
        L64:
            io.bidmachine.media3.common.util.Assertions.checkState(r4)
        L67:
            int r4 = r1.length
            if (r10 >= r4) goto L8d
            r4 = r9[r10]
            if (r4 != 0) goto L73
            io.bidmachine.media3.exoplayer.source.ClippingMediaPeriod$a[] r4 = r0.sampleStreams
            r4[r10] = r11
            goto L84
        L73:
            io.bidmachine.media3.exoplayer.source.ClippingMediaPeriod$a[] r5 = r0.sampleStreams
            r6 = r5[r10]
            if (r6 == 0) goto L7d
            io.bidmachine.media3.exoplayer.source.SampleStream r6 = r6.childStream
            if (r6 == r4) goto L84
        L7d:
            io.bidmachine.media3.exoplayer.source.ClippingMediaPeriod$a r6 = new io.bidmachine.media3.exoplayer.source.ClippingMediaPeriod$a
            r6.<init>(r4)
            r5[r10] = r6
        L84:
            io.bidmachine.media3.exoplayer.source.ClippingMediaPeriod$a[] r4 = r0.sampleStreams
        ...
        L8d:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: io.bidmachine.media3.exoplayer.source.ClippingMediaPeriod.selectTracks(io.bidmachine.media3.exoplayer.trackselection.ExoTrackSelection[], boolean[], io.bidmachine.media3.exoplayer.source.SampleStream[], boolean[], long):long");
    }
