...
import io.bidmachine.media3.exoplayer.source.MediaParserExtractorAdapter;
...
public final class MediaParserExtractorAdapter implements ProgressiveMediaExtractor {
    ...
    @Deprecated
    public static final ProgressiveMediaExtractor.Factory FACTORY = new ProgressiveMediaExtractor.Factory() { // from class: aj.k
    ...
    public static final class Factory implements ProgressiveMediaExtractor.Factory {
        ...
        public void setConstantBitrateSeekingEnabled(boolean z10) {
            if (!z10) {
