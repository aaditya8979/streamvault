...
public class SampleQueue implements TrackOutput {
    ...
    private final d sampleDataQueue;
    ...
    private final z<c> sharedSampleMetadata = new z<>(new Consumer() { // from class: aj.x
    ...
    public SampleQueue(Allocator allocator, @Nullable DrmSessionManager drmSessionManager, @Nullable DrmSessionEventListener.EventDispatcher eventDispatcher) {
        ...
        this.sampleDataQueue = new d(allocator);
    }
    ...
    private synchronized void commitSample(long j10, int i10, long j11, int i11, @Nullable TrackOutput.CryptoData cryptoData) {
        ...
        if (this.sharedSampleMetadata.isEmpty() || !this.sharedSampleMetadata.getEndValue().format.equals(this.upstreamFormat)) {
            ...
            this.sharedSampleMetadata.appendSpan(getWriteIndex(), new c(format, drmSessionManager != null ? drmSessionManager.preacquireSession(this.drmEventDispatcher, format) : DrmSessionManager.DrmSessionReference.EMPTY));
        }
    ...
    private synchronized int peekSampleMetadata(FormatHolder formatHolder, DecoderInputBuffer decoderInputBuffer, boolean z10, boolean z11, b bVar) {
        ...
        if (!z10 && format2 == this.downstreamFormat) {
            ...
            bVar.size = this.sizes[relativeIndex];
            bVar.offset = this.offsets[relativeIndex];
            bVar.cryptoData = this.cryptoDatas[relativeIndex];
            return -4;
        }
    ...
    */
    public void sampleMetadata(long r12, int r14, int r15, int r16, @androidx.annotation.Nullable io.bidmachine.media3.extractor.TrackOutput.CryptoData r17) {
        /*
            r11 = this;
            r8 = r11
            boolean r0 = r8.upstreamFormatAdjustmentRequired
            if (r0 == 0) goto L10
            io.bidmachine.media3.common.Format r0 = r8.unadjustedUpstreamFormat
            java.lang.Object r0 = io.bidmachine.media3.common.util.Assertions.checkStateNotNull(r0)
            io.bidmachine.media3.common.Format r0 = (io.bidmachine.media3.common.Format) r0
            r11.format(r0)
        L10:
            r0 = r14 & 1
            r1 = 0
        ...
        L30:
            ...
            r0.append(r6)
            io.bidmachine.media3.common.Format r6 = r8.upstreamFormat
            r0.append(r6)
            java.lang.String r0 = r0.toString()
            java.lang.String r6 = "SampleQueue"
            io.bidmachine.media3.common.util.Log.w(r6, r0)
        ...
        L65:
            return
        L66:
            io.bidmachine.media3.exoplayer.source.d r0 = r8.sampleDataQueue
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: io.bidmachine.media3.exoplayer.source.SampleQueue.sampleMetadata(long, int, int, int, io.bidmachine.media3.extractor.TrackOutput$CryptoData):void");
    }
    ...
    */
    public final synchronized void skip(int r3) {
        ...
        Le:
            r0 = 0
        Lf:
            io.bidmachine.media3.common.util.Assertions.checkArgument(r0)     // Catch: java.lang.Throwable -> Lc
            int r0 = r2.readPosition     // Catch: java.lang.Throwable -> Lc
            int r0 = r0 + r3
        ...
        L19:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: io.bidmachine.media3.exoplayer.source.SampleQueue.skip(int):void");
    }
