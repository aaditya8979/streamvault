...
public final class TrackGroupArray {
    ...
    public static TrackGroupArray fromBundle(Bundle bundle) {
        ...
        return parcelableArrayList == null ? new TrackGroupArray(new TrackGroup[0]) : new TrackGroupArray((TrackGroup[]) BundleCollectionUtil.fromBundleList(new y7.e() { // from class: aj.c0
            @Override // y7.e
    ...
    public ImmutableList<Integer> getTrackTypes() {
        return ImmutableList.copyOf((Collection) Lists.m(this.trackGroups, new y7.e() { // from class: aj.a0
            @Override // y7.e
            public final Object apply(Object obj) {
    ...
    public Bundle toBundle() {
        ...
        bundle.putParcelableArrayList(FIELD_TRACK_GROUPS, BundleCollectionUtil.toBundleArrayList(this.trackGroups, new y7.e() { // from class: aj.b0
            @Override // y7.e
            public final Object apply(Object obj) {
