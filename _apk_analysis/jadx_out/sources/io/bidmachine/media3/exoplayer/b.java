...
public final class b {
    ...
    /* JADX INFO: compiled from: MediaPeriodHolder.java */
    public interface a {
        b create(p1 p1Var, long j10);
    }

    public b(RendererCapabilities[] rendererCapabilitiesArr, long j10, TrackSelector trackSelector, Allocator allocator, MediaSourceList mediaSourceList, p1 p1Var, TrackSelectorResult trackSelectorResult) {
        ...
        this.mediaPeriod = createMediaPeriod(mediaPeriodId, mediaSourceList, allocator, p1Var.startPositionUs, p1Var.endPositionUs);
    }
    ...
    public boolean canBeUsedForMediaPeriodInfo(p1 p1Var) {
        if (c.areDurationsCompatible(this.info.durationUs, p1Var.durationUs)) {
            p1 p1Var2 = this.info;
            if (p1Var2.startPositionUs == p1Var.startPositionUs && p1Var2.f76404id.equals(p1Var.f76404id)) {
                return true;
            }
        }
        return false;
    ...
    public void handlePrepared(float f10, Timeline timeline) throws ExoPlaybackException {
        ...
        p1 p1Var = this.info;
        long jMax = p1Var.startPositionUs;
        long j10 = p1Var.durationUs;
        ...
        p1 p1Var2 = this.info;
        this.rendererPositionOffsetUs = j11 + (p1Var2.startPositionUs - jApplyTrackSelection);
        this.info = p1Var2.copyWithStartPositionUs(jApplyTrackSelection);
    }
    ...
    public TrackSelectorResult selectTracks(float f10, Timeline timeline) throws ExoPlaybackException {
        TrackSelectorResult trackSelectorResultSelectTracks = this.trackSelector.selectTracks(this.rendererCapabilities, getTrackGroups(), this.info.f76404id, timeline);
    ...
    public void setNext(@Nullable b bVar) {
        if (bVar == this.next) {
            return;
        }
        disableTrackSelectionsInResult();
