...
public abstract class SegmentBase {
    ...
    public static final class SegmentTemplate extends MultiSegmentBase {
        ...
        public RangedUri getInitialization(Representation representation) {
            ...
            return new RangedUri(urlTemplate.buildUri(format.f69794id, 0L, format.bitrate, 0L), 0L, -1L);
        }
        ...
        public RangedUri getSegmentUrl(Representation representation, long j10) {
            ...
            Format format = representation.format;
            return new RangedUri(urlTemplate.buildUri(format.f69794id, j10, format.bitrate, j11), 0L, -1L);
        }
    }
