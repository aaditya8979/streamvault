...
public class MediaCodecVideoRenderer extends MediaCodecRenderer implements VideoFrameReleaseControl.FrameTimingEvaluator {
    ...
    @Nullable
    public c tunnelingOnFrameRenderedListener;
    ...
    private static List<MediaCodecInfo> getDecoderInfos(Context context, MediaCodecSelector mediaCodecSelector, Format format, boolean z10, boolean z11) throws MediaCodecUtil.DecoderQueryException {
        ...
        if (Util.SDK_INT >= 26 && "video/dolby-vision".equals(str) && !b.doesDisplaySupportDolbyVision(context)) {
    ...
    /* JADX WARN: Type inference failed for: r5v0, types: [io.bidmachine.media3.exoplayer.BaseRenderer, io.bidmachine.media3.exoplayer.mediacodec.MediaCodecRenderer, io.bidmachine.media3.exoplayer.video.MediaCodecVideoRenderer] */
    ...
    public void onEnabled(boolean z10, boolean z11) throws ExoPlaybackException {
        ...
        videoSink.setListener(new a(), com.google.common.util.concurrent.c.a());
        VideoFrameMetadataListener videoFrameMetadataListener = this.frameMetadataListener;
        if (videoFrameMetadataListener != null) {
    ...
    public int supportsFormat(MediaCodecSelector mediaCodecSelector, Format format) throws MediaCodecUtil.DecoderQueryException {
        ...
        int i15 = z10 ? 128 : 0;
        if (Util.SDK_INT >= 26 && "video/dolby-vision".equals(format.sampleMimeType) && !b.doesDisplaySupportDolbyVision(this.context)) {
            i15 = 256;
        }
        if (zIsFormatSupported) {
