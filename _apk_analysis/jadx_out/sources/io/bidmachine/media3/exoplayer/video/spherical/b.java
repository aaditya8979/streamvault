...
public final class b {
    ...
    public void draw(int i10, float[] fArr, boolean z10) {
        a aVar = z10 ? this.rightMeshData : this.leftMeshData;
        if (aVar == null) {
            return;
        }
        int i11 = this.stereoMode;
        GLES20.glUniformMatrix3fv(this.uTexMatrixHandle, 1, false, i11 == 1 ? z10 ? TEX_MATRIX_BOTTOM : TEX_MATRIX_TOP : i11 == 2 ? z10 ? TEX_MATRIX_RIGHT : TEX_MATRIX_LEFT : TEX_MATRIX_WHOLE, 0);
