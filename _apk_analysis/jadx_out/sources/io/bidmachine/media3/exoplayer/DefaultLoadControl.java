...
public class DefaultLoadControl implements LoadControl {
    ...
    private final HashMap<PlayerId, b> loadingStates;
    ...
    private void resetPlayerLoadingState(PlayerId playerId) {
        b bVar = (b) Assertions.checkNotNull(this.loadingStates.get(playerId));
        int i10 = this.targetBufferBytesOverwrite;
        if (i10 == -1) {
            i10 = 13107200;
        }
        bVar.targetBufferBytes = i10;
    ...
    public int calculateTotalTargetBufferBytes() {
        Iterator<b> it = this.loadingStates.values().iterator();
        int i10 = 0;
        while (it.hasNext()) {
    ...
    public void onPrepared(PlayerId playerId) {
        ...
        if (!this.loadingStates.containsKey(playerId)) {
            this.loadingStates.put(playerId, new b());
        }
    ...
    public /* bridge */ /* synthetic */ void onTracksSelected(Timeline timeline, MediaSource.MediaPeriodId mediaPeriodId, Renderer[] rendererArr, TrackGroupArray trackGroupArray, ExoTrackSelection[] exoTrackSelectionArr) {
        super.onTracksSelected(timeline, mediaPeriodId, rendererArr, trackGroupArray, exoTrackSelectionArr);
    }
    ...
    public void onTracksSelected(PlayerId playerId, Timeline timeline, MediaSource.MediaPeriodId mediaPeriodId, Renderer[] rendererArr, TrackGroupArray trackGroupArray, ExoTrackSelection[] exoTrackSelectionArr) {
        ...
        bVar.targetBufferBytes = iCalculateTargetBufferBytes;
        updateAllocator();
    }
    ...
    public /* bridge */ /* synthetic */ void onTracksSelected(Renderer[] rendererArr, TrackGroupArray trackGroupArray, ExoTrackSelection[] exoTrackSelectionArr) {
        super.onTracksSelected(rendererArr, trackGroupArray, exoTrackSelectionArr);
    }
    ...
    public boolean shouldContinueLoading(LoadControl.Parameters parameters) {
        b bVar = (b) Assertions.checkNotNull(this.loadingStates.get(parameters.playerId));
        boolean z10 = true;
    ...
    @Override // io.bidmachine.media3.exoplayer.LoadControl
    @Deprecated
    public /* bridge */ /* synthetic */ boolean shouldStartPlayback(Timeline timeline, MediaSource.MediaPeriodId mediaPeriodId, long j10, float f10, boolean z10, long j11) {
        return super.shouldStartPlayback(timeline, mediaPeriodId, j10, f10, z10, j11);
    }
