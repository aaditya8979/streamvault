...
public final class RequirementsWatcher {
    ...
    public final class c extends ConnectivityManager.NetworkCallback {
        ...
        private void postCheckRequirements() {
            RequirementsWatcher.this.handler.post(new Runnable() { // from class: zi.a
                @Override // java.lang.Runnable
                public final void run() {
                    this.f98278b.lambda$postCheckRequirements$0();
                }
            });
        }

        private void postRecheckNotMetNetworkRequirements() {
            RequirementsWatcher.this.handler.post(new Runnable() { // from class: zi.b
                @Override // java.lang.Runnable
                public final void run() {
                    this.f98279b.lambda$postRecheckNotMetNetworkRequirements$1();
                }
            });
        }
