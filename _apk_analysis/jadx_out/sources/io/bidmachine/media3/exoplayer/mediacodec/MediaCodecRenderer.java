...
public abstract class MediaCodecRenderer extends BaseRenderer {
    ...
    private e outputStreamInfo;
    private boolean pendingOutputEndOfStream;
    private final ArrayDeque<e> pendingOutputStreamChanges;
    ...
    public static final class b {
        ...
        @DoNotInline
        public static boolean registerOnBufferAvailableListener(MediaCodecAdapter mediaCodecAdapter, d dVar) {
    ...
    public static final class e {
        public static final e UNSET = new e(-9223372036854775807L, -9223372036854775807L, -9223372036854775807L);
    ...
    private boolean bypassRender(long j10, long j11) throws ExoPlaybackException {
        ...
        if (this.bypassBatchBuffer.hasSamples()) {
            ...
            if (!processOutputBuffer(j10, j11, null, fVar.data, this.outputIndex, 0, fVar.getSampleCount(), this.bypassBatchBuffer.getFirstSampleTimeUs(), isDecodeOnly(getLastResetPositionUs(), this.bypassBatchBuffer.getLastSampleTimeUs()), this.bypassBatchBuffer.isEndOfStream(), (Format) Assertions.checkNotNull(this.outputFormat))) {
                return false;
            }
    ...
    private void initCodec(MediaCodecInfo mediaCodecInfo, @Nullable MediaCrypto mediaCrypto) throws Exception {
        ...
        try {
            ...
            this.codecRegisteredOnBufferAvailableListener = i10 >= 21 && b.registerOnBufferAvailableListener(mediaCodecAdapterCreateAdapter, new d());
    ...
    private void setOutputStreamInfo(e eVar) {
        this.outputStreamInfo = eVar;
        long j10 = eVar.streamOffsetUs;
    ...
    */
    public io.bidmachine.media3.exoplayer.DecoderReuseEvaluation onInputFormatChanged(io.bidmachine.media3.exoplayer.FormatHolder r12) throws io.bidmachine.media3.exoplayer.ExoPlaybackException {
        /*
            Method dump skipped, instruction units count: 289
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: io.bidmachine.media3.exoplayer.mediacodec.MediaCodecRenderer.onInputFormatChanged(io.bidmachine.media3.exoplayer.FormatHolder):io.bidmachine.media3.exoplayer.DecoderReuseEvaluation");
    }
    ...
    public void onProcessedOutputBuffer(long j10) {
        ...
        while (!this.pendingOutputStreamChanges.isEmpty() && j10 >= this.pendingOutputStreamChanges.peek().previousStreamLastBufferTimeUs) {
            setOutputStreamInfo((e) Assertions.checkNotNull(this.pendingOutputStreamChanges.poll()));
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public void onStreamChanged(io.bidmachine.media3.common.Format[] r13, long r14, long r16, io.bidmachine.media3.exoplayer.source.MediaSource.MediaPeriodId r18) throws io.bidmachine.media3.exoplayer.ExoPlaybackException {
        /*
            r12 = this;
            r0 = r12
            io.bidmachine.media3.exoplayer.mediacodec.MediaCodecRenderer$e r1 = r0.outputStreamInfo
            long r1 = r1.streamOffsetUs
            r3 = -9223372036854775807(0x8000000000000001, double:-4.9E-324)
            int r1 = (r1 > r3 ? 1 : (r1 == r3 ? 0 : -1))
            if (r1 != 0) goto L20
            io.bidmachine.media3.exoplayer.mediacodec.MediaCodecRenderer$e r1 = new io.bidmachine.media3.exoplayer.mediacodec.MediaCodecRenderer$e
            ...
            goto L65
        L20:
            java.util.ArrayDeque<io.bidmachine.media3.exoplayer.mediacodec.MediaCodecRenderer$e> r1 = r0.pendingOutputStreamChanges
        ...
        L55:
            java.util.ArrayDeque<io.bidmachine.media3.exoplayer.mediacodec.MediaCodecRenderer$e> r1 = r0.pendingOutputStreamChanges
            io.bidmachine.media3.exoplayer.mediacodec.MediaCodecRenderer$e r9 = new io.bidmachine.media3.exoplayer.mediacodec.MediaCodecRenderer$e
