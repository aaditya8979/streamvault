...
public abstract class SegmentDownloader<M extends FilterableManifest<M>> implements Downloader {
    ...
    public class a extends RunnableFutureTask<M, IOException> {
        ...
        public M doWork() throws IOException {
            return (M) ParsingLoadable.load(this.val$dataSource, SegmentDownloader.this.manifestParser, this.val$dataSpec, 4);
        }
    }
    ...
    public static final class c extends RunnableFutureTask<Void, IOException> {
        ...
        @Nullable
        private final b progressNotifier;
        ...
        public c(Segment segment, CacheDataSource cacheDataSource, @Nullable b bVar, byte[] bArr) {
            ...
            this.progressNotifier = bVar;
            this.temporaryBuffer = bArr;
            this.cacheWriter = new CacheWriter(cacheDataSource, segment.dataSpec, bArr, bVar);
        }
        ...
        try {
            ...
            for (int size3 = segments.size() - 1; size3 >= 0; size3 = i11 - 1) {
                ...
                if (j12 == -1) {
                    ...
                    if (contentLength != -1) {
                        j12 = contentLength - dataSpec.position;
                    }
                }
                int i13 = size3;
            ...
            while (!this.isCanceled && !arrayDeque.isEmpty()) {
                ...
                if (arrayDeque2.isEmpty()) {
                    ...
                    cacheDataSourceCreateDataSourceForDownloading = cVar.dataSource;
                    bArr = cVar.temporaryBuffer;
                }
                c cVar2 = new c((Segment) arrayDeque.removeFirst(), cacheDataSourceCreateDataSourceForDownloading, bVar, bArr);
                addActiveRunnable(cVar2);
                this.executor.execute(cVar2);
                for (int size4 = this.activeRunnables.size() - 1; size4 >= 0; size4--) {
                    c cVar3 = (c) this.activeRunnables.get(size4);
                    if (arrayDeque.isEmpty() || cVar3.isDone()) {
                        try {
                            ...
                            if (th2 instanceof PriorityTaskManager.PriorityTooLowException) {
                                arrayDeque.addFirst(cVar3.segment);
                                removeActiveRunnable(size4);
                                arrayDeque2.addLast(cVar3);
                            } else {
    ...
    */
    public final <T> T execute(io.bidmachine.media3.common.util.RunnableFutureTask<T, ?> r3, boolean r4) throws java.lang.Throwable {
        /*
            r2 = this;
            if (r4 == 0) goto L20
            r3.run()
        ...
        L20:
            ...
            if (r4 != 0) goto L6a
            io.bidmachine.media3.common.PriorityTaskManager r4 = r2.priorityTaskManager
            if (r4 == 0) goto L2d
        ...
        L42:
            ...
            java.lang.Object r0 = io.bidmachine.media3.common.util.Assertions.checkNotNull(r0)     // Catch: java.lang.Throwable -> L40
            java.lang.Throwable r0 = (java.lang.Throwable) r0     // Catch: java.lang.Throwable -> L40
            boolean r1 = r0 instanceof io.bidmachine.media3.common.PriorityTaskManager.PriorityTooLowException     // Catch: java.lang.Throwable -> L40
            if (r1 == 0) goto L52
            goto L59
        L52:
            boolean r1 = r0 instanceof java.io.IOException     // Catch: java.lang.Throwable -> L40
            if (r1 != 0) goto L60
            io.bidmachine.media3.common.util.Util.sneakyThrow(r4)     // Catch: java.lang.Throwable -> L40
        L59:
            r3.blockUntilFinished()
            r2.removeActiveRunnable(r3)
            goto L20
        ...
        L6a:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: io.bidmachine.media3.exoplayer.offline.SegmentDownloader.execute(io.bidmachine.media3.common.util.RunnableFutureTask, boolean):java.lang.Object");
    }
