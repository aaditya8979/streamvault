...
public final class DownloadRequest implements Parcelable {
    ...
    public static class Builder {
        ...
        public DownloadRequest build() {
            ...
            return new DownloadRequest(str, uri, str2, listOf, this.keySetId, this.customCacheKey, this.data, null);
        }
    ...
    public DownloadRequest(Parcel parcel) {
        this.f69916id = (String) Util.castNonNull(parcel.readString());
    ...
    public DownloadRequest copyWithKeySetId(@Nullable byte[] bArr) {
        return new DownloadRequest(this.f69916id, this.uri, this.mimeType, this.streamKeys, bArr, this.customCacheKey, this.data);
    }

    public DownloadRequest copyWithMergedRequest(DownloadRequest downloadRequest) {
        List listEmptyList;
        Assertions.checkArgument(this.f69916id.equals(downloadRequest.f69916id));
        ...
        return new DownloadRequest(this.f69916id, downloadRequest.uri, downloadRequest.mimeType, listEmptyList, downloadRequest.keySetId, downloadRequest.customCacheKey, downloadRequest.data);
    }
    ...
    public MediaItem toMediaItem() {
        return new MediaItem.Builder().setMediaId(this.f69916id).setUri(this.uri).setCustomCacheKey(this.customCacheKey).setMimeType(this.mimeType).setStreamKeys(this.streamKeys).build();
    }

    public String toString() {
        return this.mimeType + StringUtils.PROCESS_POSTFIX_DELIMITER + this.f69916id;
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel parcel, int i10) {
        parcel.writeString(this.f69916id);
