...
public final class HlsPlaylistParser implements ParsingLoadable.Parser<HlsPlaylist> {
    ...
    private static boolean checkPlaylistHeader(BufferedReader bufferedReader) throws IOException {
        ...
        int iSkipIgnorableWhitespace = skipIgnorableWhitespace(bufferedReader, true, i10);
        for (int i11 = 0; i11 < 7; i11++) {
            if (iSkipIgnorableWhitespace != PLAYLIST_HEADER.charAt(i11)) {
                return false;
            }
    ...
    private static Pattern compileBooleanAttrPattern(String str) {
        return Pattern.compile(str + "=(" + BOOLEAN_FALSE + ImpressionLog.Q + BOOLEAN_TRUE + ")");
    }
    ...
    @Nullable
    private static String getSegmentEncryptionIV(long j10, @Nullable String str, @Nullable String str2) {
        if (str == null) {
            return null;
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:112:0x031d A[PHI: r79
    ...
    */
    private static io.bidmachine.media3.exoplayer.hls.playlist.HlsMediaPlaylist parseMediaPlaylist(io.bidmachine.media3.exoplayer.hls.playlist.HlsMultivariantPlaylist r94, @androidx.annotation.Nullable io.bidmachine.media3.exoplayer.hls.playlist.HlsMediaPlaylist r95, io.bidmachine.media3.exoplayer.hls.playlist.HlsPlaylistParser.a r96, java.lang.String r97) throws java.io.IOException {
        /*
            Method dump skipped, instruction units count: 1883
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: io.bidmachine.media3.exoplayer.hls.playlist.HlsPlaylistParser.parseMediaPlaylist(io.bidmachine.media3.exoplayer.hls.playlist.HlsMultivariantPlaylist, io.bidmachine.media3.exoplayer.hls.playlist.HlsMediaPlaylist, io.bidmachine.media3.exoplayer.hls.playlist.HlsPlaylistParser$a, java.lang.String):io.bidmachine.media3.exoplayer.hls.playlist.HlsMediaPlaylist");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private static io.bidmachine.media3.exoplayer.hls.playlist.HlsMultivariantPlaylist parseMultivariantPlaylist(io.bidmachine.media3.exoplayer.hls.playlist.HlsPlaylistParser.a r36, java.lang.String r37) throws java.io.IOException {
        /*
            Method dump skipped, instruction units count: 1272
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: io.bidmachine.media3.exoplayer.hls.playlist.HlsPlaylistParser.parseMultivariantPlaylist(io.bidmachine.media3.exoplayer.hls.playlist.HlsPlaylistParser$a, java.lang.String):io.bidmachine.media3.exoplayer.hls.playlist.HlsMultivariantPlaylist");
    }
    ...
    private static int parseRoleFlags(String str, Map<String, String> map) {
        ...
        int i10 = Util.contains(strArrSplit, "public.accessibility.describes-video") ? 512 : 0;
        ...
        return Util.contains(strArrSplit, "public.easy-to-read") ? i10 | 8192 : i10;
    }
    ...
    private static HlsMediaPlaylist.ServerControl parseServerControl(String str) {
        ...
        long j11 = optionalDoubleAttr2 == -9.223372036854776E18d ? -9223372036854775807L : (long) (optionalDoubleAttr2 * 1000000.0d);
        double optionalDoubleAttr3 = parseOptionalDoubleAttr(str, REGEX_PART_HOLD_BACK, -9.223372036854776E18d);
        return new HlsMediaPlaylist.ServerControl(j10, optionalBooleanAttribute, j11, optionalDoubleAttr3 != -9.223372036854776E18d ? (long) (optionalDoubleAttr3 * 1000000.0d) : -9223372036854775807L, parseOptionalBooleanAttribute(str, REGEX_CAN_BLOCK_RELOAD, false));
    }
            ...
            while (true) {
                ...
                if (!strTrim.isEmpty()) {
                    if (!strTrim.startsWith(TAG_STREAM_INF)) {
                        ...
                        arrayDeque.add(strTrim);
                        return parseMultivariantPlaylist(new a(arrayDeque, bufferedReader), uri.toString());
                    }
                }
            }
            arrayDeque.add(strTrim);
            return parseMediaPlaylist(this.multivariantPlaylist, this.previousMediaPlaylist, new a(arrayDeque, bufferedReader), uri.toString());
        } finally {
            Util.closeQuietly(bufferedReader);
        }
    }
