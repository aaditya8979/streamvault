    ...
    public static Cue fromBundle(Bundle bundle) {
        ...
        if (charSequence != null) {
            ...
            if (parcelableArrayList != null) {
                ...
                while (it.hasNext()) {
                    c.unbundleAndApplyCustomSpan((Bundle) it.next(), spannableStringValueOf);
                }
    ...
    private Bundle toBundleWithoutBitmap() {
        ...
        if (charSequence != null) {
            ...
            if (charSequence2 instanceof Spanned) {
                ArrayList<Bundle> arrayListBundleCustomSpans = c.bundleCustomSpans((Spanned) charSequence2);
