...
public interface VideoFrameProcessor {
    ...
    public interface Factory {
        VideoFrameProcessor create(Context context, DebugViewProvider debugViewProvider, ColorInfo colorInfo, boolean z10, Executor executor, Listener listener) throws VideoFrameProcessingException;
    }
    ...
    public interface Listener {
        ...
        void onInputStreamRegistered(int i10, List<Effect> list, FrameInfo frameInfo);
    ...
    void registerInputStream(int i10, List<Effect> list, FrameInfo frameInfo);
