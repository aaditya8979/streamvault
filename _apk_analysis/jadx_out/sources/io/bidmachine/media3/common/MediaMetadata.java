...
public final class MediaMetadata {
    ...
    public static final class Builder {
        ...
        public Builder maybeSetArtworkData(byte[] bArr, int i10) {
            if (this.artworkData == null || Util.areEqual(Integer.valueOf(i10), 3) || !Util.areEqual(this.artworkDataType, 3)) {
        ...
        public Builder populate(@Nullable MediaMetadata mediaMetadata) {
            ...
            Long l10 = mediaMetadata.durationMs;
            if (l10 != null) {
                setDurationMs(l10);
            }
        ...
        @UnstableApi
        public Builder setDurationMs(@Nullable Long l10) {
            Assertions.checkArgument(l10 == null || l10.longValue() >= 0);
            this.durationMs = l10;
            return this;
        }
    ...
    private static int getFolderTypeFromMediaType(int i10) {
        switch (i10) {
            case 1:
            case 2:
            case 3:
    ...
    private static int getMediaTypeFromFolderType(int i10) {
        switch (i10) {
            case 1:
                return 0;
            case 2:
