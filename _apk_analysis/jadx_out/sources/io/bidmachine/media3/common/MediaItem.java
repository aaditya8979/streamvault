...
public final class MediaItem {
    ...
    public static final class DrmConfiguration {
        ...
        public static DrmConfiguration fromBundle(Bundle bundle) {
            ...
            return new Builder(uuidFromString).setLicenseUri(uri).setLicenseRequestHeaders(immutableMapBundleToStringImmutableMap).setMultiSession(z10).setForceDefaultLicenseUri(z12).setPlayClearContentWithoutKey(z11).setForcedSessionTrackTypes(immutableListCopyOf).setKeySetId(bundle.getByteArray(FIELD_KEY_SET_ID)).build();
        }
    ...
    public static final class LocalConfiguration {
        ...
        private LocalConfiguration(Uri uri, @Nullable String str, @Nullable DrmConfiguration drmConfiguration, @Nullable AdsConfiguration adsConfiguration, List<StreamKey> list, @Nullable String str2, ImmutableList<SubtitleConfiguration> immutableList, @Nullable Object obj, long j10) {
            ...
            for (int i10 = 0; i10 < immutableList.size(); i10++) {
                aVarBuilder.a(immutableList.get(i10).buildUpon().buildSubtitle());
            }
            this.subtitles = aVarBuilder.m();
            this.tag = obj;
            this.imageDurationMs = j10;
        }
        ...
        public static LocalConfiguration fromBundle(Bundle bundle) {
            ...
            ImmutableList immutableListOf = parcelableArrayList == null ? ImmutableList.of() : BundleCollectionUtil.fromBundleList(new y7.e() { // from class: io.bidmachine.media3.common.e
                @Override // y7.e
            ...
            return new LocalConfiguration((Uri) Assertions.checkNotNull((Uri) bundle.getParcelable(FIELD_URI)), bundle.getString(FIELD_MIME_TYPE), drmConfigurationFromBundle, adsConfigurationFromBundle, immutableListOf, bundle.getString(FIELD_CUSTOM_CACHE_KEY), parcelableArrayList2 == null ? ImmutableList.of() : BundleCollectionUtil.fromBundleList(new y7.e() { // from class: io.bidmachine.media3.common.f
                @Override // y7.e
                public final Object apply(Object obj) {
        ...
        public Bundle toBundle() {
            ...
            if (!this.streamKeys.isEmpty()) {
                bundle.putParcelableArrayList(FIELD_STREAM_KEYS, BundleCollectionUtil.toBundleArrayList(this.streamKeys, new y7.e() { // from class: io.bidmachine.media3.common.g
                    @Override // y7.e
                    public final Object apply(Object obj) {
            ...
            if (!this.subtitleConfigurations.isEmpty()) {
                bundle.putParcelableArrayList(FIELD_SUBTITLE_CONFIGURATION, BundleCollectionUtil.toBundleArrayList(this.subtitleConfigurations, new y7.e() { // from class: io.bidmachine.media3.common.h
                    @Override // y7.e
                    public final Object apply(Object obj) {
    ...
    public static class SubtitleConfiguration {
        ...
        public static final class Builder {
            ...
            private Builder(SubtitleConfiguration subtitleConfiguration) {
                ...
                this.f69797id = subtitleConfiguration.f69796id;
            }
        ...
        private SubtitleConfiguration(Builder builder) {
            ...
            this.f69796id = builder.f69797id;
        }
