...
public final class Format {
    ...
    public static final class Builder {
        ...
        public Builder setId(int i10) {
            this.f69795id = Integer.toString(i10);
            return this;
        }
    ...
    private Format(Builder builder) {
        this.f69794id = builder.f69795id;
    ...
    public static Format fromBundle(Bundle bundle) {
        ...
        builder.setId((String) defaultIfNull(string, format.f69794id)).setLabel((String) defaultIfNull(bundle.getString(FIELD_LABEL), format.label));
        ArrayList parcelableArrayList = bundle.getParcelableArrayList(FIELD_LABELS);
        builder.setLabels(parcelableArrayList == null ? ImmutableList.of() : BundleCollectionUtil.fromBundleList(new y7.e() { // from class: io.bidmachine.media3.common.d
            @Override // y7.e
    ...
    public Bundle toBundle(boolean z10) {
        ...
        bundle.putString(FIELD_ID, this.f69794id);
        bundle.putString(FIELD_LABEL, this.label);
        bundle.putParcelableArrayList(FIELD_LABELS, BundleCollectionUtil.toBundleArrayList(this.labels, new y7.e() { // from class: io.bidmachine.media3.common.b
            @Override // y7.e
            public final Object apply(Object obj) {
    ...
    public String toString() {
        return "Format(" + this.f69794id + ", " + this.label + ", " + this.containerMimeType + ", " + this.sampleMimeType + ", " + this.codecs + ", " + this.bitrate + ", " + this.language + ", [" + this.width + ", " + this.height + ", " + this.frameRate + ", " + this.colorInfo + "], [" + this.channelCount + ", " + this.sampleRate + "])";
    }
