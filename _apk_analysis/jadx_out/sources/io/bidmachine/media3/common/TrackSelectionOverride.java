...
public final class TrackSelectionOverride {
    ...
    public static TrackSelectionOverride fromBundle(Bundle bundle) {
        return new TrackSelectionOverride(TrackGroup.fromBundle((Bundle) Assertions.checkNotNull(bundle.getBundle(FIELD_TRACK_GROUP))), Ints.c((int[]) Assertions.checkNotNull(bundle.getIntArray(FIELD_TRACKS))));
    }
