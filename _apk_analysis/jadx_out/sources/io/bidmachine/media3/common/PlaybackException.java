...
public class PlaybackException extends Exception {
    ...
    public PlaybackException(@Nullable String str, @Nullable Throwable th2, int i10) {
        this(str, th2, i10, Bundle.EMPTY, Clock.DEFAULT.elapsedRealtime());
    }

    @UnstableApi
    public PlaybackException(@Nullable String str, @Nullable Throwable th2, int i10, Bundle bundle) {
        this(str, th2, i10, bundle, Clock.DEFAULT.elapsedRealtime());
    }
