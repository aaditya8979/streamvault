...
public abstract class SimpleBasePlayer extends BasePlayer {
    ...
    private final HashSet<c8.i<?>> pendingOperations;
    ...
    public static final class MediaItemData {
        ...
        public int hashCode() {
            ...
            int i10 = (iHashCode4 + ((int) (j10 ^ (j10 >>> 32)))) * 31;
    ...
    public static final class PeriodData {
        ...
        public int hashCode() {
            ...
            return ((((iHashCode + ((int) (j10 ^ (j10 >>> 32)))) * 31) + this.adPlaybackState.hashCode()) * 31) + (this.isPlaceholder ? 1 : 0);
        }
    }
    ...
    public interface PositionSupplier {
        ...
        static PositionSupplier getConstant(final long j10) {
            return new PositionSupplier() { // from class: io.bidmachine.media3.common.w1
                @Override // io.bidmachine.media3.common.SimpleBasePlayer.PositionSupplier
                public final long get() {
                    return SimpleBasePlayer.PositionSupplier.lambda$getConstant$0(j10);
                }
            };
        }
        ...
        static PositionSupplier getExtrapolating(final long j10, final float f10) {
            ...
            return new PositionSupplier() { // from class: io.bidmachine.media3.common.x1
                @Override // io.bidmachine.media3.common.SimpleBasePlayer.PositionSupplier
                public final long get() {
                    return SimpleBasePlayer.PositionSupplier.lambda$getExtrapolating$1(j10, jElapsedRealtime, f10);
                }
            };
        }
    ...
    public static final class State {
        ...
        public static final class Builder {
            ...
            public Builder setPlaylist(List<MediaItemData> list) {
                ...
                this.timeline = new c(this.playlist);
                return this;
            }
    ...
    public static final class c extends Timeline {
        ...
        public c(ImmutableList<MediaItemData> immutableList) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                MediaItemData mediaItemData = immutableList.get(i10);
            ...
            for (int i12 = 0; i12 < size; i12++) {
                MediaItemData mediaItemData2 = immutableList.get(i12);
    ...
    public SimpleBasePlayer(Looper looper, Clock clock) {
        ...
        this.listeners = new ListenerSet<>(looper, clock, new ListenerSet.IterationFinishedEvent() { // from class: io.bidmachine.media3.common.s1
            @Override // io.bidmachine.media3.common.util.ListenerSet.IterationFinishedEvent
            public final void invoke(Object obj, FlagSet flagSet) {
                this.f69867a.lambda$new$0((Player.Listener) obj, flagSet);
            }
        });
    }
    ...
    private static State buildStateForNewPosition(State.Builder builder, State state, long j10, List<MediaItemData> list, int i10, long j11, boolean z10) {
        ...
        if (z12 || z11 || j11 < positionOrDefaultInMediaItem) {
            ...
            builder.setCurrentMediaItemIndex(i10).setCurrentAd(-1, -1).setContentPositionMs(j11).setContentBufferedPositionMs(PositionSupplier.getConstant(Math.max(getContentBufferedPositionMsInternal(state), j11))).setTotalBufferedDurationMs(PositionSupplier.getConstant(Math.max(0L, state.totalBufferedDurationMsSupplier.get() - (j11 - positionOrDefaultInMediaItem))));
        }
    ...
    private void clearVideoOutput(@Nullable Object obj) {
        ...
        if (shouldHandleCommand(27)) {
            updateStateForPendingOperation(handleClearVideoOutput(obj), new y7.p() { // from class: io.bidmachine.media3.common.d1
                @Override // y7.p
    ...
    private static Player.PositionInfo getPositionInfo(State state, boolean z10, Timeline.Window window, Timeline.Period period) {
        ...
        if (z10) {
            ...
            contentPositionMsInternal = state.currentAdGroupIndex == -1 ? j10 : getContentPositionMsInternal(state);
        } else {
    ...
    private static State getStateWithNewPlaylist(State state, List<MediaItemData> list, Timeline.Period period) {
        ...
        long j11 = mediaItemIndexInNewPlaylist == -1 ? -9223372036854775807L : j10;
    ...
    private static State getStateWithNewPlaylistAndPosition(State state, List<MediaItemData> list, int i10, long j10) {
        ...
        return buildStateForNewPosition(builderBuildUpon, state, state.contentPositionMsSupplier.get(), list, i10, j10, false);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ c8.i lambda$handleReplaceMediaItems$31(c8.i iVar, Object obj) throws Exception {
        return iVar;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ State lambda$seekTo$10(boolean z10, State state, int i10, long j10) {
        return z10 ? state : getStateWithNewPlaylistAndPosition(state, state.playlist, i10, j10);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$updateStateAndInformListeners$32(State state, int i10, Player.Listener listener) {
        listener.onTimelineChanged(state.timeline, i10);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$updateStateAndInformListeners$33(int i10, Player.PositionInfo positionInfo, Player.PositionInfo positionInfo2, Player.Listener listener) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$updateStateForPendingOperation$62(c8.i iVar) {
        Util.castNonNull(this.state);
        this.pendingOperations.remove(iVar);
    ...
    private void setMediaItemsInternal(final List<MediaItem> list, final int i10, final long j10) {
        ...
        if (shouldHandleCommand(20) || (list.size() == 1 && shouldHandleCommand(31))) {
            updateStateForPendingOperation(handleSetMediaItems(list, i10, j10), new y7.p() { // from class: io.bidmachine.media3.common.v1
                @Override // y7.p
                public final Object get() {
                    return this.f69886b.lambda$setMediaItemsInternal$2(list, state, i10, j10);
                }
            });
        }
    }
    ...
    private void updateStateAndInformListeners(final State state, boolean z10, boolean z11) {
        int i10;
        ...
        final int positionDiscontinuityReason = getPositionDiscontinuityReason(state2, state, z10, this.window, this.period);
        boolean z14 = !state2.timeline.equals(state.timeline);
        final int mediaItemTransitionReason = getMediaItemTransitionReason(state2, state, positionDiscontinuityReason, z11, this.window);
        if (z14) {
            final int timelineChangeReason = getTimelineChangeReason(state2.playlist, state.playlist);
            this.listeners.queueEvent(0, new ListenerSet.Event() { // from class: io.bidmachine.media3.common.k
        ...
        if (positionDiscontinuityReason != -1) {
            ...
            this.listeners.queueEvent(11, new ListenerSet.Event() { // from class: io.bidmachine.media3.common.x
                @Override // io.bidmachine.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (mediaItemTransitionReason != i10) {
            ...
            this.listeners.queueEvent(1, new ListenerSet.Event() { // from class: io.bidmachine.media3.common.j0
                @Override // io.bidmachine.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!Util.areEqual(state2.playerError, state.playerError)) {
            this.listeners.queueEvent(10, new ListenerSet.Event() { // from class: io.bidmachine.media3.common.l0
                @Override // io.bidmachine.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
            ...
            if (state.playerError != null) {
                this.listeners.queueEvent(10, new ListenerSet.Event() { // from class: io.bidmachine.media3.common.m0
                    @Override // io.bidmachine.media3.common.util.ListenerSet.Event
                    public final void invoke(Object obj) {
        ...
        if (!state2.trackSelectionParameters.equals(state.trackSelectionParameters)) {
            this.listeners.queueEvent(19, new ListenerSet.Event() { // from class: io.bidmachine.media3.common.n0
                @Override // io.bidmachine.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!currentTracksInternal.equals(currentTracksInternal2)) {
            this.listeners.queueEvent(2, new ListenerSet.Event() { // from class: io.bidmachine.media3.common.o0
                @Override // io.bidmachine.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!mediaMetadataInternal.equals(mediaMetadataInternal2)) {
            this.listeners.queueEvent(14, new ListenerSet.Event() { // from class: io.bidmachine.media3.common.p0
                @Override // io.bidmachine.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (state2.isLoading != state.isLoading) {
            this.listeners.queueEvent(3, new ListenerSet.Event() { // from class: io.bidmachine.media3.common.r0
                @Override // io.bidmachine.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (z12 || z13) {
            this.listeners.queueEvent(-1, new ListenerSet.Event() { // from class: io.bidmachine.media3.common.s0
                @Override // io.bidmachine.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (z13) {
            this.listeners.queueEvent(4, new ListenerSet.Event() { // from class: io.bidmachine.media3.common.l
                @Override // io.bidmachine.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (z12 || state2.playWhenReadyChangeReason != state.playWhenReadyChangeReason) {
            this.listeners.queueEvent(5, new ListenerSet.Event() { // from class: io.bidmachine.media3.common.m
                @Override // io.bidmachine.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (state2.playbackSuppressionReason != state.playbackSuppressionReason) {
            this.listeners.queueEvent(6, new ListenerSet.Event() { // from class: io.bidmachine.media3.common.n
                @Override // io.bidmachine.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (isPlaying(state2) != isPlaying(state)) {
            this.listeners.queueEvent(7, new ListenerSet.Event() { // from class: io.bidmachine.media3.common.o
                @Override // io.bidmachine.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!state2.playbackParameters.equals(state.playbackParameters)) {
            this.listeners.queueEvent(12, new ListenerSet.Event() { // from class: io.bidmachine.media3.common.p
                @Override // io.bidmachine.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (state2.repeatMode != state.repeatMode) {
            this.listeners.queueEvent(8, new ListenerSet.Event() { // from class: io.bidmachine.media3.common.q
                @Override // io.bidmachine.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (state2.shuffleModeEnabled != state.shuffleModeEnabled) {
            this.listeners.queueEvent(9, new ListenerSet.Event() { // from class: io.bidmachine.media3.common.s
                @Override // io.bidmachine.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (state2.seekBackIncrementMs != state.seekBackIncrementMs) {
            this.listeners.queueEvent(16, new ListenerSet.Event() { // from class: io.bidmachine.media3.common.t
                @Override // io.bidmachine.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (state2.seekForwardIncrementMs != state.seekForwardIncrementMs) {
            this.listeners.queueEvent(17, new ListenerSet.Event() { // from class: io.bidmachine.media3.common.v
                @Override // io.bidmachine.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (state2.maxSeekToPreviousPositionMs != state.maxSeekToPreviousPositionMs) {
            this.listeners.queueEvent(18, new ListenerSet.Event() { // from class: io.bidmachine.media3.common.w
                @Override // io.bidmachine.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!state2.audioAttributes.equals(state.audioAttributes)) {
            this.listeners.queueEvent(20, new ListenerSet.Event() { // from class: io.bidmachine.media3.common.y
                @Override // io.bidmachine.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!state2.videoSize.equals(state.videoSize)) {
            this.listeners.queueEvent(25, new ListenerSet.Event() { // from class: io.bidmachine.media3.common.z
                @Override // io.bidmachine.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!state2.deviceInfo.equals(state.deviceInfo)) {
            this.listeners.queueEvent(29, new ListenerSet.Event() { // from class: io.bidmachine.media3.common.a0
                @Override // io.bidmachine.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!state2.playlistMetadata.equals(state.playlistMetadata)) {
            this.listeners.queueEvent(15, new ListenerSet.Event() { // from class: io.bidmachine.media3.common.b0
                @Override // io.bidmachine.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!state2.surfaceSize.equals(state.surfaceSize)) {
            this.listeners.queueEvent(24, new ListenerSet.Event() { // from class: io.bidmachine.media3.common.d0
                @Override // io.bidmachine.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (state2.volume != state.volume) {
            this.listeners.queueEvent(22, new ListenerSet.Event() { // from class: io.bidmachine.media3.common.e0
                @Override // io.bidmachine.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (state2.deviceVolume != state.deviceVolume || state2.isDeviceMuted != state.isDeviceMuted) {
            this.listeners.queueEvent(30, new ListenerSet.Event() { // from class: io.bidmachine.media3.common.g0
                @Override // io.bidmachine.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!state2.currentCues.equals(state.currentCues)) {
            this.listeners.queueEvent(27, new ListenerSet.Event() { // from class: io.bidmachine.media3.common.h0
                @Override // io.bidmachine.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!state2.timedMetadata.equals(state.timedMetadata) && state.timedMetadata.presentationTimeUs != -9223372036854775807L) {
            this.listeners.queueEvent(28, new ListenerSet.Event() { // from class: io.bidmachine.media3.common.i0
                @Override // io.bidmachine.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!state2.availableCommands.equals(state.availableCommands)) {
            this.listeners.queueEvent(13, new ListenerSet.Event() { // from class: io.bidmachine.media3.common.k0
                @Override // io.bidmachine.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
    ...
    private void updateStateForPendingOperation(c8.i<?> iVar, y7.p<State> pVar) {
        updateStateForPendingOperation(iVar, pVar, false, false);
    }

    private void updateStateForPendingOperation(final c8.i<?> iVar, y7.p<State> pVar, boolean z10, boolean z11) {
        if (iVar.isDone() && this.pendingOperations.isEmpty()) {
            updateStateAndInformListeners(getState(), z10, z11);
            return;
        }
        this.pendingOperations.add(iVar);
        updateStateAndInformListeners(getPlaceholderState(pVar.get()), z10, z11);
        iVar.addListener(new Runnable() { // from class: io.bidmachine.media3.common.i1
            @Override // java.lang.Runnable
            public final void run() {
                this.f69828b.lambda$updateStateForPendingOperation$62(iVar);
            }
        }, new Executor() { // from class: io.bidmachine.media3.common.j1
            @Override // java.util.concurrent.Executor
            public final void execute(Runnable runnable) {
                this.f69833b.postOrRunOnApplicationHandler(runnable);
            }
        });
    }
    ...
    public final void addMediaItems(int i10, final List<MediaItem> list) {
        ...
        updateStateForPendingOperation(handleAddMediaItems(iMin, list), new y7.p() { // from class: io.bidmachine.media3.common.q1
            @Override // y7.p
            public final Object get() {
                return this.f69858b.lambda$addMediaItems$3(state, list, iMin);
            }
        });
    }
    ...
    public final void decreaseDeviceVolume() {
        ...
        if (shouldHandleCommand(26)) {
            updateStateForPendingOperation(handleDecreaseDeviceVolume(1), new y7.p() { // from class: io.bidmachine.media3.common.t0
                @Override // y7.p
                public final Object get() {
    ...
    public final void decreaseDeviceVolume(int i10) {
        ...
        if (shouldHandleCommand(34)) {
            updateStateForPendingOperation(handleDecreaseDeviceVolume(i10), new y7.p() { // from class: io.bidmachine.media3.common.b1
                @Override // y7.p
                public final Object get() {
    ...
    public c8.i<?> handleAddMediaItems(int i10, List<MediaItem> list) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_CHANGE_MEDIA_ITEMS");
    }

    public c8.i<?> handleClearVideoOutput(@Nullable Object obj) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_SET_VIDEO_SURFACE");
    }

    public c8.i<?> handleDecreaseDeviceVolume(int i10) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_ADJUST_DEVICE_VOLUME or COMMAND_ADJUST_DEVICE_VOLUME_WITH_FLAGS");
    }

    public c8.i<?> handleIncreaseDeviceVolume(int i10) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_ADJUST_DEVICE_VOLUME or COMMAND_ADJUST_DEVICE_VOLUME_WITH_FLAGS");
    }

    public c8.i<?> handleMoveMediaItems(int i10, int i11, int i12) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_CHANGE_MEDIA_ITEMS");
    }

    public c8.i<?> handlePrepare() {
        throw new IllegalStateException("Missing implementation to handle COMMAND_PREPARE");
    }

    public c8.i<?> handleRelease() {
        throw new IllegalStateException("Missing implementation to handle COMMAND_RELEASE");
    }

    public c8.i<?> handleRemoveMediaItems(int i10, int i11) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_CHANGE_MEDIA_ITEMS");
    }

    public c8.i<?> handleReplaceMediaItems(int i10, int i11, List<MediaItem> list) {
        c8.i<?> iVarHandleAddMediaItems = handleAddMediaItems(i11, list);
        final c8.i<?> iVarHandleRemoveMediaItems = handleRemoveMediaItems(i10, i11);
        return Util.transformFutureAsync(iVarHandleAddMediaItems, new c8.b() { // from class: io.bidmachine.media3.common.m1
            @Override // c8.b
            public final c8.i apply(Object obj) {
                return SimpleBasePlayer.lambda$handleReplaceMediaItems$31(iVarHandleRemoveMediaItems, obj);
            }
        });
    }

    public c8.i<?> handleSeek(int i10, long j10, int i11) {
        throw new IllegalStateException("Missing implementation to handle one of the COMMAND_SEEK_*");
    }

    public c8.i<?> handleSetAudioAttributes(AudioAttributes audioAttributes, boolean z10) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_SET_AUDIO_ATTRIBUTES");
    }

    public c8.i<?> handleSetDeviceMuted(boolean z10, int i10) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_ADJUST_DEVICE_VOLUME or COMMAND_ADJUST_DEVICE_VOLUME_WITH_FLAGS");
    }

    public c8.i<?> handleSetDeviceVolume(@IntRange(from = 0) int i10, int i11) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_SET_DEVICE_VOLUME or COMMAND_SET_DEVICE_VOLUME_WITH_FLAGS");
    }

    public c8.i<?> handleSetMediaItems(List<MediaItem> list, int i10, long j10) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_SET_MEDIA_ITEM(S)");
    }

    public c8.i<?> handleSetPlayWhenReady(boolean z10) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_PLAY_PAUSE");
    }

    public c8.i<?> handleSetPlaybackParameters(PlaybackParameters playbackParameters) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_SET_SPEED_AND_PITCH");
    }

    public c8.i<?> handleSetPlaylistMetadata(MediaMetadata mediaMetadata) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_SET_PLAYLIST_METADATA");
    }

    public c8.i<?> handleSetRepeatMode(int i10) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_SET_REPEAT_MODE");
    }

    public c8.i<?> handleSetShuffleModeEnabled(boolean z10) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_SET_SHUFFLE_MODE");
    }

    public c8.i<?> handleSetTrackSelectionParameters(TrackSelectionParameters trackSelectionParameters) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_SET_TRACK_SELECTION_PARAMETERS");
    }

    public c8.i<?> handleSetVideoOutput(Object obj) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_SET_VIDEO_SURFACE");
    }

    public c8.i<?> handleSetVolume(@FloatRange(from = 0.0d, to = 1.0d) float f10) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_SET_VOLUME");
    }

    public c8.i<?> handleStop() {
    ...
    public final void increaseDeviceVolume() {
        ...
        final State state = this.state;
        if (shouldHandleCommand(26)) {
            updateStateForPendingOperation(handleIncreaseDeviceVolume(1), new y7.p() { // from class: io.bidmachine.media3.common.l1
                @Override // y7.p
                public final Object get() {
    ...
    public final void increaseDeviceVolume(int i10) {
        ...
        final State state = this.state;
        if (shouldHandleCommand(34)) {
            updateStateForPendingOperation(handleIncreaseDeviceVolume(i10), new y7.p() { // from class: io.bidmachine.media3.common.j
                @Override // y7.p
                public final Object get() {
    ...
    public final void moveMediaItems(final int i10, int i11, int i12) {
        ...
        final int iMin = Math.min(i11, size);
        final int iMin2 = Math.min(i12, state.playlist.size() - (iMin - i10));
        if (i10 == iMin || iMin2 == i10) {
            return;
        }
        updateStateForPendingOperation(handleMoveMediaItems(i10, iMin, iMin2), new y7.p() { // from class: io.bidmachine.media3.common.f0
            @Override // y7.p
            public final Object get() {
                return this.f69812b.lambda$moveMediaItems$4(state, i10, iMin, iMin2);
            }
        });
    }
    ...
    public final void prepare() {
        ...
        if (shouldHandleCommand(2)) {
            updateStateForPendingOperation(handlePrepare(), new y7.p() { // from class: io.bidmachine.media3.common.o1
                @Override // y7.p
                public final Object get() {
    ...
    public final void release() {
        ...
        if (shouldHandleCommand(32)) {
            updateStateForPendingOperation(handleRelease(), new y7.p() { // from class: io.bidmachine.media3.common.i
                @Override // y7.p
                public final Object get() {
    ...
    public final void removeMediaItems(final int i10, int i11) {
        ...
        final State state = this.state;
        int size = state.playlist.size();
        if (!shouldHandleCommand(20) || size == 0 || i10 >= size || i10 == (iMin = Math.min(i11, size))) {
            return;
        }
        updateStateForPendingOperation(handleRemoveMediaItems(i10, iMin), new y7.p() { // from class: io.bidmachine.media3.common.u1
            @Override // y7.p
            public final Object get() {
                return this.f69879b.lambda$removeMediaItems$6(state, i10, iMin);
            }
        });
    }
    ...
    public final void replaceMediaItems(final int i10, int i11, final List<MediaItem> list) {
        ...
        final int iMin = Math.min(i11, size);
        updateStateForPendingOperation(handleReplaceMediaItems(i10, iMin, list), new y7.p() { // from class: io.bidmachine.media3.common.t1
            @Override // y7.p
            public final Object get() {
                return this.f69870b.lambda$replaceMediaItems$5(state, list, iMin, i10);
            }
        });
    }
    ...
    public final void seekTo(final int i10, final long j10, int i11, boolean z10) {
        ...
        if (shouldHandleCommand(i11)) {
            if (i10 == -1 || isPlayingAd() || (!state.playlist.isEmpty() && i10 >= state.playlist.size())) {
                z11 = true;
            }
            final boolean z12 = z11;
            updateStateForPendingOperation(handleSeek(i10, j10, i11), new y7.p() { // from class: io.bidmachine.media3.common.g1
                @Override // y7.p
                public final Object get() {
                    return SimpleBasePlayer.lambda$seekTo$10(z12, state, i10, j10);
                }
            }, !z11, z10);
        }
    }
    ...
    @Override // io.bidmachine.media3.common.BasePlayer, io.bidmachine.media3.common.Player
    public final void setAudioAttributes(final AudioAttributes audioAttributes, boolean z10) {
        verifyApplicationThreadAndInitState();
        final State state = this.state;
        if (shouldHandleCommand(35)) {
            updateStateForPendingOperation(handleSetAudioAttributes(audioAttributes, z10), new y7.p() { // from class: io.bidmachine.media3.common.x0
                @Override // y7.p
                public final Object get() {
    ...
    public final void setDeviceMuted(final boolean z10) {
        ...
        final State state = this.state;
        if (shouldHandleCommand(26)) {
            updateStateForPendingOperation(handleSetDeviceMuted(z10, 1), new y7.p() { // from class: io.bidmachine.media3.common.y0
                @Override // y7.p
                public final Object get() {
    ...
    public final void setDeviceMuted(final boolean z10, int i10) {
        ...
        final State state = this.state;
        if (shouldHandleCommand(34)) {
            updateStateForPendingOperation(handleSetDeviceMuted(z10, i10), new y7.p() { // from class: io.bidmachine.media3.common.z0
                @Override // y7.p
                public final Object get() {
    ...
    public final void setDeviceVolume(final int i10) {
        ...
        if (shouldHandleCommand(25)) {
            updateStateForPendingOperation(handleSetDeviceVolume(i10, 1), new y7.p() { // from class: io.bidmachine.media3.common.w0
                @Override // y7.p
                public final Object get() {
                    return SimpleBasePlayer.lambda$setDeviceVolume$22(state, i10);
                }
            });
        }
    }
    ...
    public final void setDeviceVolume(final int i10, int i11) {
        ...
        if (shouldHandleCommand(33)) {
            updateStateForPendingOperation(handleSetDeviceVolume(i10, i11), new y7.p() { // from class: io.bidmachine.media3.common.u0
                @Override // y7.p
                public final Object get() {
                    return SimpleBasePlayer.lambda$setDeviceVolume$23(state, i10);
                }
            });
        }
    }
    ...
    public final void setMediaItems(List<MediaItem> list, boolean z10) {
        verifyApplicationThreadAndInitState();
        setMediaItemsInternal(list, z10 ? -1 : this.state.currentMediaItemIndex, z10 ? -9223372036854775807L : this.state.contentPositionMsSupplier.get());
    }
    ...
    public final void setPlayWhenReady(final boolean z10) {
        ...
        if (shouldHandleCommand(1)) {
            updateStateForPendingOperation(handleSetPlayWhenReady(z10), new y7.p() { // from class: io.bidmachine.media3.common.k1
                @Override // y7.p
                public final Object get() {
    ...
    public final void setPlaybackParameters(final PlaybackParameters playbackParameters) {
        ...
        if (shouldHandleCommand(13)) {
            updateStateForPendingOperation(handleSetPlaybackParameters(playbackParameters), new y7.p() { // from class: io.bidmachine.media3.common.c1
                @Override // y7.p
                public final Object get() {
    ...
    public final void setPlaylistMetadata(final MediaMetadata mediaMetadata) {
        ...
        if (shouldHandleCommand(19)) {
            updateStateForPendingOperation(handleSetPlaylistMetadata(mediaMetadata), new y7.p() { // from class: io.bidmachine.media3.common.h1
                @Override // y7.p
                public final Object get() {
    ...
    public final void setRepeatMode(final int i10) {
        ...
        if (shouldHandleCommand(15)) {
            updateStateForPendingOperation(handleSetRepeatMode(i10), new y7.p() { // from class: io.bidmachine.media3.common.r1
                @Override // y7.p
                public final Object get() {
                    return SimpleBasePlayer.lambda$setRepeatMode$8(state, i10);
                }
            });
        }
    }
    ...
    public final void setShuffleModeEnabled(final boolean z10) {
        ...
        if (shouldHandleCommand(14)) {
            updateStateForPendingOperation(handleSetShuffleModeEnabled(z10), new y7.p() { // from class: io.bidmachine.media3.common.v0
                @Override // y7.p
                public final Object get() {
    ...
    public final void setTrackSelectionParameters(final TrackSelectionParameters trackSelectionParameters) {
        ...
        if (shouldHandleCommand(29)) {
            updateStateForPendingOperation(handleSetTrackSelectionParameters(trackSelectionParameters), new y7.p() { // from class: io.bidmachine.media3.common.n1
                @Override // y7.p
                public final Object get() {
    ...
    public final void setVideoSurface(@Nullable Surface surface) {
        ...
        if (shouldHandleCommand(27)) {
            if (surface == null) {
                ...
                updateStateForPendingOperation(handleSetVideoOutput(surface), new y7.p() { // from class: io.bidmachine.media3.common.q0
                    @Override // y7.p
                    public final Object get() {
    ...
    public final void setVideoSurfaceHolder(@Nullable final SurfaceHolder surfaceHolder) {
        ...
        if (shouldHandleCommand(27)) {
            if (surfaceHolder == null) {
                ...
                updateStateForPendingOperation(handleSetVideoOutput(surfaceHolder), new y7.p() { // from class: io.bidmachine.media3.common.e1
                    @Override // y7.p
                    public final Object get() {
    ...
    public final void setVideoSurfaceView(@Nullable final SurfaceView surfaceView) {
        ...
        if (shouldHandleCommand(27)) {
            if (surfaceView == null) {
                ...
                updateStateForPendingOperation(handleSetVideoOutput(surfaceView), new y7.p() { // from class: io.bidmachine.media3.common.u
                    @Override // y7.p
                    public final Object get() {
    ...
    public final void setVideoTextureView(@Nullable TextureView textureView) {
        ...
        if (shouldHandleCommand(27)) {
            if (textureView == null) {
                ...
                updateStateForPendingOperation(handleSetVideoOutput(textureView), new y7.p() { // from class: io.bidmachine.media3.common.a1
                    @Override // y7.p
                    public final Object get() {
    ...
    public final void setVolume(final float f10) {
        ...
        if (shouldHandleCommand(24)) {
            updateStateForPendingOperation(handleSetVolume(f10), new y7.p() { // from class: io.bidmachine.media3.common.p1
                @Override // y7.p
                public final Object get() {
    ...
    public final void stop() {
        ...
        if (shouldHandleCommand(3)) {
            updateStateForPendingOperation(handleStop(), new y7.p() { // from class: io.bidmachine.media3.common.f1
                @Override // y7.p
                public final Object get() {
