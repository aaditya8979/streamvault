...
public final class GlProgram {
    ...
    public static final class a {
        ...
        public static a create(int i10, int i11) {
            int[] iArr = new int[1];
            ...
            return new a(str, GlProgram.getAttributeLocation(i10, str));
        }
    ...
    public static final class b {
        ...
        public static b create(int i10, int i11) {
            int[] iArr = new int[1];
            ...
            String str = new String(bArr, 0, GlProgram.getCStringLength(bArr));
            return new b(str, GlProgram.getUniformLocation(i10, str), iArr2[0]);
        }

        public void bind(boolean z10) throws GlUtil.GlException {
            int i10 = this.type;
            if (i10 == 5124) {
            ...
            if (i10 == 35678 || i10 == GlProgram.GL_SAMPLER_EXTERNAL_2D_Y2Y_EXT || i10 == 36198) {
                ...
                GlUtil.checkGlError();
                int i11 = this.type;
                GlUtil.bindTexture(i11 == 35678 ? 3553 : 36197, this.texIdValue, (i11 != 35678 || z10) ? 9728 : 9729);
    ...
    public GlProgram(String str, String str2) throws GlUtil.GlException {
        ...
        for (int i10 = 0; i10 < iArr2[0]; i10++) {
            a aVarCreate = a.create(this.programId, i10);
            this.attributes[i10] = aVarCreate;
            this.attributeByName.put(aVarCreate.name, aVarCreate);
        }
        ...
        for (int i11 = 0; i11 < iArr3[0]; i11++) {
            b bVarCreate = b.create(this.programId, i11);
            this.uniforms[i11] = bVarCreate;
            this.uniformByName.put(bVarCreate.name, bVarCreate);
        }
        GlUtil.checkGlError();
    }

    private static void addShader(int i10, int i11, String str) throws GlUtil.GlException {
    ...
    public static int getAttributeLocation(int i10, String str) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static int getUniformLocation(int i10, String str) {
    ...
    public void bindAttributesAndUniforms() throws GlUtil.GlException {
        ...
        for (b bVar : this.uniforms) {
            bVar.bind(this.externalTexturesRequireNearestSampling);
        }
    }
    ...
    public void setBufferAttribute(String str, float[] fArr, int i10) {
        ((a) Assertions.checkNotNull(this.attributeByName.get(str))).setBuffer(fArr, i10);
    }

    public void setExternalTexturesRequireNearestSampling(boolean z10) {
        this.externalTexturesRequireNearestSampling = z10;
    }

    public void setFloatUniform(String str, float f10) {
        ((b) Assertions.checkNotNull(this.uniformByName.get(str))).setFloat(f10);
    }

    public void setFloatsUniform(String str, float[] fArr) {
        ((b) Assertions.checkNotNull(this.uniformByName.get(str))).setFloats(fArr);
    }

    public void setFloatsUniformIfPresent(String str, float[] fArr) {
        b bVar = this.uniformByName.get(str);
        if (bVar == null) {
            return;
        }
        bVar.setFloats(fArr);
    ...
    public void setIntUniform(String str, int i10) {
        ((b) Assertions.checkNotNull(this.uniformByName.get(str))).setInt(i10);
    }

    public void setIntsUniform(String str, int[] iArr) {
        ((b) Assertions.checkNotNull(this.uniformByName.get(str))).setInts(iArr);
    }

    public void setSamplerTexIdUniform(String str, int i10, int i11) {
        ((b) Assertions.checkNotNull(this.uniformByName.get(str))).setSamplerTexId(i10, i11);
    }
