...
public final class FlvExtractor implements Extractor {
    public static final ExtractorsFactory FACTORY = new ExtractorsFactory() { // from class: oj.a
    ...
    private int tagType;
    private b videoReader;
    private final ParsableByteArray scratch = new ParsableByteArray(4);
    private final ParsableByteArray headerBuffer = new ParsableByteArray(9);
    private final ParsableByteArray tagHeaderBuffer = new ParsableByteArray(11);
    private final ParsableByteArray tagData = new ParsableByteArray();
    private final oj.b metadataReader = new oj.b();
    private int state = 1;
    ...
    private boolean readFlvHeader(ExtractorInput extractorInput) throws IOException {
        ...
        if (z11 && this.videoReader == null) {
            this.videoReader = new b(this.extractorOutput.track(9, 2));
        }
    ...
    */
    private boolean readTagData(io.bidmachine.media3.extractor.ExtractorInput r10) throws java.io.IOException {
        /*
            r9 = this;
            ...
            r7 = 8
            if (r2 != r7) goto L24
            io.bidmachine.media3.extractor.flv.a r7 = r9.audioReader
            if (r7 == 0) goto L24
            r9.ensureReadyForMediaOutput()
            io.bidmachine.media3.extractor.flv.a r2 = r9.audioReader
            io.bidmachine.media3.common.util.ParsableByteArray r10 = r9.prepareTagData(r10)
        ...
        L24:
            r7 = 9
            if (r2 != r7) goto L3a
            io.bidmachine.media3.extractor.flv.b r7 = r9.videoReader
            if (r7 == 0) goto L3a
            r9.ensureReadyForMediaOutput()
            io.bidmachine.media3.extractor.flv.b r2 = r9.videoReader
            io.bidmachine.media3.common.util.ParsableByteArray r10 = r9.prepareTagData(r10)
            boolean r5 = r2.consume(r10, r0)
            goto L22
        L3a:
            ...
            if (r2 != 0) goto L6f
            oj.b r2 = r9.metadataReader
            io.bidmachine.media3.common.util.ParsableByteArray r10 = r9.prepareTagData(r10)
            boolean r5 = r2.consume(r10, r0)
            oj.b r10 = r9.metadataReader
            long r0 = r10.getDurationUs()
            int r10 = (r0 > r3 ? 1 : (r0 == r3 ? 0 : -1))
            if (r10 == 0) goto L22
            io.bidmachine.media3.extractor.ExtractorOutput r10 = r9.extractorOutput
            io.bidmachine.media3.extractor.IndexSeekMap r2 = new io.bidmachine.media3.extractor.IndexSeekMap
            oj.b r7 = r9.metadataReader
            long[] r7 = r7.getKeyFrameTagPositions()
            oj.b r8 = r9.metadataReader
        ...
        L8f:
            ...
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: io.bidmachine.media3.extractor.flv.FlvExtractor.readTagData(io.bidmachine.media3.extractor.ExtractorInput):boolean");
    }
