...
public final class SpliceInsertCommand extends SpliceCommand {
    ...
    public static final class ComponentSplice {
        ...
        public /* synthetic */ ComponentSplice(int i10, long j10, long j11, a aVar) {
            this(i10, j10, j11);
        }
        ...
        if (z15) {
            ...
            if (!z17) {
                ...
                for (int i10 = 0; i10 < unsignedByte4; i10++) {
                    ...
                    arrayList.add(new ComponentSplice(unsignedByte5, spliceTime2, timestampAdjuster.adjustTsTimestamp(spliceTime2), null));
                }
