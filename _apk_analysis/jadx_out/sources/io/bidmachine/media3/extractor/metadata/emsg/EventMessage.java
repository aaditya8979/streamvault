...
public final class EventMessage implements Metadata.Entry {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return this.durationMs == eventMessage.durationMs && this.f69923id == eventMessage.f69923id && Util.areEqual(this.schemeIdUri, eventMessage.schemeIdUri) && Util.areEqual(this.value, eventMessage.value) && Arrays.equals(this.messageData, eventMessage.messageData);
    }
    ...
    public String toString() {
        return "EMSG: scheme=" + this.schemeIdUri + ", id=" + this.f69923id + ", durationMs=" + this.durationMs + ", value=" + this.value;
    }
    ...
    public void writeToParcel(Parcel parcel, int i10) {
        ...
        parcel.writeLong(this.f69923id);
