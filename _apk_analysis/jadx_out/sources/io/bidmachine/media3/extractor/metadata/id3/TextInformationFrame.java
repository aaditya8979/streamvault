...
public final class TextInformationFrame extends Id3Frame {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Util.areEqual(this.f69924id, textInformationFrame.f69924id) && Util.areEqual(this.description, textInformationFrame.description) && this.values.equals(textInformationFrame.values);
    }
        ...
        try {
            switch (b10) {
                ...
                case 22:
                    ...
                    break;
                case 12:
                    Integer numP = Ints.p(this.values.get(0));
                    if (numP != null) {
    ...
    public String toString() {
        return this.f69924id + ": description=" + this.description + ": values=" + this.values;
    }
