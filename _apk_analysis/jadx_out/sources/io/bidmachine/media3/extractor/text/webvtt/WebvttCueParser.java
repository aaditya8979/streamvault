...
public final class WebvttCueParser {
    ...
    public static class b {
        private static final Comparator<b> BY_START_POSITION_ASC = new Comparator() { // from class: ak.b
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
                return WebvttCueParser.b.lambda$static$0((WebvttCueParser.b) obj, (WebvttCueParser.b) obj2);
            }
        };
    ...
    private static void applyRubySpans(SpannableStringBuilder spannableStringBuilder, @Nullable String str, c cVar, List<b> list, List<WebvttCssStyle> list2) {
        int rubyPosition = getRubyPosition(list2, str, cVar);
        ...
        for (int i11 = 0; i11 < arrayList.size(); i11++) {
            if ("rt".equals(((b) arrayList.get(i11)).startTag.name)) {
                b bVar = (b) arrayList.get(i11);
                int iFirstKnownRubyPosition = firstKnownRubyPosition(getRubyPosition(list2, str, bVar.startTag), rubyPosition, 1);
                int i12 = bVar.startTag.position - length;
                int i13 = bVar.endPosition - length;
    ...
    private static void applySpansForTag(@Nullable String str, c cVar, List<b> list, SpannableStringBuilder spannableStringBuilder, List<WebvttCssStyle> list2) {
        int i10;
        int length;
        i10 = cVar.position;
        ...
        switch (str2) {
            ...
            case "b":
                ...
                break;
            case "c":
                applyDefaultColors(spannableStringBuilder, cVar.classes, i10, length);
                break;
            case "i":
            ...
            case "u":
                ...
                break;
            case "ruby":
                applyRubySpans(spannableStringBuilder, str, cVar, list, list2);
                break;
            default:
                return;
        }
        List<d> applicableStyles = getApplicableStyles(list2, str, cVar);
    ...
    private static List<d> getApplicableStyles(List<WebvttCssStyle> list, @Nullable String str, c cVar) {
    ...
    private static int getRubyPosition(List<WebvttCssStyle> list, @Nullable String str, c cVar) {
        List<d> applicableStyles = getApplicableStyles(list, str, cVar);
    ...
    private static WebvttCueInfo parseCue(@Nullable String str, Matcher matcher, ParsableByteArray parsableByteArray, List<WebvttCssStyle> list) {
        ...
        try {
            ...
            parseCueSettingsList((String) Assertions.checkNotNull(matcher.group(3)), eVar);
            ...
            eVar.text = parseCueText(str, sb2.toString(), list);
            return eVar.build();
    ...
    public static Cue.Builder parseCueSettingsList(String str) {
        e eVar = new e();
        parseCueSettingsList(str, eVar);
        return eVar.toCueBuilder();
    }

    private static void parseCueSettingsList(String str, e eVar) {
        ...
        while (matcher.find()) {
            ...
            try {
                if ("line".equals(str2)) {
                    parseLineAttribute(str3, eVar);
                } else if ("align".equals(str2)) {
                    eVar.textAlignment = parseTextAlignment(str3);
                } else if (C3978d4.i.L.equals(str2)) {
                    parsePositionAttribute(str3, eVar);
                } else if ("size".equals(str2)) {
                    eVar.size = WebvttParserUtil.parsePercentage(str3);
                } else if ("vertical".equals(str2)) {
                    eVar.verticalType = parseVerticalAttribute(str3);
                } else {
    ...
    public static SpannedString parseCueText(@Nullable String str, String str2, List<WebvttCssStyle> list) {
                        ...
                        if (isSupportedTag(tagName)) {
                            if (z10) {
                                while (!arrayDeque.isEmpty()) {
                                    ...
                                    applySpansForTag(str, cVar, arrayList, spannableStringBuilder, list);
                                    if (arrayDeque.isEmpty()) {
                                        arrayList.clear();
                                    } else {
                                        arrayList.add(new b(cVar, spannableStringBuilder.length()));
                                    }
                                    if (cVar.name.equals(tagName)) {
                                        break;
                                    }
                                }
                            } else if (!z11) {
        ...
        while (!arrayDeque.isEmpty()) {
            applySpansForTag(str, (c) arrayDeque.pop(), arrayList, spannableStringBuilder, list);
        }
        applySpansForTag(str, c.buildWholeCueVirtualTag(), Collections.emptyList(), spannableStringBuilder, list);
    ...
    private static void parseLineAttribute(String str, e eVar) {
        int iIndexOf = str.indexOf(44);
        if (iIndexOf != -1) {
            eVar.lineAnchor = parseLineAnchor(str.substring(iIndexOf + 1));
    ...
    private static void parsePositionAttribute(String str, e eVar) {
        int iIndexOf = str.indexOf(44);
        if (iIndexOf != -1) {
            eVar.positionAnchor = parsePositionAnchor(str.substring(iIndexOf + 1));
            str = str.substring(0, iIndexOf);
        }
