...
public final class Cea608Decoder extends c {
    ...
    private final ArrayList<a> cueBuilders = new ArrayList<>();
    private a currentCueBuilder = new a(0, 4);
    ...
    public static final class a {
        ...
        private final List<C0813a> cueStyles = new ArrayList();
        private final List<SpannableString> rolledUpCaptions = new ArrayList();
        private final StringBuilder captionStringBuilder = new StringBuilder();

        /* JADX INFO: renamed from: io.bidmachine.media3.extractor.text.cea.Cea608Decoder$a$a, reason: collision with other inner class name */
        public static class C0813a {
            public int start;
            public final int style;
            public final boolean underline;

            public C0813a(int i10, boolean z10, int i11) {
                this.style = i10;
                this.underline = z10;
                this.start = i11;
            }
        ...
        private SpannableString buildCurrentLine() {
            ...
            while (i10 < this.cueStyles.size()) {
                C0813a c0813a = this.cueStyles.get(i10);
                boolean z11 = c0813a.underline;
                int i16 = c0813a.style;
                if (i16 != 8) {
                    boolean z12 = i16 == 7;
                    if (i16 != 7) {
        ...
        public void backspace() {
            ...
            if (length > 0) {
                ...
                for (int size = this.cueStyles.size() - 1; size >= 0; size--) {
                    C0813a c0813a = this.cueStyles.get(size);
                    int i10 = c0813a.start;
                    if (i10 != length) {
                        return;
                    }
                    c0813a.start = i10 - 1;
        ...
        public void setStyle(int i10, boolean z10) {
            this.cueStyles.add(new C0813a(i10, z10, this.captionStringBuilder.length()));
        }
    }
    ...
    private void handlePreambleAddressCode(byte b10, byte b11) {
        ...
        if (i10 != this.currentCueBuilder.row) {
            if (this.captionMode != 1 && !this.currentCueBuilder.isEmpty()) {
                a aVar = new a(this.captionMode, this.captionRowCount);
                this.currentCueBuilder = aVar;
                this.cueBuilders.add(aVar);
            }
    ...
    */
    public void decode(io.bidmachine.media3.extractor.text.SubtitleInputBuffer r10) {
        /*
            Method dump skipped, instruction units count: 267
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: io.bidmachine.media3.extractor.text.cea.Cea608Decoder.decode(io.bidmachine.media3.extractor.text.SubtitleInputBuffer):void");
    }
