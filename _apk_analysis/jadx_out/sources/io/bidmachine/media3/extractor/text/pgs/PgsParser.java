...
public final class PgsParser implements SubtitleParser {
    ...
    public static final class a {
        ...
        public void parsePaletteSection(ParsableByteArray parsableByteArray, int i10) {
            ...
            while (i12 < i11) {
                ...
                this.colors[unsignedByte] = Util.constrainValue((int) (d10 + (d12 * 1.772d)), 0, 255) | (Util.constrainValue((int) ((d10 - (0.34414d * d12)) - (d11 * 0.71414d)), 0, 255) << 8) | (unsignedByte5 << 24) | (Util.constrainValue(i13, 0, 255) << 16);
                i12 = i14 + 1;
            }
            this.colorsSet = true;
        }
            ...
            while (i11 < i10) {
                ...
                if (unsignedByte2 != 0) {
                    ...
                    if (unsignedByte3 != 0) {
                        ...
                        Arrays.fill(iArr, i11, unsignedByte, (unsignedByte3 & 128) == 0 ? this.colors[0] : this.colors[this.bitmapData.readUnsignedByte()]);
                    }
                }
                i11 = unsignedByte;
            }
    ...
    private static Cue readNextSection(ParsableByteArray parsableByteArray, a aVar) {
        ...
        if (unsignedByte != 128) {
            switch (unsignedByte) {
                case 20:
                    aVar.parsePaletteSection(parsableByteArray, unsignedShort);
                    break;
                case 21:
                    aVar.parseBitmapSection(parsableByteArray, unsignedShort);
                    break;
                case 22:
                    aVar.parseIdentifierSection(parsableByteArray, unsignedShort);
                    break;
            }
        } else {
            cueBuild = aVar.build();
    ...
    public void parse(byte[] bArr, int i10, int i11, SubtitleParser.OutputOptions outputOptions, Consumer<CuesWithTiming> consumer) {
        this.buffer.reset(bArr, i11 + i10);
        this.buffer.setPosition(i10);
