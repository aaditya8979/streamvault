...
/* JADX INFO: compiled from: SubtitleTranscodingTrackOutput.java */
...
public final class a implements TrackOutput {
    ...
    public void sampleMetadata(final long j10, final int i10, int i11, int i12, @Nullable TrackOutput.CryptoData cryptoData) {
        ...
        this.currentSubtitleParser.parse(this.sampleData, i13, i11, SubtitleParser.OutputOptions.allCues(), new Consumer() { // from class: wj.e
            @Override // io.bidmachine.media3.common.util.Consumer
            public final void accept(Object obj) {
                this.f86438a.lambda$sampleMetadata$0(j10, i10, (CuesWithTiming) obj);
            }
        });
        int i14 = i13 + i11;
