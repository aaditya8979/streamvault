...
public abstract class a {
    ...
    /* JADX INFO: renamed from: io.bidmachine.media3.extractor.mp4.a$a, reason: collision with other inner class name */
    /* JADX INFO: compiled from: Atom.java */
    public static final class C0811a extends a {
        public final List<C0811a> containerChildren;
        public final long endPosition;
        public final List<b> leafChildren;

        public C0811a(int i10, long j10) {
            super(i10);
        ...
        public void add(C0811a c0811a) {
            this.containerChildren.add(c0811a);
        }
        ...
        @Nullable
        public C0811a getContainerAtomOfType(int i10) {
            int size = this.containerChildren.size();
            for (int i11 = 0; i11 < size; i11++) {
                C0811a c0811a = this.containerChildren.get(i11);
                if (c0811a.type == i10) {
                    return c0811a;
                }
            }
        ...
        @Override // io.bidmachine.media3.extractor.mp4.a
