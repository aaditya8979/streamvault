...
public final class PsshAtomUtil {
    ...
    public static final class PsshAtom {
        ...
        public PsshAtom(UUID uuid, int i10, byte[] bArr, @Nullable UUID[] uuidArr) {
            this.uuid = uuid;
            this.version = i10;
    ...
    public static PsshAtom parsePsshAtom(byte[] bArr) {
        ...
        if (i11 != 1886614376) {
            Log.w(TAG, "Atom type is not pssh: " + i11);
            return null;
        }
        int fullAtomVersion = a.parseFullAtomVersion(parsableByteArray.readInt());
