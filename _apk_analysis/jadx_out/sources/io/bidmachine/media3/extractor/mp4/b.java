...
public final class b {
    ...
    /* JADX INFO: renamed from: io.bidmachine.media3.extractor.mp4.b$b, reason: collision with other inner class name */
    /* JADX INFO: compiled from: AtomParsers.java */
    public static final class C0812b {
        ...
        public C0812b(String str, byte[] bArr, long j10, long j11) {
            this.mimeType = str;
    ...
    public static final class e implements c {
        ...
        public e(a.b bVar, Format format) {
            ...
            if ("audio/raw".equals(format.sampleMimeType)) {
                ...
                if (unsignedIntToInt == 0 || unsignedIntToInt % pcmFrameSize != 0) {
                    Log.w(b.TAG, "Audio sample size mismatch. stsd sample size: " + pcmFrameSize + ", stsz sample size: " + unsignedIntToInt);
        ...
        @Override // io.bidmachine.media3.extractor.mp4.b.c
    ...
    */
    private static void parseAudioSampleEntry(io.bidmachine.media3.common.util.ParsableByteArray r24, int r25, int r26, int r27, int r28, java.lang.String r29, boolean r30, @androidx.annotation.Nullable io.bidmachine.media3.common.DrmInitData r31, io.bidmachine.media3.extractor.mp4.b.d r32, int r33) throws io.bidmachine.media3.common.ParserException {
        /*
            Method dump skipped, instruction units count: 1106
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: io.bidmachine.media3.extractor.mp4.b.parseAudioSampleEntry(io.bidmachine.media3.common.util.ParsableByteArray, int, int, int, int, java.lang.String, boolean, io.bidmachine.media3.common.DrmInitData, io.bidmachine.media3.extractor.mp4.b$d, int):void");
    }
    ...
    @Nullable
    private static Pair<long[], long[]> parseEdts(a.C0811a c0811a) {
        a.b leafAtomOfType = c0811a.getLeafAtomOfType(1701606260);
    ...
    private static C0812b parseEsdsFromParent(ParsableByteArray parsableByteArray, int i10) {
        ...
        if ("audio/mpeg".equals(mimeTypeFromMp4ObjectType) || "audio/vnd.dts".equals(mimeTypeFromMp4ObjectType) || "audio/vnd.dts.hd".equals(mimeTypeFromMp4ObjectType)) {
            return new C0812b(mimeTypeFromMp4ObjectType, null, -1L, -1L);
        }
        parsableByteArray.skipBytes(4);
        ...
        return new C0812b(mimeTypeFromMp4ObjectType, bArr, unsignedInt2 > 0 ? unsignedInt2 : -1L, unsignedInt > 0 ? unsignedInt : -1L);
    }
    ...
    private static Metadata parseIlst(ParsableByteArray parsableByteArray, int i10) {
        ...
        while (parsableByteArray.getPosition() < i10) {
            Metadata.Entry ilstElement = uj.e.parseIlstElement(parsableByteArray);
            if (ilstElement != null) {
    ...
    @Nullable
    public static Metadata parseMdtaFromMeta(a.C0811a c0811a) {
        a.b leafAtomOfType = c0811a.getLeafAtomOfType(1751411826);
        a.b leafAtomOfType2 = c0811a.getLeafAtomOfType(1801812339);
        a.b leafAtomOfType3 = c0811a.getLeafAtomOfType(1768715124);
        ...
        while (parsableByteArray2.bytesLeft() > 8) {
            ...
            if (i14 < 0 || i14 >= i10) {
                ...
                MdtaMetadataEntry mdtaMetadataEntryFromIlst = uj.e.parseMdtaMetadataEntryFromIlst(parsableByteArray2, position + i13, strArr[i14]);
    ...
    private static void parseMetaDataSampleEntry(ParsableByteArray parsableByteArray, int i10, int i11, int i12, d dVar) {
        parsableByteArray.setPosition(i11 + 8 + 8);
        if (i10 == 1835365492) {
            parsableByteArray.readNullTerminatedString();
            String nullTerminatedString = parsableByteArray.readNullTerminatedString();
            if (nullTerminatedString != null) {
                dVar.format = new Format.Builder().setId(i12).setSampleMimeType(nullTerminatedString).build();
            }
        }
    }
    ...
    public static Mp4TimestampData parseMvhd(ParsableByteArray parsableByteArray) {
        ...
        long unsignedInt2;
        parsableByteArray.setPosition(8);
        if (io.bidmachine.media3.extractor.mp4.a.parseFullAtomVersion(parsableByteArray.readInt()) == 0) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private static uj.l parseStbl(io.bidmachine.media3.extractor.mp4.Track r37, io.bidmachine.media3.extractor.mp4.a.C0811a r38, io.bidmachine.media3.extractor.GaplessInfoHolder r39) throws io.bidmachine.media3.common.ParserException {
        /*
            Method dump skipped, instruction units count: 1323
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: io.bidmachine.media3.extractor.mp4.b.parseStbl(io.bidmachine.media3.extractor.mp4.Track, io.bidmachine.media3.extractor.mp4.a$a, io.bidmachine.media3.extractor.GaplessInfoHolder):uj.l");
    }

    private static d parseStsd(ParsableByteArray parsableByteArray, int i10, int i11, String str, @Nullable DrmInitData drmInitData, boolean z10) throws ParserException {
        int i12;
        parsableByteArray.setPosition(12);
        int i13 = parsableByteArray.readInt();
        d dVar = new d(i13);
        for (int i14 = 0; i14 < i13; i14++) {
            ...
            if (i16 == 1635148593 || i16 == 1635148595 || i16 == 1701733238 || i16 == 1831958048 || i16 == 1836070006 || i16 == 1752589105 || i16 == 1751479857 || i16 == 1932670515 || i16 == 1211250227 || i16 == 1987063864 || i16 == 1987063865 || i16 == 1635135537 || i16 == 1685479798 || i16 == 1685479729 || i16 == 1685481573 || i16 == 1685481521) {
                i12 = position;
                parseVideoSampleEntry(parsableByteArray, i16, i12, i15, i10, i11, drmInitData, dVar, i14);
                ...
                i12 = position;
                parseAudioSampleEntry(parsableByteArray, i16, position, i15, i10, str, z10, drmInitData, dVar, i14);
            } else {
                if (i16 == 1414810956 || i16 == 1954034535 || i16 == 2004251764 || i16 == 1937010800 || i16 == 1664495672) {
                    parseTextSampleEntry(parsableByteArray, i16, position, i15, i10, str, dVar);
                } else if (i16 == 1835365492) {
                    parseMetaDataSampleEntry(parsableByteArray, i16, position, i10, dVar);
                } else if (i16 == 1667329389) {
                    dVar.format = new Format.Builder().setId(i10).setSampleMimeType("application/x-camera-motion").build();
                }
                i12 = position;
            }
    ...
    private static void parseTextSampleEntry(ParsableByteArray parsableByteArray, int i10, int i11, int i12, int i13, String str, d dVar) {
        parsableByteArray.setPosition(i11 + 8 + 8);
        ...
        dVar.format = new Format.Builder().setId(i13).setSampleMimeType(str2).setLanguage(str).setSubsampleOffsetUs(j10).setInitializationData(immutableListOf).build();
    }

    private static g parseTkhd(ParsableByteArray parsableByteArray) {
        boolean z10;
        parsableByteArray.setPosition(8);
        int fullAtomVersion = io.bidmachine.media3.extractor.mp4.a.parseFullAtomVersion(parsableByteArray.readInt());
        parsableByteArray.skipBytes(fullAtomVersion == 0 ? 8 : 16);
        ...
        return new g(i10, j10, i12);
    }

    @Nullable
    private static Track parseTrak(a.C0811a c0811a, a.b bVar, long j10, @Nullable DrmInitData drmInitData, boolean z10, boolean z11) throws ParserException {
        a.b bVar2;
        long j11;
        long[] jArr;
        long[] jArr2;
        a.C0811a containerAtomOfType;
        Pair<long[], long[]> edts;
        a.C0811a c0811a2 = (a.C0811a) Assertions.checkNotNull(c0811a.getContainerAtomOfType(1835297121));
        int trackTypeForHdlr = getTrackTypeForHdlr(parseHdlr(((a.b) Assertions.checkNotNull(c0811a2.getLeafAtomOfType(1751411826))).data));
        if (trackTypeForHdlr == -1) {
            return null;
        }
        g tkhd = parseTkhd(((a.b) Assertions.checkNotNull(c0811a.getLeafAtomOfType(1953196132))).data);
        ...
        long j12 = parseMvhd(bVar2.data).timescale;
        long jScaleLargeTimestamp = j11 != -9223372036854775807L ? Util.scaleLargeTimestamp(j11, 1000000L, j12) : -9223372036854775807L;
        a.C0811a c0811a3 = (a.C0811a) Assertions.checkNotNull(((a.C0811a) Assertions.checkNotNull(c0811a2.getContainerAtomOfType(1835626086))).getContainerAtomOfType(1937007212));
        Pair<Long, String> mdhd = parseMdhd(((a.b) Assertions.checkNotNull(c0811a2.getLeafAtomOfType(1835296868))).data);
        a.b leafAtomOfType = c0811a3.getLeafAtomOfType(1937011556);
        if (leafAtomOfType == null) {
            throw ParserException.createForMalformedContainer("Malformed sample table (stbl) missing sample description (stsd)", null);
        }
        d stsd = parseStsd(leafAtomOfType.data, tkhd.f69926id, tkhd.rotationDegrees, (String) mdhd.second, drmInitData, z11);
        if (z10 || (containerAtomOfType = c0811a.getContainerAtomOfType(1701082227)) == null || (edts = parseEdts(containerAtomOfType)) == null) {
            jArr = null;
            jArr2 = null;
        } else {
        ...
        return new Track(tkhd.f69926id, trackTypeForHdlr, ((Long) mdhd.first).longValue(), j12, jScaleLargeTimestamp, stsd.format, stsd.requiredSampleTransformation, stsd.trackEncryptionBoxes, stsd.nalUnitLengthFieldLength, jArr, jArr2);
    }

    public static List<l> parseTraks(a.C0811a c0811a, GaplessInfoHolder gaplessInfoHolder, long j10, @Nullable DrmInitData drmInitData, boolean z10, boolean z11, y7.e<Track, Track> eVar) throws ParserException {
        Track trackApply;
        ArrayList arrayList = new ArrayList();
        for (int i10 = 0; i10 < c0811a.containerChildren.size(); i10++) {
            a.C0811a c0811a2 = c0811a.containerChildren.get(i10);
            if (c0811a2.type == 1953653099 && (trackApply = eVar.apply(parseTrak(c0811a2, (a.b) Assertions.checkNotNull(c0811a.getLeafAtomOfType(1836476516)), j10, drmInitData, z10, z11))) != null) {
                arrayList.add(parseStbl(trackApply, (a.C0811a) Assertions.checkNotNull(((a.C0811a) Assertions.checkNotNull(((a.C0811a) Assertions.checkNotNull(c0811a2.getContainerAtomOfType(1835297121))).getContainerAtomOfType(1835626086))).getContainerAtomOfType(1937007212)), gaplessInfoHolder));
            }
        }
        return arrayList;
    }
    ...
    private static void parseVideoSampleEntry(ParsableByteArray parsableByteArray, int i10, int i11, int i12, int i13, int i14, @Nullable DrmInitData drmInitData, d dVar, int i15) throws ParserException {
        ...
        if (iIntValue == 1701733238) {
            ...
            if (sampleEntryEncryptionData != null) {
                ...
                dVar2.trackEncryptionBoxes[i15] = (TrackEncryptionBox) sampleEntryEncryptionData.second;
            }
            parsableByteArray.setPosition(position);
        }
        ...
        while (i27 - i21 < i22) {
            ...
            if (i30 == 1635148611) {
                ...
                dVar2.nalUnitLengthFieldLength = avcConfig.nalUnitLengthFieldLength;
                if (!z10) {
                ...
                if (i30 == 1752589123) {
                    ...
                    dVar2.nalUnitLengthFieldLength = hevcConfig.nalUnitLengthFieldLength;
                    if (!z10) {
                                ...
                                if (i30 == 1668246642) {
                                    ...
                                    if (i19 == -1 && i20 == -1) {
                                        ...
                                        if (i43 == TYPE_nclx || i43 == TYPE_nclc) {
                                            ...
                                            Log.w(TAG, "Unsupported color type: " + io.bidmachine.media3.extractor.mp4.a.getAtomTypeString(i43));
                                        }
                                    }
                                    i27 += i29;
                                    i21 = i11;
