...
public final class H263Reader implements ElementaryStreamReader {
    ...
    public H263Reader(@Nullable io.bidmachine.media3.extractor.ts.a aVar) {
        this.userDataReader = aVar;
        this.prefixFlags = new boolean[4];
        this.csdBuffer = new a(128);
        this.pesTimeUs = -9223372036854775807L;
        if (aVar != null) {
            this.userData = new d(START_CODE_VALUE_USER_DATA, 128);
    ...
    private static Format parseCsdBuffer(a aVar, int i10, String str) {
        ...
        parsableBitArray.skipBit();
        parsableBitArray.skipBit();
        return new Format.Builder().setId(str).setSampleMimeType("video/mp4v-es").setWidth(bits5).setHeight(bits6).setPixelWidthHeightRatio(f10).setInitializationData(Collections.singletonList(bArrCopyOf)).build();
    }
    ...
    public void consume(ParsableByteArray parsableByteArray) {
        ...
        while (true) {
            ...
            if (!this.hasOutputFormat) {
                ...
                if (this.csdBuffer.onStartCode(i11, i12 < 0 ? -i12 : 0)) {
                    ...
                    trackOutput.format(parseCsdBuffer(aVar, aVar.volStartPosition, (String) Assertions.checkNotNull(this.formatId)));
            ...
            if (dVar != null) {
                if (i12 > 0) {
                    dVar.appendToNalUnit(data, position, iFindNalUnit);
                } else {
                    i13 = -i12;
                }
                if (this.userData.endNalUnit(i13)) {
                    d dVar2 = this.userData;
                    ((ParsableByteArray) Util.castNonNull(this.userDataParsable)).reset(this.userData.nalData, NalUnitUtil.unescapeStream(dVar2.nalData, dVar2.nalLength));
                    ((io.bidmachine.media3.extractor.ts.a) Util.castNonNull(this.userDataReader)).consume(this.pesTimeUs, this.userDataParsable);
                }
                if (i11 == START_CODE_VALUE_USER_DATA && parsableByteArray.getData()[iFindNalUnit + 2] == 1) {
        ...
        d dVar3 = this.userData;
        if (dVar3 != null) {
            dVar3.appendToNalUnit(data, position, iLimit);
        }
    }
    ...
    public void createTracks(ExtractorOutput extractorOutput, TsPayloadReader.TrackIdGenerator trackIdGenerator) {
        ...
        this.sampleReader = new b(trackOutputTrack);
