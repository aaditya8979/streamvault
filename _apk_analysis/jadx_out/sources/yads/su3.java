...
public final class su3 implements yj3 {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final Context f94935a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final mf3 f94936b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public final gg3 f94937c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public final List f94938d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public final wj3 f94939e;

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    public final ca2 f94940f;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    public final io2 f94941g;
    ...
    public su3(Context context, mf3 mf3Var, gg3 gg3Var, List list, wj3 wj3Var, ca2 ca2Var, io2 io2Var) {
    ...
    public final aa2 a(Context context) {
        nt2 nt2VarA;
        wv3 wv3Var;
        y92 y92VarA = z92.a(context);
        Object obj = r92.f94330c;
        r92 r92VarA = q92.a();
        Object obj2 = dw2.f89000j;
        dw2 dw2VarA = cw2.a();
        Context applicationContext = context.getApplicationContext();
        List list = this.f94938d;
        aa2 aa2Var = null;
        if (tb.a(applicationContext) && (nt2VarA = dw2VarA.a(applicationContext)) != null && !nt2VarA.f92980w) {
            synchronized (r92.f94330c) {
                if (r92VarA.f94332a.a(applicationContext) && !r92VarA.f94333b) {
                    ea2.a(applicationContext);
                    r92VarA.f94333b = true;
                }
            ...
            while (it.hasNext()) {
                try {
                    listC.add(da2.a((gd3) it.next()));
                } catch (id3 e10) {
                    Map mapG = cn.p0.g(bn.h.a("[REASON]", String.valueOf(e10.f90777c.f90369b)));
                    wj3 wj3Var = this.f94939e;
                    gd3 gd3Var = e10.f90776b;
                    wj3Var.getClass();
                    List list2 = (List) gd3Var.a().get("verificationNotExecuted");
                    if (list2 != null) {
                        wj3Var.f96405a.a(list2, mapG);
                    }
    ...
    public final void a(float f10) {
        ...
        if (il1Var != null) {
            try {
                ...
                boolean z10 = ad1.f87661a;
                this.f94941g.reportError("Failed to execute safely", e10);
            }
        }
    }
    ...
    public final void a(View view, List list) {
        ...
        bn.r rVar = bn.r.f5635a;
        try {
            aa2 aa2VarA = a(this.f94935a);
            if (aa2VarA != null) {
                wv3 wv3Var = aa2VarA.f87622a;
                wv3Var.a(view);
                this.f94942h = wv3Var;
                this.f94943i = aa2VarA.f87623b;
                this.f94944j = aa2VarA.f87624c;
            }
        } catch (Exception e10) {
            boolean z10 = ad1.f87661a;
            this.f94941g.reportError("Failed to execute safely", e10);
        }
        wv3 wv3Var2 = this.f94942h;
        if (wv3Var2 != null) {
            Iterator it = list.iterator();
            while (it.hasNext()) {
                he3 he3Var = (he3) it.next();
                lm2 lm2Var = he3Var.f90379c;
                KProperty kProperty = he3.f90376d[0];
                View view2 = (View) lm2Var.f92035a.get();
                if (view2 != null) {
                    bn.r rVar2 = bn.r.f5635a;
                    try {
                        int iOrdinal = he3Var.f90377a.ordinal();
                        if (iOrdinal == 0) {
                            yx0Var = yx0.f97318b;
                        } else if (iOrdinal == 1) {
                            yx0Var = yx0.f97319c;
                        ...
                        wv3Var2.a(view2, yx0Var, he3Var.f90378b);
                    } catch (Exception e11) {
                        boolean z11 = ad1.f87661a;
                        this.f94941g.reportError("Failed to execute safely", e11);
                    }
                }
            }
        }
        wv3 wv3Var3 = this.f94942h;
        if (wv3Var3 != null) {
            try {
                if (!this.f94945k) {
                    wv3Var3.c();
                ...
                this.f94941g.reportError("Failed to execute safely", e12);
            }
        }
        e4 e4Var = this.f94944j;
        if (e4Var != null) {
            try {
                if (this.f94945k) {
                    return;
                }
                ca2 ca2Var = this.f94940f;
                gg3 gg3Var = this.f94937c;
                mf3 mf3Var = this.f94936b;
                ca2Var.getClass();
                int iOrdinal2 = mf3Var.ordinal();
                fg2 fg2Var = iOrdinal2 != 0 ? iOrdinal2 != 1 ? iOrdinal2 != 2 ? iOrdinal2 != 3 ? fg2.f89577f : fg2.f89577f : fg2.f89576e : fg2.f89575d : fg2.f89574c;
                e4Var.a(gg3Var != null ? new nc3(true, Float.valueOf(gg3Var.f89981a / 1000), fg2Var) : new nc3(false, null, fg2Var));
            } catch (Exception e13) {
                boolean z13 = ad1.f87661a;
                this.f94941g.reportError("Failed to execute safely", e13);
            }
        }
    }
        ...
        if (il1Var != null) {
            try {
                if (!this.f94945k) {
                    ...
                    if (iOrdinal == 0) {
                        ex3.a(il1Var.f90877a);
                        il1Var.f90877a.f96536e.a("firstQuartile", (JSONObject) null);
                    } else if (iOrdinal == 1) {
                        ex3.a(il1Var.f90877a);
                        il1Var.f90877a.f96536e.a(CampaignEx.JSON_NATIVE_VIDEO_MIDPOINT, (JSONObject) null);
                    } else if (iOrdinal == 2) {
                        ex3.a(il1Var.f90877a);
                        il1Var.f90877a.f96536e.a("thirdQuartile", (JSONObject) null);
                    }
                }
            } catch (Exception e10) {
                boolean z10 = ad1.f87661a;
    ...
    public final void b() {
        ...
        if (il1Var != null) {
            try {
                ...
                ex3.a(il1Var.f90877a);
                il1Var.f90877a.f96536e.a("complete", (JSONObject) null);
            } catch (Exception e10) {
                boolean z10 = ad1.f87661a;
                this.f94941g.reportError("Failed to execute safely", e10);
            }
    ...
    public final void c() {
        ...
        if (il1Var != null) {
            try {
                ...
                ex3.a(il1Var.f90877a);
                il1Var.f90877a.f96536e.a(CampaignEx.JSON_NATIVE_VIDEO_RESUME, (JSONObject) null);
            } catch (Exception e10) {
                boolean z10 = ad1.f87661a;
                this.f94941g.reportError("Failed to execute safely", e10);
            }
    ...
    public final void d() {
        ...
        if (il1Var != null) {
            try {
                ...
                ex3.a(il1Var.f90877a);
                il1Var.f90877a.f96536e.a(CampaignEx.JSON_NATIVE_VIDEO_PAUSE, (JSONObject) null);
            } catch (Exception e10) {
                boolean z10 = ad1.f87661a;
                this.f94941g.reportError("Failed to execute safely", e10);
            }
    ...
    public final void f() {
        ...
        if (il1Var != null) {
            try {
                ...
                ex3.a(il1Var.f90877a);
                il1Var.f90877a.f96536e.a("bufferStart", (JSONObject) null);
            } catch (Exception e10) {
                boolean z10 = ad1.f87661a;
                this.f94941g.reportError("Failed to execute safely", e10);
            }
    ...
    public final void j() {
        ...
        if (il1Var != null) {
            try {
                ...
                ex3.a(il1Var.f90877a);
                il1Var.f90877a.f96536e.a("bufferFinish", (JSONObject) null);
            } catch (Exception e10) {
                boolean z10 = ad1.f87661a;
                this.f94941g.reportError("Failed to execute safely", e10);
            }
    ...
    public final void m() {
        ...
        if (il1Var != null) {
            try {
                ...
                qc1 qc1Var = qc1.f94005c;
                ex3.a(il1Var.f90877a);
                JSONObject jSONObject = new JSONObject();
                lw3.a(jSONObject, "interactionType", qc1Var);
                il1Var.f90877a.f96536e.a("adUserInteraction", jSONObject);
            } catch (Exception e10) {
                boolean z10 = ad1.f87661a;
                this.f94941g.reportError("Failed to execute safely", e10);
            }
