...
public abstract class AdIdManager {
    ...
    public static final class Api33Ext4Impl extends AdIdManager {
        ...
        public Api33Ext4Impl(@NotNull android.adservices.adid.AdIdManager adIdManager) {
        ...
        private final AdId convertResponse(android.adservices.adid.AdId adId) {
            ...
            p.j(adId2, "response.adId");
            return new AdId(adId2, adId.isLimitAdTrackingEnabled());
        }

        /* JADX INFO: Access modifiers changed from: private */
        @RequiresPermission("android.permission.ACCESS_ADSERVICES_AD_ID")
        public final Object getAdIdAsyncInternal(c<? super android.adservices.adid.AdId> cVar) {
            kotlinx.coroutines.c cVar2 = new kotlinx.coroutines.c(IntrinsicsKt__IntrinsicsJvmKt.d(cVar), 1);
            cVar2.K();
            this.mAdIdManager.getAdId(new a(), OutcomeReceiverKt.asOutcomeReceiver(cVar2));
            Object objB = cVar2.B();
            if (objB == in.a.g()) {
                f.c(cVar);
            }
        ...
        */
        public java.lang.Object getAdId(@org.jetbrains.annotations.NotNull hn.c<? super androidx.privacysandbox.ads.adservices.adid.AdId> r5) {
            /*
                r4 = this;
            ...
            L44:
                ...
                return r5
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.privacysandbox.ads.adservices.adid.AdIdManager.Api33Ext4Impl.getAdId(hn.c):java.lang.Object");
        }
    }
    ...
    @RequiresPermission("android.permission.ACCESS_ADSERVICES_AD_ID")
    @Nullable
    public abstract Object getAdId(@NotNull c<? super AdId> cVar);
}
