...
public final class MeasurementManagerFutures$Api33Ext5JavaImpl$registerWebTriggerAsync$1 extends SuspendLambda implements p<l0, c<? super r>, Object> {
    ...
    public final Object mo2invoke(@NotNull l0 l0Var, @Nullable c<? super r> cVar) {
        return ((MeasurementManagerFutures$Api33Ext5JavaImpl$registerWebTriggerAsync$1) create(l0Var, cVar)).invokeSuspend(r.f5635a);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i10 == 0) {
            ...
            this.label = 1;
            if (measurementManager.registerWebTrigger(webTriggerRegistrationRequest, this) == objG) {
                return objG;
            }
        } else {
            if (i10 != 1) {
