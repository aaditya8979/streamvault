...
public final class AdIdManagerFutures$Api33Ext4JavaImpl$getAdIdAsync$1 extends SuspendLambda implements p<l0, c<? super AdId>, Object> {
    public int label;
    ...
    public final Object mo2invoke(@NotNull l0 l0Var, @Nullable c<? super AdId> cVar) {
        return ((AdIdManagerFutures$Api33Ext4JavaImpl$getAdIdAsync$1) create(l0Var, cVar)).invokeSuspend(r.f5635a);
    }
