...
public final class MeasurementManagerFutures$Api33Ext5JavaImpl$getMeasurementApiStatusAsync$1 extends SuspendLambda implements p<l0, c<? super Integer>, Object> {
    public int label;
    ...
    public final Object mo2invoke(@NotNull l0 l0Var, @Nullable c<? super Integer> cVar) {
        return ((MeasurementManagerFutures$Api33Ext5JavaImpl$getMeasurementApiStatusAsync$1) create(l0Var, cVar)).invokeSuspend(r.f5635a);
    }
