...
public abstract class ListenableWorker {
    ...
    @NonNull
    public final i<Void> setForegroundAsync(@NonNull ForegroundInfo foregroundInfo) {
        return this.mWorkerParams.getForegroundUpdater().setForegroundAsync(getApplicationContext(), getId(), foregroundInfo);
    }

    @NonNull
    public i<Void> setProgressAsync(@NonNull Data data) {
    ...
    @NonNull
    @MainThread
    public abstract i<Result> startWork();
