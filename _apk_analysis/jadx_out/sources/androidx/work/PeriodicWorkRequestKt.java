...
public final class PeriodicWorkRequestKt {
    public static final /* synthetic */ <W extends ListenableWorker> PeriodicWorkRequest.Builder PeriodicWorkRequestBuilder(long j10, TimeUnit timeUnit) {
        p.k(timeUnit, "repeatIntervalTimeUnit");
        p.q(4, ExifInterface.LONGITUDE_WEST);
        return new PeriodicWorkRequest.Builder((Class<? extends ListenableWorker>) ListenableWorker.class, j10, timeUnit);
    }

    public static final /* synthetic */ <W extends ListenableWorker> PeriodicWorkRequest.Builder PeriodicWorkRequestBuilder(long j10, TimeUnit timeUnit, long j11, TimeUnit timeUnit2) {
        p.k(timeUnit, "repeatIntervalTimeUnit");
        p.k(timeUnit2, "flexTimeIntervalUnit");
        p.q(4, ExifInterface.LONGITUDE_WEST);
    ...
    public static final /* synthetic */ <W extends ListenableWorker> PeriodicWorkRequest.Builder PeriodicWorkRequestBuilder(Duration duration, Duration duration2) {
        p.k(duration, "repeatInterval");
        p.k(duration2, "flexTimeInterval");
        p.q(4, ExifInterface.LONGITUDE_WEST);
