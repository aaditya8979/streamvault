...
public abstract class WorkManager {
    ...
    @NonNull
    public abstract i<Long> getLastCancelAllTimeMillis();

    @NonNull
    public abstract LiveData<Long> getLastCancelAllTimeMillisLiveData();

    @NonNull
    public abstract i<WorkInfo> getWorkInfoById(@NonNull UUID uuid);
    ...
    @NonNull
    public abstract i<List<WorkInfo>> getWorkInfosByTag(@NonNull String str);

    @NonNull
    public abstract LiveData<List<WorkInfo>> getWorkInfosByTagLiveData(@NonNull String str);

    @NonNull
    public abstract i<List<WorkInfo>> getWorkInfosForUniqueWork(@NonNull String str);
    ...
    @NonNull
    public abstract i<UpdateResult> updateWork(@NonNull WorkRequest workRequest);
}
