...
public class WorkManagerImpl extends WorkManager {
    ...
    public WorkManagerImpl(@NonNull Context context, @NonNull Configuration configuration, @NonNull TaskExecutor taskExecutor, boolean z10) {
        this(context, configuration, taskExecutor, WorkDatabase.create(context.getApplicationContext(), taskExecutor.getSerialTaskExecutor(), z10));
    }
    ...
    @Override // androidx.work.WorkManager
    @NonNull
    public i<Long> getLastCancelAllTimeMillis() {
    ...
    @Override // androidx.work.WorkManager
    @NonNull
    public i<WorkInfo> getWorkInfoById(@NonNull UUID uuid) {
    ...
    @Override // androidx.work.WorkManager
    @NonNull
    public i<List<WorkInfo>> getWorkInfos(@NonNull WorkQuery workQuery) {
    ...
    @Override // androidx.work.WorkManager
    @NonNull
    public i<List<WorkInfo>> getWorkInfosByTag(@NonNull String str) {
    ...
    @Override // androidx.work.WorkManager
    @NonNull
    public i<List<WorkInfo>> getWorkInfosForUniqueWork(@NonNull String str) {
    ...
    @Override // androidx.work.WorkManager
    @NonNull
    public i<WorkManager.UpdateResult> updateWork(@NonNull WorkRequest workRequest) {
