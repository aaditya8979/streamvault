...
public class Processor implements ExecutionListener, ForegroundProcessor {
    ...
    public static class FutureListener implements Runnable {
        ...
        @NonNull
        private i<Boolean> mFuture;

        @NonNull
        private final WorkGenerationalId mWorkGenerationalId;

        public FutureListener(@NonNull ExecutionListener executionListener, @NonNull WorkGenerationalId workGenerationalId, @NonNull i<Boolean> iVar) {
    ...
    private void runOnExecuted(@NonNull final WorkGenerationalId workGenerationalId, final boolean z10) {
        this.mWorkTaskExecutor.getMainThreadExecutor().execute(new Runnable() { // from class: androidx.work.impl.b
            @Override // java.lang.Runnable
            public final void run() {
                this.f5145b.lambda$runOnExecuted$1(workGenerationalId, z10);
            }
        });
    }
    ...
    public void lambda$runOnExecuted$1(@NonNull WorkGenerationalId workGenerationalId, boolean z10) {
        synchronized (this.mLock) {
            ...
            Logger.get().debug(TAG, getClass().getSimpleName() + Z7.f30794r + workGenerationalId.getWorkSpecId() + " executed; reschedule = " + z10);
            Iterator<ExecutionListener> it = this.mOuterListeners.iterator();
            while (it.hasNext()) {
                it.next().lambda$runOnExecuted$1(workGenerationalId, z10);
            }
        }
    }
    ...
    public boolean startWork(@NonNull StartStopToken startStopToken, @Nullable WorkerParameters.RuntimeExtras runtimeExtras) {
        ...
        WorkSpec workSpec = (WorkSpec) this.mWorkDatabase.runInTransaction(new Callable() { // from class: androidx.work.impl.a
            ...
            public final Object call() {
                return this.f5142b.lambda$startWork$0(arrayList, workSpecId);
            }
        });
        if (workSpec == null) {
        ...
        synchronized (this.mLock) {
            ...
            i<Boolean> future = workerWrapperBuild.getFuture();
