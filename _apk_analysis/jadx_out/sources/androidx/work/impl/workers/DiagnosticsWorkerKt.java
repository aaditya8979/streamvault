...
public final class DiagnosticsWorkerKt {
    ...
    static {
        ...
        p.j(strTagWithPrefix, "tagWithPrefix(\"DiagnosticsWrkr\")");
    ...
    public static final String workSpecRows(WorkNameDao workNameDao, WorkTagDao workTagDao, SystemIdInfoDao systemIdInfoDao, List<WorkSpec> list) {
        ...
        for (WorkSpec workSpec : list) {
            ...
            sb2.append(workSpecRow(workSpec, f0.D0(workNameDao.getNamesForWorkSpecId(workSpec.id), StringUtils.COMMA, null, null, 0, null, null, 62, null), systemIdInfo != null ? Integer.valueOf(systemIdInfo.systemId) : null, f0.D0(workTagDao.getTagsForWorkSpecId(workSpec.id), StringUtils.COMMA, null, null, 0, null, null, 62, null)));
        }
