...
abstract class ConstraintProxy extends BroadcastReceiver {
    ...
    public static void updateAll(Context context, List<WorkSpec> list) {
        ...
        while (it.hasNext()) {
            ...
            z10 |= constraints.getRequiredNetworkType() != NetworkType.NOT_REQUIRED;
            if (requiresBatteryNotLow && requiresCharging && requiresStorageNotLow && z10) {
                break;
            }
        }
        context.sendBroadcast(ConstraintProxyUpdateReceiver.newConstraintProxyUpdateIntent(context, requiresBatteryNotLow, requiresCharging, requiresStorageNotLow, z10));
    }
