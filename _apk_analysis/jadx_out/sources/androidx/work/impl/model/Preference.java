...
public final /* data */ class Preference {
    ...
    public Preference(@NotNull String str, @Nullable Long l10) {
        p.k(str, "key");
        this.key = str;
        this.value = l10;
    }
    ...
    public Preference(@NotNull String str, boolean z10) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return p.f(this.key, preference.key) && p.f(this.value, preference.value);
    }
