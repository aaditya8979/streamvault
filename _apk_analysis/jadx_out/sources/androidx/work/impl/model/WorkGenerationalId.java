...
public final /* data */ class WorkGenerationalId {
    ...
    public WorkGenerationalId(@NotNull String str, int i10) {
        p.k(str, "workSpecId");
        this.workSpecId = str;
        this.generation = i10;
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return p.f(this.workSpecId, workGenerationalId.workSpecId) && this.generation == workGenerationalId.generation;
    }
