...
public class TransitionManager {
    ...
    public static void beginDelayedTransition(@NonNull ViewGroup viewGroup, @Nullable Transition transition) {
        ...
        Transition transitionMo4112clone = transition.mo4112clone();
        sceneChangeSetup(viewGroup, transitionMo4112clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo4112clone);
    }
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo4112clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo4112clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo4112clone);
    }
