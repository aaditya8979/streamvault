...
public class TransitionSet extends Transition {
    ...
    public Transition mo4112clone() {
        TransitionSet transitionSet = (TransitionSet) super.mo4112clone();
        transitionSet.mTransitions = new ArrayList<>();
        int size = this.mTransitions.size();
        for (int i10 = 0; i10 < size; i10++) {
            transitionSet.addTransitionInternal(this.mTransitions.get(i10).mo4112clone());
        }
