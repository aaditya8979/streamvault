...
public class ChangeBounds extends Transition {
    ...
    private static final Property<View, PointF> POSITION_PROPERTY = new Property<View, PointF>(PointF.class, C3978d4.i.L) { // from class: androidx.transition.ChangeBounds.6
        @Override // android.util.Property
    ...
    public Animator createAnimator(@NonNull final ViewGroup viewGroup, @Nullable TransitionValues transitionValues, @Nullable TransitionValues transitionValues2) {
        ...
        if (this.mResizeClip) {
            ...
            ObjectAnimator objectAnimatorOfPointF = (i14 == i15 && i16 == i17) ? null : ObjectAnimatorUtils.ofPointF(view, POSITION_PROPERTY, getPathMotion().getPath(i14, i16, i15, i17));
            if (rect4 == null) {
                i11 = 0;
