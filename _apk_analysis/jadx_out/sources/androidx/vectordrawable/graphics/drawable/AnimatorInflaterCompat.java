...
public class AnimatorInflaterCompat {
    ...
    */
    ...
    private static PropertyValuesHolder getPVH(TypedArray typedArray, int i10, int i11, int i12, String str) {
        ...
        if (i10 != 2) {
            ...
            if (z12) {
                ...
                if (z11) {
                    propertyValuesHolderOfInt = PropertyValuesHolder.ofInt(str, dimension2, i14 == 5 ? (int) typedArray.getDimension(i12, 0.0f) : isColorType(i14) ? typedArray.getColor(i12, 0) : typedArray.getInt(i12, 0));
                } else {
                    propertyValuesHolderOfInt = PropertyValuesHolder.ofInt(str, dimension2);
                }
            } else if (z11) {
                propertyValuesHolderOfInt = PropertyValuesHolder.ofInt(str, i14 == 5 ? (int) typedArray.getDimension(i12, 0.0f) : isColorType(i14) ? typedArray.getColor(i12, 0) : typedArray.getInt(i12, 0));
            }
        ...
        try {
            try {
                try {
                    ...
                    return createAnimatorFromXml(context, resources, theme, animation, f10);
    ...
    private static Keyframe loadKeyframe(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i10, XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        ...
        Keyframe keyframeOfInt = z10 ? i10 != 0 ? (i10 == 1 || i10 == 3) ? Keyframe.ofInt(namedFloat, TypedArrayUtils.getNamedInt(typedArrayObtainAttributes, xmlPullParser, "value", 0, 0)) : null : Keyframe.ofFloat(namedFloat, TypedArrayUtils.getNamedFloat(typedArrayObtainAttributes, xmlPullParser, "value", 0, 0.0f)) : i10 == 0 ? Keyframe.ofFloat(namedFloat) : Keyframe.ofInt(namedFloat);
