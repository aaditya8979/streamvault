...
public class LinearSystem {
    ...
    private SolverVariable createVariable(String str, SolverVariable.Type type) {
        ...
        this.mNumColumns++;
        solverVariableAcquireSolverVariable.f4175id = i10;
    ...
    private int enforceBFS(Row row) throws Exception {
        ...
        while (!z11) {
            ...
            for (int i15 = 0; i15 < this.mNumRows; i15++) {
                ArrayRow arrayRow2 = this.mRows[i15];
    ...
    private String getDisplayStrength(int i10) {
        return i10 == 1 ? "LOW" : i10 == 2 ? "MEDIUM" : i10 == 3 ? "HIGH" : i10 == 4 ? "HIGHEST" : i10 == 5 ? "EQUALITY" : i10 == 8 ? "FIXED" : i10 == 6 ? "BARRIER" : Constraint.NONE;
    }
    ...
    private final int optimize(Row row, boolean z10) {
        ...
        while (!z11) {
            ...
            if (row.getKey() != null) {
                this.mAlreadyTestedCandidates[row.getKey().f4175id] = true;
            }
            SolverVariable pivotCandidate = row.getPivotCandidate(this, this.mAlreadyTestedCandidates);
            if (pivotCandidate != null) {
                boolean[] zArr = this.mAlreadyTestedCandidates;
                int i12 = pivotCandidate.f4175id;
                if (zArr[i12]) {
                    return i11;
                }
                zArr[i12] = true;
    ...
    */
    ...
    public void addEquality(SolverVariable solverVariable, int i10) {
        if (USE_BASIC_SYNONYMS && solverVariable.definitionId == -1) {
            ...
            for (int i11 = 0; i11 < this.mVariablesID + 1; i11++) {
                ...
                if (solverVariable2 != null && solverVariable2.isSynonym && solverVariable2.synonym == solverVariable.f4175id) {
    ...
    public SolverVariable createErrorVariable(int i10, String str) {
        ...
        this.mNumColumns++;
        solverVariableAcquireSolverVariable.f4175id = i11;
    ...
    public SolverVariable createObjectVariable(Object obj) {
        ...
        if (obj instanceof ConstraintAnchor) {
            ...
            int i10 = solverVariable.f4175id;
    ...
    public void displayReadableRows() {
        ...
        for (int i11 = 0; i11 < this.mVariablesID + 1; i11++) {
            ...
            if (solverVariable2 != null && solverVariable2.isSynonym) {
                str2 = str2 + " ~[" + i11 + "] => " + solverVariable2 + " = " + solverVariableArr[solverVariable2.synonym] + " + " + solverVariable2.synonymDelta + "\n";
            }
        }
        String str3 = str2 + "\n\n #  ";
