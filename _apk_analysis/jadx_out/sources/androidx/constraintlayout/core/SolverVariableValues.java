...
public class SolverVariableValues implements ArrayRow.ArrayRowVariables {
    ...
    private void addToHashMap(SolverVariable solverVariable, int i10) {
        int[] iArr;
        int i11 = solverVariable.f4175id % this.HASH_SIZE;
        int[] iArr2 = this.keys;
        int i12 = iArr2[i11];
        if (i12 == -1) {
            iArr2[i11] = i10;
    ...
    private void addVariable(int i10, SolverVariable solverVariable, float f10) {
        this.variables[i10] = solverVariable.f4175id;
        this.values[i10] = f10;
        this.previous[i10] = -1;
        this.next[i10] = -1;
    ...
    private void displayHash() {
        for (int i10 = 0; i10 < this.HASH_SIZE; i10++) {
            if (this.keys[i10] != -1) {
                ...
                boolean z10 = false;
                while (!z10) {
                    str = str + Z7.f30794r + this.variables[i11];
    ...
    private void removeFromHashMap(SolverVariable solverVariable) {
        int[] iArr;
        int i10;
        int i11 = solverVariable.f4175id;
    ...
    public String toString() {
        ...
        for (int i11 = 0; i11 < i10; i11++) {
            SolverVariable variable = getVariable(i11);
            if (variable != null) {
                String str2 = str + variable + " = " + getVariableValue(i11) + Z7.f30794r;
                ...
                str = (this.next[iIndexOf] != -1 ? str4 + this.mCache.mIndexedVariables[this.variables[this.next[iIndexOf]]] : str4 + "none") + C3978d4.j.f31385e;
            }
        }
        return str + " }";
    }
