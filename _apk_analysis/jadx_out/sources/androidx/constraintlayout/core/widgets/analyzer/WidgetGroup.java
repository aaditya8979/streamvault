...
public class WidgetGroup {
    ...
    public class MeasureResult {
        ...
        public MeasureResult(ConstraintWidget constraintWidget, LinearSystem linearSystem, int i10) {
            ...
            this.f4194top = linearSystem.getObjectVariableValue(constraintWidget.mTop);
        ...
        public void apply() {
            ...
            if (constraintWidget != null) {
                constraintWidget.setFinalFrame(this.left, this.f4194top, this.right, this.bottom, this.baseline, this.orientation);
            }
        }
    }
    ...
    public void cleanup(ArrayList<WidgetGroup> arrayList) {
        ...
        if (this.moveTo != -1 && size > 0) {
            for (int i10 = 0; i10 < arrayList.size(); i10++) {
                ...
                if (this.moveTo == widgetGroup.f4193id) {
    ...
    public void moveTo(int i10, WidgetGroup widgetGroup) {
        ...
        this.moveTo = widgetGroup.f4193id;
    }
    ...
    public String toString() {
        String str = getOrientationString() + " [" + this.f4193id + "] <";
        Iterator<ConstraintWidget> it = this.widgets.iterator();
        while (it.hasNext()) {
            str = str + Z7.f30794r + it.next().getDebugName();
        }
        return str + " >";
    }
}
