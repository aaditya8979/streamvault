...
public class MotionWidget implements TypedValues {
    ...
    public int getHeight() {
        ...
        return widgetFrame.bottom - widgetFrame.f4189top;
    }
    ...
    public int getTop() {
        return this.widgetFrame.f4189top;
    }
    ...
    public String toString() {
        return this.widgetFrame.left + ", " + this.widgetFrame.f4189top + ", " + this.widgetFrame.right + ", " + this.widgetFrame.bottom;
    }
}
