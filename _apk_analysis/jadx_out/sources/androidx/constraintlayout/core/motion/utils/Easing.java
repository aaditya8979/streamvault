...
public class Easing {
    ...
    public static class CubicEasing extends Easing {
        ...
        public double f4180x1;

        /* JADX INFO: renamed from: x2, reason: collision with root package name */
        public double f4181x2;

        /* JADX INFO: renamed from: y1, reason: collision with root package name */
        public double f4182y1;

        /* JADX INFO: renamed from: y2, reason: collision with root package name */
        public double f4183y2;
        ...
        public CubicEasing(String str) {
            ...
            this.f4180x1 = Double.parseDouble(str.substring(iIndexOf + 1, iIndexOf2).trim());
            int i10 = iIndexOf2 + 1;
            int iIndexOf3 = str.indexOf(44, i10);
            this.f4182y1 = Double.parseDouble(str.substring(i10, iIndexOf3).trim());
            int i11 = iIndexOf3 + 1;
            int iIndexOf4 = str.indexOf(44, i11);
            this.f4181x2 = Double.parseDouble(str.substring(i11, iIndexOf4).trim());
            int i12 = iIndexOf4 + 1;
            this.f4183y2 = Double.parseDouble(str.substring(i12, str.indexOf(41, i12)).trim());
        }

        private double getDiffX(double d10) {
            double d11 = 1.0d - d10;
            double d12 = this.f4180x1;
            double d13 = this.f4181x2;
            return (d11 * 3.0d * d11 * d12) + (d11 * 6.0d * d10 * (d13 - d12)) + (3.0d * d10 * d10 * (1.0d - d13));
        }

        private double getDiffY(double d10) {
            double d11 = 1.0d - d10;
            double d12 = this.f4182y1;
            double d13 = this.f4183y2;
            return (d11 * 3.0d * d11 * d12) + (d11 * 6.0d * d10 * (d13 - d12)) + (3.0d * d10 * d10 * (1.0d - d13));
        }
        ...
        private double getX(double d10) {
            double d11 = 1.0d - d10;
            double d12 = 3.0d * d11;
            return (this.f4180x1 * d11 * d12 * d10) + (this.f4181x2 * d12 * d10 * d10) + (d10 * d10 * d10);
        }

        private double getY(double d10) {
            double d11 = 1.0d - d10;
            double d12 = 3.0d * d11;
            return (this.f4182y1 * d11 * d12 * d10) + (this.f4183y2 * d12 * d10 * d10) + (d10 * d10 * d10);
        }
