...
class MotionConstrainedPoint implements Comparable<MotionConstrainedPoint> {
    ...
    public void different(MotionConstrainedPoint motionConstrainedPoint, boolean[] zArr, String[] strArr) {
        ...
        zArr[1] = zArr[1] | diff(this.f4176x, motionConstrainedPoint.f4176x);
        zArr[2] = zArr[2] | diff(this.f4177y, motionConstrainedPoint.f4177y);
    ...
    public void fillStandard(double[] dArr, int[] iArr) {
        float[] fArr = {this.position, this.f4176x, this.f4177y, this.width, this.height, this.alpha, this.elevation, this.rotation, this.rotationX, this.rotationY, this.scaleX, this.scaleY, this.mPivotX, this.mPivotY, this.translationX, this.translationY, this.translationZ, this.mPathRotate};
        int i10 = 0;
        for (int i11 : iArr) {
            if (i11 < 18) {
                dArr[i10] = fArr[r4];
    ...
    public void setState(Rect rect, MotionWidget motionWidget, int i10, float f10) {
        setBounds(rect.left, rect.f4185top, rect.width(), rect.height());
        applyParameters(motionWidget);
