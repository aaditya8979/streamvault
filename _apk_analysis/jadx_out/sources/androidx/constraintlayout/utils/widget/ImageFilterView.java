...
public class ImageFilterView extends AppCompatImageView {
    ...
    public static class ImageMatrix {
        ...
        public float[] f4204m = new float[20];
        ...
        public void updateMatrix(ImageView imageView) {
            ...
            if (f10 != 1.0f) {
                saturation(f10);
                this.mColorMatrix.set(this.f4204m);
                z10 = true;
            } else {
                z10 = false;
            }
            ...
            if (f12 != 1.0f) {
                warmth(f12);
                this.mTmpColorMatrix.set(this.f4204m);
                this.mColorMatrix.postConcat(this.mTmpColorMatrix);
                z10 = true;
            }
    ...
    public void setAltImageResource(int i10) {
        Drawable drawableMutate = AppCompatResources.getDrawable(getContext(), i10).mutate();
