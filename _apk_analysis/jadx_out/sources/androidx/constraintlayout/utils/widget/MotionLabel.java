...
public class MotionLabel extends View implements FloatLayout {
    ...
    private void setTypefaceFromAttrs(String str, int i10, int i11) {
        ...
        if (i11 <= 0) {
            ...
            this.mPaint.setFakeBoldText((i12 & 1) != 0);
            this.mPaint.setTextSkewX((i12 & 2) != 0 ? -0.25f : 0.0f);
        }
    }
    ...
    public void buildShape(float f10) {
    ...
    public void layout(float f10, float f11, float f12, float f13) {
        ...
        if (this.mAutoSize) {
            ...
            if (fWidth * f17 > fHeight * f16) {
                this.mPaint.setTextSize((this.paintTextSize * f16) / fWidth);
            } else {
                this.mPaint.setTextSize((this.paintTextSize * f17) / fHeight);
            }
    ...
    public void setTextSize(float f10) {
        this.mTextSize = f10;
        Log.v(TAG, Debug.getLoc() + "  " + f10 + " / " + this.mBaseTextSize);
        TextPaint textPaint = this.mPaint;
