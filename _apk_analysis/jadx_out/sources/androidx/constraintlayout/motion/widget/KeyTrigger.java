    ...
    private void fire(String str, View view) {
        ...
        if (method == null) {
            try {
                ...
                Log.e("KeyTrigger", "Could not find method \"" + str + "\"on class " + view.getClass().getSimpleName() + Z7.f30794r + Debug.getName(view));
                return;
            }
        }
        try {
            ...
            Log.e("KeyTrigger", "Exception in call \"" + this.mCross + "\"on class " + view.getClass().getSimpleName() + Z7.f30794r + Debug.getName(view));
        }
    }
