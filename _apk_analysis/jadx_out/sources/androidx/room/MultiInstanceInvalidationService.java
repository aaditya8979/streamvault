...
public final class MultiInstanceInvalidationService extends Service {
    ...
    private final RemoteCallbackList<IMultiInstanceInvalidationCallback> callbackList = new RemoteCallbackList<IMultiInstanceInvalidationCallback>() { // from class: androidx.room.MultiInstanceInvalidationService$callbackList$1
        ...
        public void onCallbackDied(@NotNull IMultiInstanceInvalidationCallback iMultiInstanceInvalidationCallback, @NotNull Object obj) {
            tn.p.k(iMultiInstanceInvalidationCallback, "callback");
            tn.p.k(obj, "cookie");
    ...
    private final IMultiInstanceInvalidationService.Stub binder = new IMultiInstanceInvalidationService.Stub() { // from class: androidx.room.MultiInstanceInvalidationService$binder$1
            ...
            synchronized (callbackList$room_runtime_release) {
                ...
                for (int i10 = 0; i10 < iBeginBroadcast; i10++) {
                    try {
                        ...
                        tn.p.i(broadcastCookie, "null cannot be cast to non-null type kotlin.Int");
                        ...
                        if (clientId != iIntValue && tn.p.f(str, str2)) {
                            try {
                                ((IMultiInstanceInvalidationCallback) multiInstanceInvalidationService.getCallbackList$room_runtime_release().getBroadcastItem(i10)).onInvalidation(tables);
        ...
        @Override // androidx.room.IMultiInstanceInvalidationService
        public void unregisterCallback(@NotNull IMultiInstanceInvalidationCallback iMultiInstanceInvalidationCallback, int i10) {
            tn.p.k(iMultiInstanceInvalidationCallback, "callback");
            RemoteCallbackList<IMultiInstanceInvalidationCallback> callbackList$room_runtime_release = this.this$0.getCallbackList$room_runtime_release();
            MultiInstanceInvalidationService multiInstanceInvalidationService = this.this$0;
            synchronized (callbackList$room_runtime_release) {
