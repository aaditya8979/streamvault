...
final class AdapterHelper implements OpReorderer.Callback {
    ...
    public static final class UpdateOp {
        ...
        public String cmdToString() {
            int i10 = this.cmd;
            return i10 != 1 ? i10 != 2 ? i10 != 4 ? i10 != 8 ? "??" : "mv" : "up" : "rm" : ImpressionLog.f51742l;
        }
        ...
        public String toString() {
            return Integer.toHexString(System.identityHashCode(this)) + C3978d4.j.f31383d + cmdToString() + ",s:" + this.positionStart + "c:" + this.itemCount + ",p:" + this.payload + C3978d4.j.f31385e;
        }
    }
    ...
    private void dispatchAndUpdateViewHolders(UpdateOp updateOp) {
        ...
        for (int i15 = 1; i15 < updateOp.itemCount; i15++) {
            int iUpdatePositionWithPostponed2 = updatePositionWithPostponed(updateOp.positionStart + (i10 * i15), updateOp.cmd);
