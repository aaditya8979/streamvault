...
public final class AviExtractor implements Extractor {
    ...
    @Nullable
    private ChunkReader getChunkReader(int i10) {
    ...
    private void parseHdrlBody(ParsableByteArray parsableByteArray) throws IOException {
        ...
        r2<AviChunk> it = from.children.iterator();
        int i10 = 0;
        while (it.hasNext()) {
            AviChunk next = it.next();
            if (next.getType() == 1819440243) {
                int i11 = i10 + 1;
                ChunkReader chunkReaderProcessStreamList = processStreamList((ListChunk) next, i10);
    ...
    @Nullable
    private ChunkReader processStreamList(ListChunk listChunk, int i10) {
        ...
        ChunkReader chunkReader = new ChunkReader(i10, trackType, durationUs, aviStreamHeaderChunk.length, trackOutputTrack);
