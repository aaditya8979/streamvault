...
public final class TextInformationFrame extends Id3Frame {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Util.areEqual(this.f5015id, textInformationFrame.f5015id) && Util.areEqual(this.description, textInformationFrame.description) && this.values.equals(textInformationFrame.values);
    }
    ...
    public String toString() {
        return this.f5015id + ": description=" + this.description + ": values=" + this.values;
    }
