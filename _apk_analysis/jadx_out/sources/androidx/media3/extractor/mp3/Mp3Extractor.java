...
public final class Mp3Extractor implements Extractor {
    ...
    private Seeker computeSeeker(ExtractorInput extractorInput) throws IOException {
        ...
        if ((this.flags & 4) != 0) {
            if (mlltSeekerMaybeHandleSeekMetadata != null) {
                ...
                j10 = -1;
                seekerMaybeReadSeekFrame = new IndexSeeker(id3TlenUs, extractorInput.getPosition(), j10);
            }
            j10 = dataEndPosition;
    ...
    private Seeker getConstantBitrateSeeker(long j10, XingFrame xingFrame, long j11) {
        ...
        long j16 = j12;
        return new ConstantBitrateSeeker(j13, j10 + ((long) xingFrame.header.frameSize), Ints.d(Util.scaleLargeValue(j16, 8000000L, jComputeDurationUs, RoundingMode.HALF_UP)), Ints.d(e.b(j16, xingFrame.frameCount, RoundingMode.HALF_UP)), false);
    }
    ...
    private Seeker getConstantBitrateSeeker(ExtractorInput extractorInput, boolean z10) throws IOException {
        ...
        return new ConstantBitrateSeeker(extractorInput.getLength(), extractorInput.getPosition(), this.synchronizedHeader, z10);
    }
    ...
    private static long getId3TlenUs(@Nullable Metadata metadata) {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            ...
            if (entry instanceof TextInformationFrame) {
                ...
                if (textInformationFrame.f5015id.equals("TLEN")) {
