...
final class TtmlRenderUtil {
    ...
    public static void applyStylesToSpan(Spannable spannable, int i10, int i11, TtmlStyle ttmlStyle, @Nullable TtmlNode ttmlNode, Map<String, TtmlStyle> map, int i12) {
