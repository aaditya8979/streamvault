...
final class TtmlNode {
    ...
    private TtmlNode(@Nullable String str, @Nullable String str2, long j10, long j11, @Nullable TtmlStyle ttmlStyle, @Nullable String[] strArr, String str3, @Nullable String str4, @Nullable TtmlNode ttmlNode) {
        this.tag = str;
        this.text = str2;
        this.imageId = str4;
    ...
    public static TtmlNode buildNode(@Nullable String str, long j10, long j11, @Nullable TtmlStyle ttmlStyle, @Nullable String[] strArr, String str2, @Nullable String str3, @Nullable TtmlNode ttmlNode) {
