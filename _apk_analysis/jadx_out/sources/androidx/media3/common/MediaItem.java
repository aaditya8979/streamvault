...
public final class MediaItem {
    ...
    public static final class LocalConfiguration {
        ...
        public static LocalConfiguration fromBundle(Bundle bundle) {
            ...
            ImmutableList immutableListOf = parcelableArrayList == null ? ImmutableList.of() : BundleCollectionUtil.fromBundleList(new y7.e() { // from class: androidx.media3.common.i
                @Override // y7.e
            ...
            return new LocalConfiguration((Uri) Assertions.checkNotNull((Uri) bundle.getParcelable(FIELD_URI)), bundle.getString(FIELD_MIME_TYPE), drmConfigurationFromBundle, adsConfigurationFromBundle, immutableListOf, bundle.getString(FIELD_CUSTOM_CACHE_KEY), parcelableArrayList2 == null ? ImmutableList.of() : BundleCollectionUtil.fromBundleList(new y7.e() { // from class: androidx.media3.common.j
                @Override // y7.e
                public final Object apply(Object obj) {
        ...
        public Bundle toBundle() {
            ...
            if (!this.streamKeys.isEmpty()) {
                bundle.putParcelableArrayList(FIELD_STREAM_KEYS, BundleCollectionUtil.toBundleArrayList(this.streamKeys, new y7.e() { // from class: androidx.media3.common.g
                    @Override // y7.e
                    public final Object apply(Object obj) {
            ...
            if (!this.subtitleConfigurations.isEmpty()) {
                bundle.putParcelableArrayList(FIELD_SUBTITLE_CONFIGURATION, BundleCollectionUtil.toBundleArrayList(this.subtitleConfigurations, new y7.e() { // from class: androidx.media3.common.h
                    @Override // y7.e
                    public final Object apply(Object obj) {
    ...
    public static class SubtitleConfiguration {
        ...
        public static final class Builder {
            ...
            private Builder(SubtitleConfiguration subtitleConfiguration) {
                ...
                this.f4350id = subtitleConfiguration.f4349id;
            }
