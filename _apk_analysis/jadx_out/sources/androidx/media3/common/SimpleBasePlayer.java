...
public abstract class SimpleBasePlayer extends BasePlayer {
    ...
    public interface PositionSupplier {
        ...
        static PositionSupplier getConstant(final long j10) {
            return new PositionSupplier() { // from class: androidx.media3.common.z1
        ...
        static PositionSupplier getExtrapolating(final long j10, final float f10) {
            ...
            return new PositionSupplier() { // from class: androidx.media3.common.y1
                @Override // androidx.media3.common.SimpleBasePlayer.PositionSupplier
                public final long get() {
    ...
    public SimpleBasePlayer(Looper looper, Clock clock) {
        ...
        this.listeners = new ListenerSet<>(looper, clock, new ListenerSet.IterationFinishedEvent() { // from class: androidx.media3.common.g1
            @Override // androidx.media3.common.util.ListenerSet.IterationFinishedEvent
            public final void invoke(Object obj, FlagSet flagSet) {
                this.f4371a.lambda$new$0((Player.Listener) obj, flagSet);
            }
        });
    }
    ...
    private void clearVideoOutput(@Nullable Object obj) {
        ...
        if (shouldHandleCommand(27)) {
            updateStateForPendingOperation(handleClearVideoOutput(obj), new y7.p() { // from class: androidx.media3.common.l1
                @Override // y7.p
    ...
    private void setMediaItemsInternal(final List<MediaItem> list, final int i10, final long j10) {
        ...
        if (shouldHandleCommand(20) || (list.size() == 1 && shouldHandleCommand(31))) {
            updateStateForPendingOperation(handleSetMediaItems(list, i10, j10), new y7.p() { // from class: androidx.media3.common.v1
                @Override // y7.p
                public final Object get() {
                    return this.f4453b.lambda$setMediaItemsInternal$2(list, state, i10, j10);
                }
            });
        }
    }
    ...
    private void updateStateAndInformListeners(final State state, boolean z10, boolean z11) {
        ...
        if (positionDiscontinuityReason != -1) {
            ...
            this.listeners.queueEvent(11, new ListenerSet.Event() { // from class: androidx.media3.common.c0
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (mediaItemTransitionReason != i10) {
            ...
            this.listeners.queueEvent(1, new ListenerSet.Event() { // from class: androidx.media3.common.o0
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!Util.areEqual(state2.playerError, state.playerError)) {
            this.listeners.queueEvent(10, new ListenerSet.Event() { // from class: androidx.media3.common.q0
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
            ...
            if (state.playerError != null) {
                this.listeners.queueEvent(10, new ListenerSet.Event() { // from class: androidx.media3.common.r0
                    @Override // androidx.media3.common.util.ListenerSet.Event
                    public final void invoke(Object obj) {
        ...
        if (!state2.trackSelectionParameters.equals(state.trackSelectionParameters)) {
            this.listeners.queueEvent(19, new ListenerSet.Event() { // from class: androidx.media3.common.t0
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!currentTracksInternal.equals(currentTracksInternal2)) {
            this.listeners.queueEvent(2, new ListenerSet.Event() { // from class: androidx.media3.common.u0
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!mediaMetadataInternal.equals(mediaMetadataInternal2)) {
            this.listeners.queueEvent(14, new ListenerSet.Event() { // from class: androidx.media3.common.v0
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (state2.isLoading != state.isLoading) {
            this.listeners.queueEvent(3, new ListenerSet.Event() { // from class: androidx.media3.common.w0
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (z12 || z13) {
            this.listeners.queueEvent(-1, new ListenerSet.Event() { // from class: androidx.media3.common.x0
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (z13) {
            this.listeners.queueEvent(4, new ListenerSet.Event() { // from class: androidx.media3.common.q
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (z12 || state2.playWhenReadyChangeReason != state.playWhenReadyChangeReason) {
            this.listeners.queueEvent(5, new ListenerSet.Event() { // from class: androidx.media3.common.s
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (state2.playbackSuppressionReason != state.playbackSuppressionReason) {
            this.listeners.queueEvent(6, new ListenerSet.Event() { // from class: androidx.media3.common.t
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (isPlaying(state2) != isPlaying(state)) {
            this.listeners.queueEvent(7, new ListenerSet.Event() { // from class: androidx.media3.common.u
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!state2.playbackParameters.equals(state.playbackParameters)) {
            this.listeners.queueEvent(12, new ListenerSet.Event() { // from class: androidx.media3.common.v
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (state2.repeatMode != state.repeatMode) {
            this.listeners.queueEvent(8, new ListenerSet.Event() { // from class: androidx.media3.common.x
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (state2.shuffleModeEnabled != state.shuffleModeEnabled) {
            this.listeners.queueEvent(9, new ListenerSet.Event() { // from class: androidx.media3.common.y
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (state2.seekBackIncrementMs != state.seekBackIncrementMs) {
            this.listeners.queueEvent(16, new ListenerSet.Event() { // from class: androidx.media3.common.z
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (state2.seekForwardIncrementMs != state.seekForwardIncrementMs) {
            this.listeners.queueEvent(17, new ListenerSet.Event() { // from class: androidx.media3.common.a0
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (state2.maxSeekToPreviousPositionMs != state.maxSeekToPreviousPositionMs) {
            this.listeners.queueEvent(18, new ListenerSet.Event() { // from class: androidx.media3.common.b0
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!state2.audioAttributes.equals(state.audioAttributes)) {
            this.listeners.queueEvent(20, new ListenerSet.Event() { // from class: androidx.media3.common.d0
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!state2.videoSize.equals(state.videoSize)) {
            this.listeners.queueEvent(25, new ListenerSet.Event() { // from class: androidx.media3.common.e0
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!state2.deviceInfo.equals(state.deviceInfo)) {
            this.listeners.queueEvent(29, new ListenerSet.Event() { // from class: androidx.media3.common.f0
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!state2.playlistMetadata.equals(state.playlistMetadata)) {
            this.listeners.queueEvent(15, new ListenerSet.Event() { // from class: androidx.media3.common.g0
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (state.newlyRenderedFirstFrame) {
            this.listeners.queueEvent(26, new i0());
        }
        if (!state2.surfaceSize.equals(state.surfaceSize)) {
            this.listeners.queueEvent(24, new ListenerSet.Event() { // from class: androidx.media3.common.j0
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (state2.volume != state.volume) {
            this.listeners.queueEvent(22, new ListenerSet.Event() { // from class: androidx.media3.common.k0
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (state2.deviceVolume != state.deviceVolume || state2.isDeviceMuted != state.isDeviceMuted) {
            this.listeners.queueEvent(30, new ListenerSet.Event() { // from class: androidx.media3.common.l0
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!state2.currentCues.equals(state.currentCues)) {
            this.listeners.queueEvent(27, new ListenerSet.Event() { // from class: androidx.media3.common.m0
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!state2.timedMetadata.equals(state.timedMetadata) && state.timedMetadata.presentationTimeUs != -9223372036854775807L) {
            this.listeners.queueEvent(28, new ListenerSet.Event() { // from class: androidx.media3.common.n0
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!state2.availableCommands.equals(state.availableCommands)) {
            this.listeners.queueEvent(13, new ListenerSet.Event() { // from class: androidx.media3.common.p0
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
    ...
    private void updateStateForPendingOperation(final c8.i<?> iVar, y7.p<State> pVar, boolean z10, boolean z11) {
        ...
        iVar.addListener(new Runnable() { // from class: androidx.media3.common.e1
            @Override // java.lang.Runnable
            public final void run() {
                this.f4366b.lambda$updateStateForPendingOperation$62(iVar);
            }
        }, new Executor() { // from class: androidx.media3.common.f1
            @Override // java.util.concurrent.Executor
            public final void execute(Runnable runnable) {
                this.f4369b.postOrRunOnApplicationHandler(runnable);
            }
        });
    }
    ...
    public final void addMediaItems(int i10, final List<MediaItem> list) {
        ...
        updateStateForPendingOperation(handleAddMediaItems(iMin, list), new y7.p() { // from class: androidx.media3.common.p1
            @Override // y7.p
            public final Object get() {
                return this.f4406b.lambda$addMediaItems$3(state, list, iMin);
            }
        });
    }
    ...
    public final void decreaseDeviceVolume() {
        ...
        if (shouldHandleCommand(26)) {
            updateStateForPendingOperation(handleDecreaseDeviceVolume(1), new y7.p() { // from class: androidx.media3.common.i1
                @Override // y7.p
                public final Object get() {
    ...
    public final void decreaseDeviceVolume(int i10) {
        ...
        if (shouldHandleCommand(34)) {
            updateStateForPendingOperation(handleDecreaseDeviceVolume(i10), new y7.p() { // from class: androidx.media3.common.d1
                @Override // y7.p
                public final Object get() {
    ...
    public c8.i<?> handleReplaceMediaItems(int i10, int i11, List<MediaItem> list) {
        ...
        return Util.transformFutureAsync(iVarHandleAddMediaItems, new c8.b() { // from class: androidx.media3.common.c1
            @Override // c8.b
    ...
    public final void increaseDeviceVolume() {
        ...
        final State state = this.state;
        if (shouldHandleCommand(26)) {
            updateStateForPendingOperation(handleIncreaseDeviceVolume(1), new y7.p() { // from class: androidx.media3.common.o1
                @Override // y7.p
                public final Object get() {
    ...
    public final void increaseDeviceVolume(int i10) {
        ...
        final State state = this.state;
        if (shouldHandleCommand(34)) {
            updateStateForPendingOperation(handleIncreaseDeviceVolume(i10), new y7.p() { // from class: androidx.media3.common.l
                @Override // y7.p
                public final Object get() {
    ...
    public final void moveMediaItems(final int i10, int i11, int i12) {
        ...
        updateStateForPendingOperation(handleMoveMediaItems(i10, iMin, iMin2), new y7.p() { // from class: androidx.media3.common.k1
            @Override // y7.p
            public final Object get() {
                return this.f4382b.lambda$moveMediaItems$4(state, i10, iMin, iMin2);
            }
        });
    }
    ...
    public final void prepare() {
        ...
        if (shouldHandleCommand(2)) {
            updateStateForPendingOperation(handlePrepare(), new y7.p() { // from class: androidx.media3.common.m1
                @Override // y7.p
                public final Object get() {
    ...
    public final void release() {
        ...
        if (shouldHandleCommand(32)) {
            updateStateForPendingOperation(handleRelease(), new y7.p() { // from class: androidx.media3.common.n1
                @Override // y7.p
                public final Object get() {
    ...
    public final void removeMediaItems(final int i10, int i11) {
        ...
        updateStateForPendingOperation(handleRemoveMediaItems(i10, iMin), new y7.p() { // from class: androidx.media3.common.q1
            @Override // y7.p
            public final Object get() {
                return this.f4412b.lambda$removeMediaItems$6(state, i10, iMin);
            }
        });
    }
    ...
    public final void replaceMediaItems(final int i10, int i11, final List<MediaItem> list) {
        ...
        final int iMin = Math.min(i11, size);
        updateStateForPendingOperation(handleReplaceMediaItems(i10, iMin, list), new y7.p() { // from class: androidx.media3.common.s0
            @Override // y7.p
            public final Object get() {
                return this.f4420b.lambda$replaceMediaItems$5(state, list, iMin, i10);
            }
        });
    }
    ...
    public final void seekTo(final int i10, final long j10, int i11, boolean z10) {
        ...
        if (shouldHandleCommand(i11)) {
            ...
            updateStateForPendingOperation(handleSeek(i10, j10, i11), new y7.p() { // from class: androidx.media3.common.w
                @Override // y7.p
                public final Object get() {
    ...
    public final void setAudioAttributes(final AudioAttributes audioAttributes, boolean z10) {
        ...
        if (shouldHandleCommand(35)) {
            updateStateForPendingOperation(handleSetAudioAttributes(audioAttributes, z10), new y7.p() { // from class: androidx.media3.common.m
                @Override // y7.p
                public final Object get() {
    ...
    public final void setDeviceMuted(final boolean z10) {
        ...
        final State state = this.state;
        if (shouldHandleCommand(26)) {
            updateStateForPendingOperation(handleSetDeviceMuted(z10, 1), new y7.p() { // from class: androidx.media3.common.a1
                @Override // y7.p
                public final Object get() {
    ...
    public final void setDeviceMuted(final boolean z10, int i10) {
        ...
        final State state = this.state;
        if (shouldHandleCommand(34)) {
            updateStateForPendingOperation(handleSetDeviceMuted(z10, i10), new y7.p() { // from class: androidx.media3.common.j1
                @Override // y7.p
                public final Object get() {
    ...
    public final void setDeviceVolume(final int i10) {
        ...
        if (shouldHandleCommand(25)) {
            updateStateForPendingOperation(handleSetDeviceVolume(i10, 1), new y7.p() { // from class: androidx.media3.common.k
                @Override // y7.p
                public final Object get() {
    ...
    public final void setDeviceVolume(final int i10, int i11) {
        ...
        if (shouldHandleCommand(33)) {
            updateStateForPendingOperation(handleSetDeviceVolume(i10, i11), new y7.p() { // from class: androidx.media3.common.u1
                @Override // y7.p
                public final Object get() {
    ...
    public final void setPlayWhenReady(final boolean z10) {
        ...
        if (shouldHandleCommand(1)) {
            updateStateForPendingOperation(handleSetPlayWhenReady(z10), new y7.p() { // from class: androidx.media3.common.z0
                @Override // y7.p
                public final Object get() {
    ...
    public final void setPlaybackParameters(final PlaybackParameters playbackParameters) {
        ...
        if (shouldHandleCommand(13)) {
            updateStateForPendingOperation(handleSetPlaybackParameters(playbackParameters), new y7.p() { // from class: androidx.media3.common.x1
                @Override // y7.p
                public final Object get() {
    ...
    public final void setPlaylistMetadata(final MediaMetadata mediaMetadata) {
        ...
        if (shouldHandleCommand(19)) {
            updateStateForPendingOperation(handleSetPlaylistMetadata(mediaMetadata), new y7.p() { // from class: androidx.media3.common.o
                @Override // y7.p
                public final Object get() {
    ...
    public final void setRepeatMode(final int i10) {
        ...
        if (shouldHandleCommand(15)) {
            updateStateForPendingOperation(handleSetRepeatMode(i10), new y7.p() { // from class: androidx.media3.common.b1
                @Override // y7.p
                public final Object get() {
    ...
    public final void setShuffleModeEnabled(final boolean z10) {
        ...
        if (shouldHandleCommand(14)) {
            updateStateForPendingOperation(handleSetShuffleModeEnabled(z10), new y7.p() { // from class: androidx.media3.common.s1
                @Override // y7.p
                public final Object get() {
    ...
    public final void setTrackSelectionParameters(final TrackSelectionParameters trackSelectionParameters) {
        ...
        if (shouldHandleCommand(29)) {
            updateStateForPendingOperation(handleSetTrackSelectionParameters(trackSelectionParameters), new y7.p() { // from class: androidx.media3.common.t1
                @Override // y7.p
                public final Object get() {
    ...
    public final void setVideoSurface(@Nullable Surface surface) {
        ...
        if (shouldHandleCommand(27)) {
            if (surface == null) {
                ...
                updateStateForPendingOperation(handleSetVideoOutput(surface), new y7.p() { // from class: androidx.media3.common.w1
                    @Override // y7.p
                    public final Object get() {
    ...
    public final void setVideoSurfaceHolder(@Nullable final SurfaceHolder surfaceHolder) {
        ...
        if (shouldHandleCommand(27)) {
            if (surfaceHolder == null) {
                ...
                updateStateForPendingOperation(handleSetVideoOutput(surfaceHolder), new y7.p() { // from class: androidx.media3.common.n
                    @Override // y7.p
                    public final Object get() {
    ...
    public final void setVideoSurfaceView(@Nullable final SurfaceView surfaceView) {
        ...
        if (shouldHandleCommand(27)) {
            if (surfaceView == null) {
                ...
                updateStateForPendingOperation(handleSetVideoOutput(surfaceView), new y7.p() { // from class: androidx.media3.common.r1
                    @Override // y7.p
                    public final Object get() {
    ...
    public final void setVideoTextureView(@Nullable TextureView textureView) {
        ...
        if (shouldHandleCommand(27)) {
            if (textureView == null) {
                ...
                updateStateForPendingOperation(handleSetVideoOutput(textureView), new y7.p() { // from class: androidx.media3.common.y0
                    @Override // y7.p
                    public final Object get() {
    ...
    public final void setVolume(final float f10) {
        ...
        if (shouldHandleCommand(24)) {
            updateStateForPendingOperation(handleSetVolume(f10), new y7.p() { // from class: androidx.media3.common.h1
                @Override // y7.p
                public final Object get() {
    ...
    public final void stop() {
        ...
        if (shouldHandleCommand(3)) {
            updateStateForPendingOperation(handleStop(), new y7.p() { // from class: androidx.media3.common.h0
                @Override // y7.p
                public final Object get() {
