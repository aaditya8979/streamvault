...
public final class CueGroup {
    ...
    public Bundle toBundle() {
        ...
        bundle.putParcelableArrayList(FIELD_CUES, BundleCollectionUtil.toBundleArrayList(filterOutBitmapCues(this.cues), new e() { // from class: androidx.media3.common.text.a
            @Override // y7.e
