...
public interface Player {
    ...
    public static final class PositionInfo {
        ...
        public static PositionInfo fromBundle(Bundle bundle) {
            ...
            return new PositionInfo(null, i10, bundle2 == null ? null : MediaItem.fromBundle(bundle2), null, bundle.getInt(FIELD_PERIOD_INDEX, 0), bundle.getLong(FIELD_POSITION_MS, 0L), bundle.getLong(FIELD_CONTENT_POSITION_MS, 0L), bundle.getInt(FIELD_AD_GROUP_INDEX, -1), bundle.getInt(FIELD_AD_INDEX_IN_AD_GROUP, -1));
        }
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            return equalsForBundling(positionInfo) && y7.i.a(this.windowUid, positionInfo.windowUid) && y7.i.a(this.periodUid, positionInfo.periodUid);
        }

        @UnstableApi
        public boolean equalsForBundling(PositionInfo positionInfo) {
            return this.mediaItemIndex == positionInfo.mediaItemIndex && this.periodIndex == positionInfo.periodIndex && this.positionMs == positionInfo.positionMs && this.contentPositionMs == positionInfo.contentPositionMs && this.adGroupIndex == positionInfo.adGroupIndex && this.adIndexInAdGroup == positionInfo.adIndexInAdGroup && y7.i.a(this.mediaItem, positionInfo.mediaItem);
        }

        @UnstableApi
        public PositionInfo filterByAvailableCommands(boolean z10, boolean z11) {
            if (z10 && z11) {
                return this;
            }
            return new PositionInfo(this.windowUid, z11 ? this.mediaItemIndex : 0, z10 ? this.mediaItem : null, this.periodUid, z11 ? this.periodIndex : 0, z10 ? this.positionMs : 0L, z10 ? this.contentPositionMs : 0L, z10 ? this.adGroupIndex : -1, z10 ? this.adIndexInAdGroup : -1);
        }

        public int hashCode() {
            return y7.i.b(this.windowUid, Integer.valueOf(this.mediaItemIndex), this.mediaItem, this.periodUid, Integer.valueOf(this.periodIndex), Long.valueOf(this.positionMs), Long.valueOf(this.contentPositionMs), Integer.valueOf(this.adGroupIndex), Integer.valueOf(this.adIndexInAdGroup));
        }
