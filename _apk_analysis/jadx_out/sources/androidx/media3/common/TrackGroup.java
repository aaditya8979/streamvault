...
public final class TrackGroup {
    ...
    public static TrackGroup fromBundle(Bundle bundle) {
        ...
        return new TrackGroup(bundle.getString(FIELD_ID, ""), (Format[]) (parcelableArrayList == null ? ImmutableList.of() : BundleCollectionUtil.fromBundleList(new y7.e() { // from class: androidx.media3.common.c2
            @Override // y7.e
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return this.f4352id.equals(trackGroup.f4352id) && Arrays.equals(this.formats, trackGroup.formats);
    }
    ...
    public int hashCode() {
        if (this.hashCode == 0) {
            this.hashCode = ((IronSourceError.ERROR_NON_EXISTENT_INSTANCE + this.f4352id.hashCode()) * 31) + Arrays.hashCode(this.formats);
        }
    ...
    public Bundle toBundle() {
        ...
        bundle.putString(FIELD_ID, this.f4352id);
        return bundle;
    }
}
