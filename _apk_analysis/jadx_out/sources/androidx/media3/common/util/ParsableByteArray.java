...
public final class ParsableByteArray {
    ...
    private static final ImmutableSet<Charset> SUPPORTED_CHARSETS_FOR_READLINE = ImmutableSet.of(y7.c.f87335a, y7.c.f87337c, y7.c.f87340f, y7.c.f87338d, y7.c.f87339e);
    private byte[] data;
    private int limit;
    ...
    private int findNextLineTerminator(Charset charset) {
        int i10;
        if (charset.equals(y7.c.f87337c) || charset.equals(y7.c.f87335a)) {
            i10 = 1;
        } else {
            if (!charset.equals(y7.c.f87340f) && !charset.equals(y7.c.f87339e) && !charset.equals(y7.c.f87338d)) {
        ...
        while (true) {
            ...
            if ((charset.equals(y7.c.f87337c) || charset.equals(y7.c.f87335a)) && Util.isLinebreak(this.data[i11])) {
                return i11;
            }
            if (charset.equals(y7.c.f87340f) || charset.equals(y7.c.f87338d)) {
                byte[] bArr = this.data;
                if (bArr[i11] == 0 && Util.isLinebreak(bArr[i11 + 1])) {
                    return i11;
                }
            }
            if (charset.equals(y7.c.f87339e)) {
    ...
    private int peekCharacterAndSize(Charset charset) {
        ...
        char c10;
        int i10 = 2;
        if ((charset.equals(y7.c.f87337c) || charset.equals(y7.c.f87335a)) && bytesLeft() >= 1) {
            bA = (byte) b8.b.a(b8.g.b(this.data[this.position]));
            i10 = 1;
        } else {
            if ((charset.equals(y7.c.f87340f) || charset.equals(y7.c.f87338d)) && bytesLeft() >= 2) {
                byte[] bArr = this.data;
                int i11 = this.position;
                c10 = b8.b.c(bArr[i11], bArr[i11 + 1]);
            } else {
                if (!charset.equals(y7.c.f87339e) || bytesLeft() < 2) {
                    return 0;
                }
                byte[] bArr2 = this.data;
                int i12 = this.position;
                c10 = b8.b.c(bArr2[i12 + 1], bArr2[i12]);
            }
            bA = (byte) c10;
        }
        return (b8.b.a(bA) << 16) + i10;
    }
    ...
    public String readLine(Charset charset) {
        ...
        if (!charset.equals(y7.c.f87335a)) {
    ...
    public String readString(int i10) {
        return readString(i10, y7.c.f87337c);
    }
