...
public abstract class Timeline {
    ...
    public static final class Period {
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            return Util.areEqual(this.f4351id, period.f4351id) && Util.areEqual(this.uid, period.uid) && this.windowIndex == period.windowIndex && this.durationUs == period.durationUs && this.positionInWindowUs == period.positionInWindowUs && this.isPlaceholder == period.isPlaceholder && Util.areEqual(this.adPlaybackState, period.adPlaybackState);
        }
    ...
    public static final class RemotableTimeline extends Timeline {
        ...
        public Period getPeriod(int i10, Period period, boolean z10) {
            ...
            period.set(period2.f4351id, period2.uid, period2.windowIndex, period2.durationUs, period2.positionInWindowUs, period2.adPlaybackState, period2.isPlaceholder);
            return period;
        }
    ...
    public static Timeline fromBundle(Bundle bundle) {
        ImmutableList immutableListFromBundleListRetriever = fromBundleListRetriever(new y7.e() { // from class: androidx.media3.common.a2
            @Override // y7.e
            public final Object apply(Object obj) {
                return Timeline.Window.fromBundle((Bundle) obj);
            }
        }, bundle.getBinder(FIELD_WINDOWS));
        ImmutableList immutableListFromBundleListRetriever2 = fromBundleListRetriever(new y7.e() { // from class: androidx.media3.common.b2
            @Override // y7.e
            public final Object apply(Object obj) {
