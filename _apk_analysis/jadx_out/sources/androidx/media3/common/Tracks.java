...
public final class Tracks {
    ...
    public static Tracks fromBundle(Bundle bundle) {
        ...
        return new Tracks(parcelableArrayList == null ? ImmutableList.of() : BundleCollectionUtil.fromBundleList(new y7.e() { // from class: androidx.media3.common.g2
            @Override // y7.e
    ...
    public Bundle toBundle() {
        Bundle bundle = new Bundle();
        bundle.putParcelableArrayList(FIELD_TRACK_GROUPS, BundleCollectionUtil.toBundleArrayList(this.groups, new y7.e() { // from class: androidx.media3.common.f2
            @Override // y7.e
            public final Object apply(Object obj) {
