...
public final class SimpleCache implements Cache {
    ...
    private void loadDirectory(File file, boolean z10, @Nullable File[] fileArr, @Nullable Map<String, CacheFileMetadata> map) {
        ...
        for (File file2 : fileArr) {
            ...
            } else if (!z10 || (!CachedContentIndex.isIndexFile(name) && !name.endsWith(UID_FILE_SUFFIX))) {
                long j10 = -1;
    ...
    private SimpleCacheSpan touchSpan(String str, SimpleCacheSpan simpleCacheSpan) {
        ...
        SimpleCacheSpan lastTouchTimestamp = ((CachedContent) Assertions.checkNotNull(this.contentIndex.get(str))).setLastTouchTimestamp(simpleCacheSpan, jCurrentTimeMillis, z10);
    ...
    */
    public synchronized boolean isCached(java.lang.String r4, long r5, long r7) {
        ...
        La:
            ...
            androidx.media3.datasource.cache.CachedContentIndex r0 = r3.contentIndex     // Catch: java.lang.Throwable -> L21
            androidx.media3.datasource.cache.CachedContent r4 = r0.get(r4)     // Catch: java.lang.Throwable -> L21
            if (r4 == 0) goto L1e
    ...
    public synchronized File startFile(String str, long j10, long j11) throws Cache.CacheException {
        ...
        return SimpleCacheSpan.getCacheFile(file, cachedContent.f4481id, j10, System.currentTimeMillis());
    }
