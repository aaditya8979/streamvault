...
public final class SntpClient {
    ...
    public static long getElapsedRealtimeOffsetMs() {
        ...
        synchronized (valueLock) {
            j10 = isInitialized ? elapsedRealtimeOffsetMs : -9223372036854775807L;
        }
        return j10;
    }
    ...
    public static long loadNtpTimeOffsetMs() throws IOException {
        ...
        try {
            ...
            checkValidServerReply((byte) ((b10 >> 6) & 3), (byte) (b10 & 7), i10, timestamp3);
            long j11 = (j10 + (((timestamp2 - timestamp) + (timestamp3 - j10)) / 2)) - jElapsedRealtime2;
    ...
    private static long readTimestamp(byte[] bArr, int i10) {
        ...
        return ((j10 - OFFSET_1900_TO_1970) * 1000) + ((j11 * 1000) / 4294967296L);
    }
