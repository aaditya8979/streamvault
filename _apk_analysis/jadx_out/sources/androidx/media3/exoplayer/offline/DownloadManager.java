...
public final class DownloadManager {
    ...
    public static final class InternalHandler extends Handler {
        ...
        private void addDownload(DownloadRequest downloadRequest, int i10) {
            Download download = getDownload(downloadRequest.f4810id, true);
        ...
        private int getDownloadIndex(String str) {
            for (int i10 = 0; i10 < this.downloads.size(); i10++) {
                if (this.downloads.get(i10).request.f4810id.equals(str)) {
                    return i10;
                }
            }
            return -1;
        ...
        private void onContentLengthChanged(Task task, long j10) {
            Download download = (Download) Assertions.checkNotNull(getDownload(task.request.f4810id, false));
        ...
        private void onDownloadTaskStopped(Download download, @Nullable Exception exc) {
            ...
            this.downloads.remove(getDownloadIndex(download2.request.f4810id));
            try {
        ...
        private void onRemoveTaskStopped(Download download) {
            if (download.state == 7) {
                ...
                this.downloads.remove(getDownloadIndex(download.request.f4810id));
                try {
                    this.downloadIndex.removeDownload(download.request.f4810id);
        ...
        private void onTaskStopped(Task task) {
            String str = task.request.f4810id;
        ...
        private Download putDownload(Download download) {
            ...
            int downloadIndex = getDownloadIndex(download.request.f4810id);
            if (downloadIndex == -1) {
        ...
        private void removeAllDownloads() {
            ...
            for (int i12 = 0; i12 < this.downloads.size(); i12++) {
                this.mainHandler.obtainMessage(3, new DownloadUpdate(this.downloads.get(i12), false, arrayList3, null)).sendToTarget();
            }
            syncTasks();
        }
        ...
        private Task syncQueuedDownload(@Nullable Task task, Download download) {
            ...
            this.activeTasks.put(downloadPutDownloadWithState.request.f4810id, task2);
        ...
        private void syncRemovingDownload(@Nullable Task task, Download download) {
            if (task != null) {
                ...
                this.activeTasks.put(download.request.f4810id, task2);
        ...
        private void syncTasks() {
            ...
            for (int i11 = 0; i11 < this.downloads.size(); i11++) {
                ...
                Task taskSyncQueuedDownload = this.activeTasks.get(download.request.f4810id);
                ...
                if (i12 == 0) {
                    ...
                    syncDownloadingDownload(taskSyncQueuedDownload, download, i10);
                } else {
                    if (i12 != 5 && i12 != 7) {
                        throw new IllegalStateException();
                    }
    ...
    public DownloadManager(Context context, WritableDownloadIndex writableDownloadIndex, DownloaderFactory downloaderFactory) {
        ...
        Handler handlerCreateHandlerForCurrentOrMainLooper = Util.createHandlerForCurrentOrMainLooper(new Handler.Callback() { // from class: androidx.media3.exoplayer.offline.i
            @Override // android.os.Handler.Callback
            public final boolean handleMessage(Message message) {
                return this.f4819b.handleMainMessage(message);
            }
        });
        ...
        RequirementsWatcher.Listener listener = new RequirementsWatcher.Listener() { // from class: androidx.media3.exoplayer.offline.j
            ...
            public final void onRequirementsStateChanged(RequirementsWatcher requirementsWatcher, int i10) {
                this.f4820a.onRequirementsStateChanged(requirementsWatcher, i10);
            }
        };
