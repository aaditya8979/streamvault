...
public abstract class DownloadService extends Service {
    ...
    public static final class DownloadManagerHelper implements DownloadManager.Listener {
        ...
        public void attachService(final DownloadService downloadService) {
            ...
            if (this.downloadManager.isInitialized()) {
                Util.createHandlerForCurrentOrMainLooper().postAtFrontOfQueue(new Runnable() { // from class: androidx.media3.exoplayer.offline.l
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f4821b.lambda$attachService$0(downloadService);
                    }
                });
            }
        }
    ...
    public final class ForegroundNotificationUpdater {
        ...
        public void update() {
            ...
            if (this.periodicUpdatesStarted) {
                ...
                this.handler.postDelayed(new Runnable() { // from class: androidx.media3.exoplayer.offline.m
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f4823b.update();
                    }
    ...
    public void onCreate() {
        ...
        if (downloadManagerHelper == null) {
            ...
            downloadManagerHelper = new DownloadManagerHelper(getApplicationContext(), downloadManager, z10, scheduler, cls);
