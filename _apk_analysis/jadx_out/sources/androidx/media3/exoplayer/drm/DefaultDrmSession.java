...
class DefaultDrmSession implements DrmSession {
    ...
    private void onError(final Throwable th2, int i10) {
        ...
        if (th2 instanceof Exception) {
            dispatchEvent(new Consumer() { // from class: androidx.media3.exoplayer.drm.a
                @Override // androidx.media3.common.util.Consumer
                public final void accept(Object obj) {
    ...
    */
    ...
    private void postKeyRequest(byte[] bArr, int i10, boolean z10) {
        try {
            ...
            ((RequestHandler) Util.castNonNull(this.requestHandler)).post(2, Assertions.checkNotNull(this.currentKeyRequest), z10);
        } catch (Exception | NoSuchMethodError e10) {
            onKeysError(e10, true);
        }
    }
