...
public class DashManifest implements FilterableManifest<DashManifest> {
    ...
    private static ArrayList<AdaptationSet> copyAdaptationSets(List<AdaptationSet> list, LinkedList<StreamKey> linkedList) {
        ...
        do {
            ...
            arrayList.add(new AdaptationSet(adaptationSet.f4711id, adaptationSet.type, arrayList2, adaptationSet.accessibilityDescriptors, adaptationSet.essentialProperties, adaptationSet.supplementalProperties));
    ...
    public final DashManifest copy(List<StreamKey> list) {
        ...
        while (true) {
            ...
            if (((StreamKey) linkedList.peek()).periodIndex != i10) {
                ...
                arrayList.add(new Period(period.f4713id, period.startMs - j10, copyAdaptationSets(period.adaptationSets, linkedList), period.eventStreams));
            }
            i10++;
        }
