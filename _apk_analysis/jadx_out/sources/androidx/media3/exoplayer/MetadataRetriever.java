...
public final class MetadataRetriever {
    ...
    public static final class MetadataRetrieverInternal {
        ...
        private final com.google.common.util.concurrent.d<TrackGroupArray> trackGroupsFuture;
            ...
            public final class MediaSourceCaller implements MediaSource.MediaSourceCaller {
                ...
                public final class MediaPeriodCallback implements MediaPeriod.Callback {
                    ...
                    public void onPrepared(MediaPeriod mediaPeriod) {
                        MetadataRetrieverInternal.this.trackGroupsFuture.D(mediaPeriod.getTrackGroups());
            ...
            public boolean handleMessage(Message message) {
                ...
                if (i10 == 2) {
                    try {
                        ...
                        MetadataRetrieverInternal.this.trackGroupsFuture.E(e10);
                        MetadataRetrieverInternal.this.mediaSourceHandler.obtainMessage(4).sendToTarget();
                    }
                    return true;
                }
        ...
        public MetadataRetrieverInternal(MediaSource.Factory factory, Clock clock) {
            ...
            this.trackGroupsFuture = com.google.common.util.concurrent.d.I();
        }

        public c8.i<TrackGroupArray> retrieveMetadata(MediaItem mediaItem) {
    ...
    public static c8.i<TrackGroupArray> retrieveMetadata(Context context, MediaItem mediaItem) {
        return retrieveMetadata(context, mediaItem, Clock.DEFAULT);
    }

    @VisibleForTesting
    public static c8.i<TrackGroupArray> retrieveMetadata(Context context, MediaItem mediaItem, Clock clock) {
    ...
    public static c8.i<TrackGroupArray> retrieveMetadata(MediaSource.Factory factory, MediaItem mediaItem) {
        return retrieveMetadata(factory, mediaItem, Clock.DEFAULT);
    }

    private static c8.i<TrackGroupArray> retrieveMetadata(MediaSource.Factory factory, MediaItem mediaItem, Clock clock) {
