...
public final class ConcatenatingMediaSource2 extends CompositeMediaSource<Integer> {
    ...
    private ConcatenatedTimeline maybeCreateConcatenatedTimeline() {
        ...
        long j14 = 0;
        while (i11 < size) {
            MediaSourceHolder mediaSourceHolder2 = concatenatingMediaSource2.mediaSourceHolders.get(i11);
            ...
            while (i12 < timeline.getWindowCount()) {
                ...
                if (j15 == -9223372036854775807L) {
                    j15 = mediaSourceHolder3.initialPlaceholderDurationUs;
                    if (j15 == -9223372036854775807L) {
                        return null;
                    }
                }
                j12 += j15;
                if (mediaSourceHolder3.index == 0 && i12 == 0) {
                    z11 = z10;
                    obj = obj2;
                ...
                while (i13 <= window2.lastPeriodIndex) {
                    ...
                    Object obj3 = obj;
                    if (!(i13 == window2.firstPeriodIndex && !(mediaSourceHolder3.index == 0 && i12 == 0)) || j16 == -9223372036854775807L) {
                        i10 = size;
                        j10 = j15;
                        j11 = 0;
                    } else {
                    ...
                    if (mediaSourceHolder3.activeMediaPeriods == 0 || !mediaSourceHolder3.periodTimeOffsetsByUid.containsKey(objCheckNotNull)) {
                        ...
                        window = window2;
                        if (!mediaSourceHolder3.periodTimeOffsetsByUid.get(objCheckNotNull).equals(Long.valueOf(j11))) {
                            z12 = false;
                        }
                        Assertions.checkArgument(z12, "Can't handle windows with changing offset in first period.");
                        mediaSourceHolder3.periodTimeOffsetsByUid.put(objCheckNotNull, Long.valueOf(j11));
                        j14 += j16;
                        i13++;
                        periodCount = i14;
                        obj = obj3;
        ...
        return new ConcatenatedTimeline(getMediaItem(), aVarBuilder.m(), aVarBuilder2.m(), aVarBuilder3.m(), z14, z16, j12, j13, z13 ? obj2 : null);
    }
    ...
    public void prepareSourceInternal(@Nullable TransferListener transferListener) {
        ...
        this.playbackThreadHandler = new Handler(new Handler.Callback() { // from class: androidx.media3.exoplayer.source.d
            ...
            public final boolean handleMessage(Message message) {
                return this.f4859b.handleMessage(message);
            }
        });
        for (int i10 = 0; i10 < this.mediaSourceHolders.size(); i10++) {
