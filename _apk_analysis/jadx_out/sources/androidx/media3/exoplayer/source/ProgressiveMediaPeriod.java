...
final class ProgressiveMediaPeriod implements MediaPeriod, ExtractorOutput, Loader.Callback<ExtractingLoadable>, Loader.ReleaseCallback, SampleQueue.UpstreamFormatChangedListener {
    ...
    private final Runnable maybeFinishPrepareRunnable = new Runnable() { // from class: androidx.media3.exoplayer.source.s
        @Override // java.lang.Runnable
        public final void run() {
            this.f4909b.maybeFinishPrepare();
        }
    };
    private final Runnable onContinueLoadingRequestedRunnable = new Runnable() { // from class: androidx.media3.exoplayer.source.t
        @Override // java.lang.Runnable
        public final void run() {
            this.f4910b.lambda$new$0();
        }
    };
    ...
    public static final class TrackId {
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            return this.f4839id == trackId.f4839id && this.isIcyTrack == trackId.isIcyTrack;
        }

        public int hashCode() {
            return (this.f4839id * 31) + (this.isIcyTrack ? 1 : 0);
        }
    }
    ...
    public void onLengthKnown() {
        this.handler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.u
            @Override // java.lang.Runnable
            public final void run() {
                this.f4911b.lambda$onLengthKnown$2();
            }
        });
    }
    ...
    private TrackOutput prepareTrackOutput(TrackId trackId) {
        ...
        if (this.sampleQueuesBuilt) {
            Log.w(TAG, "Extractor added new track (id=" + trackId.f4839id + ") after finishing tracks.");
    ...
    public Loader.LoadErrorAction onLoadError(ExtractingLoadable extractingLoadable, long j10, long j11, IOException iOException, int i10) {
        ...
        if (retryDelayMsFor == -9223372036854775807L) {
            ...
            loadErrorActionCreateRetryAction = configureRetry(extractingLoadable2, extractedSamplesCount) ? Loader.createRetryAction(z10, retryDelayMsFor) : Loader.DONT_RETRY;
        }
    ...
    public void seekMap(final SeekMap seekMap) {
        this.handler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.v
            @Override // java.lang.Runnable
            public final void run() {
                this.f4912b.lambda$seekMap$1(seekMap);
            }
        });
    }
