...
public final class AdsMediaSource extends CompositeMediaSource<MediaSource.MediaPeriodId> {
    ...
    public final class AdMediaSourceHolder {
        ...
        private final MediaSource.MediaPeriodId f4840id;
        private Timeline timeline;

        public AdMediaSourceHolder(MediaSource.MediaPeriodId mediaPeriodId) {
            this.f4840id = mediaPeriodId;
        }
        ...
        public void handleSourceInfoRefresh(Timeline timeline) {
            ...
            if (this.timeline == null) {
                ...
                for (int i10 = 0; i10 < this.activeMediaPeriods.size(); i10++) {
                    ...
                    maskingMediaPeriod.createPeriod(new MediaSource.MediaPeriodId(uidOfPeriod, maskingMediaPeriod.f4838id.windowSequenceNumber));
                }
            }
        ...
        public void initializeWithMediaSource(MediaSource mediaSource, MediaItem mediaItem) {
            ...
            AdsMediaSource.this.prepareChildSource(this.f4840id, mediaSource);
        }
        ...
        public void release() {
            if (hasMediaSource()) {
                AdsMediaSource.this.releaseChildSource(this.f4840id);
            }
        }
    ...
    public final class AdPrepareListener implements MaskingMediaPeriod.PrepareListener {
        ...
        public void onPrepareComplete(final MediaSource.MediaPeriodId mediaPeriodId) {
            AdsMediaSource.this.mainHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.ads.c
                ...
                public final void run() {
                    this.f4845b.lambda$onPrepareComplete$0(mediaPeriodId);
                }
            });
        }
        ...
        public void onPrepareError(final MediaSource.MediaPeriodId mediaPeriodId, final IOException iOException) {
            ...
            AdsMediaSource.this.mainHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.ads.d
                @Override // java.lang.Runnable
                public final void run() {
                    this.f4847b.lambda$onPrepareError$1(mediaPeriodId, iOException);
                }
            });
        }
    }
    ...
    public final class ComponentListener implements AdsLoader.EventListener {
        ...
        public void onAdPlaybackState(final AdPlaybackState adPlaybackState) {
            ...
            this.playerHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.ads.e
                @Override // java.lang.Runnable
                public final void run() {
                    this.f4850b.lambda$onAdPlaybackState$0(adPlaybackState);
                }
            });
        }
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (i11 < adMediaSourceHolderArr2.length) {
                    ...
                    jArr[i10][i11] = adMediaSourceHolder == null ? -9223372036854775807L : adMediaSourceHolder.getDurationUs();
                    i11++;
                }
            }
            i10++;
    ...
    public void prepareSourceInternal(@Nullable TransferListener transferListener) {
        ...
        this.mainHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.ads.a
            @Override // java.lang.Runnable
            public final void run() {
                this.f4841b.lambda$prepareSourceInternal$0(componentListener);
            }
        });
    }
    ...
    public void releasePeriod(MediaPeriod mediaPeriod) {
        ...
        MediaSource.MediaPeriodId mediaPeriodId = maskingMediaPeriod.f4838id;
        if (!mediaPeriodId.isAd()) {
            maskingMediaPeriod.releasePeriod();
            return;
        }
    ...
    public void releaseSourceInternal() {
        ...
        this.mainHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.ads.b
            @Override // java.lang.Runnable
            public final void run() {
                this.f4843b.lambda$releaseSourceInternal$1(componentListener);
            }
        });
    }
