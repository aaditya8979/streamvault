...
public final class ServerSideAdInsertionMediaSource extends BaseMediaSource implements MediaSource.MediaSourceCaller, MediaSourceEventListener, DrmSessionEventListener {
    ...
    private final z1<Pair<Long, Object>, SharedMediaPeriod> mediaPeriods = ArrayListMultimap.create();
    ...
    public static final class ServerSideAdInsertionTimeline extends ForwardingTimeline {
        ...
        public Timeline.Period getPeriod(int i10, Timeline.Period period, boolean z10) {
            ...
            period.set(period.f4351id, period.uid, period.windowIndex, mediaPeriodPositionUsForContent, mediaPeriodPositionUsForContent2, adPlaybackState, period.isPlaceholder);
            return period;
        }
    ...
    public static final class SharedMediaPeriod implements MediaPeriod.Callback {
            ...
            loop0: while (true) {
                ...
                if (exoTrackSelection != null) {
                    ...
                    for (int i11 = 0; i11 < trackGroup.length; i11++) {
                        ...
                        if (format.equals(mediaLoadData.trackFormat) || (z10 && (str = format.f4347id) != null && str.equals(mediaLoadData.trackFormat.f4347id))) {
                            break loop0;
                        }
                    }
                }
        ...
        public boolean canReuseMediaPeriod(MediaSource.MediaPeriodId mediaPeriodId, long j10) {
            MediaPeriodImpl mediaPeriodImpl = (MediaPeriodImpl) y1.f(this.mediaPeriods);
    ...
    private MediaPeriodImpl getMediaPeriodForEvent(@Nullable MediaSource.MediaPeriodId mediaPeriodId, @Nullable MediaLoadData mediaLoadData, boolean z10) {
        ...
        if (z10) {
            SharedMediaPeriod sharedMediaPeriod = (SharedMediaPeriod) y1.f(list);
            return sharedMediaPeriod.loadingPeriod != null ? sharedMediaPeriod.loadingPeriod : (MediaPeriodImpl) y1.f(sharedMediaPeriod.mediaPeriods);
        }
    ...
    public MediaPeriod createPeriod(MediaSource.MediaPeriodId mediaPeriodId, Allocator allocator, long j10) {
        ...
        if (sharedMediaPeriod == null && ((sharedMediaPeriod = (SharedMediaPeriod) y1.g(this.mediaPeriods.get(pair), null)) == null || !sharedMediaPeriod.canReuseMediaPeriod(mediaPeriodId, j10))) {
            ...
            if (handler == null) {
                ...
                handler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.ads.f
                    ...
                    public final void run() {
                        this.f4852b.lambda$setAdPlaybackStates$0(immutableMap, timeline);
                    }
                });
            }
        }
