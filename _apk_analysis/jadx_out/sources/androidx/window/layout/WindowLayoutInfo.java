...
public final class WindowLayoutInfo {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (other == null || !p.f(WindowLayoutInfo.class, other.getClass())) {
            return false;
        }
        return p.f(this.displayFeatures, ((WindowLayoutInfo) other).displayFeatures);
    }
    ...
    public String toString() {
        return f0.D0(this.displayFeatures, ", ", "WindowLayoutInfo{ DisplayFeatures[", "] }", 0, null, null, 56, null);
    }
}
