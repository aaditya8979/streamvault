...
public final class HardwareFoldingFeature implements FoldingFeature {
    ...
    /* JADX INFO: compiled from: HardwareFoldingFeature.kt */
    @Metadata(bv = {}, d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\b\u0080\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\b\u0010\tJ\u0017\u0010\u0007\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002H\u0000¢\u0006\u0004\b\u0005\u0010\u0006¨\u0006\n"}, d2 = {"Landroidx/window/layout/HardwareFoldingFeature$Companion;", "", "Landroidx/window/core/Bounds;", "bounds", "Lbn/r;", "validateFeatureBounds$window_release", "(Landroidx/window/core/Bounds;)V", "validateFeatureBounds", "<init>", "()V", "window_release"}, k = 1, mv = {1, 6, 0})
    ...
    /* JADX INFO: compiled from: HardwareFoldingFeature.kt */
    @Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0004\b\u0000\u0018\u0000 \u00062\u00020\u0001:\u0001\u0006B\u000f\b\u0002\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\b\u0010\u0005\u001a\u00020\u0003H\u0016R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0007"}, d2 = {"Landroidx/window/layout/HardwareFoldingFeature$Type;", "", UnifiedMediationParams.KEY_DESCRIPTION, "", "(Ljava/lang/String;)V", "toString", VastTagName.COMPANION, "window_release"}, k = 1, mv = {1, 6, 0}, xi = 48)
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!p.f(HardwareFoldingFeature.class, other == null ? null : other.getClass())) {
            return false;
        }
        if (other == null) {
        ...
        return p.f(this.featureBounds, hardwareFoldingFeature.featureBounds) && p.f(this.type, hardwareFoldingFeature.type) && p.f(getState(), hardwareFoldingFeature.getState());
    }
    ...
    public boolean isSeparating() {
        ...
        if (p.f(type, companion.getHINGE())) {
            return true;
        }
        return p.f(this.type, companion.getFOLD()) && p.f(getState(), FoldingFeature.State.HALF_OPENED);
    }
