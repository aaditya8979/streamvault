...
public final class SplitInfo {
    ...
    public SplitInfo(@NotNull ActivityStack activityStack, @NotNull ActivityStack activityStack2, float f10) {
        p.k(activityStack, "primaryActivityStack");
        p.k(activityStack2, "secondaryActivityStack");
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (p.f(this.primaryActivityStack, splitInfo.primaryActivityStack) && p.f(this.secondaryActivityStack, splitInfo.secondaryActivityStack)) {
