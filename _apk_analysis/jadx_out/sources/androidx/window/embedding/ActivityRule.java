...
public final class ActivityRule extends EmbeddingRule {
    ...
    public ActivityRule(@NotNull Set<ActivityFilter> set, boolean z10) {
        p.k(set, "filters");
        this.alwaysExpand = z10;
        this.filters = f0.l1(set);
    }

    public /* synthetic */ ActivityRule(Set set, boolean z10, int i10, i iVar) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return p.f(this.filters, activityRule.filters) && this.alwaysExpand == activityRule.alwaysExpand;
    }
    ...
    public final ActivityRule plus$window_release(@NotNull ActivityFilter filter) {
        ...
        return new ActivityRule(f0.l1(linkedHashSet), this.alwaysExpand);
    }
}
