...
public final class ActivityFilter {
    ...
    public ActivityFilter(@NotNull ComponentName componentName, @Nullable String str) {
        ...
        p.j(packageName, "componentName.packageName");
        String className = componentName.getClassName();
        p.j(className, "componentName.className");
        boolean z10 = true;
        ...
        if (!(!d0.c0(packageName, "*", false, 2, null) || d0.r0(packageName, "*", 0, false, 6, null) == packageName.length() - 1)) {
            throw new IllegalArgumentException("Wildcard in package name is only allowed at the end.".toString());
        }
        if (d0.c0(className, "*", false, 2, null) && d0.r0(className, "*", 0, false, 6, null) != className.length() - 1) {
            z10 = false;
        }
        if (!z10) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return p.f(this.componentName, activityFilter.componentName) && p.f(this.intentAction, activityFilter.intentAction);
    }
    ...
    public final boolean matchesActivity(@NotNull Activity activity) {
        ...
        if (MatcherUtils.INSTANCE.areActivityOrIntentComponentsMatching$window_release(activity, this.componentName)) {
            ...
            if (str != null) {
                ...
                if (p.f(str, intent == null ? null : intent.getAction())) {
                }
            }
            return true;
        }
    ...
    public final boolean matchesIntent(@NotNull Intent intent) {
        ...
        String str = this.intentAction;
        return str == null || p.f(str, intent.getAction());
    }
