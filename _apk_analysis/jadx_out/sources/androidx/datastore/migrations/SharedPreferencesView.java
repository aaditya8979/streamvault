...
public final class SharedPreferencesView {
    ...
    private final String checkKey(String key) {
        ...
        throw new IllegalStateException(p.t("Can't access key outside migration: ", key).toString());
    }
