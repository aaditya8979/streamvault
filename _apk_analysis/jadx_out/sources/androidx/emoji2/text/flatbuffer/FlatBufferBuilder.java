...
public class FlatBufferBuilder {
    ...
    public FlatBufferBuilder(int i10, ByteBufferFactory byteBufferFactory, ByteBuffer byteBuffer, Utf8 utf8) {
        ...
        if (byteBuffer != null) {
            this.f4319bb = byteBuffer;
            byteBuffer.clear();
            this.f4319bb.order(ByteOrder.LITTLE_ENDIAN);
        } else {
            this.f4319bb = byteBufferFactory.newByteBuffer(i10);
        }
        this.utf8 = utf8;
        this.space = this.f4319bb.capacity();
    }
    ...
    public int createByteVector(ByteBuffer byteBuffer) {
        ...
        ByteBuffer byteBuffer2 = this.f4319bb;
        int i10 = this.space - iRemaining;
        this.space = i10;
        byteBuffer2.position(i10);
        this.f4319bb.put(byteBuffer);
        return endVector();
    }
    ...
    public int createByteVector(byte[] bArr) {
        ...
        ByteBuffer byteBuffer = this.f4319bb;
        int i10 = this.space - length;
        this.space = i10;
        byteBuffer.position(i10);
        this.f4319bb.put(bArr);
        return endVector();
    }
    ...
    public int createString(CharSequence charSequence) {
        ...
        this.space = i10;
        byteBuffer.position(i10);
        this.utf8.encodeUtf8(charSequence, this.f4319bb);
        return endVector();
    }
    ...
    public ByteBuffer createUnintializedVector(int i10, int i11, int i12) {
        ...
        ByteBuffer byteBufferOrder = this.f4319bb.slice().order(ByteOrder.LITTLE_ENDIAN);
    ...
    public int endTable() {
        ...
        loop2: while (true) {
            ...
            int iCapacity = this.f4319bb.capacity() - this.vtables[i14];
            int i15 = this.space;
            short s10 = this.f4319bb.getShort(iCapacity);
            if (s10 == this.f4319bb.getShort(i15)) {
                for (int i16 = 2; i16 < s10; i16 += 2) {
                    if (this.f4319bb.getShort(iCapacity + i16) != this.f4319bb.getShort(i15 + i16)) {
                        break;
                    }
                }
        ...
        if (i10 != 0) {
            int iCapacity2 = this.f4319bb.capacity() - iOffset;
            this.space = iCapacity2;
            this.f4319bb.putInt(iCapacity2, i10 - iOffset);
        } else {
    ...
    public void finish(int i10, boolean z10) {
        ...
        addOffset(i10);
        if (z10) {
            addInt(this.f4319bb.capacity() - this.space);
        }
        this.f4319bb.position(this.space);
        this.finished = true;
    }
    ...
    public int offset() {
        return this.f4319bb.capacity() - this.space;
    }
    ...
    public void required(int i10, int i11) {
        int iCapacity = this.f4319bb.capacity() - i10;
        if (this.f4319bb.getShort((iCapacity - this.f4319bb.getInt(iCapacity)) + i11) != 0) {
            return;
        }
    ...
    public byte[] sizedByteArray() {
        return sizedByteArray(this.space, this.f4319bb.capacity() - this.space);
    }

    public byte[] sizedByteArray(int i10, int i11) {
        finished();
        byte[] bArr = new byte[i11];
        this.f4319bb.position(i10);
        this.f4319bb.get(bArr);
        return bArr;
    }

    public InputStream sizedInputStream() {
        finished();
        ByteBuffer byteBufferDuplicate = this.f4319bb.duplicate();
        byteBufferDuplicate.position(this.space);
        byteBufferDuplicate.limit(this.f4319bb.capacity());
