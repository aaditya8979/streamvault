...
public final class AppBarConfiguration {
    ...
    public static final class Builder {
        ...
        public Builder(@NotNull int... iArr) {
            p.k(iArr, "topLevelDestinationIds");
            this.topLevelDestinations = new HashSet();
            for (int i10 : iArr) {
    ...
    public /* synthetic */ AppBarConfiguration(Set set, Openable openable, OnNavigateUpListener onNavigateUpListener, i iVar) {
