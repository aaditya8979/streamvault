...
public final class ActivityNavigatorDestinationBuilder extends NavDestinationBuilder<ActivityNavigator.Destination> {
    ...
    public ActivityNavigatorDestinationBuilder(@NotNull ActivityNavigator activityNavigator, @IdRes int i10) {
        super(activityNavigator, i10);
        p.k(activityNavigator, "navigator");
    ...
    public ActivityNavigator.Destination build() {
        ...
        if (kClass != null) {
            destination.setComponentName(new ComponentName(this.context, (Class<?>) rn.a.a(kClass)));
        }
