...
public abstract class AbstractResolvableFuture<V> implements i<V> {
    ...
    public static final boolean GENERATE_CANCELLATION_CAUSES = Boolean.parseBoolean(System.getProperty("guava.concurrent.generate_cancellation_cause", com.ironsource.mediationsdk.metadata.a.f32683h));
    ...
    public static final class SetFuture<V> implements Runnable {
        ...
        public SetFuture(AbstractResolvableFuture<V> abstractResolvableFuture, i<? extends V> iVar) {
    ...
    public static Object getFutureValue(i<?> iVar) {
        if (iVar instanceof AbstractResolvableFuture) {
            Object obj = ((AbstractResolvableFuture) iVar).value;
            if (!(obj instanceof Cancellation)) {
                return obj;
            }
