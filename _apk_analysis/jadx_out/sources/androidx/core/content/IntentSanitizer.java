...
public class IntentSanitizer {
    ...
    public static final class Builder {
        ...
        private boolean mAllowSourceBounds;
        private int mAllowedFlags;
        private Predicate<String> mAllowedActions = new Predicate() { // from class: androidx.core.content.w
            @Override // androidx.core.util.Predicate
            public final boolean test(Object obj) {
                return IntentSanitizer.Builder.lambda$new$0((String) obj);
            }
        };
        private Predicate<Uri> mAllowedData = new Predicate() { // from class: androidx.core.content.x
            @Override // androidx.core.util.Predicate
            public final boolean test(Object obj) {
                return IntentSanitizer.Builder.lambda$new$1((Uri) obj);
            }
        };
        private Predicate<String> mAllowedTypes = new Predicate() { // from class: androidx.core.content.y
            @Override // androidx.core.util.Predicate
            public final boolean test(Object obj) {
                return IntentSanitizer.Builder.lambda$new$2((String) obj);
            }
        };
        private Predicate<String> mAllowedCategories = new Predicate() { // from class: androidx.core.content.z
            @Override // androidx.core.util.Predicate
            public final boolean test(Object obj) {
                return IntentSanitizer.Builder.lambda$new$3((String) obj);
            }
        };
        private Predicate<String> mAllowedPackages = new Predicate() { // from class: androidx.core.content.a0
            @Override // androidx.core.util.Predicate
            public final boolean test(Object obj) {
                return IntentSanitizer.Builder.lambda$new$4((String) obj);
            }
        };
        private Predicate<ComponentName> mAllowedComponents = new Predicate() { // from class: androidx.core.content.b0
            @Override // androidx.core.util.Predicate
            public final boolean test(Object obj) {
        ...
        private Predicate<Uri> mAllowedClipDataUri = new Predicate() { // from class: androidx.core.content.c0
            @Override // androidx.core.util.Predicate
            public final boolean test(Object obj) {
                return IntentSanitizer.Builder.lambda$new$6((Uri) obj);
            }
        };
        private Predicate<ClipData> mAllowedClipData = new Predicate() { // from class: androidx.core.content.d0
            @Override // androidx.core.util.Predicate
            public final boolean test(Object obj) {
        ...
        public Builder allowAnyComponent() {
            ...
            this.mAllowedComponents = new Predicate() { // from class: androidx.core.content.p
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
        ...
        public Builder allowCategory(@NonNull String str) {
            Preconditions.checkNotNull(str);
            Objects.requireNonNull(str);
            return allowCategory(new n(str));
        }
        ...
        public Builder allowClipDataUriWithAuthority(@NonNull final String str) {
            Preconditions.checkNotNull(str);
            return allowClipDataUri(new Predicate() { // from class: androidx.core.content.m
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
        ...
        public Builder allowComponent(@NonNull final ComponentName componentName) {
            ...
            return allowComponent(new Predicate() { // from class: androidx.core.content.u
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
        ...
        public Builder allowComponentWithPackage(@NonNull final String str) {
            Preconditions.checkNotNull(str);
            return allowComponent(new Predicate() { // from class: androidx.core.content.r
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
        ...
        public Builder allowDataWithAuthority(@NonNull final String str) {
            Preconditions.checkNotNull(str);
            allowData(new Predicate() { // from class: androidx.core.content.s
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
        ...
        public Builder allowExtra(@NonNull String str, @NonNull Predicate<Object> predicate) {
            ...
            if (predicate2 == null) {
                predicate2 = new Predicate() { // from class: androidx.core.content.l
                    @Override // androidx.core.util.Predicate
                    public final boolean test(Object obj) {
        ...
        public Builder allowExtra(@NonNull String str, @NonNull Class<?> cls) {
            return allowExtra(str, cls, new Predicate() { // from class: androidx.core.content.v
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
        ...
        public <T> Builder allowExtra(@NonNull String str, @NonNull final Class<T> cls, @NonNull final Predicate<T> predicate) {
            ...
            Preconditions.checkNotNull(predicate);
            return allowExtra(str, new Predicate() { // from class: androidx.core.content.q
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
        ...
        public Builder allowExtraOutput(@NonNull final String str) {
            allowExtra("output", Uri.class, new Predicate() { // from class: androidx.core.content.t
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
        ...
        public Builder allowExtraStreamUriWithAuthority(@NonNull final String str) {
            Preconditions.checkNotNull(str);
            allowExtra("android.intent.extra.STREAM", Uri.class, new Predicate() { // from class: androidx.core.content.o
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
    ...
    */
    ...
    public Intent sanitizeByFiltering(@NonNull Intent intent) {
        return sanitize(intent, new Consumer() { // from class: androidx.core.content.g
    ...
    public Intent sanitizeByThrowing(@NonNull Intent intent) {
        return sanitize(intent, new Consumer() { // from class: androidx.core.content.h
            @Override // androidx.core.util.Consumer
            public final void accept(Object obj) {
