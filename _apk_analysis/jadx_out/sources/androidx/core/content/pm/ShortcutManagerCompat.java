        ...
        if (sShortcutInfoChangeListeners == null) {
            ...
            while (it.hasNext()) {
                ...
                if (activityInfo != null && (bundle = activityInfo.metaData) != null && (string = bundle.getString(SHORTCUT_LISTENER_META_DATA_KEY)) != null) {
                    try {
                        arrayList.add((ShortcutInfoChangeListener) Class.forName(string, false, ShortcutManagerCompat.class.getClassLoader()).getMethod(Constants.GET_INSTANCE, Context.class).invoke(null, context));
                    } catch (Exception unused) {
                    }
                }
            }
