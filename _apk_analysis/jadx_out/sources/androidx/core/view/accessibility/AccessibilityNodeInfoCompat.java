...
public class AccessibilityNodeInfoCompat {
    ...
    public static class AccessibilityActionCompat {
        ...
        static {
            ...
            ACTION_SCROLL_IN_DIRECTION = new AccessibilityActionCompat(i10 >= 34 ? Api34Impl.getActionScrollInDirection() : null, R.id.accessibilityActionScrollInDirection, null, null, null);
        }
    ...
    public void addSpansToExtras(CharSequence charSequence, View view) {
        if (Build.VERSION.SDK_INT < 26) {
            ...
            for (int i10 = 0; i10 < clickableSpans.length; i10++) {
                int iIdForClickableSpan = idForClickableSpan(clickableSpans[i10], orCreateSpansFromViewTags);
                orCreateSpansFromViewTags.put(iIdForClickableSpan, new WeakReference<>(clickableSpans[i10]));
                addSpanLocationToExtras(clickableSpans[i10], (Spanned) charSequence, iIdForClickableSpan);
            }
        }
    }
    ...
    public AccessibilityNodeInfoCompat getChild(int i10, int i11) {
        return Build.VERSION.SDK_INT >= 33 ? Api33Impl.getChild(this.mInfo, i10, i11) : getChild(i10);
    }
    ...
    public AccessibilityNodeInfoCompat getParent(int i10) {
        return Build.VERSION.SDK_INT >= 33 ? Api33Impl.getParent(this.mInfo, i10) : getParent();
    }
