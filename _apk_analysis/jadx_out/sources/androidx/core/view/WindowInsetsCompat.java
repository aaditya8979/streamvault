...
public class WindowInsetsCompat {
    ...
    public static class BuilderImpl20 extends BuilderImpl {
        ...
        public void setSystemWindowInsets(@NonNull Insets insets) {
            ...
            if (windowInsets != null) {
                this.mPlatformInsets = windowInsets.replaceSystemWindowInsets(insets.left, insets.f4229top, insets.right, insets.bottom);
            }
        }
    }
    ...
    public static class Impl20 extends Impl {
        ...
        public Insets getInsetsForType(int i10, boolean z10) {
            ...
            int i11;
            if (i10 == 1) {
                return z10 ? Insets.of(0, Math.max(getRootStableInsets().f4229top, getSystemWindowInsets().f4229top), 0, 0) : Insets.of(0, getSystemWindowInsets().f4229top, 0, 0);
            }
            if (i10 == 2) {
                if (z10) {
    ...
    public static Insets insetInsets(@NonNull Insets insets, int i10, int i11, int i12, int i13) {
        ...
        int iMax2 = Math.max(0, insets.f4229top - i11);
    ...
    public int getStableInsetTop() {
        return this.mImpl.getStableInsets().f4229top;
    }
    ...
    public int getSystemWindowInsetTop() {
        return this.mImpl.getSystemWindowInsets().f4229top;
    }
    ...
    public WindowInsetsCompat inset(@NonNull Insets insets) {
        return inset(insets.left, insets.f4229top, insets.right, insets.bottom);
    }
