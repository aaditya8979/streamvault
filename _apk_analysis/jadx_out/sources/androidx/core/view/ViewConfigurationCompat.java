...
public final class ViewConfigurationCompat {
    ...
    public static class Api34Impl {
        ...
        @DoNotInline
        public static int getScaledMaximumFlingVelocity(@NonNull ViewConfiguration viewConfiguration, int i10, int i11, int i12) {
            return viewConfiguration.getScaledMaximumFlingVelocity(i10, i11, i12);
        }

        @DoNotInline
        public static int getScaledMinimumFlingVelocity(@NonNull ViewConfiguration viewConfiguration, int i10, int i11, int i12) {
    ...
    private static int getCompatFlingVelocityThreshold(Resources resources, int i10, Supplier<Integer> supplier, int i11) {
        ...
        return i10 != -1 ? (i10 == 0 || (dimensionPixelSize = resources.getDimensionPixelSize(i10)) < 0) ? i11 : dimensionPixelSize : supplier.get().intValue();
    }
    ...
    public static int getScaledMaximumFlingVelocity(@NonNull Context context, @NonNull final ViewConfiguration viewConfiguration, int i10, int i11, int i12) {
        ...
        return getCompatFlingVelocityThreshold(resources, preApi34MaximumFlingVelocityResId, new Supplier() { // from class: androidx.core.view.l1
    ...
    public static int getScaledMinimumFlingVelocity(@NonNull Context context, @NonNull final ViewConfiguration viewConfiguration, int i10, int i11, int i12) {
        ...
        Objects.requireNonNull(viewConfiguration);
        return getCompatFlingVelocityThreshold(resources, preApi34MinimumFlingVelocityResId, new Supplier() { // from class: androidx.core.view.k1
            @Override // androidx.core.util.Supplier
            public final Object get() {
