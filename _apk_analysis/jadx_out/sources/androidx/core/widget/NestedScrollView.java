...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    public static class SavedState extends View.BaseSavedState {
        ...
        public String toString() {
            return "HorizontalScrollView.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " scrollPosition=" + this.scrollPosition + com.safedk.android.analytics.brandsafety.creatives.discoveries.h.f52302e;
        }
    ...
    */
    ...
    private int scrollBy(int i10, int i11, int i12, boolean z10) {
        ...
        if (z11 && i12 == 0 && (velocityTracker = this.mVelocityTracker) != null) {
            velocityTracker.clear();
        }
        if (i12 == 1) {
    ...
    public int consumeFlingInVerticalStretch(int i10) {
        ...
        if (i10 > 0 && EdgeEffectCompat.getDistance(this.mEdgeGlowTop) != 0.0f) {
            int iRound = Math.round(((-height) / 4.0f) * EdgeEffectCompat.onPullDistance(this.mEdgeGlowTop, ((-i10) * 4.0f) / height, 0.5f));
            if (iRound != i10) {
        ...
        float f10 = height;
        int iRound2 = Math.round((f10 / 4.0f) * EdgeEffectCompat.onPullDistance(this.mEdgeGlowBottom, (i10 * 4.0f) / f10, 0.5f));
        if (iRound2 != i10) {
