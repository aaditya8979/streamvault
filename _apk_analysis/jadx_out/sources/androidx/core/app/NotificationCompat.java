...
public class NotificationCompat {
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            public WearableExtender m4079clone() {
    ...
    public static final class BubbleMetadata {
        ...
        public static class Api30Impl {
            ...
            public static BubbleMetadata fromPlatform(@Nullable Notification$BubbleMetadata notification$BubbleMetadata) {
                ...
                Builder builder = notification$BubbleMetadata.getShortcutId() != null ? new Builder(notification$BubbleMetadata.getShortcutId()) : new Builder(notification$BubbleMetadata.getIntent(), IconCompat.createFromIcon(notification$BubbleMetadata.getIcon()));
    ...
    public static class CallStyle extends Style {
        ...
        public static class Api31Impl {
            ...
            @DoNotInline
            public static Notification$CallStyle setAnswerButtonColorHint(Notification$CallStyle notification$CallStyle, @ColorInt int i10) {
            ...
            @DoNotInline
            public static Notification$CallStyle setDeclineButtonColorHint(Notification$CallStyle notification$CallStyle, @ColorInt int i10) {
                return notification$CallStyle.setDeclineButtonColorHint(i10);
            }

            @DoNotInline
            public static Notification$CallStyle setIsVideo(Notification$CallStyle notification$CallStyle, boolean z10) {
                return notification$CallStyle.setIsVideo(z10);
            }

            @DoNotInline
            public static Notification$CallStyle setVerificationIcon(Notification$CallStyle notification$CallStyle, @Nullable Icon icon) {
                return notification$CallStyle.setVerificationIcon(icon);
            }

            @DoNotInline
            public static Notification$CallStyle setVerificationText(Notification$CallStyle notification$CallStyle, @Nullable CharSequence charSequence) {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            Notification$CallStyle notification$CallStyleForIncomingCall = null;
            defaultText = null;
            if (i10 < 31) {
            ...
            if (i11 == 1) {
                notification$CallStyleForIncomingCall = Api31Impl.forIncomingCall(this.mPerson.toAndroidPerson(), this.mDeclineIntent, this.mAnswerIntent);
            } else if (i11 == 2) {
                notification$CallStyleForIncomingCall = Api31Impl.forOngoingCall(this.mPerson.toAndroidPerson(), this.mHangUpIntent);
            } else if (i11 == 3) {
                notification$CallStyleForIncomingCall = Api31Impl.forScreeningCall(this.mPerson.toAndroidPerson(), this.mHangUpIntent, this.mAnswerIntent);
            ...
            if (notification$CallStyleForIncomingCall != null) {
                notification$CallStyleForIncomingCall.setBuilder(notificationBuilderWithBuilderAccessor.getBuilder());
                Integer num = this.mAnswerButtonColor;
                if (num != null) {
                    Api31Impl.setAnswerButtonColorHint(notification$CallStyleForIncomingCall, num.intValue());
                }
                Integer num2 = this.mDeclineButtonColor;
                if (num2 != null) {
                    Api31Impl.setDeclineButtonColorHint(notification$CallStyleForIncomingCall, num2.intValue());
                }
                Api31Impl.setVerificationText(notification$CallStyleForIncomingCall, this.mVerificationText);
                IconCompat iconCompat = this.mVerificationIcon;
                if (iconCompat != null) {
                    Api31Impl.setVerificationIcon(notification$CallStyleForIncomingCall, iconCompat.toIcon(this.mBuilder.mContext));
                }
                Api31Impl.setIsVideo(notification$CallStyleForIncomingCall, this.mIsVideo);
            }
        }
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z10) {
            ...
            if (!z10 || nonContextualActions == null || (iMin = Math.min(nonContextualActions.size(), 3)) <= 0) {
                ...
                for (int i10 = 0; i10 < iMin; i10++) {
                    remoteViewsApplyStandardTemplate.addView(R.id.actions, generateActionButton(nonContextualActions.get(i10)));
                }
            }
            int i11 = z11 ? 0 : 8;
            remoteViewsApplyStandardTemplate.setViewVisibility(R.id.actions, i11);
            remoteViewsApplyStandardTemplate.setViewVisibility(R.id.action_divider, i11);
    ...
    public static final class WearableExtender implements Extender {
        ...
        @NonNull
        /* JADX INFO: renamed from: clone, reason: merged with bridge method [inline-methods] */
        public WearableExtender m4080clone() {
            WearableExtender wearableExtender = new WearableExtender();
    ...
    public static Action getActionCompatFromAction(@NonNull Notification.Action action) {
        ...
        boolean z10 = Api20Impl.getExtras(action).getBoolean(NotificationCompatJellybean.EXTRA_ALLOW_GENERATED_REPLIES) || Api24Impl.getAllowGeneratedReplies(action);
        boolean z11 = Api20Impl.getExtras(action).getBoolean(Action.EXTRA_SHOWS_USER_INTERFACE, true);
        int semanticAction = i12 >= 28 ? Api28Impl.getSemanticAction(action) : Api20Impl.getExtras(action).getInt(Action.EXTRA_SEMANTIC_ACTION, 0);
        boolean zIsContextual = i12 >= 29 ? Api29Impl.isContextual(action) : false;
        boolean zIsAuthenticationRequired = i12 >= 31 ? Api31Impl.isAuthenticationRequired(action) : false;
