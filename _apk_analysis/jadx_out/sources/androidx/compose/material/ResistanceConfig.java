...
public final class ResistanceConfig {
    ...
    public /* synthetic */ ResistanceConfig(float f10, float f11, float f12, int i10, i iVar) {
    ...
    public final float computeResistance(float overflow) {
        ...
        return (this.basis / f10) * ((float) Math.sin((n.m(overflow / this.basis, -1.0f, 1.0f) * 3.1415927f) / 2));
    }
