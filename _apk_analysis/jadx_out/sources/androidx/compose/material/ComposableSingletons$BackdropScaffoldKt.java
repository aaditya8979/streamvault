...
public final class ComposableSingletons$BackdropScaffoldKt {
    ...
    @NotNull
    public static q<SnackbarHostState, Composer, Integer, r> f5lambda1 = ComposableLambdaKt.composableLambdaInstance(229445492, false, new q<SnackbarHostState, Composer, Integer, r>() { // from class: androidx.compose.material.ComposableSingletons$BackdropScaffoldKt$lambda-1$1
        @Override // sn.q
    ...
    public final q<SnackbarHostState, Composer, Integer, r> m991getLambda1$material_release() {
        return f5lambda1;
    }
}
