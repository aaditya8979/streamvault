...
public final class ModalBottomSheetKt$Scrim$dismissModifier$1$1 extends SuspendLambda implements p<PointerInputScope, c<? super r>, Object> {
    public final /* synthetic */ a<r> $onDismiss;
    private /* synthetic */ Object L$0;
    public int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ModalBottomSheetKt$Scrim$dismissModifier$1$1(a<r> aVar, c<? super ModalBottomSheetKt$Scrim$dismissModifier$1$1> cVar) {
        super(2, cVar);
        this.$onDismiss = aVar;
    }
    ...
    public final Object mo2invoke(@NotNull PointerInputScope pointerInputScope, @Nullable c<? super r> cVar) {
        return ((ModalBottomSheetKt$Scrim$dismissModifier$1$1) create(pointerInputScope, cVar)).invokeSuspend(r.f5635a);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i10 == 0) {
            ...
            l<Offset, r> lVar = new l<Offset, r>() { // from class: androidx.compose.material.ModalBottomSheetKt$Scrim$dismissModifier$1$1.1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public /* bridge */ /* synthetic */ r invoke(Offset offset) {
                    m1086invokek4lQ0M(offset.getPackedValue());
                    return r.f5635a;
                }

                /* JADX INFO: renamed from: invoke-k-4lQ0M, reason: not valid java name */
                public final void m1086invokek4lQ0M(long j10) {
                    aVar.invoke();
                }
            };
            this.label = 1;
