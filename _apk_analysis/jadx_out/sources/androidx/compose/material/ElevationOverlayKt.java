...
public final class ElevationOverlayKt {
    ...
    private static final ProvidableCompositionLocal<Dp> LocalAbsoluteElevation = CompositionLocalKt.compositionLocalOf$default(null, new a<Dp>() { // from class: androidx.compose.material.ElevationOverlayKt$LocalAbsoluteElevation$1
        ...
        public /* bridge */ /* synthetic */ Dp invoke() {
            return Dp.m3824boximpl(m1036invokeD9Ej5fM());
        }

        /* JADX INFO: renamed from: invoke-D9Ej5fM, reason: not valid java name */
        public final float m1036invokeD9Ej5fM() {
    ...
    public static final long m1035calculateForegroundColorCLU3JFs(long j10, float f10, Composer composer, int i10) {
        return Color.m1618copywmQWz5c$default(ColorsKt.m985contentColorForek8zF_U(j10, composer, i10 & 14), ((((float) Math.log(f10 + 1)) * 4.5f) + 2.0f) / 100.0f, 0.0f, 0.0f, 0.0f, 14, null);
    }
