...
final class DefaultFloatingActionButtonElevation implements FloatingActionButtonElevation {
    ...
    @d(c = "androidx.compose.material.DefaultFloatingActionButtonElevation$elevation$1", f = "FloatingActionButton.kt", l = {AudioAttributesCompat.FLAG_ALL_PUBLIC}, m = "invokeSuspend")
    public static final class AnonymousClass1 extends SuspendLambda implements p<l0, c<? super r>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i10 == 0) {
                ...
                e<Interaction> eVar = new e<Interaction>() { // from class: androidx.compose.material.DefaultFloatingActionButtonElevation.elevation.1.1
                    @Nullable
    ...
    /* JADX INFO: compiled from: FloatingActionButton.kt */
    @Metadata(k = 3, mv = {1, 6, 0}, xi = 48)
    @d(c = "androidx.compose.material.DefaultFloatingActionButtonElevation$elevation$2", f = "FloatingActionButton.kt", l = {318}, m = "invokeSuspend")
    public static final class AnonymousClass2 extends SuspendLambda implements p<l0, c<? super r>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public AnonymousClass2(Animatable<Dp, AnimationVector1D> animatable, DefaultFloatingActionButtonElevation defaultFloatingActionButtonElevation, float f10, Interaction interaction, c<? super AnonymousClass2> cVar) {
            super(2, cVar);
    ...
    public State<Dp> elevation(@NotNull InteractionSource interactionSource, @Nullable Composer composer, int i10) {
        ...
        EffectsKt.LaunchedEffect(Dp.m3824boximpl(f10), new AnonymousClass2(animatable, this, f10, interaction, null), composer, 0);
