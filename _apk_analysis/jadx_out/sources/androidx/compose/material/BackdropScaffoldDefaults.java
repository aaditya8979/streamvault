...
public final class BackdropScaffoldDefaults {
    ...
    private static final float PeekHeight = Dp.m3826constructorimpl(56);
    private static final float HeaderHeight = Dp.m3826constructorimpl(48);
    private static final float FrontLayerElevation = Dp.m3826constructorimpl(1);

    private BackdropScaffoldDefaults() {
    }

    /* JADX INFO: renamed from: getFrontLayerElevation-D9Ej5fM, reason: not valid java name */
    public final float m880getFrontLayerElevationD9Ej5fM() {
    ...
    public final long getFrontLayerScrimColor(@Nullable Composer composer, int i10) {
        ...
        long jM1618copywmQWz5c$default = Color.m1618copywmQWz5c$default(MaterialTheme.INSTANCE.getColors(composer, 6).m971getSurface0d7_KjU(), 0.6f, 0.0f, 0.0f, 0.0f, 14, null);
        composer.endReplaceableGroup();
        return jM1618copywmQWz5c$default;
    }
    ...
    public final Shape getFrontLayerShape(@Nullable Composer composer, int i10) {
        ...
        float f10 = 16;
        CornerBasedShape cornerBasedShapeCopy$default = CornerBasedShape.copy$default(MaterialTheme.INSTANCE.getShapes(composer, 6).getLarge(), CornerSizeKt.m653CornerSize0680j_4(Dp.m3826constructorimpl(f10)), CornerSizeKt.m653CornerSize0680j_4(Dp.m3826constructorimpl(f10)), null, null, 12, null);
        composer.endReplaceableGroup();
        return cornerBasedShapeCopy$default;
    }

    /* JADX INFO: renamed from: getHeaderHeight-D9Ej5fM, reason: not valid java name */
    public final float m881getHeaderHeightD9Ej5fM() {
        return HeaderHeight;
    }

    /* JADX INFO: renamed from: getPeekHeight-D9Ej5fM, reason: not valid java name */
    public final float m882getPeekHeightD9Ej5fM() {
        return PeekHeight;
    }
}
