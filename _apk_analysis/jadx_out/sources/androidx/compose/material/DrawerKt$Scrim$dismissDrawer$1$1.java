...
public final class DrawerKt$Scrim$dismissDrawer$1$1 extends SuspendLambda implements p<PointerInputScope, c<? super r>, Object> {
    public final /* synthetic */ a<r> $onClose;
    private /* synthetic */ Object L$0;
    public int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DrawerKt$Scrim$dismissDrawer$1$1(a<r> aVar, c<? super DrawerKt$Scrim$dismissDrawer$1$1> cVar) {
        super(2, cVar);
        this.$onClose = aVar;
    }
    ...
    public final Object mo2invoke(@NotNull PointerInputScope pointerInputScope, @Nullable c<? super r> cVar) {
        return ((DrawerKt$Scrim$dismissDrawer$1$1) create(pointerInputScope, cVar)).invokeSuspend(r.f5635a);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i10 == 0) {
            ...
            final a<r> aVar = this.$onClose;
            l<Offset, r> lVar = new l<Offset, r>() { // from class: androidx.compose.material.DrawerKt$Scrim$dismissDrawer$1$1.1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public /* bridge */ /* synthetic */ r invoke(Offset offset) {
                    m1027invokek4lQ0M(offset.getPackedValue());
                    return r.f5635a;
                }

                /* JADX INFO: renamed from: invoke-k-4lQ0M, reason: not valid java name */
                public final void m1027invokek4lQ0M(long j10) {
                    aVar.invoke();
                }
            };
            this.label = 1;
