...
public final class RippleKt {
    ...
    public static final Indication m1253rememberRipple9IZ8Weo(boolean z10, float f10, long j10, @Nullable Composer composer, int i10, int i11) {
        ...
        State stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m1609boximpl(j10), composer, (i10 >> 6) & 14);
        Boolean boolValueOf = Boolean.valueOf(z10);
        Dp dpM3824boximpl = Dp.m3824boximpl(f10);
        composer.startReplaceableGroup(-3686552);
        boolean zChanged = composer.changed(boolValueOf) | composer.changed(dpM3824boximpl);
