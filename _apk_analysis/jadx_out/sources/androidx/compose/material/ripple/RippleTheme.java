...
public interface RippleTheme {
    ...
    public static final class Companion {
        ...
        public final RippleAlpha m1254defaultRippleAlphaDxMtmZc(long contentColor, boolean lightTheme) {
            return lightTheme ? ((double) ColorKt.m1672luminance8_81llA(contentColor)) > 0.5d ? RippleThemeKt.LightThemeHighContrastRippleAlpha : RippleThemeKt.LightThemeLowContrastRippleAlpha : RippleThemeKt.DarkThemeRippleAlpha;
        }

        /* JADX INFO: renamed from: defaultRippleColor-5vOe2sY, reason: not valid java name */
        public final long m1255defaultRippleColor5vOe2sY(long contentColor, boolean lightTheme) {
            return (lightTheme || ((double) ColorKt.m1672luminance8_81llA(contentColor)) >= 0.5d) ? contentColor : Color.INSTANCE.m1656getWhite0d7_KjU();
        }
    }

    @Composable
    /* JADX INFO: renamed from: defaultColor-WaAFU9c */
    long mo1069defaultColorWaAFU9c(@Nullable Composer composer, int i10);
