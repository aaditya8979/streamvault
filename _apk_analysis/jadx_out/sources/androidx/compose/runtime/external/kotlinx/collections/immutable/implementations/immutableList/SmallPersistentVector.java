...
public final class SmallPersistentVector<E> extends AbstractPersistentList<E> implements ImmutableList<E> {
    ...
    public SmallPersistentVector(@NotNull Object[] objArr) {
        p.k(objArr, "buffer");
        this.buffer = objArr;
        CommonFunctionsKt.m1286assert(objArr.length <= 32);
    }
    ...
    public PersistentList<E> add(int index, E element) {
        ...
        if (size() < 32) {
            ...
            cn.p.p(this.buffer, objArrBufferOfSize, 0, 0, index, 6, null);
            cn.p.l(this.buffer, objArrBufferOfSize, index + 1, index, size());
        ...
        cn.p.l(this.buffer, objArrCopyOf, index + 1, index, size() - 1);
    ...
    public PersistentList<E> addAll(int index, @NotNull Collection<? extends E> c10) {
        ...
        cn.p.p(this.buffer, objArrBufferOfSize, 0, 0, index, 6, null);
        cn.p.l(this.buffer, objArrBufferOfSize, c10.size() + index, index, size());
    ...
    public int indexOf(Object element) {
        return r.i0(this.buffer, element);
    }

    @Override // cn.d, java.util.List
    public int lastIndexOf(Object element) {
        return r.r0(this.buffer, element);
    }
    ...
    public PersistentList<E> removeAll(@NotNull l<? super E, Boolean> lVar) {
        ...
        return size == size() ? this : size == 0 ? EMPTY : new SmallPersistentVector(cn.p.s(objArrCopyOf, 0, size));
    }
    ...
    public PersistentList<E> removeAt(int index) {
        ...
        Object[] objArrCopyOf = Arrays.copyOf(this.buffer, size() - 1);
        p.j(objArrCopyOf, "copyOf(this, newSize)");
        cn.p.l(this.buffer, objArrCopyOf, index, index + 1, size());
        return new SmallPersistentVector(objArrCopyOf);
    }
