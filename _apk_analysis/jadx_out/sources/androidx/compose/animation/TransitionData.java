...
public final /* data */ class TransitionData {
    ...
    public /* synthetic */ TransitionData(Fade fade, Slide slide, ChangeSize changeSize, Scale scale, int i10, i iVar) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return p.f(this.fade, transitionData.fade) && p.f(this.slide, transitionData.slide) && p.f(this.changeSize, transitionData.changeSize) && p.f(this.scale, transitionData.scale);
    }
