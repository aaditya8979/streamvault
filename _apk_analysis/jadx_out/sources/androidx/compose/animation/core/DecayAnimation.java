...
public final class DecayAnimation<T, V extends AnimationVector> implements Animation<T, V> {
    ...
    public DecayAnimation(@NotNull DecayAnimationSpec<T> decayAnimationSpec, @NotNull TwoWayConverter<T, V> twoWayConverter, T t10, @NotNull V v10) {
        ...
        p.k(decayAnimationSpec, "animationSpec");
    ...
    public DecayAnimation(@NotNull VectorizedDecayAnimationSpec<V> vectorizedDecayAnimationSpec, @NotNull TwoWayConverter<T, V> twoWayConverter, T t10, @NotNull V v10) {
        p.k(vectorizedDecayAnimationSpec, "animationSpec");
        p.k(twoWayConverter, "typeConverter");
        p.k(v10, "initialVelocityVector");
        ...
        this.initialVelocityVector = (V) AnimationVectorsKt.copy(v10);
        this.targetValue = (T) getTypeConverter().getConvertFromVector().invoke(vectorizedDecayAnimationSpec.getTargetValue(vInvoke, v10));
        this.durationNanos = vectorizedDecayAnimationSpec.getDurationNanos(vInvoke, v10);
        V v11 = (V) AnimationVectorsKt.copy(vectorizedDecayAnimationSpec.getVelocityFromNanos(getDurationNanos(), vInvoke, v10));
        this.endVelocity = v11;
        int size = v11.getSize();
        for (int i10 = 0; i10 < size; i10++) {
            V v12 = this.endVelocity;
            v12.set$animation_core_release(i10, n.m(v12.get$animation_core_release(i10), -this.animationSpec.getAbsVelocityThreshold(), this.animationSpec.getAbsVelocityThreshold()));
        }
    }
