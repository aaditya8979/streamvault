...
public final class FloatTweenSpec implements FloatAnimationSpec {
    ...
    public /* synthetic */ FloatTweenSpec(int i10, int i11, Easing easing, int i12, i iVar) {
    ...
    private final long clampPlayTime(long playTime) {
        return n.p(playTime - ((long) this.delay), 0L, this.duration);
    }
    ...
    public float getValueFromNanos(long playTimeNanos, float initialValue, float targetValue, float initialVelocity) {
        ...
        return VectorConvertersKt.lerp(initialValue, targetValue, this.easing.transform(n.m(i10 == 0 ? 1.0f : jClampPlayTime / i10, 0.0f, 1.0f)));
    }
