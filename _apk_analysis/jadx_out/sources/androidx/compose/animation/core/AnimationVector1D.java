...
public final class AnimationVector1D extends AnimationVector {
    ...
    public boolean equals(@Nullable Object other) {
        if (other instanceof AnimationVector1D) {
            if (((AnimationVector1D) other).value == this.value) {
                return true;
            }
        }
        return false;
