...
public final class PrimitiveResources_androidKt {
    ...
    public static final float dimensionResource(@DimenRes int i10, @Nullable Composer composer, int i11) {
        return Dp.m3826constructorimpl(((Context) composer.consume(AndroidCompositionLocals_androidKt.getLocalContext())).getResources().getDimension(i10) / ((Density) composer.consume(CompositionLocalsKt.getLocalDensity())).getDensity());
    }
    ...
    public static final int[] integerArrayResource(@ArrayRes int i10, @Nullable Composer composer, int i11) {
        ...
        p.j(intArray, "context.resources.getIntArray(id)");
        return intArray;
    }
