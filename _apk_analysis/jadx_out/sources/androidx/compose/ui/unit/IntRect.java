...
public final /* data */ class IntRect {
    ...
    public static /* synthetic */ void m3962getSizeYbymL2g$annotations() {
    }
    ...
    public final boolean m3963containsgyyYBs(long offset) {
        return IntOffset.m3944getXimpl(offset) >= this.left && IntOffset.m3944getXimpl(offset) < this.right && IntOffset.m3945getYimpl(offset) >= this.top && IntOffset.m3945getYimpl(offset) < this.bottom;
    }

    @NotNull
    public final IntRect copy(int left, int top2, int right, int bottom) {
        return new IntRect(left, top2, right, bottom);
    }
    ...
    public final long m3964getBottomCenternOccac() {
    ...
    public final long m3965getBottomLeftnOccac() {
    ...
    public final long m3968getCenterLeftnOccac() {
    ...
    public final long m3969getCenterRightnOccac() {
    ...
    public final long m3970getSizeYbymL2g() {
    ...
    public final long m3971getTopCenternOccac() {
    ...
    public final IntRect m3974translategyyYBs(long offset) {
        return new IntRect(this.left + IntOffset.m3944getXimpl(offset), this.top + IntOffset.m3945getYimpl(offset), this.right + IntOffset.m3944getXimpl(offset), this.bottom + IntOffset.m3945getYimpl(offset));
    }
}
