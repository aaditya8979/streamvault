...
public final class ComposableSingletons$AndroidPopup_androidKt {
    ...
    @NotNull
    public static p<Composer, Integer, r> f21lambda1 = ComposableLambdaKt.composableLambdaInstance(-1131826196, false, new p<Composer, Integer, r>() { // from class: androidx.compose.ui.window.ComposableSingletons$AndroidPopup_androidKt$lambda-1$1
        @Override // sn.p
    ...
    public final p<Composer, Integer, r> m4073getLambda1$ui_release() {
        return f21lambda1;
    }
}
