...
public final class ModifierLocalProviderKt {
    ...
    public static final class AnonymousClass1<T> extends InspectorValueInfo implements ModifierLocalProvider<T> {
        ...
        public AnonymousClass1(ProvidableModifierLocal<T> providableModifierLocal, a<? extends T> aVar, l<? super InspectorInfo, r> lVar) {
            super(lVar);
    ...
    @NotNull
    public static final <T> Modifier modifierLocalProvider(@NotNull Modifier modifier, @NotNull final ProvidableModifierLocal<T> providableModifierLocal, @NotNull final a<? extends T> aVar) {
        p.k(modifier, "<this>");
        p.k(providableModifierLocal, "key");
        p.k(aVar, "value");
        return modifier.then(new AnonymousClass1(providableModifierLocal, aVar, InspectableValueKt.isDebugInspectorInfoEnabled() ? new l<InspectorInfo, r>() { // from class: androidx.compose.ui.modifier.ModifierLocalProviderKt$modifierLocalProvider$$inlined$debugInspectorInfo$1
