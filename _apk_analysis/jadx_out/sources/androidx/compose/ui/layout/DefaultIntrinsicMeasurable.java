...
public final class DefaultIntrinsicMeasurable implements Measurable {
    ...
    public Placeable mo3112measureBRTryo0(long constraints) {
        if (this.widthHeight == IntrinsicWidthHeight.Width) {
            return new FixedSizeIntrinsicsPlaceable(this.minMax == IntrinsicMinMax.Max ? this.measurable.maxIntrinsicWidth(Constraints.m3781getMaxHeightimpl(constraints)) : this.measurable.minIntrinsicWidth(Constraints.m3781getMaxHeightimpl(constraints)), Constraints.m3781getMaxHeightimpl(constraints));
        }
        return new FixedSizeIntrinsicsPlaceable(Constraints.m3782getMaxWidthimpl(constraints), this.minMax == IntrinsicMinMax.Max ? this.measurable.maxIntrinsicHeight(Constraints.m3782getMaxWidthimpl(constraints)) : this.measurable.minIntrinsicHeight(Constraints.m3782getMaxWidthimpl(constraints)));
    }
