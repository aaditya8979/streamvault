...
final class OnGloballyPositionedModifierImpl extends InspectorValueInfo implements OnGloballyPositionedModifier {
    ...
    public OnGloballyPositionedModifierImpl(@NotNull l<? super LayoutCoordinates, r> lVar, @NotNull l<? super InspectorInfo, r> lVar2) {
        super(lVar2);
        p.k(lVar, "callback");
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (other instanceof OnGloballyPositionedModifierImpl) {
            return p.f(this.callback, ((OnGloballyPositionedModifierImpl) other).callback);
        }
        return false;
    }
