...
public final class ComposableSingletons$SubcomposeLayoutKt {
    ...
    @NotNull
    public static p<Composer, Integer, r> f18lambda1 = ComposableLambdaKt.composableLambdaInstance(-1741544742, false, new p<Composer, Integer, r>() { // from class: androidx.compose.ui.layout.ComposableSingletons$SubcomposeLayoutKt$lambda-1$1
        @Override // sn.p
    ...
    public final p<Composer, Integer, r> m3102getLambda1$ui_release() {
        return f18lambda1;
    }
}
