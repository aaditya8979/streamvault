...
final class MeasuringIntrinsics {
    ...
    public static final class DefaultIntrinsicMeasurable implements Measurable {
        ...
        public DefaultIntrinsicMeasurable(@NotNull IntrinsicMeasurable intrinsicMeasurable, @NotNull IntrinsicMinMax intrinsicMinMax, @NotNull IntrinsicWidthHeight intrinsicWidthHeight) {
            ...
            p.k(intrinsicMinMax, "minMax");
            p.k(intrinsicWidthHeight, "widthHeight");
        ...
        public Placeable mo3112measureBRTryo0(long constraints) {
            if (this.widthHeight == IntrinsicWidthHeight.Width) {
                return new EmptyPlaceable(this.minMax == IntrinsicMinMax.Max ? this.measurable.maxIntrinsicWidth(Constraints.m3781getMaxHeightimpl(constraints)) : this.measurable.minIntrinsicWidth(Constraints.m3781getMaxHeightimpl(constraints)), Constraints.m3781getMaxHeightimpl(constraints));
            }
            return new EmptyPlaceable(Constraints.m3782getMaxWidthimpl(constraints), this.minMax == IntrinsicMinMax.Max ? this.measurable.maxIntrinsicHeight(Constraints.m3782getMaxWidthimpl(constraints)) : this.measurable.minIntrinsicHeight(Constraints.m3782getMaxWidthimpl(constraints)));
        }
    ...
    public final int maxHeight$ui_release(@NotNull LayoutModifier modifier, @NotNull IntrinsicMeasureScope instrinsicMeasureScope, @NotNull IntrinsicMeasurable intrinsicMeasurable, int w10) {
        p.k(modifier, "modifier");
        p.k(instrinsicMeasureScope, "instrinsicMeasureScope");
        p.k(intrinsicMeasurable, "intrinsicMeasurable");
        return modifier.mo21measure3p2s80s(new IntrinsicsMeasureScope(instrinsicMeasureScope, instrinsicMeasureScope.getLayoutDirection()), new DefaultIntrinsicMeasurable(intrinsicMeasurable, IntrinsicMinMax.Max, IntrinsicWidthHeight.Height), ConstraintsKt.Constraints$default(0, w10, 0, 0, 13, null)).getHeight();
    }

    public final int maxWidth$ui_release(@NotNull LayoutModifier modifier, @NotNull IntrinsicMeasureScope instrinsicMeasureScope, @NotNull IntrinsicMeasurable intrinsicMeasurable, int h10) {
        p.k(modifier, "modifier");
        p.k(instrinsicMeasureScope, "instrinsicMeasureScope");
        p.k(intrinsicMeasurable, "intrinsicMeasurable");
        return modifier.mo21measure3p2s80s(new IntrinsicsMeasureScope(instrinsicMeasureScope, instrinsicMeasureScope.getLayoutDirection()), new DefaultIntrinsicMeasurable(intrinsicMeasurable, IntrinsicMinMax.Max, IntrinsicWidthHeight.Width), ConstraintsKt.Constraints$default(0, 0, 0, h10, 7, null)).getWidth();
    }

    public final int minHeight$ui_release(@NotNull LayoutModifier modifier, @NotNull IntrinsicMeasureScope instrinsicMeasureScope, @NotNull IntrinsicMeasurable intrinsicMeasurable, int w10) {
        p.k(modifier, "modifier");
        p.k(instrinsicMeasureScope, "instrinsicMeasureScope");
        p.k(intrinsicMeasurable, "intrinsicMeasurable");
        return modifier.mo21measure3p2s80s(new IntrinsicsMeasureScope(instrinsicMeasureScope, instrinsicMeasureScope.getLayoutDirection()), new DefaultIntrinsicMeasurable(intrinsicMeasurable, IntrinsicMinMax.Min, IntrinsicWidthHeight.Height), ConstraintsKt.Constraints$default(0, w10, 0, 0, 13, null)).getHeight();
    }

    public final int minWidth$ui_release(@NotNull LayoutModifier modifier, @NotNull IntrinsicMeasureScope instrinsicMeasureScope, @NotNull IntrinsicMeasurable intrinsicMeasurable, int h10) {
        p.k(modifier, "modifier");
        p.k(instrinsicMeasureScope, "instrinsicMeasureScope");
        p.k(intrinsicMeasurable, "intrinsicMeasurable");
        return modifier.mo21measure3p2s80s(new IntrinsicsMeasureScope(instrinsicMeasureScope, instrinsicMeasureScope.getLayoutDirection()), new DefaultIntrinsicMeasurable(intrinsicMeasurable, IntrinsicMinMax.Min, IntrinsicWidthHeight.Width), ConstraintsKt.Constraints$default(0, 0, 0, h10, 7, null)).getWidth();
    }
}
