...
public final class XmlVectorParser_androidKt {
    ...
    public static final ImageVector.Builder createVectorImageBuilder(@NotNull AndroidVectorParser androidVectorParser, @NotNull Resources resources, @Nullable Resources.Theme theme, @NotNull AttributeSet attributeSet) throws XmlPullParserException {
        long jM1655getUnspecified0d7_KjU;
        int iM1561getSrcIn0nO6VwU;
        ColorStateList namedColorStateList;
        p.k(androidVectorParser, "<this>");
        p.k(resources, "res");
        ...
        if (typedArrayObtainAttributes.hasValue(androidVectorResources.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) {
            ...
            jM1655getUnspecified0d7_KjU = (typedValue.type == 2 || (namedColorStateList = androidVectorParser.getNamedColorStateList(typedArrayObtainAttributes, theme, "tint", androidVectorResources.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) == null) ? Color.INSTANCE.m1655getUnspecified0d7_KjU() : ColorKt.Color(namedColorStateList.getDefaultColor());
        } else {
            jM1655getUnspecified0d7_KjU = Color.INSTANCE.m1655getUnspecified0d7_KjU();
        }
        long j10 = jM1655getUnspecified0d7_KjU;
        ...
        if (i10 == -1) {
            iM1561getSrcIn0nO6VwU = BlendMode.INSTANCE.m1561getSrcIn0nO6VwU();
        } else if (i10 == 3) {
            iM1561getSrcIn0nO6VwU = BlendMode.INSTANCE.m1563getSrcOver0nO6VwU();
        } else if (i10 == 5) {
            iM1561getSrcIn0nO6VwU = BlendMode.INSTANCE.m1561getSrcIn0nO6VwU();
        } else if (i10 != 9) {
            switch (i10) {
                case 14:
                    iM1561getSrcIn0nO6VwU = BlendMode.INSTANCE.m1552getModulate0nO6VwU();
                    break;
                case 15:
                    iM1561getSrcIn0nO6VwU = BlendMode.INSTANCE.m1557getScreen0nO6VwU();
                    break;
                case 16:
                    iM1561getSrcIn0nO6VwU = BlendMode.INSTANCE.m1555getPlus0nO6VwU();
                    break;
                default:
                    iM1561getSrcIn0nO6VwU = BlendMode.INSTANCE.m1561getSrcIn0nO6VwU();
                    break;
            ...
            iM1561getSrcIn0nO6VwU = BlendMode.INSTANCE.m1560getSrcAtop0nO6VwU();
        }
        int i11 = iM1561getSrcIn0nO6VwU;
        float fM3826constructorimpl = Dp.m3826constructorimpl(dimension / resources.getDisplayMetrics().density);
        float fM3826constructorimpl2 = Dp.m3826constructorimpl(dimension2 / resources.getDisplayMetrics().density);
        typedArrayObtainAttributes.recycle();
        return new ImageVector.Builder(null, fM3826constructorimpl, fM3826constructorimpl2, namedFloat, namedFloat2, j10, i11, namedBoolean, 1, null);
    }

    /* JADX INFO: renamed from: getStrokeLineCap-CSYIeUk, reason: not valid java name */
    private static final int m2227getStrokeLineCapCSYIeUk(int i10, int i11) {
        return i10 != 0 ? i10 != 1 ? i10 != 2 ? i11 : StrokeCap.INSTANCE.m1925getSquareKaPHkGw() : StrokeCap.INSTANCE.m1924getRoundKaPHkGw() : StrokeCap.INSTANCE.m1923getButtKaPHkGw();
    }

    /* JADX INFO: renamed from: getStrokeLineCap-CSYIeUk$default, reason: not valid java name */
    public static /* synthetic */ int m2228getStrokeLineCapCSYIeUk$default(int i10, int i11, int i12, Object obj) {
        if ((i12 & 2) != 0) {
            i11 = StrokeCap.INSTANCE.m1923getButtKaPHkGw();
        }
        return m2227getStrokeLineCapCSYIeUk(i10, i11);
    }

    /* JADX INFO: renamed from: getStrokeLineJoin-kLtJ_vA, reason: not valid java name */
    private static final int m2229getStrokeLineJoinkLtJ_vA(int i10, int i11) {
        return i10 != 0 ? i10 != 1 ? i10 != 2 ? i11 : StrokeJoin.INSTANCE.m1933getBevelLxFBmk8() : StrokeJoin.INSTANCE.m1935getRoundLxFBmk8() : StrokeJoin.INSTANCE.m1934getMiterLxFBmk8();
    }

    /* JADX INFO: renamed from: getStrokeLineJoin-kLtJ_vA$default, reason: not valid java name */
    public static /* synthetic */ int m2230getStrokeLineJoinkLtJ_vA$default(int i10, int i11, int i12, Object obj) {
        if ((i12 & 2) != 0) {
            i11 = StrokeJoin.INSTANCE.m1934getMiterLxFBmk8();
        }
        return m2229getStrokeLineJoinkLtJ_vA(i10, i11);
    }

    public static final boolean isAtEnd(@NotNull XmlPullParser xmlPullParser) {
        p.k(xmlPullParser, "<this>");
    ...
    public static final int parseCurrentVectorNode(@NotNull AndroidVectorParser androidVectorParser, @NotNull Resources resources, @NotNull AttributeSet attributeSet, @Nullable Resources.Theme theme, @NotNull ImageVector.Builder builder, int i10) throws XmlPullParserException {
        p.k(androidVectorParser, "<this>");
        p.k(resources, "res");
        p.k(attributeSet, "attrs");
        p.k(builder, "builder");
        ...
        if (eventType != 2) {
            if (eventType != 3 || !p.f(SHAPE_GROUP, androidVectorParser.getXmlParser().getName())) {
                return i10;
            }
            int i11 = i10 + 1;
    ...
    public static final void parsePath(@NotNull AndroidVectorParser androidVectorParser, @NotNull Resources resources, @Nullable Resources.Theme theme, @NotNull AttributeSet attributeSet, @NotNull ImageVector.Builder builder) throws IllegalArgumentException {
        ...
        int iM2227getStrokeLineCapCSYIeUk = m2227getStrokeLineCapCSYIeUk(androidVectorParser.getNamedInt(typedArrayObtainAttributes, "strokeLineCap", androidVectorResources.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_CAP(), -1), StrokeCap.INSTANCE.m1923getButtKaPHkGw());
        int iM2229getStrokeLineJoinkLtJ_vA = m2229getStrokeLineJoinkLtJ_vA(androidVectorParser.getNamedInt(typedArrayObtainAttributes, "strokeLineJoin", androidVectorResources.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_JOIN(), -1), StrokeJoin.INSTANCE.m1933getBevelLxFBmk8());
        ...
        builder.m2195addPathoIyEayM(listAddPathNodes, namedInt == 0 ? companion.m1863getNonZeroRgk1Os() : companion.m1862getEvenOddRgk1Os(), str, brushObtainBrushFromComplexColor, namedFloat, brushObtainBrushFromComplexColor2, namedFloat3, namedFloat4, iM2227getStrokeLineCapCSYIeUk, iM2229getStrokeLineJoinkLtJ_vA, namedFloat2, namedFloat7, namedFloat5, namedFloat6);
    }
