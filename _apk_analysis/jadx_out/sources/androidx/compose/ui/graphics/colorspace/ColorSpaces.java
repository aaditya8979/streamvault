...
public final class ColorSpaces {
    ...
    static {
        ...
        LinearSrgb = rgb2;
        Rgb rgb3 = new Rgb("scRGB-nl IEC 61966-2-2:2003", fArr, illuminant.getD65(), null, new l<Double, Double>() { // from class: androidx.compose.ui.graphics.colorspace.ColorSpaces$ExtendedSrgb$1
            @NotNull
        ...
        }, new l<Double, Double>() { // from class: androidx.compose.ui.graphics.colorspace.ColorSpaces$ExtendedSrgb$2
            @NotNull
            public final Double invoke(double d10) {
        ...
        Acescg = rgb14;
        Xyz xyz2 = new Xyz("Generic XYZ", 14);
        CieXyz = xyz2;
        ...
        Oklab = oklab;
        ColorSpacesArray = new ColorSpace[]{rgb, rgb2, rgb3, rgb4, rgb5, rgb6, rgb7, rgb8, rgb9, rgb10, rgb11, rgb12, rgb13, rgb14, xyz2, lab, rgb15, oklab};
    }
