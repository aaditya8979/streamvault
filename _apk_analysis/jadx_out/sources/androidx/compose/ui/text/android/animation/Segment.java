...
public final /* data */ class Segment {
    ...
    @NotNull
    public final Segment copy(int startOffset, int endOffset, int left, int top2, int right, int bottom) {
        return new Segment(startOffset, endOffset, left, top2, right, bottom);
    }
