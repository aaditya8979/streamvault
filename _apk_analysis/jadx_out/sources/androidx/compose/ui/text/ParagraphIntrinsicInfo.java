...
public final /* data */ class ParagraphIntrinsicInfo {
    ...
    public ParagraphIntrinsicInfo(@NotNull ParagraphIntrinsics paragraphIntrinsics, int i10, int i11) {
        p.k(paragraphIntrinsics, "intrinsics");
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return p.f(this.intrinsics, paragraphIntrinsicInfo.intrinsics) && this.startIndex == paragraphIntrinsicInfo.startIndex && this.endIndex == paragraphIntrinsicInfo.endIndex;
    }
