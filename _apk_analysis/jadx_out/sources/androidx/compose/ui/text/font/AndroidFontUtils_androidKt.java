...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int m3510getAndroidTypefaceStyleFO1MlWM(@NotNull FontWeight fontWeight, int i10) {
        p.k(fontWeight, "fontWeight");
        return getAndroidTypefaceStyle(fontWeight.compareTo(getAndroidBold(FontWeight.INSTANCE)) >= 0, FontStyle.m3552equalsimpl0(i10, FontStyle.INSTANCE.m3556getItalic_LCdwA()));
    }
}
