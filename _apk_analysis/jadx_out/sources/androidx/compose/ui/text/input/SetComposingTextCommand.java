...
public final class SetComposingTextCommand implements EditCommand {
    ...
    public void applyTo(@NotNull EditingBuffer editingBuffer) {
        ...
        if (editingBuffer.hasComposition$ui_text_release()) {
            ...
            if (getText().length() > 0) {
                editingBuffer.setComposition$ui_text_release(compositionStart, getText().length() + compositionStart);
            }
        } else {
            ...
            if (getText().length() > 0) {
                editingBuffer.setComposition$ui_text_release(selectionStart, getText().length() + selectionStart);
            }
        }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return p.f(getText(), setComposingTextCommand.getText()) && this.newCursorPosition == setComposingTextCommand.newCursorPosition;
    }
