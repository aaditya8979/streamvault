...
public final class AndroidDefaultTypeface implements AndroidTypeface {
    ...
    public Typeface mo3655getNativeTypefacePYhJU0U(@NotNull FontWeight fontWeight, int fontStyle, int synthesis) {
        ...
        if (Build.VERSION.SDK_INT < 28) {
            Typeface typefaceDefaultFromStyle = Typeface.defaultFromStyle(AndroidFontUtils_androidKt.m3510getAndroidTypefaceStyleFO1MlWM(fontWeight, fontStyle));
        ...
        return typefaceHelperMethodsApi28.create(typeface, fontWeight.getWeight(), FontStyle.m3552equalsimpl0(fontStyle, FontStyle.INSTANCE.m3556getItalic_LCdwA()));
    }
}
