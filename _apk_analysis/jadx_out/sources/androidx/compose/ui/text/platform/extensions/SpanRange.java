...
final /* data */ class SpanRange {
    ...
    public SpanRange(@NotNull Object obj, int i10, int i11) {
        p.k(obj, "span");
        this.span = obj;
        this.start = i10;
        this.end = i11;
    ...
    @NotNull
    public final SpanRange copy(@NotNull Object span, int start, int end) {
        p.k(span, "span");
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return p.f(this.span, spanRange.span) && this.start == spanRange.start && this.end == spanRange.end;
    }
