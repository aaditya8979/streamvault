...
@d(c = "androidx.compose.ui.input.pointer.SuspendingPointerInputFilterKt$pointerInput$2$2$1", f = "SuspendingPointerInputFilter.kt", l = {243}, m = "invokeSuspend")
public final class SuspendingPointerInputFilterKt$pointerInput$2$2$1 extends SuspendLambda implements p<l0, c<? super r>, Object> {
    ...
    public SuspendingPointerInputFilterKt$pointerInput$2$2$1(SuspendingPointerInputFilter suspendingPointerInputFilter, p<? super PointerInputScope, ? super c<? super r>, ? extends Object> pVar, c<? super SuspendingPointerInputFilterKt$pointerInput$2$2$1> cVar) {
        super(2, cVar);
    ...
    public final Object mo2invoke(@NotNull l0 l0Var, @Nullable c<? super r> cVar) {
        return ((SuspendingPointerInputFilterKt$pointerInput$2$2$1) create(l0Var, cVar)).invokeSuspend(r.f5635a);
    }
