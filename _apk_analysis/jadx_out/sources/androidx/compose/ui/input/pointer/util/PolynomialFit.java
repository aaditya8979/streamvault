...
public final /* data */ class PolynomialFit {
    ...
    @NotNull
    public final PolynomialFit copy(@NotNull List<Float> coefficients, float confidence) {
        p.k(coefficients, "coefficients");
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return p.f(this.coefficients, polynomialFit.coefficients) && p.f(Float.valueOf(this.confidence), Float.valueOf(polynomialFit.confidence));
    }
