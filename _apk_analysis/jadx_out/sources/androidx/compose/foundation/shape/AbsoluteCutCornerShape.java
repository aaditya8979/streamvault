...
public final class AbsoluteCutCornerShape extends CornerBasedShape {
    ...
    public AbsoluteCutCornerShape(@NotNull CornerSize cornerSize, @NotNull CornerSize cornerSize2, @NotNull CornerSize cornerSize3, @NotNull CornerSize cornerSize4) {
        ...
        p.k(cornerSize, "topLeft");
        p.k(cornerSize2, "topRight");
        p.k(cornerSize3, "bottomRight");
        p.k(cornerSize4, "bottomLeft");
    }
    ...
    public Outline mo644createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, @NotNull LayoutDirection layoutDirection) {
        ...
        Path.lineTo(Size.m1452getWidthimpl(size) - topEnd, 0.0f);
        Path.lineTo(Size.m1452getWidthimpl(size), topEnd);
        Path.lineTo(Size.m1452getWidthimpl(size), Size.m1449getHeightimpl(size) - bottomEnd);
        Path.lineTo(Size.m1452getWidthimpl(size) - bottomEnd, Size.m1449getHeightimpl(size));
        Path.lineTo(bottomStart, Size.m1449getHeightimpl(size));
        Path.lineTo(0.0f, Size.m1449getHeightimpl(size) - bottomStart);
        Path.close();
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return p.f(getTopStart(), absoluteCutCornerShape.getTopStart()) && p.f(getTopEnd(), absoluteCutCornerShape.getTopEnd()) && p.f(getBottomEnd(), absoluteCutCornerShape.getBottomEnd()) && p.f(getBottomStart(), absoluteCutCornerShape.getBottomStart());
    }
