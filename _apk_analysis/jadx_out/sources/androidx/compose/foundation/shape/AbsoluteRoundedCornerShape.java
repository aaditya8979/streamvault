...
public final class AbsoluteRoundedCornerShape extends CornerBasedShape {
    ...
    private final long m648toRadiusBz7bX_o(float f10) {
    ...
    public Outline mo644createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, @NotNull LayoutDirection layoutDirection) {
        ...
        return ((((topStart + topEnd) + bottomEnd) + bottomStart) > 0.0f ? 1 : ((((topStart + topEnd) + bottomEnd) + bottomStart) == 0.0f ? 0 : -1)) == 0 ? new Outline.Rectangle(SizeKt.m1473toRectuvyYCjk(size)) : new Outline.Rounded(RoundRectKt.m1435RoundRectZAM2FJo(SizeKt.m1473toRectuvyYCjk(size), CornerRadiusKt.CornerRadius$default(topStart, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(topEnd, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(bottomEnd, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(bottomStart, 0.0f, 2, null)));
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return p.f(getTopStart(), absoluteRoundedCornerShape.getTopStart()) && p.f(getTopEnd(), absoluteRoundedCornerShape.getTopEnd()) && p.f(getBottomEnd(), absoluteRoundedCornerShape.getBottomEnd()) && p.f(getBottomStart(), absoluteRoundedCornerShape.getBottomStart());
    }
