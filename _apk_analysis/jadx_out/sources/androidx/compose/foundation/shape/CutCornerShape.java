...
public final class CutCornerShape extends CornerBasedShape {
    ...
    public Outline mo644createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, @NotNull LayoutDirection layoutDirection) {
        ...
        Path.lineTo(Size.m1452getWidthimpl(size) - topStart, 0.0f);
        Path.lineTo(Size.m1452getWidthimpl(size), topStart);
        float f11 = layoutDirection == layoutDirection2 ? bottomEnd : bottomStart;
        Path.lineTo(Size.m1452getWidthimpl(size), Size.m1449getHeightimpl(size) - f11);
        Path.lineTo(Size.m1452getWidthimpl(size) - f11, Size.m1449getHeightimpl(size));
        if (layoutDirection == layoutDirection2) {
            bottomEnd = bottomStart;
        }
        Path.lineTo(bottomEnd, Size.m1449getHeightimpl(size));
        Path.lineTo(0.0f, Size.m1449getHeightimpl(size) - bottomEnd);
        Path.close();
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return p.f(getTopStart(), cutCornerShape.getTopStart()) && p.f(getTopEnd(), cutCornerShape.getTopEnd()) && p.f(getBottomEnd(), cutCornerShape.getBottomEnd()) && p.f(getBottomStart(), cutCornerShape.getBottomStart());
    }
