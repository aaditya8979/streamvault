...
final /* data */ class VerticalScrollLayoutModifier implements LayoutModifier {
    ...
    @NotNull
    public final VerticalScrollLayoutModifier copy(@NotNull TextFieldScrollerPosition textFieldScrollerPosition, int i10, @NotNull TransformedText transformedText, @NotNull a<TextLayoutResultProxy> aVar) {
        p.k(textFieldScrollerPosition, "scrollerPosition");
        p.k(transformedText, "transformedText");
        p.k(aVar, "textLayoutResultProvider");
        return new VerticalScrollLayoutModifier(textFieldScrollerPosition, i10, transformedText, aVar);
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return p.f(this.scrollerPosition, verticalScrollLayoutModifier.scrollerPosition) && this.cursorOffset == verticalScrollLayoutModifier.cursorOffset && p.f(this.transformedText, verticalScrollLayoutModifier.transformedText) && p.f(this.textLayoutResultProvider, verticalScrollLayoutModifier.textLayoutResultProvider);
    }
    ...
    public MeasureResult mo21measure3p2s80s(@NotNull final MeasureScope measureScope, @NotNull Measurable measurable, long j10) {
        ...
        final Placeable placeableMo3112measureBRTryo0 = measurable.mo3112measureBRTryo0(Constraints.m3773copyZbe2FdA$default(j10, 0, 0, 0, Integer.MAX_VALUE, 7, null));
        final int iMin = Math.min(placeableMo3112measureBRTryo0.getHeight(), Constraints.m3781getMaxHeightimpl(j10));
        return MeasureScope.layout$default(measureScope, placeableMo3112measureBRTryo0.getWidth(), iMin, null, new l<Placeable.PlacementScope, r>() { // from class: androidx.compose.foundation.text.VerticalScrollLayoutModifier$measure$1
            ...
            public final void invoke2(@NotNull Placeable.PlacementScope placementScope) {
                ...
                this.getScrollerPosition().update(Orientation.Vertical, TextFieldScrollKt.getCursorRectInScroller(measureScope2, cursorOffset, transformedText, textLayoutResultProxyInvoke != null ? textLayoutResultProxyInvoke.getValue() : null, false, placeableMo3112measureBRTryo0.getWidth()), iMin, placeableMo3112measureBRTryo0.getHeight());
                Placeable.PlacementScope.placeRelative$default(placementScope, placeableMo3112measureBRTryo0, 0, c.d(-this.getScrollerPosition().getOffset()), 0.0f, 4, null);
            }
        }, 4, null);
    }
