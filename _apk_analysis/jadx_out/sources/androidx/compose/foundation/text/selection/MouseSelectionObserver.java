...
public interface MouseSelectionObserver {
    ...
    boolean mo727onDrag3MmeM6k(long dragPosition, @NotNull SelectionAdjustment adjustment);

    /* JADX INFO: renamed from: onExtend-k-4lQ0M */
    boolean mo728onExtendk4lQ0M(long downPosition);

    /* JADX INFO: renamed from: onExtendDrag-k-4lQ0M */
    boolean mo729onExtendDragk4lQ0M(long dragPosition);

    /* JADX INFO: renamed from: onStart-3MmeM6k */
    boolean mo730onStart3MmeM6k(long downPosition, @NotNull SelectionAdjustment adjustment);
}
