...
public final class TextSelectionColorsKt {
    ...
    @NotNull
    private static final ProvidableCompositionLocal<SelectionColors> LocalTextSelectionColors = CompositionLocalKt.compositionLocalOf$default(null, new sn.a<SelectionColors>() { // from class: androidx.compose.foundation.text.selection.TextSelectionColorsKt$LocalTextSelectionColors$1
    ...
    static {
        ...
        DefaultTextSelectionColors = new SelectionColors(jColor, Color.m1618copywmQWz5c$default(jColor, 0.4f, 0.0f, 0.0f, 0.0f, 14, null), null);
    }
