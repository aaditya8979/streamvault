...
public final class TextFieldSelectionManager_androidKt {
    ...
    public static final class AnonymousClass1 extends Lambda implements q<Modifier, Composer, Integer, Modifier> {
        ...
        public static final long m861invoke$lambda1(MutableState<IntSize> mutableState) {
            return mutableState.getValue().getPackedValue();
        }

        /* JADX INFO: Access modifiers changed from: private */
        /* JADX INFO: renamed from: invoke$lambda-2, reason: not valid java name */
        public static final void m862invoke$lambda2(MutableState<IntSize> mutableState, long j10) {
        ...
        public final Modifier invoke(@NotNull Modifier modifier, @Nullable Composer composer, int i10) {
            ...
            Modifier modifierAnimatedSelectionMagnifier = SelectionMagnifierKt.animatedSelectionMagnifier(modifier, new sn.a<Offset>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt.textFieldMagnifier.1.1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(0);
                }
                ...
                public /* bridge */ /* synthetic */ Offset invoke() {
                    return Offset.m1372boximpl(m863invokeF1C5BW0());
                }

                /* JADX INFO: renamed from: invoke-F1C5BW0, reason: not valid java name */
                public final long m863invokeF1C5BW0() {
                    return TextFieldSelectionManagerKt.m858calculateSelectionMagnifierCenterAndroidO0kMr_c(textFieldSelectionManager, AnonymousClass1.m861invoke$lambda1(mutableState));
                }
            }, new l<sn.a<? extends Offset>, Modifier>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt.textFieldMagnifier.1.2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final Modifier invoke2(@NotNull final sn.a<Offset> aVar) {
                    ...
                    l<Density, Offset> lVar = new l<Density, Offset>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt.textFieldMagnifier.1.2.1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(1);
                        }
                        ...
                        public /* bridge */ /* synthetic */ Offset invoke(Density density2) {
                            return Offset.m1372boximpl(m864invoketuRUvjQ(density2));
                        }

                        /* JADX INFO: renamed from: invoke-tuRUvjQ, reason: not valid java name */
                        public final long m864invoketuRUvjQ(@NotNull Density density2) {
                    ...
                    return MagnifierKt.magnifier$default(companion, lVar, null, 0.0f, textDefault, new l<DpSize, r>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt.textFieldMagnifier.1.2.2
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(1);
                        }
                        ...
                        public /* bridge */ /* synthetic */ r invoke(DpSize dpSize) {
                            m865invokeEaSLcWc(dpSize.getPackedValue());
                            return r.f5635a;
                        }

                        /* JADX INFO: renamed from: invoke-EaSLcWc, reason: not valid java name */
                        public final void m865invokeEaSLcWc(long j10) {
                            MutableState<IntSize> mutableState3 = mutableState2;
                            Density density3 = density2;
                            AnonymousClass1.m862invoke$lambda2(mutableState3, IntSizeKt.IntSize(density3.mo300roundToPx0680j_4(DpSize.m3924getWidthD9Ej5fM(j10)), density3.mo300roundToPx0680j_4(DpSize.m3922getHeightD9Ej5fM(j10))));
                        }
                    }, 6, null);
                }
