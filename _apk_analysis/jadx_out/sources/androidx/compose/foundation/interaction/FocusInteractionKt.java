...
public final class FocusInteractionKt {
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements p<l0, c<? super r>, Object> {
        ...
        public final c<r> create(@Nullable Object obj, @NotNull c<?> cVar) {
            return new AnonymousClass1(this.$this_collectIsFocusedAsState, this.$isFocused, cVar);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i10 == 0) {
                ...
                go.d<Interaction> interactions = this.$this_collectIsFocusedAsState.getInteractions();
                final MutableState<Boolean> mutableState = this.$isFocused;
                e<Interaction> eVar = new e<Interaction>() { // from class: androidx.compose.foundation.interaction.FocusInteractionKt.collectIsFocusedAsState.1.1
                    @Nullable
    ...
    @Composable
    @NotNull
    public static final State<Boolean> collectIsFocusedAsState(@NotNull InteractionSource interactionSource, @Nullable Composer composer, int i10) {
