...
public final class PressInteractionKt {
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements p<l0, c<? super r>, Object> {
        ...
        public final c<r> create(@Nullable Object obj, @NotNull c<?> cVar) {
            return new AnonymousClass1(this.$this_collectIsPressedAsState, this.$isPressed, cVar);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i10 == 0) {
                ...
                go.d<Interaction> interactions = this.$this_collectIsPressedAsState.getInteractions();
                final MutableState<Boolean> mutableState = this.$isPressed;
                e<Interaction> eVar = new e<Interaction>() { // from class: androidx.compose.foundation.interaction.PressInteractionKt.collectIsPressedAsState.1.1
                    @Nullable
