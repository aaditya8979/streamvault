...
public final class DragInteractionKt {
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements p<l0, c<? super r>, Object> {
        ...
        public final c<r> create(@Nullable Object obj, @NotNull c<?> cVar) {
            return new AnonymousClass1(this.$this_collectIsDraggedAsState, this.$isDragged, cVar);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i10 == 0) {
                ...
                go.d<Interaction> interactions = this.$this_collectIsDraggedAsState.getInteractions();
                final MutableState<Boolean> mutableState = this.$isDragged;
                e<Interaction> eVar = new e<Interaction>() { // from class: androidx.compose.foundation.interaction.DragInteractionKt.collectIsDraggedAsState.1.1
                    @Nullable
