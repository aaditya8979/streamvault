...
final class ExcludeInsets implements WindowInsets {
    ...
    public ExcludeInsets(@NotNull WindowInsets windowInsets, @NotNull WindowInsets windowInsets2) {
        p.k(windowInsets, "included");
        p.k(windowInsets2, "excluded");
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return p.f(excludeInsets.included, this.included) && p.f(excludeInsets.excluded, this.excluded);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getBottom(@NotNull Density density) {
        p.k(density, "density");
        return n.e(this.included.getBottom(density) - this.excluded.getBottom(density), 0);
    }
    ...
    public int getLeft(@NotNull Density density, @NotNull LayoutDirection layoutDirection) {
        ...
        return n.e(this.included.getLeft(density, layoutDirection) - this.excluded.getLeft(density, layoutDirection), 0);
    }
    ...
    public int getRight(@NotNull Density density, @NotNull LayoutDirection layoutDirection) {
        p.k(density, "density");
        p.k(layoutDirection, "layoutDirection");
        return n.e(this.included.getRight(density, layoutDirection) - this.excluded.getRight(density, layoutDirection), 0);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getTop(@NotNull Density density) {
        p.k(density, "density");
        return n.e(this.included.getTop(density) - this.excluded.getTop(density), 0);
    }
