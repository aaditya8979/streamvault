...
final class InsetsPaddingValues implements PaddingValues {
    ...
    public float getBottom() {
        ...
        return density.mo303toDpu2uoSUM(this.insets.getBottom(density));
    }
    ...
    public float mo392calculateLeftPaddingu2uoSUM(@NotNull LayoutDirection layoutDirection) {
        ...
        Density density = this.density;
        return density.mo303toDpu2uoSUM(this.insets.getLeft(density, layoutDirection));
    }
    ...
    public float mo393calculateRightPaddingu2uoSUM(@NotNull LayoutDirection layoutDirection) {
        p.k(layoutDirection, "layoutDirection");
        Density density = this.density;
        return density.mo303toDpu2uoSUM(this.insets.getRight(density, layoutDirection));
    }
    ...
    public float getTop() {
        Density density = this.density;
        return density.mo303toDpu2uoSUM(this.insets.getTop(density));
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return p.f(this.insets, insetsPaddingValues.insets) && p.f(this.density, insetsPaddingValues.density);
    }
