...
public final class LazyGridItemPlacementAnimator$getAnimatedOffset$1 extends SuspendLambda implements p<l0, c<? super r>, Object> {
    ...
    public final Object mo2invoke(@NotNull l0 l0Var, @Nullable c<? super r> cVar) {
        return ((LazyGridItemPlacementAnimator$getAnimatedOffset$1) create(l0Var, cVar)).invokeSuspend(r.f5635a);
    }
