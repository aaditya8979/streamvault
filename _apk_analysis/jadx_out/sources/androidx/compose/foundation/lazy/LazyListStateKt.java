...
public final class LazyListStateKt {
    ...
    public static final LazyListState rememberLazyListState(final int i10, final int i11, @Nullable Composer composer, int i12, int i13) {
        ...
        LazyListState lazyListState = (LazyListState) RememberSaveableKt.m1287rememberSaveable(new Object[0], (Saver) LazyListState.INSTANCE.getSaver(), (String) null, (a) new a<LazyListState>() { // from class: androidx.compose.foundation.lazy.LazyListStateKt.rememberLazyListState.1
