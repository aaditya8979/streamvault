...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    public String generateActivityResultKey() {
        return FragmentManager.FRAGMENT_NAME_PREFIX + this.mWho + "_rq#" + this.mNextLocalRequestCode.getAndIncrement();
    }
    ...
    public void performSaveInstanceState(Bundle bundle) {
        ...
        if (bundleSaveAllStateInternal != null) {
            bundle.putParcelable(FragmentManager.SAVED_STATE_TAG, bundleSaveAllStateInternal);
        }
    }
