...
abstract class SpecialEffectsController {
    ...
    public static class Operation {
        ...
        public String toString() {
            return "Operation " + com.safedk.android.analytics.brandsafety.creatives.discoveries.h.f52301d + Integer.toHexString(System.identityHashCode(this)) + "} " + com.safedk.android.analytics.brandsafety.creatives.discoveries.h.f52301d + "mFinalState = " + this.mFinalState + "} " + com.safedk.android.analytics.brandsafety.creatives.discoveries.h.f52301d + "mLifecycleImpact = " + this.mLifecycleImpact + "} " + com.safedk.android.analytics.brandsafety.creatives.discoveries.h.f52301d + "mFragment = " + this.mFragment + com.safedk.android.analytics.brandsafety.creatives.discoveries.h.f52302e;
        }
    }
