...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    private final Consumer<Configuration> mOnConfigurationChangedListener = new Consumer() { // from class: androidx.fragment.app.f
        ...
        public final void accept(Object obj) {
            this.f4331b.lambda$new$0((Configuration) obj);
        }
    };
    private final Consumer<Integer> mOnTrimMemoryListener = new Consumer() { // from class: androidx.fragment.app.g
        @Override // androidx.core.util.Consumer
        public final void accept(Object obj) {
            this.f4332b.lambda$new$1((Integer) obj);
        }
    };
    private final Consumer<MultiWindowModeChangedInfo> mOnMultiWindowModeChangedListener = new Consumer() { // from class: androidx.fragment.app.h
        @Override // androidx.core.util.Consumer
        public final void accept(Object obj) {
            this.f4333b.lambda$new$2((MultiWindowModeChangedInfo) obj);
        }
    };
    private final Consumer<PictureInPictureModeChangedInfo> mOnPictureInPictureModeChangedListener = new Consumer() { // from class: androidx.fragment.app.i
        @Override // androidx.core.util.Consumer
        public final void accept(Object obj) {
            this.f4334b.lambda$new$3((PictureInPictureModeChangedInfo) obj);
        }
    };
        ...
        if ((obj instanceof SavedStateRegistryOwner) && fragment == null) {
            ...
            savedStateRegistry.registerSavedStateProvider(SAVED_STATE_TAG, new SavedStateRegistry.SavedStateProvider() { // from class: androidx.fragment.app.j
                ...
                public final Bundle saveState() {
                    return this.f4335a.lambda$attachController$4();
                }
            });
    ...
    public boolean restoreBackStackState(@NonNull ArrayList<BackStackRecord> arrayList, @NonNull ArrayList<Boolean> arrayList2, @NonNull String str) {
        ...
        while (true) {
            while (it2.hasNext()) {
                z10 = it2.next().generateOps(arrayList, arrayList2) || z10;
            }
            return z10;
        }
    }
    ...
    public void restoreSaveStateInternal(@Nullable Parcelable parcelable) {
        ...
        if (fragmentManagerState.mBackStack != null) {
            ...
            while (true) {
                ...
                BackStackRecord backStackRecordInstantiate = backStackRecordStateArr[i10].instantiate(this);
                if (isLoggingEnabled(2)) {
                    Log.v(TAG, "restoreAllState: back stack #" + i10 + " (index " + backStackRecordInstantiate.mIndex + "): " + backStackRecordInstantiate);
                    PrintWriter printWriter = new PrintWriter(new LogWriter(TAG));
    ...
    public boolean saveBackStackState(@NonNull ArrayList<BackStackRecord> arrayList, @NonNull ArrayList<Boolean> arrayList2, @NonNull String str) {
        ...
        for (int i12 = iFindBackStackIndex; i12 < this.mBackStack.size(); i12++) {
            ...
            for (FragmentTransaction.Op op2 : backStackRecord2.mOps) {
                Fragment fragment = op2.mFragment;
                if (fragment != null) {
                    if (!op2.mFromExpandedOp || (i10 = op2.mCmd) == 1 || i10 == 2 || i10 == 8) {
            ...
            if (!hashSet2.isEmpty()) {
                ...
                sb2.append(hashSet2.size() == 1 ? Z7.f30794r + hashSet2.iterator().next() : "s " + hashSet2);
                sb2.append(" in ");
