    ...
    public class MenuState {
        ...
        public void readItem(AttributeSet attributeSet) {
            ...
            if (tintTypedArrayObtainStyledAttributes.hasValue(i10)) {
                this.itemCheckable = tintTypedArrayObtainStyledAttributes.getBoolean(i10, false) ? 1 : 0;
            } else {
            ...
            if (tintTypedArrayObtainStyledAttributes.hasValue(i11)) {
                this.itemIconTintMode = DrawableUtils.parseTintMode(tintTypedArrayObtainStyledAttributes.getInt(i11, -1), this.itemIconTintMode);
            } else {
                this.itemIconTintMode = null;
            }
            int i12 = R.styleable.MenuItem_iconTint;
            if (tintTypedArrayObtainStyledAttributes.hasValue(i12)) {
                this.itemIconTintList = tintTypedArrayObtainStyledAttributes.getColorStateList(i12);
            } else {
