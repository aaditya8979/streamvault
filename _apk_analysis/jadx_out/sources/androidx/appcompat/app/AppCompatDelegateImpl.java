...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    private int getActivityHandlesConfigChangesFlags(Context context) {
        if (!this.mActivityHandlesConfigFlagsChecked && (this.mHost instanceof Activity)) {
            ...
            try {
                ...
                Log.d(AppCompatDelegate.TAG, "Exception while getting ActivityInfo", e10);
    ...
    */
    ...
    public Context attachBaseContext2(@NonNull Context context) {
        ...
        Configuration configurationCreateOverrideAppConfiguration = createOverrideAppConfiguration(context, iMapNightMode, localeListCompatCalculateApplicationLocales, configuration2.equals(configuration3) ? null : generateConfigDelta(configuration2, configuration3), true);
        ...
        if (this.mAppCompatViewInflater == null) {
            ...
            if (string == null) {
                ...
                try {
                    ...
                    Log.i(AppCompatDelegate.TAG, "Failed to instantiate custom view inflater " + string + ". Falling back to default.", th2);
                    this.mAppCompatViewInflater = new AppCompatViewInflater();
                }
            }
        }
    ...
    public boolean hasWindowFeature(int i10) {
        ...
        return (iSanitizeWindowFeatureId != 1 ? iSanitizeWindowFeatureId != 2 ? iSanitizeWindowFeatureId != 5 ? iSanitizeWindowFeatureId != 10 ? iSanitizeWindowFeatureId != 108 ? iSanitizeWindowFeatureId != 109 ? false : this.mOverlayActionBar : this.mHasActionBar : this.mOverlayActionMode : this.mFeatureIndeterminateProgress : this.mFeatureProgress : this.mWindowNoTitle) || this.mWindow.hasFeature(i10);
    }
