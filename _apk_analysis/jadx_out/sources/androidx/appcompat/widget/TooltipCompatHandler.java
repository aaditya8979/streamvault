...
class TooltipCompatHandler implements View.OnLongClickListener, View.OnHoverListener, View.OnAttachStateChangeListener {
    ...
    private final Runnable mShowRunnable = new Runnable() { // from class: androidx.appcompat.widget.q
        @Override // java.lang.Runnable
        public final void run() {
            this.f4059b.lambda$new$0();
        }
    };
    private final Runnable mHideRunnable = new Runnable() { // from class: androidx.appcompat.widget.r
        @Override // java.lang.Runnable
        public final void run() {
            this.f4060b.hide();
        }
