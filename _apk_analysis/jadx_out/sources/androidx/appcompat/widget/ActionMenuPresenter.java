...
class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    public boolean flagActionItems() {
        ...
        int i12 = actionMenuPresenter.mMaxItems;
        int i13 = actionMenuPresenter.mActionItemWidthLimit;
        ...
        if (actionMenuPresenter.mReserveOverflow && (z10 || i15 + i14 > i12)) {
            i12--;
        }
        int i17 = i12 - i14;
        ...
        if (actionMenuPresenter.mStrictWidthLimit) {
            int i18 = actionMenuPresenter.mMinCellSize;
        ...
        while (i19 < size) {
            ...
            if (menuItemImpl2.requiresActionButton()) {
                ...
                boolean z12 = (i17 > 0 || z11) && i13 > 0 && (!r03.mStrictWidthLimit || iMeasureChildForCells > 0);
                boolean z13 = z12;
                i11 = size;
                if (z12) {
                    ...
                    z12 = z14 & (!r03.mStrictWidthLimit ? i13 + i20 <= 0 : i13 < 0);
                }
                if (z12 && groupId2 != 0) {
