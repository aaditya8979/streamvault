...
public class Toolbar extends ViewGroup implements MenuHost {
    ...
    public Toolbar(@NonNull Context context, @Nullable AttributeSet attributeSet, int i10) {
        ...
        this.mMenuHostHelper = new MenuHostHelper(new Runnable() { // from class: androidx.appcompat.widget.m
            @Override // java.lang.Runnable
            public final void run() {
                this.f4056b.invalidateMenu();
            }
        });
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            ...
            if (z10 && this.mBackInvokedDispatcher == null) {
                if (this.mBackInvokedCallback == null) {
                    this.mBackInvokedCallback = Api33Impl.newOnBackInvokedCallback(new Runnable() { // from class: androidx.appcompat.widget.n
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f4057b.collapseActionView();
                        }
                    });
                }
