...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            return "SearchView.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " isIconified=" + this.isIconified + com.safedk.android.analytics.brandsafety.creatives.discoveries.h.f52302e;
        }
    ...
    public SearchView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i10) {
        ...
        int i12 = tintTypedArrayObtainStyledAttributes.getInt(R.styleable.SearchView_android_imeOptions, -1);
        if (i12 != -1) {
            setImeOptions(i12);
        }
        int i13 = tintTypedArrayObtainStyledAttributes.getInt(R.styleable.SearchView_android_inputType, -1);
        if (i13 != -1) {
            setInputType(i13);
        }
    ...
    public void launchQuerySearch(int i10, String str, String str2) {
        safedk_Context_startActivity_97cb3195734cf5c9cc3418feeafa6dd6(getContext(), createIntent("android.intent.action.SEARCH", null, null, str2, i10, str));
    }
