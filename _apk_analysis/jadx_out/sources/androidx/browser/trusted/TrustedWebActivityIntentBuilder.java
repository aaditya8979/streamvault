...
public class TrustedWebActivityIntentBuilder {
    ...
    @NonNull
    public TrustedWebActivityIntentBuilder setColorScheme(int i10) {
        this.mIntentBuilder.setColorScheme(i10);
        return this;
    }

    @NonNull
    public TrustedWebActivityIntentBuilder setColorSchemeParams(int i10, @NonNull CustomTabColorSchemeParams customTabColorSchemeParams) {
        this.mIntentBuilder.setColorSchemeParams(i10, customTabColorSchemeParams);
        return this;
    }
    ...
    @NonNull
    @Deprecated
    public TrustedWebActivityIntentBuilder setNavigationBarColor(@ColorInt int i10) {
        this.mIntentBuilder.setNavigationBarColor(i10);
        return this;
    }

    @NonNull
    @Deprecated
    public TrustedWebActivityIntentBuilder setNavigationBarDividerColor(@ColorInt int i10) {
        this.mIntentBuilder.setNavigationBarDividerColor(i10);
        return this;
    }

    @NonNull
    public TrustedWebActivityIntentBuilder setScreenOrientation(int i10) {
    ...
    @NonNull
    @Deprecated
    public TrustedWebActivityIntentBuilder setToolbarColor(@ColorInt int i10) {
        this.mIntentBuilder.setToolbarColor(i10);
        return this;
    }
}
