...
public final class CustomTabsSession {
    ...
    public class AnonymousClass1 extends IEngagementSignalsCallback.Stub {
        ...
        public void onGreatestScrollPercentageIncreased(final int i10, final Bundle bundle) {
            ...
            handler.post(new Runnable() { // from class: androidx.browser.customtabs.d
                ...
                public final void run() {
                    engagementSignalsCallback.onGreatestScrollPercentageIncreased(i10, bundle);
                }
            });
        }
        ...
        public void onSessionEnded(final boolean z10, final Bundle bundle) {
            ...
            handler.post(new Runnable() { // from class: androidx.browser.customtabs.c
                @Override // java.lang.Runnable
                public final void run() {
                    engagementSignalsCallback.onSessionEnded(z10, bundle);
                }
            });
        }
        ...
        public void onVerticalScrollEvent(final boolean z10, final Bundle bundle) {
            ...
            handler.post(new Runnable() { // from class: androidx.browser.customtabs.b
                @Override // java.lang.Runnable
                public final void run() {
                    engagementSignalsCallback.onVerticalScrollEvent(z10, bundle);
                }
            });
        }
    }
    ...
    public boolean receiveFile(@NonNull Uri uri, int i10, @Nullable Bundle bundle) {
        try {
            return this.mService.receiveFile(this.mCallback, uri, i10, createBundleWithId(bundle));
        } catch (RemoteException unused) {
            return false;
        }
    }
    ...
    public boolean validateRelationship(int i10, @NonNull Uri uri, @Nullable Bundle bundle) {
        if (i10 >= 1 && i10 <= 2) {
            try {
                return this.mService.validateRelationship(this.mCallback, i10, uri, createBundleWithId(bundle));
            } catch (RemoteException unused) {
            }
        }
        return false;
