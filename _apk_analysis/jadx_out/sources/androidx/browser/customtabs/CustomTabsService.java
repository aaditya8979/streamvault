...
public abstract class CustomTabsService extends Service {
    ...
    public class AnonymousClass1 extends ICustomTabsService.Stub {
        ...
        private Uri getTargetOriginFromBundle(@Nullable Bundle bundle) {
            ...
            return Build.VERSION.SDK_INT >= 33 ? (Uri) Api33Impl.getParcelable(bundle, CustomTabsSession.TARGET_ORIGIN_KEY, Uri.class) : (Uri) bundle.getParcelable(CustomTabsSession.TARGET_ORIGIN_KEY);
        }
            ...
            try {
                IBinder.DeathRecipient deathRecipient = new IBinder.DeathRecipient() { // from class: androidx.browser.customtabs.a
                    ...
                    public final void binderDied() {
                        this.f4061b.lambda$newSessionInternal$0(customTabsSessionToken);
                    }
                };
        ...
        public boolean receiveFile(@NonNull ICustomTabsCallback iCustomTabsCallback, @NonNull Uri uri, int i10, @Nullable Bundle bundle) {
            return CustomTabsService.this.receiveFile(new CustomTabsSessionToken(iCustomTabsCallback, getSessionIdFromBundle(bundle)), uri, i10, bundle);
        }
        ...
        public boolean validateRelationship(@NonNull ICustomTabsCallback iCustomTabsCallback, int i10, @NonNull Uri uri, @Nullable Bundle bundle) {
            return CustomTabsService.this.validateRelationship(new CustomTabsSessionToken(iCustomTabsCallback, getSessionIdFromBundle(bundle)), i10, uri, bundle);
        }
    ...
    public abstract boolean receiveFile(@NonNull CustomTabsSessionToken customTabsSessionToken, @NonNull Uri uri, int i10, @Nullable Bundle bundle);
    ...
    public abstract boolean validateRelationship(@NonNull CustomTabsSessionToken customTabsSessionToken, int i10, @NonNull Uri uri, @Nullable Bundle bundle);
