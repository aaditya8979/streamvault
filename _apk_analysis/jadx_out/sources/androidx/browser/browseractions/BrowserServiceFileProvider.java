...
public final class BrowserServiceFileProvider extends FileProvider {
    ...
    public static class FileCleanupTask extends AsyncTask<Void, Void, Void> {
        ...
        public Void doInBackground(Void... voidArr) {
            ...
            synchronized (BrowserServiceFileProvider.sFileCleanupLock) {
                ...
                long jCurrentTimeMillis2 = z10 ? System.currentTimeMillis() : (System.currentTimeMillis() - CLEANUP_REQUIRED_TIME_SPAN) + DELETION_FAILED_REATTEMPT_DURATION;
    ...
    @NonNull
    public static i<Bitmap> loadBitmap(@NonNull final ContentResolver contentResolver, @NonNull final Uri uri) {
