...
public class YogaNative {
    ...
    public static native int jni_YGNodeStyleGetBoxSizingJNI(long j10);
    ...
    public static native void jni_YGNodeStyleSetBoxSizingJNI(long j10, int i10);
    ...
    public static native void jni_YGNodeStyleSetGapPercentJNI(long j10, int i10, float f10);
    ...
    public static native void jni_YGNodeStyleSetPositionAutoJNI(long j10, int i10);
