...
public final class pno {
    ...
    private static final ThreadLocal<Path> f11976lh = new ThreadLocal<Path>() { // from class: com.bytedance.adsdk.vt.le.pno.3
        @Override // java.lang.ThreadLocal
        public final /* synthetic */ Path initialValue() {
            return new Path();
        }
    ...
    public static void ouw(Canvas canvas, RectF rectF, Paint paint, int i10) {
    ...
    public static void ouw(Path path, zin zinVar) {
        ...
        ouw(path, ((com.bytedance.adsdk.vt.ouw.vt.yu) zinVar.f12140lh).pno() / 100.0f, ((com.bytedance.adsdk.vt.ouw.vt.yu) zinVar.yu).pno() / 100.0f, ((com.bytedance.adsdk.vt.ouw.vt.yu) zinVar.fkw).pno() / 360.0f);
    }
    ...
    public static boolean ouw(int i10, int i11, int i12) {
        if (i10 < 4) {
            return false;
        }
        if (i10 > 4) {
