...
public final class le {
    ...
    public static void ouw(FrameLayout frameLayout, vpp vppVar) {
        ...
        pnoVar4.setTextColor(ViewCompat.MEASURED_STATE_MASK);
        ...
        viewCreatePAGLogoViewByMaterial.setId(rn.f14362pd);
