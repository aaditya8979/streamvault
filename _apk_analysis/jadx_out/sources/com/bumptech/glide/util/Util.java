...
public final class Util {
    ...
    public static int getBitmapByteSize(@NonNull Bitmap bitmap) {
        ...
        throw new IllegalStateException("Cannot obtain size for recycled Bitmap: " + bitmap + C3978d4.j.f31383d + bitmap.getWidth() + VastAttributes.HORIZONTAL_POSITION + bitmap.getHeight() + "] " + bitmap.getConfig());
    }
