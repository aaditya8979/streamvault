...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        ...
        this.header.currentFrame.f11255ih = readShort();
        int i10 = read();
        ...
        while (true) {
            try {
                ...
                if (Log.isLoggable(TAG, 3)) {
                    Log.d(TAG, "Error Reading Block n: " + i11 + " count: " + i12 + " blockSize: " + this.blockSize, e10);
                }
                this.header.status = 1;
                return;
            }
    ...
    private void readContents(int i10) {
        ...
        while (!z10 && !err() && this.header.frameCount <= i10) {
            ...
            if (i11 == 33) {
                ...
                if (i12 == 1) {
                    skip();
                } else if (i12 == LABEL_GRAPHIC_CONTROL_EXTENSION) {
                    this.header.currentFrame = new GifFrame();
                    readGraphicControlExt();
                } else if (i12 == LABEL_COMMENT_EXTENSION) {
                    skip();
                } else if (i12 != 255) {
                    skip();
                } else {
                    ...
                    for (int i13 = 0; i13 < 11; i13++) {
                        sb2.append((char) this.block[i13]);
                    }
    ...
    private void readGraphicControlExt() {
        ...
        gifFrame.transparency = (i10 & 1) != 0;
        int i12 = readShort();
        if (i12 < 2) {
            i12 = 10;
        }
        GifFrame gifFrame2 = this.header.currentFrame;
        gifFrame2.delay = i12 * 10;
    ...
    private void readLSD() {
        ...
        int i10 = read();
        GifHeader gifHeader = this.header;
        gifHeader.gctFlag = (i10 & 128) != 0;
        gifHeader.gctSize = (int) Math.pow(2.0d, (i10 & 7) + 1);
    ...
    private void skip() {
        ...
        do {
            i10 = read();
            this.rawData.position(Math.min(this.rawData.position() + i10, this.rawData.limit()));
        } while (i10 > 0);
    }
