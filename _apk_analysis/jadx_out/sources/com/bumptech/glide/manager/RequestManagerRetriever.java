    ...
    public boolean handleMessage(Message message) {
        ...
        if (i10 != 1) {
            if (i10 != 2) {
                ...
                if (verifyOurSupportFragmentWasAddedOrCantBeAdded(fragmentManager3, z12)) {
            ...
            if (verifyOurFragmentWasAddedOrCantBeAdded(fragmentManager4, z12)) {
        ...
        if (Log.isLoggable(TAG, 5) && z10 && objRemove == null) {
