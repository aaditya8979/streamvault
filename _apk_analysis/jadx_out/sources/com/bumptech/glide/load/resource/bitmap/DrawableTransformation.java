...
public class DrawableTransformation implements Transformation<Drawable> {
    ...
    public Resource<Drawable> transform(@NonNull Context context, @NonNull Resource<Drawable> resource, int i10, int i11) {
        ...
        Resource<Bitmap> resourceConvert = DrawableToBitmapConverter.convert(bitmapPool, drawable, i10, i11);
        if (resourceConvert != null) {
            Resource<Bitmap> resourceTransform = this.wrapped.transform(context, resourceConvert, i10, i11);
