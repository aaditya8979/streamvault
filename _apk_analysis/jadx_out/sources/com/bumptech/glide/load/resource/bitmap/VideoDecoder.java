...
public class VideoDecoder<T> implements ResourceDecoder<T, Bitmap> {
    ...
    private static Bitmap decodeFrame(MediaMetadataRetriever mediaMetadataRetriever, long j10, int i10, int i11, int i12, DownsampleStrategy downsampleStrategy) {
        Bitmap bitmapDecodeScaledFrame = (Build.VERSION.SDK_INT < 27 || i11 == Integer.MIN_VALUE || i12 == Integer.MIN_VALUE || downsampleStrategy == DownsampleStrategy.NONE) ? null : decodeScaledFrame(mediaMetadataRetriever, j10, i10, i11, i12, downsampleStrategy);
        if (bitmapDecodeScaledFrame == null) {
            bitmapDecodeScaledFrame = decodeOriginalFrame(mediaMetadataRetriever, j10, i10);
        }
        if (bitmapDecodeScaledFrame != null) {
    ...
    public Resource<Bitmap> decode(@NonNull T t10, int i10, int i11, @NonNull Options options) throws IOException {
        ...
        try {
            this.initializer.initialize(mediaMetadataRetrieverBuild, t10);
            return BitmapResource.obtain(decodeFrame(mediaMetadataRetrieverBuild, jLongValue, num.intValue(), i10, i11, downsampleStrategy2), this.bitmapPool);
        } finally {
