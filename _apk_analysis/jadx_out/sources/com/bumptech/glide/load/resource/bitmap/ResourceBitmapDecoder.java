...
public class ResourceBitmapDecoder implements ResourceDecoder<Uri, Bitmap> {
    ...
    public Resource<Bitmap> decode(@NonNull Uri uri, int i10, int i11, @NonNull Options options) {
        Resource<Drawable> resourceDecode = this.drawableDecoder.decode(uri, i10, i11, options);
        if (resourceDecode == null) {
            return null;
        }
        return DrawableToBitmapConverter.convert(this.bitmapPool, resourceDecode.get(), i10, i11);
    }
