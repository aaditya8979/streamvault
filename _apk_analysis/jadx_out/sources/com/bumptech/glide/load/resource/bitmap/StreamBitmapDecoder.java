...
public class StreamBitmapDecoder implements ResourceDecoder<InputStream, Bitmap> {
    ...
    public Resource<Bitmap> decode(@NonNull InputStream inputStream, int i10, int i11, @NonNull Options options) throws IOException {
        ...
        try {
            return this.downsampler.decode(new MarkEnforcingInputStream(exceptionPassthroughInputStreamObtain), i10, i11, options, new UntrustedCallbacks(recyclableBufferedInputStream, exceptionPassthroughInputStreamObtain));
        } finally {
