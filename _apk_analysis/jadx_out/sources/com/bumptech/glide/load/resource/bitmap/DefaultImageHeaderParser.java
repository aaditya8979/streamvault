...
public final class DefaultImageHeaderParser implements ImageHeaderParser {
    ...
    public static final class ByteBufferReader implements Reader {
        ...
        public long skip(long j10) {
            int iMin = (int) Math.min(this.byteBuffer.remaining(), j10);
    ...
    public static final class StreamReader implements Reader {
        ...
        private final InputStream f11264is;

        public StreamReader(InputStream inputStream) {
            this.f11264is = inputStream;
        }
        ...
        public int read(byte[] bArr, int i10) throws IOException {
            int i11 = 0;
            int i12 = 0;
            while (i11 < i10 && (i12 = this.f11264is.read(bArr, i11, i10 - i11)) != -1) {
                i11 += i12;
            }
            if (i11 == 0 && i12 == -1) {
                throw new Reader.EndOfFileException();
        ...
        public long skip(long j10) throws IOException {
            ...
            long j11 = j10;
            while (j11 > 0) {
                long jSkip = this.f11264is.skip(j11);
                if (jSkip <= 0) {
                    if (this.f11264is.read() == -1) {
                        break;
                    }
                    jSkip = 1;
                }
    ...
    private static boolean handles(int i10) {
        return (i10 & EXIF_MAGIC_NUMBER) == 65496 || i10 == MOTOROLA_TIFF_MAGIC_NUMBER || i10 == INTEL_TIFF_MAGIC_NUMBER;
    }
    ...
    private boolean sniffAvif(Reader reader, int i10) throws IOException {
