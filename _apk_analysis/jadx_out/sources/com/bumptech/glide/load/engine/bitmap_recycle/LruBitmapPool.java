...
public class LruBitmapPool implements BitmapPool {
    ...
    public static class ThrowingBitmapTracker implements BitmapTracker {
        ...
        public void add(Bitmap bitmap) {
            ...
            throw new IllegalStateException("Can't add already added bitmap: " + bitmap + " [" + bitmap.getWidth() + VastAttributes.HORIZONTAL_POSITION + bitmap.getHeight() + C3978d4.j.f31385e);
        }
