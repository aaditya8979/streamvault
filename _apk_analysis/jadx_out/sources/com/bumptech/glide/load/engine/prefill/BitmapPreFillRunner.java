    ...
    public boolean allocate() {
        ...
        while (!this.toPrefill.isEmpty() && !isGcDetected(jNow)) {
            ...
            if (Log.isLoggable(TAG, 3)) {
                Log.d(TAG, "allocated [" + preFillTypeRemove.getWidth() + VastAttributes.HORIZONTAL_POSITION + preFillTypeRemove.getHeight() + "] " + preFillTypeRemove.getConfig() + " size: " + bitmapByteSize);
            }
        }
