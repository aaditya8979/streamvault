...
public final class DivSliderView extends SliderView implements DivHolderView<Div.m> {
    private final /* synthetic */ DivHolderViewMixin<Div.m> $$delegate_0;
    ...
    public /* synthetic */ DivSliderView(Context context, AttributeSet attributeSet, int i10, int i11, i iVar) {
    ...
    @Nullable
    public Div.m getDiv() {
        return (Div.m) this.$$delegate_0.getDiv();
    }
    ...
    @Override // com.yandex.div.core.view2.divs.widgets.DivHolderView
    public void setDiv(@Nullable Div.m mVar) {
