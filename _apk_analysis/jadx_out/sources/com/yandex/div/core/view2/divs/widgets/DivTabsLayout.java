...
public class DivTabsLayout extends TabsLayout implements DivHolderView<Div.p> {
    private final /* synthetic */ DivHolderViewMixin<Div.p> $$delegate_0;
    ...
    public /* synthetic */ DivTabsLayout(Context context, AttributeSet attributeSet, int i10, i iVar) {
    ...
    @Nullable
    public Div.p getDiv() {
        return (Div.p) this.$$delegate_0.getDiv();
    }
    ...
    @Override // com.yandex.div.core.view2.divs.widgets.DivHolderView
    public void setDiv(@Nullable Div.p pVar) {
