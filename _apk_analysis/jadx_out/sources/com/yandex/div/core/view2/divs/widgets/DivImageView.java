...
public class DivImageView extends LoadableImageView implements DivHolderView<Div.g> {
    private final /* synthetic */ DivHolderViewMixin<Div.g> $$delegate_0;

    @Nullable
    private Uri imageUrl;

    public DivImageView(@NotNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, 0, 4, null);
    }

    public DivImageView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i10) {
    ...
    public /* synthetic */ DivImageView(Context context, AttributeSet attributeSet, int i10, int i11, i iVar) {
    ...
    @Nullable
    public Div.g getDiv() {
        return (Div.g) this.$$delegate_0.getDiv();
    }
    ...
    @Override // com.yandex.div.core.view2.divs.widgets.DivHolderView
    public void setDiv(@Nullable Div.g gVar) {
