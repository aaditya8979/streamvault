...
public class DivSelectView extends SelectView implements DivHolderView<Div.k> {
    private final /* synthetic */ DivHolderViewMixin<Div.k> $$delegate_0;

    @Nullable
    private l<? super String, r> valueUpdater;
    ...
    @Nullable
    public Div.k getDiv() {
        return (Div.k) this.$$delegate_0.getDiv();
    }
    ...
    @Nullable
    public l<String, r> getValueUpdater() {
    ...
    @Override // com.yandex.div.core.view2.divs.widgets.DivHolderView
    public void setDiv(@Nullable Div.k kVar) {
    ...
    public void setValueUpdater(@Nullable l<? super String, r> lVar) {
