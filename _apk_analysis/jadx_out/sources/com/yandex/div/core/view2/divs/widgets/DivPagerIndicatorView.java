...
public final class DivPagerIndicatorView extends PagerIndicatorView implements DivHolderView<Div.h> {
    private final /* synthetic */ DivHolderViewMixin<Div.h> $$delegate_0;

    public DivPagerIndicatorView(@NotNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, 0, 4, null);
    }

    public DivPagerIndicatorView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i10) {
        super(context, attributeSet, i10);
        this.$$delegate_0 = new DivHolderViewMixin<>();
    }

    public /* synthetic */ DivPagerIndicatorView(Context context, AttributeSet attributeSet, int i10, int i11, i iVar) {
    ...
    @Nullable
    public Div.h getDiv() {
        return (Div.h) this.$$delegate_0.getDiv();
    }
    ...
    @Override // com.yandex.div.core.view2.divs.widgets.DivHolderView
    public void setDiv(@Nullable Div.h hVar) {
