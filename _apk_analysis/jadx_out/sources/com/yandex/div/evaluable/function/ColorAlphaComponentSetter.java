    ...
    private ColorAlphaComponentSetter() {
        super(new p<Color, Double, Color>() { // from class: com.yandex.div.evaluable.function.ColorAlphaComponentSetter.1
            ...
            public /* bridge */ /* synthetic */ Color mo2invoke(Color color, Double d10) {
                return Color.m7444boximpl(m7407invokeGnj5c28(color.m7452unboximpl(), d10.doubleValue()));
            }

            /* JADX INFO: renamed from: invoke-Gnj5c28, reason: not valid java name */
            public final int m7407invokeGnj5c28(int i10, double d10) {
                return Color.Companion.m7453argbH0kstlE(ColorFunctionsKt.toColorIntComponentValue(d10), Color.m7450redimpl(i10), Color.m7448greenimpl(i10), Color.m7443blueimpl(i10));
            }
        });
    }
