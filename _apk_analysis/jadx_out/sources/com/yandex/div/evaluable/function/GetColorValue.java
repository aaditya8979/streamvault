...
public final class GetColorValue extends Function {
    ...
    public Object mo7374evaluateex6DHhM(@NotNull EvaluationContext evaluationContext, @NotNull Evaluable evaluable, @NotNull List<? extends Object> list) {
        ...
        p.i(obj2, "null cannot be cast to non-null type com.yandex.div.evaluable.types.Color");
        int iM7452unboximpl = ((Color) obj2).m7452unboximpl();
        Object obj3 = evaluationContext.getVariableProvider().get((String) obj);
        Color color = obj3 instanceof Color ? (Color) obj3 : null;
        return color == null ? Color.m7444boximpl(iM7452unboximpl) : color;
    }
