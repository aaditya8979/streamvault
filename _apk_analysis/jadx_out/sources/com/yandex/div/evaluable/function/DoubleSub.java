...
public final class DoubleSub extends Function {
    ...
    public Object mo7374evaluateex6DHhM(@NotNull EvaluationContext evaluationContext, @NotNull Evaluable evaluable, @NotNull List<? extends Object> list) {
        ...
        for (Object objEvalSum$div_evaluable : list) {
            ...
            if (i10 != 0) {
                objEvalSum$div_evaluable = Evaluator.Companion.evalSum$div_evaluable(Token.Operator.Binary.Sum.Minus.INSTANCE, Double.valueOf(dDoubleValue), objEvalSum$div_evaluable);
            }
            p.i(objEvalSum$div_evaluable, "null cannot be cast to non-null type kotlin.Double");
