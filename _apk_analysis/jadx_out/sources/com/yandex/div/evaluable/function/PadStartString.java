...
public final class PadStartString extends Function {
    ...
    static {
        ...
        declaredArgs = w.p(new FunctionArgument(evaluableType, false, 2, null), new FunctionArgument(EvaluableType.INTEGER, false, 2, null), new FunctionArgument(evaluableType, false, 2, null));
    ...
    public Object mo7374evaluateex6DHhM(@NotNull EvaluationContext evaluationContext, @NotNull Evaluable evaluable, @NotNull List<? extends Object> list) {
        ...
        return StringFunctionsKt.m7414buildRepeatableStringzbMA7A(evaluationContext, evaluable, (int) (jLongValue - ((long) str.length())), (String) obj3) + str;
    }
