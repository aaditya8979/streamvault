...
public class InitializeThread extends Thread {
    ...
    public static class InitializeStateConfig extends InitializeState {
        ...
        public static /* synthetic */ Object lambda$executeWithLoader$0(HttpClientProvider httpClientProvider, l0 l0Var, hn.c cVar) {
            return httpClientProvider.invoke(cVar);
        }
        ...
        public InitializeState executeWithLoader() {
            ...
            final HttpClientProvider httpClientProvider = (HttpClientProvider) Utilities.getService(HttpClientProvider.class);
            try {
                HttpClient httpClient = (HttpClient) g.e(m1.f59865b.getCoroutineContext(), new p() { // from class: com.unity3d.services.core.configuration.a
                    @Override // sn.p
                    /* JADX INFO: renamed from: invoke */
                    public final Object mo2invoke(Object obj, Object obj2) {
                        return InitializeThread.InitializeStateConfig.lambda$executeWithLoader$0(httpClientProvider, (l0) obj, (hn.c) obj2);
                    }
                });
                ...
                DeviceLog.exception("Failed to initialize HttpClient", e11);
                return new InitializeStateError(ErrorState.InitModules, e11, this._configuration);
            }
        }
    ...
    public static class InitializeStateDownloadWebView extends InitializeState {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static /* synthetic */ Object lambda$execute$0(HttpClientProvider httpClientProvider, l0 l0Var, hn.c cVar) {
            return httpClientProvider.invoke(cVar);
        }
        ...
        public InitializeState execute() {
            ...
            try {
                try {
                    try {
                        String string = ((HttpClient) g.e(m1.f59865b.getCoroutineContext(), new p() { // from class: com.unity3d.services.core.configuration.b
                            @Override // sn.p
                            /* JADX INFO: renamed from: invoke */
                            public final Object mo2invoke(Object obj, Object obj2) {
                                return InitializeThread.InitializeStateDownloadWebView.lambda$execute$0(httpClientProvider, (l0) obj, (hn.c) obj2);
                            }
                        })).executeBlocking(new HttpRequest(this._configuration.getWebViewUrl())).getBody().toString();
    ...
    public static class InitializeStateLoadWeb extends InitializeState {
        ...
        public InitializeState execute() {
            ...
            try {
                try {
                    try {
                        String string = ((HttpClient) g.e(m1.f59865b.getCoroutineContext(), new p() { // from class: com.unity3d.services.core.configuration.c
                            @Override // sn.p
                            /* JADX INFO: renamed from: invoke */
                            public final Object mo2invoke(Object obj, Object obj2) {
                                return InitializeThread.InitializeStateLoadWeb.lambda$execute$0(httpClientProvider, (l0) obj, (hn.c) obj2);
                            }
                        })).executeBlocking(new HttpRequest(this._configuration.getWebViewUrl())).getBody().toString();
                        String webViewHash = this._configuration.getWebViewHash();
                ...
                DeviceLog.exception("Failed to initialize HttpClient", e12);
                return new InitializeStateError(ErrorState.InitModules, e12, this._configuration);
            }
        }
