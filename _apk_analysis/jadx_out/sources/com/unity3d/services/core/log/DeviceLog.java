...
public class DeviceLog {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        public static final /* synthetic */ int[] $SwitchMap$com$unity3d$services$core$log$DeviceLog$UnityAdsLogLevel;
    ...
    private static void writeToLog(DeviceLogEntry deviceLogEntry) {
        ...
        try {
            ...
            Log.e(Q6.H1, "Writing to log failed!", e10);
            method = null;
        }
        if (method != null) {
            try {
                ...
                Log.e(Q6.H1, "Writing to log failed!", e11);
            }
        }
    }
}
