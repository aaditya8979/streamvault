...
public class DeviceInfoReaderPrivacyBuilder extends DeviceInfoReaderBuilder {
    ...
    private JsonFlattenerRules getPrivacyRequestStorageRules() {
        return new JsonFlattenerRules(Arrays.asList("privacy", InMobiSdk.IM_GDPR_CONSENT_GDPR_APPLIES, "unity", "pipl"), Collections.singletonList("value"), Arrays.asList("ts", "exclude", C3978d4.a.f31224t));
    }
