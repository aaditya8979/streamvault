...
public final class InitializeSDK extends MetricTask<EmptyParams, r> {
    ...
    public InitializeSDK(@NotNull ISDKDispatchers iSDKDispatchers, @NotNull ConfigFileFromLocalStorage configFileFromLocalStorage, @NotNull InitializeStateReset initializeStateReset, @NotNull InitializeStateError initializeStateError, @NotNull InitializeStateConfig initializeStateConfig, @NotNull InitializeStateCreate initializeStateCreate, @NotNull InitializeStateLoadCache initializeStateLoadCache, @NotNull InitializeStateLoadWeb initializeStateLoadWeb, @NotNull InitializeStateComplete initializeStateComplete) {
        ...
        p.k(configFileFromLocalStorage, "configFileFromLocalStorage");
        p.k(initializeStateReset, "initializeStateReset");
        p.k(initializeStateError, "initializeStateError");
        p.k(initializeStateConfig, "initializeStateConfig");
        p.k(initializeStateCreate, "initializeStateCreate");
        p.k(initializeStateLoadCache, "initializeStateLoadCache");
        p.k(initializeStateLoadWeb, "initializeStateLoadWeb");
        p.k(initializeStateComplete, "initializeStateComplete");
    ...
    */
    public final java.lang.Object m7257executeErrorStateBWLJW6A(com.unity3d.services.core.configuration.ErrorState r6, java.lang.Throwable r7, com.unity3d.services.core.configuration.Configuration r8, hn.c<? super kotlin.Result<bn.r>> r9) {
        /*
            r5 = this;
        ...
        L18:
            ...
            java.lang.Object r6 = r9.m7542unboximpl()
            goto L57
        L2f:
        ...
        L48:
            ...
            r2.<init>(r6, r4, r8)
            r0.label = r3
            java.lang.Object r6 = r9.mo7253invokegIAlus(r2, r0)
            if (r6 != r1) goto L57
            return r1
        L57:
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.unity3d.services.core.domain.task.InitializeSDK.m7257executeErrorStateBWLJW6A(com.unity3d.services.core.configuration.ErrorState, java.lang.Throwable, com.unity3d.services.core.configuration.Configuration, hn.c):java.lang.Object");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.lang.Object handleInitializationException(com.unity3d.services.core.domain.task.InitializationException r6, hn.c<? super bn.r> r7) throws com.unity3d.services.core.domain.task.InitializationException {
        /*
            r5 = this;
        ...
        L3a:
            ...
            r0.L$0 = r6
            r0.label = r3
            java.lang.Object r7 = r5.m7257executeErrorStateBWLJW6A(r7, r2, r4, r0)
            if (r7 != r1) goto L54
            return r1
        L54:
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.unity3d.services.core.domain.task.InitializeSDK.handleInitializationException(com.unity3d.services.core.domain.task.InitializationException, hn.c):java.lang.Object");
    }
    ...
    public /* bridge */ /* synthetic */ Object mo7252doWorkgIAlus(BaseParams baseParams, c cVar) {
        return m7258doWorkgIAlus((EmptyParams) baseParams, (c<? super Result<r>>) cVar);
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public java.lang.Object m7258doWorkgIAlus(@org.jetbrains.annotations.NotNull com.unity3d.services.core.domain.task.EmptyParams r5, @org.jetbrains.annotations.NotNull hn.c<? super kotlin.Result<bn.r>> r6) {
        /*
            r4 = this;
        ...
        L31:
            ...
            r1.<init>(r4, r3)
            r5.label = r2
            java.lang.Object r6 = p000do.g.g(r6, r1, r5)
            if (r6 != r0) goto L49
            return r0
        L49:
            kotlin.Result r6 = (kotlin.Result) r6
            java.lang.Object r5 = r6.m7542unboximpl()
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.unity3d.services.core.domain.task.InitializeSDK.m7258doWorkgIAlus(com.unity3d.services.core.domain.task.EmptyParams, hn.c):java.lang.Object");
    }
