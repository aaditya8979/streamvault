...
public class GMAScarAdapterBridge {
    ...
    private void loadRewardedAd(c cVar) {
        this._scarAdapter.f(ClientProperties.getApplicationContext(), cVar, new ScarRewardedAdHandler(cVar, getScarEventSubject(cVar.e()), this._gmaEventSender));
    }
    ...
    public void loadBanner(Context context, BannerView bannerView, String str, c cVar, UnityBannerSize unityBannerSize) {
        ...
        e eVar = this._scarAdapter;
        if (eVar != null) {
            eVar.g(context, bannerView, cVar, unityBannerSize.getWidth(), unityBannerSize.getHeight(), scarBannerAdHandler);
        } else {
