...
public class LoadModuleDecoratorTimeout extends LoadModuleDecorator {
    ...
    public void onOperationTimeout(final LoadOperationState loadOperationState) {
        if (loadOperationState != null) {
            ...
            remove(loadOperationState.f53548id);
            Utilities.runOnUiThread(new Runnable() { // from class: com.unity3d.services.ads.operation.load.a
                @Override // java.lang.Runnable
                public final void run() {
                    LoadModuleDecoratorTimeout.lambda$onOperationTimeout$0(loadOperationState);
                }
            });
        }
    }
