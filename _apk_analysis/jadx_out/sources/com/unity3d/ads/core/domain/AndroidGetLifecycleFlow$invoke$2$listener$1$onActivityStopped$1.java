...
public final class AndroidGetLifecycleFlow$invoke$2$listener$1$onActivityStopped$1 extends SuspendLambda implements p<l0, c<? super r>, Object> {
    ...
    public AndroidGetLifecycleFlow$invoke$2$listener$1$onActivityStopped$1(m<? super LifecycleEvent> mVar, Activity activity, c<? super AndroidGetLifecycleFlow$invoke$2$listener$1$onActivityStopped$1> cVar) {
        super(2, cVar);
    ...
    public final Object mo2invoke(@NotNull l0 l0Var, @Nullable c<? super r> cVar) {
        return ((AndroidGetLifecycleFlow$invoke$2$listener$1$onActivityStopped$1) create(l0Var, cVar)).invokeSuspend(r.f5635a);
    }
