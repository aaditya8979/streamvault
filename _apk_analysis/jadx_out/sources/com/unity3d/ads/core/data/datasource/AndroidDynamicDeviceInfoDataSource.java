...
public final class AndroidDynamicDeviceInfoDataSource implements DynamicDeviceInfoDataSource {
    ...
    @NotNull
    private final l<Map<String, Boolean>> reportedWarning;
    ...
    public AndroidDynamicDeviceInfoDataSource(@NotNull Context context, @NotNull LifecycleDataSource lifecycleDataSource) {
        ...
        this.reportedWarning = v.a(kotlin.collections.a.j());
        this.volumeSettingsChange = f.f(new AndroidDynamicDeviceInfoDataSource$volumeSettingsChange$1(this, null));
    }
    ...
    private final double getBatteryLevel() {
        ...
        return ((double) intentRegisterReceiver.getIntExtra(AppLovinEventTypes.USER_COMPLETED_LEVEL, 0)) / ((double) intentRegisterReceiver.getIntExtra("scale", 0));
    }
    ...
    private final long getFreeSpace(File file) {
        ...
        return c.d(file.getFreeSpace() / ((long) 1024));
    }

    private final String getLanguage() {
        String string = Locale.getDefault().toString();
        p.j(string, "getDefault().toString()");
        return string;
    }
    ...
    private final int getNetworkType() {
        ...
        try {
            ...
            if (p.f(this.reportedWarning.getValue().get("getNetworkType"), Boolean.TRUE)) {
                return -1;
            }
            l<Map<String, Boolean>> lVar = this.reportedWarning;
            do {
                value = lVar.getValue();
            } while (!lVar.b(value, kotlin.collections.a.r(value, h.a("getNetworkType", Boolean.TRUE))));
    ...
    public final double getStreamVolume(int i10) {
        return getAudioManager() != null ? r0.getStreamVolume(i10) : -2;
    }
    ...
    private final long getUsableSpace(File file) {
        ...
        return c.d(file.getUsableSpace() / ((long) 1024));
    }
    ...
    public List<String> getLocaleList() {
        ...
        p.j(locales, "context.resources.configuration.locales");
        int size = locales.size();
        ArrayList arrayList = new ArrayList(size);
        for (int i10 = 0; i10 < size; i10++) {
            String string = locales.get(i10).toString();
            p.j(string, "locales[it].toString()");
    ...
    public final NetworkCapabilityTransportsOuterClass.NetworkCapabilityTransports getNetworkCapabilityTransports() {
        ...
        if (Build.VERSION.SDK_INT < 31) {
            ...
            p.j(networkCapabilityTransportsBuild, "result.build()");
        ...
        if (connectivityManager == null || (activeNetwork = connectivityManager.getActiveNetwork()) == null) {
            ...
            p.j(networkCapabilityTransportsBuild2, "result.build()");
        ...
        p.j(networkCapabilityTransportsBuild4, "result.build()");
    ...
    public String getOrientation() {
        return getScreenHeight() > getScreenWidth() ? C3978d4.i.D : C3978d4.i.C;
    }
    ...
    public final double getStreamMaxVolume(int i10) {
        return getAudioManager() != null ? r0.getStreamMaxVolume(i10) : -2;
    }
