...
public final class AndroidDeveloperConsentDataSource implements DeveloperConsentDataSource {
    ...
    private final List<DeveloperConsentOuterClass.DeveloperConsentOption> developerConsentList() throws JSONException {
        ...
        p.j(itKeys, "data.keys()");
        while (itKeys.hasNext()) {
            String next = itKeys.next();
            Object obj = jSONObjectFetchData.get(next);
            DeveloperConsentOuterClass.DeveloperConsentOption developerConsentOptionCreateDeveloperConsentOption = null;
            if (obj instanceof Boolean) {
                ...
                if (a0.J(str, "true", true) || a0.J(str, com.ironsource.mediationsdk.metadata.a.f32683h, true)) {
                    p.j(next, "key");
    ...
    private final JSONObject fetchData() {
        ...
        p.j(jSONObjectFlattenJson, "flattener.flattenJson(\".… flattenerRulesUseCase())");
    ...
    private final DeveloperConsentOuterClass.DeveloperConsentChoice getDeveloperConsentChoice(Boolean bool) {
        return p.f(bool, Boolean.TRUE) ? DeveloperConsentOuterClass.DeveloperConsentChoice.DEVELOPER_CONSENT_CHOICE_TRUE : p.f(bool, Boolean.FALSE) ? DeveloperConsentOuterClass.DeveloperConsentChoice.DEVELOPER_CONSENT_CHOICE_FALSE : DeveloperConsentOuterClass.DeveloperConsentChoice.DEVELOPER_CONSENT_CHOICE_UNSPECIFIED;
    }
