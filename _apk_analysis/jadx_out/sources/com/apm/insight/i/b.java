...
public final class b implements c {
    ...
    private synchronized void b(final long j10, final Thread thread, final Throwable th2, final String str, final String str2, final boolean z10) {
        final File file = new File(j.a(this.f7270a), str);
        ...
        com.apm.insight.entity.a aVarA = com.apm.insight.runtime.a.f.a().a(CrashType.LAUNCH, new c.a() { // from class: com.apm.insight.i.b.1
            ...
            public final com.apm.insight.entity.a a(int i10, com.apm.insight.entity.a aVar) {
                this.f7271a = SystemClock.uptimeMillis();
                if (i10 == 0) {
                    aVar.a("stack", (Object) m.a(th2));
                    aVar.a(StatsEvent.f52830z, "start_crash");
                    ...
                    aVar.a("main_process", Boolean.valueOf(com.apm.insight.l.a.b(b.this.f7270a)));
                    ...
                    aVar.a("crash_after_crash", Npth.hasCrashWhenJavaCrash() ? "true" : com.ironsource.mediationsdk.metadata.a.f32683h);
                    aVar.a("crash_after_native", NativeImpl.e() ? "true" : com.ironsource.mediationsdk.metadata.a.f32683h);
                    com.apm.insight.g.a.a().a(thread, th2, true, aVar);
                } else if (i10 == 2) {
                    if (zC) {
                        com.apm.insight.l.a.a(b.this.f7270a, aVar.c());
                    }
                    aVar.a("launch_did", (Object) a.a(b.this.f7270a));
                    if (e.x()) {
