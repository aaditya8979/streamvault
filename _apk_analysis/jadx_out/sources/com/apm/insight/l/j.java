...
public final class j {
    ...
    private static File f7397b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static File f7398c;
    ...
    public static File d(@NonNull Context context) {
        if (f7397b == null) {
            ...
            f7397b = new File(j(context), "apminsight/CrashLogNative");
        }
        return f7397b;
    }
    ...
    public static File e(@NonNull Context context) {
        if (f7398c == null) {
            f7398c = new File(j(context) + "/apminsight/CrashCommonLog/" + com.apm.insight.e.f());
        }
        return f7398c;
    }
    ...
    public static String j(@NonNull Context context) {
        if (TextUtils.isEmpty(f7396a)) {
            try {
                f7396a = context.getFilesDir().getAbsolutePath();
            } catch (Exception e10) {
                f7396a = "/sdcard/";
                e10.printStackTrace();
            }
