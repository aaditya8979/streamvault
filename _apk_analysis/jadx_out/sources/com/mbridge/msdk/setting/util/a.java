...
public class a {
    ...
    /* JADX INFO: compiled from: MraidJSController.java */
    public class C0494a extends com.mbridge.msdk.foundation.same.net.handler.a {
    ...
    public class b implements Runnable {
        ...
        public void run() throws Throwable {
            try {
                ...
                o0.a(this.f39730a.getBytes(), file);
                com.mbridge.msdk.foundation.buffer.sharedperference.a.b().a("MraidJSController", this.f39731b);
            } catch (Exception e10) {
                q0.a("MraidJSController", e10.getMessage());
            }
        }
    }
    ...
    public void a(Context context, String str) {
        ...
        if (TextUtils.isEmpty(strA) || !strA.equals(str)) {
            try {
                new com.mbridge.msdk.setting.net.a(context).get(0, str, (com.mbridge.msdk.foundation.same.net.wrapper.e) null, new C0494a(str), "mraid_js", 60000L);
            } catch (Exception e10) {
                q0.b("MraidJSController", e10.getMessage());
            }
        }
    }
    ...
    public String b() {
        try {
            ...
            if (gVarD != null && !TextUtils.isEmpty(gVarD.O())) {
                a(com.mbridge.msdk.foundation.controller.c.n().d(), gVarD.O());
            }
            return f39725b;
