...
public class ComponentLinearLayout extends LinearLayout implements a {
    ...
    public void onAttachedToWindow() {
        ...
        try {
            ...
            q0.b("MBLinearLayout", "onAttachedToWindow异常: " + e10.getMessage());
        }
    }
    ...
    public void setViewClickListener() {
        setOnClickListener(new View.OnClickListener() { // from class: hb.g
    ...
    public void setXmlData(Map<String, Object> map) {
        ...
        try {
            ...
            q0.b("MBLinearLayout", "setXmlData异常: " + e10.getMessage());
        }
    }
