...
public class FeedBackLinerLayout extends ComponentLinearLayout implements com.mbridge.msdk.config.dynamic.baseview.inter.b {
    ...
    private FeedbackRadioGroup f36524a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private String f36525b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private Map<String, Object> f36526c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private FeedBackLinerLayout f36527d;
    ...
    private b a(Context context) {
        b bVar = new b();
        try {
            bVar.f36528a = i0.a(context, "mbridge_cm_feedback_choice_btn_bg", "drawable");
            ...
            if (resourcesA != null && iA != 0) {
                try {
                    bVar.f36529b = resourcesA.getColorStateList(iA);
                } catch (Exception e10) {
                    Log.w("FeedBackLinerLayout", "Error loading color state list", e10);
                }
            }
            bVar.f36530c = v0.a(context, 8.0f);
            bVar.f36531d = v0.a(context, 4.0f);
            bVar.f36532e = v0.c(context, 14.0f);
        } catch (Exception e11) {
    ...
    private FeedbackRadioGroup a() {
        ...
        try {
            ...
            this.f36524a = feedbackRadioGroup;
            feedbackRadioGroup.setOrientation(0);
            LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(-1, -2);
            layoutParams.setMargins(0, v0.a(contextD, 4.0f), 0, 0);
            this.f36524a.setLayoutParams(layoutParams);
            a(this.f36524a, contextD);
            return this.f36524a;
        } catch (Exception e10) {
    ...
    private void a(RadioButton radioButton) {
        if (TextUtils.isEmpty(this.f36525b) || radioButton == null) {
            return;
        }
        try {
            ...
            if (text instanceof String) {
                ...
                if (this.f36526c.containsKey("selectedContents")) {
                    Object obj = this.f36526c.get("selectedContents");
                    ...
                    this.f36526c.put("selectedContents", arrayList);
                }
            }
        } catch (Throwable th2) {
    ...
    public /* synthetic */ void a(RadioButton radioButton, View view) {
        if (TextUtils.isEmpty(this.f36525b)) {
            return;
        }
        a(radioButton);
        HashMap map = new HashMap();
        map.put("property", this.f36526c);
        f.a(this.xmlView, "feedbackItemView", map);
    }

    private void a(RadioButton radioButton, b bVar) {
        try {
            ColorStateList colorStateList = bVar.f36529b;
            if (colorStateList != null) {
                radioButton.setTextColor(colorStateList);
                radioButton.setButtonTintList(bVar.f36529b);
            }
            int i10 = bVar.f36530c;
            radioButton.setPadding(i10, i10, i10, i10);
            radioButton.setCompoundDrawablePadding(bVar.f36530c / 2);
            radioButton.setEllipsize(TextUtils.TruncateAt.END);
            radioButton.setSingleLine(true);
            radioButton.setTextSize(0, bVar.f36532e);
        } catch (Exception e10) {
    ...
    private void setupRadioButtonClickListener(final RadioButton radioButton) {
        radioButton.setOnClickListener(new View.OnClickListener() { // from class: com.mbridge.msdk.config.dynamic.baseview.cusview.a
            ...
            public final void onClick(View view) {
                this.f36562b.a(radioButton, view);
            }
        });
    }
    ...
    public Map<String, Object> getOutData() {
        Object tag;
        if (TextUtils.isEmpty(this.f36525b) || (tag = getTag()) == null) {
            return null;
        }
        HashMap map = new HashMap();
        map.put(String.valueOf(tag), this.f36526c);
        return map;
    }
