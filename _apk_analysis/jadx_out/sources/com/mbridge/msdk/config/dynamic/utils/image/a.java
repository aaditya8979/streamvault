...
/* JADX INFO: compiled from: FastBlur.java */
...
public class a {
    ...
    public static Bitmap a(Bitmap bitmap, int i10, boolean z10) {
        ...
        while (i62 < width) {
            ...
            int i85 = 0;
            while (i85 < i83) {
                iArr16[i81] = (iArr16[i81] & ViewCompat.MEASURED_STATE_MASK) | (iArr15[i65] << 16) | (iArr15[i82] << 8) | iArr15[i84];
                int i86 = i65 - i68;
                int i87 = i82 - i67;
                int i88 = i84 - i66;
                int[] iArr18 = iArr8[((i80 - i11) + i64) % i64];
                int i89 = i68 - iArr18[0];
                int i90 = i67 - iArr18[1];
                int i91 = i66 - iArr18[2];
                if (i62 == 0) {
