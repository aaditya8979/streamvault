...
public class c {
    ...
    public static String f36005a = "NormalDeviceInfoProvider";
    ...
    public String a(Context context) {
        ...
        try {
            return (context.getResources() == null || context.getResources().getConfiguration() == null || (locale = context.getResources().getConfiguration().locale) == null) ? "en-US" : locale.toLanguageTag();
        } catch (Throwable th2) {
            q0.a(f36005a, th2.getMessage(), th2);
            return "en-US";
        }
    }
    ...
    public String a(Context context, String str) {
        try {
            ...
            q0.b(f36005a, e10.getMessage(), e10);
        }
        return "";
    }
    ...
    public Map<String, Object> e() {
        try {
            ...
            map.put(Q6.f30274w, Long.valueOf((j11 / 1024) / 1024));
            return map;
        } catch (Throwable th2) {
            q0.b(f36005a, th2.getMessage(), th2);
            return null;
        }
    }
    ...
    public int l() {
        ...
        try {
            Context contextD = com.mbridge.msdk.foundation.controller.c.n().d();
            if (contextD == null || (packageManager = contextD.getPackageManager()) == null) {
                return 0;
            }
            return packageManager.getApplicationInfo("com.android.vending", 0).enabled ? 1 : 2;
        } catch (Throwable th2) {
            q0.b(f36005a, th2.getMessage(), th2);
            return 0;
        }
