...
public class MBridgeClickMiniCardView extends MBridgeH5EndCardView {
    ...
    public class a implements Runnable {
        ...
        public void run() {
            try {
                ...
                try {
                    int[] iArr = new int[2];
                    MBridgeClickMiniCardView.this.f41682p.getLocationOnScreen(iArr);
                ...
                f.a().a((WebView) MBridgeClickMiniCardView.this.f41682p, "webviewshow", Base64.encodeToString(string.toString().getBytes(), 2));
            } catch (Exception e10) {
                e10.printStackTrace();
            }
        }
    ...
    private void setContentLayoutParams(View view) {
        ...
        layoutParams.height = (int) ((v0.f(this.f41631a) * 0.7f) + 0.5f);
    ...
    public String getURL() {
        ...
        String strH = rewardTemplateMode != null ? rewardTemplateMode.h() : null;
        if (TextUtils.isEmpty(strH) || !strH.contains(MultiDexExtractor.EXTRACTED_SUFFIX)) {
            return strH;
        }
        String h5ResAddress = H5DownLoadManager.getInstance().getH5ResAddress(strH);
        return !TextUtils.isEmpty(h5ResAddress) ? h5ResAddress : strH;
    }
    ...
    public void j() {
        ...
        if (this.f41635e) {
            ...
            setContentLayoutParams(this.f41679m);
            setClickable(true);
        }
    }
    ...
    public void resizeMiniCard(int i10, int i11) {
        View viewFindViewById = ((Activity) this.f41631a).getWindow().findViewById(R.id.content);
        int width = viewFindViewById.getWidth();
        int height = viewFindViewById.getHeight();
        if (i10 <= 0 || i11 <= 0 || i10 > width || i11 > height) {
            return;
        }
        ViewGroup.LayoutParams layoutParams = this.f41679m.getLayoutParams();
        layoutParams.width = i10;
        layoutParams.height = i11;
        this.f41679m.setLayoutParams(layoutParams);
    }
    ...
    public void setRadius(int i10) {
        if (i10 > 0) {
            ...
            this.f41682p.setBackground(gradientDrawable);
            this.f41682p.setClipToOutline(true);
        }
    }
    ...
    public void webviewshow() {
        ...
        if (windVaneWebView != null) {
            ...
            e eVar = new e();
            eVar.a("type", 3);
            d.b().a("2000133", this.f41632b, eVar);
        }
    }
}
