...
public abstract class a extends c<JSONObject> {
    ...
    private void a(List<g> list, JSONObject jSONObject) {
        ...
        CampaignUnit v5CampaignUnit = "v5".equals(jSONObject.optString("version")) ? b.parseV5CampaignUnit(jSONObject.optJSONObject("data"), this.f41475b) : b.parseCampaignUnit(jSONObject.optJSONObject("data"), this.f41475b);
    ...
    public void onSuccess(e<JSONObject> eVar) {
        ...
        if (eVar == null || (aVar = eVar.f37790b) == null || this.f41474a != 0) {
            return;
        }
