...
public class MOfferModel implements NoProGuard {
    ...
    public class g implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            try {
                if (MOfferModel.this.mCampaignUnit == null || MOfferModel.this.mCampaignUnit.ads == null || MOfferModel.this.mCampaignUnit.ads.size() <= 0 || (campaignEx = MOfferModel.this.mCampaignUnit.ads.get(this.f41433a)) == null) {
                    return;
                }
                ...
                com.mbridge.msdk.video.dynview.request.a.a(com.mbridge.msdk.foundation.controller.c.n().d(), campaignEx, MOfferModel.this.mUnitId, this.f41434b);
            } catch (Exception e10) {
                q0.b(MOfferModel.TAG, e10.getMessage());
            }
        }
    ...
    public class h implements com.mbridge.msdk.foundation.same.image.c {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public final /* synthetic */ RoundImageView f41436a;

        public h(RoundImageView roundImageView) {
            this.f41436a = roundImageView;
        }
        ...
        public void onSuccessLoad(Bitmap bitmap, String str) {
            try {
                if (this.f41436a != null && bitmap != null && !bitmap.isRecycled()) {
                    this.f41436a.setBorderRadius(13);
                    this.f41436a.setImageBitmap(bitmap);
                }
    ...
    private View buildItemView(int i10) {
        ...
        View viewInflate = LayoutInflater.from(this.mContext).inflate(i0.a(context, "mbridge_reward_end_card_more_offer_item", "layout"), (ViewGroup) null, false);
    ...
    private void buildRequestParams(CampaignEx campaignEx) {
        ...
        com.mbridge.msdk.foundation.same.net.utils.b.a(eVar, "r_id", str);
        ...
        this.mParam.a("parent_ad_type", str3);
        ...
        com.mbridge.msdk.foundation.same.net.utils.b.a(this.mParam, TypedValues.CycleType.S_WAVE_OFFSET, "0");
        ...
        if (TextUtils.isEmpty(strA)) {
            com.mbridge.msdk.foundation.same.net.utils.b.a(this.mParam, str2, "92762");
    ...
    /* JADX WARN: Removed duplicated region for block: B:18:0x0039 A[Catch: Exception -> 0x0053, TryCatch #0 {Exception -> 0x0053, blocks: (B:3:0x0004, B:5:0x0008, B:8:0x0013, B:18:0x0039, B:20:0x003f, B:21:0x0045, B:23:0x004b, B:13:0x0028, B:14:0x002f), top: B:29:0x0004 }] */
    /*
    ...
    */
    private void doAdmfContorl() {
        /*
            ...
            com.mbridge.msdk.foundation.entity.CampaignEx r2 = r6.mMainOfferCampaignEx     // Catch: java.lang.Exception -> L53
            if (r2 == 0) goto L52
            java.lang.String r2 = r2.getMoreOfferJsonData()     // Catch: java.lang.Exception -> L53
        ...
        L13:
            ...
            com.mbridge.msdk.foundation.entity.CampaignEx r3 = r6.mMainOfferCampaignEx     // Catch: java.lang.Exception -> L53
            java.lang.String r3 = r3.getMoreOfferJsonData()     // Catch: java.lang.Exception -> L53
            r2.<init>(r3)     // Catch: java.lang.Exception -> L53
            r3 = 0
            int r4 = r6.mFromType     // Catch: java.lang.Exception -> L53
            r5 = 1
            if (r4 == r5) goto L2f
            r5 = 2
            if (r4 == r5) goto L28
        ...
        L28:
            ...
            org.json.JSONObject r2 = r2.getJSONObject(r3)     // Catch: java.lang.Exception -> L53
            goto L35
        L2f:
        ...
        L36:
            ...
            return
        L39:
            boolean r2 = r3.has(r1)     // Catch: java.lang.Exception -> L53
            if (r2 == 0) goto L45
            int r1 = r3.getInt(r1)     // Catch: java.lang.Exception -> L53
            r6.admftm = r1     // Catch: java.lang.Exception -> L53
        L45:
            boolean r1 = r3.has(r0)     // Catch: java.lang.Exception -> L53
            if (r1 == 0) goto L5d
            int r0 = r3.getInt(r0)     // Catch: java.lang.Exception -> L53
            r6.admf = r0     // Catch: java.lang.Exception -> L53
            goto L5d
        L52:
            return
        L53:
            ...
            com.mbridge.msdk.foundation.tools.q0.b(r1, r0)
        L5d:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.video.dynview.moffer.MOfferModel.doAdmfContorl():void");
    }
