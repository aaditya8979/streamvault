...
public class d extends b {
    ...
    private com.mbridge.msdk.videocommon.setting.c f41360d;
    ...
    private boolean f41363g;

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    private Context f41364h;

    /* JADX INFO: renamed from: i, reason: collision with root package name */
    private boolean f41365i = false;

    /* JADX INFO: renamed from: j, reason: collision with root package name */
    private boolean f41366j = false;
    ...
    */
    private void a(com.mbridge.msdk.videocommon.setting.c r7, com.mbridge.msdk.foundation.entity.CampaignEx r8) {
        ...
        L22:
            if (r0 == 0) goto L2c
            long r0 = r0.b0()     // Catch: java.lang.Exception -> L5c
    ...
    public void a(com.mbridge.msdk.foundation.same.report.metrics.c cVar) {
        super.a(cVar);
        if (this.f41359c == null || this.f41365i) {
            return;
        }
        this.f41365i = true;
        b();
        this.f41359c.a(cVar);
        this.f41359c.a(2, this.f41362f, this.f41361e);
    }

    @Override // com.mbridge.msdk.video.bt.module.orglistener.b, com.mbridge.msdk.video.bt.module.orglistener.h
    public void a(com.mbridge.msdk.foundation.same.report.metrics.c cVar, String str) {
        super.a(cVar, str);
        if (this.f41359c == null || this.f41366j) {
            return;
        }
        this.f41366j = true;
        a();
        this.f41359c.a(cVar, str);
        this.f41359c.a(4, this.f41362f, this.f41361e);
    }
    ...
    public void a(com.mbridge.msdk.foundation.same.report.metrics.c cVar, boolean z10, com.mbridge.msdk.videocommon.entity.c cVar2) {
        ...
        h hVar = this.f41359c;
        if (hVar == null || this.f41367k) {
            return;
        }
        this.f41367k = true;
        hVar.a(7, this.f41362f, this.f41361e);
        this.f41359c.a(cVar, z10, cVar2);
    }
