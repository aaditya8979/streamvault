...
public class m extends a {
    ...
    public g a(t<?> tVar, Map<String, String> map) throws IOException {
        ...
        v.b bVarA = this.f41083a.s().a(arrayList).a(new MBridgeHostnameVerifier(strA));
        long j11 = iQ;
        TimeUnit timeUnit = TimeUnit.MILLISECONDS;
        v.b bVarA2 = bVarA.d(j11, timeUnit).b(j11, timeUnit).a(pVarH == null ? com.mbridge.msdk.thrid.okhttp.n.f40700a : new j(pVarH.H(), pVarH.b(), pVarH)).e(j11, timeUnit).a(Math.max(jR, 0L), timeUnit);
        a(pVarH, bVarA2);
        y.a aVar = new y.a();
        ...
        b0 b0VarD = a0VarD.d();
        return b0VarD == null ? new g(a0VarD.k(), arrayList2) : new g(a0VarD.k(), arrayList2, a(b0VarD), b0VarD.d());
    }
}
