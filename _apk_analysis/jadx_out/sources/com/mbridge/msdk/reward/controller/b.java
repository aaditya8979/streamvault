...
public class b extends Handler {
    ...
    public void handleMessage(Message message) {
        ...
        com.mbridge.msdk.foundation.same.report.metrics.c cVarA = this.f39541a.a(message);
        CopyOnWriteArrayList<CampaignEx> copyOnWriteArrayListI = this.f39541a.i();
        List<CampaignEx> listH = this.f39541a.h();
        com.mbridge.msdk.reward.adapter.c cVarN = this.f39541a.n();
        boolean zS = this.f39541a.s();
        String strL = this.f39541a.l();
        String strP = this.f39541a.p();
        a.h hVarK = this.f39541a.k();
        InterVideoOutListener interVideoOutListenerO = this.f39541a.o();
        boolean zR = this.f39541a.r();
        MBridgeIds mBridgeIdsG = this.f39541a.g();
        boolean zT = this.f39541a.t();
        switch (i10) {
            case 8:
            ...
            case 17:
                ...
                break;
            case 1001001:
                this.f39541a.a(false, d.b().a(0, zT ? MBSupportMuteAdType.INTERSTITIAL_VIDEO : 94, strP, true, 1));
                break;
            case 1001002:
                if (cVarN != null) {
                    if (!cVarN.l()) {
                        if (!cVarN.g(false)) {
                            if (cVarN.g(true)) {
                                if (!cVarN.l()) {
                                    ...
                                    this.f39541a.a(copyOnWriteArrayListH);
                                    com.mbridge.msdk.foundation.same.report.metrics.c cVarA2 = this.f39541a.a(copyOnWriteArrayListH, cVarA);
                                    if (cVarA2 != null) {
                            ...
                            if (cVarN.g(true)) {
                                if (!cVarN.l()) {
                                    ...
                                    this.f39541a.a(copyOnWriteArrayListH2);
                                    com.mbridge.msdk.foundation.same.report.metrics.c cVarA3 = this.f39541a.a(copyOnWriteArrayListH2, cVarA);
                                    if (cVarA3 != null) {
                            ...
                            this.f39541a.a(copyOnWriteArrayListH3);
                            com.mbridge.msdk.foundation.same.report.metrics.c cVarA4 = this.f39541a.a(copyOnWriteArrayListH3, cVarA);
                            if (cVarA4 != null) {
                        ...
                        this.f39541a.a(copyOnWriteArrayListH4);
                        com.mbridge.msdk.foundation.same.report.metrics.c cVarA5 = this.f39541a.a(copyOnWriteArrayListH4, cVarA);
                        if (cVarA5 != null) {
