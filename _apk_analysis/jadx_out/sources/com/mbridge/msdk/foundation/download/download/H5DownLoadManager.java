...
public class H5DownLoadManager {
        ...
        try {
            ...
            MBDownloadManager.getInstance().download(new DownloadMessage<>(new Object(), str, md5 + ".html", 100, DownloadResourceType.DOWNLOAD_RESOURCE_TYPE_HTML)).withTimeout(60000L).withReadTimeout(30000L).withConnectTimeout(20000L).withDownloadPriority(DownloadPriority.HIGH).withHttpRetryCounter(1).withDirectoryPathInternal(str2).withDownloadStateListener(new OnDownloadStateListener() { // from class: com.mbridge.msdk.foundation.download.download.H5DownLoadManager.1
                ...
                public void onDownloadComplete(DownloadMessage downloadMessage) {
                    q0.a(H5DownLoadManager.TAG, "下载结束： " + downloadMessage.getDownloadUrl() + Z7.f30794r + downloadMessage.getDownloadResourceType() + Z7.f30794r + downloadMessage.getSaveFilePath());
                    H5ResDownloadListerInter h5ResDownloadListerInter2 = h5ResDownloadListerInter;
                    if (h5ResDownloadListerInter2 != null) {
                ...
                public void onDownloadStart(DownloadMessage downloadMessage) {
                    q0.a(H5DownLoadManager.TAG, "开始下载 html： " + downloadMessage.getDownloadUrl() + Z7.f30794r + downloadMessage.getDownloadResourceType());
                }
    ...
    private void downloadZipByDownloadModule(final com.mbridge.msdk.foundation.same.report.metrics.c cVar, String str, final ZipDownloadListener zipDownloadListener) {
        ...
        try {
            ...
            DownloadMessage<?> downloadMessage = new DownloadMessage<>(cVar, str, md5 + MultiDexExtractor.EXTRACTED_SUFFIX, 100, DownloadResourceType.DOWNLOAD_RESOURCE_TYPE_ZIP);
            if (cVar != null) {
            ...
            MBDownloadManager.getInstance().download(downloadMessage).withReadTimeout(30000L).withConnectTimeout(20000L).withDownloadPriority(DownloadPriority.HIGH).withHttpRetryCounter(1).withDirectoryPathInternal(str2).withTimeout(60000L).withDownloadStateListener(new OnDownloadStateListener() { // from class: com.mbridge.msdk.foundation.download.download.H5DownLoadManager.3
                ...
                public void onCancelDownload(DownloadMessage downloadMessage2) {
                    q0.a(H5DownLoadManager.TAG, "下载取消： " + downloadMessage2.getDownloadUrl() + Z7.f30794r + downloadMessage2.getDownloadResourceType());
                    e eVar2 = eVar;
                    if (eVar2 != null) {
                ...
                public void onDownloadComplete(DownloadMessage downloadMessage2) {
                    q0.a(H5DownLoadManager.TAG, "下载结束，开始解压缩文件： " + downloadMessage2.getDownloadUrl() + Z7.f30794r + downloadMessage2.getDownloadResourceType() + Z7.f30794r + downloadMessage2.getSaveFilePath());
                    try {
                        e eVar2 = eVar;
                        if (eVar2 != null) {
                            eVar2.a("cache", Integer.valueOf(downloadMessage2.isCache() ? 1 : 2));
                        ...
                        try {
                            ...
                            q0.b(H5DownLoadManager.TAG, th2.getMessage());
                        }
                ...
                public void onDownloadError(DownloadMessage downloadMessage2, DownloadError downloadError) {
                    q0.a(H5DownLoadManager.TAG, "下载错误： " + downloadMessage2.getDownloadUrl() + Z7.f30794r + downloadMessage2.getDownloadResourceType() + "  " + downloadError.getException().getMessage());
                    e eVar2 = eVar;
                    if (eVar2 != null) {
                        eVar2.a("cache", Integer.valueOf(downloadMessage2.isCache() ? 1 : 2));
                    }
                ...
                public void onDownloadStart(DownloadMessage downloadMessage2) {
                    q0.a(H5DownLoadManager.TAG, "开始下载 zip： " + downloadMessage2.getDownloadUrl() + Z7.f30794r + downloadMessage2.getDownloadResourceType());
                }
    ...
    public String getH5ResAddress(String str) {
        try {
            if (Patterns.WEB_URL.matcher(str).matches() || URLUtil.isValidUrl(str)) {
                ...
                return (TextUtils.isEmpty(path) || !TextUtils.isEmpty(uri.getQueryParameter("urlDebug"))) ? str : path.toLowerCase().endsWith(MultiDexExtractor.EXTRACTED_SUFFIX) ? getResAddress(str) : getHtmlAddress(str);
            }
        } catch (Exception e10) {
            e10.printStackTrace();
        }
