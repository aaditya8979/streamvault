...
public class CronetDownloadCallback extends UrlRequest.Callback {
    ...
    public AtomicBoolean startResponse = new AtomicBoolean(false);
    ...
    private void handlerDownloadResume(String str, String str2) {
        boolean z10 = !isSupportResume(this.responseCode, this.downloadModel);
        DownloadRequest<?> downloadRequest = this.downloadRequest;
        boolean z11 = downloadRequest != null && this.responseCode == 206 && downloadRequest.getTotalBytes() > 0 && this.contentLength != this.downloadRequest.getTotalBytes() - this.downloadRequest.getDownloadedBytes();
        if (z10 && z11) {
    ...
    private boolean isSupportResume(int i10, DownloadModel downloadModel) {
        return i10 == 206 && !TextUtils.isEmpty(this.etag) && (downloadModel == null || TextUtils.equals(this.etag, downloadModel.getEtag()));
    }
    ...
    public void onReadCompleted(UrlRequest urlRequest, UrlResponseInfo urlResponseInfo, ByteBuffer byteBuffer) throws Exception {
        ...
        try {
            ...
            if (MBridgeConstans.DEBUG) {
                q0.b(TAG, "onReadCompleted error: ", e10);
            }
            cancelRequestSafety(urlRequest);
        }
    }
