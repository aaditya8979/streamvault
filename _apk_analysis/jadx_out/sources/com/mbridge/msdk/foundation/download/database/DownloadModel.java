...
public class DownloadModel {
    ...
    public static DownloadModel create(String str, String str2, String str3, String str4, String str5, String str6, long j10, long j11, int i10, int i11, DownloadResourceType downloadResourceType) {
        DownloadModel downloadModel = new DownloadModel();
        ...
        downloadModel.setDownloadedBytes(j11);
        downloadModel.setTotalBytes(j10);
        downloadModel.setLastModifiedTime(System.currentTimeMillis());
        downloadModel.setUsageCounter(i11);
        downloadModel.setDownloadRate(i10);
    ...
    public static DownloadModel create(String str, String str2, String str3, String str4, String str5, String str6, long j10, long j11, int i10, int i11, DownloadResourceType downloadResourceType, int i12) {
        DownloadModel downloadModel = new DownloadModel();
        downloadModel.setDownloadId(str);
        downloadModel.setDownloadUrl(str2);
        downloadModel.setResourceUrl(str3);
    ...
    public void setUnZipResourceByte(long j10) {
        this.unZipResourceByte = j10;
    }
    ...
    public void setUsageCounter(int i10) {
