...
public class d {
    ...
    private static d f37985e;

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private volatile m f37986a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private Map<String, e> f37987b = new HashMap();

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private LinkedHashMap<String, c> f37988c = new LinkedHashMap<>();

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private Map<String, e> f37989d = new HashMap();

    private d() {
        if (this.f37986a == null) {
            this.f37986a = m.b("metrics_sdk", com.mbridge.msdk.foundation.controller.c.n().d(), a());
        }
        JSONObject jSONObjectB = com.mbridge.msdk.foundation.same.report.c.b();
        if (this.f37986a != null) {
            this.f37986a.a(jSONObjectB);
            this.f37986a.h();
        }
    }

    private p a(int i10) {
        return i10 == 1 ? new p(new com.mbridge.msdk.foundation.same.report.m((byte) 2), com.mbridge.msdk.foundation.same.net.utils.d.h().f37840j, com.mbridge.msdk.foundation.same.net.utils.d.h().f37844n) : new p(new h(), com.mbridge.msdk.foundation.same.net.utils.d.h().f37831d, 0);
    }
    ...
    private x a() {
        try {
            ...
            int iB4 = s0.a().b("metrics", "t_m_t", s0.a().b("t_m_t", 15000));
    ...
    private void a(String str, c cVar, com.mbridge.msdk.foundation.same.report.metrics.callback.a aVar) {
        try {
            if (Arrays.asList(b.f37946c).contains(str)) {
                cVar.d(str);
            }
            Map<String, e> map = this.f37989d;
            if (map != null && map.containsKey(str)) {
                cVar.a(str, this.f37989d.get(str));
            }
    ...
    public c a(String str, String str2) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(str3) && (linkedHashMap = this.f37988c) != null && linkedHashMap.containsKey(str3)) {
                return this.f37988c.get(str3);
            }
            return null;
        } catch (Exception e10) {
            if (MBridgeConstans.DEBUG) {
    ...
    public void a(String str, CampaignEx campaignEx, e eVar) {
        ...
        if (cVar == null) {
            cVar = new c();
        } else if (Arrays.asList(b.f37951h).contains(str)) {
            cVar = a(cVar);
        }
        cVar.a(campaignEx);
    ...
    public void a(String str, c cVar, CampaignEx campaignEx, Context context, com.mbridge.msdk.foundation.same.report.metrics.callback.a aVar) {
        try {
            ...
            if (campaignEx != null) {
                ...
                eVar.a(ImpressionLog.f51754x, campaignEx.getRequestId());
    ...
    public e c(String str) {
        ...
        e eVar = new e();
        try {
            return (TextUtils.isEmpty(str) || (map = this.f37987b) == null || !map.containsKey(str)) ? eVar : this.f37987b.get(str);
        } catch (Exception e10) {
            if (!MBridgeConstans.DEBUG) {
                return eVar;
            }
