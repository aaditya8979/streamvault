...
public class g {
    ...
    private static String f37870a = "";

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static String f37871b = "";
    ...
    public static void a(e eVar, Context context, boolean z10, com.mbridge.msdk.setting.g gVar) {
        ...
        try {
            ...
            if (!jSONObject.equals(f37871b)) {
                f37870a = k0.b(jSONObject.toString());
            }
            if (TextUtils.isEmpty(f37870a)) {
                return;
            }
            eVar.a("dvi", f37870a);
        } catch (Exception e10) {
