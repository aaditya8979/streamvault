...
public class g {
    ...
    private static Handler f37926a = new Handler(Looper.getMainLooper());
    ...
    public static void a(String str, CampaignEx campaignEx, String str2, String str3, String str4) {
        ...
        com.mbridge.msdk.foundation.entity.n nVar = new com.mbridge.msdk.foundation.entity.n(str, TextUtils.isEmpty(campaignEx.getMraid()) ^ true ? 1 : 3, "0", "", campaignEx.getId(), str3, str2, String.valueOf(campaignEx.getKeyIaRst()));
