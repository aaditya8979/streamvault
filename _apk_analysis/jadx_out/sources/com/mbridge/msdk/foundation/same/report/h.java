...
public class h {
    ...
    public static final String f37927b = "h";

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private final Context f37928a;

    public h(Context context) {
        this.f37928a = context.getApplicationContext();
    }
    ...
    public void a() {
        try {
            ...
            q0.b(f37927b, th2.getMessage());
        }
    }

    public void a(int i10, int i11, String str, String str2, String str3) {
        i.a(this.f37928a, i10, i11, str, str2, str3);
    }
    ...
    public void a(String str, String str2, String str3) {
        try {
            ...
            q0.b(f37927b, e10.getMessage());
        }
    }

    public void a(String str, String str2, String str3, String str4, String str5) {
        try {
            int iS = m0.s(this.f37928a);
            JSONObject jSONObject = new JSONObject();
            jSONObject.put("key", URLEncoder.encode("2000071", G5.N));
            jSONObject.put(ImpressionLog.f51754x, URLEncoder.encode(str, G5.N));
            jSONObject.put("rid_n", URLEncoder.encode(str2, G5.N));
            jSONObject.put("cid", URLEncoder.encode(str3, G5.N));
    ...
    public void a(String str, String str2, String str3, String str4, String str5, boolean z10) {
        try {
            ...
            jSONObject.put("key", URLEncoder.encode("2000065", G5.N));
            jSONObject.put(ImpressionLog.f51754x, URLEncoder.encode(str, G5.N));
            jSONObject.put("rid_n", URLEncoder.encode(str2, G5.N));
            jSONObject.put("cid", URLEncoder.encode(str3, G5.N));
            jSONObject.put(MBridgeConstans.PROPERTIES_UNIT_ID, URLEncoder.encode(str4, G5.N));
            jSONObject.put("click_url", URLEncoder.encode(str5, G5.N));
            com.mbridge.msdk.foundation.same.report.metrics.d.b().a(jSONObject);
        } catch (Exception e10) {
            q0.b(f37927b, e10.getMessage());
        }
    ...
    public void b(String str, String str2, String str3, String str4, String str5, boolean z10) {
        try {
            ...
            jSONObject.put("key", URLEncoder.encode("2000066", G5.N));
            jSONObject.put(ImpressionLog.f51754x, URLEncoder.encode(str, G5.N));
            jSONObject.put("rid_n", URLEncoder.encode(str2, G5.N));
            jSONObject.put("cid", URLEncoder.encode(str3, G5.N));
            jSONObject.put(MBridgeConstans.PROPERTIES_UNIT_ID, URLEncoder.encode(str4, G5.N));
