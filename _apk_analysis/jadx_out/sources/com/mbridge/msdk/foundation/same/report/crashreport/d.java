...
public class d {
    ...
    public static final class a implements com.mbridge.msdk.foundation.same.report.crashreport.a {
        ...
        public class RunnableC0448a implements Runnable {
            ...
            public final /* synthetic */ StackTraceElement[] f37898b;

            public RunnableC0448a(String str, StackTraceElement[] stackTraceElementArr) {
                this.f37897a = str;
                this.f37898b = stackTraceElementArr;
            }

            @Override // java.lang.Runnable
            public void run() {
                a.c(this.f37897a, this.f37898b);
            }
        }
        ...
        public void a(String str, StackTraceElement[] stackTraceElementArr) {
            ...
            long unused = d.f37896a = System.currentTimeMillis();
            com.mbridge.msdk.foundation.same.threadpool.a.e().execute(new RunnableC0448a(str, stackTraceElementArr));
        }
    }
