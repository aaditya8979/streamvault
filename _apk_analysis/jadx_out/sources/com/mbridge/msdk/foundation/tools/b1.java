...
public class b1 {
    ...
    public class a implements View.OnTouchListener {
        ...
        public JSONArray f38049a = new JSONArray();
        ...
        public final /* synthetic */ View.OnTouchListener f38052d;

        public a(View view, String str, View.OnTouchListener onTouchListener) {
            this.f38050b = view;
            this.f38051c = str;
            this.f38052d = onTouchListener;
        }

        private void a() {
            this.f38049a = new JSONArray();
        }

        @Override // android.view.View.OnTouchListener
        public boolean onTouch(View view, MotionEvent motionEvent) {
            if (motionEvent.getAction() != 0) {
                b1.b(this.f38049a, motionEvent);
            }
            int actionMasked = motionEvent.getActionMasked();
            if (actionMasked == 0) {
                a();
                b1.b(this.f38049a, motionEvent);
                b1.b(this.f38050b, motionEvent, this.f38049a, this.f38051c);
            ...
            View.OnTouchListener onTouchListener = this.f38052d;
    ...
    public static void b(JSONArray jSONArray, MotionEvent motionEvent) {
        try {
            JSONObject jSONObject = new JSONObject();
            jSONObject.put(C3978d4.i.f31344j0, a(motionEvent));
            ...
            for (int i10 = 0; i10 < motionEvent.getPointerCount(); i10++) {
                ...
                if (Build.VERSION.SDK_INT >= 29) {
                    jSONObject2.put(VastAttributes.HORIZONTAL_POSITION, String.valueOf(motionEvent.getRawX(i10)));
                    jSONObject2.put(VastAttributes.VERTICAL_POSITION, String.valueOf(motionEvent.getRawY(i10)));
                } else {
                    jSONObject2.put(VastAttributes.HORIZONTAL_POSITION, String.valueOf(motionEvent.getRawX()));
                    jSONObject2.put(VastAttributes.VERTICAL_POSITION, String.valueOf(motionEvent.getRawY()));
                }
