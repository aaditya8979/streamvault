...
public class CampaignEx extends DomainCampaignEx {
    ...
    private String f37482q;

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    private String f37483r;
    ...
    private int vst = -2;
    private int wtick = 0;
    private int showIndex = com.mbridge.msdk.foundation.same.report.metrics.a.f37936a;
    private int showType = com.mbridge.msdk.foundation.same.report.metrics.a.f37938c;
    ...
    public static final class a implements Serializable {
        ...
        private String f37489e = "";

        /* JADX INFO: renamed from: f, reason: collision with root package name */
        private int f37490f = 0;

        /* JADX INFO: renamed from: g, reason: collision with root package name */
        private int f37491g = 0;

        /* JADX INFO: renamed from: h, reason: collision with root package name */
        private String f37492h = "";

        /* JADX INFO: renamed from: i, reason: collision with root package name */
        private String f37493i = "";

        /* JADX INFO: renamed from: j, reason: collision with root package name */
        private String f37494j = "";
    ...
    public static final class b implements Serializable {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public Map<Integer, String> f37496a;

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        public boolean f37497b = false;
        ...
        /* JADX INFO: renamed from: h, reason: collision with root package name */
        public boolean f37503h = false;

        /* JADX INFO: renamed from: i, reason: collision with root package name */
        public boolean f37504i = false;

        /* JADX INFO: renamed from: j, reason: collision with root package name */
        public boolean f37505j = false;

        /* JADX INFO: renamed from: k, reason: collision with root package name */
        public boolean f37506k = false;

        /* JADX INFO: renamed from: l, reason: collision with root package name */
        public boolean f37507l = false;
    }

    public static final class c implements Serializable {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private List<a> f37508a;
        ...
        public static final class a implements Serializable {
            ...
            /* JADX INFO: renamed from: a, reason: collision with root package name */
            public List<String> f37514a = new ArrayList();
    ...
    public static j TrackingStr2Object(String str) {
        try {
            if (!TextUtils.isEmpty(str)) {
                ...
                jVar.f(processNativeVideoTrackingArray(jSONObject.optJSONArray("complete")));
    ...
    public static JSONObject campaignToJsonObject(CampaignEx campaignEx, boolean z10, boolean z11) throws JSONException {
        ...
        jSONObjectCampaignToJsonObject.put(BillingClientBridgeCommon.isReadyMethodName, z10);
        ...
        try {
            ...
            try {
                ...
                if (TextUtils.isEmpty(jSONObject.optString("rating"))) {
                    ...
                    String strOptString = jSONObject.optString("rating", "0");
                    str = JSON_KEY_RS_IGNORE_CHECK_RULE;
                ...
                String strOptString6 = jSONObject.optString("mraid");
                if (TextUtils.isEmpty(strOptString6)) {
    ...
    private void setMoreOfferAdControl(String str, String str2) {
        try {
            int iD = v0.d(str, MBridgeConstans.DYNAMIC_VIEW_MORE_OFFER_ADMF);
            if (iD == 0) {
                return;
            }
            JSONObject jSONObject = TextUtils.isEmpty(this.moreOfferJsonData) ? new JSONObject() : new JSONObject(this.moreOfferJsonData);
            int iD2 = v0.d(str, MBridgeConstans.DYNAMIC_VIEW_MORE_OFFER_ADMFTM);
            JSONObject jSONObject2 = new JSONObject();
            jSONObject2.put(MBridgeConstans.DYNAMIC_VIEW_MORE_OFFER_ADMF, iD);
            jSONObject2.put(MBridgeConstans.DYNAMIC_VIEW_MORE_OFFER_ADMFTM, iD2);
    ...
    public String getImpressionURL() {
        try {
            if (s0.a().a("v_a_d_p", false)) {
                String strA = v0.a(this.impressionURL, "&tun=", m0.y() + "");
    ...
    public String getNoticeUrl() {
        try {
            if (s0.a().a("v_a_d_p", false)) {
                String strA = v0.a(this.noticeUrl, "&tun=", m0.y() + "");
                this.noticeUrl = strA;
                return strA;
            }
        } catch (Exception e10) {
    ...
    public String getOnlyImpressionURL() {
        try {
            if (s0.a().a("v_a_d_p", false)) {
                String strA = v0.a(this.onlyImpressionURL, "&tun=", m0.y() + "");
    ...
    public void setendcard_url(String str) {
        ...
        if (TextUtils.isEmpty(this.mof_template_url) && (((cVar = this.rewardTemplateMode) == null || TextUtils.isEmpty(cVar.f37512e)) && !TextUtils.isEmpty(str) && str.contains(KEY_IS_CMPT_ENTRY))) {
            setCMPTEntryUrl(str);
        }
