...
public class a extends WebChromeClient {
    ...
    private CopyOnWriteArrayList<WebChromeClient> f38861a = new CopyOnWriteArrayList<>();

    public void a(WebChromeClient webChromeClient) {
        this.f38861a.add(webChromeClient);
    }

    public void b(WebChromeClient webChromeClient) {
        this.f38861a.remove(webChromeClient);
    }
    ...
    public void onCloseWindow(WebView webView) {
        Iterator<WebChromeClient> it = this.f38861a.iterator();
        while (it.hasNext()) {
