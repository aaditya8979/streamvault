...
public abstract class BaseBannerSignalPlugin extends BannerSignalPluginDiff {
    ...
    private final String f38864g = "BannerSignalPlugin";
    ...
    public void init(Object obj, String str) {
        try {
            q0.b("BannerSignalPlugin", C3978d4.a.f31210f);
            e eVar = this.f38865h;
            if (eVar != null) {
                eVar.init(obj, str);
            }
        } catch (Throwable th2) {
            q0.b("BannerSignalPlugin", C3978d4.a.f31210f, th2);
        }
    }
