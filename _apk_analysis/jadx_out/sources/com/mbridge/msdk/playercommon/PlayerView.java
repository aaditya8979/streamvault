...
public class PlayerView extends LinearLayout {
    ...
    public class MySurfaceHoldeCallback implements SurfaceHolder.Callback {
        ...
        public void surfaceChanged(SurfaceHolder surfaceHolder, int i10, int i11, int i12) {
            try {
                ...
                if (PlayerView.this.mIsSurfaceHolderDestoryed && !PlayerView.this.mIsCovered && !PlayerView.this.isComplete() && !PlayerView.this.isBTVideo && !b.f37652f) {
    ...
    private void initView() {
        View viewInflate = LayoutInflater.from(getContext()).inflate(i0.a(getContext(), "mbridge_playercommon_player_view", "layout"), (ViewGroup) null);
        if (viewInflate != null) {
    ...
    public JSONObject buildH5JsonObject(int i10) {
        ...
        try {
            jSONObject.put(a.f37699h, v0.b(c.n().d(), this.xInScreen));
            jSONObject.put(a.f37700i, v0.b(c.n().d(), this.yInScreen));
            ...
            jSONObject.put(a.f37702k, this.orientation);
