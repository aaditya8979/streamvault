...
public class EventLogger implements AnalyticsListener {
    ...
    private String getEventString(AnalyticsListener.EventTime eventTime, String str) {
        return str + " [" + getEventTimeString(eventTime) + C3978d4.j.f31385e;
    }

    private String getEventString(AnalyticsListener.EventTime eventTime, String str, String str2) {
        return str + " [" + getEventTimeString(eventTime) + ", " + str2 + C3978d4.j.f31385e;
    }
    ...
    public void onAudioUnderrun(AnalyticsListener.EventTime eventTime, int i10, long j10, long j11) {
        loge(eventTime, "audioTrackUnderrun", i10 + ", " + j10 + ", " + j11 + C3978d4.j.f31385e, null);
    }
    ...
    public void onTimelineChanged(AnalyticsListener.EventTime eventTime, int i10) {
        ...
        for (int i12 = 0; i12 < Math.min(windowCount, 3); i12++) {
            ...
            logd("  window [" + getTimeString(this.window.getDurationMs()) + ", " + this.window.isSeekable + ", " + this.window.isDynamic + C3978d4.j.f31385e);
        }
        if (windowCount > 3) {
            logd("  ...");
        }
        ...
        while (true) {
            ...
            if (trackGroups.length > 0) {
                ...
                while (i12 < trackGroups.length) {
                    ...
                    String str3 = str;
                    logd("    Group:" + i12 + ", adaptive_supported=" + getAdaptiveSupportString(trackGroup.length, currentMappedTrackInfo.getAdaptiveSupport(i11, i12, false)) + str2);
                    int i13 = 0;
