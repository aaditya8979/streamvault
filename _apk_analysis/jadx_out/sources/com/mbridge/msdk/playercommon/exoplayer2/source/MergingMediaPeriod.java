...
final class MergingMediaPeriod implements MediaPeriod, MediaPeriod.Callback {
    ...
    public long readDiscontinuity() {
        ...
        while (true) {
            ...
            if (mediaPeriodArr[i10].readDiscontinuity() != -9223372036854775807L) {
    ...
    public long selectTracks(TrackSelection[] trackSelectionArr, boolean[] zArr, SampleStream[] sampleStreamArr, boolean[] zArr2, long j10) {
        ...
        while (i12 < this.periods.length) {
            ...
            long jSelectTracks = this.periods[i12].selectTracks(trackSelectionArr2, zArr, sampleStreamArr4, zArr2, j11);
            if (i14 == 0) {
                j11 = jSelectTracks;
