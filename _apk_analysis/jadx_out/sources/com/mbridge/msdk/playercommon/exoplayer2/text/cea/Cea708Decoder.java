...
public final class Cea708Decoder extends CeaDecoder {
    ...
    public static final class CueBuilder {
        ...
        public Cea708Cue build() {
            ...
            int i17 = this.windowFillColor;
            return new Cea708Cue(spannableStringBuilder, alignment2, f13, 0, i14, f12, i16, Float.MIN_VALUE, i17 != COLOR_SOLID_BLACK, i17, this.priority);
        }
                ...
                if (z10) {
                    if (i10 == 3) {
                        ...
                        if (dtvCcPacket2 == null) {
                            ...
                            dtvCcPacket2.currentIndex = i15 + 1;
