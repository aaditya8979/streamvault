...
public abstract class MediaCodecRenderer extends BaseRenderer {
    ...
    private static boolean codecNeedsEosFlushWorkaround(String str) {
        int i10 = Util.SDK_INT;
        return (i10 <= 23 && "OMX.google.vorbis.decoder".equals(str)) || (i10 <= 19 && "hb2000".equals(Util.DEVICE) && ("OMX.amlogic.avc.decoder.awesome".equals(str) || "OMX.amlogic.avc.decoder.awesome.secure".equals(str)));
    }
    ...
    public final void maybeInitCodec() throws ExoPlaybackException {
        ...
        if (shouldInitCodec(this.codecInfo)) {
            ...
            try {
                ...
                throwDecoderInitError(new DecoderInitializationException(this.format, e11, zRequiresSecureDecoderComponent, str2));
            }
