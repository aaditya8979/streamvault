...
public final class DefaultDataSource implements DataSource {
    ...
    public DefaultDataSource(Context context, TransferListener<? super DataSource> transferListener, String str, int i10, int i11, boolean z10) {
        this(context, transferListener, new DefaultHttpDataSource(str, null, transferListener, i10, i11, z10, null));
    }

    public DefaultDataSource(Context context, TransferListener<? super DataSource> transferListener, String str, boolean z10) {
