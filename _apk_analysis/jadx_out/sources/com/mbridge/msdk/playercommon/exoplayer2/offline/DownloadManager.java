...
public final class DownloadManager {
    ...
    public static final class Task implements Runnable {
        ...
        public TaskState getDownloadState() {
            return new TaskState(this.f39167id, this.action, getExternalState(), getDownloadPercentage(), getDownloadedBytes(), this.error);
        }
    ...
    public int handleAction(DownloadAction downloadAction) {
        ...
        return taskAddTaskForAction.f39167id;
    }
