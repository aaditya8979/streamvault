...
public class AdaptiveTrackSelection extends BaseTrackSelection {
    ...
    public AdaptiveTrackSelection(TrackGroup trackGroup, int[] iArr, BandwidthMeter bandwidthMeter) {
        this(trackGroup, iArr, bandwidthMeter, 10000L, V2.f30587h, V2.f30587h, 0.75f, 0.75f, 2000L, Clock.DEFAULT);
    }
    ...
    private long minDurationForQualityIncreaseUs(long j10) {
        return (j10 > (-9223372036854775807L) ? 1 : (j10 == (-9223372036854775807L) ? 0 : -1)) != 0 && (j10 > this.minDurationForQualityIncreaseUs ? 1 : (j10 == this.minDurationForQualityIncreaseUs ? 0 : -1)) <= 0 ? (long) (j10 * this.bufferedFractionToLiveEdgeForQualityIncrease) : this.minDurationForQualityIncreaseUs;
    }
    ...
    public int evaluateQueueSize(long j10, List<? extends MediaChunk> list) {
        ...
        if (j11 != -9223372036854775807L && jElapsedRealtime - j11 < this.minTimeBetweenBufferReevaluationMs) {
            return list.size();
        }
