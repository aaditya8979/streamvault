...
public final class Mp4Extractor implements Extractor, SeekMap {
    ...
    private ArrayList<TrackSampleTable> getTrackSampleTables(Atom.ContainerAtom containerAtom, GaplessInfoHolder gaplessInfoHolder, boolean z10) throws ParserException {
        ...
        for (int i10 = 0; i10 < containerAtom.containerChildren.size(); i10++) {
            ...
            if (containerAtom2.type == Atom.TYPE_trak && (trak = AtomParsers.parseTrak(containerAtom2, containerAtom.getLeafAtomOfType(Atom.TYPE_mvhd), -9223372036854775807L, null, z10, this.isQuickTime)) != null) {
    ...
    private int readSample(ExtractorInput extractorInput, PositionHolder positionHolder) throws InterruptedException, IOException {
        ...
        long j11 = (j10 - position) + ((long) this.sampleBytesWritten);
        if (j11 < 0 || j11 >= 262144) {
    ...
    public SeekMap.SeekPoints getSeekPoints(long j10) {
        ...
        return j12 == -9223372036854775807L ? new SeekMap.SeekPoints(seekPoint) : new SeekMap.SeekPoints(seekPoint, new SeekPoint(j12, jMaybeAdjustSeekOffset));
    }
