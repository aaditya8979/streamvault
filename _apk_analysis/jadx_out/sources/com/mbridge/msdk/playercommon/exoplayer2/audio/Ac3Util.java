...
public final class Ac3Util {
    ...
    public static SyncFrameInfo parseAc3SyncframeInfo(ParsableBitArray parsableBitArray) {
        ...
        if (z10) {
            ...
            i12 = CHANNEL_COUNT_BY_ACMOD[bits4] + (bit ? 1 : 0);
            ...
            i12 = CHANNEL_COUNT_BY_ACMOD[bits8] + (parsableBitArray.readBit() ? 1 : 0);
            str = "audio/ac3";
        }
        return new SyncFrameInfo(str, i15, i12, i10, ac3SyncframeSize, i11);
    }
