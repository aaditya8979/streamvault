...
final class ExoPlayerImplInternal implements Handler.Callback, MediaPeriod.Callback, TrackSelector.InvalidationListener, MediaSource.SourceInfoRefreshListener, DefaultMediaClock.PlaybackParameterListener, PlayerMessage.Sender {
    ...
    private void doSomeWork() throws IOException, ExoPlaybackException {
        ...
        if (z11 && ((j10 == -9223372036854775807L || j10 <= this.playbackInfo.positionUs) && playingPeriod.info.isFinal)) {
            setState(4);
            stopRenderers();
    ...
    private boolean isTimelineReady() {
        ...
        MediaPeriodHolder playingPeriod = this.queue.getPlayingPeriod();
        long j10 = playingPeriod.info.durationUs;
        return j10 == -9223372036854775807L || this.playbackInfo.positionUs < j10 || ((mediaPeriodHolder = playingPeriod.next) != null && (mediaPeriodHolder.prepared || mediaPeriodHolder.info.f39160id.isAd()));
    }
    ...
    */
    private void maybeTriggerPendingMessages(long r8, long r10) throws com.mbridge.msdk.playercommon.exoplayer2.ExoPlaybackException {
        /*
    ...
    private void maybeUpdateLoadingPeriod() throws IOException {
        ...
        if (this.queue.shouldLoadNextMediaPeriod()) {
            ...
            this.queue.enqueueNextMediaPeriod(this.rendererCapabilities, this.trackSelector, this.loadControl.getAllocator(), this.mediaSource, this.playbackInfo.timeline.getPeriod(nextMediaPeriodInfo.f39160id.periodIndex, this.period, true).uid, nextMediaPeriodInfo).prepare(this, nextMediaPeriodInfo.startPositionUs);
            setIsLoading(true);
        }
    }
    ...
    private void resetInternal(boolean z10, boolean z11, boolean z12) {
        ...
        long j10 = z11 ? -9223372036854775807L : this.playbackInfo.positionUs;
        long j11 = z11 ? -9223372036854775807L : this.playbackInfo.contentPositionUs;
        PlaybackInfo playbackInfo = this.playbackInfo;
        this.playbackInfo = new PlaybackInfo(timeline, obj, mediaPeriodId, j10, j11, playbackInfo.playbackState, false, z12 ? TrackGroupArray.EMPTY : playbackInfo.trackGroups, z12 ? this.emptyTrackSelectorResult : playbackInfo.trackSelectorResult);
    ...
    private Pair<Integer, Long> resolveSeekPosition(SeekPosition seekPosition, boolean z10) {
        ...
        try {
            ...
            if (!z10 || (iResolveSubsequentPeriod = resolveSubsequentPeriod(((Integer) periodPosition.first).intValue(), timeline2, timeline)) == -1) {
                return null;
            }
    ...
    private void seekToCurrentPosition(boolean z10) throws ExoPlaybackException {
        MediaSource.MediaPeriodId mediaPeriodId = this.queue.getPlayingPeriod().info.f39160id;
    ...
    */
    ...
    private long seekToPeriodPosition(MediaSource.MediaPeriodId mediaPeriodId, long j10, boolean z10) throws ExoPlaybackException {
        ...
        if (mediaPeriodHolderAdvancePlayingPeriod != null) {
            ...
            if (mediaPeriodHolderAdvancePlayingPeriod.hasEnabledTracks) {
                long jSeekToUs = mediaPeriodHolderAdvancePlayingPeriod.mediaPeriod.seekToUs(j10);
    ...
    private boolean shouldKeepPeriodHolder(MediaSource.MediaPeriodId mediaPeriodId, long j10, MediaPeriodHolder mediaPeriodHolder) {
        if (!mediaPeriodId.equals(mediaPeriodHolder.info.f39160id) || !mediaPeriodHolder.prepared) {
            return false;
        }
        this.playbackInfo.timeline.getPeriod(mediaPeriodHolder.info.f39160id.periodIndex, this.period);
    ...
    private void updatePeriods() throws IOException, ExoPlaybackException {
        ...
        while (this.playWhenReady && playingPeriod != readingPeriod && this.rendererPositionUs >= playingPeriod.next.rendererPositionOffsetUs) {
            ...
            this.playbackInfo = playbackInfo.fromNewPosition(mediaPeriodInfo.f39160id, mediaPeriodInfo.startPositionUs, mediaPeriodInfo.contentPositionUs);
        ...
        if (readingPeriod.info.isFinal) {
            ...
            while (true) {
                ...
                if (i12 < rendererArr2.length) {
                    ...
                    boolean z11 = mediaPeriodHolderAdvanceReadingPeriod.mediaPeriod.readDiscontinuity() != -9223372036854775807L;
                    int i13 = 0;
                    while (true) {
