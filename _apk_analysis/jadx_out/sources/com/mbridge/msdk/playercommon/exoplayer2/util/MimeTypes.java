...
public final class MimeTypes {
    ...
    public static String getMediaMimeType(@Nullable String str) {
        ...
        if (!strTrim.startsWith("mp4a")) {
            return (strTrim.startsWith("ac-3") || strTrim.startsWith("dac3")) ? "audio/ac3" : (strTrim.startsWith("ec-3") || strTrim.startsWith("dec3")) ? "audio/eac3" : strTrim.startsWith("ec+3") ? "audio/eac3-joc" : (strTrim.startsWith("dtsc") || strTrim.startsWith("dtse")) ? "audio/vnd.dts" : (strTrim.startsWith("dtsh") || strTrim.startsWith("dtsl")) ? "audio/vnd.dts.hd" : strTrim.startsWith("opus") ? "audio/opus" : strTrim.startsWith("vorbis") ? "audio/vorbis" : getCustomMimeTypeForCodec(strTrim);
        }
        if (strTrim.startsWith("mp4a.")) {
