...
final class MediaPeriodQueue {
    ...
    private boolean canKeepMediaPeriodHolder(MediaPeriodHolder mediaPeriodHolder, MediaPeriodInfo mediaPeriodInfo) {
        ...
        return mediaPeriodInfo2.startPositionUs == mediaPeriodInfo.startPositionUs && mediaPeriodInfo2.endPositionUs == mediaPeriodInfo.endPositionUs && mediaPeriodInfo2.f39160id.equals(mediaPeriodInfo.f39160id);
    }
    ...
    private MediaPeriodInfo getFollowingMediaPeriodInfo(MediaPeriodHolder mediaPeriodHolder, long j10) {
        ...
        if (mediaPeriodInfo.isLastInTimelinePeriod) {
            int nextPeriodIndex = this.timeline.getNextPeriodIndex(mediaPeriodInfo.f39160id.periodIndex, this.period, this.window, this.repeatMode, this.shuffleModeEnabled);
            if (nextPeriodIndex == -1) {
                return null;
            }
            int i11 = this.timeline.getPeriod(nextPeriodIndex, this.period, true).windowIndex;
            Object obj = this.period.uid;
            long j13 = mediaPeriodInfo.f39160id.windowSequenceNumber;
            long j14 = 0;
            if (this.timeline.getWindow(i11, this.window).firstPeriodIndex == nextPeriodIndex) {
                ...
                if (mediaPeriodHolder2 == null || !mediaPeriodHolder2.uid.equals(obj)) {
                    ...
                    j12 = mediaPeriodHolder.next.info.f39160id.windowSequenceNumber;
                }
                j14 = jLongValue;
                j11 = j12;
                i10 = iIntValue;
        ...
        MediaSource.MediaPeriodId mediaPeriodId = mediaPeriodInfo.f39160id;
    ...
    private MediaPeriodInfo getMediaPeriodInfoForContent(int i10, long j10, long j11) {
        ...
        return new MediaPeriodInfo(mediaPeriodId, j10, adGroupTimeUs, -9223372036854775807L, adGroupTimeUs == Long.MIN_VALUE ? this.period.getDurationUs() : adGroupTimeUs, zIsLastInPeriod, isLastInTimeline(mediaPeriodId, zIsLastInPeriod));
    }
    ...
    private boolean isLastInPeriod(MediaSource.MediaPeriodId mediaPeriodId, long j10) {
        ...
        if (zIsAd && mediaPeriodId.adGroupIndex == i10 && mediaPeriodId.adIndexInAdGroup == adCountInAdGroup + (-1)) {
            return true;
        }
        return !zIsAd && this.period.getFirstAdIndexToPlay(i10) == adCountInAdGroup;
    }
    ...
    private MediaSource.MediaPeriodId resolveMediaPeriodIdForAds(int i10, long j10, long j11) {
        ...
        return adGroupIndexForPositionUs == -1 ? new MediaSource.MediaPeriodId(i10, j11) : new MediaSource.MediaPeriodId(i10, adGroupIndexForPositionUs, this.period.getFirstAdIndexToPlay(adGroupIndexForPositionUs), j11);
    }
    ...
    private long resolvePeriodIndexToWindowSequenceNumber(int i10) {
        ...
        for (MediaPeriodHolder frontPeriod = getFrontPeriod(); frontPeriod != null; frontPeriod = frontPeriod.next) {
            if (frontPeriod.uid.equals(obj)) {
                return frontPeriod.info.f39160id.windowSequenceNumber;
            }
        }
        for (MediaPeriodHolder frontPeriod2 = getFrontPeriod(); frontPeriod2 != null; frontPeriod2 = frontPeriod2.next) {
            ...
            if (indexOfPeriod2 != -1 && this.timeline.getPeriod(indexOfPeriod2, this.period).windowIndex == i11) {
                return frontPeriod2.info.f39160id.windowSequenceNumber;
            }
        }
    ...
    private boolean updateForPlaybackModeChange() {
        ...
        while (true) {
            int nextPeriodIndex = this.timeline.getNextPeriodIndex(frontPeriod.info.f39160id.periodIndex, this.period, this.window, this.repeatMode, this.shuffleModeEnabled);
            while (true) {
            ...
            if (nextPeriodIndex == -1 || mediaPeriodHolder == null || mediaPeriodHolder.info.f39160id.periodIndex != nextPeriodIndex) {
                break;
            }
            frontPeriod = mediaPeriodHolder;
        }
        ...
        frontPeriod.info = getUpdatedMediaPeriodInfo(mediaPeriodInfo, mediaPeriodInfo.f39160id);
    ...
    public MediaPeriodHolder advancePlayingPeriod() {
        ...
        if (mediaPeriodHolder != null) {
            ...
            if (i10 == 0) {
                ...
                this.oldFrontPeriodWindowSequenceNumber = mediaPeriodHolder2.info.f39160id.windowSequenceNumber;
            }
    ...
    public void clear(boolean z10) {
        ...
        if (frontPeriod != null) {
            ...
            this.oldFrontPeriodWindowSequenceNumber = frontPeriod.info.f39160id.windowSequenceNumber;
            frontPeriod.release();
    ...
    public MediaPeriodInfo getUpdatedMediaPeriodInfo(MediaPeriodInfo mediaPeriodInfo, int i10) {
        return getUpdatedMediaPeriodInfo(mediaPeriodInfo, mediaPeriodInfo.f39160id.copyWithPeriodIndex(i10));
    }
