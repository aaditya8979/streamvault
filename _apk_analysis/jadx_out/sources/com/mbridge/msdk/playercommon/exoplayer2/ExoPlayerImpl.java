...
final class ExoPlayerImpl implements ExoPlayer {
    ...
    public ExoPlayerImpl(Renderer[] rendererArr, TrackSelector trackSelector, LoadControl loadControl, Clock clock) {
        Log.i(TAG, "Init " + Integer.toHexString(System.identityHashCode(this)) + " [" + ExoPlayerLibraryInfo.VERSION_SLASHY + "] [" + Util.DEVICE_DEBUG_INFO + C3978d4.j.f31385e);
    ...
    private void handlePlaybackInfo(PlaybackInfo playbackInfo, int i10, boolean z10, int i11) {
        ...
        if (i12 == 0) {
            ...
            updatePlaybackInfo(playbackInfo2, z10, i11, i13, z11, false);
        }
    }
    ...
    @Override // com.mbridge.msdk.playercommon.exoplayer2.Player
    public void release() {
        Log.i(TAG, "Release " + Integer.toHexString(System.identityHashCode(this)) + " [" + ExoPlayerLibraryInfo.VERSION_SLASHY + "] [" + Util.DEVICE_DEBUG_INFO + "] [" + ExoPlayerLibraryInfo.registeredModules() + C3978d4.j.f31385e);
