...
public final class DeferredMediaPeriod implements MediaPeriod, MediaPeriod.Callback {
    ...
    public final MediaSource.MediaPeriodId f39169id;
    ...
    public void createPeriod() {
        MediaPeriod mediaPeriodCreatePeriod = this.mediaSource.createPeriod(this.f39169id, this.allocator);
    ...
    public void maybeThrowPrepareError() throws IOException {
        try {
            ...
            prepareErrorListener.onPrepareError(this.f39169id, e10);
        }
    }
