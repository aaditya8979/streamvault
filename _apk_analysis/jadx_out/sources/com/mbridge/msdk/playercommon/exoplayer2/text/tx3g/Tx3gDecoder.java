...
public final class Tx3gDecoder extends SimpleSubtitleDecoder {
    ...
    private static String readSubtitleText(ParsableByteArray parsableByteArray) throws SubtitleDecoderException {
        ...
        int unsignedShort = parsableByteArray.readUnsignedShort();
        return unsignedShort == 0 ? "" : (parsableByteArray.bytesLeft() < 2 || !((cPeekChar = parsableByteArray.peekChar()) == 65279 || cPeekChar == 65534)) ? parsableByteArray.readString(unsignedShort, Charset.forName("UTF-8")) : parsableByteArray.readString(unsignedShort, Charset.forName(C.UTF16_NAME));
    }
