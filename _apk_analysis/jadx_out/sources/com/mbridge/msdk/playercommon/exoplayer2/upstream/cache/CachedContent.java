...
final class CachedContent {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return this.f39176id == cachedContent.f39176id && this.key.equals(cachedContent.key) && this.cachedSpans.equals(cachedContent.cachedSpans) && this.metadata.equals(cachedContent.metadata);
    }
    ...
    public int headerHashCode(int i10) {
        int i11;
        int iHashCode;
        int iHashCode2 = (this.f39176id * 31) + this.key.hashCode();
        if (i10 < 2) {
    ...
    public SimpleCacheSpan touch(SimpleCacheSpan simpleCacheSpan) throws Cache.CacheException {
        ...
        SimpleCacheSpan simpleCacheSpanCopyWithUpdatedLastAccessTime = simpleCacheSpan.copyWithUpdatedLastAccessTime(this.f39176id);
    ...
    public void writeToStream(DataOutputStream dataOutputStream) throws IOException {
        dataOutputStream.writeInt(this.f39176id);
