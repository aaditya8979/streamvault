...
public class DefaultTrackSelector extends MappingTrackSelector {
    ...
    */
    ...
    public final Pair<RendererConfiguration[], TrackSelection[]> selectTracks(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, int[] iArr2) throws ExoPlaybackException {
        ...
        for (int i11 = 0; i11 < rendererCount; i11++) {
            rendererConfigurationArr[i11] = !parameters.getRendererDisabled(i11) && (mappedTrackInfo.getRendererType(i11) == 5 || trackSelectionArrSelectAllTracks[i11] != null) ? RendererConfiguration.DEFAULT : null;
        }
