...
public class BannerUtils {
    ...
    public static final /* synthetic */ int f38520a = 0;
    ...
    public static String getCloseIds(String str) {
        ...
        try {
            Map<String, List<com.mbridge.msdk.foundation.same.metadata.a>> map = b.f37724b;
        ...
        try {
            ...
            if (!TextUtils.isEmpty(str)) {
                ...
                if (jSONObjectOptJSONObject != null) {
                    strValueOf2 = String.valueOf(v0.a(c.n().d(), Integer.valueOf(jSONObjectOptJSONObject.getString(com.mbridge.msdk.foundation.same.a.f37699h)).intValue()));
                    strValueOf = String.valueOf(v0.a(c.n().d(), Integer.valueOf(jSONObjectOptJSONObject.getString(com.mbridge.msdk.foundation.same.a.f37700i)).intValue()));
                } else {
                    strValueOf = "-999";
                }
