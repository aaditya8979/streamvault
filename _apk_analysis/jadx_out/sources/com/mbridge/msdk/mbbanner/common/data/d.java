...
public class d {
    ...
    private static final String f38423a = c.class.getSimpleName();
    ...
    public static e a(Context context, String str, String str2, int i10, a aVar) {
        ...
        com.mbridge.msdk.foundation.same.net.utils.b.a(eVar, e.f37864h, strA);
        com.mbridge.msdk.foundation.same.net.utils.b.a(eVar, CampaignEx.JSON_KEY_AD_SOURCE_ID, "1");
        com.mbridge.msdk.foundation.same.net.utils.b.a(eVar, e.f37865i, str2);
        com.mbridge.msdk.foundation.same.net.utils.b.a(eVar, "ad_type", "296");
        com.mbridge.msdk.foundation.same.net.utils.b.a(eVar, TypedValues.CycleType.S_WAVE_OFFSET, i10 + "");
        com.mbridge.msdk.foundation.same.net.utils.b.a(eVar, e.f37863g, strA2);
