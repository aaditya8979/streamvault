    ...
    public a0 a(t.a aVar) throws IOException {
        ...
        if (f.a(yVarD.e()) && yVarD.a() != null) {
            ...
            if (aVarA == null) {
                ...
                yVarD.a().a(dVarA);
                dVarA.close();
                gVar.g().requestBodyEnd(gVar.e(), aVar2.f40391b);
            } else if (!cVar.f()) {
                gVarI.e();
            }
        }
        ...
        a0 a0VarA2 = (this.f40390a && iK == 101) ? a0VarA.p().a(com.mbridge.msdk.thrid.okhttp.internal.c.f40308c).a() : a0VarA.p().a(cVarH.a(a0VarA)).a();
