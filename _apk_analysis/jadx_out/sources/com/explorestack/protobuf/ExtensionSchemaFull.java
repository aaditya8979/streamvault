...
final class ExtensionSchemaFull extends ExtensionSchema<Descriptors.FieldDescriptor> {
    ...
    public Object findExtensionByNumber(ExtensionRegistryLite extensionRegistryLite, MessageLite messageLite, int i10) {
        return ((ExtensionRegistry) extensionRegistryLite).findExtensionByNumber(((Message) messageLite).getDescriptorForType(), i10);
    }
    ...
    public FieldSet<Descriptors.FieldDescriptor> getMutableExtensions(Object obj) {
        ...
        FieldSet fieldSetM4285clone = extensions.m4285clone();
        setExtensions(obj, fieldSetM4285clone);
        return fieldSetM4285clone;
    }
    ...
    @Override // com.explorestack.protobuf.ExtensionSchema
    public <UT, UB> UB parseExtension(Reader reader, Object obj, ExtensionRegistryLite extensionRegistryLite, FieldSet<Descriptors.FieldDescriptor> fieldSet, UB ub2, UnknownFieldSchema<UT, UB> unknownFieldSchema) throws IOException {
        Object field;
        ArrayList arrayList;
        ...
        if (extensionInfo.descriptor.isRepeated() && extensionInfo.descriptor.isPacked()) {
                ...
                case 14:
                    ...
                    while (it.hasNext()) {
                        ...
                        if (enumValueDescriptorFindValueByNumber != null) {
                            ...
                            ub2 = (UB) SchemaUtil.storeUnknownEnum(number, iIntValue, ub2, unknownFieldSchema);
                        }
                    }
                    fieldSet.setField(extensionInfo.descriptor, arrayList2);
                    break;
            ...
            if (extensionInfo.descriptor.getLiteType() != WireFormat.FieldType.ENUM) {
                ...
                if (objValueOf == null) {
                    return (UB) SchemaUtil.storeUnknownEnum(number, int32, ub2, unknownFieldSchema);
                }
            }
