...
final class SchemaUtil {
    ...
    public static <UT, UB> UB filterUnknownEnumList(int i10, List<Integer> list, Internal.EnumLiteMap<?> enumLiteMap, UB ub2, UnknownFieldSchema<UT, UB> unknownFieldSchema) {
        if (enumLiteMap == null) {
            return ub2;
        }
        if (list instanceof RandomAccess) {
            ...
            for (int i12 = 0; i12 < size; i12++) {
                ...
                if (enumLiteMap.findValueByNumber(iIntValue) != null) {
                    ...
                    ub2 = (UB) storeUnknownEnum(i10, iIntValue, ub2, unknownFieldSchema);
                }
            }
            if (i11 != size) {
            ...
            while (it.hasNext()) {
                ...
                if (enumLiteMap.findValueByNumber(iIntValue2) == null) {
                    ub2 = (UB) storeUnknownEnum(i10, iIntValue2, ub2, unknownFieldSchema);
                    it.remove();
                }
            }
        }
    ...
    public static <UT, UB> UB filterUnknownEnumList(int i10, List<Integer> list, Internal.EnumVerifier enumVerifier, UB ub2, UnknownFieldSchema<UT, UB> unknownFieldSchema) {
    ...
    public static <UT, UB> UB storeUnknownEnum(int i10, int i11, UB ub2, UnknownFieldSchema<UT, UB> unknownFieldSchema) {
        if (ub2 == null) {
