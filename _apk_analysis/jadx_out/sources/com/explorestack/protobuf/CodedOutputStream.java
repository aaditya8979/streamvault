    ...
    public static class ArrayEncoder extends CodedOutputStream {
        ...
        public final void writeUInt32NoTag(int i10) throws IOException {
            ...
            if ((i10 & (-128)) == 0) {
                ...
                int i13 = this.position;
                this.position = i13 + 1;
                UnsafeUtil.putByte(bArr3, i13, (byte) i10);
                return;
            }
            byte[] bArr4 = this.buffer;
            int i14 = this.position;
            this.position = i14 + 1;
            UnsafeUtil.putByte(bArr4, i14, (byte) (i10 | 128));
            int i15 = i10 >>> 7;
            if ((i15 & (-128)) == 0) {
                byte[] bArr5 = this.buffer;
                int i16 = this.position;
                this.position = i16 + 1;
                UnsafeUtil.putByte(bArr5, i16, (byte) i15);
                return;
            }
            byte[] bArr6 = this.buffer;
            int i17 = this.position;
            this.position = i17 + 1;
            UnsafeUtil.putByte(bArr6, i17, (byte) (i15 | 128));
            int i18 = i15 >>> 7;
            if ((i18 & (-128)) == 0) {
                byte[] bArr7 = this.buffer;
                int i19 = this.position;
                this.position = i19 + 1;
                UnsafeUtil.putByte(bArr7, i19, (byte) i18);
                return;
            }
            byte[] bArr8 = this.buffer;
            int i20 = this.position;
            this.position = i20 + 1;
            UnsafeUtil.putByte(bArr8, i20, (byte) (i18 | 128));
            int i21 = i18 >>> 7;
            if ((i21 & (-128)) == 0) {
                byte[] bArr9 = this.buffer;
                int i22 = this.position;
                this.position = i22 + 1;
                UnsafeUtil.putByte(bArr9, i22, (byte) i21);
                return;
            }
            byte[] bArr10 = this.buffer;
            int i23 = this.position;
            this.position = i23 + 1;
            UnsafeUtil.putByte(bArr10, i23, (byte) (i21 | 128));
            byte[] bArr11 = this.buffer;
            int i24 = this.position;
            this.position = i24 + 1;
            UnsafeUtil.putByte(bArr11, i24, (byte) (i21 >>> 7));
        }
