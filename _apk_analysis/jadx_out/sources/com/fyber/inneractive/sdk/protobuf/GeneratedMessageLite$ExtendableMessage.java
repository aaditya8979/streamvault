...
public abstract class GeneratedMessageLite$ExtendableMessage<MessageType extends GeneratedMessageLite$ExtendableMessage<MessageType, BuilderType>, BuilderType> extends z0 implements e2 {
    public n0 extensions = n0.f19189d;
    ...
    private void mergeMessageSetExtensionFromBytes(s sVar, h0 h0Var, x0 x0Var) throws IOException {
        d2 d2Var = (d2) this.extensions.f19190a.get(x0Var.f19283d);
        c2 builder = d2Var != null ? d2Var.toBuilder() : null;
        if (builder == null) {
            builder = x0Var.f19282c.newBuilderForType();
        }
        t0 t0Var = (t0) builder;
        t0Var.getClass();
        try {
            ...
            w0 w0Var = x0Var.f19283d;
            if (w0Var.f19268c.a() == k4.ENUM) {
    ...
    /* JADX WARN: Type inference failed for: r10v24, types: [com.fyber.inneractive.sdk.protobuf.d1] */
    ...
    */
    ...
    private void verifyExtensionContainingType(x0 x0Var) {
        if (x0Var.f19280a != getDefaultInstanceForType()) {
    ...
    public n0 ensureExtensionsAreMutable() {
        ...
        if (n0Var.f19191b) {
            this.extensions = n0Var.m4287clone();
        }
    ...
    public final <Type> Type getExtension(e0 e0Var) {
        ...
        Type type = (Type) this.extensions.f19190a.get(x0VarAccess$000.f19283d);
        if (type == 0) {
            return (Type) x0VarAccess$000.f19281b;
        }
        w0 w0Var = x0VarAccess$000.f19283d;
        if (!w0Var.f19269d) {
            return w0Var.f19268c.a() == k4.ENUM ? (Type) x0VarAccess$000.f19283d.f19266a.a(((Integer) type).intValue()) : type;
        }
        if (w0Var.f19268c.a() != k4.ENUM) {
            return type;
        }
        ...
        for (Object objA : (List) type) {
            if (x0VarAccess$000.f19283d.f19268c.a() == k4.ENUM) {
                objA = x0VarAccess$000.f19283d.f19266a.a(((Integer) objA).intValue());
            }
            r12.add(objA);
        }
        return r12;
    ...
    public final <Type> Type getExtension(e0 e0Var, int i10) {
        ...
        Object obj = n0Var.f19190a.get(w0Var);
        if (obj == null) {
            throw new IndexOutOfBoundsException();
        }
        Type type = (Type) ((List) obj).get(i10);
        return x0VarAccess$000.f19283d.f19268c.a() == k4.ENUM ? (Type) x0VarAccess$000.f19283d.f19266a.a(((Integer) type).intValue()) : type;
    }
    ...
    public final <Type> boolean hasExtension(e0 e0Var) {
        ...
        return n0Var.f19190a.get(w0Var) != null;
    }
