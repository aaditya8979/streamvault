...
public final class h extends i {
    ...
    public final boolean f19137a = true;
    ...
    public h(ByteBuffer byteBuffer) {
        this.f19138b = byteBuffer.array();
        this.f19139c = byteBuffer.position() + byteBuffer.arrayOffset();
        this.f19140d = byteBuffer.limit() + byteBuffer.arrayOffset();
    }
    ...
    public final s a() throws n1 {
        ...
        a(iX);
        if (this.f19137a) {
            byte[] bArr = this.f19138b;
            int i10 = this.f19139c;
            q qVar2 = s.f19223b;
            qVar = new n(bArr, i10, iX);
        } else {
            byte[] bArr2 = this.f19138b;
            int i11 = this.f19139c;
            q qVar3 = s.f19223b;
            s.a(i11, i11 + iX, bArr2.length);
            qVar = new q(s.f19224c.a(bArr2, i11, iX));
        }
        this.f19139c += iX;
        return qVar;
    }
    ...
    public final String a(boolean z10) throws n1 {
        ...
        if (z10) {
            byte[] bArr = this.f19138b;
            int i10 = this.f19139c;
            if (!d4.f19118a.b(bArr, i10, i10 + iX)) {
                throw new n1("Protocol message had invalid UTF-8.");
            }
        }
        String str = new String(this.f19138b, this.f19139c, iX, l1.f19181a);
        this.f19139c += iX;
        return str;
    }

    public final void a(int i10) throws n1 {
        if (i10 < 0 || i10 > this.f19140d - this.f19139c) {
    ...
    public final void a(List list) throws n1 {
        ...
        if (!(list instanceof u1)) {
            ...
            int iX = this.f19139c + x();
            while (this.f19139c < iX) {
                list.add(Long.valueOf(y()));
            }
            b(iX);
            return;
        ...
        int iX2 = this.f19139c + x();
        while (this.f19139c < iX2) {
            u1Var.a(y());
        }
        b(iX2);
    }
    ...
    public final Object c(t2 t2Var, h0 h0Var) {
        ...
        this.f19142f = ((this.f19141e >>> 3) << 3) | 4;
        try {
            Object objA = t2Var.a();
    ...
    public final void d(List list) throws n1 {
        ...
        if (!(list instanceof q0)) {
            ...
            if (i12 == 2) {
                int iX = x();
                d(iX);
                int i13 = this.f19139c + iX;
                while (this.f19139c < i13) {
        ...
        q0 q0Var = (q0) list;
        int i15 = this.f19141e & 7;
        if (i15 == 2) {
            int iX2 = x();
            d(iX2);
            int i16 = this.f19139c + iX2;
            while (this.f19139c < i16) {
    ...
    */
    public final boolean i() throws com.fyber.inneractive.sdk.protobuf.n1 {
        ...
        Lf:
            ...
            return r4
        L29:
            int r0 = com.fyber.inneractive.sdk.protobuf.n1.f19193a
    ...
    public final void j(List list) throws n1 {
        ...
        if (!(list instanceof d0)) {
            ...
            int iX = x();
            e(iX);
            int i14 = this.f19139c + iX;
            while (this.f19139c < i14) {
        ...
        int iX2 = x();
        e(iX2);
        int i17 = this.f19139c + iX2;
        while (this.f19139c < i17) {
    ...
    public final boolean u() {
        return this.f19139c == this.f19140d;
    }
        ...
        if (i16 < 0) {
            ...
            if (i18 >= 0) {
                ...
                if (i20 < 0) {
                    ...
                    long j15 = i20;
                    i15 = i10 + 5;
                    long j16 = j15 ^ (((long) bArr[i19]) << 28);
                    if (j16 >= 0) {
                        j12 = 266354560;
                    } else {
                        i19 = i10 + 6;
                        long j17 = j16 ^ (((long) bArr[i15]) << 35);
                        if (j17 < 0) {
                            j11 = -34093383808L;
                        } else {
                            i15 = i10 + 7;
                            j16 = j17 ^ (((long) bArr[i19]) << 42);
                            if (j16 >= 0) {
                                j12 = 4363953127296L;
                            } else {
                                i19 = i10 + 8;
                                j17 = j16 ^ (((long) bArr[i15]) << 49);
                                if (j17 < 0) {
                                    j11 = -558586000294016L;
                                } else {
                                    i15 = i10 + 9;
                                    long j18 = (j17 ^ (((long) bArr[i19]) << 56)) ^ 71499008037633920L;
                                    if (j18 < 0) {
                                        int i21 = i10 + 10;
                                        if (bArr[i15] < 0) {
                                            throw new n1("CodedInputStream encountered a malformed varint.");
