...
public final class t extends w {
    ...
    public int f19233k = Integer.MAX_VALUE;

    public t(byte[] bArr, int i10, int i11, boolean z10) {
        this.f19227e = bArr;
        this.f19228f = i11 + i10;
        this.f19230h = i10;
        this.f19231i = i10;
    }
    ...
    public final int a() {
        ...
        return i10 - (this.f19230h - this.f19231i);
    }
    ...
    @Override // com.fyber.inneractive.sdk.protobuf.w
    public final int b() {
        return this.f19230h - this.f19231i;
    }
    ...
    public final boolean c() {
        return this.f19230h == this.f19228f;
    }
    ...
    public final int d(int i10) {
        ...
        int i11 = (this.f19230h - this.f19231i) + i10;
        int i12 = this.f19233k;
        if (i11 > i12) {
    ...
    */
    public final com.fyber.inneractive.sdk.protobuf.q e() throws com.fyber.inneractive.sdk.protobuf.n1 {
        /*
            ...
            if (r0 > r1) goto L28
            byte[] r1 = r5.f19227e
            com.fyber.inneractive.sdk.protobuf.q r3 = com.fyber.inneractive.sdk.protobuf.s.f19223b
            int r3 = r2 + r0
            int r4 = r1.length
            ...
            com.fyber.inneractive.sdk.protobuf.o r4 = com.fyber.inneractive.sdk.protobuf.s.f19224c
        ...
        L28:
            if (r0 != 0) goto L2d
            com.fyber.inneractive.sdk.protobuf.q r0 = com.fyber.inneractive.sdk.protobuf.s.f19223b
            return r0
        L2d:
            if (r0 <= 0) goto L40
            int r1 = r5.f19228f
        ...
        L40:
            if (r0 > 0) goto L56
            if (r0 != 0) goto L4e
            byte[] r0 = com.fyber.inneractive.sdk.protobuf.l1.f19182b
        L46:
            com.fyber.inneractive.sdk.protobuf.q r1 = com.fyber.inneractive.sdk.protobuf.s.f19223b
    ...
    public final boolean e(int i10) throws n1 {
        ...
        int i12 = 0;
        if (i11 == 0) {
            if (this.f19228f - this.f19230h >= 10) {
                while (i12 < 10) {
                    byte[] bArr = this.f19227e;
                    int i13 = this.f19230h;
                    this.f19230h = i13 + 1;
                    if (bArr[i13] < 0) {
                        i12++;
                    }
            ...
            while (i12 < 10) {
                int i14 = this.f19230h;
                if (i14 == this.f19228f) {
                    throw new n1("While parsing a protocol message, the input ended unexpectedly in the middle of a field.  This could mean either that the input has been truncated or that an embedded message misreported its own length.");
                }
                byte[] bArr2 = this.f19227e;
                this.f19230h = i14 + 1;
                if (bArr2[i14] < 0) {
                    i12++;
                }
    ...
    public final void f(int i10) throws n1 {
        if (i10 >= 0) {
            int i11 = this.f19228f;
            int i12 = this.f19230h;
            if (i10 <= i11 - i12) {
                this.f19230h = i12 + i10;
                return;
            }
        }
        if (i10 >= 0) {
    ...
    */
    ...
    public final String r() throws n1 {
        ...
        if (iM > 0) {
            ...
            int i11 = this.f19230h;
            if (iM <= i10 - i11) {
                String str = new String(this.f19227e, i11, iM, l1.f19181a);
                this.f19230h += iM;
                return str;
            }
        }
    ...
    public final String s() throws n1 {
        ...
        if (iM > 0) {
            ...
            int i11 = this.f19230h;
            if (iM <= i10 - i11) {
                String strA = d4.f19118a.a(this.f19227e, i11, iM);
                this.f19230h += iM;
                return strA;
            }
        }
    ...
    public final void z() {
        int i10 = this.f19228f + this.f19229g;
        this.f19228f = i10;
        int i11 = i10 - this.f19231i;
        int i12 = this.f19233k;
        if (i11 <= i12) {
            this.f19229g = 0;
            return;
