...
public abstract class t0 implements c2 {
    ...
    public final z0 f19234a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public z0 f19235b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public boolean f19236c = false;

    public t0(z0 z0Var) {
        this.f19234a = z0Var;
        this.f19235b = (z0) z0Var.dynamicMethod(y0.NEW_MUTABLE_INSTANCE);
    }
    ...
    public final t0 a(w wVar, h0 h0Var) throws IOException {
        ...
        try {
            p2 p2Var = p2.f19204c;
            z0 z0Var = this.f19235b;
            p2Var.getClass();
            t2 t2VarA = p2Var.a(z0Var.getClass());
            z0 z0Var2 = this.f19235b;
            x xVar = wVar.f19265d;
            if (xVar == null) {
                xVar = new x(wVar);
            }
    ...
    public final void c() {
        if (this.f19236c) {
            z0 z0Var = (z0) this.f19235b.dynamicMethod(y0.NEW_MUTABLE_INSTANCE);
            a(z0Var, this.f19235b);
            this.f19235b = z0Var;
            this.f19236c = false;
        }
    }
    ...
    public final Object clone() {
        t0 t0VarNewBuilderForType = this.f19234a.newBuilderForType();
        z0 z0VarB = b();
        t0VarNewBuilderForType.c();
        a(t0VarNewBuilderForType.f19235b, z0VarB);
