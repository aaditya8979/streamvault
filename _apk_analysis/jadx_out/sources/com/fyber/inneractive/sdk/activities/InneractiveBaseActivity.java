...
public class InneractiveBaseActivity extends Activity {
    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            this.f15775a = new b(this);
            getOnBackInvokedDispatcher().registerOnBackInvokedCallback(0, this.f15775a);
        }
    }
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            try {
                if (this.f15775a != null) {
                    getOnBackInvokedDispatcher().unregisterOnBackInvokedCallback(this.f15775a);
                    this.f15775a = null;
                }
            } catch (Exception e10) {
