...
public final class b extends TelephonyCallback implements TelephonyCallback.DisplayInfoListener {
    ...
    public final ExecutorService f15990a = Executors.newSingleThreadExecutor();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public h f15991b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public final TelephonyManager f15992c;

    public b(TelephonyManager telephonyManager, h hVar) {
        this.f15992c = telephonyManager;
        this.f15991b = hVar;
    }

    public final void a() {
        this.f15991b = null;
        TelephonyManager telephonyManager = this.f15992c;
        if (telephonyManager != null) {
            telephonyManager.unregisterTelephonyCallback(this);
        }
        this.f15990a.shutdownNow();
    }

    public final void b() {
        TelephonyManager telephonyManager = this.f15992c;
        if (telephonyManager != null) {
            telephonyManager.registerTelephonyCallback(this.f15990a, this);
        }
    }
    ...
    */
    public final void onDisplayInfoChanged(android.telephony.TelephonyDisplayInfo r4) {
        ...
        L3a:
            com.fyber.inneractive.sdk.util.z0 r4 = com.fyber.inneractive.sdk.util.z0.MOBILE_5G
        L3c:
            com.fyber.inneractive.sdk.config.cellular.h r0 = r3.f15991b
            if (r0 == 0) goto L43
            r0.a(r4)
        L43:
            return
