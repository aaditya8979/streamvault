...
public final class e1 extends t0 {
    ...
    public final o0 a(l lVar, Map map, int i10) {
        ...
        try {
            ...
            if (inputStream != null) {
                ...
                if (bitmapDecodeStream != null) {
                    ...
                    for (int i13 = 0; i13 < i11; i13++) {
                        ...
                        if (i13 != 0) {
                            if (i14 != i12) {
                                d1Var.f16956a = bitmapDecodeStream;
                                IAlog.a("SimpleImageLoader: Got a valid bitmap %s", this.f16963p);
                                break;
                            }
                        } else {
                            i12 = i14;
                    ...
                    d1Var.f16957b = "Got an invalid bitmap";
                } else {
                    IAlog.a("SimpleImageLoader: Got an invalid bitmap", new Object[0]);
                    d1Var.f16957b = "Got an invalid bitmap";
                }
            ...
            d1Var.f16957b = e10.getMessage();
        } catch (OutOfMemoryError e11) {
            IAlog.c("SimpleImageLoader: OutOfMemoryError on load image %s", e11.getMessage());
            Bitmap bitmap = d1Var.f16956a;
            if (bitmap != null) {
                bitmap.recycle();
            }
            d1Var.f16957b = e11.getMessage();
        }
        o0Var.f17012a = d1Var;
        return o0Var;
    }
