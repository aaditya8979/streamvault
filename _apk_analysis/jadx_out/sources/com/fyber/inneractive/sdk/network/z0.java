...
public final class z0 extends t0 {
    ...
    public final AtomicInteger f17093q;

    public z0(f0 f0Var, String str) {
        super(f0Var, g0.f16977c.a(), null);
        this.f17093q = new AtomicInteger();
        this.f17092p = str;
    }

    public static void b(String str) {
        IAConfigManager.O.f15973s.a(new z0(new y0(str, System.currentTimeMillis()), str));
    }
    ...
    public final o0 a(l lVar, Map map, int i10) throws n0 {
        try {
            ...
            if (inputStream != null) {
                o0Var.f17013b = com.fyber.inneractive.sdk.util.v.b(inputStream).toString();
            }
            return o0Var;
        } catch (Exception e10) {
    ...
    @Override // com.fyber.inneractive.sdk.network.t0
    public final int g() {
        return ((int) Math.pow(2.0d, this.f17093q.get())) * 1000;
    }
    ...
    public final boolean u() {
        return this.f17093q.getAndIncrement() < 4;
    }
}
