...
public abstract class d {
    public static b a(com.fyber.inneractive.sdk.player.exoplayer2.extractor.b bVar) throws InterruptedException, r, EOFException {
        n nVar = new n(16);
        if (c.a(bVar, nVar).f18300a != z.a("RIFF")) {
            return null;
        }
        ...
        while (cVarA.f18300a != z.a("fmt ")) {
            bVar.a((int) cVarA.f18301b, false);
            cVarA = c.a(bVar, nVar);
        }
        if (cVarA.f18301b < 16) {
            throw new IllegalStateException();
        }
        bVar.a(nVar.f18794a, 0, 16, false);
        nVar.e(0);
        int iF = nVar.f();
        int iF2 = nVar.f();
        int iD = nVar.d();
        ...
        int i10 = (iF2 * iF4) / 8;
        if (iF3 != i10) {
            throw new r("Expected block alignment: " + i10 + "; got: " + iF3);
        }
        int iA = z.a(iF4);
        if (iA == 0) {
        ...
        if (iF == 1 || iF == 65534) {
            bVar.a(((int) cVarA.f18301b) - 16, false);
