...
public final class e extends BroadcastReceiver {
    ...
    public final void onReceive(Context context, Intent intent) {
        ...
        } else if (!bVar.f16938c || !s.a()) {
            bVar.f16936a = applicationContext;
            new Thread(bVar.f16940e, "NativeCache").start();
        }
        com.fyber.inneractive.sdk.factories.d.f16273a.a(com.fyber.inneractive.sdk.response.a.RETURNED_ADTYPE_NATIVE, new c());
        k kVar = j.f16277a;
        kVar.f16278a.add(new d());
    }
}
