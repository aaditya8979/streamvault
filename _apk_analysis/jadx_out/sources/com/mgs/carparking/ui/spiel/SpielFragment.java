...
public class SpielFragment extends BaseFragment<FragmentSpielBinding, SPIELVIEWMODEL> implements vd.a {
    ...
    public class a extends WebChromeClient {
        ...
        public void onProgressChanged(WebView webView, int i10) {
            if (i10 == 100) {
                ((FragmentSpielBinding) SpielFragment.this.binding).f43098d.setVisibility(8);
            } else {
                ((FragmentSpielBinding) SpielFragment.this.binding).f43098d.setProgress(i10);
            }
    ...
    public class b implements View.OnClickListener {
        ...
        public void onClick(View view) {
            if (((FragmentSpielBinding) SpielFragment.this.binding).f43099e.canGoBack()) {
                ((FragmentSpielBinding) SpielFragment.this.binding).f43099e.goBack();
            }
        }
    }
    ...
    public class c {
        ...
        public void gotoBrowser(String str) {
            ...
            try {
                ed.a.a(SpielFragment.this.getContext(), str);
    ...
    public /* synthetic */ void lambda$initViewObservable$1(k0 k0Var) throws Exception {
        ...
        ((FragmentSpielBinding) this.binding).f43099e.post(new Runnable() { // from class: bd.d
            @Override // java.lang.Runnable
            public final void run() {
                this.f5564b.lambda$initViewObservable$0(strQuote);
            }
        });
    }
    ...
    public void initViewObservable() {
        ...
        addSubscribe(op.a.a().d(k0.class).subscribe(new g() { // from class: bd.c
            @Override // dm.g
            public final void accept(Object obj) throws Exception {
                this.f5563b.lambda$initViewObservable$1((k0) obj);
            }
        }));
    }
    ...
    public void initWebView() {
        ...
        ec.b.f("链接为：");
        ((FragmentSpielBinding) this.binding).f43099e.loadUrl(l0.P());
