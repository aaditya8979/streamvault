...
public class VarietyAdapter extends BindingRecyclerViewAdapter {
    ...
    public Context f44705r;

    public VarietyAdapter(Context context) {
        this.f44705r = context;
    }
    ...
    public void f(ViewDataBinding viewDataBinding, int i10, int i11, int i12, Object obj) {
        ...
        Glide.with(this.f44705r).load(Integer.valueOf(R.drawable.ic_video_is_play)).into((ImageView) viewDataBinding.getRoot().findViewById(R.id.iv_is_play));
    }
