...
public abstract class a8 {
    ...
    private static final DateFormat f7659a = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSSZ", Locale.US);

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final Random f7660b = new Random(System.currentTimeMillis());
    ...
    public static Uri a(String str, long j10, Uri uri, t7 t7Var, com.applovin.impl.sdk.k kVar) {
        ...
        try {
            ...
            kVar.O();
            if (com.applovin.impl.sdk.o.a()) {
                kVar.O().a("VastUtils", "Unable to replace macros in URL string " + str, th2);
            }
            kVar.D().a("VastUtils", th2);
            return null;
        }
    }

    private static String a() {
        return Integer.toString(f7660b.nextInt(89999999) + 10000000);
    }
    ...
    public static String a(s7 s7Var) {
        ...
        if (size <= 0 || (p8VarB = ((p8) listA.get(size - 1)).b(VastTagName.VAST_AD_TAG_URI)) == null) {
            return null;
        }
        return p8VarB.d();
    }
    ...
    private static Set a(s7 s7Var, com.applovin.impl.sdk.k kVar) {
        ...
        List<p8> listA = s7Var.a();
        HashSet hashSet = new HashSet(listA.size());
        for (p8 p8Var : listA) {
            p8 p8VarB = p8Var.b(VastTagName.WRAPPER);
            if (p8VarB == null) {
                p8VarB = p8Var.b(VastTagName.IN_LINE);
            }
            hashSet = a(hashSet, p8VarB != null ? p8VarB.a(VastTagName.ERROR) : p8Var.a(VastTagName.ERROR), s7Var, kVar);
        }
        kVar.O();
        if (com.applovin.impl.sdk.o.a()) {
    ...
    public static void a(p8 p8Var, Map map, s7 s7Var, com.applovin.impl.sdk.k kVar) {
        ...
        p8 p8VarC = p8Var.c(VastTagName.TRACKING_EVENTS);
        if (p8VarC == null || (listA = p8VarC.a(VastTagName.TRACKING)) == null) {
            return;
        }
        for (p8 p8Var2 : listA) {
    ...
    public static void a(Set set, long j10, Uri uri, t7 t7Var, com.applovin.impl.sdk.k kVar) {
        ...
        while (it.hasNext()) {
            y7 y7Var = (y7) it.next();
            Uri uriA = a(y7Var.c(), j10, uri, t7Var, kVar);
            if (uriA != null) {
                kVar.f0().a(com.applovin.impl.sdk.network.d.b().d(uriA.toString()).a(false).b(y7Var.d()).a(), false);
            }
        }
    }
    ...
    public static boolean a(p8 p8Var) {
        if (p8Var != null) {
            return p8Var.b(VastTagName.IN_LINE) != null;
        }
        throw new IllegalArgumentException("Unable to check if a given XmlNode contains an inline response");
    }

    private static String b() {
        DateFormat dateFormat = f7659a;
    ...
    public static boolean b(p8 p8Var) {
        if (p8Var != null) {
            return p8Var.b(VastTagName.WRAPPER) != null;
        }
