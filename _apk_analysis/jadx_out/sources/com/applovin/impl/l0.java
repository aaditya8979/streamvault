...
public abstract class l0 extends n3 {
    ...
    private com.applovin.impl.sdk.k f8655a;
    ...
    public class a extends s2 {
        ...
        public final /* synthetic */ List f8657e;
        ...
        public final /* synthetic */ List f8660h;

        /* JADX INFO: renamed from: i, reason: collision with root package name */
        public final /* synthetic */ List f8661i;
        ...
        public List c(int i10) {
            ...
            if (i10 == c.MISSING_TC_NETWORKS.ordinal()) {
                ...
                list = i10 == c.LISTED_TC_NETWORKS.ordinal() ? this.f8659g : i10 == c.LISTED_AC_NETWORKS.ordinal() ? this.f8660h : this.f8661i;
                z10 = false;
            }
        ...
        public int d(int i10) {
            return i10 == c.MISSING_TC_NETWORKS.ordinal() ? this.f8657e.size() : i10 == c.MISSING_AC_NETWORKS.ordinal() ? this.f8658f.size() : i10 == c.LISTED_TC_NETWORKS.ordinal() ? this.f8659g.size() : i10 == c.LISTED_AC_NETWORKS.ordinal() ? this.f8660h.size() : this.f8661i.size();
        }
    ...
    public void onCreate(Bundle bundle) {
        ...
        ((ListView) findViewById(R.id.listView)).setAdapter((ListAdapter) this.f8656b);
    }
}
