...
public class AppLovinVastMediaView extends AppLovinMediaView implements AppLovinCommunicatorSubscriber {
    ...
    public class d implements AppLovinTouchToClickListener.OnClickListener {
        ...
        public void onClick(View view, MotionEvent motionEvent) {
            ...
            if (AppLovinVastMediaView.this.vastAd.B0() && (uriC0 = AppLovinVastMediaView.this.vastAd.c0()) != null) {
                ...
                AppLovinVastMediaView.this.nativeAd.handleNativeAdClick(uriC0, null, (!((Boolean) AppLovinVastMediaView.this.sdk.a(x4.f10861w)).booleanValue() || AppLovinVastMediaView.this.viewActivity == null) ? AppLovinVastMediaView.this.getContext() : AppLovinVastMediaView.this.viewActivity);
            }
        }
    }
    ...
    public class e implements MediaPlayer.OnPreparedListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnCompletionListener {
        ...
        public boolean onError(MediaPlayer mediaPlayer, int i10, int i11) {
            AppLovinVastMediaView.this.handleMediaError("Video view error (" + i10 + StringUtils.COMMA + i11 + ")");
            return true;
        }
        ...
        public void safedk_AppLovinVastMediaView$e_onCompletion_88f7c28abf0dd7120d52ce73cde77146(MediaPlayer mediaPlayer) {
            com.applovin.impl.sdk.o oVar = AppLovinVastMediaView.this.logger;
            if (com.applovin.impl.sdk.o.a()) {
    ...
    public AppLovinVastMediaView(AppLovinNativeAdImpl appLovinNativeAdImpl, com.applovin.impl.sdk.k kVar, Context context) {
        ...
        if (((Boolean) kVar.a(x4.f10706d5)).booleanValue()) {
            ...
            this.videoWidgetLinearLayout.setAlpha(((Float) kVar.a(x4.f10697c5)).floatValue());
            ImageView imageView = new ImageView(context);
            this.playPauseButtonImageView = imageView;
            imageView.setClickable(true);
            f fVar = new f(this, aVar);
            this.playPauseButtonImageView.setOnClickListener(fVar);
            int iDpToPx3 = AppLovinSdkUtils.dpToPx(context, ((Integer) kVar.a(x4.f10680a5)).intValue());
            ...
            int iDpToPx4 = AppLovinSdkUtils.dpToPx(context, ((Integer) kVar.a(x4.f10688b5)).intValue());
            this.videoWidgetLinearLayout.setPadding(iDpToPx4, iDpToPx4, iDpToPx4, iDpToPx4);
            int i10 = iDpToPx4 * 2;
            this.videoWidgetLinearLayout.setLayoutParams(new FrameLayout.LayoutParams(iDpToPx3 + iDpToPx2 + i10, Math.max(iDpToPx3, iDpToPx2) + i10, BadgeDrawable.BOTTOM_START));
            addView(this.videoWidgetLinearLayout);
        }
        if (((Boolean) kVar.a(x4.f10715e5)).booleanValue()) {
            ...
            int iDpToPx5 = AppLovinSdkUtils.dpToPx(context, ((Integer) kVar.a(x4.f10724f5)).intValue());
        ...
        appLovinVideoView.setOnTouchListener(new AppLovinTouchToClickListener(kVar, x4.f10719f0, getContext(), new d(this, aVar)));
        ...
        hashSet.addAll(vastAd.a(o7.d.VIDEO, z7.f11075a));
    }
    ...
    public void onMessageReceived(AppLovinCommunicatorMessage appLovinCommunicatorMessage) {
        if ("video_caching_failed".equals(appLovinCommunicatorMessage.getTopic())) {
            ...
            if (messageData.getLong(CreativeInfo.f52474c) == this.vastAd.getAdIdNumber() && this.isVideoStream) {
