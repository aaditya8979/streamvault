...
public class CollectionUtils {
    public static <T> boolean addObjectIfExists(@Nullable T t10, List<T> list) {
        if (t10 != null) {
            return list.add(t10);
        }
        return false;
    ...
    public static <T> boolean addUniqueObjectIfExists(@Nullable T t10, List<T> list) {
    ...
    public static String implode(Collection<String> collection, int i10) {
        return implode(collection, io.appmetrica.analytics.coreutils.internal.StringUtils.COMMA, i10);
    }
    ...
    public static String toJsonString(Map<String, String> map, String str) {
        try {
            ...
            o.c("CollectionUtils", "Failed to convert map '" + map + "' to JSON string.", e10);
            return str;
        }
    }
}
