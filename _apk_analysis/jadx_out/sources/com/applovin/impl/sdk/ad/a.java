...
public final class a extends b {
    ...
    public static a a(JSONObject jSONObject, com.applovin.impl.sdk.k kVar) {
        ...
        String string = JsonUtils.getString(jSONObject3, CreativeInfo.f52467al, "");
        if (TextUtils.isEmpty(string)) {
            return null;
        }
        String string2 = JsonUtils.getString(jSONObject3, "video", "");
        JsonUtils.putString(jSONObject3, CreativeInfo.f52467al, JsonUtils.getString(jSONObject, "original_html_source", ""));
    ...
    public /* synthetic */ void s(h5 h5Var) {
        h5Var.b(CreativeInfo.f52467al, this.f9936n);
        h5Var.b("stream_url", this.f9938p);
    }
    ...
    public void E0() {
        ...
        if (h5Var != null) {
            h5Var.a(new Consumer() { // from class: com.applovin.impl.sdk.ad.d
                @Override // androidx.core.util.Consumer
                public final void accept(Object obj) {
                    this.f9972b.s((h5) obj);
                }
            });
            return;
        }
        synchronized (this.adObjectLock) {
            JsonUtils.putString(this.adObject, CreativeInfo.f52467al, this.f9936n);
            JsonUtils.putString(this.adObject, "stream_url", this.f9938p);
        }
    }
    ...
    public JSONObject a() {
        ...
        JsonUtils.putString(jSONObject, "original_html_source", this.f9936n);
        JsonUtils.putString(jSONObject, "original_video_uri_string", this.f9937o);
        JsonUtils.putString(jSONObject, "original_video_stream_uri_string", this.f9938p);
    ...
    public void d(String str) {
        h5 h5Var = this.synchronizedAdObject;
        if (h5Var != null) {
            h5Var.b(CreativeInfo.f52467al, str);
            return;
        }
        synchronized (this.adObjectLock) {
            JsonUtils.putString(this.adObject, CreativeInfo.f52467al, str);
        }
    }
    ...
    public String g1() {
        return getStringFromAdObject(CreativeInfo.f52467al, "");
    }
    ...
    public JSONObject getOriginalFullResponse() {
        ...
        if (jSONArray.length() > 0) {
            ...
            JsonUtils.putString(jSONObject, CreativeInfo.f52467al, this.f9936n);
            JsonUtils.putString(jSONObject, "video", this.f9937o);
            JsonUtils.putString(jSONObject, "stream_url", this.f9938p);
        }
        return jSONObjectA;
    }
