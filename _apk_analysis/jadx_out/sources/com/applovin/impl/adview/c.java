...
public class c extends t4 {
    ...
    private final com.applovin.impl.sdk.k f7740a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final com.applovin.impl.sdk.o f7741b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private final a f7742c;
    ...
    private void a(WebView webView, RenderProcessGoneDetail renderProcessGoneDetail, com.applovin.impl.sdk.ad.b bVar) {
        ...
        if (webView == null || !webView.equals(this.f7742c.f())) {
            return;
        }
        this.f7742c.b();
        AppLovinAdSize appLovinAdSizeK = this.f7742c.k();
        if (n7.a(appLovinAdSizeK)) {
            this.f7742c.a(appLovinAdSizeK);
            this.f7742c.F();
        }
    }
    ...
    private void a(b bVar, Uri uri) {
        ...
        AppLovinAdView appLovinAdViewI = this.f7742c.i();
        if (appLovinAdViewI != null && currentAd != null) {
            if (currentAd instanceof o7) {
                ((o7) currentAd).getAdEventTracker().v();
            }
            this.f7742c.a(currentAd, appLovinAdViewI, uri, bVar.getAndClearLastClickEvent());
        } else if (com.applovin.impl.sdk.o.a()) {
            this.f7741b.b("AdWebView", "Attempting to track click that is null or not an ApplovinAdView instance for clickedUri = " + uri);
        }
    }
    ...
    public Map a() {
        ...
        mapHashMap.putAll(f2.a((AppLovinAdImpl) this.f7742c.g()));
        return mapHashMap;
    }
    ...
    */
    ...
    public void onReceivedError(WebView webView, int i10, String str, String str2) {
        ...
        com.applovin.impl.sdk.ad.b bVarG = this.f7742c.g();
        String str3 = "Received error with error code: " + i10 + " with description \\'" + str + "\\' for URL: " + str2;
        if (com.applovin.impl.sdk.o.a()) {
            this.f7741b.b("AdWebView", str3 + " for ad: " + bVarG);
        }
        if (n7.a(str2, this.f7740a)) {
            this.f7740a.D().a("adWebViewReceivedError", str2, i10, str);
        }
    }
    ...
    public void onReceivedHttpError(WebView webView, WebResourceRequest webResourceRequest, WebResourceResponse webResourceResponse) {
        ...
        com.applovin.impl.sdk.ad.b bVarG = this.f7742c.g();
        if (com.applovin.impl.sdk.o.a()) {
            this.f7741b.b("AdWebView", "Received HTTP error: " + webResourceResponse + "for url: " + webResourceRequest.getUrl() + " and ad: " + bVarG);
        }
        if (n7.a(webResourceRequest.getUrl().toString(), this.f7740a)) {
            this.f7740a.D().a("adWebViewReceivedHttpError", webResourceRequest.getUrl().toString(), webResourceResponse.getStatusCode(), webResourceResponse.getReasonPhrase());
        }
    }
    ...
    public void onReceivedSslError(WebView webView, SslErrorHandler sslErrorHandler, SslError sslError) {
        ...
        if (com.applovin.impl.sdk.o.a()) {
            this.f7741b.b("AdWebView", str + " for ad: " + bVarG);
        }
    }
    ...
    public boolean onRenderProcessGone(WebView webView, RenderProcessGoneDetail renderProcessGoneDetail) {
        ...
        if (((Boolean) this.f7740a.a(x4.R5)).booleanValue()) {
    ...
    public void safedk_c_onLoadResource_1af43fc902fb6865fb0a01b3cce96a24(WebView webView, String str) {
        ...
        if (com.applovin.impl.sdk.o.a()) {
            this.f7741b.d("AdWebView", "Loaded resource: " + str);
        }
    }
    ...
    public void safedk_c_onPageFinished_a44c2ec5ed56e4c2419c3d079c098b25(WebView webView, String str) {
        ...
        if (com.applovin.impl.sdk.o.a()) {
            this.f7741b.d("AdWebView", "Loaded URL: " + str);
        }
        this.f7742c.a(webView, str);
    }
    ...
    public boolean safedk_c_shouldOverrideUrlLoading_678f8c4351efae3cc506edb28e260cba(WebView webView, WebResourceRequest webResourceRequest) {
        ...
        this.f7741b.b("AdWebView", "No url found for request");
        return false;
    }
    ...
    public boolean shouldOverrideUrlLoading(WebView webView, WebResourceRequest webResourceRequest) {
        ...
        BrandSafetyUtils.onShouldOverrideUrlLoadingWithHeaders(com.safedk.android.utils.g.f53127a, webView, webResourceRequest, zSafedk_c_shouldOverrideUrlLoading_678f8c4351efae3cc506edb28e260cba);
    ...
    public boolean shouldOverrideUrlLoading(WebView webView, String str) {
        ...
        BrandSafetyUtils.onShouldOverrideUrlLoading(com.safedk.android.utils.g.f53127a, webView, str, zSafedk_c_shouldOverrideUrlLoading_2ce55369ff10fa536fb839524e517b10);
