...
public class g0 implements AppLovinBroadcastManager.Receiver {
    ...
    private static final Set f8323c = new HashSet();

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private final g7 f8324a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final com.applovin.impl.sdk.k f8325b;

    private g0(long j10, final boolean z10, com.applovin.impl.sdk.k kVar, final Runnable runnable) {
        this.f8324a = g7.a(j10, z10, kVar, new Runnable() { // from class: com.applovin.impl.qa
            @Override // java.lang.Runnable
            public final void run() {
                this.f9676b.a(z10, runnable);
            }
        });
        this.f8325b = kVar;
        f8323c.add(this);
