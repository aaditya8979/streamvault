...
public abstract class f2 {
    ...
    public static Map a(k3 k3Var) {
        ...
        CollectionUtils.putStringIfValid(BrandSafetyEvent.f52736ad, k3Var.c(), map);
        String strB = k3Var.b();
    ...
    public static Map a(AppLovinAdImpl appLovinAdImpl) {
        ...
        CollectionUtils.putStringIfValid(CreativeInfo.aU, appLovinAdImpl.getAdDomain(), map);
        CollectionUtils.putStringIfValid(CreativeInfo.f52474c, String.valueOf(appLovinAdImpl.getAdIdNumber()), map);
    ...
    public static Map a(AppLovinNativeAdImpl appLovinNativeAdImpl) {
        ...
        CollectionUtils.putStringIfValid(CreativeInfo.aU, appLovinNativeAdImpl.getAdDomain(), map);
        CollectionUtils.putStringIfValid(CreativeInfo.f52474c, String.valueOf(appLovinNativeAdImpl.getAdIdNumber()), map);
    ...
    public static Map a(y2 y2Var) {
        ...
        CollectionUtils.putStringIfValid("ad_unit_id", y2Var.getAdUnitId(), mapA);
