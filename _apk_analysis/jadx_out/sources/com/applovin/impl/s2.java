...
public abstract class s2 extends BaseAdapter implements View.OnClickListener {
    ...
    private List f9807b = new ArrayList();

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private Map f9808c = new HashMap();
    ...
    private Drawable a(View view) {
        ...
        gradientDrawable.setColor(m0.a(R.color.applovin_sdk_highlightListItemColor, this.f9806a));
    ...
    private j2 a(int i10) {
        for (int i11 = 0; i11 < b(); i11++) {
            Integer num = (Integer) this.f9808c.get(Integer.valueOf(i11));
            if (num != null) {
    ...
    public View getView(int i10, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            q2Var = new q2();
            q2Var.f9653a = (TextView) view.findViewById(android.R.id.text1);
            q2Var.f9654b = (TextView) view.findViewById(android.R.id.text2);
            q2Var.f9655c = (ImageView) view.findViewById(R.id.imageView);
            q2Var.f9656d = (ImageView) view.findViewById(R.id.detailImageView);
            view.setTag(q2Var);
    ...
    public void notifyDataSetChanged() {
        ...
        int iB = b();
        this.f9808c = new HashMap(iB);
        r2 r2VarA = a();
        if (r2VarA != null) {
            this.f9807b.add(r2VarA);
            i10 = 1;
        } else {
            i10 = 0;
        }
        for (int i11 = 0; i11 < iB; i11++) {
            int iD = d(i11);
            if (iD != 0) {
                this.f9807b.add(e(i11));
                this.f9807b.addAll(c(i11));
                this.f9808c.put(Integer.valueOf(i11), Integer.valueOf(i10));
                i10 += iD + 1;
            }
        }
        this.f9807b.add(new v4(""));
