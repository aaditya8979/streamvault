...
public class UnityAdsMediationAdapter extends MediationAdapterBase implements MaxSignalProvider, MaxInterstitialAdapter, MaxRewardedAdapter, MaxAdViewAdapter {
    ...
    /* JADX INFO: renamed from: com.applovin.mediation.adapters.UnityAdsMediationAdapter$7, reason: invalid class name */
    ...
    private void updatePrivacyConsent(MaxAdapterParameters maxAdapterParameters, Context context) throws JSONException {
    ...
    public void collectSignal(MaxAdapterSignalCollectionParameters maxAdapterSignalCollectionParameters, @Nullable Activity activity, final MaxSignalCollectionListener maxSignalCollectionListener) throws JSONException {
        log("Collecting signal...");
        updatePrivacyConsent(maxAdapterSignalCollectionParameters, getContext(activity));
        UnityAds.getToken(new TokenConfiguration(toUnityAdFormat(maxAdapterSignalCollectionParameters)), new IUnityAdsTokenListener() { // from class: com.applovin.mediation.adapters.o
            @Override // com.unity3d.ads.IUnityAdsTokenListener
            public final void onUnityAdsTokenReady(String str) {
                this.f11132a.lambda$collectSignal$0(maxSignalCollectionListener, str);
            }
        });
    }
    ...
    @Override // com.applovin.mediation.adapter.MaxAdapter
    public void initialize(MaxAdapterInitializationParameters maxAdapterInitializationParameters, @Nullable Activity activity, final MaxAdapter.OnCompletionListener onCompletionListener) throws JSONException {
    ...
    public void loadAdViewAd(MaxAdapterResponseParameters maxAdapterResponseParameters, final MaxAdFormat maxAdFormat, @Nullable Activity activity, final MaxAdViewAdapterListener maxAdViewAdapterListener) throws JSONException {
    ...
    public void loadInterstitialAd(MaxAdapterResponseParameters maxAdapterResponseParameters, @Nullable Activity activity, final MaxInterstitialAdapterListener maxInterstitialAdapterListener) throws JSONException {
    ...
    public void loadRewardedAd(MaxAdapterResponseParameters maxAdapterResponseParameters, @Nullable Activity activity, final MaxRewardedAdapterListener maxRewardedAdapterListener) throws JSONException {
        String thirdPartyAdPlacementId = maxAdapterResponseParameters.getThirdPartyAdPlacementId();
        StringBuilder sb2 = new StringBuilder();
        sb2.append("Loading ");
        sb2.append(AppLovinSdkUtils.isValidString(maxAdapterResponseParameters.getBidResponse()) ? "bidding " : "");
