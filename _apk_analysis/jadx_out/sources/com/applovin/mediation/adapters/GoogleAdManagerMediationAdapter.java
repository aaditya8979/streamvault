...
public class GoogleAdManagerMediationAdapter extends MediationAdapterBase implements MaxInterstitialAdapter, MaxRewardedAdapter, MaxAdViewAdapter {
        ...
        public void requestLayout() {
            ...
            post(new Runnable() { // from class: com.applovin.mediation.adapters.c
                ...
                public final void run() {
                    this.f11102b.lambda$requestLayout$0();
                }
            });
        }
    }
        ...
        if (this.rewardedAd != null) {
            ...
            this.rewardedAd.show(activity, new OnUserEarnedRewardListener() { // from class: com.applovin.mediation.adapters.b
                ...
                public final void onUserEarnedReward(RewardItem rewardItem) {
                    this.f11100a.lambda$showRewardedAd$0(thirdPartyAdPlacementId, rewardItem);
                }
            });
            return;
        }
