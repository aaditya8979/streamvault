...
public class AppLovinSdkUtils {
    ...
    private static final Handler f11240a = new Handler(Looper.getMainLooper());
    ...
    public static final class Size {
        ...
        public boolean equals(Object obj) {
            ...
            Size size = (Size) obj;
            return this.f11241a == size.getWidth() && this.f11242b == size.getHeight();
        }
        ...
        public String toString() {
            return this.f11241a + VastAttributes.HORIZONTAL_POSITION + this.f11242b;
        }
    }
    ...
    public static void runOnUiThreadDelayed(Runnable runnable, long j10) {
        runOnUiThreadDelayed(runnable, j10, f11240a);
    }
