...
public class AppLovinAdType {
    ...
    public static final AppLovinAdType APP_OPEN = new AppLovinAdType(BrandSafetyUtils.f51655l);
    ...
    public static AppLovinAdType fromString(String str) {
        ...
        if (BrandSafetyUtils.f51655l.equalsIgnoreCase(str)) {
            return APP_OPEN;
        }
    ...
    public String getLabel() {
        return this.f11223a.toUpperCase(Locale.ENGLISH);
    }
