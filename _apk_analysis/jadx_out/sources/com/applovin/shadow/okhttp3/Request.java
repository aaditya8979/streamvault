...
public final class Request {
    ...
    public static class Builder {
        ...
        public Builder(@NotNull Request request) {
            ...
            this.tags = request.getTags$okhttp().isEmpty() ? new LinkedHashMap<>() : kotlin.collections.a.C(request.getTags$okhttp());
    ...
    public final RequestBody m4235deprecated_body() {
        return this.body;
    }

    @NotNull
    /* JADX INFO: renamed from: -deprecated_cacheControl, reason: not valid java name */
    public final CacheControl m4236deprecated_cacheControl() {
        return cacheControl();
    }

    @NotNull
    /* JADX INFO: renamed from: -deprecated_headers, reason: not valid java name */
    public final Headers m4237deprecated_headers() {
        return this.headers;
    }

    @NotNull
    /* JADX INFO: renamed from: -deprecated_method, reason: not valid java name */
    public final String m4238deprecated_method() {
        return this.method;
    }

    @NotNull
    /* JADX INFO: renamed from: -deprecated_url, reason: not valid java name */
    public final HttpUrl m4239deprecated_url() {
        return this.url;
    }
