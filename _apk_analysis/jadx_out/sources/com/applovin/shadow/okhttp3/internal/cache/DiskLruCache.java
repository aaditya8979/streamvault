...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    public final class Editor {
        ...
        public final Sink newSink(int i10) {
            ...
            synchronized (diskLruCache) {
                ...
                try {
                    return new FaultHidingSink(diskLruCache.getFileSystem$okhttp().sink(this.entry.getDirtyFiles$okhttp().get(i10)), new l<IOException, r>() { // from class: com.applovin.shadow.okhttp3.internal.cache.DiskLruCache$Editor$newSink$1$1
    ...
    /* JADX WARN: Type inference failed for: r11v3, types: [com.applovin.shadow.okhttp3.internal.cache.DiskLruCache$cleanupTask$1] */
    ...
    private final BufferedSink newJournalWriter() throws FileNotFoundException {
        return Okio.buffer(new FaultHidingSink(this.fileSystem.appendingSink(this.journalFile), new l<IOException, r>() { // from class: com.applovin.shadow.okhttp3.internal.cache.DiskLruCache$newJournalWriter$faultHidingSink$1
            {
                super(1);
            }
