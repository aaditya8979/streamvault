...
public final class Http1ExchangeCodec implements ExchangeCodec {
    ...
    public final class ChunkedSource extends AbstractSource {
        ...
        private final void readChunkSize() throws IOException {
            ...
            try {
                ...
                String string = d0.s1(this.this$0.source.readUtf8LineStrict()).toString();
                if (this.bytesRemainingInChunk >= 0) {
                    if (!(string.length() > 0) || a0.W(string, ";", false, 2, null)) {
                        if (this.bytesRemainingInChunk == 0) {
    ...
    private final boolean isChunked(Request request) {
        return a0.J("chunked", request.header("Transfer-Encoding"), true);
    }

    private final boolean isChunked(Response response) {
        return a0.J("chunked", Response.header$default(response, "Transfer-Encoding", null, 2, null), true);
    }
    ...
    @Override // com.applovin.shadow.okhttp3.internal.http.ExchangeCodec
    @NotNull
    public Sink createRequestBody(@NotNull Request request, long j10) throws ProtocolException {
