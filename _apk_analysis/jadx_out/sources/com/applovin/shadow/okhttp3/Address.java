...
public final class Address {
    ...
    public final Authenticator m4129deprecated_proxyAuthenticator() {
        return this.proxyAuthenticator;
    }

    @NotNull
    /* JADX INFO: renamed from: -deprecated_proxySelector, reason: not valid java name */
    public final ProxySelector m4130deprecated_proxySelector() {
        return this.proxySelector;
    }

    @NotNull
    /* JADX INFO: renamed from: -deprecated_socketFactory, reason: not valid java name */
    public final SocketFactory m4131deprecated_socketFactory() {
        return this.socketFactory;
    }

    @Nullable
    /* JADX INFO: renamed from: -deprecated_sslSocketFactory, reason: not valid java name */
    public final SSLSocketFactory m4132deprecated_sslSocketFactory() {
        return this.sslSocketFactory;
    }

    @NotNull
    /* JADX INFO: renamed from: -deprecated_url, reason: not valid java name */
    public final HttpUrl m4133deprecated_url() {
        return this.url;
    }
