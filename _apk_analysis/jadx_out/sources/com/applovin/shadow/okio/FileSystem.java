...
public abstract class FileSystem {
    ...
    public static /* synthetic */ Object m4270write$default(FileSystem fileSystem, Path path, boolean z10, l lVar, int i10, Object obj) throws Throwable {
        Object objInvoke;
        if (obj != null) {
    ...
    public final <T> T m4271read(@NotNull Path path, @NotNull l<? super BufferedSource, ? extends T> lVar) throws Throwable {
        T tInvoke;
        p.k(path, C3978d4.i.f31327b);
    ...
    public final <T> T m4272write(@NotNull Path path, boolean z10, @NotNull l<? super BufferedSink, ? extends T> lVar) throws Throwable {
        T tInvoke;
        p.k(path, C3978d4.i.f31327b);
        p.k(lVar, "writerAction");
    ...
    public final void createDirectories(@NotNull Path path, boolean z10) throws IOException {
        p.k(path, "dir");
        com.applovin.shadow.okio.internal.FileSystem.commonCreateDirectories(this, path, z10);
    }
    ...
    public void deleteRecursively(@NotNull Path path, boolean z10) throws IOException {
        p.k(path, "fileOrDirectory");
        com.applovin.shadow.okio.internal.FileSystem.commonDeleteRecursively(this, path, z10);
    }
    ...
    public ao.i<Path> listRecursively(@NotNull Path path, boolean z10) {
        p.k(path, "dir");
        return com.applovin.shadow.okio.internal.FileSystem.commonListRecursively(this, path, z10);
    }
