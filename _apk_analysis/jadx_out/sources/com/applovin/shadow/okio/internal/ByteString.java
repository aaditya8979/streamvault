...
public final class ByteString {
    ...
    */
    ...
    public static final int commonCompareTo(@NotNull com.applovin.shadow.okio.ByteString byteString, @NotNull com.applovin.shadow.okio.ByteString byteString2) {
        p.k(byteString, "<this>");
    ...
    public static final void commonCopyInto(@NotNull com.applovin.shadow.okio.ByteString byteString, int i10, @NotNull byte[] bArr, int i11, int i12) {
        p.k(byteString, "<this>");
    ...
    public static final boolean commonEndsWith(@NotNull com.applovin.shadow.okio.ByteString byteString, @NotNull com.applovin.shadow.okio.ByteString byteString2) {
        p.k(byteString, "<this>");
        p.k(byteString2, "suffix");
        return byteString.rangeEquals(byteString.size() - byteString2.size(), byteString2, 0, byteString2.size());
    }

    public static final boolean commonEndsWith(@NotNull com.applovin.shadow.okio.ByteString byteString, @NotNull byte[] bArr) {
        p.k(byteString, "<this>");
        p.k(bArr, "suffix");
    ...
    public static final int commonIndexOf(@NotNull com.applovin.shadow.okio.ByteString byteString, @NotNull byte[] bArr, int i10) {
        p.k(byteString, "<this>");
        p.k(bArr, "other");
    ...
    public static final int commonLastIndexOf(@NotNull com.applovin.shadow.okio.ByteString byteString, @NotNull com.applovin.shadow.okio.ByteString byteString2, int i10) {
        p.k(byteString, "<this>");
        p.k(byteString2, "other");
        return byteString.lastIndexOf(byteString2.internalArray$okio(), i10);
    }

    public static final int commonLastIndexOf(@NotNull com.applovin.shadow.okio.ByteString byteString, @NotNull byte[] bArr, int i10) {
        p.k(byteString, "<this>");
        p.k(bArr, "other");
    ...
    @NotNull
    public static final com.applovin.shadow.okio.ByteString commonOf(@NotNull byte[] bArr) {
        p.k(bArr, "data");
    ...
    public static final boolean commonRangeEquals(@NotNull com.applovin.shadow.okio.ByteString byteString, int i10, @NotNull com.applovin.shadow.okio.ByteString byteString2, int i11, int i12) {
        p.k(byteString, "<this>");
        p.k(byteString2, "other");
        return byteString2.rangeEquals(i11, byteString.getData$okio(), i10, i12);
    }

    public static final boolean commonRangeEquals(@NotNull com.applovin.shadow.okio.ByteString byteString, int i10, @NotNull byte[] bArr, int i11, int i12) {
        p.k(byteString, "<this>");
        p.k(bArr, "other");
    ...
    public static final boolean commonStartsWith(@NotNull com.applovin.shadow.okio.ByteString byteString, @NotNull com.applovin.shadow.okio.ByteString byteString2) {
        p.k(byteString, "<this>");
        p.k(byteString2, "prefix");
        return byteString.rangeEquals(0, byteString2, 0, byteString2.size());
    }

    public static final boolean commonStartsWith(@NotNull com.applovin.shadow.okio.ByteString byteString, @NotNull byte[] bArr) {
        p.k(byteString, "<this>");
        p.k(bArr, "prefix");
    ...
    public static final com.applovin.shadow.okio.ByteString commonSubstring(@NotNull com.applovin.shadow.okio.ByteString byteString, int i10, int i11) {
        ...
        if (iResolveDefaultParameter <= byteString.getData$okio().length) {
            if (iResolveDefaultParameter - i10 >= 0) {
                return (i10 == 0 && iResolveDefaultParameter == byteString.getData$okio().length) ? byteString : new com.applovin.shadow.okio.ByteString(cn.p.q(byteString.getData$okio(), i10, iResolveDefaultParameter));
            }
    ...
    public static final com.applovin.shadow.okio.ByteString commonToByteString(@NotNull byte[] bArr, int i10, int i11) {
        ...
        return new com.applovin.shadow.okio.ByteString(cn.p.q(bArr, i10, iResolveDefaultParameter + i10));
    }
    ...
    public static final String commonToString(@NotNull com.applovin.shadow.okio.ByteString byteString) {
        ...
        if (iResolveDefaultParameter != byteString.getData$okio().length) {
            byteString2 = new com.applovin.shadow.okio.ByteString(cn.p.q(byteString.getData$okio(), 0, iResolveDefaultParameter));
        }
