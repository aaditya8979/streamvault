...
@Metadata(bv = {}, d1 = {"\u0000>\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0010\b\n\u0002\b\u000f\n\u0002\u0018\u0002\n\u0002\b\u0002\u0018\u0000  2\u00020\u0001:\u0004! \"#B\u0017\u0012\u0006\u0010\b\u001a\u00020\u0007\u0012\u0006\u0010\u000b\u001a\u00020\n¢\u0006\u0004\b\u001e\u0010\u001fJ\b\u0010\u0003\u001a\u00020\u0002H\u0002J\u000e\u0010\u0006\u001a\u00020\u00022\u0006\u0010\u0005\u001a\u00020\u0004R\u0014\u0010\b\u001a\u00020\u00078\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\b\u0010\tR\u0014\u0010\u000b\u001a\u00020\n8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u000b\u0010\fR \u0010\u000e\u001a\u00020\r8\u0000X\u0081\u0004¢\u0006\u0012\n\u0004\b\u000e\u0010\u000f\u0012\u0004\b\u0012\u0010\u0013\u001a\u0004\b\u0010\u0010\u0011R\u0014\u0010\u0017\u001a\u00020\u00148BX\u0082\u0004¢\u0006\u0006\u001a\u0004\b\u0015\u0010\u0016R\u0014\u0010\u0019\u001a\u00020\u00148BX\u0082\u0004¢\u0006\u0006\u001a\u0004\b\u0018\u0010\u0016R\u0014\u0010\u001b\u001a\u00020\u00148BX\u0082\u0004¢\u0006\u0006\u001a\u0004\b\u001a\u0010\u0016R\u0014\u0010\u001d\u001a\u00020\u00148BX\u0082\u0004¢\u0006\u0006\u001a\u0004\b\u001c\u0010\u0016¨\u0006&²\u0006\f\u0010%\u001a\u00020$8\nX\u008a\u0084\u0002"}, d2 = {"Lcom/vungle/ads/internal/ClickCoordinateTracker;", "", "Lbn/r;", "sendClickCoordinates", "Landroid/view/MotionEvent;", "event", "trackCoordinate", "Landroid/content/Context;", GAMConfig.KEY_CONTEXT, "Landroid/content/Context;", "Lcom/vungle/ads/internal/model/AdPayload;", "advertisement", "Lcom/vungle/ads/internal/model/AdPayload;", "Lcom/vungle/ads/internal/ClickCoordinateTracker$ClickCoordinate;", "currentClick", "Lcom/vungle/ads/internal/ClickCoordinateTracker$ClickCoordinate;", "getCurrentClick$vungle_ads_release", "()Lcom/vungle/ads/internal/ClickCoordinateTracker$ClickCoordinate;", "getCurrentClick$vungle_ads_release$annotations", "()V", "", "getRequestedWidth", "()I", "requestedWidth", "getRequestedHeight", "requestedHeight", "getDeviceWidth", "deviceWidth", "getDeviceHeight", "deviceHeight", "<init>", "(Landroid/content/Context;Lcom/vungle/ads/internal/model/AdPayload;)V", VastTagName.COMPANION, "ClickCoordinate", "Coordinate", "DeviceScreenInfo", "Lcom/vungle/ads/internal/network/TpatSender;", "tpatSender", "vungle-ads_release"}, k = 1, mv = {1, 7, 1})
public final class ClickCoordinateTracker {
    ...
    public static final /* data */ class ClickCoordinate {
        ...
        public ClickCoordinate(@NotNull Coordinate coordinate, @NotNull Coordinate coordinate2) {
            p.k(coordinate, "downCoordinate");
            p.k(coordinate2, "upCoordinate");
        ...
        public final ClickCoordinate copy(@NotNull Coordinate downCoordinate, @NotNull Coordinate upCoordinate) {
            p.k(downCoordinate, "downCoordinate");
            p.k(upCoordinate, "upCoordinate");
        ...
        public boolean equals(@Nullable Object other) {
            ...
            return p.f(this.downCoordinate, clickCoordinate.downCoordinate) && p.f(this.upCoordinate, clickCoordinate.upCoordinate);
        }
    ...
    public static final /* data */ class Coordinate {
        ...
        @NotNull
        public final Coordinate copy(int x10, int y10) {
            return new Coordinate(x10, y10);
        }
    ...
    public static final /* data */ class DeviceScreenInfo {
        ...
        public boolean equals(@Nullable Object other) {
            ...
            return (other instanceof DeviceScreenInfo) && p.f(this.context, ((DeviceScreenInfo) other).context);
        }
    ...
    private final void sendClickCoordinates() {
        ...
        g gVarA = kotlin.b.a(LazyThreadSafetyMode.SYNCHRONIZED, new sn.a<TpatSender>() { // from class: com.vungle.ads.internal.ClickCoordinateTracker$sendClickCoordinates$$inlined$inject$1
        ...
        for (String str : tpatUrls$default) {
            ...
            p.j(str2, "MACRO_REQ_WIDTH");
            String strReplace = new Regex(str2).replace(str, String.valueOf(requestedWidth));
            String str3 = MACRO_REQ_HEIGHT;
            p.j(str3, "MACRO_REQ_HEIGHT");
            String strReplace2 = new Regex(str3).replace(strReplace, String.valueOf(requestedHeight));
            String str4 = MACRO_WIDTH;
            p.j(str4, "MACRO_WIDTH");
            String strReplace3 = new Regex(str4).replace(strReplace2, String.valueOf(requestedWidth2));
            String str5 = MACRO_HEIGHT;
            p.j(str5, "MACRO_HEIGHT");
            String strReplace4 = new Regex(str5).replace(strReplace3, String.valueOf(requestedHeight2));
            String str6 = MACRO_DOWN_X;
            p.j(str6, "MACRO_DOWN_X");
            String strReplace5 = new Regex(str6).replace(strReplace4, String.valueOf(this.currentClick.getDownCoordinate().getX()));
            String str7 = MACRO_DOWN_Y;
            p.j(str7, "MACRO_DOWN_Y");
            String strReplace6 = new Regex(str7).replace(strReplace5, String.valueOf(this.currentClick.getDownCoordinate().getY()));
            String str8 = MACRO_UP_X;
            p.j(str8, "MACRO_UP_X");
            String strReplace7 = new Regex(str8).replace(strReplace6, String.valueOf(this.currentClick.getUpCoordinate().getX()));
            String str9 = MACRO_UP_Y;
            p.j(str9, "MACRO_UP_Y");
            TpatSender.sendTpat$default(m7292sendClickCoordinates$lambda0(gVarA), new TpatRequest.Builder(new Regex(str9).replace(strReplace7, String.valueOf(this.currentClick.getUpCoordinate().getY()))).tpatKey(Constants.COORDINATE).build(), false, 2, null);
        }
    }

    /* JADX INFO: renamed from: sendClickCoordinates$lambda-0, reason: not valid java name */
    private static final TpatSender m7292sendClickCoordinates$lambda0(g<TpatSender> gVar) {
