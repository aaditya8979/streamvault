...
@Metadata(bv = {}, d1 = {"\u00004\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\bÇ\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0013\u0010\u0014J\u001a\u0010\u0005\u001a\f\u0012\b\u0012\u0006\u0012\u0002\b\u00030\u00040\u0003HÖ\u0001¢\u0006\u0004\b\u0005\u0010\u0006J\u0011\u0010\t\u001a\u00020\u00022\u0006\u0010\b\u001a\u00020\u0007HÖ\u0001J\u0019\u0010\u000e\u001a\u00020\r2\u0006\u0010\u000b\u001a\u00020\n2\u0006\u0010\f\u001a\u00020\u0002HÖ\u0001R\u0014\u0010\u0012\u001a\u00020\u000f8VXÖ\u0005¢\u0006\u0006\u001a\u0004\b\u0010\u0010\u0011¨\u0006\u0015"}, d2 = {"com/vungle/ads/internal/model/AdPayload.ViewAbilityInfo.$serializer", "Lwo/m0;", "Lcom/vungle/ads/internal/model/AdPayload$ViewAbilityInfo;", "", "Lkotlinx/serialization/KSerializer;", "childSerializers", "()[Lkotlinx/serialization/KSerializer;", "Lkotlinx/serialization/encoding/Decoder;", "decoder", "deserialize", "Lkotlinx/serialization/encoding/Encoder;", "encoder", "value", "Lbn/r;", "serialize", "Lkotlinx/serialization/descriptors/SerialDescriptor;", "getDescriptor", "()Lkotlinx/serialization/descriptors/SerialDescriptor;", "descriptor", "<init>", "()V", "vungle-ads_release"}, k = 1, mv = {1, 7, 1})
public final class AdPayload$ViewAbilityInfo$$serializer implements m0<AdPayload.ViewAbilityInfo> {
    ...
    static {
        ...
        g2Var.n("is_enabled", true);
        g2Var.n("extra_vast", true);
        descriptor = g2Var;
    }
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{a.t(i.f86540a), a.t(w2.f86635a)};
    }
    ...
    public AdPayload.ViewAbilityInfo deserialize(@NotNull Decoder decoder) {
        ...
        if (cVarB.l()) {
            ...
            objC2 = cVarB.C(descriptor2, 1, w2.f86635a, null);
            i10 = 3;
        } else {
            objC = null;
            Object objC3 = null;
            ...
            while (z10) {
                ...
                if (iW == -1) {
                    ...
                    objC = cVarB.C(descriptor2, 0, i.f86540a, objC);
                    i11 |= 1;
                } else {
                    if (iW != 1) {
                        throw new UnknownFieldException(iW);
                    }
                    objC3 = cVarB.C(descriptor2, 1, w2.f86635a, objC3);
                    i11 |= 2;
                }
            }
            objC2 = objC3;
        ...
        cVarB.c(descriptor2);
        return new AdPayload.ViewAbilityInfo(i10, (Boolean) objC, (String) objC2, (r2) null);
    }
    ...
    @Override // so.l
    public void serialize(@NotNull Encoder encoder, @NotNull AdPayload.ViewAbilityInfo viewAbilityInfo) {
        p.k(encoder, "encoder");
        p.k(viewAbilityInfo, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        d dVarB = encoder.b(descriptor2);
        AdPayload.ViewAbilityInfo.write$Self(viewAbilityInfo, dVarB, descriptor2);
        dVarB.c(descriptor2);
    }
