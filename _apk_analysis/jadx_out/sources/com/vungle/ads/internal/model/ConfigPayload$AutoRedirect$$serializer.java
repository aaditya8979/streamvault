...
public final class ConfigPayload$AutoRedirect$$serializer implements m0<ConfigPayload.AutoRedirect> {
    ...
    static {
        ...
        g2 g2Var = new g2("com.vungle.ads.internal.model.ConfigPayload.AutoRedirect", configPayload$AutoRedirect$$serializer, 2);
        g2Var.n("allow_auto_redirect", true);
        g2Var.n("after_click_ms", true);
        descriptor = g2Var;
    }
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{a.t(i.f86540a), a.t(g1.f86515a)};
    }
    ...
    public ConfigPayload.AutoRedirect deserialize(@NotNull Decoder decoder) {
        ...
        if (cVarB.l()) {
            ...
            objC2 = cVarB.C(descriptor2, 1, g1.f86515a, null);
            i10 = 3;
        } else {
            objC = null;
            Object objC3 = null;
            ...
            while (z10) {
                ...
                if (iW == -1) {
                    ...
                    objC3 = cVarB.C(descriptor2, 1, g1.f86515a, objC3);
                    i11 |= 2;
                }
            }
            objC2 = objC3;
        ...
        cVarB.c(descriptor2);
        return new ConfigPayload.AutoRedirect(i10, (Boolean) objC, (Long) objC2, (r2) null);
    }
    ...
    @Override // so.l
    public void serialize(@NotNull Encoder encoder, @NotNull ConfigPayload.AutoRedirect autoRedirect) {
        p.k(encoder, "encoder");
        p.k(autoRedirect, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        d dVarB = encoder.b(descriptor2);
        ConfigPayload.AutoRedirect.write$Self(autoRedirect, dVarB, descriptor2);
        dVarB.c(descriptor2);
    }
