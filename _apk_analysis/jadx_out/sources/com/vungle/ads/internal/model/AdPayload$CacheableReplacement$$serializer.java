...
public final class AdPayload$CacheableReplacement$$serializer implements m0<AdPayload.CacheableReplacement> {
    ...
    static {
        ...
        g2 g2Var = new g2("com.vungle.ads.internal.model.AdPayload.CacheableReplacement", adPayload$CacheableReplacement$$serializer, 3);
        g2Var.n("url", true);
        g2Var.n("extension", true);
        g2Var.n("download_percent", true);
        descriptor = g2Var;
    }
    ...
    public KSerializer<?>[] childSerializers() {
        w2 w2Var = w2.f86635a;
        return new KSerializer[]{a.t(w2Var), a.t(w2Var), a.t(v0.f86626a)};
    }
    ...
    public AdPayload.CacheableReplacement deserialize(@NotNull Decoder decoder) {
        ...
        if (cVarB.l()) {
            ...
            while (z10) {
                ...
                if (iW == -1) {
                    ...
                    objC5 = cVarB.C(descriptor2, 2, v0.f86626a, objC5);
                    i11 |= 4;
                }
            }
            obj = objC3;
        ...
        cVarB.c(descriptor2);
        return new AdPayload.CacheableReplacement(i10, (String) obj, (String) objC, (Integer) objC2, (r2) null);
    }
    ...
    public void serialize(@NotNull Encoder encoder, @NotNull AdPayload.CacheableReplacement cacheableReplacement) {
        p.k(encoder, "encoder");
        p.k(cacheableReplacement, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        d dVarB = encoder.b(descriptor2);
        AdPayload.CacheableReplacement.write$Self(cacheableReplacement, dVarB, descriptor2);
        dVarB.c(descriptor2);
    }
