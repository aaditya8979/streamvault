...
public final class AdPayload$WebViewSettings$$serializer implements m0<AdPayload.WebViewSettings> {
    ...
    static {
        ...
        g2 g2Var = new g2("com.vungle.ads.internal.model.AdPayload.WebViewSettings", adPayload$WebViewSettings$$serializer, 2);
        g2Var.n("allow_file_access_from_file_urls", true);
        g2Var.n("allow_universal_access_from_file_urls", true);
        descriptor = g2Var;
    }
    ...
    public AdPayload.WebViewSettings deserialize(@NotNull Decoder decoder) {
        ...
        if (cVarB.l()) {
            i iVar = i.f86540a;
            objC2 = cVarB.C(descriptor2, 0, iVar, null);
            objC = cVarB.C(descriptor2, 1, iVar, null);
            i10 = 3;
        } else {
            objC = null;
            Object objC3 = null;
            ...
            while (z10) {
                ...
                if (iW == -1) {
                    ...
                    objC = cVarB.C(descriptor2, 1, i.f86540a, objC);
                    i11 |= 2;
                }
            }
            objC2 = objC3;
        ...
        cVarB.c(descriptor2);
        return new AdPayload.WebViewSettings(i10, (Boolean) objC2, (Boolean) objC, (r2) null);
    }
    ...
    @Override // so.l
    public void serialize(@NotNull Encoder encoder, @NotNull AdPayload.WebViewSettings webViewSettings) {
        p.k(encoder, "encoder");
        p.k(webViewSettings, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        d dVarB = encoder.b(descriptor2);
        AdPayload.WebViewSettings.write$Self(webViewSettings, dVarB, descriptor2);
        dVarB.c(descriptor2);
    }
