...
public final class AdPayload$PlacementAdUnit$$serializer implements m0<AdPayload.PlacementAdUnit> {
    ...
    static {
        ...
        g2 g2Var = new g2("com.vungle.ads.internal.model.AdPayload.PlacementAdUnit", adPayload$PlacementAdUnit$$serializer, 2);
        g2Var.n("placement_reference_id", true);
        g2Var.n(m.f52406c, true);
        descriptor = g2Var;
    }
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{a.t(w2.f86635a), a.t(AdPayload$AdUnit$$serializer.INSTANCE)};
    }
    ...
    public AdPayload.PlacementAdUnit deserialize(@NotNull Decoder decoder) {
        ...
        if (cVarB.l()) {
            ...
            objC2 = cVarB.C(descriptor2, 1, AdPayload$AdUnit$$serializer.INSTANCE, null);
            i10 = 3;
        } else {
            objC = null;
            Object objC3 = null;
            ...
            while (z10) {
                ...
                if (iW == -1) {
                    ...
                    objC3 = cVarB.C(descriptor2, 1, AdPayload$AdUnit$$serializer.INSTANCE, objC3);
                    i11 |= 2;
                }
            }
            objC2 = objC3;
        ...
        cVarB.c(descriptor2);
        return new AdPayload.PlacementAdUnit(i10, (String) objC, (AdPayload.AdUnit) objC2, (r2) null);
    }
    ...
    public void serialize(@NotNull Encoder encoder, @NotNull AdPayload.PlacementAdUnit placementAdUnit) {
        p.k(encoder, "encoder");
        p.k(placementAdUnit, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        d dVarB = encoder.b(descriptor2);
        AdPayload.PlacementAdUnit.write$Self(placementAdUnit, dVarB, descriptor2);
        dVarB.c(descriptor2);
    }
