...
public final class AdRequest implements Serializable {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (other == null || !p.f(AdRequest.class, other.getClass())) {
            return false;
        }
        AdRequest adRequest = (AdRequest) other;
        if (!p.f(this.placement.getReferenceId(), adRequest.placement.getReferenceId()) || !p.f(this.requestAdSize, adRequest.requestAdSize)) {
            return false;
        }
        BidPayload bidPayload = this.adMarkup;
        BidPayload bidPayload2 = adRequest.adMarkup;
        return bidPayload != null ? p.f(bidPayload, bidPayload2) : bidPayload2 == null;
    }
