    ...
    public static void MediaPlayerSetDataSource(MediaPlayer mediaPlayer, String str) throws IllegalStateException, IOException, SecurityException, IllegalArgumentException {
        ...
        if (SafeDK.aa()) {
            try {
                ...
                CreativeInfoManager.a(g.f53142p, mediaPlayer, str);
            } catch (Exception e10) {
    ...
    public static void MediaPlayerStart(MediaPlayer mediaPlayer) throws IllegalStateException {
        ...
        if (SafeDK.aa()) {
            try {
                ...
                CreativeInfoManager.a(g.f53142p, mediaPlayer);
            } catch (Exception e10) {
    ...
    public static void MediaPlayerStop(MediaPlayer mediaPlayer) throws IllegalStateException {
        ...
        if (SafeDK.aa()) {
            try {
                ...
                CreativeInfoManager.onVideoCompleted(g.f53142p, mediaPlayer);
            } catch (Exception e10) {
    ...
    public static void VideoViewPlay(VideoView videoView) {
        ...
        if (SafeDK.aa()) {
            try {
                ...
                CreativeInfoManager.a(g.f53142p, (Object) videoView);
                CreativeInfoManager.a(g.f53142p, BrandSafetyUtils.a(videoView), false);
            } catch (Exception e10) {
    ...
    public static void VideoViewSetVideoPath(VideoView videoView, String str) {
        ...
        if (SafeDK.aa()) {
            try {
                ...
                CreativeInfoManager.a(g.f53142p, videoView, str);
            } catch (Exception e10) {
