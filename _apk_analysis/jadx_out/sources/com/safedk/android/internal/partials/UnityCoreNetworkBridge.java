...
public class UnityCoreNetworkBridge {
    ...
    public static int httpUrlConnectionGetResponseCode(HttpURLConnection httpURLConnection) throws IOException {
        ...
        if (SafeDK.getInstance() != null && SafeDK.getInstance().o() && responseCode >= 200 && responseCode < 300) {
            ...
            Logger.d("SafeDKNetwork", "httpUrlConnectionGetResponseCode url=" + string + ", isOnUiThread = " + k.c() + ", SDK_PACKAGE_NAME = " + g.f53139m);
            CreativeInfoManager.a(g.f53139m, string, httpURLConnection.getInputStream(), httpURLConnection.getHeaderFields());
        }
        return responseCode;
    }
    ...
    public static void okhttp3CallEnqueue(Call call, Callback callback) {
        ...
        if (SafeDK.getInstance() != null && SafeDK.getInstance().o()) {
            try {
                ...
                if (requestInfo == null) {
                    requestInfo = new NetworkBridge.RequestInfo(g.f53139m, string);
                } else {
    ...
    public static void onAddedJavascriptInterface(WebView webView, Object obj, String str) {
        ...
        Logger.d("SafeDKNetwork", "onAddedJavascriptInterface invoked, WebView address: " + webView + ", SDK_PACKAGE_NAME: " + g.f53139m + " object is: " + obj + " and name: " + str);
        AdNetworkDiscovery adNetworkDiscoveryH = CreativeInfoManager.h(g.f53139m);
    ...
    public static InputStream urlConnectionGetInputStream(URLConnection uRLConnection) throws IOException {
        ...
        Logger.d("SafeDKNetwork", "urlConnectionGetInputStream : " + string + ", isOnUiThread = " + k.c() + ", SDK_PACKAGE_NAME =  " + g.f53139m);
        ...
        InputStream inputStreamA = CreativeInfoManager.a(g.f53139m, string, inputStream, headerFields);
    ...
    public static OutputStream urlConnectionGetOutputStream(URLConnection uRLConnection) throws IOException {
        ...
        String string = uRLConnection.getURL().toString();
        Logger.d("SafeDKNetwork", "urlConnectionGetOutputStream url=" + string + ", isOnUiThread = " + k.c() + ", SDK_PACKAGE_NAME = " + g.f53139m);
        return CreativeInfoManager.a(g.f53139m, string, outputStream);
    }
    ...
    public static void webviewLoadDataWithBaseURL(WebView webView, String str, String str2, String str3, String str4, String str5) {
        ...
        if (SafeDK.getInstance() != null && SafeDK.getInstance().o()) {
            Logger.d("SafeDKNetwork", "webviewLoadDataWithBaseURL: " + str + ", WebView address : " + webView.toString() + ", isOnUiThread = " + k.c() + ", SDK_PACKAGE_NAME = " + g.f53139m);
            CreativeInfoManager.a(str, str2, webView, g.f53139m);
            SafeDKWebAppInterface.a(g.f53139m, webView, str2);
        }
    ...
    public static void webviewLoadUrl(WebView webView, String str) {
        ...
        if (SafeDK.getInstance() != null && SafeDK.getInstance().o()) {
            Logger.d("SafeDKNetwork", "webviewLoadUrl2. url: " + str + ", WebView address : " + webView.toString() + "  SDK_PACKAGE_NAME = " + g.f53139m);
            NetworkBridge.logWebviewLoadURLRequest(g.f53139m, webView, str);
            AdNetworkDiscovery adNetworkDiscoveryH = CreativeInfoManager.h(g.f53139m);
            if (adNetworkDiscoveryH != null && adNetworkDiscoveryH.d().b(AdNetworkConfiguration.USE_WEBVIEW_LOADURL_AS_RESOURCE_LOADED_INDICATION)) {
                CreativeInfoManager.a(str, (String) null, webView, g.f53139m);
            }
            SafeDKWebAppInterface.a(g.f53139m, webView, str);
        }
        webView.loadUrl(str);
    }
}
