...
public class c {
    ...
    private static WindowManager f23819a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static String[] f23820b = {VastAttributes.HORIZONTAL_POSITION, VastAttributes.VERTICAL_POSITION, "width", "height"};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public static float f23821c = Resources.getSystem().getDisplayMetrics().density;
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f23819a != null) {
            ...
            f23819a.getDefaultDisplay().getRealSize(point);
            fA2 = a(point.x);
            fA = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f23821c = context.getResources().getDisplayMetrics().density;
            f23819a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0325a c0325a) {
        com.iab.omid.library.applovin.internal.e eVarA = c0325a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0325a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f23822a[outputDeviceStatus.ordinal()] == 1;
    }
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f23823a);
            jSONObject.put("height", bVarA.f23824b);
        } catch (JSONException e10) {
            e10.printStackTrace();
        }
    }
