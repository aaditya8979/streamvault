...
public abstract class AdSessionStatePublisher {
    ...
    private com.iab.omid.library.ironsrc.weakreference.b f24599b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private AdEvents f24600c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private MediaEvents f24601d;
    ...
    public AdSessionStatePublisher(String str) {
        a();
        this.f24598a = str;
        this.f24599b = new com.iab.omid.library.ironsrc.weakreference.b(null);
    }

    public void a() {
        this.f24603f = f.b();
        this.f24602e = a.AD_STATE_IDLE;
    }

    public void a(float f10) {
        h.a().a(getWebView(), this.f24598a, f10);
    }

    public void a(WebView webView) {
        this.f24599b = new com.iab.omid.library.ironsrc.weakreference.b(webView);
    }

    public void a(AdEvents adEvents) {
        this.f24600c = adEvents;
    }

    public void a(AdSessionConfiguration adSessionConfiguration) {
        h.a().a(getWebView(), this.f24598a, adSessionConfiguration.toJsonObject());
    }

    public void a(ErrorType errorType, String str) {
        h.a().a(getWebView(), this.f24598a, errorType, str);
    }
    ...
    public void a(String str, long j10) {
        if (j10 >= this.f24603f) {
            ...
            if (aVar != aVar2) {
                this.f24602e = aVar2;
                h.a().b(getWebView(), this.f24598a, str);
            }
        }
    }

    public void a(String str, @Nullable JSONObject jSONObject) {
        h.a().a(getWebView(), this.f24598a, str, jSONObject);
    }
    ...
    public void a(@Nullable JSONObject jSONObject) {
        h.a().b(getWebView(), this.f24598a, jSONObject);
    }

    public void a(boolean z10) {
        if (e()) {
            h.a().c(getWebView(), this.f24598a, z10 ? "foregrounded" : "backgrounded");
        }
    }
    ...
    public void b(String str, long j10) {
        if (j10 >= this.f24603f) {
            this.f24602e = a.AD_STATE_VISIBLE;
            h.a().b(getWebView(), this.f24598a, str);
        }
    }
    ...
    public void b(boolean z10) {
        if (e()) {
            h.a().a(getWebView(), this.f24598a, z10 ? "locked" : "unlocked");
        }
    }
    ...
    public boolean e() {
        return this.f24599b.get() != null;
    }

    public void f() {
        h.a().a(getWebView(), this.f24598a);
    }

    public void g() {
        h.a().b(getWebView(), this.f24598a);
    }
