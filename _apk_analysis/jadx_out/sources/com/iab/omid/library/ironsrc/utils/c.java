...
public class c {
    ...
    private static WindowManager f24616a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static String[] f24617b = {VastAttributes.HORIZONTAL_POSITION, VastAttributes.VERTICAL_POSITION, "width", "height"};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public static float f24618c = Resources.getSystem().getDisplayMetrics().density;
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f24616a != null) {
            ...
            f24616a.getDefaultDisplay().getRealSize(point);
            fA2 = a(point.x);
            fA = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f24618c = context.getResources().getDisplayMetrics().density;
            f24616a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0349a c0349a) {
        com.iab.omid.library.ironsrc.internal.e eVarA = c0349a.a();
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f24619a[outputDeviceStatus.ordinal()] == 1;
    }
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f24620a);
            jSONObject.put("height", bVarA.f24621b);
        } catch (JSONException e10) {
            e10.printStackTrace();
        }
    }
