...
public class c {
    ...
    private static WindowManager f24205a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static String[] f24206b = {VastAttributes.HORIZONTAL_POSITION, VastAttributes.VERTICAL_POSITION, "width", "height"};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public static float f24207c = Resources.getSystem().getDisplayMetrics().density;
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f24205a != null) {
            ...
            f24205a.getDefaultDisplay().getRealSize(point);
            fA2 = a(point.x);
            fA = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f24207c = context.getResources().getDisplayMetrics().density;
            f24205a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0336a c0336a) {
        com.iab.omid.library.bytedance2.internal.e eVarA = c0336a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0336a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f24208a[outputDeviceStatus.ordinal()] == 1;
    }
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f24209a);
            jSONObject.put("height", bVarA.f24210b);
        } catch (JSONException e10) {
            e10.printStackTrace();
        }
    }
