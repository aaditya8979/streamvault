...
public class b extends AdSessionStatePublisher {
    ...
    private WebView f24197g;

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    private Long f24198h;

    /* JADX INFO: renamed from: i, reason: collision with root package name */
    private final Map<String, VerificationScriptResource> f24199i;
    ...
    public class RunnableC0335b implements Runnable {
        ...
        private final WebView f24202a;

        public RunnableC0335b() {
            this.f24202a = b.this.f24197g;
        }

        @Override // java.lang.Runnable
        public void run() {
            this.f24202a.destroy();
        }
    }
    ...
    public void b() {
        super.b();
        new Handler().postDelayed(new RunnableC0335b(), Math.max(4000 - (this.f24198h == null ? 4000L : TimeUnit.MILLISECONDS.convert(f.b() - this.f24198h.longValue(), TimeUnit.NANOSECONDS)), 2000L));
        this.f24197g = null;
    }
    ...
    public void j() {
        ...
        this.f24197g = webView;
        webView.getSettings().setJavaScriptEnabled(true);
        this.f24197g.getSettings().setAllowContentAccess(false);
        this.f24197g.getSettings().setAllowFileAccess(false);
        this.f24197g.setWebViewClient(new a());
        a(this.f24197g);
        h.a().c(this.f24197g, this.f24200j);
        for (String str : this.f24199i.keySet()) {
            h.a().c(this.f24197g, this.f24199i.get(str).getResourceUrl().toExternalForm(), str);
        }
        this.f24198h = Long.valueOf(f.b());
    }
}
