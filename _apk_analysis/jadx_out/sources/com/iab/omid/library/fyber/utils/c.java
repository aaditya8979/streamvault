...
public class c {
    ...
    private static WindowManager f24340a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static String[] f24341b = {VastAttributes.HORIZONTAL_POSITION, VastAttributes.VERTICAL_POSITION, "width", "height"};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public static float f24342c = Resources.getSystem().getDisplayMetrics().density;
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f24340a != null) {
            ...
            f24340a.getDefaultDisplay().getRealSize(point);
            fA2 = a(point.x);
            fA = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f24342c = context.getResources().getDisplayMetrics().density;
            f24340a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0340a c0340a) {
        com.iab.omid.library.fyber.internal.e eVarA = c0340a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0340a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f24343a[outputDeviceStatus.ordinal()] == 1;
    }
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f24344a);
            jSONObject.put("height", bVarA.f24345b);
        } catch (JSONException e10) {
            e10.printStackTrace();
        }
    }
