...
public class c {
    ...
    private static WindowManager f24481a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static String[] f24482b = {VastAttributes.HORIZONTAL_POSITION, VastAttributes.VERTICAL_POSITION, "width", "height"};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public static float f24483c = Resources.getSystem().getDisplayMetrics().density;
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f24481a != null) {
            ...
            f24481a.getDefaultDisplay().getRealSize(point);
            fA2 = a(point.x);
            fA = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f24483c = context.getResources().getDisplayMetrics().density;
            f24481a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0345a c0345a) {
        com.iab.omid.library.inmobi.internal.e eVarA = c0345a.a();
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f24484a[outputDeviceStatus.ordinal()] == 1;
    }
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f24485a);
            jSONObject.put("height", bVarA.f24486b);
        } catch (JSONException e10) {
            e10.printStackTrace();
        }
    }
