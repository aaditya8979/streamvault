...
public class h {
    ...
    private static h f24444a = new h();

    public class a implements Runnable {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public final /* synthetic */ WebView f24445a;

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        public final /* synthetic */ String f24446b;

        public a(WebView webView, String str) {
            this.f24445a = webView;
            this.f24446b = str;
        }

        @Override // java.lang.Runnable
        public void run() {
            h.this.c(this.f24445a, this.f24446b);
        }
    }
    ...
    public void a(WebView webView, String str, JSONObject jSONObject) {
        a(webView, C3978d4.a.f31210f, jSONObject, str);
    }
    ...
    public boolean c(WebView webView, String str) {
        if (webView != null && !TextUtils.isEmpty(str)) {
            try {
                ...
                com.iab.omid.library.inmobi.utils.d.b("Unable to inject javascript: " + e10.getMessage());
            }
        }
        return false;
    }
