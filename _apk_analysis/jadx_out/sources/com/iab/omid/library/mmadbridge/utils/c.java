...
public class c {
    ...
    private static WindowManager f24751a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static String[] f24752b = {VastAttributes.HORIZONTAL_POSITION, VastAttributes.VERTICAL_POSITION, "width", "height"};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public static float f24753c = Resources.getSystem().getDisplayMetrics().density;
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f24751a != null) {
            ...
            f24751a.getDefaultDisplay().getRealSize(point);
            fA2 = a(point.x);
            fA = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f24753c = context.getResources().getDisplayMetrics().density;
            f24751a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0353a c0353a) {
        com.iab.omid.library.mmadbridge.internal.e eVarA = c0353a.a();
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f24754a[outputDeviceStatus.ordinal()] == 1;
    }
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f24755a);
            jSONObject.put("height", bVarA.f24756b);
        } catch (JSONException e10) {
            e10.printStackTrace();
        }
    }
