...
public class c {
    ...
    private static WindowManager f23954a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static String[] f23955b = {VastAttributes.HORIZONTAL_POSITION, VastAttributes.VERTICAL_POSITION, "width", "height"};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public static float f23956c = Resources.getSystem().getDisplayMetrics().density;
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f23954a != null) {
            ...
            f23954a.getDefaultDisplay().getRealSize(point);
            fA2 = a(point.x);
            fA = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f23956c = context.getResources().getDisplayMetrics().density;
            f23954a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0329a c0329a) {
        com.iab.omid.library.appodeal.internal.e eVarA = c0329a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0329a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f23957a[outputDeviceStatus.ordinal()] == 1;
    }
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f23958a);
            jSONObject.put("height", bVarA.f23959b);
        } catch (JSONException e10) {
            e10.printStackTrace();
        }
    }
