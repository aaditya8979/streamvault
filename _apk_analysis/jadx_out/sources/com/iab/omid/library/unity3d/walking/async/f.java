...
public class f extends a {
    public f(b.InterfaceC0358b interfaceC0358b, HashSet<String> hashSet, JSONObject jSONObject, long j10) {
        ...
        if (cVarC != null) {
            for (com.iab.omid.library.unity3d.adsession.a aVar : cVarC.b()) {
                if (this.f24912c.contains(aVar.getAdSessionId())) {
                    aVar.getAdSessionStatePublisher().b(str, this.f24914e);
                }
            }
        }
    }
    ...
    public String doInBackground(Object... objArr) {
        if (com.iab.omid.library.unity3d.utils.c.h(this.f24913d, this.f24916b.a())) {
            return null;
        }
        this.f24916b.a(this.f24913d);
