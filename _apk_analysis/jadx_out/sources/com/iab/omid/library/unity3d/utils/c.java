...
public class c {
    ...
    private static WindowManager f24880a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static String[] f24881b = {VastAttributes.HORIZONTAL_POSITION, VastAttributes.VERTICAL_POSITION, "width", "height"};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public static float f24882c = Resources.getSystem().getDisplayMetrics().density;
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f24880a != null) {
            ...
            f24880a.getDefaultDisplay().getRealSize(point);
            fA2 = a(point.x);
            fA = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f24882c = context.getResources().getDisplayMetrics().density;
            f24880a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0357a c0357a) {
        com.iab.omid.library.unity3d.internal.e eVarA = c0357a.a();
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f24883a[outputDeviceStatus.ordinal()] == 1;
    }
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f24884a);
            jSONObject.put("height", bVarA.f24885b);
        } catch (JSONException e10) {
            e10.printStackTrace();
        }
    }
