...
public abstract class AdSessionStatePublisher {
    ...
    private com.iab.omid.library.bigosg.e.b f24071a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private AdEvents f24072b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private MediaEvents f24073c;
    ...
    public AdSessionStatePublisher() {
        i();
        this.f24071a = new com.iab.omid.library.bigosg.e.b(null);
    }
    ...
    public void a(WebView webView) {
        this.f24071a = new com.iab.omid.library.bigosg.e.b(webView);
    }

    public void a(AdEvents adEvents) {
        this.f24072b = adEvents;
    }
    ...
    public void a(com.iab.omid.library.bigosg.adsession.a aVar, AdSessionContext adSessionContext, JSONObject jSONObject) {
        ...
        com.iab.omid.library.bigosg.d.b.a(jSONObject4, "appId", d.a().b().getApplicationContext().getPackageName());
        com.iab.omid.library.bigosg.d.b.a(jSONObject2, MBridgeConstans.DYNAMIC_VIEW_WX_APP, jSONObject4);
    ...
    public void a(String str, long j10) {
        if (j10 >= this.f24075e) {
            this.f24074d = a.AD_STATE_VISIBLE;
    ...
    public void i() {
        this.f24075e = com.iab.omid.library.bigosg.d.d.a();
        this.f24074d = a.AD_STATE_IDLE;
    }
}
