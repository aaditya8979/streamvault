...
class c {
    ...
    private static final Pattern f24055a = Pattern.compile("<(head)( [^>]*)?>", 2);

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final Pattern f24056b = Pattern.compile("<(head)( [^>]*)?/>", 2);

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final Pattern f24057c = Pattern.compile("<(body)( [^>]*?)?>", 2);

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static final Pattern f24058d = Pattern.compile("<(body)( [^>]*?)?/>", 2);

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private static final Pattern f24059e = Pattern.compile("<(html)( [^>]*?)?>", 2);

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private static final Pattern f24060f = Pattern.compile("<(html)( [^>]*?)?/>", 2);

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    private static final Pattern f24061g = Pattern.compile("<!DOCTYPE [^>]*>", 2);
    ...
    public static String b(String str, String str2) {
        ...
        if (!b(str, sb2, f24056b, str2, iArrA) && !a(str, sb2, f24055a, str2, iArrA) && !b(str, sb2, f24058d, str2, iArrA) && !a(str, sb2, f24057c, str2, iArrA) && !b(str, sb2, f24060f, str2, iArrA) && !a(str, sb2, f24059e, str2, iArrA) && !a(str, sb2, f24061g, str2, iArrA)) {
            return str2 + str;
        }
        return sb2.toString();
    }
