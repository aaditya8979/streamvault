...
public class h {
    ...
    private static h f24983a = new h();

    public class a implements Runnable {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public final /* synthetic */ WebView f24984a;

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        public final /* synthetic */ String f24985b;

        public a(WebView webView, String str) {
            this.f24984a = webView;
            this.f24985b = str;
        }

        @Override // java.lang.Runnable
        public void run() {
            h.this.c(this.f24984a, this.f24985b);
        }
    }
    ...
    public boolean c(WebView webView, String str) {
        if (webView != null && !TextUtils.isEmpty(str)) {
            try {
                ...
                com.iab.omid.library.vungle.utils.d.b("Unable to inject javascript: " + e10.getMessage());
            }
        }
        return false;
    }
