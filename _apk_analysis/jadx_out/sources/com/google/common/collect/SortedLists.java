...
public final class SortedLists {
    ...
    public static <E> int a(List<? extends E> list, E e10, Comparator<? super E> comparator, KeyPresentBehavior keyPresentBehavior, KeyAbsentBehavior keyAbsentBehavior) {
        y7.l.m(comparator);
        y7.l.m(list);
        y7.l.m(keyPresentBehavior);
        y7.l.m(keyAbsentBehavior);
    ...
    public static <E, K extends Comparable> int b(List<E> list, y7.e<? super E, K> eVar, K k10, KeyPresentBehavior keyPresentBehavior, KeyAbsentBehavior keyAbsentBehavior) {
        y7.l.m(k10);
        return c(list, eVar, k10, Ordering.natural(), keyPresentBehavior, keyAbsentBehavior);
    }

    public static <E, K> int c(List<E> list, y7.e<? super E, K> eVar, K k10, Comparator<? super K> comparator, KeyPresentBehavior keyPresentBehavior, KeyAbsentBehavior keyAbsentBehavior) {
        return a(Lists.m(list, eVar), k10, comparator, keyPresentBehavior, keyAbsentBehavior);
    }
}
