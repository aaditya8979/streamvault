...
public final class zzf {
    ...
    public static final String zzv(StackTraceElement[] stackTraceElementArr, String str) {
        ...
        while (true) {
            ...
            if (f.H.equalsIgnoreCase(stackTraceElement.getMethodName()) && (zzb.equalsIgnoreCase(className2) || zzc.equalsIgnoreCase(className2) || zzd.equalsIgnoreCase(className2) || zze.equalsIgnoreCase(className2) || zzf.equalsIgnoreCase(className2) || zzg.equalsIgnoreCase(className2))) {
                break;
            }
            i11 = i10;
        }
