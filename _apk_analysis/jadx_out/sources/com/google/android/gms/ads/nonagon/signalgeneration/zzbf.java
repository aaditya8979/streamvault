...
public final class zzbf implements zzikg {
    ...
    public final /* bridge */ /* synthetic */ Object zzb() {
        ...
        if (zzbjVarZzb != null) {
            ...
            iVarZzi = zzgzo.zza(zzbjVarZzb);
        } else {
            iVarZzi = zzfnuVar.zza(zzfno.GENERATE_SIGNALS, zzdajVarZzb.zzb()).zzc(zzbhVarZzb).zzh(((Integer) com.google.android.gms.ads.internal.client.zzbd.zzc().zzd(zzbhe.zzgC)).intValue(), TimeUnit.SECONDS).zzi();
            zzgzo.zzr(iVarZzi, new zzaw(zzdkbVar), zzcei.zza);
        }
        zziko.zzb(iVarZzi);
        return iVarZzi;
    }
