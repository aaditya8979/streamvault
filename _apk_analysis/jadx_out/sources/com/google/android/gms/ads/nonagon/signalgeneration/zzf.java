...
public final class zzf {
    ...
    public final void zza(@Nullable WebView webView) {
        ...
        for (String str : ((String) com.google.android.gms.ads.internal.client.zzbd.zzc().zzd(zzbhe.zzll)).split(StringUtils.COMMA, -1)) {
        ...
        if (((Boolean) zzbjj.zzb.zze()).booleanValue() && WebViewFeature.isFeatureSupported(WebViewFeature.DOCUMENT_START_SCRIPT) && webView != null) {
            WebViewCompat.addDocumentStartJavaScript(webView, String.format(Locale.getDefault(), (String) com.google.android.gms.ads.internal.client.zzbd.zzc().zzd(zzbhe.zzlk), zzb()), zzgup.zzi("*"));
        }
    }
