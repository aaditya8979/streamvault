...
public final class zzs extends zzbw {
    ...
    public final String zzN() {
        ...
        StringBuilder sb2 = new StringBuilder(strZzO.length() + 1 + String.valueOf(encodedQuery).length());
        sb2.append(strZzO);
        sb2.append("#");
    ...
    public final String zzO() {
        ...
        StringBuilder sb2 = new StringBuilder(String.valueOf(strZza).length() + 8 + String.valueOf(str).length());
        sb2.append("https://");
        sb2.append(strZza);
        sb2.append(str);
        return sb2.toString();
