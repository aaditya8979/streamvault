...
public final class zzp extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValue = a.f32683h, getter = "getIgnoreTestKeysOverride", id = 3)
    ...
    @SafeParcelable.Field(defaultValue = a.f32683h, getter = "getShouldFetchSourceStampTimestamp", id = 8)
    private final boolean zzg;

    @SafeParcelable.Constructor
    public zzp(@SafeParcelable.Param(id = 1) String str, @SafeParcelable.Param(id = 2) boolean z10, @SafeParcelable.Param(id = 3) boolean z11, @SafeParcelable.Param(id = 4) IBinder iBinder, @SafeParcelable.Param(id = 5) boolean z12, @SafeParcelable.Param(id = 6) boolean z13, @SafeParcelable.Param(id = 8) boolean z14) {
        this.zza = str;
        this.zzb = z10;
        this.zzc = z11;
