...
public class WorkSourceUtil {
    ...
    static {
        ...
        Method method8;
        try {
            method = WorkSource.class.getMethod(ImpressionLog.f51742l, Integer.TYPE);
        } catch (Exception unused) {
            method = null;
        }
        zzb = method;
        try {
            method2 = WorkSource.class.getMethod(ImpressionLog.f51742l, Integer.TYPE, String.class);
