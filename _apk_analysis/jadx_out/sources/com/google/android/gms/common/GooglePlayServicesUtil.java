...
public final class GooglePlayServicesUtil extends GooglePlayServicesUtilLight {
    ...
    public static boolean showErrorDialogFragment(int i10, @NonNull Activity activity, @Nullable Fragment fragment, int i11, @Nullable DialogInterface.OnCancelListener onCancelListener) {
        ...
        Dialog dialogZaa = googleApiAvailability.zaa(activity, i12, zag.zac(fragment, GoogleApiAvailability.getInstance().getErrorResolutionIntent(activity, i12, "d"), i11), onCancelListener, null);
        if (dialogZaa == null) {
            return false;
        }
