...
public final class zak extends zap {
    ...
    public final void onStart() {
        super.onStart();
        SparseArray sparseArray = this.zad;
        Log.d("AutoManageHelper", "onStart " + this.zaa + Z7.f30794r + String.valueOf(sparseArray));
    ...
    public final void zad(int i10, GoogleApiClient googleApiClient, @Nullable GoogleApiClient.OnConnectionFailedListener onConnectionFailedListener) {
        ...
        Log.d("AutoManageHelper", "starting AutoManage for client " + i10 + Z7.f30794r + this.zaa + Z7.f30794r + String.valueOf(zamVar));
