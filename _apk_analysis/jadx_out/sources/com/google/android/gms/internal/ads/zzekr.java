...
public final class zzekr implements zzekg {
    ...
    public final c8.i zzb(final zzfjc zzfjcVar, final zzfir zzfirVar) {
        ...
        c8.i iVarZzj = zzgzo.zzj(iVarZza, zzgywVar, executor);
        iVarZzj.addListener(new Runnable(zzduzVar) { // from class: com.google.android.gms.internal.ads.zzekq
    ...
    public final /* synthetic */ c8.i zzc(final zzfir zzfirVar, zzfjc zzfjcVar, zzduz zzduzVar, Object obj) throws zzcka {
        ...
        if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.zzc().zzd(zzbgvVar)).booleanValue()) {
            zzekrVar = this;
            zzekrVar.zzi.zze().putLong(zzdxh.RENDERING_AD_COMPONENT_CREATION_END.zza(), com.google.android.gms.ads.internal.zzt.zzk().currentTimeMillis());
        } else {
            zzekrVar = this;
        }
