...
public final class zzcrv {
    ...
    private final c8.i zzk(final String str, @Nullable final InputEvent inputEvent, Random random) {
        try {
    ...
    public final c8.i zzb(final String str, Random random) {
    ...
    public final /* synthetic */ c8.i zzd(String str, final Throwable th2) {
    ...
    public final /* synthetic */ c8.i zze(final Uri.Builder builder, String str, InputEvent inputEvent, Integer num) {
        if (num.intValue() != 1) {
    ...
    public final /* synthetic */ c8.i zzf(Uri.Builder builder, final Throwable th2) {
    ...
    public final /* synthetic */ void zzg(Throwable th2) {
        if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.zzc().zzd(zzbhe.zzlM)).booleanValue()) {
            ...
            zzbyrVarZzc.zzh(th2, "AttributionReporting");
        } else {
            zzbyr zzbyrVarZza = zzbyp.zza(this.zzc);
            this.zza = zzbyrVarZza;
            zzbyrVarZza.zzh(th2, "AttributionReportingSampled");
        }
    }
    ...
    public final /* synthetic */ void zzh(Throwable th2) {
        if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.zzc().zzd(zzbhe.zzlM)).booleanValue()) {
            zzbyr zzbyrVarZzc = zzbyp.zzc(this.zzc);
            this.zzb = zzbyrVarZzc;
            zzbyrVarZzc.zzh(th2, "AttributionReporting.getUpdatedUrlAndRegisterSource");
        } else {
            zzbyr zzbyrVarZza = zzbyp.zza(this.zzc);
            this.zza = zzbyrVarZza;
            zzbyrVarZza.zzh(th2, "AttributionReportingSampled.getUpdatedUrlAndRegisterSource");
        }
    }
