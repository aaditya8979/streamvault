...
public abstract class zzde extends zzdb implements List, RandomAccess {
    ...
    public static zzde zzg(Object[] objArr, int i10) {
        return i10 == 0 ? zzdh.zza : new zzdh(objArr, i10);
    }
            ...
            if (size == list.size()) {
                if (list instanceof RandomAccess) {
                    for (int i10 = 0; i10 < size; i10++) {
                        if (zzcw.zza(get(i10), list.get(i10))) {
                        }
                    }
                    return true;
                }
    ...
    public zzde subList(int i10, int i11) {
        zzcx.zzc(i10, i11, size());
        int i12 = i11 - i10;
        return i12 == size() ? this : i12 == 0 ? zzdh.zza : new zzdd(this, i10, i12);
    }

    @Override // java.util.List
    /* JADX INFO: renamed from: zzh, reason: merged with bridge method [inline-methods] */
    public final zzdl listIterator(int i10) {
        zzcx.zzb(i10, size(), "index");
        return isEmpty() ? zza : new zzdc(this, i10);
    }
}
