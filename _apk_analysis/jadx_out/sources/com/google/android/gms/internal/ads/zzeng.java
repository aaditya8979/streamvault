...
public abstract class zzeng implements zzekg {
    ...
    public final c8.i zzb(zzfjc zzfjcVar, zzfir zzfirVar) {
        ...
        String strOptString2 = jSONObject.optString(AdMobAdapter.HOUSE_ADS_PARAMETER, null);
        if (strOptString2 != null) {
            bundleZzd2.putString(AdMobAdapter.HOUSE_ADS_PARAMETER, strOptString2);
        }
        String strOptString3 = jSONObject.optString(AdMobAdapter.AD_JSON_PARAMETER, null);
        if (strOptString3 != null) {
            bundleZzd2.putString(AdMobAdapter.AD_PARAMETER, strOptString3);
        }
    ...
    public abstract c8.i zzc(zzfjk zzfjkVar, Bundle bundle, zzfir zzfirVar, zzfjc zzfjcVar);
}
