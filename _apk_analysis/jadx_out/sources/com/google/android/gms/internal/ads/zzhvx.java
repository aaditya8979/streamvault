...
public final class zzhvx {
    ...
    static {
        ...
        zzc = zzhyeVarZza2;
        zzd = zzhkn.zzd(new zzhkm() { // from class: com.google.android.gms.internal.ads.zzhvw
            @Override // com.google.android.gms.internal.ads.zzhkm
            public final /* synthetic */ zzhlg zza(zzhbp zzhbpVar) {
                return zzhvx.zzb((zzhty) zzhbpVar);
            }
        }, zzhty.class, zzhlc.class);
        zze = zzhkk.zzd(new zzhkj() { // from class: com.google.android.gms.internal.ads.zzhvr
            @Override // com.google.android.gms.internal.ads.zzhkj
            public final /* synthetic */ zzhbp zza(zzhlg zzhlgVar) {
                return zzhvx.zzc((zzhlc) zzhlgVar);
            }
        }, zzhyeVarZza, zzhlc.class);
        zzf = zzhji.zzd(new zzhjh() { // from class: com.google.android.gms.internal.ads.zzhvs
            @Override // com.google.android.gms.internal.ads.zzhjh
            public final /* synthetic */ zzhlg zza(zzhaz zzhazVar, zzhbt zzhbtVar) {
                zzhuc zzhucVar = (zzhuc) zzhazVar;
                return zzhlb.zza("type.googleapis.com/google.crypto.tink.RsaSsaPkcs1PublicKey", zzhvx.zzi(zzhucVar).zzaM(), zzhqb.ASYMMETRIC_PUBLIC, (zzhqy) zzhvx.zzj.zzb(zzhucVar.zzf().zze()), zzhucVar.zzb());
            }
        }, zzhuc.class, zzhlb.class);
        zzg = zzhjf.zzd(new zzhje() { // from class: com.google.android.gms.internal.ads.zzhvt
            @Override // com.google.android.gms.internal.ads.zzhje
            public final /* synthetic */ zzhaz zza(zzhlg zzhlgVar, zzhbt zzhbtVar) {
                return zzhvx.zze((zzhlb) zzhlgVar, zzhbtVar);
            }
        }, zzhyeVarZza2, zzhlb.class);
        zzh = zzhji.zzd(new zzhjh() { // from class: com.google.android.gms.internal.ads.zzhvu
            @Override // com.google.android.gms.internal.ads.zzhjh
            public final /* synthetic */ zzhlg zza(zzhaz zzhazVar, zzhbt zzhbtVar) {
                return zzhvx.zzf((zzhua) zzhazVar, zzhbtVar);
            }
        }, zzhua.class, zzhlb.class);
        zzi = zzhjf.zzd(new zzhje() { // from class: com.google.android.gms.internal.ads.zzhvv
            @Override // com.google.android.gms.internal.ads.zzhje
            public final /* synthetic */ zzhaz zza(zzhlg zzhlgVar, zzhbt zzhbtVar) {
                return zzhvx.zzg((zzhlb) zzhlgVar, zzhbtVar);
            }
