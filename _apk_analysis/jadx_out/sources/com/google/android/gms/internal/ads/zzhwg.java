...
public final class zzhwg {
    ...
    static {
        ...
        zzc = zzhyeVarZza2;
        zzd = zzhkn.zzd(new zzhkm() { // from class: com.google.android.gms.internal.ads.zzhwf
            @Override // com.google.android.gms.internal.ads.zzhkm
            public final /* synthetic */ zzhlg zza(zzhbp zzhbpVar) {
                return zzhwg.zzb((zzhuk) zzhbpVar);
            }
        }, zzhuk.class, zzhlc.class);
        zze = zzhkk.zzd(new zzhkj() { // from class: com.google.android.gms.internal.ads.zzhwa
            @Override // com.google.android.gms.internal.ads.zzhkj
            public final /* synthetic */ zzhbp zza(zzhlg zzhlgVar) {
                return zzhwg.zzc((zzhlc) zzhlgVar);
            }
        }, zzhyeVarZza, zzhlc.class);
        zzf = zzhji.zzd(new zzhjh() { // from class: com.google.android.gms.internal.ads.zzhwb
            @Override // com.google.android.gms.internal.ads.zzhjh
            public final /* synthetic */ zzhlg zza(zzhaz zzhazVar, zzhbt zzhbtVar) {
                zzhuo zzhuoVar = (zzhuo) zzhazVar;
                return zzhlb.zza("type.googleapis.com/google.crypto.tink.RsaSsaPssPublicKey", zzhwg.zzi(zzhuoVar).zzaM(), zzhqb.ASYMMETRIC_PUBLIC, (zzhqy) zzhwg.zzj.zzb(zzhuoVar.zzf().zze()), zzhuoVar.zzb());
            }
        }, zzhuo.class, zzhlb.class);
        zzg = zzhjf.zzd(new zzhje() { // from class: com.google.android.gms.internal.ads.zzhwc
            @Override // com.google.android.gms.internal.ads.zzhje
            public final /* synthetic */ zzhaz zza(zzhlg zzhlgVar, zzhbt zzhbtVar) {
                return zzhwg.zze((zzhlb) zzhlgVar, zzhbtVar);
            }
        }, zzhyeVarZza2, zzhlb.class);
        zzh = zzhji.zzd(new zzhjh() { // from class: com.google.android.gms.internal.ads.zzhwd
            @Override // com.google.android.gms.internal.ads.zzhjh
            public final /* synthetic */ zzhlg zza(zzhaz zzhazVar, zzhbt zzhbtVar) {
                return zzhwg.zzf((zzhum) zzhazVar, zzhbtVar);
            }
        }, zzhum.class, zzhlb.class);
        zzi = zzhjf.zzd(new zzhje() { // from class: com.google.android.gms.internal.ads.zzhwe
            @Override // com.google.android.gms.internal.ads.zzhje
            public final /* synthetic */ zzhaz zza(zzhlg zzhlgVar, zzhbt zzhbtVar) {
    ...
    private static zzhrm zzh(zzhuk zzhukVar) throws GeneralSecurityException {
    ...
    private static zzhrq zzi(zzhuo zzhuoVar) throws GeneralSecurityException {
