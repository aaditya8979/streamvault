...
public final class zzahg implements zzaeu {
    ...
    private final long zzh(zzer zzerVar, boolean z10) {
        boolean zZza;
        this.zzh.getClass();
    ...
    private final void zzi() {
        ...
        zzafh zzafhVar = this.zzh;
        String str = zzfj.zza;
        this.zze.zze(j10 / ((long) zzafhVar.zze), 1, this.zzl, 0, null);
    }

    @Override // com.google.android.gms.internal.ads.zzaeu
    public final boolean zza(zzaev zzaevVar) throws Throwable {
    ...
    public final int zzd(zzaev zzaevVar, zzafv zzafvVar) throws Throwable {
        ...
        int i12 = this.zzi;
        if (i11 < i12) {
            zzerVar3.zzk(Math.min(i12 - i11, zzerVar3.zzd()));
        }
        long jZzh = zzh(zzerVar3, z10);
