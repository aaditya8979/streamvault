...
public final class zzdt implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public zzdt(Handler handler, @Nullable zzds zzdsVar) {
        this.zzb = handler;
    }
    ...
    public final void zza(int i10) throws zzdu {
        ...
        String str = zzfj.zza;
        zzdv.zzf(z10, String.format(Locale.US, "eglChooseConfig failed: success=%b, numConfigs[0]=%d, configs[0]=%s", objArr));
