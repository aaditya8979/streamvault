...
public final class zzhdo extends zzhcg {
    private final zzhdv zza;
    private final zzhyg zzb;
    private final zzhye zzc;
    private final Integer zzd;

    public /* synthetic */ zzhdo(zzhdv zzhdvVar, zzhyg zzhygVar, zzhye zzhyeVar, Integer num, byte[] bArr) {
        this.zza = zzhdvVar;
        this.zzb = zzhygVar;
        this.zzc = zzhyeVar;
        this.zzd = num;
