...
public final class zzfiu {
    ...
    public zzfiu(JsonReader jsonReader) throws IllegalStateException, JSONException, IOException, NumberFormatException {
        ...
        while (jsonReader.hasNext()) {
            ...
            } else if (com.safedk.android.analytics.brandsafety.c.f51874g.equals(strNextName)) {
                iNextInt3 = jsonReader.nextInt();
            } else if ("latency".equals(strNextName)) {
                jNextLong = jsonReader.nextLong();
            } else {
                if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.zzc().zzd(zzbhe.zzjD)).booleanValue() && "public_error".equals(strNextName) && jsonReader.peek() == JsonToken.BEGIN_OBJECT) {
                    zzfitVar = new zzfit(jsonReader);
                } else if ("bidding_data".equals(strNextName)) {
                    strNextString = jsonReader.nextString();
                } else {
                    if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.zzc().zzd(zzbhe.zzlR)).booleanValue() && Objects.equals(strNextName, "topics_should_record_observation")) {
                        ...
                        if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.zzc().zzd(zzbgvVar)).booleanValue() && Objects.equals(strNextName, "adResponseBody")) {
                            strNextString6 = jsonReader.nextString();
                        } else if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.zzc().zzd(zzbgvVar)).booleanValue() && Objects.equals(strNextName, "adResponseHeaders")) {
                            ...
                            if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.zzc().zzd(zzbhe.zzkS)).booleanValue() && Objects.equals(strNextName, "inspector_ad_transaction_extras")) {
                                jSONObject2 = com.google.android.gms.ads.internal.util.zzbp.zzd(jsonReader);
                            } else {
                                if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.zzc().zzd(zzbhe.zzcL)).booleanValue() && Objects.equals(strNextName, "latency_extras")) {
                                    try {
        ...
        this.zze = strNextString4;
        this.zzf = iNextInt3;
        this.zzg = jNextLong;
        this.zzj = zzfitVar;
        this.zzh = zNextBoolean;
        this.zzi = strNextString;
        this.zzk = bundle;
        this.zzl = strNextString2;
        this.zzm = strNextString5;
        this.zzn = strNextString6;
        this.zzo = jSONObject;
        this.zzp = jSONObject2;
        this.zzq = strNextString7;
        zzbio zzbioVar2 = zzbji.zza;
        this.zzr = ((Long) zzbioVar2.zze()).longValue() > 0 ? ((Long) zzbioVar2.zze()).intValue() : iMax;
        this.zzs = jZza2;
        this.zzt = jZza;
    }
