...
public final class zzhcx extends zzhcg {
    private final zzhdd zza;
    private final zzhyg zzb;
    private final zzhye zzc;
    private final Integer zzd;

    public /* synthetic */ zzhcx(zzhdd zzhddVar, zzhyg zzhygVar, zzhye zzhyeVar, Integer num, byte[] bArr) {
        this.zza = zzhddVar;
        this.zzb = zzhygVar;
        this.zzc = zzhyeVar;
        this.zzd = num;
