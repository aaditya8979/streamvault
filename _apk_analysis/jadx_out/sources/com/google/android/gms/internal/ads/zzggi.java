...
final class zzggi extends zzghb {
    ...
    public final void zza(Method method, zzawg zzawgVar) throws IllegalAccessException, InvocationTargetException {
        ...
        try {
            ...
            if (iVar != null && ((Build.VERSION.SDK_INT < 31 || iVar.isDone()) && (zzaxgVar = (zzaxg) iVar.get(this.zzd, TimeUnit.MILLISECONDS)) != null && zzaxgVar.zzb().length() > 1)) {
                strZzb = zzaxgVar.zzb();
            }
        ...
        if (strZzb.equals(ExifInterface.LONGITUDE_EAST)) {
            try {
                c8.i iVar2 = (c8.i) this.zza.get("ai");
                if (iVar2 != null) {
