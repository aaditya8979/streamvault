...
public final class zzfsk {
    ...
    private zzfsk(zzfso zzfsoVar, zzfsr zzfsrVar, zzfsw zzfswVar, zzfsw zzfswVar2, boolean z10) {
        this.zzd = zzfsoVar;
        this.zze = zzfsrVar;
        this.zza = zzfswVar;
        if (zzfswVar2 == null) {
    ...
    public static zzfsk zza(zzfso zzfsoVar, zzfsr zzfsrVar, zzfsw zzfswVar, zzfsw zzfswVar2, boolean z10) {
        ...
        return new zzfsk(zzfsoVar, zzfsrVar, zzfswVar, zzfswVar2, z10);
    }
