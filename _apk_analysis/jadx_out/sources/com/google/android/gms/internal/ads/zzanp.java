...
public final class zzanp {
    ...
    public final zzanp zzh(boolean z10) {
        this.zzj = 1;
        return this;
    }

    public final zzanp zzi(boolean z10) {
        this.zzk = 1;
        return this;
    }

    public final zzanp zzj(boolean z10) {
        this.zzl = 1;
        return this;
    }
    ...
    public final zzanp zzl(@Nullable String str) {
    ...
    public final zzanp zzn(int i10) {
        this.zzf = i10;
        this.zzg = true;
        return this;
    }
    ...
    public final zzanp zzq(int i10) {
        this.zzh = i10;
        this.zzi = true;
        return this;
    }
    ...
    public final zzanp zzs(float f10) {
        this.zzn = f10;
        return this;
    }

    public final zzanp zzt(int i10) {
        this.zzm = i10;
        return this;
    }
    ...
    public final zzanp zzw(int i10) {
        this.zzo = i10;
        return this;
    }
    ...
    public final zzanp zzy(boolean z10) {
        this.zzp = z10;
        return this;
    }
