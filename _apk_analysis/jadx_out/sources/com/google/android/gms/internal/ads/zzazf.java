...
public class zzazf extends zzazd {
    ...
    public static final Object zzs = new Object();

    @VisibleForTesting
    public static boolean zzt = false;
    private static final String zzw = "zzazf";
    private static long zzx;
    private static zzazn zzz;
    public final zzaze zzu;
    ...
    public static zzbak zzp(Context context, boolean z10) {
        if (zzazd.zza == null) {
            synchronized (zzs) {
                if (zzazd.zza == null) {
    ...
    private final synchronized void zzt(zzbak zzbakVar, zzawg zzawgVar) {
        ...
        try {
            ...
            Long l10 = zzbamVarZzq.zza;
            if (l10 != null) {
                zzawgVar.zzh(l10.longValue());
            }
            Long l11 = zzbamVarZzq.zzb;
            if (l11 != null) {
                zzawgVar.zzi(l11.longValue());
            }
            Long l12 = zzbamVarZzq.zzc;
            if (l12 != null) {
                zzawgVar.zzj(l12.longValue());
            }
            if (this.zzp) {
                Long l13 = zzbamVarZzq.zzd;
                if (l13 != null) {
                    zzawgVar.zzv(l13.longValue());
                }
                Long l14 = zzbamVarZzq.zze;
                if (l14 != null) {
                    zzawgVar.zzw(l14.longValue());
                }
            }
        } catch (zzbaa unused) {
        }
        ...
        try {
            ...
            Long l15 = zzbamVarZzm.zza;
            if (l15 != null) {
                zzaxcVarZza.zza(l15.longValue());
            }
            Long l16 = zzbamVarZzm.zzb;
            if (l16 != null) {
                zzaxcVarZza.zzb(l16.longValue());
            }
            zzaxcVarZza.zzh(zzbamVarZzm.zzc.longValue());
            if (this.zzp) {
                Long l17 = zzbamVarZzm.zze;
                if (l17 != null) {
                    zzaxcVarZza.zzc(l17.longValue());
                }
                Long l18 = zzbamVarZzm.zzd;
                if (l18 != null) {
                    zzaxcVarZza.zzf(l18.longValue());
                }
                Long l19 = zzbamVarZzm.zzf;
                if (l19 != null) {
                    zzaxcVarZza.zzs(l19.longValue() != 0 ? 2 : 1);
                }
                if (this.zze > 0) {
                ...
                Long l20 = zzbamVarZzm.zzi;
                if (l20 != null) {
                    zzaxcVarZza.zzj(l20.longValue());
                }
                Long l21 = zzbamVarZzm.zzj;
                if (l21 != null) {
                    zzaxcVarZza.zzi(l21.longValue());
                }
                Long l22 = zzbamVarZzm.zzk;
                if (l22 != null) {
                    zzaxcVarZza.zzt(l22.longValue() != 0 ? 2 : 1);
                }
            }
        } catch (zzbaa unused2) {
        }
        ...
        try {
            ...
            if (size > 0) {
                ...
                for (int i10 = 0; i10 < size; i10++) {
                    zzbam zzbamVarZzq2 = zzq(zzazd.zza, (MotionEvent) linkedList.get(i10), this.zzq);
    ...
    public final void zzr(zzbak zzbakVar, zzawg zzawgVar, View view, Activity activity, boolean z10, Context context) {
        List listAsList;
        long jZzc;
        long jZzd;
        if (zzbakVar.zzc()) {
            ...
            if (zzbakVar.zzd() != null) {
                ...
                if (!z10) {
                    ...
                    if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.zzc().zzd(zzbhe.zzdB)).booleanValue()) {
                        arrayList.add(new zzbbi(zzbakVar, "mt+WJZ1rsk0A64GmF9v+ldp/SXHcK6tYIctDM1+NeYG+QzoGvdHV21P9oFWIcCVk", "JGpzBcqG4jzyQyzoEbT5NvLNZXRWAW3o2QUKET83n6Q=", zzawgVar, iZzq, 94, this.zzr));
                    }
                } else if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.zzc().zzd(zzbhe.zzdq)).booleanValue()) {
                    arrayList.add(new zzbbs(zzbakVar, "X3d3ekEggpPfZcTTuZPSKX+MUCnQGNsbyccHnkW7iVTfczCTjKoxcgVjpAE8Uhyz", "I4rncSeVGoKv0gEJ8Xd0rq9G0kL2Ky2ley3iuTG83Dg=", zzawgVar, iZzq, 53, this.zzv));
                }
            }
