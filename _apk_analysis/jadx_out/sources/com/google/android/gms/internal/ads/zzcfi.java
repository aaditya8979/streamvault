...
public final class zzcfi extends zzcfk implements TextureView.SurfaceTextureListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnVideoSizeChangedListener {
    ...
    private final void zzD() {
        ...
        try {
            ...
            com.google.android.gms.ads.internal.util.client.zzo.zzj("Failed to initialize MediaPlayer at ".concat(String.valueOf(this.zzk)), e10);
    ...
    public final void onCompletion(MediaPlayer mediaPlayer) {
        ...
        CreativeInfoManager.onVideoCompleted(com.safedk.android.utils.g.f53134h, mediaPlayer);
    ...
    */
    ...
    public void safedk_zzcfi_onCompletion_072fdd70c07d7233532afaf0ee8d8cc7(MediaPlayer mediaPlayer) {
                        ...
                        if (trackType == 1) {
                            ...
                            if (format2 != null) {
                                ...
                                if (format2.containsKey(VastAttributes.BITRATE)) {
                                    Integer numValueOf = Integer.valueOf(format2.getInteger(VastAttributes.BITRATE));
                                    this.zzt = numValueOf;
