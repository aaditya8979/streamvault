...
public final class zzajh implements zzaeu {
    ...
    */
    ...
    private static byte[] zzx(long j10, String str, long j11) {
        zzgrc.zza(j10 != -9223372036854775807L);
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final void zzi(int r34) throws com.google.android.gms.internal.ads.zzat {
        /*
    ...
    public final void zzm(int i10, int i11, zzaev zzaevVar) throws IOException {
        ...
        if (this.zzU == 1) {
            ...
            if (i22 == 0) {
                ...
                zzt(zzaevVar, 4);
                int i23 = (zzerVar3.zzi()[3] & 255) + 1;
                this.zzY = i23;
                int[] iArrZzA2 = zzA(this.zzZ, i23);
                this.zzZ = iArrZzA2;
                if (i22 == 2) {
                    int i24 = (i11 - this.zzab) - 4;
                    int i25 = this.zzY;
                    ...
                    if (i22 != 1) {
                        ...
                        while (true) {
                            int i29 = this.zzY - 1;
                            if (i26 >= i29) {
                                this.zzZ[i29] = ((i11 - this.zzab) - i28) - i27;
                                break;
                            }
                            this.zzZ[i26] = i20;
                            i28++;
                            zzt(zzaevVar, i28);
                            int i30 = i28 - 1;
                            if (zzerVar3.zzi()[i30] == 0) {
                                throw zzat.zzb("No valid varint length mask found", th2);
                            }
                            int i31 = i20;
                            while (true) {
                                if (i31 >= i21) {
                                ...
                                int i32 = i19 << (7 - i31);
                                if ((zzerVar3.zzi()[i30] & i32) != 0) {
                                    int i33 = i28 + i31;
                                    zzt(zzaevVar, i33);
                                    j10 = (~i32) & zzerVar3.zzi()[i30] & 255;
                                    int i34 = i30 + 1;
                                    while (i34 < i33) {
                                        j10 = (j10 << 8) | ((long) (zzerVar3.zzi()[i34] & 255));
                                        i34++;
                                        i33 = i33;
                                    }
                                    int i35 = i33;
                    ...
                    this.zzZ[i13] = ((i11 - this.zzab) - i39) - i38;
                }
            }
        ...
        if (i18 == i12) {
            while (true) {
                ...
                zzs(zzajgVar3, ((long) ((this.zzX * zzajgVar3.zzf) / 1000)) + this.zzV, this.zzac, zzu(zzaevVar, zzajgVar3, this.zzZ[i40], false), 0);
                this.zzX++;
            }
        } else {
            while (true) {
                ...
                int[] iArr3 = this.zzZ;
                iArr3[i41] = zzu(zzaevVar, zzajgVar3, iArr3[i41], true);
                this.zzX++;
            }
        }
    }
