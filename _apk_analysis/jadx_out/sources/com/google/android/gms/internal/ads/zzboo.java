...
public final class zzboo implements zzboh {
    public static final Map zza = CollectionUtils.mapOfKeyValueArrays(new String[]{"resize", "playVideo", "storePicture", "createCalendarEvent", MRAIDPresenter.SET_ORIENTATION_PROPERTIES, "closeResizedAd", "unload"}, new Integer[]{1, 2, 3, 4, 5, 6, 7});
    ...
    public final /* bridge */ /* synthetic */ void zza(Object obj, Map map) {
        ...
        if (C3978d4.i.D.equalsIgnoreCase(str)) {
            i10 = 7;
        } else if (!C3978d4.i.C.equalsIgnoreCase(str)) {
            i10 = z10 ? -1 : 14;
        }
        zzcjlVar.zzam(i10);
    }
