...
final class zzgpo {
    ...
    @VisibleForTesting
    public final zzgqf zza;
    private final String zze;

    public zzgpo(Context context) {
        if (zzgqi.zza(context)) {
            this.zza = new zzgqf(context.getApplicationContext(), zzc, "OverlayDisplayService", zzd, new zzgpw() { // from class: com.google.android.gms.internal.ads.zzgoz
            });
        } else {
            this.zza = null;
        }
    ...
    public final void zzc(final zzgpv zzgpvVar, final zzgpt zzgptVar, final int i10) {
        zzgqf zzgqfVar = this.zza;
        if (zzgqfVar == null) {
            zzc.zzc("error: %s", "Play Store not found.");
            ...
            zzgqfVar.zza(new Runnable() { // from class: com.google.android.gms.internal.ads.zzgpc
                @Override // java.lang.Runnable
                public final /* synthetic */ void run() {
                    this.zza.zzg(zzgpvVar, i10, zzgptVar);
                }
            });
        }
    }
    ...
    public final /* synthetic */ void zzg(zzgpv zzgpvVar, int i10, zzgpt zzgptVar) {
        try {
            zzgqf zzgqfVar = this.zza;
            zzgqfVar.getClass();
            zzgoj zzgojVar = (zzgoj) zzgqfVar.zzc();
