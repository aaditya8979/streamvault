...
public final class zzelg implements zzekg {
    ...
    public final /* synthetic */ c8.i zzc(zzfjc zzfjcVar, zzfir zzfirVar, Object obj) throws zzcka {
        ...
        zzctyVarZzf.zzj();
        c8.i iVarZzj = zzduu.zzj(zzcjlVarZza, zzfiwVar.zzb, strZza, zzdxtVar.zze(), zzcvcVar.zze());
        if (zzfirVar.zzM) {
            iVarZzj.addListener(new Runnable() { // from class: com.google.android.gms.internal.ads.zzela
        ...
        iVarZzj.addListener(new Runnable() { // from class: com.google.android.gms.internal.ads.zzeld
            @Override // java.lang.Runnable
            public final /* synthetic */ void run() {
                this.zza.zzd(zzcjlVarZza);
            }
        }, this.zze);
        return zzgzo.zzk(iVarZzj, new zzgqt() { // from class: com.google.android.gms.internal.ads.zzele
