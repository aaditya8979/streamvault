...
public final class zzbww extends zzbwx implements zzboh {
    ...
    public final /* synthetic */ void zza(Object obj, Map map) {
        ...
        try {
            jSONObjectPut = new JSONObject().put("sms", zZzf).put("tel", zZzg).put("calendar", zZzh).put("storePicture", zZzi).put(MraidNativeFeature.FEATURE_INLINE_VIDEO, zzbwvVar.zzj());
