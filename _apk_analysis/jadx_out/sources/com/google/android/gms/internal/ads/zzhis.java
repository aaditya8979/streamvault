    ...
    public static ECPoint zzd(BigInteger bigInteger, ECParameterSpec eCParameterSpec) throws GeneralSecurityException {
        ...
        for (int iBitLength = bigInteger.bitLength(); iBitLength >= 0; iBitLength--) {
            if (bigInteger.testBit(iBitLength)) {
                zzhirVarZze = zzg(zzhirVarZze, zzhirVarZze2, a10, bigIntegerZzc);
                zzhirVarZze2 = zzf(zzhirVarZze2, a10, bigIntegerZzc);
            } else {
                zzhirVarZze2 = zzg(zzhirVarZze, zzhirVarZze2, a10, bigIntegerZzc);
                zzhirVarZze = zzf(zzhirVarZze, a10, bigIntegerZzc);
            }
        }
        if (zzhirVarZze.zza()) {
