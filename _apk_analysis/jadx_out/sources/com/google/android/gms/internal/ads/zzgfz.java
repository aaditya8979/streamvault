...
final class zzgfz implements zzgfx {
    ...
    /* JADX WARN: Not initialized variable reg: 0, insn: 0x0257: INVOKE (r0 I:com.google.android.gms.internal.ads.zzgoc) VIRTUAL call: com.google.android.gms.internal.ads.zzgoc.zzc():void A[Catch: all -> 0x025b, MD:():void (m), TRY_ENTER], block:B:108:0x0257 */
    ...
    public final synchronized void zza() {
        ...
        FileInputStream fileInputStream;
        try {
            zzgoc zzgocVarZza = this.zzf.zza(201);
            try {
                zzgocVarZza.zza();
                try {
                    try {
                        bArrZzb = zzgca.zzb("n86zgxhQ61zjjm6tfFDGvuoFJBviiscKeJQOTsE9oyA=", false);
                    } catch (zzgfv e10) {
                        throw new zzgcb(e10);
                    }
            ...
            try {
                ...
                if (!file2.exists()) {
                    ...
                    file2.createNewFile();
                    FileOutputStream fileOutputStreamFileOutputStreamCtor2 = AdMobFilesBridge.fileOutputStreamCtor(file2);
                    try {
                        if (Build.VERSION.SDK_INT >= 34) {
                            file2.setReadOnly();
                        }
                        fileOutputStreamFileOutputStreamCtor2.write(bArrZza, 0, bArrZza.length);
                        fileOutputStreamFileOutputStreamCtor2.close();
                    } catch (Throwable th3) {
                        try {
                            fileOutputStreamFileOutputStreamCtor2.close();
                        } catch (Throwable th4) {
                ...
                if (file4.exists()) {
                    ...
                    sb4.append(MultiDexExtractor.DEX_SUFFIX);
                                ...
                                try {
                                    try {
                                        if (fileInputStream.read(bArr2) <= 0) {
                                            ...
                                            zzaxk zzaxkVarZze = zzaxk.zze(bArr2, zzibb.zza());
                                            if ("1764808731656".equals(new String(zzaxkVarZze.zzc().zzy())) && Arrays.equals(zzaxkVarZze.zzb().zzy(), this.zzd.zze(zzaxkVarZze.zza().zzy())) && Arrays.equals(zzaxkVarZze.zzd().zzy(), Build.VERSION.SDK.getBytes())) {
                                                byte[] bArrZza2 = this.zze.zza(this.zzm, new String(zzaxkVarZze.zza().zzy()));
                                                file5.createNewFile();
                                                fileOutputStreamFileOutputStreamCtor = AdMobFilesBridge.fileOutputStreamCtor(file5);
                                                try {
                                                    fileOutputStreamFileOutputStreamCtor.write(bArrZza2, 0, bArrZza2.length);
                                                    zzh(fileInputStream);
                                                    zzh(fileOutputStreamFileOutputStreamCtor);
                ...
                try {
                    ...
                    for (final zzggb zzggbVar : this.zzh) {
                        Pair pairCreate = Pair.create(zzggbVar.zza, zzggbVar.zzb);
                        Map map = this.zzi;
                        if (!map.containsKey(pairCreate)) {
                            map.put(pairCreate, this.zzc.submit(new Callable() { // from class: com.google.android.gms.internal.ads.zzgfy
                                @Override // java.util.concurrent.Callable
                                public final /* synthetic */ Object call() {
                                    return this.zza.zzd(zzggbVar);
                                }
                            }));
                        }
                    }
            ...
            } catch (zzgfv | IOException | NullPointerException e13) {
                throw new zzgcb(e13);
            }
        } catch (Throwable th9) {
            zzgocVarZzc.zzc();
