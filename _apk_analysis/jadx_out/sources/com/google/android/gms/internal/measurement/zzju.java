...
public final class zzju {
    ...
    static {
        ...
        zzju[] zzjuVarArrValues = values();
        zzZ = new zzju[zzjuVarArrValues.length];
        for (zzju zzjuVar52 : zzjuVarArrValues) {
            zzZ[zzjuVar52.zzac] = zzjuVar52;
        }
    }

    private zzju(String str, int i10, int i11, int i12, zzkn zzknVar) {
        this.zzac = i11;
        this.zzab = zzknVar;
