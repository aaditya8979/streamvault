...
public final class zzdst extends zzbll {
    ...
    public final List zzg() {
        try {
            ...
            int i10 = 0;
            for (int i11 = 0; i11 < simpleArrayMapZzaa.size(); i11++) {
                strArr[i10] = (String) simpleArrayMapZzaa.keyAt(i11);
                i10++;
            }
            for (int i12 = 0; i12 < simpleArrayMapZzad.size(); i12++) {
                strArr[i10] = (String) simpleArrayMapZzad.keyAt(i12);
                i10++;
            }
