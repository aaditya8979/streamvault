    ...
    public static String zzd(byte[] bArr, int i10, int i11) throws zzkm {
        ...
        while (i10 < i12) {
            ...
            if (zzmw.zzd(b11)) {
                ...
                zzmw.zzc(b11, bArr[i14], cArr, i13);
                i10 = i14 + 1;
                i13++;
            } else if (b11 < -16) {
                if (i14 >= i12 - 1) {
                ...
                int i16 = i14 + 1;
                zzmw.zzb(b11, bArr[i14], bArr[i16], cArr, i13);
                i10 = i16 + 1;
                i13++;
            } else {
                if (i14 >= i12 - 2) {
                ...
                int i17 = i14 + 1;
                int i18 = i17 + 1;
                zzmw.zza(b11, bArr[i14], bArr[i17], bArr[i18], cArr, i13);
                i13 += 2;
                i10 = i18 + 1;
            }
        }
