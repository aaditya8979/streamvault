...
public final class zzps {
    ...
    private zzps(List list) {
        for (int i10 = 0; i10 < list.size(); i10++) {
            zzpr zzprVar = (zzpr) list.get(i10);
            this.zzd.put(zzprVar.zzb, zzprVar);
        }
        int iMax = 0;
        for (int i11 = 0; i11 < this.zzd.size(); i11++) {
            iMax = Math.max(iMax, ((zzpr) this.zzd.valueAt(i11)).zzc);
        }
        this.zze = iMax;
    }

    @SuppressLint({"UnprotectedReceiver"})
    public static zzps zza(Context context, zzd zzdVar, @Nullable AudioDeviceInfo audioDeviceInfo) {
    ...
    */
    public static com.google.android.gms.internal.ads.zzps zzb(android.content.Context r9, @androidx.annotation.Nullable android.content.Intent r10, com.google.android.gms.internal.ads.zzd r11, @androidx.annotation.Nullable android.media.AudioDeviceInfo r12) {
        /*
    ...
    */
    public final boolean equals(@androidx.annotation.Nullable java.lang.Object r9) {
        ...
        La:
            ...
            r5 = 31
            if (r4 < r5) goto L1f
            boolean r1 = androidx.media3.common.util.f.a(r1, r3)
            if (r1 == 0) goto L48
            goto L41
        L1f:
            int r4 = r1.size()
    ...
    */
    public final android.util.Pair zzd(com.google.android.gms.internal.ads.zzv r10, com.google.android.gms.internal.ads.zzd r11) {
        ...
        L2c:
            if (r1 != r4) goto L3a
            android.util.SparseArray r1 = r9.zzd
            boolean r1 = com.google.android.gms.internal.ads.zzfj.zza(r1, r4)
            if (r1 == 0) goto L38
            r1 = r4
            goto L3a
        L38:
