...
public final class zzauk {
    ...
    public final String toString() {
        ...
        sb2.append(zzaui.zza("CVC1qiQNJHikW0iU1TIPZA=="));
        sb2.append(string);
        sb2.append(zzaui.zza("Ng=="));
        return sb2.toString();
    }
    ...
    public final byte zzb(int i10) {
        ...
        iArr[7] = 1442767057;
        iArr[8] = 63299708;
        int i21 = 189699559 + (((((~1287859999) & 62941354) | 437464817) + ((1287859999 & 1639989262) | 1644309956)) - (-2044289941));
        int i22 = 1442767057 % 63299708;
        byte[] bArr = this.zza;
        int length = bArr.length;
        ...
        if (i10 < 0) {
            StringBuilder sb2 = new StringBuilder(String.valueOf(i10).length() + (i19 ^ i20));
            sb2.append(zzaui.zza("Akelqh1fajntGgo="));
            sb2.append(i10);
            throw new ArrayIndexOutOfBoundsException(sb2.toString());
        }
        StringBuilder sb3 = new StringBuilder(String.valueOf(i10).length() + (i21 ^ i22) + String.valueOf(length).length());
        sb3.append(zzaui.zza("Akelqh1faDmxRUSK1T9GeQ=="));
        sb3.append(i10);
        sb3.append(zzaui.zza("Zwk="));
        sb3.append(length);
