...
public final class zzbop implements zzboh {
    ...
    public final void zza(Object obj, Map map) {
        if (map == null || !map.containsKey("id") || TextUtils.isEmpty((CharSequence) map.get("id")) || !map.containsKey(StatsEvent.f52830z) || TextUtils.isEmpty((CharSequence) map.get(StatsEvent.f52830z))) {
            com.google.android.gms.ads.internal.util.zze.zza("Ignoring onDeviceStorageEvent GMSG: missing required parameters.");
            return;
        }
        try {
            this.zza.zza(Long.parseLong((String) map.get("id")), Integer.parseInt((String) map.get(StatsEvent.f52830z)), com.google.android.gms.ads.internal.zzt.zzk().currentTimeMillis());
