...
public class PlaybackException extends Exception implements f {
    public static final f.a<PlaybackException> CREATOR = new f.a() { // from class: d6.n1
    ...
    public PlaybackException(@Nullable String str, @Nullable Throwable th2, int i10) {
        this(str, th2, i10, s7.d.f79450a.elapsedRealtime());
    }
    ...
    public static String keyForField(int i10) {
    ...
    */
    public boolean errorInfoEquals(@androidx.annotation.Nullable com.google.android.exoplayer2.PlaybackException r7) {
        ...
        L12:
            ...
            boolean r4 = s7.m0.c(r4, r5)
            if (r4 != 0) goto L2d
            return r1
        L2d:
            java.lang.Class r2 = r2.getClass()
            java.lang.Class r3 = r3.getClass()
            boolean r2 = s7.m0.c(r2, r3)
            if (r2 != 0) goto L41
            return r1
        L3c:
            if (r2 != 0) goto L60
