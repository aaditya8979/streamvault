...
public class BadgeDrawable extends Drawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private void calculateCenterAndBounds(@NonNull Context context, @NonNull Rect rect, @NonNull View view) {
        ...
        if (i13 == 8388659 || i13 == 8388691) {
            this.badgeCenterX = ViewCompat.getLayoutDirection(view) == 0 ? (rect.left - this.halfBadgeWidth) + dimensionPixelSize + i12 : ((rect.right + this.halfBadgeWidth) - dimensionPixelSize) - i12;
        } else {
            this.badgeCenterX = ViewCompat.getLayoutDirection(view) == 0 ? ((rect.right + this.halfBadgeWidth) - dimensionPixelSize) - i12 : (rect.left - this.halfBadgeWidth) + dimensionPixelSize + i12;
        }
    }
    ...
    private void loadDefaultStateFromAttributes(Context context, AttributeSet attributeSet, @AttrRes int i10, @StyleRes int i11) {
        ...
        if (typedArrayObtainStyledAttributes.hasValue(i12)) {
            setNumber(typedArrayObtainStyledAttributes.getInt(i12, 0));
        }
        ...
        if (typedArrayObtainStyledAttributes.hasValue(i13)) {
            setBadgeTextColor(readColorFromAttributes(context, typedArrayObtainStyledAttributes, i13));
        }
