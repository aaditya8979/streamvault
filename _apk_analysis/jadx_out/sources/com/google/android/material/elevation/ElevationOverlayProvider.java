...
public class ElevationOverlayProvider {
    ...
    public int compositeOverlay(@ColorInt int i10, float f10) {
        ...
        return ColorUtils.setAlphaComponent(MaterialColors.layer(ColorUtils.setAlphaComponent(i10, 255), this.elevationOverlayColor, fCalculateOverlayAlphaFraction), Color.alpha(i10));
    }
