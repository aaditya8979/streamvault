...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    public NavigationView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i10) {
        ...
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(i12)) {
            ViewCompat.setBackground(this, tintTypedArrayObtainTintedStyledAttributes.getDrawable(i12));
        }
        ...
        ColorStateList colorStateList = tintTypedArrayObtainTintedStyledAttributes.hasValue(i13) ? tintTypedArrayObtainTintedStyledAttributes.getColorStateList(i13) : createDefaultColorStateList(R.attr.textColorSecondary);
        ...
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(i14)) {
            resourceId = tintTypedArrayObtainTintedStyledAttributes.getResourceId(i14, 0);
            z10 = true;
        } else {
            resourceId = 0;
            z10 = false;
        ...
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(i15)) {
            setItemIconSize(tintTypedArrayObtainTintedStyledAttributes.getDimensionPixelSize(i15, 0));
        }
        int i16 = com.google.android.material.R.styleable.NavigationView_itemTextColor;
        ColorStateList colorStateList2 = tintTypedArrayObtainTintedStyledAttributes.hasValue(i16) ? tintTypedArrayObtainTintedStyledAttributes.getColorStateList(i16) : null;
        ...
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(i17)) {
            navigationMenuPresenter.setItemHorizontalPadding(tintTypedArrayObtainTintedStyledAttributes.getDimensionPixelSize(i17, 0));
        }
        ...
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(i18)) {
            inflateMenu(tintTypedArrayObtainTintedStyledAttributes.getResourceId(i18, 0));
        }
        ...
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(i19)) {
            inflateHeaderView(tintTypedArrayObtainTintedStyledAttributes.getResourceId(i19, 0));
        }
