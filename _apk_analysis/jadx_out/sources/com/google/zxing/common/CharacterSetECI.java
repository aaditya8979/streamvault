...
public enum CharacterSetECI {
    ...
    public static final Map<Integer, CharacterSetECI> f23657b = new HashMap();

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public static final Map<String, CharacterSetECI> f23658c = new HashMap();
    ...
    static {
        for (CharacterSetECI characterSetECI : values()) {
            for (int i10 : characterSetECI.values) {
                f23657b.put(Integer.valueOf(i10), characterSetECI);
            }
            f23658c.put(characterSetECI.name(), characterSetECI);
            for (String str : characterSetECI.otherEncodingNames) {
                f23658c.put(str, characterSetECI);
            }
        }
    }
    ...
    public static CharacterSetECI getCharacterSetECIByValue(int i10) throws FormatException {
        ...
        return f23657b.get(Integer.valueOf(i10));
    }
