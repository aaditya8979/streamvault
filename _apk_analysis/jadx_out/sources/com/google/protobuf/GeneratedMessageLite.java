...
public abstract class GeneratedMessageLite<MessageType extends GeneratedMessageLite<MessageType, BuilderType>, BuilderType extends Builder<MessageType, BuilderType>> extends AbstractMessageLite<MessageType, BuilderType> {
    ...
    public static abstract class Builder<MessageType extends GeneratedMessageLite<MessageType, BuilderType>, BuilderType extends Builder<MessageType, BuilderType>> extends AbstractMessageLite.Builder<MessageType, BuilderType> {
        ...
        public BuilderType mo4289clone() {
    ...
    public static abstract class ExtendableBuilder<MessageType extends ExtendableMessage<MessageType, BuilderType>, BuilderType extends ExtendableBuilder<MessageType, BuilderType>> extends Builder<MessageType, BuilderType> implements ExtendableMessageOrBuilder<MessageType, BuilderType> {
        ...
        private FieldSet<b> ensureExtensionsAreMutable() {
            ...
            FieldSet fieldSetClone = fieldSet.m4301clone();
        ...
        public void copyOnWriteInternal() {
            ...
            if (((ExtendableMessage) this.instance).extensions != FieldSet.emptySet()) {
                ...
                ((ExtendableMessage) messagetype).extensions = ((ExtendableMessage) messagetype).extensions.m4301clone();
            }
        }
    ...
    public static abstract class ExtendableMessage<MessageType extends ExtendableMessage<MessageType, BuilderType>, BuilderType extends ExtendableBuilder<MessageType, BuilderType>> extends GeneratedMessageLite<MessageType, BuilderType> implements ExtendableMessageOrBuilder<MessageType, BuilderType> {
        public FieldSet<b> extensions = FieldSet.emptySet();
        ...
        */
        ...
        public FieldSet<b> ensureExtensionsAreMutable() {
            if (this.extensions.isImmutable()) {
                this.extensions = this.extensions.m4301clone();
            }
    ...
    private int computeSerializedSize(l0<?> l0Var) {
        return l0Var == null ? h0.getInstance().schemaFor(this).getSerializedSize(this) : l0Var.getSerializedSize(this);
    }
    ...
    public static final <T extends GeneratedMessageLite<T, ?>> boolean isInitialized(T t10, boolean z10) {
        ...
        boolean zIsInitialized = h0.getInstance().schemaFor(t10).isInitialized(t10);
        if (z10) {
    ...
    public static <T extends GeneratedMessageLite<T, ?>> T parsePartialFrom(T t10, CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
        ...
        try {
            l0 l0VarSchemaFor = h0.getInstance().schemaFor(t11);
            l0VarSchemaFor.mergeFrom(t11, f.forCodedInput(codedInputStream), extensionRegistryLite);
            l0VarSchemaFor.makeImmutable(t11);
            return t11;
        } catch (InvalidProtocolBufferException e10) {
            e = e10;
    ...
    public static <T extends GeneratedMessageLite<T, ?>> T parsePartialFrom(T t10, byte[] bArr, int i10, int i11, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
        ...
        try {
            l0 l0VarSchemaFor = h0.getInstance().schemaFor(t11);
            l0VarSchemaFor.mergeFrom(t11, bArr, i10, i10 + i11, new c.b(extensionRegistryLite));
            l0VarSchemaFor.makeImmutable(t11);
            return t11;
        } catch (InvalidProtocolBufferException e10) {
            e = e10;
    ...
    public int getSerializedSize(l0 l0Var) {
        if (!isMutable()) {
            ...
            int iComputeSerializedSize = computeSerializedSize(l0Var);
            setMemoizedSerializedSize(iComputeSerializedSize);
            return iComputeSerializedSize;
        }
        int iComputeSerializedSize2 = computeSerializedSize(l0Var);
