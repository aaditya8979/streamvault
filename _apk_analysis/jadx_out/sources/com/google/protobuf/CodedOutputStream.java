...
public abstract class CodedOutputStream extends ByteOutput {
    ...
    public com.google.protobuf.g wrapper;
    private static final Logger logger = Logger.getLogger(CodedOutputStream.class.getName());
    private static final boolean HAS_UNSAFE_ARRAY_OPERATIONS = s0.hasUnsafeArrayOperations();
    ...
    public static abstract class b extends CodedOutputStream {
        ...
        public final void bufferUInt32NoTag(int i10) {
            ...
            while ((i10 & (-128)) != 0) {
                ...
                this.position = i13 + 1;
                s0.putByte(bArr3, i13, (byte) ((i10 & 127) | 128));
                i10 >>>= 7;
            }
            byte[] bArr4 = this.buffer;
            int i14 = this.position;
            this.position = i14 + 1;
            s0.putByte(bArr4, i14, (byte) i10);
        ...
        public final void bufferUInt64NoTag(long j10) {
            ...
            while ((j10 & (-128)) != 0) {
                ...
                int i12 = this.position;
                this.position = i12 + 1;
                s0.putByte(bArr3, i12, (byte) ((((int) j10) & 127) | 128));
                j10 >>>= 7;
            }
            byte[] bArr4 = this.buffer;
            int i13 = this.position;
            this.position = i13 + 1;
            s0.putByte(bArr4, i13, (byte) j10);
    ...
    public static class c extends CodedOutputStream {
        ...
        @Override // com.google.protobuf.CodedOutputStream
        public final void writeMessage(int i10, MessageLite messageLite, l0 l0Var) throws IOException {
            writeTag(i10, 2);
            writeUInt32NoTag(((AbstractMessageLite) messageLite).getSerializedSize(l0Var));
            l0Var.writeTo(messageLite, this.wrapper);
        }
        ...
        @Override // com.google.protobuf.CodedOutputStream
        public final void writeMessageNoTag(MessageLite messageLite, l0 l0Var) throws IOException {
            writeUInt32NoTag(((AbstractMessageLite) messageLite).getSerializedSize(l0Var));
            l0Var.writeTo(messageLite, this.wrapper);
        }
        ...
        public final void writeUInt64NoTag(long j10) throws IOException {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS && spaceLeft() >= 10) {
                while ((j10 & (-128)) != 0) {
                    ...
                    int i10 = this.position;
                    this.position = i10 + 1;
                    s0.putByte(bArr, i10, (byte) ((((int) j10) & 127) | 128));
                    j10 >>>= 7;
                }
                byte[] bArr2 = this.buffer;
                int i11 = this.position;
                this.position = i11 + 1;
                s0.putByte(bArr2, i11, (byte) j10);
                return;
            }
            while ((j10 & (-128)) != 0) {
                try {
    ...
    public static final class d extends b {
        ...
        @Override // com.google.protobuf.CodedOutputStream
        public void writeMessage(int i10, MessageLite messageLite, l0 l0Var) throws IOException {
            writeTag(i10, 2);
            writeMessageNoTag(messageLite, l0Var);
        }
        ...
        @Override // com.google.protobuf.CodedOutputStream
        public void writeMessageNoTag(MessageLite messageLite, l0 l0Var) throws IOException {
            writeUInt32NoTag(((AbstractMessageLite) messageLite).getSerializedSize(l0Var));
            l0Var.writeTo(messageLite, this.wrapper);
        }
    ...
    public static final class e extends c {
        ...
        public void flush() {
            q.position(this.byteBuffer, this.initialPosition + getTotalBytesWritten());
        }
    }
    ...
    public static final class g extends CodedOutputStream {
        ...
        @Override // com.google.protobuf.CodedOutputStream
        public void flush() {
            q.position(this.originalBuffer, this.buffer.position());
        }
        ...
        public void writeStringNoTag(String str) throws IOException {
            ...
            try {
                ...
                if (iComputeUInt32SizeNoTag2 == iComputeUInt32SizeNoTag) {
                    ...
                    q.position(this.buffer, iPosition2);
                    encode(str);
                    int iPosition3 = this.buffer.position();
                    q.position(this.buffer, iPosition);
                    writeUInt32NoTag(iPosition3 - iPosition2);
                    q.position(this.buffer, iPosition3);
                } else {
                    writeUInt32NoTag(Utf8.encodedLength(str));
                    encode(str);
                }
    ...
    public static final class h extends CodedOutputStream {
        ...
        public h(ByteBuffer byteBuffer) {
            ...
            this.originalBuffer = byteBuffer;
            this.buffer = byteBuffer.duplicate().order(ByteOrder.LITTLE_ENDIAN);
            long jAddressOffset = s0.addressOffset(byteBuffer);
        ...
        private void repositionBuffer(long j10) {
            q.position(this.buffer, bufferPos(j10));
        }

        @Override // com.google.protobuf.CodedOutputStream
        public void flush() {
            q.position(this.originalBuffer, bufferPos(this.position));
        }
        ...
        public void write(byte[] bArr, int i10, int i11) throws IOException {
            if (bArr != null && i10 >= 0 && i11 >= 0 && bArr.length - i11 >= i10) {
                ...
                if (j11 >= j12) {
                    s0.copyMemory(bArr, i10, j12, j10);
                    this.position += j10;
                    return;
                }
            }
        ...
        public void writeStringNoTag(String str) throws IOException {
            ...
            try {
                ...
                if (iComputeUInt32SizeNoTag2 == iComputeUInt32SizeNoTag) {
                    ...
                    q.position(this.buffer, iBufferPos);
                    Utf8.encodeUtf8(str, this.buffer);
        ...
        public void writeUInt32NoTag(int i10) throws IOException {
            if (this.position <= this.oneVarintLimit) {
                while ((i10 & (-128)) != 0) {
                    long j10 = this.position;
                    this.position = j10 + 1;
                    s0.putByte(j10, (byte) ((i10 & 127) | 128));
                    i10 >>>= 7;
                }
                long j11 = this.position;
                this.position = 1 + j11;
                s0.putByte(j11, (byte) i10);
                return;
            }
            while (true) {
                long j12 = this.position;
                ...
                if ((i10 & (-128)) == 0) {
                    this.position = 1 + j12;
                    s0.putByte(j12, (byte) i10);
                    return;
                } else {
                    this.position = j12 + 1;
                    s0.putByte(j12, (byte) ((i10 & 127) | 128));
                    i10 >>>= 7;
                }
            }
        }
        ...
        public void writeUInt64NoTag(long j10) throws IOException {
            if (this.position <= this.oneVarintLimit) {
                while ((j10 & (-128)) != 0) {
                    long j11 = this.position;
                    this.position = j11 + 1;
                    s0.putByte(j11, (byte) ((((int) j10) & 127) | 128));
                    j10 >>>= 7;
                }
                long j12 = this.position;
                this.position = 1 + j12;
                s0.putByte(j12, (byte) j10);
                return;
            }
            while (true) {
                ...
                if ((j10 & (-128)) == 0) {
                    this.position = 1 + j13;
                    s0.putByte(j13, (byte) j10);
                    return;
                } else {
                    this.position = j13 + 1;
                    s0.putByte(j13, (byte) ((((int) j10) & 127) | 128));
                    j10 >>>= 7;
                }
            }
        }
    ...
    @Deprecated
    public static int computeGroupSize(int i10, MessageLite messageLite, l0 l0Var) {
        return (computeTagSize(i10) * 2) + computeGroupSizeNoTag(messageLite, l0Var);
    }
    ...
    @Deprecated
    public static int computeGroupSizeNoTag(MessageLite messageLite, l0 l0Var) {
    ...
    public static int computeMessageSize(int i10, MessageLite messageLite, l0 l0Var) {
        return computeTagSize(i10) + computeMessageSizeNoTag(messageLite, l0Var);
    }
    ...
    public static int computeMessageSizeNoTag(MessageLite messageLite, l0 l0Var) {
        return computeLengthDelimitedFieldSize(((AbstractMessageLite) messageLite).getSerializedSize(l0Var));
    }
    ...
    @Deprecated
    public final void writeGroup(int i10, MessageLite messageLite, l0 l0Var) throws IOException {
        writeTag(i10, 3);
        writeGroupNoTag(messageLite, l0Var);
        writeTag(i10, 4);
    }
    ...
    @Deprecated
    public final void writeGroupNoTag(MessageLite messageLite, l0 l0Var) throws IOException {
        l0Var.writeTo(messageLite, this.wrapper);
    }
    ...
    public abstract void writeMessage(int i10, MessageLite messageLite, l0 l0Var) throws IOException;

    public abstract void writeMessageNoTag(MessageLite messageLite) throws IOException;

    public abstract void writeMessageNoTag(MessageLite messageLite, l0 l0Var) throws IOException;
