...
public final class FieldType {
    ...
    static {
        ...
        for (FieldType fieldType52 : fieldTypeArrValues) {
            VALUES[fieldType52.f23640id] = fieldType52;
        }
    }
    ...
    private FieldType(String str, int i10, int i11, Collection collection, JavaType javaType) {
        ...
        int i13 = a.$SwitchMap$com$google$protobuf$FieldType$Collection[collection.ordinal()];
        if (i13 == 1 || i13 == 2) {
            this.elementType = javaType.getBoxedType();
        } else {
            this.elementType = null;
        }
        this.primitiveScalar = (collection != Collection.SCALAR || (i12 = a.$SwitchMap$com$google$protobuf$JavaType[javaType.ordinal()]) == 1 || i12 == 2 || i12 == 3) ? false : true;
    }
