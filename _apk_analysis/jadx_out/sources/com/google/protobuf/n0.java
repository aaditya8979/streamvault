...
public final class n0 {
    ...
    private static final q0<?, ?> UNKNOWN_FIELD_SET_FULL_SCHEMA = getUnknownFieldSetSchema();
    private static final q0<?, ?> UNKNOWN_FIELD_SET_LITE_SCHEMA = new r0();
    ...
    public static int computeSizeGroupList(int i10, List<MessageLite> list, l0 l0Var) {
        int size = list.size();
        if (size == 0) {
            return 0;
        }
        int iComputeGroupSize = 0;
        for (int i11 = 0; i11 < size; i11++) {
            iComputeGroupSize += CodedOutputStream.computeGroupSize(i10, list.get(i11), l0Var);
        }
        return iComputeGroupSize;
    }
    ...
    public static int computeSizeInt64ListNoTag(List<Long> list) {
        ...
        if (list instanceof s) {
            ...
            while (i10 < size) {
                iComputeInt64SizeNoTag += CodedOutputStream.computeInt64SizeNoTag(sVar.getLong(i10));
                i10++;
            }
        } else {
            iComputeInt64SizeNoTag = 0;
    ...
    public static int computeSizeMessage(int i10, Object obj, l0 l0Var) {
        return obj instanceof LazyFieldLite ? CodedOutputStream.computeLazyFieldSize(i10, (LazyFieldLite) obj) : CodedOutputStream.computeMessageSize(i10, (MessageLite) obj, l0Var);
    }
    ...
    public static int computeSizeMessageList(int i10, List<?> list, l0 l0Var) {
        int size = list.size();
        if (size == 0) {
            return 0;
        }
        ...
        for (int i11 = 0; i11 < size; i11++) {
            Object obj = list.get(i11);
            iComputeTagSize += obj instanceof LazyFieldLite ? CodedOutputStream.computeLazyFieldSizeNoTag((LazyFieldLite) obj) : CodedOutputStream.computeMessageSizeNoTag((MessageLite) obj, l0Var);
        }
        return iComputeTagSize;
    }
    ...
    public static int computeSizeSInt64ListNoTag(List<Long> list) {
        ...
        if (list instanceof s) {
            ...
            while (i10 < size) {
                iComputeSInt64SizeNoTag += CodedOutputStream.computeSInt64SizeNoTag(sVar.getLong(i10));
                i10++;
            }
        } else {
            iComputeSInt64SizeNoTag = 0;
    ...
    public static int computeSizeUInt64ListNoTag(List<Long> list) {
        ...
        if (list instanceof s) {
            ...
            while (i10 < size) {
                iComputeUInt64SizeNoTag += CodedOutputStream.computeUInt64SizeNoTag(sVar.getLong(i10));
                i10++;
            }
        } else {
            iComputeUInt64SizeNoTag = 0;
    ...
    public static <UT, UB> UB filterUnknownEnumList(Object obj, int i10, List<Integer> list, Internal.EnumLiteMap<?> enumLiteMap, UB ub2, q0<UT, UB> q0Var) {
        if (enumLiteMap == null) {
            return ub2;
        }
        if (list instanceof RandomAccess) {
            ...
            for (int i12 = 0; i12 < size; i12++) {
                ...
                if (enumLiteMap.findValueByNumber(iIntValue) != null) {
                    ...
                    ub2 = (UB) storeUnknownEnum(obj, i10, iIntValue, ub2, q0Var);
                }
            }
            if (i11 != size) {
            ...
            while (it.hasNext()) {
                ...
                if (enumLiteMap.findValueByNumber(iIntValue2) == null) {
                    ub2 = (UB) storeUnknownEnum(obj, i10, iIntValue2, ub2, q0Var);
                    it.remove();
                }
            }
        }
    ...
    public static <UT, UB> UB filterUnknownEnumList(Object obj, int i10, List<Integer> list, Internal.EnumVerifier enumVerifier, UB ub2, q0<UT, UB> q0Var) {
    ...
    public static Object getMapDefaultEntry(Class<?> cls, String str) {
        try {
            ...
            if (declaredFields.length == 1) {
                return s0.getStaticObject(declaredFields[0]);
            }
    ...
    private static q0<?, ?> getUnknownFieldSetSchema() {
        try {
            Class<?> unknownFieldSetSchemaClass = getUnknownFieldSetSchemaClass();
            if (unknownFieldSetSchemaClass == null) {
                return null;
            }
            return (q0) unknownFieldSetSchemaClass.getConstructor(new Class[0]).newInstance(new Object[0]);
        } catch (Throwable unused) {
            return null;
        }
    }
    ...
    public static <T, FT extends FieldSet.FieldDescriptorLite<FT>> void mergeExtensions(j<FT> jVar, T t10, T t11) {
        FieldSet<T> extensions = jVar.getExtensions(t11);
    ...
    public static <T> void mergeMap(u uVar, T t10, T t11, long j10) {
        s0.putObject(t10, j10, uVar.mergeFrom(s0.getObject(t10, j10), s0.getObject(t11, j10)));
    }

    public static <T, UT, UB> void mergeUnknownFields(q0<UT, UB> q0Var, T t10, T t11) {
        q0Var.setToMessage(t10, q0Var.merge(q0Var.getFromMessage(t10), q0Var.getFromMessage(t11)));
    }
    ...
    public static <UT, UB> UB storeUnknownEnum(Object obj, int i10, int i11, UB ub2, q0<UT, UB> q0Var) {
        if (ub2 == null) {
            ub2 = q0Var.getBuilderFromMessage(obj);
        }
        q0Var.addVarint(ub2, i10, i11);
        return ub2;
    }
    ...
    public static q0<?, ?> unknownFieldSetFullSchema() {
        return UNKNOWN_FIELD_SET_FULL_SCHEMA;
    }

    public static q0<?, ?> unknownFieldSetLiteSchema() {
    ...
    public static void writeGroupList(int i10, List<?> list, Writer writer, l0 l0Var) throws IOException {
        if (list == null || list.isEmpty()) {
            return;
        }
        writer.writeGroupList(i10, list, l0Var);
    }
    ...
    public static void writeMessageList(int i10, List<?> list, Writer writer, l0 l0Var) throws IOException {
        if (list == null || list.isEmpty()) {
            return;
        }
        writer.writeMessageList(i10, list, l0Var);
    }
