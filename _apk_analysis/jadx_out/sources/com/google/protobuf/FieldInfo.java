...
public final class FieldInfo implements Comparable<FieldInfo> {
    ...
    public static FieldInfo forOneofMemberField(int i10, FieldType fieldType, f0 f0Var, Class<?> cls, boolean z10, Internal.EnumVerifier enumVerifier) {
        checkFieldNumber(i10);
        Internal.checkNotNull(fieldType, "fieldType");
        Internal.checkNotNull(f0Var, "oneof");
        Internal.checkNotNull(cls, "oneofStoredType");
        if (fieldType.isScalar()) {
            return new FieldInfo(null, i10, fieldType, null, null, 0, false, z10, f0Var, cls, null, enumVerifier, null);
        }
