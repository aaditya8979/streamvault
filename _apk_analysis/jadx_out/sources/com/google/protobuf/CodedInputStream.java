...
public abstract class CodedInputStream {
    ...
    public static final class c extends CodedInputStream {
        ...
        private void tryGetNextByteBuffer() {
            ...
            long jAddressOffset = s0.addressOffset(this.currentByteBuffer);
        ...
        public int readRawLittleEndian32() throws IOException {
            ...
            return ((s0.getByte(j10 + 3) & 255) << 24) | (s0.getByte(j10) & 255) | ((s0.getByte(1 + j10) & 255) << 8) | ((s0.getByte(2 + j10) & 255) << 16);
        }
        ...
        public long readRawLittleEndian64() throws IOException {
            ...
            if (currentRemaining() >= 8) {
                ...
                rawByte = (((long) s0.getByte(j10)) & 255) | ((((long) s0.getByte(1 + j10)) & 255) << 8) | ((((long) s0.getByte(2 + j10)) & 255) << 16) | ((((long) s0.getByte(3 + j10)) & 255) << 24) | ((((long) s0.getByte(4 + j10)) & 255) << 32) | ((((long) s0.getByte(5 + j10)) & 255) << 40) | ((((long) s0.getByte(6 + j10)) & 255) << 48);
                rawByte2 = s0.getByte(j10 + 7);
            } else {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:33:0x0088, code lost:
            ...
            if (com.google.protobuf.s0.getByte(r4) < 0) goto L34;
         */
        @Override // com.google.protobuf.CodedInputStream
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        ...
        */
        public int readRawVarint32() throws java.io.IOException {
            ...
            La:
                r2 = 1
                long r4 = r0 + r2
                byte r0 = com.google.protobuf.s0.getByte(r0)
                if (r0 < 0) goto L1a
            ...
            L26:
                long r6 = r4 + r2
                byte r1 = com.google.protobuf.s0.getByte(r4)
                int r1 = r1 << 7
                r0 = r0 ^ r1
                if (r0 >= 0) goto L34
                r0 = r0 ^ (-128(0xffffffffffffff80, float:NaN))
            ...
            L34:
                long r4 = r6 + r2
                byte r1 = com.google.protobuf.s0.getByte(r6)
                int r1 = r1 << 14
                r0 = r0 ^ r1
                if (r0 < 0) goto L43
                r0 = r0 ^ 16256(0x3f80, float:2.278E-41)
                    ...
                    if (i11 >= 0) {
                        ...
                        if (i12 >= 0) {
                            ...
                            if (i13 < 0) {
                                ...
                                j16 = j15 + 1;
                                long j17 = ((long) i13) ^ (((long) s0.getByte(j15)) << 28);
                                if (j17 < 0) {
                                    long j18 = j16 + 1;
                                    long j19 = j17 ^ (((long) s0.getByte(j16)) << 35);
                                    if (j19 < 0) {
                                        j11 = -34093383808L;
                                    } else {
                                        j16 = j18 + 1;
                                        j17 = j19 ^ (((long) s0.getByte(j18)) << 42);
                                        if (j17 >= 0) {
                                            j12 = 4363953127296L;
                                        } else {
                                            j18 = j16 + 1;
                                            j19 = j17 ^ (((long) s0.getByte(j16)) << 49);
                                            if (j19 >= 0) {
                                                j16 = j18 + 1;
                                                j10 = (j19 ^ (((long) s0.getByte(j18)) << 56)) ^ 71499008037633920L;
                                                if (j10 < 0) {
                                                    long j20 = 1 + j16;
                                                    if (s0.getByte(j16) >= 0) {
                                                        j15 = j20;
    ...
    public static final class e extends CodedInputStream {
        ...
        public long readRawLittleEndian64() throws IOException {
            ...
            this.pos = 8 + j10;
            return ((((long) s0.getByte(j10 + 7)) & 255) << 56) | (((long) s0.getByte(j10)) & 255) | ((((long) s0.getByte(1 + j10)) & 255) << 8) | ((((long) s0.getByte(2 + j10)) & 255) << 16) | ((((long) s0.getByte(3 + j10)) & 255) << 24) | ((((long) s0.getByte(4 + j10)) & 255) << 32) | ((((long) s0.getByte(5 + j10)) & 255) << 40) | ((((long) s0.getByte(6 + j10)) & 255) << 48);
        }
    ...
    public static CodedInputStream newInstance(Iterable<ByteBuffer> iterable) {
        return !e.isSupported() ? newInstance(new p(iterable)) : newInstance(iterable, false);
    }
    ...
    public static CodedInputStream newInstance(Iterable<ByteBuffer> iterable, boolean z10) {
        ...
        return i10 == 2 ? new c(iterable, iRemaining, z10) : newInstance(new p(iterable));
    }
