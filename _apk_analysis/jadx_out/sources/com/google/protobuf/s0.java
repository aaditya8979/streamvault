...
public final class s0 {
    ...
    public static abstract class e {
        ...
        public boolean supportsUnsafeByteBufferOperations() {
            ...
            try {
                ...
                return s0.bufferAddressField() != null;
            } catch (Throwable th2) {
                s0.logMissingMethod(th2);
                return false;
            }
    ...
    private static int firstDifferingByteIndexNativeEndian(long j10, long j11) {
        return (IS_BIG_ENDIAN ? Long.numberOfLeadingZeros(j10 ^ j11) : Long.numberOfTrailingZeros(j10 ^ j11)) >> 3;
    }
    ...
    public static void logMissingMethod(Throwable th2) {
        Logger.getLogger(s0.class.getName()).log(Level.WARNING, "platform method missing - proto runtime falling back to safer methods: " + th2);
    }
