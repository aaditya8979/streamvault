...
public class JsonWriter implements Closeable, Flushable {
    ...
    private JsonWriter close(int i10, int i11, String str) throws IOException {
        int iPeek = peek();
    ...
    private JsonWriter open(int i10, String str) throws IOException {
        beforeValue();
        push(i10);
        this.out.write(str);
        return this;
    ...
    */
    ...
    public JsonWriter beginArray() throws IOException {
        writeDeferredName();
        return open(1, C3978d4.j.f31383d);
    }

    public JsonWriter beginObject() throws IOException {
        writeDeferredName();
        return open(3, h.f52301d);
    }
    ...
    public JsonWriter endArray() throws IOException {
        return close(1, 2, C3978d4.j.f31385e);
    }

    public JsonWriter endObject() throws IOException {
        return close(3, 5, h.f52302e);
    }
    ...
    public JsonWriter value(Boolean bool) throws IOException {
        ...
        writeDeferredName();
        beforeValue();
        this.out.write(bool.booleanValue() ? "true" : a.f32683h);
        return this;
    }
    ...
    public JsonWriter value(boolean z10) throws IOException {
        writeDeferredName();
        beforeValue();
        this.out.write(z10 ? "true" : a.f32683h);
        return this;
    }
}
