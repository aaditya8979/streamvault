...
public enum AdErrorType {
    ...
    NETWORK_ERROR(1000, A00(C4169ne.f33110f, 13, 38), true),
    ...
    AD_PRESENTATION_ERROR(AdError.AD_PRESENTATION_ERROR_CODE, A00(TextFieldImplKt.AnimationDuration, 25, 73), true),
    ...
    PARSER_FAILURE(InterfaceC3934ae.a.f30965b, A00(IronSourceError.ERROR_DO_RV_CALL_LOAD_BEFORE_SHOW, 50, 83), false),
    UNKNOWN_RESPONSE(InterfaceC3934ae.a.f30966c, A00(2343, 47, 20), false),
    ERROR_MESSAGE(InterfaceC3934ae.a.f30970g, A00(575, 48, 29), true),
    ...
    NATIVE_AD_IS_NOT_LOADED(AdError.NATIVE_AD_IS_NOT_LOADED, A00(HideBottomViewOnScrollBehavior.EXIT_ANIMATION_DURATION, 86, 93), true),
