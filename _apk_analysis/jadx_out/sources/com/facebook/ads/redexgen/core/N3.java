...
public final class N3 implements Serializable {
    ...
    public static void A06(N3 n32, C2529dL c2529dL) {
        if (n32 == null || !n32.A09()) {
            return;
        }
        new UY(c2529dL).A04(true, n32.A01(), n32.A03(), n32.A02(), System.currentTimeMillis(), n32.A08());
    }

    public static void A07(N3 n32, C2529dL c2529dL) {
        if (n32 == null || !n32.A0A()) {
            return;
        }
        new UY(c2529dL).A04(false, n32.A01(), n32.A03(), n32.A02(), System.currentTimeMillis(), n32.A08());
    }
