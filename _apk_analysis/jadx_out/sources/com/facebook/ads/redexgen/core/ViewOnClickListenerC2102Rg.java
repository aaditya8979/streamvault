...
public class ViewOnClickListenerC2102Rg implements View.OnClickListener, View.OnLongClickListener, View.OnTouchListener, SM {
    ...
    public final C2529dL A00;
    public final /* synthetic */ C2072Qc A01;

    static {
        A02();
    }

    public ViewOnClickListenerC2102Rg(C2072Qc c2072Qc, C2529dL c2529dL) {
        this.A01 = c2072Qc;
        this.A00 = c2529dL;
    }

    public /* synthetic */ ViewOnClickListenerC2102Rg(C2072Qc c2072Qc, C2529dL c2529dL, TB tb2) {
        this(c2072Qc, c2529dL);
    }
    ...
    private Map<String, String> A01() {
        Map<String, String> mapA05 = new C2314Zp().A03(this.A01.A0R).A02(this.A01.A0f).A05();
    ...
    public static void A02() {
        A02 = new byte[]{101, 64, 4, 71, 69, 74, 74, 75, 80, 4, 70, 65, 4, 71, 72, 77, 71, 79, 65, 64, 4, 70, 65, 66, 75, 86, 65, 4, 77, 80, 4, 77, 87, 4, 82, 77, 65, 83, 65, 64, 10, ExifInterface.START_CODE, 5, 0, 10, 2, 26, 73, 1, 8, 25, 25, 12, 7, 12, 13, 73, 29, 6, 6, 73, 15, 8, 26, 29, 71, 13, 9, 10, 62, 47, 34, 46, 37, 40, 46, 5, 46, 63, 60, 36, 57, 32, 24, 57, 118, 34, 57, 35, 53, 62, 118, 50, 55, 34, 55, 118, 36, 51, 53, 57, 36, 50, 51, 50, 122, 118, 38, 58, 51, 55, 37, 51, 118, 51, 56, 37, 35, 36, 51, 118, 34, 57, 35, 53, 62, 118, 51, 32, 51, 56, 34, 37, 118, 36, 51, 55, 53, 62, 118, 34, 62, 51, 118, 55, 50, 118, 0, 63, 51, 33, 118, 52, 47, 118, 36, 51, 34, 35, 36, 56, 63, 56, 49, 118, 48, 55, 58, 37, 51, 118, 63, 48, 118, 47, 57, 35, 118, 63, 56, 34, 51, 36, 53, 51, 38, 34, 118, 34, 62, 51, 118, 51, 32, 51, 56, 34, 120, 13, 11, 16, 120, 98, 127};
    }

    private void A03(Map<String, String> map) {
    ...
    public final void onClick(View view) throws Throwable {
        ...
        try {
            ...
            int iA0K = U7.A0K(this.A01.A0c);
            if (iA0K >= 0 && this.A01.A0f.A03() < iA0K) {
                if (this.A01.A0f.A07()) {
