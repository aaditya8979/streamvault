...
public final class C2519dA {
    ...
    public final C1980Ml A0Z;
    public final C1990Mw A0a;
    public final N0 A0b;
    public final N9 A0c;
    public final C2529dL A0d;
    public final C2172Ua A0e;
    ...
    public final int A0V = (int) AbstractC2232Wl.A02;

    static {
        A0M();
    }

    public C2519dA(final C2529dL c2529dL, AbstractC2804hy abstractC2804hy, InterfaceC2260Xn interfaceC2260Xn, KE ke2, Handler handler, C2172Ua c2172Ua) {
        this.A0d = c2529dL;
        this.A0Y = abstractC2804hy;
        this.A0e = c2172Ua;
        this.A0c = abstractC2804hy.A23();
        this.A0b = abstractC2804hy.A20().A0K();
        this.A0f = interfaceC2260Xn;
        this.A0W = handler;
        this.A0a = abstractC2804hy.A20().A0I();
        this.A0Z = abstractC2804hy.A1z();
        this.A0g = ke2;
        this.A0R = new C15766g(c2529dL) { // from class: com.facebook.ads.redexgen.X.0c
            @Override // com.facebook.ads.redexgen.core.C15766g, android.view.ViewGroup
        ...
        this.A0P = new RelativeLayout(c2529dL);
        this.A0S = new C2343aK(c2529dL);
        this.A0Q = new TextView(c2529dL);
        this.A0M = new ImageView(c2529dL);
    ...
    private FrameLayout.LayoutParams A01() {
        if (this.A0d.getResources().getConfiguration().orientation == 2) {
            ...
            layoutParams.setMargins(0, this.A0L, 0, this.A0C);
            return layoutParams;
        }
        FrameLayout.LayoutParams layoutParams2 = new FrameLayout.LayoutParams(-1, this.A0T ? this.A0I : this.A0J);
        layoutParams2.setMargins(0, this.A0K, 0, 0);
    ...
    private ImageView A03() {
        Bitmap bitmapCreateScaledBitmap = Bitmap.createScaledBitmap(XY.A01(XX.OTHER_SKIP), this.A0C, this.A0C, true);
    ...
    private LinearLayout.LayoutParams A04() {
        ...
        layoutParams.setMargins(this.A0B, i12, this.A0B, 0);
        return layoutParams;
    }
    ...
    private LinearLayout A06() {
        ...
        arrayList.add(new C2522dD(this.A0d).A02(new C2332a9(this.A0d, -1, -1, XX.RATINGS)).A04(this.A0a.A0B()).A03(this.A0a.A0A()));
        if (!this.A0a.A08().isEmpty()) {
            try {
                strA08 = AbstractC2241Wu.A01(Integer.parseInt(this.A0a.A08()));
            } catch (NumberFormatException unused) {
                strA08 = this.A0a.A08();
            }
            arrayList.add(new C2522dD(this.A0d).A02(new C2332a9(this.A0d, -1, -1, XX.NUCLEUS_GROUP)).A04(strA08).A03(this.A0a.A09()));
        }
        if (!this.A0a.A05().isEmpty()) {
            arrayList.add(new C2522dD(this.A0d).A02(new C2332a9(this.A0d, -1, -1, XX.DOWNLOAD)).A04(this.A0a.A05()).A03(this.A0a.A06()));
        }
        C1990Mw c1990Mw = this.A0a;
        if (A0j[2].length() == 29) {
            throw new RuntimeException();
        }
        A0j[2] = "3vpsIj";
        if (!c1990Mw.A01().isEmpty()) {
            arrayList.add(new C2522dD(this.A0d).A02(new C2332a9(this.A0d, -1, -1, XX.NUCLEUS_DURATION)).A04(this.A0a.A01()).A03(this.A0a.A0C()));
        }
        if (!this.A0a.A02().isEmpty()) {
            arrayList.add(new C2522dD(this.A0d).A02(new C2332a9(this.A0d, -1, -1, XX.GRID_4)).A04(this.A0a.A02()).A03(this.A0a.A03()));
        }
    ...
    private LinearLayout A07(RelativeLayout relativeLayout, KE ke2) {
        ...
        linearLayout.setId(View.generateViewId());
        C2332a9 c2332a9 = new C2332a9(this.A0d, -1, -1, XX.GOOGLE_PLAY_STORE);
        ...
        c2332a9.setLayoutParams(layoutParams2);
        c2332a9.setAlpha(0.5f);
        linearLayout.addView(c2332a9);
    ...
    private RelativeLayout.LayoutParams A08(LinearLayout linearLayout) {
        int i10 = (linearLayout == null || this.A0T || this.A0d.getResources().getConfiguration().orientation == 2) ? (-this.A01) / 4 : (-this.A01) / 2;
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(this.A01, this.A01);
    ...
    private RelativeLayout.LayoutParams A0B(C2343aK c2343aK) {
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams.addRule(14);
        layoutParams.addRule(3, c2343aK.getId());
    ...
    private RelativeLayout A0C() {
        ...
        LinearLayout.LayoutParams layoutParamsA04 = A04();
        relativeLayout.setClipChildren(false);
        relativeLayout.setLayoutParams(layoutParamsA04);
        relativeLayout.setId(View.generateViewId());
        return relativeLayout;
    }

    private TextView A0D(RelativeLayout relativeLayout, C2343aK c2343aK) {
        TextView textView = new TextView(this.A0d);
        ...
        textView.setLayoutParams(A0B(c2343aK));
        relativeLayout.addView(textView);
        textView.setId(View.generateViewId());
        return textView;
    }

    private C15766g A0E(KE ke2) {
        this.A0R.setLayoutManager(new C2709gI(this.A0d, 0, false));
        this.A0R.setLayoutParams(A01());
        this.A0R.setAdapter(new C1767Ef(this.A0d, this.A0b.A02(), this.A0H, this.A0R, ke2, this.A0d.getResources().getConfiguration().orientation == 2 ? 2 : 4));
        return this.A0R;
    }

    private C2343aK A0G(LinearLayout linearLayout) {
        C2343aK c2343aK = new C2343aK(this.A0d);
        c2343aK.setRadius(30);
        XP.A0K(c2343aK, 0);
        new KZ(c2343aK, this.A0d).A04().A07(this.A0c.A01());
        c2343aK.setLayoutParams(A08(linearLayout));
        c2343aK.setId(View.generateViewId());
        return c2343aK;
    }
    ...
    private void A0I() {
        ...
        Bitmap bitmapCreateScaledBitmap = Bitmap.createScaledBitmap(zA05 ? XY.A01(XX.SKIP_ARROW_APP_INSTALL) : XY.A01(XX.NAV_CROSS), this.A0C, this.A0C, true);
        this.A0M = new ImageView(this.A0d);
        this.A0M.setImageBitmap(bitmapCreateScaledBitmap);
        this.A0M.setColorFilter(-1);
        GradientDrawable gradientDrawable = new GradientDrawable();
        gradientDrawable.setShape(1);
        gradientDrawable.setColor(Color.parseColor(A0H(7, 9, 61)));
        this.A0M.setBackground(gradientDrawable);
        ...
        AbstractC2521dC.A01(this.A0d, this.A0M, this.A0b.A00(), this.A0N);
    }
    ...
    private void A0L() {
        ...
        this.A0h.set(true);
        ((ViewGroup) parent.getParent()).addView(new C2379au(this.A0d, this.A0Y, this.A0e, this.A0W, this.A0f).A0A(this.A0g, this.A0S));
    }
    ...
    private void A0R(RelativeLayout relativeLayout, KE ke2, LinearLayout linearLayout, TextView textView) {
        ...
        ke2.setLayoutParams(layoutParamsA09);
        ke2.A0D();
    ...
    public final FrameLayout A0T() {
        ...
        view.setBackgroundColor(Color.parseColor(A0H(0, 7, 28)));
        this.A0X.addView(view);
        final LinearLayout linearLayoutA05 = A05();
        this.A0P = A0C();
        if (U7.A1C(this.A0d)) {
            this.A0P.setOnClickListener(new ViewOnClickListenerC2516d7(this));
        }
        A0P(this.A0P);
        this.A0O = A06();
        ...
        A0S(new InterfaceC2518d9() { // from class: com.facebook.ads.redexgen.X.Ep
            @Override // com.facebook.ads.redexgen.core.InterfaceC2518d9
            public final void ADV() {
                this.A01.A0Z(linearLayoutA05);
            }
        });
        return this.A0X;
    }
    ...
    public final void A0W(int i10) {
        ...
        C1767Ef c1767Ef = (C1767Ef) this.A0R.getAdapter();
        if (this.A0g != null) {
    ...
    public final /* synthetic */ void A0X(View view) {
        if (this.A0g != null) {
            ...
            if (this.A0Y.A2D() || meA0E == ME.A09 || meA0E == ME.A06) {
                return;
            }
            A0V();
        }
    ...
    public final /* synthetic */ void A0Y(ImageView imageView, InterfaceC2518d9 interfaceC2518d9, C2312Zn c2312Zn) {
        ...
        if (drawable != null && drawable.getIntrinsicWidth() > drawable.getIntrinsicHeight()) {
            ...
            if (this.A0d.getResources().getConfiguration().orientation == 2) {
                ...
                this.A00 = this.A05;
                AbstractC2804hy abstractC2804hy = this.A0Y;
                if (A0j[1].charAt(29) == 'N') {
                    throw new RuntimeException();
                }
                A0j[1] = "S95acxw01Fp1FcMeAJU8kfpwrSO3Cs6T";
                if (abstractC2804hy.A2H()) {
                    this.A00 = this.A05 - this.A0F;
                }
            }
        }
    ...
    public final /* synthetic */ void A0Z(LinearLayout linearLayout) {
        ...
        if (this.A0Y.A2K()) {
            View view = new View(this.A0d);
            view.setOnClickListener(new ViewOnClickListenerC2517d8(this));
            if (this.A0d.getResources().getConfiguration().orientation == 2) {
