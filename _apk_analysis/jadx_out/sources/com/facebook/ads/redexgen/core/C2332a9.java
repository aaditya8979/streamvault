...
public final class C2332a9 extends ImageView {
    public final float A00;
    public final int A01;
    public final int A02;
    public final Bitmap A03;

    public C2332a9(C2529dL c2529dL, int i10, int i11, XX xx) {
        super(c2529dL);
        this.A00 = 1.0f;
        this.A01 = i10;
        this.A02 = i11;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        canvas.drawBitmap(this.A03, new Rect(0, 0, (int) (this.A03.getWidth() * 1.0f), this.A03.getHeight()), new Rect(0, 0, (int) (getWidth() * 1.0f), getHeight()), paint);
    }
}
