...
public abstract class C1F<E> extends A3<E> implements List<E> {
    ...
    public static final C3226pF A02;

    static {
        A07();
        A02 = new C3226pF(null);
    }
    ...
    public int indexOf(E element) {
        ...
        while (it.hasNext()) {
            if (C3220p6.A0C(it.next(), element)) {
                return i10;
            }
            i10++;
        }
    ...
    @Override // com.facebook.ads.redexgen.core.A3, java.util.Collection, java.lang.Iterable, java.util.List
    ...
    public int lastIndexOf(E element) {
        ...
        while (listIterator.hasPrevious()) {
            if (C3220p6.A0C(listIterator.previous(), element)) {
