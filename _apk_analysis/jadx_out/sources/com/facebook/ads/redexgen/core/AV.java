...
public final class AV {
    ...
    private AO A01(boolean z10, C2801hv c2801hv, EnumC2798hq enumC2798hq, String str) throws MediaCodecInitializationException {
        if (A0I(z10, c2801hv) && A0G(str, c2801hv)) {
            synchronized (this) {
                ...
                if (set != null && !set.isEmpty()) {
                    ...
                    AO next = it.next();
                    it.remove();
                    A03().A0A(z10, str, enumC2798hq, next.hashCode());
                    return next;
                }
            }
        }
        try {
            C2796ho c2796hoA05 = A03().A05(z10, str, enumC2798hq);
            AO aoA03 = this.A03.A03(z10, str);
            A03().A06(c2796hoA05, aoA03.hashCode());
            return aoA03;
        } catch (Exception e10) {
    ...
    private void A0A(C2801hv c2801hv) {
        if (this.A02 == null) {
            synchronized (this) {
                if (this.A02 == null) {
                    this.A02 = Boolean.valueOf(c2801hv.A0R);
    ...
    */
    private void A0C(boolean r5, com.facebook.ads.redexgen.core.C2801hv r6, com.facebook.ads.redexgen.core.EnumC2798hq r7, java.lang.String r8, com.facebook.ads.redexgen.core.AO r9) {
        /*
            r4 = this;
        ...
        L9f:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.AV.A0C(boolean, com.facebook.ads.redexgen.X.hv, com.facebook.ads.redexgen.X.hq, java.lang.String, com.facebook.ads.redexgen.X.AO):void");
    }
    ...
    public static boolean A0G(String str, C2801hv c2801hv) {
        return (A0E(str) && c2801hv.A0A) ? false : true;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public boolean A0I(boolean z10, C2801hv c2801hv) {
        if (!c2801hv.A0C || this.A05 == -1 || SystemClock.elapsedRealtime() - this.A05 <= 5000) {
            return A0J(z10, c2801hv);
        }
        return false;
    }

    public static boolean A0J(boolean z10, C2801hv c2801hv) {
        return (z10 && c2801hv.A0M) || (!z10 && c2801hv.A0L);
    }

    public final AO A0K(boolean z10, C2801hv c2801hv, MediaCodecPoolTracker mediaCodecPoolTracker, EnumC2798hq enumC2798hq, String str) throws MediaCodecInitializationException {
        A09(mediaCodecPoolTracker);
        A0A(c2801hv);
        if (!c2801hv.A0J) {
            return A01(z10, c2801hv, enumC2798hq, str);
        }
        AO aoA02 = this.A03.A02(z10, c2801hv, enumC2798hq, str);
        String[] strArr = A07;
    ...
    public final void A0L(boolean z10, C2801hv c2801hv, MediaCodecPoolTracker mediaCodecPoolTracker, EnumC2798hq enumC2798hq, String str, AO ao2) throws Throwable {
        A09(mediaCodecPoolTracker);
        if (c2801hv.A0J) {
            this.A03.A0A(z10, c2801hv, enumC2798hq, str, ao2);
        } else {
            A0C(z10, c2801hv, enumC2798hq, str, ao2);
        }
    }
}
