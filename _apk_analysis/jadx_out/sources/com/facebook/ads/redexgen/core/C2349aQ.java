...
public final class C2349aQ extends LinearLayout {
    ...
    public C2349aQ(C2529dL c2529dL, C1992My c1992My, boolean z10, int i10, int i11, int i12) {
        super(c2529dL);
        setOrientation(1);
    ...
    public C2349aQ(C2529dL c2529dL, C1992My c1992My, boolean z10, boolean z11, boolean z12) {
        int i10 = z11 ? 18 : 22;
        int i11 = z11 ? 14 : 16;
        int i12 = A07;
        this(c2529dL, c1992My, z10, i10, i11, z12 ? i12 / 2 : i12);
    }
    ...
    public final void A03(C1992My c1992My, boolean z10) {
        this.A02.setTextColor(c1992My.A07(z10));
        this.A01.setTextColor(c1992My.A05(z10));
        this.A00.setTextColor(c1992My.A06(z10));
    }
    ...
    public void setCTAClickListener(KE ke2) {
        ViewOnClickListenerC2353aU viewOnClickListenerC2353aUA03 = AbstractC2354aV.A03(ke2, A00(0, 9, 20));
        this.A02.setOnClickListener(viewOnClickListenerC2353aUA03);
        this.A00.setOnClickListener(viewOnClickListenerC2353aUA03);
        this.A01.setOnClickListener(viewOnClickListenerC2353aUA03);
    }
