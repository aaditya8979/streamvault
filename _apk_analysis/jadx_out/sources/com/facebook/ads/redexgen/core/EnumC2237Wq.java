...
public enum EnumC2237Wq {
    ...
    EnumC2237Wq(int i10, NativeAdBase.NativeComponentTag nativeComponentTag) {
        this.A00 = i10;
        this.A01 = nativeComponentTag;
    }

    @Nullable
    public static EnumC2237Wq A00(NativeAdBase.NativeComponentTag nativeComponentTag) {
        for (EnumC2237Wq enumC2237Wq : values()) {
            if (enumC2237Wq.A01 == nativeComponentTag) {
                return enumC2237Wq;
            }
        }
        return null;
    ...
    public static void A03(@Nullable View view, NativeAdBase.NativeComponentTag nativeComponentTag) {
        EnumC2237Wq enumC2237WqA00 = A00(nativeComponentTag);
        if (view == null || enumC2237WqA00 == null) {
            return;
        }
        view.setTag(A02, nativeComponentTag);
    }

    public static void A04(@Nullable View view, @Nullable EnumC2237Wq enumC2237Wq) {
        if (view == null || enumC2237Wq == null) {
            return;
        }
        view.setTag(A02, enumC2237Wq);
    }
