...
public class RP extends AsyncTask<RR, Void, Drawable> {
    ...
    public RP(C2529dL c2529dL, RQ rq2, boolean z10) {
        this.A01 = c2529dL;
        this.A00 = rq2;
        this.A02 = z10;
    }

    public /* synthetic */ RP(C2529dL c2529dL, RQ rq2, boolean z10, C2665fZ c2665fZ) {
        this(c2529dL, rq2, z10);
    }

    private final Drawable A00(RR... rrArr) throws Throwable {
        if (!AbstractC2208Vl.A02(this) && rrArr != null) {
            try {
                if (rrArr.length >= 1) {
                    ...
                    try {
                        ...
                        this.A01.A08().AAy(A01(0, 7, 4), AbstractC2142Sv.A1V, new C2143Sw(th2));
                    }
                    if (bitmapA0O != null) {
                        return C2072Qc.A05(this.A01, bitmapA0O, this.A02, str2);
                    }
                    return null;
                }
            } catch (Throwable th3) {
    ...
    public static String A01(int i10, int i11, int i12) {
        ...
        for (int i13 = 0; i13 < bArrCopyOfRange.length; i13++) {
            int i14 = (bArrCopyOfRange[i13] ^ i12) ^ 36;
            String[] strArr = A04;
