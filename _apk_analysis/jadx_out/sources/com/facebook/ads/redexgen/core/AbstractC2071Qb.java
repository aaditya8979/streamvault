...
public abstract class AbstractC2071Qb {
    ...
    public void A04(int i10, int i11) {
        ...
        if (!this.A05 || this.A00 == -1 || c15766g == null) {
            A09();
        }
        this.A04 = false;
        if (this.A01 != null) {
            if (A00(this.A01) == this.A00) {
                A0I(this.A01, c15766g.A0s, this.A06);
                this.A06.A05(c15766g);
                A09();
            } else {
        ...
        if (this.A05) {
            A0H(i10, i11, c15766g.A0s, this.A06);
    ...
    public final void A0D(C15766g c15766g, QO qo2) {
        this.A03 = c15766g;
        this.A02 = qo2;
        if (this.A00 == -1) {
    ...
    public abstract void A0H(int i10, int i11, C2073Qd c2073Qd, QZ qz);

    public abstract void A0I(View view, C2073Qd c2073Qd, QZ qz);
}
