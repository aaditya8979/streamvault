...
public class HV implements InterfaceC2225Wc {
    ...
    public final void ACp() {
        if ((this.A00.A01 instanceof C1914Jx) && this.A00.A01.A1K()) {
            this.A00.A07.AFE(true);
            this.A00.A06.setToolbarActionMode(1);
        } else if ((this.A00.A01 instanceof C1883Is) && this.A00.A01.A1K()) {
            this.A00.A07.AFE(true);
            this.A00.A06.setToolbarActionMode(1);
        } else {
            InterfaceC2476cT interfaceC2476cT = this.A00.A07;
            String[] strArr = A01;
