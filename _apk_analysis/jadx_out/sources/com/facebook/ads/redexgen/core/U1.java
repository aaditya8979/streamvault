...
public final class U1 implements Closeable {
    ...
    public U1(C2163Tr c2163Tr, InterfaceC2171Tz interfaceC2171Tz) throws IOException {
        this.A01 = c2163Tr;
        A05(c2163Tr, interfaceC2171Tz);
        if (this.A02.isEmpty()) {
            A00();
        }
    }
    ...
    private U0 A00() throws IOException {
        int iA00 = (this.A02.isEmpty() ? -1 : this.A02.getLast().A00()) + 1;
        this.A02.add(new U0(iA00, new C2169Tx(new File(this.A01.A05(), A01(iA00)))));
    ...
    public static void A03() {
        A03 = new byte[]{-37, 7, 13, 4, -4, -72, 6, 7, 12, -72, -7, -4, -4, -72, 10, -3, -5, 7, 10, -4, -72, 12, 7, -72, 6, -3, 15, 4, 17, -72, -7, -4, -4, -3, -4, -72, -2, 1, 4, -3, 30, 57, 65, 68, 61, 60, -8, 76, 71, -8, 60, 61, 68, 61, 76, 61, -8, 62, 65, 68, 61, -8, -1, -3, 75, -1, -73, -46, -38, -35, -42, -43, -111, -27, -32, -111, -35, -38, -28, -27, -111, -41, -38, -35, -42, -43, -111, -38, -33, -111, -43, -38, -29, -42, -44, -27, -32, -29, -22, -111, -104, -106, -28, -104, ExifInterface.MARKER_APP1, -4, 4, 7, 0, -1, -69, 15, 10, -69, 7, 10, -4, -1, -69, 1, 4, 7, 0, -69, -62, -64, 14, -62, -57, -69, 14, 6, 4, 11, 11, 4, 9, 2, -69, -4, 7, 7, -69, 11, 13, 0, 17, 4, 10, 16, 14, -69, 1, 4, 7, 0, 14, -69, 16, 9, 15, 4, 7, -69, -64, -1, -37, -4, -5, -70, -16, -4, -5, 1, -10, -12, 2, -4, 2, 0, -83, -5, -18, -6, -14, -15, -83, -13, -10, -7, -14, -83, -10, -5, -83, -7, -4, -12, -12, -10, -5, -12, -83, -15, -10, -1, -14, -16, 1, -4, -1, 6, -57, -83, -78, -15, -71, -83, -6, -10, -5, -83, -10, 0, -83, -78, -15, -43, -24, -26, -14, -11, -25, -55, -20, -17, -24, -42, -24, -12, -8, -24, -15, -26, -24, -93, -28, -17, -11, -24, -28, -25, -4, -93, -26, -17, -14, -10, -24, -25, 47, 72, 69, 72, 73, 81, 72, -6, 64, 67, 70, 63, -6, 67, 72, -6, 70, 73, 65, 65, 67, 72, 65, -6, 62, 67, 76, 63, 61, 78, 73, 76, 83, 20, -6, 1, -1, 77, 1};
    }

    private void A04(int i10, File file) throws IOException {
        C2169Tx c2169Tx = new C2169Tx(file);
        c2169Tx.A05();
        this.A02.addFirst(new U0(i10, c2169Tx));
    }

    private void A05(C2163Tr c2163Tr, InterfaceC2171Tz interfaceC2171Tz) throws IOException {
        File[] fileArrListFiles = c2163Tr.A05().listFiles();
        if (fileArrListFiles == null) {
            throw new IOException(String.format(Locale.US, A02(66, 38, 13), c2163Tr.A05().getCanonicalPath()));
        }
        ...
        for (File file : fileArrListFiles) {
            try {
                ...
                hashSet.add(file);
                interfaceC2171Tz.AHs(String.format(Locale.US, A02(260, 39, 118), file.getCanonicalPath()));
            }
        }
        ...
        if (!zIsEmpty) {
            ...
            while (it.hasNext()) {
                ...
                if (iIntValue < i12) {
                    interfaceC2171Tz.AHs(String.format(Locale.US, A02(166, 61, 41), Integer.valueOf(iIntValue), Integer.valueOf(i12)));
            ...
            while (i10 >= i12) {
                ...
                try {
                    ...
                    interfaceC2171Tz.AHt(String.format(Locale.US, A02(104, 62, 55), file2.getCanonicalPath(), Integer.valueOf(i10)), e10);
        ...
        for (Object obj : hashSet) {
            ...
            if (!file3.delete()) {
                ...
                if (A04[7].charAt(19) != 'm') {
                    ...
                    interfaceC2171Tz.AHs(String.format(locale, A02(40, 26, 116), objArr));
                } else {
                    A04[7] = "xgRJlHLuW2qx7z7dN03x9GIdgxBOKXSD";
                    objArr[0] = canonicalPath;
                    interfaceC2171Tz.AHs(String.format(locale, A02(38, 20, 82), objArr));
                }
            }
        }
    }
    ...
    public final synchronized C2161Tp A0A(int i10, int i11, byte[] bArr, int i12, int[] iArr, int i13) throws IOException {
        if (this.A00) {
            throw new IOException(A02(227, 33, 31));
        }
        for (U0 u02 : this.A02) {
            if (u02.A00() == i10) {
                return new C2161Tp(i10, u02.A02(i11, bArr, i12, iArr, i13));
            }
        }
        return new C2161Tp(-1, new C2160To(EnumC2159Tn.A05, -1, -1, 0));
    }
