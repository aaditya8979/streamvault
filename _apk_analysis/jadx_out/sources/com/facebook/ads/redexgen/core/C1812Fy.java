...
public final class C1812Fy extends FrameLayout implements InterfaceC2261Xo {
    ...
    public int A02;
    public C2331a8 A03;
    public AbstractC1856Hr A04;
    public C2526dI A05;
    public boolean A06;
    public boolean A07;
    public boolean A08;
    public boolean A09;
    public final C2802hw A0A;
    public final R6 A0B;
    public final SF A0C;
    public final C2529dL A0D;
    public final US A0E;
    public final C2172Ua A0F;
    public final XC A0G;
    public final AbstractC2259Xm A0H;
    public final InterfaceC2260Xn A0I;
    public final YY A0J;
    public final ArrayList<C2474cR> A0K;

    static {
        A0G();
        A0N = new RelativeLayout.LayoutParams(-1, -1);
        A0O = (int) (AbstractC2232Wl.A02 * 48.0f);
        A0P = (int) (AbstractC2232Wl.A02 * 64.0f);
    }

    public C1812Fy(C2529dL c2529dL, YY yy, US us2, C2802hw c2802hw, SF sf2, InterfaceC2260Xn interfaceC2260Xn) {
        ...
        this.A0A = c2802hw;
        this.A0C = sf2;
        this.A0I = interfaceC2260Xn;
        this.A0F = new C2172Ua(this.A0A.A1x(0).A25(), this.A0E);
        this.A0G = new XC(this);
        this.A0G.A05(XB.A02);
        this.A05 = new C2526dI(this.A0D, this.A0J, this.A0A.A1A(), interfaceC2260Xn);
        this.A0H = A05();
        if (this.A0A.A1U()) {
    ...
    */
    private int A00() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C1812Fy.A00():int");
    }

    private int A01(int i10) {
        if (this.A0A.A26()) {
            C2802hw c2802hw = this.A0A;
            String[] strArr = A0M;
    ...
    public static /* synthetic */ int A02(C1812Fy c1812Fy, int i10) {
        int i11 = c1812Fy.A01 + i10;
        c1812Fy.A01 = i11;
        return i11;
    }

    private AbstractC2259Xm A05() {
        AbstractC2259Xm fullScreenAdToolbar = !this.A0A.A1U() ? new FullScreenAdToolbar(this.A0D, this.A0I, this.A0F, 2, -1, false) : new C2011Nr(this.A0D, this.A0I, this.A0F, 2);
        fullScreenAdToolbar.setFullscreen(true);
        fullScreenAdToolbar.setToolbarListener(new C1813Fz(this));
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private com.facebook.ads.redexgen.core.AbstractC1856Hr A0A(boolean r33, int r34) {
        /*
            Method dump skipped, instruction units count: 476
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C1812Fy.A0A(boolean, int):com.facebook.ads.redexgen.X.Hr");
    }
    ...
    private void A0D() {
        ...
        C2314Zp c2314ZpA03 = new C2314Zp().A03(this.A04 != null ? this.A04.getAdViewabilityChecker() : null);
        AbstractC1856Hr abstractC1856Hr = this.A04;
        String[] strArr = A0M;
        ...
        us2.AAt(strA25, c2314ZpA03.A02(abstractC1856Hr != null ? this.A04.getTouchDataRecorder() : null).A05());
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A0E() {
        if (this.A0H.getToolbarActionMode() == 8) {
            AbstractC2259Xm abstractC2259Xm = this.A0H;
            String[] strArr = A0M;
            ...
            abstractC2259Xm.setToolbarActionMode(2);
        }
        int i10 = this.A00 - 1;
        if (this.A0A.A27(i10)) {
            AbstractC2804hy abstractC2804hyA1x = this.A0A.A1x(i10);
            AbstractC2259Xm abstractC2259Xm2 = this.A0H;
            String[] strArr3 = A0M;
            ...
            abstractC2259Xm2.setProgressSpinnerInvisible(!abstractC2804hyA1x.A2J());
            abstractC2804hyA1x.A2B(false);
            abstractC2804hyA1x.A20().A0M(-1);
        }
    }
    ...
    private void A0F() {
        this.A0D.A0F().A4o();
        this.A07 = true;
        this.A03 = new C2331a8(this.A0D, this.A0A, this.A0E, this.A0I, this.A0H.getToolbarHeight(), this.A02);
        C2474cR c2474cR = null;
        Iterator<C2474cR> it = this.A0K.iterator();
        while (true) {
            if (!it.hasNext()) {
                break;
            }
            C2474cR next = it.next();
            if (next.A00 == C2474cR.A06) {
                c2474cR = next;
                break;
            }
        }
        if (c2474cR != null) {
            A0L(this.A03, c2474cR);
        } else {
    ...
    public void A0J(float f10) {
        ...
        float f11 = fA01 > 0.0f ? ((this.A0A.A26() ? 0 : this.A01) + f10) / fA01 : 1.0f;
        if (this.A06 && this.A0A.A26()) {
            this.A06 = false;
            this.A0H.setProgressImmediate(0.0f);
        }
        this.A0H.setProgress(100.0f * f11);
        if (f11 < 1.0f || this.A09) {
            return;
        }
    ...
    private void A0L(ViewGroup viewGroup, C2474cR c2474cR) {
        if (c2474cR.A00 != C2474cR.A06 || c2474cR.A03 == null) {
            int i10 = c2474cR.A01;
            String[] strArr = A0M;
            if (strArr[0].length() == strArr[1].length()) {
                throw new RuntimeException();
            ...
            AbstractC2350aR.A00(this.A0D, viewGroup, c2474cR.A03);
        }
        this.A0H.setFullscreen(c2474cR.A05);
        this.A0H.A0A(c2474cR.A02, c2474cR.A04);
    }

    private void A0M(AbstractC2804hy abstractC2804hy) {
        if (this.A0H instanceof FullScreenAdToolbar) {
            if (A0Z(abstractC2804hy) && this.A02 == 2) {
                ((FullScreenAdToolbar) this.A0H).setOnlyPageDetails(abstractC2804hy.A23());
            } else {
                ((FullScreenAdToolbar) this.A0H).setOnlyPageDetails(null);
            }
        }
    ...
    */
    public void A0U(boolean r7) {
        /*
            ...
            if (r0 != 0) goto La5
            boolean r5 = r6.A0Y()
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C1812Fy.A0M
            r0 = 0
            r1 = r2[r0]
            r0 = 1
            r0 = r2[r0]
        ...
        Lad:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C1812Fy.A0U(boolean):void");
    }
    ...
    public void A0V(boolean z10, int i10) {
        ...
        if (A0W()) {
            ...
            AbstractC2804hy abstractC2804hyA1x = this.A0A.A1x(this.A00);
            String[] strArr = A0M;
            if (strArr[6].length() != strArr[3].length()) {
                String[] strArr2 = A0M;
                strArr2[0] = "SeXhCWKDArfU2xbUHE";
                strArr2[1] = "icHjaKCGoPIgSTYVXjnx";
                if (!sjA01.AAD(abstractC2804hyA1x.A25(), this.A0A.A1y())) {
                    this.A0D.A0F().A4m();
                    A0K(2);
                    return;
                }
                AbstractC1856Hr abstractC1856HrA0A = A0A(z10, i10);
                this.A04 = abstractC1856HrA0A;
                this.A04.A1F(this.A09);
                setupToolbarForAd(abstractC1856HrA0A);
            ...
            if (strArr3[6].length() != strArr3[3].length()) {
                String[] strArr4 = A0M;
                strArr4[5] = "b6hirdpqFqEpTGRF7TvzfLNB23PEQW";
                strArr4[7] = "Y5Eb3FssofDa3ImZpKtnPvm2BrdUNN";
                return;
            }
        }
        throw new RuntimeException();
    ...
    public static boolean A0Z(AbstractC2804hy abstractC2804hy) {
        return TextUtils.isEmpty(abstractC2804hy.A20().A0H().A09());
    }

    private void setupToolbarForAd(AbstractC1856Hr abstractC1856Hr) {
        if (this.A0H == null) {
            return;
        }
        this.A06 = true;
        ...
        if (this.A0H instanceof FullScreenAdToolbar) {
            ((FullScreenAdToolbar) this.A0H).A0D(this.A0D, abstractC2804hyA1x.A1t());
            ((FullScreenAdToolbar) this.A0H).A0C(abstractC2804hyA1x.A23(), abstractC2804hyA1x.A25(), iA01);
        } else if (this.A0H instanceof C2011Nr) {
            ((C2011Nr) this.A0H).setInitialUnskippableSeconds(iA01);
        }
        C2474cR fullScreenAdStyle = abstractC1856Hr.getFullScreenAdStyle();
        A0L(abstractC1856Hr, fullScreenAdStyle);
        this.A0K.add(fullScreenAdStyle);
        this.A0H.setToolbarActionMessage(A0B(4, 3, 90) + (this.A00 + 1) + A0B(0, 4, 21) + this.A0A.A1u());
        if (this.A08) {
            this.A0H.setToolbarActionMode(1);
        }
        A0M(abstractC2804hyA1x);
    }
    ...
    public AbstractC1856Hr getContentView() {
        return this.A04;
    }
