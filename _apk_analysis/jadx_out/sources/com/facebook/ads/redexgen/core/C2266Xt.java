...
public final class C2266Xt extends AdNativeComponentView {
    ...
    public final C2189Ur A06;
    public final C1943La A07;
    ...
    public static final int A09 = ((int) AbstractC2232Wl.A02) * 500;
    public static final int A0H = (int) (AbstractC2232Wl.A02 * 500.0f);
    public static final int A0D = (int) (AbstractC2232Wl.A02 * 4.0f);
    public static final int A0B = (int) (AbstractC2232Wl.A02 * 8.0f);
    public static final int A0G = (int) (AbstractC2232Wl.A02 * 8.0f);
    public static final int A0E = (int) (AbstractC2232Wl.A02 * 4.0f);
    public static final int A0C = (int) AbstractC2232Wl.A02;
    public static final int A0F = (int) (AbstractC2232Wl.A02 * 4.0f);
    public static final int A0A = (int) (((double) AbstractC2232Wl.A02) * 0.5d);

    public C2266Xt(C2529dL c2529dL, C2189Ur c2189Ur) {
        super(c2529dL);
        this.A06 = c2189Ur;
        this.A05 = new TextView(c2529dL);
        this.A04 = new TextView(c2529dL);
        this.A03 = new TextView(c2529dL);
        this.A02 = new RelativeLayout(c2529dL);
        this.A00 = new LinearLayout(c2529dL);
        this.A01 = new RelativeLayout(c2529dL);
        this.A07 = new C1943La(c2529dL);
        A09();
        A0D();
        A05();
        A0A();
    ...
    private void A0B() {
        ...
        EnumC2237Wq.A04(this.A07, EnumC2237Wq.A0B);
        XP.A0I(this.A07);
    }
    ...
    public final void onMeasure(int i10, int i11) {
        if (View.MeasureSpec.getSize(i11) >= ((int) AbstractC2232Wl.A02) * U7.A0F(getContext()) || View.MeasureSpec.getMode(i11) == 0) {
            A01();
            A07();
        } else {
            A02();
