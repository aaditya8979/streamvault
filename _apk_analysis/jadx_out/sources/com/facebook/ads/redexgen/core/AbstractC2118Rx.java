...
public abstract class AbstractC2118Rx {
    ...
    static {
        A05();
        A03 = C2111Rp.class.getSimpleName();
    ...
    */
    public static com.facebook.ads.redexgen.core.C2111Rp A00(com.facebook.ads.redexgen.core.SQ r5) {
        /*
            ...
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.AbstractC2118Rx.A02
            r0 = 5
            r1 = r1[r0]
            r0 = 3
            ...
            throw r0
        L2c:
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.AbstractC2118Rx.A02
        ...
        L4a:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.AbstractC2118Rx.A00(com.facebook.ads.redexgen.X.SQ):com.facebook.ads.redexgen.X.Rp");
    }

    public static C2111Rp A01(SQ sq2) {
        SU suA8p = sq2.A05().A8p();
        if (suA8p != null) {
            return new C2111Rp(suA8p.getId(), suA8p.AAO(), EnumC2110Ro.A02);
        }
        return null;
    }

    public static C2111Rp A02(SQ sq2) {
        Object objA00;
        Method methodA02;
        Object objA002;
        Method methodA022 = AbstractC2119Ry.A02(A00, A04(257, 29, 2), Context.class);
        if (methodA022 == null || (objA00 = AbstractC2119Ry.A00(null, methodA022, sq2)) == null || ((Integer) objA00).intValue() != 0 || (methodA02 = AbstractC2119Ry.A02(A04(65, 57, 83), A04(232, 20, 98), Context.class)) == null || (objA002 = AbstractC2119Ry.A00(null, methodA02, sq2)) == null) {
            return null;
        }
        Method methodA01 = AbstractC2119Ry.A01(objA002.getClass(), A04(252, 5, 124), new Class[0]);
        Method methodA012 = AbstractC2119Ry.A01(objA002.getClass(), A04(286, 24, 126), new Class[0]);
        if (methodA01 == null || methodA012 == null) {
            return null;
        }
        String str = (String) AbstractC2119Ry.A00(objA002, methodA01, new Object[0]);
        Boolean bool = (Boolean) AbstractC2119Ry.A00(objA002, methodA012, new Object[0]);
        if (str != null) {
            return new C2111Rp(str, bool != null && bool.booleanValue(), EnumC2110Ro.A06);
        }
        return null;
    }

    /* JADX WARN: Type inference failed for: r0v9, types: [com.facebook.ads.internal.attribution.GmsAttributionProvider$GoogleAdInfo] */
    public static C2111Rp A03(SQ sq2) {
        ServiceConnectionC2117Rw serviceConnectionC2117Rw = new ServiceConnectionC2117Rw();
        Intent intent = new Intent(A04(122, 51, 31));
        intent.setPackage(A04(43, 22, 97));
        if (sq2.bindService(intent, serviceConnectionC2117Rw, 1)) {
            try {
                final IBinder iBinderA02 = serviceConnectionC2117Rw.A02();
                ...
                return new C2111Rp(r02.A02(), r02.A03(), EnumC2110Ro.A07);
            } catch (Throwable th2) {
                try {
                    sq2.A08().AAy(A04(225, 7, 73), AbstractC2142Sv.A1Q, new C2143Sw(th2));
                } finally {
                    sq2.unbindService(serviceConnectionC2117Rw);
                }
            }
        }
        return null;
