...
public abstract class KB {
    ...
    static {
        ...
        A04 = Collections.unmodifiableMap(map);
        ...
        A03 = Collections.unmodifiableMap(map2);
    }
    ...
    */
    ...
    public static int A06(List<C1916Jz> list, String str, K7 k72) {
        List<K8> listA0E = A0E(list, str, k72);
        for (int i10 = 0; i10 < listA0E.size(); i10++) {
            C1916Jz c1916Jz = listA0E.get(i10).A01;
            if (c1916Jz.A07() != -1) {
                return c1916Jz.A07();
            }
        }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static android.text.SpannedString A07(java.lang.String r11, java.lang.String r12, java.util.List<com.facebook.ads.redexgen.core.C1916Jz> r13) {
        /*
    ...
    public static C3157o2 A09(CharSequence charSequence) {
        KA ka2 = new KA();
        ka2.A0A = charSequence;
        return ka2.A07().A0H();
    }

    public static K3 A0A(C4J c4j, List<C1916Jz> list) {
    ...
    public static K3 A0B(String str, Matcher matcher, C4J c4j, List<C1916Jz> list) {
        KA ka2 = new KA();
        try {
    ...
    public static String A0D(String str) {
        ...
        return AbstractC15184a.A1P(strTrim, A0C(182, 5, 117))[0];
    }

    public static List<K8> A0E(List<C1916Jz> list, String str, K7 k72) {
        ArrayList arrayList = new ArrayList();
        for (int i10 = 0; i10 < list.size(); i10++) {
            C1916Jz c1916Jz = list.get(i10);
            int iA09 = c1916Jz.A09(str, k72.A01, k72.A03, k72.A02);
            if (iA09 > 0) {
                arrayList.add(new K8(iA09, c1916Jz));
            }
        }
    ...
    public static void A0G(SpannableStringBuilder spannableStringBuilder, C1916Jz c1916Jz, int i10, int i11) {
        ...
        if (c1916Jz.A0R()) {
            C3H.A00(spannableStringBuilder, new ForegroundColorSpan(c1916Jz.A05()), i10, i11, 33);
        }
        if (c1916Jz.A0Q()) {
            C3H.A00(spannableStringBuilder, new BackgroundColorSpan(c1916Jz.A04()), i10, i11, 33);
        }
        if (c1916Jz.A0K() != null) {
            C3H.A00(spannableStringBuilder, new TypefaceSpan(c1916Jz.A0K()), i10, i11, 33);
        }
        switch (c1916Jz.A06()) {
            case 1:
                C3H.A00(spannableStringBuilder, new AbsoluteSizeSpan((int) c1916Jz.A03(), true), i10, i11, 33);
                break;
            case 2:
                C3H.A00(spannableStringBuilder, new RelativeSizeSpan(c1916Jz.A03()), i10, i11, 33);
                break;
            case 3:
                C3H.A00(spannableStringBuilder, new RelativeSizeSpan(c1916Jz.A03() / 100.0f), i10, i11, 33);
                break;
        }
        if (c1916Jz.A0P()) {
            spannableStringBuilder.setSpan(new C3151nw(), i10, i11, 33);
        }
    }

    public static void A0H(SpannableStringBuilder spannableStringBuilder, String str, K7 k72, List<K6> list, List<C1916Jz> list2) {
        ...
        for (int i11 = 0; i11 < arrayList.size(); i11++) {
            if (A0C(TTAdConstant.VIDEO_COVER_URL_CODE, 2, 49).equals(((K6) arrayList.get(i11)).A01.A01)) {
                ...
                spannableStringBuilder.setSpan(new C3150nv(charSequenceSubSequence.toString(), iA00), i10, i12, 33);
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static void A0K(java.lang.String r8, com.facebook.ads.redexgen.core.K7 r9, java.util.List<com.facebook.ads.redexgen.core.K6> r10, android.text.SpannableStringBuilder r11, java.util.List<com.facebook.ads.redexgen.core.C1916Jz> r12) {
        /*
        ...
        while (matcher.find()) {
            ...
            try {
                if (A0C(353, 4, 43).equals(str2)) {
                    ...
                    AnonymousClass44.A07(strA0C, A0C(147, 20, 102) + str2 + A0C(15, 1, 60) + str3);
                }
            } catch (NumberFormatException unused) {
                AnonymousClass44.A07(strA0C, A0C(91, 26, 123) + matcher.group());
            }
        }
    }
    ...
    public static void A0M(String str, KA ka2) {
        ...
        if (iIndexOf != -1) {
            ka2.A03 = A01(str.substring(iIndexOf + 1));
    ...
    public static void A0N(String str, KA ka2) {
        int iIndexOf = str.indexOf(44);
        if (iIndexOf != -1) {
            ka2.A05 = A02(str.substring(iIndexOf + 1));
            str = str.substring(0, iIndexOf);
        }
        ka2.A01 = KC.A00(str);
    }
