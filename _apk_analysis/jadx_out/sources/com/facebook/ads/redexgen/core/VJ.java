...
public final class VJ implements UR {
    ...
    public final C2503cu A06;
    public final UQ A07;
    public final InterfaceC2608ed A08;
    ...
    public VJ(C2503cu c2503cu, UQ uq2) {
        this.A07 = uq2;
        this.A06 = c2503cu;
        this.A04 = (ConnectivityManager) c2503cu.getSystemService(A03(293, 12, 115));
        this.A08 = C2626ev.A01(c2503cu);
        this.A03 = U9.A0K(c2503cu);
        this.A02 = U9.A0J(c2503cu);
    }
    ...
    private void A09(JSONObject jSONObject) throws JSONException {
        for (Map.Entry<String, String> entry : this.A06.A04().A5S().entrySet()) {
    ...
    public final void A0B() {
        try {
            ...
            c2622er.put(A03(315, 7, 6), jSONObjectA5D.toString());
            InterfaceC2607ec interfaceC2607ecAGD = this.A08.AGD(this.A06.A05().A7y(), c2622er.A08());
            String strA6v = interfaceC2607ecAGD != null ? interfaceC2607ecAGD.A6v() : null;
            if (!TextUtils.isEmpty(strA6v) && interfaceC2607ecAGD != null) {
                if (interfaceC2607ecAGD.A94() != 200) {
                    if (this.A06.A05().AAF()) {
                        Log.e(A0F, A03(138, 48, 30) + interfaceC2607ecAGD.A94() + A03(3, 1, 55));
                    }
                    if (interfaceC2607ecAGD.A94() == 413 && U7.A2R(this.A06)) {
                        this.A07.AEr();
                        A05();
                        return;
                    } else {
