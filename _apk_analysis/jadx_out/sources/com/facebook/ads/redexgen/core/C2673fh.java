...
public final class C2673fh extends R8 implements MediaViewApi, Repairable, SM {
    ...
    private void A06() {
        ...
        int iRound = Math.round(4.0f * f10);
        int iRound2 = Math.round(12.0f * f10);
    ...
    private void A07() {
        EnumC2237Wq.A04(this.A03, EnumC2237Wq.A0B);
        EnumC2237Wq.A04(this.A09, EnumC2237Wq.A0B);
        EnumC2237Wq.A04(this.A05, EnumC2237Wq.A0B);
        EnumC2237Wq.A04(this.A01, EnumC2237Wq.A0B);
    }

    public static void A08() {
        A0E = new byte[]{-61, ExifInterface.MARKER_APP1, -14, -17, -11, -13, -27, -20, -96, -14, -27, -18, -28, -27, -14, -27, -14, -96, -19, -11, -13, -12, -96, -30, -27, -96, -13, -27, -12, -96, -30, -27, -26, -17, -14, -27, -96, -18, ExifInterface.MARKER_APP1, -12, -23, -10, -27, -63, -28, -82, 9, 5, 4, 56, 39, 44, 40, 49, 38, 40, 17, 40, 55, 58, 50, 53, 46, -52, -16, -28, -22, -24, -93, -11, -24, -15, -25, -24, -11, -24, -11, -93, -16, -8, -10, -9, -93, -27, -24, -93, -10, -24, -9, -93, -27, -24, -23, -14, -11, -24, -93, -15, -28, -9, -20, -7, -24, -60, -25, -79, -7, 29, 17, 23, 21, -48, 34, 21, 30, 20, 21, 34, 21, 34, -48, 29, 37, 35, 36, -48, 18, 21, -48, 35, 21, 36, -48, 18, 21, 22, 31, 34, 21, -48, 30, 17, 36, 25, 38, 21, -14, 17, 30, 30, 21, 34, -15, 20, -34, -83, -46, -38, -59, -48, -51, -56, -124, -70, -51, -55, -37, -124, -57, -45, -46, -41, -40, -42, ExifInterface.MARKER_EOI, -57, -40, -45, -42, -124, -44, -59, -42, -59, -47, -41, -124, -40, -35, -44, -55, -110, -62, -43, -24, -35, -22, ExifInterface.MARKER_EOI, -108, -75, -40, -108, -67, -41, -29, -30, -108, -35, -25, -108, -30, -23, -32, -32, -94, -26, -7, -12, -11, -1, -80, 2, -11, -2, -12, -11, 2, -11, 2, -80, -3, 5, 3, 4, -80, -14, -11, -80, 3, -11, 4, -80, -14, -11, -10, -1, 2, -11, -80, -2, -15, 4, -7, 6, -11, -47, -12, -66, -41, -26, -33, -70, -58, -60, -123, -67, -72, -70, -68, -71, -58, -58, -62, -123, -72, -69, -54, -123, -59, -72, -53, -64, -51, -68, -123, -70, -61, -64, -70, -62, -68, -69, -15, -28, -33, -32, -22, -48, -19, -25, -72};
    }
    ...
    private void A0A(View view, C2072Qc c2072Qc) {
        if (this.A0B != null) {
            this.A03.removeView(this.A0B);
        }
        if (c2072Qc.A1g()) {
            String strA1D = c2072Qc.A1D();
            if (this.A03.getContext() == null) {
                return;
            }
            this.A0B = AbstractC2504cv.A01(this.A07, strA1D);
            if (this.A0B != null) {
                RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
    ...
    private final void A0C(C2529dL c2529dL, AttributeSet attributeSet, int i10, int i11, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c2529dL, attributeSet, i10, i11));
        A0H(new C2310Zl(c2529dL, attributeSet, i10, i11));
        this.A08 = new C0L(c2529dL, attributeSet, i10);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c2529dL, attributeSet, i10, i11));
        A07();
    }

    private final void A0D(C2529dL c2529dL, AttributeSet attributeSet, int i10, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c2529dL, attributeSet, i10));
        A0H(new C2310Zl(c2529dL, attributeSet, i10));
        this.A08 = new C0L(c2529dL, attributeSet, i10);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c2529dL, attributeSet, i10));
        A07();
    }

    private final void A0E(C2529dL c2529dL, AttributeSet attributeSet, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c2529dL, attributeSet));
        A0H(new C2310Zl(c2529dL, attributeSet));
        this.A08 = new C0L(c2529dL, attributeSet);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c2529dL, attributeSet));
        A07();
    }

    private final void A0F(C2529dL c2529dL, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c2529dL));
        A0H(new C2310Zl(c2529dL));
        this.A08 = new C0L(c2529dL);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c2529dL));
        A07();
    }

    private void A0G(C2072Qc c2072Qc, boolean z10, C2187Up c2187Up) {
        KZ kzA04 = new KZ(this.A02, this.A07).A04();
        if (z10) {
            kzA04.A06(new C2680fo(this, c2072Qc));
        }
        kzA04.A07(c2187Up.getUrl());
    }

    private void A0H(C2310Zl c2310Zl) {
        if (this.A0D) {
        ...
        c2310Zl.setVisibility(8);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
        layoutParams.addRule(13);
        this.A03.addView(c2310Zl, layoutParams);
        this.A09 = c2310Zl;
    }

    private boolean A0I(NativeAd nativeAd) {
        List<NativeAd> listA03 = ((RK) nativeAd.getNativeAdApi()).A03();
        if (listA03 == null) {
            return false;
        }
        Iterator<NativeAd> it = listA03.iterator();
        while (it.hasNext()) {
    ...
    */
    public final void A0L(com.facebook.ads.NativeAd r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2673fh.A0L(com.facebook.ads.NativeAd):void");
    }

    public final void A0M(NativeAdBaseApi nativeAdBaseApi, boolean z10) {
        C2529dL c2529dLA12 = ((C2072Qc) nativeAdBaseApi).A12();
        this.A07.A0L(c2529dLA12);
        c2529dLA12.A0O(this);
        this.A0D = true;
        C2072Qc c2072QcA0L = C2072Qc.A0L(nativeAdBaseApi);
        c2072QcA0L.A1S(this.A03);
        ...
        if (this.A01 != null) {
            ...
            if (this.A01 instanceof C2301Zc) {
                ((C2301Zc) this.A01).A04();
            } else {
                ((C15766g) this.A01).setAdapter(null);
            }
        }
        ...
        if (adIcon != null) {
            ...
            strArr[3] = "8vonm0Gh";
            strArr[7] = "EfYx5Mmt";
            Bitmap bitmapA0N = sfA11.A0N(adIcon.getUrl());
            if (bitmapA0N != null) {
                this.A02.setImageBitmap(bitmapA0N);
                if (z10) {
                    this.A03.post(new C2681fp(this, c2072QcA0L));
                }
            } else {
                A0G(c2072QcA0L, z10, adIcon);
            }
        } else {
            QQ qqA16 = c2072QcA0L.A16();
            AdErrorType adErrorType = AdErrorType.NATIVE_AD_IS_NOT_LOADED;
            c2529dLA12.A0F().A3F(c2072QcA0L.A0y(), adErrorType.getErrorCode(), adErrorType.getDefaultErrorMessage());
            if (qqA16 != null) {
                qqA16.ADB(V1.A00(adErrorType));
            }
            Log.e(A04(46, 17, 121), adErrorType.getDefaultErrorMessage());
            if (nativeAdBaseApi.isAdLoaded()) {
                this.A07.A08().AAy(A04(258, 3, 44), AbstractC2142Sv.A0W, new C2143Sw(A04(192, 23, 42)));
            }
        }
        A0A(this.A02, c2072QcA0L);
    }
    ...
    */
    public final int getMediaWidth() {
        /*
            ...
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C2673fh.A0F
            r0 = 2
            r1 = r2[r0]
            r0 = 0
            r2 = r2[r0]
        ...
        L35:
            ...
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.C2673fh.A0F
            r0 = 1
            r1 = r1[r0]
            r0 = 7
            char r1 = r1.charAt(r0)
        ...
        L7c:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2673fh.getMediaWidth():int");
    }
    ...
    public final void initialize(AdViewConstructorParams adViewConstructorParams, MediaView mediaView) {
        ...
        switch (adViewConstructorParams.getInitializationType()) {
            ...
            case 2:
                ...
                A0D(c2529dL, attributeSet, adViewConstructorParams.getDefStyleAttr(), mediaView);
                break;
                break;
            case 3:
    ...
    @Override // com.facebook.ads.redexgen.core.R8, com.facebook.ads.internal.api.AdComponentViewApi
    ...
    public final void repair(Throwable th2) {
        ...
        this.A03.getLayoutParams().height = height;
    ...
    public final void setListener(MediaViewListener mediaViewListener) {
        ...
        if (mediaViewListener == null) {
            ...
            ((RH) this.A05.getMediaViewVideoRendererApi()).A07(new C2674fi(this, mediaViewListener));
        }
    }
    ...
    public final void setVideoRenderer(MediaViewVideoRenderer mediaViewVideoRenderer) {
        ...
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
        layoutParams.addRule(13);
        ((C2673fh) this.A03.getMediaViewApi()).A09(mediaViewVideoRenderer, layoutParams);
