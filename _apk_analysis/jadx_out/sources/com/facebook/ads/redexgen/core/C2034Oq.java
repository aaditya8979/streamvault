...
public final class C2034Oq {
    ...
    */
    public static void A00(int[] r43, int r44, int r45, int r46, int r47, int r48, int r49) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2034Oq.A00(int[], int, int, int, int, int, int):void");
    }
    ...
    public final Bitmap A02(Bitmap bitmap, float f10) {
        ...
        try {
            ...
            int i10 = AbstractC2247Xa.A00;
            ArrayList arrayList = new ArrayList(i10);
            ArrayList arrayList2 = new ArrayList(i10);
            for (int i11 = 0; i11 < i10; i11++) {
                int i12 = height;
                arrayList.add(new XZ(iArr, width, i12, (int) f10, i10, i11, 1));
                height = i12;
                arrayList2.add(new XZ(iArr, width, height, (int) f10, i10, i11, 2));
            }
            try {
                AbstractC2247Xa.A01.invokeAll(arrayList);
                try {
                    AbstractC2247Xa.A01.invokeAll(arrayList2);
                    try {
