...
public final class C2746gv implements SN {
    public long A00;
    ...
    public C2746gv(C2529dL c2529dL, InterstitialAd interstitialAd, String str) {
        this(c2529dL, interstitialAd, str, new C2761hB());
    }

    public C2746gv(C2529dL c2529dL, InterstitialAd interstitialAd, String str, TL tl2) {
        this.A0A = c2529dL;
        this.A0B = str;
    ...
    public final void A0K(EnumSet<CacheFlag> enumSet) {
        this.A08 = enumSet;
    }
}
