...
public final class RT implements NativeBannerAdViewApi {
    ...
    public static View A00(C2529dL c2529dL, NativeBannerAd nativeBannerAd, NativeBannerAdView.Type type, NativeAdViewAttributes nativeAdViewAttributes) {
        if (nativeAdViewAttributes == null) {
            nativeAdViewAttributes = new NativeAdViewAttributes();
        }
        C2072Qc.A0L(nativeBannerAd.getInternalNativeAd()).A1a(EnumC2190Us.A00(type.getEnumCode()));
        ?? r12 = new C2672fg() { // from class: com.facebook.ads.redexgen.X.6f
            public InterfaceC2530dM A00;

            public final void A06(C2529dL c2529dL2, NativeBannerAd nativeBannerAd2, C2189Ur c2189Ur, NativeAdLayout nativeAdLayout) {
                ...
                c2189Ur.A09(adOptionsView, 20);
                this.A00 = new EQ(c2529dL2, nativeBannerAd2, c2189Ur, C2072Qc.A0L(nativeBannerAd2.getInternalNativeAd()).A18(), mediaView, adOptionsView);
        ...
        NativeAdLayout nativeAdLayout = new NativeAdLayout(c2529dL, (NativeAdLayoutApi) r12);
        r12.A06(c2529dL, nativeBannerAd, (C2189Ur) nativeAdViewAttributes.getInternalAttributes(), nativeAdLayout);
