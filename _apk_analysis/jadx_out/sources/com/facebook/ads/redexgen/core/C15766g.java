...
public class C15766g extends ViewGroup {
    ...
    public C2056Pm A01;
    public C2710gJ A02;
    public RunnableC2069Pz A03;
    public QC A04;
    public QK A05;
    public QO A06;
    public QX A07;
    public RunnableC2075Qf A08;
    public C2693g1 A09;
    public boolean A0A;
    public boolean A0B;
    public boolean A0C;
    ...
    public final QW A0r;
    public final C2073Qd A0s;
    public final C2084Qo A0t;
    public final Runnable A0u;
    public final ArrayList<RecyclerView.ItemDecoration> A0v;
    public final List<AbstractC2076Qg> A0w;
    public final int A0x;
    public final int A0y;
    public final Rect A0z;
    public final AccessibilityManager A10;
    public final C2695g4 A11;
    public final InterfaceC2083Qn A12;
    ...
    public C15766g(Context context) {
        this(context, null);
    }

    public C15766g(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public C15766g(Context context, AttributeSet attributeSet, int i10) {
        super(context, attributeSet, i10);
        this.A11 = new C2695g4(this);
        this.A0r = new QW(this);
        this.A0t = new C2084Qo();
        ...
        this.A0U = 0;
        this.A0N = 0;
        this.A05 = new C15796j();
        this.A0W = 0;
        this.A0V = -1;
        this.A0L = Float.MIN_VALUE;
        this.A0M = Float.MIN_VALUE;
        this.A0o = true;
        this.A08 = new RunnableC2075Qf(this);
        this.A02 = A1E ? new C2710gJ() : null;
        this.A0s = new C2073Qd();
        this.A0G = false;
        this.A0H = false;
        this.A0f = new C2698g7(this);
        this.A0K = false;
        this.A14 = new int[2];
        this.A17 = new int[2];
        this.A16 = new int[2];
        ...
        setAccessibilityDelegateCompat(new C2693g1(this));
    ...
    private final long A0C(AbstractC2076Qg abstractC2076Qg) {
        return this.A04.A0M() ? abstractC2076Qg.A0Q() : abstractC2076Qg.A03;
    }

    private View A0D() {
        AbstractC2076Qg abstractC2076QgA1F;
        ...
        for (int i11 = i10; i11 < iA03; i11++) {
            AbstractC2076Qg abstractC2076QgA1F2 = A1F(i11);
            if (abstractC2076QgA1F2 == null) {
                break;
            }
            if (abstractC2076QgA1F2.A0H.hasFocusable()) {
                return abstractC2076QgA1F2.A0H;
            }
        }
        for (int iMin = Math.min(iA03, i10) - 1; iMin >= 0 && (abstractC2076QgA1F = A1F(iMin)) != null; iMin--) {
            if (abstractC2076QgA1F.A0H.hasFocusable()) {
                return abstractC2076QgA1F.A0H;
            }
        }
        return null;
    }

    private final AbstractC2076Qg A0E(long j10) {
        if (this.A04 == null || !this.A04.A0M()) {
            return null;
        }
        int iA06 = this.A01.A06();
        AbstractC2076Qg abstractC2076Qg = null;
        for (int i10 = 0; i10 < iA06; i10++) {
            AbstractC2076Qg abstractC2076QgA0F = A0F(this.A01.A0A(i10));
            if (abstractC2076QgA0F != null && !abstractC2076QgA0F.A0g() && abstractC2076QgA0F.A0Q() == j10) {
                if (!this.A01.A0K(abstractC2076QgA0F.A0H)) {
                    return abstractC2076QgA0F;
                }
                abstractC2076Qg = abstractC2076QgA0F;
            }
        }
        return abstractC2076Qg;
    }

    public static AbstractC2076Qg A0F(View view) {
        if (view == null) {
            return null;
        }
    ...
    private final AbstractC2076Qg A0G(View view) {
        View viewA1E = A1E(view);
        if (viewA1E == null) {
            return null;
        }
        return A1I(viewA1E);
    ...
    public static C15766g A0H(View view) {
        if (!(view instanceof ViewGroup)) {
            return null;
        }
        if (view instanceof C15766g) {
            return (C15766g) view;
        }
        ViewGroup viewGroup = (ViewGroup) view;
        int childCount = viewGroup.getChildCount();
        for (int i10 = 0; i10 < childCount; i10++) {
            C15766g c15766gA0H = A0H(viewGroup.getChildAt(i10));
            if (c15766gA0H != null) {
                return c15766gA0H;
            }
        }
    ...
    private void A0K() {
        ...
        PM.A01(accessibilityEventObtain, i10);
    ...
    private void A0L() {
        ...
        if (this.A0s.A0C) {
            ...
            for (int i10 = 0; i10 < iA05; i10++) {
                AbstractC2076Qg abstractC2076QgA0F = A0F(this.A01.A09(i10));
                if (!abstractC2076QgA0F.A0l() && (!abstractC2076QgA0F.A0f() || this.A04.A0M())) {
                    this.A0t.A0F(abstractC2076QgA0F, this.A05.A0F(this.A0s, abstractC2076QgA0F, QK.A06(abstractC2076QgA0F), abstractC2076QgA0F.A0R()));
                    if (this.A0s.A0E && abstractC2076QgA0F.A0j() && !abstractC2076QgA0F.A0g() && !abstractC2076QgA0F.A0l() && !abstractC2076QgA0F.A0f()) {
                        this.A0t.A08(A0C(abstractC2076QgA0F), abstractC2076QgA0F);
                    }
                }
            }
        }
        if (this.A0s.A0B) {
            ...
            for (int i11 = 0; i11 < this.A01.A05(); i11++) {
                AbstractC2076Qg abstractC2076QgA0F2 = A0F(this.A01.A09(i11));
                if (!abstractC2076QgA0F2.A0l() && !this.A0t.A0I(abstractC2076QgA0F2)) {
                    int iA06 = QK.A06(abstractC2076QgA0F2);
                    boolean zA0o = abstractC2076QgA0F2.A0o(8192);
                    if (!zA0o) {
                        iA06 |= 4096;
                    }
                    QJ qjA0F = this.A05.A0F(this.A0s, abstractC2076QgA0F2, iA06, abstractC2076QgA0F2.A0R());
                    if (zA0o) {
                        A1k(abstractC2076QgA0F2, qjA0F);
                    } else {
                        this.A0t.A0D(abstractC2076QgA0F2, qjA0F);
                    }
                }
            }
            A0X();
    ...
    private void A0N() {
        ...
        if (this.A0s.A0C) {
            for (int iA05 = this.A01.A05() - 1; iA05 >= 0; iA05--) {
                AbstractC2076Qg abstractC2076QgA0F = A0F(this.A01.A09(iA05));
                if (!abstractC2076QgA0F.A0l()) {
                    long jA0C = A0C(abstractC2076QgA0F);
                    QJ qjA0E = this.A05.A0E(this.A0s, abstractC2076QgA0F);
                    AbstractC2076Qg abstractC2076QgA05 = this.A0t.A05(jA0C);
                    if (abstractC2076QgA05 == null || abstractC2076QgA05.A0l()) {
                        this.A0t.A0E(abstractC2076QgA0F, qjA0E);
                    } else {
                        boolean zA0H = this.A0t.A0H(abstractC2076QgA05);
                        boolean zA0H2 = this.A0t.A0H(abstractC2076QgA0F);
                        if (zA0H && abstractC2076QgA05 == abstractC2076QgA0F) {
                            this.A0t.A0E(abstractC2076QgA0F, qjA0E);
                        } else {
                            QJ qjA04 = this.A0t.A04(abstractC2076QgA05);
                            this.A0t.A0E(abstractC2076QgA0F, qjA0E);
                            QJ qjA03 = this.A0t.A03(abstractC2076QgA0F);
                            if (qjA04 == null) {
                                A0m(jA0C, abstractC2076QgA0F, abstractC2076QgA05);
                            } else {
                                A0t(abstractC2076QgA05, abstractC2076QgA0F, qjA04, qjA03, zA0H, zA0H2);
                            }
                        }
                    }
                }
    ...
    private void A0O() {
        this.A01 = new C2056Pm(new C2700g9(this));
    }
    ...
    */
    private void A0P() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C15766g.A0P():void");
    }
    ...
    private void A0Q() {
        ...
        AbstractC2076Qg abstractC2076QgA0E = null;
        ...
        if (j10 != -1 && this.A04.A0M()) {
            abstractC2076QgA0E = A0E(this.A0s.A08);
        }
        View viewA0D = null;
        if (abstractC2076QgA0E != null && !this.A01.A0K(abstractC2076QgA0E.A0H) && abstractC2076QgA0E.A0H.hasFocusable()) {
            viewA0D = abstractC2076QgA0E.A0H;
        } else if (this.A01.A05() > 0) {
            viewA0D = A0D();
        }
        if (viewA0D != null) {
    ...
    private void A0U() {
        ...
        AbstractC2076Qg abstractC2076QgA0G = focusedChild == null ? null : A0G(focusedChild);
        if (abstractC2076QgA0G == null) {
            A0S();
            return;
        }
        this.A0s.A08 = this.A04.A0M() ? abstractC2076QgA0G.A0Q() : -1L;
        this.A0s.A01 = this.A0C ? -1 : abstractC2076QgA0G.A0g() ? abstractC2076QgA0G.A01 : abstractC2076QgA0G.A0M();
        this.A0s.A02 = A0B(abstractC2076QgA0G.A0H);
    }
    ...
    private final void A0Z() {
        ...
        for (int size = this.A0w.size() - 1; size >= 0; size--) {
            AbstractC2076Qg abstractC2076Qg = this.A0w.get(size);
            if (abstractC2076Qg.A0H.getParent() == this && !abstractC2076Qg.A0l() && (i10 = abstractC2076Qg.A02) != -1) {
                P3.A09(abstractC2076Qg.A0H, i10);
                abstractC2076Qg.A02 = -1;
            }
        }
        this.A0w.clear();
    }
    ...
    private final void A0e() {
        this.A00 = new C2713gM(new C2699g8(this));
    }
    ...
    private final void A0g() {
        int iA06 = this.A01.A06();
        for (int i10 = 0; i10 < iA06; i10++) {
            ((QP) this.A01.A0A(i10).getLayoutParams()).A01 = true;
        }
        this.A0r.A0M();
    }
    ...
    private final void A0h() {
        ...
        for (int i10 = 0; i10 < iA06; i10++) {
            AbstractC2076Qg abstractC2076QgA0F = A0F(this.A01.A0A(i10));
            if (abstractC2076QgA0F != null && !abstractC2076QgA0F.A0l()) {
                abstractC2076QgA0F.A0Z(6);
            }
        }
        A0g();
        this.A0r.A0N();
    ...
    private void A0j(float f10, float f11, float f12, float f13) {
        ...
        if (f11 < 0.0f) {
            A0b();
            AbstractC2047Pd.A00(this.A0a, (-f11) / getWidth(), 1.0f - (f12 / getHeight()));
            z10 = true;
        } else if (f11 > 0.0f) {
            A0c();
            AbstractC2047Pd.A00(this.A0b, f11 / getWidth(), f12 / getHeight());
            z10 = true;
        }
        if (f13 < 0.0f) {
            A0d();
            AbstractC2047Pd.A00(this.A0c, (-f13) / getHeight(), f10 / getWidth());
            z10 = true;
        } else if (f13 > 0.0f) {
            A0a();
            AbstractC2047Pd.A00(this.A0Z, f13 / getHeight(), 1.0f - (f10 / getWidth()));
            z10 = true;
        }
        if (!z10 && f11 == 0.0f) {
            if (A19[7].length() != 1) {
    ...
    private void A0m(long j10, AbstractC2076Qg abstractC2076Qg, AbstractC2076Qg abstractC2076Qg2) {
        int iA05 = this.A01.A05();
        for (int i10 = 0; i10 < iA05; i10++) {
            AbstractC2076Qg abstractC2076QgA0F = A0F(this.A01.A09(i10));
            if (abstractC2076QgA0F != abstractC2076Qg && A0C(abstractC2076QgA0F) == j10) {
                QC qc2 = this.A04;
                String[] strArr = A19;
                if (strArr[0].charAt(14) == strArr[6].charAt(14)) {
                    throw new RuntimeException();
                ...
                if (qc2 != null && this.A04.A0M()) {
                    throw new IllegalStateException(A0I(1696, 130, 15) + abstractC2076QgA0F + strA0I + abstractC2076Qg + A1J());
                }
                throw new IllegalStateException(A0I(1508, 188, 43) + abstractC2076QgA0F + strA0I + abstractC2076Qg + A1J());
            }
        }
        Log.e(A0I(1370, 12, 39), A0I(InterfaceC3934ae.a.f30966c, 111, 51) + abstractC2076Qg2 + A0I(18, 41, 117) + abstractC2076Qg + A1J());
    }
    ...
    public static void A0o(View view, Rect rect) {
        ...
        Rect rect2 = qp2.A03;
        rect.set((view.getLeft() - rect2.left) - qp2.leftMargin, (view.getTop() - rect2.top) - qp2.topMargin, view.getRight() + rect2.right + qp2.rightMargin, view.getBottom() + rect2.bottom + qp2.bottomMargin);
    }
    ...
    private void A0q(QC qc2, boolean z10, boolean z11) {
        if (this.A04 != null) {
        ...
        QO qo2 = this.A06;
        this.A0r.A0U(qc3, this.A04, z10);
        this.A0s.A0D = true;
        A1R();
    }

    private void A0r(AbstractC2076Qg abstractC2076Qg) {
    ...
    public static void A0s(AbstractC2076Qg abstractC2076Qg) {
        if (abstractC2076Qg.A09 != null) {
            C15766g c15766g = abstractC2076Qg.A09.get();
            while (c15766g != null) {
                if (c15766g == abstractC2076Qg.A0H) {
                    return;
                }
                Object parent = c15766g.getParent();
                c15766g = parent instanceof View ? (View) parent : null;
            }
            abstractC2076Qg.A09 = null;
        }
    }

    private void A0t(AbstractC2076Qg abstractC2076Qg, AbstractC2076Qg abstractC2076Qg2, QJ qj2, QJ qj3, boolean z10, boolean z11) {
        ...
        if (abstractC2076Qg != abstractC2076Qg2) {
            if (z11) {
                A0r(abstractC2076Qg2);
            }
            abstractC2076Qg.A06 = abstractC2076Qg2;
            A0r(abstractC2076Qg);
            this.A0r.A0Y(abstractC2076Qg);
            abstractC2076Qg2.A0d(false);
            abstractC2076Qg2.A07 = abstractC2076Qg;
        }
        if (this.A05.A0R(abstractC2076Qg, abstractC2076Qg2, qj2, qj3)) {
            A1O();
        }
    }
    ...
    private void A0x(int[] iArr) {
        ...
        for (int i12 = 0; i12 < iA05; i12++) {
            AbstractC2076Qg abstractC2076QgA0F = A0F(this.A01.A09(i12));
            if (!abstractC2076QgA0F.A0l()) {
                int iA0O = abstractC2076QgA0F.A0O();
                if (iA0O < i10) {
                    i10 = iA0O;
                }
                if (iA0O > i11) {
    ...
    private boolean A0y() {
        ...
        for (int i10 = 0; i10 < iA05; i10++) {
            AbstractC2076Qg abstractC2076QgA0F = A0F(this.A01.A09(i10));
            if (abstractC2076QgA0F != null && !abstractC2076QgA0F.A0l()) {
                boolean zA0j = abstractC2076QgA0F.A0j();
                if (A19[7].length() != 1) {
                    throw new RuntimeException();
                }
    ...
    private final boolean A12(int i10, int i11) {
        ...
        boolean zA23 = this.A06.A23();
        if (!zA22 || Math.abs(i10) < this.A0y) {
            i10 = 0;
        }
        if (!zA23 || Math.abs(i11) < this.A0y) {
            i11 = 0;
        }
        if (i10 == 0 && i11 == 0) {
            return false;
        ...
        if (!dispatchNestedPreFling(f10, i11)) {
            boolean z10 = zA22 || zA23;
            dispatchNestedFling(i10, i11, z10);
            if (this.A0g != null && this.A0g.A0B(i10, i11)) {
                return true;
            }
            if (z10) {
                int i12 = zA22 ? 0 | 1 : 0;
                ...
                A1u(i12, 1);
                this.A08.A09(Math.max(-this.A0x, Math.min(i10, this.A0x)), Math.max(-this.A0x, Math.min(i11, this.A0x)));
                return true;
            }
        }
        return false;
    ...
    private final boolean A13(int i10, int i11, MotionEvent motionEvent) {
        ...
        if (this.A04 != null) {
            ...
            A1j(this.A0s);
            if (i10 != 0) {
                iA1f = this.A06.A1f(i10, this.A0r, this.A0s);
                i12 = i10 - iA1f;
            }
            if (i11 != 0) {
                iA1g = this.A06.A1g(i11, this.A0r, this.A0s);
                i13 = i11 - iA1g;
            }
            OQ.A00();
            A1Q();
        ...
        if (A1v(iA1f, iA1g, i12, i13, this.A17, 0)) {
            this.A0S -= this.A17[0];
            this.A0T -= this.A17[1];
            if (motionEvent != null) {
            ...
            if (motionEvent != null && !AbstractC2027Oj.A00(motionEvent, 8194)) {
                A0j(motionEvent.getX(), i12, motionEvent.getY(), i13);
            }
            A1b(i10, i11);
        }
        if (iA1f != 0 || iA1g != 0) {
    ...
    private boolean A16(View view, View view2, int i10) {
        ...
        if (A17(view, view2, (i10 == 2) ^ (this.A06.A0c() == 1) ? 66 : 17)) {
            return true;
        }
        if (i10 == 2) {
    ...
    private final boolean A18(AccessibilityEvent accessibilityEvent) {
        ...
        int iA00 = accessibilityEvent != null ? PM.A00(accessibilityEvent) : 0;
        if (iA00 == 0) {
            iA00 = 0;
        }
        this.A0P |= iA00;
    ...
    private C2029Ol getScrollingChildHelper() {
        if (this.A0d == null) {
            this.A0d = new C2029Ol(this);
        }
        return this.A0d;
    }

    public final int A1B(View view) {
        AbstractC2076Qg abstractC2076QgA0F = A0F(view);
        if (abstractC2076QgA0F != null) {
            return abstractC2076QgA0F.A0O();
        }
        return -1;
    }

    public final int A1C(AbstractC2076Qg abstractC2076Qg) {
        if (abstractC2076Qg.A0o(IronSourceError.ERROR_PLACEMENT_CAPPED) || !abstractC2076Qg.A0e()) {
            return -1;
        }
        return this.A00.A05(abstractC2076Qg.A03);
    }
    ...
    public final AbstractC2076Qg A1F(int i10) {
        if (this.A0C) {
            return null;
        }
        int iA06 = this.A01.A06();
        ...
        for (int i11 = 0; i11 < iA06; i11++) {
            AbstractC2076Qg abstractC2076QgA0F = A0F(this.A01.A0A(i11));
            if (abstractC2076QgA0F != null && !abstractC2076QgA0F.A0g() && A1C(abstractC2076QgA0F) == i10) {
                if (!this.A01.A0K(abstractC2076QgA0F.A0H)) {
                    return abstractC2076QgA0F;
                }
                abstractC2076Qg = abstractC2076QgA0F;
    ...
    public final AbstractC2076Qg A1G(int i10) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final com.facebook.ads.redexgen.core.AbstractC2076Qg A1H(int r9, boolean r10) {
        /*
            r8 = this;
        ...
        L25:
            int r6 = r3.A0O()
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.C15766g.A19
            r0 = 7
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 1
            ...
            throw r0
        L3b:
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C15766g.A19
        ...
        L57:
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C15766g.A1H(int, boolean):com.facebook.ads.redexgen.X.Qg");
    }

    public final AbstractC2076Qg A1I(View view) {
        ViewParent parent = view.getParent();
    ...
    */
    public final void A1K() {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C15766g.A1K():void");
    }
    ...
    public final void A1Q() {
        int iA05 = this.A01.A05();
        for (int i10 = 0; i10 < iA05; i10++) {
            View viewA09 = this.A01.A09(i10);
            AbstractC2076Qg abstractC2076QgA1I = A1I(viewA09);
            if (abstractC2076QgA1I != null && abstractC2076QgA1I.A07 != null) {
                View view = abstractC2076QgA1I.A07.A0H;
                int left = viewA09.getLeft();
                int top2 = viewA09.getTop();
    ...
    public final void A1b(int i10, int i11) {
        boolean zIsFinished = false;
        if (this.A0a != null && !this.A0a.isFinished() && i10 > 0) {
            this.A0a.onRelease();
            zIsFinished = this.A0a.isFinished();
        }
        if (this.A0b != null && !this.A0b.isFinished() && i10 < 0) {
            this.A0b.onRelease();
            zIsFinished |= this.A0b.isFinished();
        }
        EdgeEffect edgeEffect = this.A0c;
        ...
        if (edgeEffect != null && !this.A0c.isFinished() && i11 > 0) {
            this.A0c.onRelease();
            zIsFinished |= this.A0c.isFinished();
        }
        if (this.A0Z != null && !this.A0Z.isFinished() && i11 < 0) {
            this.A0Z.onRelease();
            zIsFinished |= this.A0Z.isFinished();
        }
        if (zIsFinished) {
    ...
    public final void A1c(int i10, int i11) {
        setMeasuredDimension(QO.A02(i10, getPaddingLeft() + getPaddingRight(), P3.A03(this)), QO.A02(i11, getPaddingTop() + getPaddingBottom(), P3.A02(this)));
    }
    ...
    public final void A1d(int i10, int i11) {
        ...
        if (this.A0m != null) {
            for (int size = this.A0m.size() - 1; size >= 0; size--) {
                this.A0m.get(size).A0M(this, i10, i11);
            }
        }
        this.A0N--;
    }
    ...
    public final void A1j(C2073Qd c2073Qd) {
        if (getScrollState() != 2) {
            c2073Qd.A06 = 0;
            c2073Qd.A07 = 0;
        } else {
            OverScroller overScroller = this.A08.A01;
            c2073Qd.A06 = overScroller.getFinalX() - overScroller.getCurrX();
            c2073Qd.A07 = overScroller.getFinalY() - overScroller.getCurrY();
        }
    }

    public final void A1k(AbstractC2076Qg abstractC2076Qg, QJ qj2) {
        abstractC2076Qg.A0a(0, 8192);
        if (this.A0s.A0E) {
            boolean zA0j = abstractC2076Qg.A0j();
            if (A19[1].charAt(14) != '5') {
                throw new RuntimeException();
            }
            String[] strArr = A19;
            ...
            if (zA0j && !abstractC2076Qg.A0g() && !abstractC2076Qg.A0l()) {
                this.A0t.A08(A0C(abstractC2076Qg), abstractC2076Qg);
            }
        }
        this.A0t.A0F(abstractC2076Qg, qj2);
    }

    public final void A1l(AbstractC2076Qg abstractC2076Qg, QJ qj2, QJ qj3) {
        abstractC2076Qg.A0d(false);
        if (this.A05.A0O(abstractC2076Qg, qj2, qj3)) {
            A1O();
        }
    }

    public final void A1m(AbstractC2076Qg abstractC2076Qg, QJ qj2, QJ qj3) {
        A0r(abstractC2076Qg);
        abstractC2076Qg.A0d(false);
        if (this.A05.A0P(abstractC2076Qg, qj2, qj3)) {
            A1O();
        }
    }
    ...
    public final boolean A1x(View view) {
        ...
        if (zA0L) {
            AbstractC2076Qg abstractC2076QgA0F = A0F(view);
            this.A0r.A0Y(abstractC2076QgA0F);
            this.A0r.A0X(abstractC2076QgA0F);
        }
        A1p(!zA0L);
        return zA0L;
    }

    public final boolean A1y(AbstractC2076Qg abstractC2076Qg) {
        return this.A05 == null || this.A05.A0S(abstractC2076Qg, abstractC2076Qg.A0R());
    }

    public final boolean A1z(AbstractC2076Qg abstractC2076Qg, int i10) {
        if (!A1s()) {
            P3.A09(abstractC2076Qg.A0H, i10);
            return true;
        }
        abstractC2076Qg.A02 = i10;
        this.A0w.add(abstractC2076Qg);
        return false;
    }

    @Override // android.view.ViewGroup, android.view.View
    public final void addFocusables(ArrayList<View> arrayList, int i10, int i11) {
        if (this.A06 == null || !this.A06.A1e(this, arrayList, i10, i11)) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:75:0x0199 A[PHI: r5
      0x0199: PHI (r5v4 boolean) = (r5v3 boolean), (r5v3 boolean), (r5v7 boolean) binds: [B:49:0x00e1, B:53:0x0108, B:74:0x018f] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public final void draw(android.graphics.Canvas r8) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C15766g.draw(android.graphics.Canvas):void");
    }
    ...
    */
    public final android.view.View focusSearch(android.view.View r11, int r12) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C15766g.focusSearch(android.view.View, int):android.view.View");
    }
    ...
    public int getBaseline() {
        return this.A06 != null ? this.A06.A0X() : super.getBaseline();
    }
    ...
    public C2693g1 getCompatAccessibilityDelegate() {
        return this.A09;
    }
    ...
    public final void onAttachedToWindow() {
        ...
        this.A0U = 0;
        this.A0F = true;
        this.A0D = this.A0D && !isLayoutRequested();
        if (this.A06 != null) {
            this.A06.A1P(this);
        }
        this.A0K = false;
        if (A1E) {
            this.A03 = RunnableC2069Pz.A07.get();
            RunnableC2069Pz runnableC2069Pz = this.A03;
            String[] strArr = A19;
            if (strArr[4].charAt(24) != strArr[5].charAt(24)) {
                throw new RuntimeException();
            }
            ...
            if (runnableC2069Pz == null) {
                this.A03 = new RunnableC2069Pz();
                ...
                RunnableC2069Pz.A07.set(this.A03);
            }
            this.A03.A09(this);
        }
    }
    ...
    public final boolean onGenericMotionEvent(MotionEvent motionEvent) {
        ...
        if (action == 8) {
            if ((motionEvent.getSource() & 2) != 0) {
                f10 = this.A06.A23() ? -motionEvent.getAxisValue(9) : 0.0f;
                axisValue = this.A06.A22() ? motionEvent.getAxisValue(10) : 0.0f;
            ...
            if (f10 != 0.0f || axisValue != 0.0f) {
                A13((int) (this.A0L * axisValue), (int) (this.A0M * f10), motionEvent);
            }
        }
        return false;
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        switch (actionMasked) {
            ...
            case 2:
                ...
                if (this.A0W != 1) {
                    int i11 = x11 - this.A0Q;
                    int i12 = y11 - this.A0R;
                    boolean z10 = false;
                    if (zA22) {
    ...
    public void onMeasure(int i10, int i11) {
        ...
        if (this.A06.A21()) {
            this.A06.A13(View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), 1073741824), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), 1073741824));
            this.A0s.A0A = true;
            A0M();
            if (A19[1].charAt(14) != '5') {
                this.A06.A14(i10, i11);
    ...
    public final Parcelable onSaveInstanceState() {
        ...
        if (this.A0j != null) {
            recyclerView$SavedState.A03(this.A0j);
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r21) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C15766g.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    public final void removeDetachedView(View view, boolean z10) {
        ...
        if (abstractC2076QgA0F != null) {
            if (abstractC2076QgA0F.A0i()) {
                abstractC2076QgA0F.A0V();
            } else if (!abstractC2076QgA0F.A0l()) {
                throw new IllegalArgumentException(A0I(Sdk.SDKError.Reason.MRAID_JS_COPY_FAILED_VALUE, 75, 84) + abstractC2076QgA0F + A1J());
            }
        }
        view.clearAnimation();
        A1g(view);
    ...
    public void setAccessibilityDelegateCompat(C2693g1 c2693g1) {
        this.A09 = c2693g1;
    ...
    public void setChildDrawingOrderCallback(QF qf2) {
        if (qf2 == null) {
            return;
        }
        this.A0e = qf2;
    ...
    public void setItemAnimator(QK qk2) {
        if (this.A05 != null) {
            this.A05.A0H();
            this.A05.A0J(null);
        }
    ...
    public void setLayoutManager(QO qo2) {
        ...
        if (qo2 != null) {
            if (qo2.A03 != null) {
                throw new IllegalArgumentException(A0I(1109, 14, 42) + qo2 + A0I(59, 39, 124) + qo2.A03.A1J());
            }
            this.A06.A1R(this);
            if (this.A0F) {
                this.A06.A1P(this);
    ...
    public void setOnFlingListener(QR qr2) {
        this.A0g = qr2;
    }
    ...
    public void setViewCacheExtension(AbstractC2074Qe abstractC2074Qe) {
        this.A0r.A0W(abstractC2074Qe);
    }
