...
public final class AnonymousClass95 implements InterfaceC2945kN {
    ...
    public final C16057j A03 = new C16057j();
    public final Deque<AbstractC16047i> A04 = new ArrayDeque();

    public AnonymousClass95() {
        for (int i10 = 0; i10 < 2; i10++) {
            this.A04.addFirst(new AbstractC16047i() { // from class: com.facebook.ads.redexgen.X.10
    ...
    public final C16057j A5j() throws C2944kM {
        C3M.A08(!this.A01);
        if (this.A00 != 0) {
            return null;
        }
    ...
    public final AbstractC16047i A5l() throws C2944kM {
        ...
        AbstractC16047i abstractC16047iRemoveFirst = this.A04.removeFirst();
        if (this.A03.A05()) {
            String[] strArr = A05;
            ...
            abstractC16047iRemoveFirst.A00(4);
        } else {
            abstractC16047iRemoveFirst.A0C(this.A03.A01, new C3040m7(this.A03.A01, this.A02.A02(((ByteBuffer) C3M.A01(this.A03.A02)).array())), 0L);
        }
        this.A03.A0A();
        this.A00 = 0;
        return abstractC16047iRemoveFirst;
    }

    /* JADX INFO: Access modifiers changed from: private */
    @Override // com.facebook.ads.redexgen.core.C5O
    /* JADX INFO: renamed from: A03, reason: merged with bridge method [inline-methods] */
    public final void AGZ(C16057j c16057j) throws C2944kM {
        C3M.A08(!this.A01);
        C3M.A08(this.A00 == 1);
        C3M.A07(this.A03 == c16057j);
        this.A00 = 2;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A04(AbstractC16047i abstractC16047i) {
        C3M.A08(this.A04.size() < 2);
        C3M.A07(!this.A04.contains(abstractC16047i));
        abstractC16047i.A0A();
        this.A04.addFirst(abstractC16047i);
    }
