...
public final class OH extends Drawable {
    ...
    public OH(ColorStateList colorStateList, float f10) {
        this.A01 = f10;
        A01(colorStateList);
        this.A0A = new RectF();
        this.A09 = new Rect();
    ...
    private void A02(Rect rect) {
        ...
        this.A09.set(rect);
        if (this.A06) {
            this.A09.inset((int) Math.ceil(OJ.A00(this.A00, this.A01, this.A07)), (int) Math.ceil(OJ.A01(this.A00, this.A01, this.A07)));
    ...
    public final boolean onStateChange(int[] iArr) {
        ...
        boolean z10 = colorForState != this.A08.getColor();
        if (z10) {
