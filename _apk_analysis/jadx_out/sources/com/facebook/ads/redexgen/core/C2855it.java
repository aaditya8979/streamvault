...
public class C2855it implements M5 {
    ...
    public C2855it(File file, byte[] bArr, boolean z10) {
    ...
    private int A00(M4 m42, int i10) {
        int iHashCode = (m42.A01 * 31) + m42.A02.hashCode();
        if (i10 >= 2) {
            return (iHashCode * 31) + m42.A03().hashCode();
        }
    ...
    private M4 A01(int i10, DataInputStream dataInputStream) throws IOException {
        ...
        if (i10 < 2) {
            ...
            M9 m92 = new M9();
            M9.A00(m92, j10);
            c2854isA02 = C2854is.A03.A05(m92);
        } else {
            c2854isA02 = M6.A02(dataInputStream);
        }
        return new M4(i11, utf, c2854isA02);
    }
    ...
    private void A05(HashMap<String, M4> map) throws IOException {
        try {
            ...
            if (this.A06) {
                ...
                ((SecureRandom) AbstractC15184a.A0f(this.A03)).nextBytes(bArr);
                dataOutputStream.write(bArr);
                try {
                    ((Cipher) AbstractC15184a.A0f(this.A04)).init(1, (Key) AbstractC15184a.A0f(this.A05), new IvParameterSpec(bArr));
    ...
    private boolean A06(HashMap<String, M4> map, SparseArray<String> sparseArray) {
        ...
        try {
            ...
            if (i10 < 0 || i10 > 2) {
                AbstractC15184a.A10(dataInputStream);
                return false;
            }
            if ((dataInputStream.readInt() & 1) != 0) {
                ...
                try {
                    this.A04.init(2, (Key) AbstractC15184a.A0f(this.A05), new IvParameterSpec(bArr));
