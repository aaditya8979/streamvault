...
public final class C2311Zm extends Drawable {
    ...
    public String A05;
    public String A06;
    public WeakReference<C2602eX> A07;
    public boolean A08;
    ...
    public final Runnable A0F = new C1920Kd(this);
    ...
    */
    public void A03() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2311Zm.A03():void");
    }

    public static void A04() {
        A0G = new byte[]{12, 26, 70, 121, 117, 103, ExifInterface.START_CODE, 48, 101, ExifInterface.START_CODE, 35, 101, 60, 48, 92, 127, 113, 116, 117, 116, 48, 0, 24, 4, 6, 24, 6, 29, 63, 44, 58, 126, 7, 32, 39, 58, 39, 47, 34, 39, 52, 39, 32, 41, 96, 96, 96, 110, 89, 86, 29, 83, 104, 109, 104, 105, 113, 104, 107, 84, 88, 74, 92, 95, 84, 81, 84, 73, 68, 29, 126, 85, 88, 94, 86, 88, 79, 29, 83, 82, 73, 29, 78, 88, 73, 60, 116, 122, 55, 89, 10, 75, 77, 69};
    }
    ...
    public final void A0A(C2602eX c2602eX) {
        this.A07 = new WeakReference<>(c2602eX);
        A03();
    }
    ...
    public final void draw(Canvas canvas) {
        if (this.A08) {
            ...
            canvas.drawRect((f10 - width2) - 40.0f, (f11 - height2) - 40.0f, f10 + width2 + 40.0f, f11 + height2 + 40.0f, this.A0B);
            canvas.save();
