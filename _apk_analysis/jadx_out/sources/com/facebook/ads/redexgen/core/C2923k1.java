...
public final class C2923k1 implements GX {
    ...
    public static final InterfaceC1815Gb A04 = new InterfaceC1815Gb() { // from class: com.facebook.ads.redexgen.X.k2
    ...
    public final int AGb(InterfaceC2995lN interfaceC2995lN, C1833Gt c1833Gt) throws IOException {
        int i10 = interfaceC2995lN.read(this.A01.A0l(), 0, 2786);
        if (i10 == -1) {
            return -1;
        }
        this.A01.A0f(0);
    ...
    public final boolean AJL(InterfaceC2995lN interfaceC2995lN) throws IOException {
        ...
        int i10 = 0;
        while (true) {
            interfaceC2995lN.AG9(c4j.A0l(), 0, 10);
            c4j.A0f(0);
            if (c4j.A0K() != 4801587) {
                ...
                int i12 = 0;
                while (true) {
                    interfaceC2995lN.AG9(c4j.A0l(), 0, 6);
                    c4j.A0f(0);
                    if (c4j.A0M() != 2935) {
                        i12 = 0;
                        interfaceC2995lN.AI1();
                        ...
                        int iA05 = GF.A05(c4j.A0l());
                        if (iA05 == -1) {
                            return false;
                        }
                        interfaceC2995lN.A3z(iA05 - 6);
                    }
                }
            } else {
                c4j.A0g(3);
