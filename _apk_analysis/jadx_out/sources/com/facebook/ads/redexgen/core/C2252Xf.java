...
public final class C2252Xf implements SensorEventListener {
    ...
    public final Set<InterfaceC2251Xe> A09 = new CopyOnWriteArraySet();

    static {
        A02();
    }

    public C2252Xf(C2529dL c2529dL) {
        this.A08 = c2529dL;
    }
    ...
    public final void A03(InterfaceC2251Xe interfaceC2251Xe) {
        if (this.A09.isEmpty()) {
            A01();
        } else if (this.A09.contains(interfaceC2251Xe)) {
            return;
        }
        this.A09.add(interfaceC2251Xe);
    }
    ...
    public final void onSensorChanged(SensorEvent sensorEvent) {
        ...
        if (jElapsedRealtime - this.A04 > 500) {
            this.A03 = 0;
        }
        if (jElapsedRealtime - this.A06 > 100) {
            if ((Math.abs(((((sensorEvent.values[0] + sensorEvent.values[1]) + sensorEvent.values[2]) - this.A00) - this.A01) - this.A02) / (jElapsedRealtime - this.A06)) * 10000.0f > 800.0f) {
                int i10 = this.A03 + 1;
                this.A03 = i10;
                if (i10 >= 3 && jElapsedRealtime - this.A05 > 1000) {
                    this.A05 = jElapsedRealtime;
                    this.A03 = 0;
                    Iterator<InterfaceC2251Xe> it = this.A09.iterator();
                    while (it.hasNext()) {
                        it.next().AFD();
                    }
                }
