...
public final class RC implements View.OnLongClickListener {
    ...
    @Nullable
    public final C2311Zm A01;

    public RC(C2311Zm c2311Zm, RelativeLayout relativeLayout) {
        this.A01 = c2311Zm;
    ...
    public final boolean onLongClick(View view) {
        if (this.A01 != null && this.A00 != null) {
            ...
            A02[7] = "";
            c2311Zm.setBounds(0, 0, width, relativeLayout.getHeight());
