...
public final class AnonymousClass13 extends C9Z implements Handler.Callback {
    ...
    public AnonymousClass13(B3 b32, Looper looper, B1 b12, String str) {
        ...
        this.A06 = looper == null ? null : AbstractC15184a.A0c(looper, this);
        this.A07 = (B1) C3M.A01(b12);
        this.A09 = new C16348z();
    ...
    private void A07(Metadata metadata, List<Metadata.Entry> list) {
        for (int i10 = 0; i10 < metadata.A02(); i10++) {
            C3206or c3206orA9T = metadata.A03(i10).A9T();
            if (c3206orA9T == null || !this.A07.AJc(c3206orA9T)) {
                list.add(metadata.A03(i10));
            } else {
                HK hkA5B = this.A07.A5B(c3206orA9T);
                byte[] bArr = (byte[]) C3M.A01(metadata.A03(i10).A9S());
                this.A09.A0A();
                this.A09.A0C(bArr.length);
                ((ByteBuffer) AbstractC15184a.A0f(this.A09.A02)).put(bArr);
                this.A09.A0B();
    ...
    public final void A1c(C3206or[] c3206orArr, long j10, long j11) {
        this.A03 = this.A07.A5B(c3206orArr[0]);
    }
    ...
    public final void AHn(long j10, long j11) {
            ...
            if (i10 < 5) {
                ...
                if (iA1R == -4) {
                    if (this.A09.A05()) {
                        ...
                        this.A09.A0B();
                        Metadata metadataA5g = ((HK) AbstractC15184a.A0f(this.A03)).A5g(this.A09);
                        if (metadataA5g != null) {
                    ...
                    this.A02 = ((C3206or) C3M.A01(c6nA1U.A00)).A0M;
                }
            }
        }
        ...
        A05((Metadata) AbstractC15184a.A0f(this.A0B[this.A01]), AbstractC14641w.A01(j10 - this.A0A[this.A01]));
    ...
    public final int AJb(C3206or c3206or) {
        if (this.A07.AJc(c3206or)) {
            return AnonymousClass76.A00(AnonymousClass14.A1G(c3206or) ? 4 : 2);
        }
