...
public final class YJ implements InterfaceC2127Sg {
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2127Sg
    public final void ABw(InterfaceC2126Sf interfaceC2126Sf) {
        String[] stringArray;
        Integer integer;
        Integer integer2;
        if (AdInternalSettings.sDataProcessingOptionsUpdate.getAndSet(false)) {
            ...
            interfaceC2126Sf.AFC(stringArray, integer, integer2);
        }
    }
}
