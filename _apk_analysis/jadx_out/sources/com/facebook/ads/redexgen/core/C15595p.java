...
public final class C15595p extends KL {
    ...
    public static final int A02 = (int) (AbstractC2232Wl.A02 * 152.0f);
    public static final int A01 = (int) (AbstractC2232Wl.A02 * 60.0f);

    public C15595p(C2529dL c2529dL, KE ke2, int i10, boolean z10, C1992My c1992My, String str, US us2, InterfaceC2260Xn interfaceC2260Xn, C2602eX c2602eX, XH xh2, AbstractC2804hy abstractC2804hy, C1732Cw c1732Cw, C2172Ua c2172Ua, boolean z11) {
        super(c2529dL, ke2, i10, z10, c1992My, false, str, us2, interfaceC2260Xn, c2602eX, xh2, abstractC2804hy, c1732Cw, c2172Ua, z11);
    ...
    private void A01(int i10) {
        if (i10 == 1) {
            ...
            this.A0O.addView(((AbstractC2320Zv) this).A08);
            ...
            this.A0L.addView(((AbstractC2320Zv) this).A08);
            this.A0N.addView(this.A0L);
            this.A0N.addView(((AbstractC2320Zv) this).A09);
    ...
    private void A05(int i10) {
        ...
        if (i10 == 1) {
            ...
            ((AbstractC2320Zv) this).A08.setMinWidth(-1);
        } else {
            ...
            ((AbstractC2320Zv) this).A08.setMinWidth((int) (getResources().getDisplayMetrics().widthPixels * 0.12f));
        }
        layoutParams.addRule(14);
        ((AbstractC2320Zv) this).A08.setLayoutParams(layoutParams);
        ((AbstractC2320Zv) this).A08.setPadding(KL.A0s, 0, KL.A0s, 0);
        A0k();
    }
    ...
    private void A06(int i10) {
        ...
        if (i10 == 1) {
            layoutParams.addRule(2, ((AbstractC2320Zv) this).A08.getId());
    ...
    private void A07(int i10) {
        ...
        if (i10 == 1) {
            layoutParams.addRule(12);
            layoutParams.addRule(7, ((AbstractC2320Zv) this).A08.getId());
            layoutParams.setMargins(0, 0, 0, KL.A0l);
        } else {
    ...
    private void A09(int i10) {
        int i11;
        RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) ((AbstractC2320Zv) this).A09.getLayoutParams();
        if (i10 == 1) {
        ...
        if (!this.A0X) {
            ((AbstractC2320Zv) this).A09.setRadius(i11);
        }
        ((AbstractC2320Zv) this).A09.setLayoutParams(layoutParams);
    }
    ...
    private void A0C(int i10) {
        ...
        if (i10 == 1) {
            ...
            i11 = 4;
            layoutParams.addRule(14);
            layoutParams.addRule(3, ((AbstractC2320Zv) this).A09.getId());
            layoutParams.setMargins(KL.A0r, KL.A0l, KL.A0r, KL.A0u);
            ...
            i11 = 5;
            layoutParams.addRule(15);
            layoutParams.addRule(1, ((AbstractC2320Zv) this).A09.getId());
    ...
    @Override // com.facebook.ads.redexgen.core.KL, com.facebook.ads.redexgen.core.AbstractC2320Zv
    public final void A0h(int i10) {
        super.A0h(i10);
        XP.A0Z(this.A0N, this.A0L, ((AbstractC2320Zv) this).A09, this.A0Q, ((AbstractC2320Zv) this).A08, this.A0U, ((KL) this).A04, this.A0P, this.A0I, this.A0K, this.A0J);
        A03(i10);
        A04(i10);
        A07(i10);
        A0A(i10);
    ...
    public final void A0s(ViewGroup viewGroup, RelativeLayout relativeLayout, int i10) {
        if (i10 == 1) {
            ...
            ((AbstractC2320Zv) this).A09.setLayoutParams(layoutParams);
            viewGroup.addView(((AbstractC2320Zv) this).A09);
