...
public class C2099Rd {
    ...
    public C2099Rd(String str, String str2, String str3, boolean z10, String str4) {
        this.A03 = str;
        this.A02 = str2;
        this.A01 = str3;
        this.A04 = z10;
    ...
    public static C2099Rd A00(JSONObject jSONObject) throws JSONException {
        return new C2099Rd(jSONObject.getString(A01(30, 3, 49)), jSONObject.getString(A01(26, 4, 87)), jSONObject.optString(A01(5, 9, 106)), jSONObject.getString(A01(14, 8, 37)).equals(A01(22, 4, 109)), jSONObject.optString(A01(0, 5, 69)));
    }
    ...
    public static void A02() {
        byte[] bArr = {-49, -38, -41, -49, ExifInterface.MARKER_APP1, -8, 11, 7, -8, 1, 6, -4, 2, 1, -67, -66, -62, -73, -67, -68, -81, -70, 10, 8, 11, -5, -12, -7, -16, -27, -49, -52, -58};
        String[] strArr = A06;
        if (strArr[6].charAt(16) == strArr[0].charAt(16)) {
            throw new RuntimeException();
        }
