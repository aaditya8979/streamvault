...
public abstract class OE extends FrameLayout {
    ...
    public static final OG A0A = new C2728gd();
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        switch (mode) {
            ...
            case 1073741824:
                i10 = View.MeasureSpec.makeMeasureSpec(Math.max((int) Math.ceil(A0A.A8Q(this.A06)), View.MeasureSpec.getSize(i10)), mode);
                break;
        }
