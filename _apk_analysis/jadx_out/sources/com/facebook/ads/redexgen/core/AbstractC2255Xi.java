...
public abstract class AbstractC2255Xi {
    ...
    public static void A02(Activity activity, int i10, C2529dL c2529dL) {
        try {
            activity.setRequestedOrientation(i10);
        } catch (IllegalStateException e10) {
            c2529dL.A08().ABR(A00(0, 7, 51), AbstractC2142Sv.A0H, new C2143Sw(e10));
        }
    }
}
