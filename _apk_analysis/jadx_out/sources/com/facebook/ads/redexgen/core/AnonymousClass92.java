...
public final class AnonymousClass92 extends AbstractC3015li {
    ...
    public static final AbstractC3185oV<Integer> A09;
    public static final AbstractC3185oV<Integer> A0A;
    public C3212oy A00;
    ...
    static {
        A0M();
        A09 = AbstractC3185oV.A04(new Comparator() { // from class: com.facebook.ads.redexgen.X.Dx
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
                return AnonymousClass92.A05((Integer) obj, (Integer) obj2);
            }
        });
        A0A = AbstractC3185oV.A04(new Comparator() { // from class: com.facebook.ads.redexgen.X.Dy
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
    ...
    public AnonymousClass92() {
        this(AnonymousClass93.A0J, new C3038m5());
    }
    ...
    @Deprecated
    public AnonymousClass92(C3165oA c3165oA, EA ea2) {
        this(c3165oA, ea2, null);
    }

    public AnonymousClass92(C3165oA c3165oA, EA ea2, Context context) {
        this.A05 = new Object();
        this.A03 = context != null ? context.getApplicationContext() : null;
        this.A04 = ea2;
        if (c3165oA instanceof AnonymousClass93) {
            this.A01 = (AnonymousClass93) c3165oA;
        } else {
            this.A01 = (context == null ? AnonymousClass93.A0J : AnonymousClass93.A02(context)).A0P().A0u(c3165oA).A0p();
        }
        this.A00 = C3212oy.A07;
        this.A06 = context != null && AbstractC15184a.A18(context);
        if (!this.A06 && context != null && AbstractC15184a.A02 >= 32) {
    ...
    public static int A02(C3206or c3206or, String str, boolean z10) {
        String strA0K;
        if (TextUtils.isEmpty(str)) {
            String strA0K2 = A0K(str);
            strA0K = A0K(c3206or.A0V);
            if (strA0K != null) {
            }
            if (z10) {
                return 0;
        ...
        if (strArr[6].length() != strArr[3].length()) {
            ...
            String str3 = AbstractC15184a.A1P(strA0K, strA0J)[0];
            String str4 = AbstractC15184a.A1P(strA0K22, strA0J)[0];
            String[] strArr3 = A08;
            if (strArr3[6].length() != strArr3[3].length()) {
                A08[4] = "rXSrCW";
                return str3.equals(str4) ? 2 : 0;
            }
        }
        throw new RuntimeException();
    }

    public static int A03(C3172oH c3172oH, int i10, int i11, boolean z10) {
        if (i10 == Integer.MAX_VALUE || i11 == Integer.MAX_VALUE) {
            return Integer.MAX_VALUE;
        }
        int i12 = Integer.MAX_VALUE;
        for (int i13 = 0; i13 < c3172oH.A01; i13++) {
            C3206or c3206orA08 = c3172oH.A08(i13);
            if (c3206orA08.A0L > 0 && c3206orA08.A0A > 0) {
                Point pointA09 = A09(z10, i10, i11, c3206orA08.A0L, c3206orA08.A0A);
                int i14 = c3206orA08.A0L * c3206orA08.A0A;
                if (c3206orA08.A0L >= ((int) (pointA09.x * 0.98f)) && c3206orA08.A0A >= ((int) (pointA09.y * 0.98f)) && i14 < i12) {
                    i12 = i14;
                }
            }
        }
    ...
    */
    ...
    public static Point A09(boolean z10, int i10, int i11, int i12, int i13) {
        if (z10) {
            if ((i12 > i13) != (i10 > i11)) {
                i10 = i11;
                i11 = i10;
        ...
        return i12 * i11 >= i13 * i10 ? new Point(i10, AbstractC15184a.A05(i10 * i13, i12)) : new Point(AbstractC15184a.A05(i11 * i12, i13), i11);
    }
    ...
    */
    ...
    private final Pair<E9, Integer> A0B(EC ec2, int[][][] iArr, final AnonymousClass93 anonymousClass93, final String str) throws C9Y {
        return A0A(3, ec2, iArr, new E4() { // from class: com.facebook.ads.redexgen.X.m0
            ...
            public final List A57(int i10, C3172oH c3172oH, int[] iArr2) {
                return C3020ln.A02(i10, c3172oH, anonymousClass93, iArr2, str);
            }
        }, new Comparator() { // from class: com.facebook.ads.redexgen.X.Dw
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
                return C3020ln.A01((List) obj, (List) obj2);
            }
        });
    }
    ...
    private final Pair<E9, Integer> A0C(EC ec2, int[][][] iArr, int[] iArr2, final AnonymousClass93 anonymousClass93) throws C9Y {
        ...
        return A0A(1, ec2, iArr, new E4() { // from class: com.facebook.ads.redexgen.X.m1
            @Override // com.facebook.ads.redexgen.core.E4
            public final List A57(int i11, C3172oH c3172oH, int[] iArr3) {
                return this.A01.A0e(anonymousClass93, z10, i11, c3172oH, iArr3);
            }
        }, new Comparator() { // from class: com.facebook.ads.redexgen.X.Dv
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
                return C3032lz.A02((List) obj, (List) obj2);
            }
        });
    }
    ...
    private final Pair<E9, Integer> A0D(EC ec2, int[][][] iArr, final int[] iArr2, final AnonymousClass93 anonymousClass93, final String str) throws C9Y {
        return A0A(2, ec2, iArr, new E4() { // from class: com.facebook.ads.redexgen.X.m3
            @Override // com.facebook.ads.redexgen.core.E4
            public final List A57(int i10, C3172oH c3172oH, int[] iArr3) {
                return C3017lk.A06(i10, c3172oH, anonymousClass93, iArr3, str, iArr2[i10]);
            }
        }, new Comparator() { // from class: com.facebook.ads.redexgen.X.Du
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
                return C3017lk.A05((List) obj, (List) obj2);
            }
        });
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private final com.facebook.ads.redexgen.core.E9 A0E(int r13, com.facebook.ads.redexgen.core.C3043mA r14, int[][] r15, com.facebook.ads.redexgen.core.AnonymousClass93 r16) throws com.facebook.ads.redexgen.core.C9Y {
        /*
            r12 = this;
            r7 = 0
            r11 = 0
    ...
    public void A0L() {
        ...
        synchronized (this.A05) {
            z10 = this.A01.A08 && !this.A06 && AbstractC15184a.A02 >= 32 && this.A02 != null && this.A02.A06();
        }
        if (z10) {
            A01();
        }
    ...
    public static void A0N(C3043mA c3043mA, C3165oA c3165oA, Map<Integer, C3167oC> map) {
        C3167oC c3167oC;
        for (int i10 = 0; i10 < c3043mA.A01; i10++) {
            C3167oC c3167oC2 = c3165oA.A0G.get(c3043mA.A05(i10));
            if (c3167oC2 != null && ((c3167oC = map.get(Integer.valueOf(c3167oC2.A01()))) == null || (c3167oC.A01.isEmpty() && !c3167oC2.A01.isEmpty()))) {
                map.put(Integer.valueOf(c3167oC2.A01()), c3167oC2);
            }
        }
    }

    public static void A0P(EC ec2, C3165oA c3165oA, E9[] e9Arr) {
        int iA02 = ec2.A02();
        HashMap map = new HashMap();
        for (int i10 = 0; i10 < iA02; i10++) {
            A0N(ec2.A07(i10), c3165oA, map);
        }
        A0N(ec2.A06(), c3165oA, map);
        for (int i11 = 0; i11 < iA02; i11++) {
            C3167oC c3167oC = (C3167oC) map.get(Integer.valueOf(ec2.A03(i11)));
            if (c3167oC != null) {
                boolean zIsEmpty = c3167oC.A01.isEmpty();
                if (A08[7].charAt(4) == 'r') {
                    throw new RuntimeException();
                }
                A08[4] = "YbaSeo";
                e9Arr[i11] = (zIsEmpty || ec2.A07(i11).A04(c3167oC.A00) == -1) ? null : new E9(c3167oC.A00, AD.A0C(c3167oC.A01));
            }
        }
    }
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static void A0R(com.facebook.ads.redexgen.core.EC r11, int[][][] r12, com.facebook.ads.redexgen.core.C7G[] r13, com.facebook.ads.redexgen.core.InterfaceC3016lj[] r14) {
        /*
            r9 = -1
            r8 = -1
            r10 = 1
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean A0T(C3206or c3206or) {
        boolean z10;
        synchronized (this.A05) {
            z10 = !this.A01.A08 || this.A06 || c3206or.A06 <= 2 || (A0U(c3206or) && (AbstractC15184a.A02 < 32 || this.A02 == null || !this.A02.A06())) || (AbstractC15184a.A02 >= 32 && this.A02 != null && this.A02.A06() && this.A02.A04() && this.A02.A05() && this.A02.A07(this.A00, c3206or));
        }
        return z10;
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static boolean A0U(com.facebook.ads.redexgen.core.C3206or r6) {
        /*
    ...
    public static boolean A0W(int[][] iArr, C3043mA c3043mA, InterfaceC3016lj interfaceC3016lj) {
        if (interfaceC3016lj == null) {
            return false;
        }
        int iA04 = c3043mA.A04(interfaceC3016lj.A9D());
        for (int i10 = 0; i10 < interfaceC3016lj.length(); i10++) {
            if (AnonymousClass76.A05(iArr[iA04][interfaceC3016lj.A89(i10)]) != 32) {
                return false;
            }
        }
        return true;
    ...
    private final E9[] A0X(EC ec2, int[][][] iArr, int[] iArr2, AnonymousClass93 anonymousClass93) throws C9Y {
        ...
        if (pairA0C != null) {
            ...
            String[] strArr = A08;
            if (strArr[0].charAt(9) == strArr[2].charAt(9)) {
                throw new RuntimeException();
            }
            A08[7] = "yBKbxgl1qoYBYNtasAVV61g1RQWhRN9O";
            e9Arr[((Integer) obj).intValue()] = (E9) pairA0C.first;
        }
        String str = pairA0C == null ? null : ((E9) pairA0C.first).A01.A08(((E9) pairA0C.first).A02[0]).A0V;
        ...
        for (int i10 = 0; i10 < iA02; i10++) {
            int iA03 = ec2.A03(i10);
            if (iA03 != 2 && iA03 != 1) {
                String[] strArr2 = A08;
                if (strArr2[0].charAt(9) == strArr2[2].charAt(9)) {
                    throw new RuntimeException();
                }
                String[] strArr3 = A08;
                ...
                if (iA03 != 3) {
                    e9Arr[i10] = A0E(iA03, ec2.A07(i10), iArr[i10], anonymousClass93);
                }
            }
        }
        return e9Arr;
    ...
    @Override // com.facebook.ads.redexgen.core.AbstractC3015li
    @MetaExoPlayerCustomization(type = {"MERGED"}, value = "final removed in D35162315")
    public final Pair<C7G[], InterfaceC3016lj[]> A0d(EC ec2, int[][][] iArr, int[] iArr2, C3053mL c3053mL, Timeline timeline) throws Throwable {
        AnonymousClass93 anonymousClass93;
        synchronized (this.A05) {
            try {
                anonymousClass93 = this.A01;
                if (anonymousClass93.A08 && AbstractC15184a.A02 >= 32 && this.A02 != null) {
        ...
        for (int i10 = 0; i10 < iA02; i10++) {
            int iA03 = ec2.A03(i10);
            if (anonymousClass93.A0R(i10) || anonymousClass93.A0H.contains(Integer.valueOf(iA03))) {
                e9ArrA0X[i10] = null;
            }
        }
        InterfaceC3016lj[] interfaceC3016ljArrA5T = this.A04.A5T(e9ArrA0X, A00(), c3053mL, timeline);
        C7G[] c7gArr = new C7G[iA02];
        for (int i11 = 0; i11 < iA02; i11++) {
            c7gArr[i11] = !(anonymousClass93.A0R(i11) || anonymousClass93.A0H.contains(Integer.valueOf(ec2.A03(i11)))) && (ec2.A03(i11) == -2 || interfaceC3016ljArrA5T[i11] != null) ? C7G.A01 : null;
        }
        if (anonymousClass93.A0D) {
            A0R(ec2, iArr, c7gArr, interfaceC3016ljArrA5T);
        }
        return Pair.create(c7gArr, interfaceC3016ljArrA5T);
    }

    public final /* synthetic */ AbstractC1673Am A0e(AnonymousClass93 anonymousClass93, boolean z10, int i10, C3172oH c3172oH, int[] iArr) {
        return C3032lz.A03(i10, c3172oH, anonymousClass93, iArr, z10, new InterfaceC2872jB() { // from class: com.facebook.ads.redexgen.X.m2
            @Override // com.facebook.ads.redexgen.core.InterfaceC2872jB
            public final boolean A44(Object obj) {
                return this.A00.A0T((C3206or) obj);
            }
        });
    }
}
