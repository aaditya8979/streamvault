...
public final class C15605q extends KL {
    ...
    public C15605q(C2529dL c2529dL, KE ke2, int i10, boolean z10, C1992My c1992My, String str, US us2, InterfaceC2260Xn interfaceC2260Xn, C2602eX c2602eX, XH xh2, AbstractC2804hy abstractC2804hy, C1732Cw c1732Cw, C2172Ua c2172Ua, boolean z11) {
        super(c2529dL, ke2, i10, z10, c1992My, false, str, us2, interfaceC2260Xn, c2602eX, xh2, abstractC2804hy, c1732Cw, c2172Ua, z11);
        this.A00 = new RunnableC2327a2(this);
    ...
    private void A05(int i10) {
        if (i10 == 1) {
            this.A0M.addView(((AbstractC2320Zv) this).A09);
            this.A0M.addView(this.A0Q);
            this.A0M.addView(this.A0P);
            this.A0M.addView(this.A0I);
            this.A0M.addView(((AbstractC2320Zv) this).A08);
    ...
    private void A0C(int i10) {
        ...
        if (i10 == 1) {
            if (this.A0W.get()) {
                ((AbstractC2320Zv) this).A09.setVisibility(8);
            }
            ...
            layoutParams.setMargins(0, KL.A0l, 0, 0);
            ((AbstractC2320Zv) this).A09.setVisibility(0);
        }
        layoutParams.addRule(14);
    ...
    private void A0D(int i10) {
        if (i10 != 1) {
            this.A0O.setGravity(BadgeDrawable.TOP_START);
            return;
        }
    ...
    public final void A0h(int i10) {
        super.A0h(i10);
        A06(i10);
        XP.A0Z(this.A0N, ((AbstractC2320Zv) this).A09, this.A0Q, ((AbstractC2320Zv) this).A08, this.A0U, ((KL) this).A04, this.A0P, this.A0K, this.A0J, this.A0I);
        A0D(i10);
        A08(i10);
        A03();
        A0C(i10);
