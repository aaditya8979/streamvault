...
public abstract class KC {
    ...
    public static long A01(String str) throws NumberFormatException {
        long j10 = 0;
        String[] strArrA1P = AbstractC15184a.A1P(str, A02(56, 2, 34));
        for (String str2 : AbstractC15184a.A1O(strArrA1P[0], A02(1, 1, 81))) {
            long j11 = 60 * j10;
            if (A01[0].length() != 27) {
                throw new RuntimeException();
            }
            A01[2] = "6AHxBA9eqgTuoeEClHZkEfjq11VkmmF";
            j10 = j11 + Long.parseLong(str2);
        }
        long j12 = j10 * 1000;
        if (strArrA1P.length == 2) {
            j12 += Long.parseLong(strArrA1P[1]);
        }
        return 1000 * j12;
    }
    ...
    public static void A04(C4J c4j) throws C14742i {
        int iA09 = c4j.A09();
        if (A05(c4j)) {
            return;
        }
        c4j.A0f(iA09);
        throw C14742i.A01(A02(2, 21, 114) + c4j.A0T(), null);
    }

    public static boolean A05(C4J c4j) {
        String strA0T = c4j.A0T();
        return strA0T != null && strA0T.startsWith(A02(50, 6, 7));
    }
}
