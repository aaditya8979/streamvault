...
public final class VV {
    ...
    private PW A01(C2529dL c2529dL, JSONObject jSONObject, long j10) throws JSONException {
        JSONObject jSONObject2 = jSONObject.getJSONArray(A04(190, 10, 45)).getJSONObject(0);
        TF tfA00 = TF.A00(jSONObject2.getJSONObject(A04(124, 10, 90)));
        String strOptString = jSONObject2.optString(A04(139, 14, 9));
        String strA04 = A04(47, 5, 107);
        String str = null;
        String strOptString2 = jSONObject2.has(strA04) ? jSONObject2.optString(strA04) : null;
        String strA042 = A04(200, 9, 36);
        String strOptString3 = jSONObject2.has(strA042) ? jSONObject2.optString(strA042) : null;
        String strOptString4 = jSONObject2.optString(A04(0, 19, 51));
        String strA043 = A04(153, 12, 16);
        TE te2 = new TE(tfA00, strOptString, strOptString4, jSONObject2.has(strA043) ? jSONObject2.optString(strA043) : null, strOptString2, strOptString3, A06(jSONObject2));
        String strA044 = A04(26, 3, 93);
        if (jSONObject2.has(strA044)) {
            JSONArray jSONArray = jSONObject2.getJSONArray(strA044);
            int i10 = 0;
            while (i10 < jSONArray.length()) {
                JSONObject jSONObject3 = jSONArray.getJSONObject(i10);
                AbstractC2174Uc.A06(c2529dL, jSONObject3, j10, str);
                String strOptString5 = jSONObject3.optString(A04(19, 7, 8));
                String strOptString6 = jSONObject3.optString(A04(90, 15, 44));
                JSONObject jSONObjectOptJSONObject = jSONObject3.optJSONObject(A04(68, 4, 58));
                JSONArray jSONArrayOptJSONArray = jSONObject3.optJSONArray(A04(209, 8, 121));
                if (jSONObjectOptJSONObject != null) {
                    te2.A0F(new TC(strOptString5, strOptString6, jSONObjectOptJSONObject, jSONArrayOptJSONArray));
                } else {
        ...
        if (jSONObject2.has(strA045)) {
            te2.A0G(jSONObject2.getJSONObject(strA045));
        }
        return new PW(te2, jSONObject.optString(A04(29, 18, 33)));
    }
    ...
    private PV A03(JSONObject jSONObject) {
        ...
        try {
            JSONObject jSONObject2 = jSONObject.getJSONArray(A04(190, 10, 45)).getJSONObject(0);
            return new PV(jSONObject.optString(A04(183, 7, 16), A04(0, 0, 92)), jSONObject.optInt(A04(64, 4, 96), 0), new TE(TF.A00(jSONObject2.getJSONObject(A04(124, 10, 90))), jSONObject2.optString(A04(139, 14, 9)), jSONObject2.optString(A04(0, 19, 51)), null, jSONObject2.has(strA042) ? jSONObject2.optString(strA042) : null, jSONObject2.has(strA04) ? jSONObject2.optString(strA04) : null, A06(jSONObject2)));
    ...
    */
    public final com.facebook.ads.redexgen.core.VX A07(com.facebook.ads.redexgen.core.C2529dL r8, java.lang.String r9, long r10) throws org.json.JSONException {
        /*
            r7 = this;
