...
public class C2778hT implements MX {
    ...
    public C2778hT(AnonymousClass72 anonymousClass72, Runnable runnable) {
    ...
    public final void ACb(InterfaceC2841id interfaceC2841id) {
        this.A00.A02.A0F().A4S();
        this.A00.A07.A0C();
    }

    @Override // com.facebook.ads.redexgen.core.MX
    public final void ACc(InterfaceC2841id interfaceC2841id, View view) {
        this.A00.A02.A0F().A4R(interfaceC2841id == ((AbstractC2775hQ) this.A00).A00);
        if (interfaceC2841id != ((AbstractC2775hQ) this.A00).A00) {
            return;
        }
        this.A00.A0H().removeCallbacks(this.A01);
        MP mp2 = ((AbstractC2775hQ) this.A00).A01;
        ...
        ((AbstractC2775hQ) anonymousClass72).A01 = interfaceC2841id;
        this.A00.A01 = view;
        if (!this.A00.A0C) {
            this.A00.A07.A0F(interfaceC2841id);
        } else {
    ...
    @Override // com.facebook.ads.redexgen.core.MX
    public final void ACd(InterfaceC2841id interfaceC2841id) {
    ...
    @Override // com.facebook.ads.redexgen.core.MX
    public final void ADj(InterfaceC2841id interfaceC2841id, V1 v12) {
        this.A00.A02.A0F().A4T(interfaceC2841id == ((AbstractC2775hQ) this.A00).A00, v12.A03().getErrorCode());
        if (interfaceC2841id != ((AbstractC2775hQ) this.A00).A00) {
            return;
        }
        this.A00.A0H().removeCallbacks(this.A01);
        this.A00.A0Q(interfaceC2841id);
        this.A00.ADB(v12);
    }
}
