...
public final class C2948kQ extends AbstractC1890Iz {
    ...
    public final long A09(C4J c4j) {
        return A06(AbstractC1831Gr.A05(c4j.A0l()));
    }
    ...
    public final boolean A0C(C4J c4j, long j10, C1889Iy c1889Iy) throws C14742i {
        if (A03(c4j, A04)) {
            byte[] bArrCopyOf = Arrays.copyOf(c4j.A0l(), c4j.A0A());
            int iA01 = AbstractC1831Gr.A01(bArrCopyOf);
            List<byte[]> listA06 = AbstractC1831Gr.A06(bArrCopyOf);
            if (c1889Iy.A00 != null) {
                return true;
            }
            c1889Iy.A00 = new C2D().A11(A00(0, 10, 33)).A0b(iA01).A0m(48000).A12(listA06).A14();
            return true;
        }
        if (!A03(c4j, A03)) {
            C3M.A02(c1889Iy.A00);
        ...
        this.A00 = true;
        c4j.A0g(A03.length);
        Metadata metadataA02 = H8.A02(MetaExoPlayerCustomizedCollections.A02(H8.A05(c4j, false, false).A02));
        if (metadataA02 == null) {
            return true;
        }
        C2D c2dA07 = c1889Iy.A00.A07();
        String[] strArr = A02;
        ...
        c1889Iy.A00 = c2dA07.A0v(metadataA02.A04(c1889Iy.A00.A0P)).A14();
        return true;
    }
}
