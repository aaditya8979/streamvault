...
public final class C2689fx extends R8 implements AdOptionsViewApi {
    ...
    static {
        A02();
        A08 = (int) (AbstractC2232Wl.A02 * 23.0f);
        A09 = (int) (AbstractC2232Wl.A02 * 4.0f);
    }

    public C2689fx(Context context, NativeAdBase nativeAdBase, NativeAdLayout nativeAdLayout, AdOptionsView.Orientation orientation, int i10, AdOptionsView adOptionsView) {
        this.A02 = false;
        this.A01 = false;
        this.A00 = false;
        ...
        C2072Qc c2072QcA0L = C2072Qc.A0L(nativeAdBase.getInternalNativeAd());
        c2072QcA0L.A1V(nativeAdLayout);
        c2072QcA0L.A1X(this);
        C2825iN c2825iNA0z = c2072QcA0L.A0z();
        if (c2825iNA0z != null && c2825iNA0z.A0R() && !c2825iNA0z.A0P()) {
            linearLayout.setVisibility(8);
        } else {
            linearLayout.setOnClickListener(new ViewOnClickListenerC2093Qx(this, c2072QcA0L, context, linearLayout));
            EnumC2237Wq.A04(this.A05, EnumC2237Wq.A0C);
        }
    }

    public C2689fx(Context context, NativeAdBase nativeAdBase, NativeAdLayout nativeAdLayout, AdOptionsView adOptionsView) {
    ...
    public final void setIconSizeDp(int i10) {
        int iMax = Math.max(A08, (int) (AbstractC2232Wl.A02 * i10));
