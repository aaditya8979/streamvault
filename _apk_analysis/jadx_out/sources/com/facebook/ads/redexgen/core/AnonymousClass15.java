...
public final class AnonymousClass15 extends AbstractC16469l {
    public int A00;
    public Uri A01;
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC3141nl
    public final long AFy(AnonymousClass56 anonymousClass56) throws C3129nZ {
        ...
        try {
            ...
            throw new C3129nZ(e10, 2001);
        } catch (SecurityException e11) {
            throw new C3129nZ(e11, 2006);
        }
    }
    ...
    public final int read(byte[] bArr, int i10, int i11) throws C3129nZ {
        if (i11 == 0) {
            return 0;
        }
        if (this.A00 == 0) {
            try {
                ...
                throw new C3129nZ(e10, 2002);
            } catch (IOException e11) {
                throw new C3129nZ(e11, 2001);
            }
        }
        int length = this.A07.getLength() - this.A00;
        int iMin = Math.min(this.A00, i11);
        System.arraycopy(this.A08, length, bArr, i10, iMin);
        this.A00 -= iMin;
        return iMin;
    }
}
