...
public abstract class GQ {
    ...
    public GQ(GL gl2, GP gp2, long j10, long j11, long j12, long j13, long j14, long j15, int i10) {
        this.A03 = gp2;
        this.A01 = i10;
        this.A02 = new C3002lV(gl2, j10, j11, j12, j13, j14, j15);
    }

    private final int A00(InterfaceC2995lN interfaceC2995lN, long j10, C1833Gt c1833Gt) {
        if (j10 != interfaceC2995lN.A8f()) {
            c1833Gt.A00 = j10;
            return 1;
        }
        if (A05[5].length() != 7) {
    ...
    public static void A03() {
        A04 = new byte[]{7, 32, 56, 47, 34, 39, ExifInterface.START_CODE, 110, 45, 47, 61, 43};
    }
    ...
    private final boolean A05(InterfaceC2995lN interfaceC2995lN, long j10) throws IOException {
        long jA8f = j10 - interfaceC2995lN.A8f();
        if (jA8f < 0 || jA8f > PlaybackStateCompat.ACTION_SET_REPEAT_MODE) {
            return false;
        }
        interfaceC2995lN.AJJ((int) jA8f);
        return true;
    }

    public final int A06(InterfaceC2995lN interfaceC2995lN, C1833Gt c1833Gt) throws IOException {
        while (true) {
            ...
            if (jA00 - jA01 <= this.A01) {
                ...
                A05[5] = "cjf3Phs";
                return A00(interfaceC2995lN, jA01, c1833Gt);
            }
            if (!A05(interfaceC2995lN, jA02)) {
                return A00(interfaceC2995lN, jA02, c1833Gt);
            }
            interfaceC2995lN.AI1();
            GN gnAIC = this.A03.AIC(interfaceC2995lN, gk2.A04());
            switch (gnAIC.A00) {
                case -3:
                    A04(false, jA02);
                    return A00(interfaceC2995lN, jA02, c1833Gt);
                ...
                case -1:
                    ...
                    break;
                case 0:
                    A05(interfaceC2995lN, gnAIC.A01);
                    A04(true, gnAIC.A01);
                    return A00(interfaceC2995lN, gnAIC.A01, c1833Gt);
                default:
