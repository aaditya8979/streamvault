...
public final class JR extends AbstractC2363ae {
    ...
    public final C2529dL A0M;
    public final C2172Ua A0N;
    public final C2343aK A0O;
    public final C2345aM A0P;
    public final C2367ai A0Q;
    public final E1 A0R;
    public final DX A0S;
    public final DP A0T;
    ...
    static {
        A0Q();
        A0X = (int) (AbstractC2232Wl.A02 * 32.0f);
        A0Y = (int) (AbstractC2232Wl.A02 * 38.0f);
        A0Z = (int) (AbstractC2232Wl.A02 * 40.0f);
        A0a = (int) (AbstractC2232Wl.A02 * 44.0f);
        A0b = (int) (AbstractC2232Wl.A02 * 48.0f);
        A0c = (int) (AbstractC2232Wl.A02 * 16.0f);
    }

    public JR(C2367ai c2367ai) {
        super(c2367ai, false);
        ...
        this.A0S = new DX() { // from class: com.facebook.ads.redexgen.X.5Z
            ...
            public final void A03(C14953d c14953d) {
                this.A00.A0R.A0h(EnumC2545db.A02, 20);
            }
        };
        this.A0U = new RunnableC2398bD(this);
        this.A0M = c2367ai.A06();
        this.A0Q = c2367ai;
        this.A0N = new C2172Ua(this.A0Q.A05().A25(), getAdEventManager());
        ...
        this.A0R.A0h(EnumC2545db.A02, 20);
        ...
        XP.A0I(this.A0E);
        AbstractC2350aR.A00(this.A0Q.A06(), this, this.A0Q.A05().A20().A0H().A08());
    ...
    private RelativeLayout A07(String str, int i10) {
        RelativeLayout relativeLayout = new RelativeLayout(this.A0M);
        relativeLayout.setPadding(AbstractC2363ae.A0A, AbstractC2363ae.A0A, AbstractC2363ae.A0A, AbstractC2363ae.A0A);
    ...
    private C2343aK A0D() {
        C2343aK c2343aK = new C2343aK(this.A0M);
        XP.A0K(c2343aK, 0);
        int i10 = (int) (this.A00 * 0.13f);
        new KZ(c2343aK, this.A0M).A05(i10, i10).A07(this.A0Q.A05().A23().A01());
        return c2343aK;
    }

    private C2345aM A0E() {
        C2345aM c2345aM = new C2345aM(this.A0M, A0c, 5, 0, -1);
        c2345aM.setRating(getRating());
        return c2345aM;
    }

    private E1 A0G() {
        E1 e12 = new E1(this.A0Q.A06());
        this.A09 = new C15003i(this.A0M, getAdEventManager(), e12, this.A0Q.A05().A25(), 0, 0, true, null, null);
        if (U7.A1v(this.A0M)) {
    ...
    private void A0K() {
        this.A0E.setOnClickListener(new ViewOnClickListenerC2400bF(this));
        if (this.A0Q.A05().A1g()) {
            this.A0L.setOnClickListener(new ViewOnClickListenerC2401bG(this));
        } else {
            this.A0G.setOnClickListener(new ViewOnClickListenerC2402bH(this));
        }
    }
    ...
    private void A0N() {
        if (this.A05 != null) {
            this.A05.setOnClickListener(new ViewOnClickListenerC2399bE(this));
        }
        A0S(8);
    }
    ...
    private void A0P() {
        ...
        layoutParams.setMargins(AbstractC2363ae.A0B, 0, 0, 0);
    ...
    private void A0T(int i10) {
        ...
        layoutParams.setMargins(0, 0, i10 == 1 ? A0Y : (int) (this.A01 * 0.1f), 0);
    ...
    private void A0U(int i10) {
        ...
        if (i10 == 1) {
            ...
            layoutParams.setMargins(0, AbstractC2363ae.A0A, 0, 0);
            layoutParams.addRule(14);
        } else {
            layoutParams.addRule(1, this.A0O.getId());
            layoutParams.setMargins(AbstractC2363ae.A0A, 0, 0, 0);
        }
    ...
    private void A0V(int i10) {
        ...
        layoutParams.setMargins(0, AbstractC2363ae.A0E, 0, 0);
        if (i10 == 1) {
            layoutParams.addRule(14);
        }
    ...
    private void A0W(int i10) {
        ...
        int i11 = AbstractC2363ae.A0A;
        if (i10 == 1) {
            i11 = A0Y;
        }
        layoutParams.setMargins(i11, 0, 0, AbstractC2363ae.A0A);
        layoutParams.addRule(12);
    ...
    private void A0Y(int i10) {
        ...
        layoutParams.addRule(3, this.A0K.getId());
        if (i10 == 1) {
            i11 = AbstractC2363ae.A0I;
            layoutParams.addRule(14);
        } else {
            i11 = AbstractC2363ae.A0E;
        }
        layoutParams.setMargins(0, i11, 0, 0);
        this.A0P.setLayoutParams(layoutParams);
        this.A0P.setItemSpacing(AbstractC2363ae.A0I);
    }

    private void A0Z(int i10) {
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams.addRule(3, this.A0P.getId());
        layoutParams.setMargins(0, i10 == 1 ? AbstractC2363ae.A0I : AbstractC2363ae.A0E, 0, 0);
        if (i10 == 1) {
            layoutParams.addRule(14);
        }
    ...
    private void A0a(int i10) {
        ...
        if (i10 == 1) {
            ...
            layoutParams.setMargins(A0a, AbstractC2363ae.A0A, A0a, 0);
        } else {
            layoutParams.addRule(3, this.A0O.getId());
            layoutParams.setMargins(0, AbstractC2363ae.A0C, 0, 0);
        }
    ...
    */
    ...
    private void A0g(int i10) {
        ...
        if (i10 == 1) {
            if (!this.A0Q.A05().A2H() || this.A04 == null) {
                ...
                i11 = AbstractC2363ae.A0A;
            }
            layoutParams.setMargins(A0Y, 0, A0Y, i11);
        } else {
            layoutParams.addRule(3, this.A0E.getId());
            int i12 = AbstractC2363ae.A0I;
            String[] strArr = A0W;
            if (strArr[2].length() == strArr[4].length()) {
                throw new RuntimeException();
            }
    ...
    private float getRating() {
        try {
            return Float.parseFloat(this.A0Q.A05().A20().A0I().A0B());
    ...
    private String getRatingText() {
        return String.format(Locale.US, A0J(7, 4, 37), Float.valueOf(getRating())) + A0J(0, 7, 95);
    }
