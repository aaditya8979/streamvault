...
public final class C1915Jy extends AbstractC2320Zv {
    ...
    static {
        A09();
        A0U = OP.A02(-1, 77);
        A0O = (int) (AbstractC2232Wl.A02 * 12.0f);
        A0P = (int) (AbstractC2232Wl.A02 * 8.0f);
        A0L = (int) (AbstractC2232Wl.A02 * 26.0f);
        A0N = (int) (AbstractC2232Wl.A02 * 144.0f);
        A0M = (int) (AbstractC2232Wl.A02 * 48.0f);
        A0Q = (int) (AbstractC2232Wl.A02 * 16.0f);
        A0V = (int) (AbstractC2232Wl.A02 * 14.0f);
        A0R = (int) (OE.A08 * 21.0f);
        A0S = (int) (OE.A08 * 12.0f);
        A0T = (int) (OE.A08 * 10.0f);
    }

    public C1915Jy(C2529dL c2529dL, KE ke2, int i10, boolean z10, C1992My c1992My, boolean z11, String str, US us2, InterfaceC2260Xn interfaceC2260Xn, C2602eX c2602eX, XH xh2, N3 n32, boolean z12, String str2, boolean z13) {
        super(c2529dL, ke2, i10, c1992My, z11, str, us2, interfaceC2260Xn, c2602eX, xh2, n32, z12, str2);
        this.A0C = false;
        this.A00 = 0;
        this.A01 = 0;
        this.A0A = true;
        ...
        this.A09 = new C2345aM(this.A0H, A0V, 5, A0U, -1);
    ...
    public C1915Jy(C2529dL c2529dL, KE ke2, int i10, boolean z10, C1992My c1992My, boolean z11, String str, US us2, InterfaceC2260Xn interfaceC2260Xn, C2602eX c2602eX, XH xh2, AbstractC2804hy abstractC2804hy) {
        this(c2529dL, ke2, i10, z10, c1992My, false, str, us2, interfaceC2260Xn, c2602eX, xh2, abstractC2804hy.A21(), abstractC2804hy.A1c(), abstractC2804hy.A0x(), abstractC2804hy.A1k());
    }
    ...
    private void A03() {
        ...
        this.A0D.addView(this.A03, this.A0I ? new LinearLayout.LayoutParams(-2, -2) : new LinearLayout.LayoutParams(-1, -2));
    }
    ...
    private void A04() {
        ...
        XP.A0I(this.A05);
        this.A05.setLayoutParams(AbstractC2320Zv.A0B);
    ...
    private void A07() {
        ...
        LinearLayout.LayoutParams layoutParams = this.A0I ? new LinearLayout.LayoutParams(-2, -2) : new LinearLayout.LayoutParams(-1, -2);
    ...
    private final void A0A() {
        ...
        layoutParams4.bottomMargin = A0P;
        this.A0D.addView(this.A0G, layoutParams4);
        this.A0D.setPadding(0, 0, 0, 0);
        this.A0G.setGravity(3);
    }

    private final void A0B() {
        super.A06.setLayoutParams(AbstractC2320Zv.A0B);
        A04();
        A03();
        if (super.A03) {
            A06();
