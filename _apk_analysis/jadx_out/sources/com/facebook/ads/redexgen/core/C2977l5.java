...
public final class C2977l5 extends HI {
    ...
    public C2977l5(H1 h12) {
        super(h12);
        this.A05 = new C4J(AbstractC1830Gq.A03);
        this.A04 = new C4J(4);
    }
    ...
    public final boolean A0B(C4J c4j) throws C2978l6 {
        ...
        int i11 = iA0I & 15;
        if (i11 != 7) {
            throw new C2978l6(A00(0, 28, 82) + i11);
        }
        this.A00 = i10;
        return i10 != 5;
    }
    ...
    public final boolean A0C(C4J c4j, long j10) throws C14742i {
        int iA0I = c4j.A0I();
        long jA0D = j10 + (((long) c4j.A0D()) * 1000);
        if (iA0I == 0 && !this.A02) {
        ...
        super.A00.AIA(jA0D, z10 ? 1 : 0, i12, 0, null);
        this.A03 = true;
        return true;
    }
}
