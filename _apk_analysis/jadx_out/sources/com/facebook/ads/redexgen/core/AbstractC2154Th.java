...
public abstract class AbstractC2154Th {
    ...
    public static InterfaceC2155Tj A00(C2503cu c2503cu) {
        try {
            return new C2212Vp(c2503cu);
        } catch (IOException e10) {
            c2503cu.A08().AAy(A02(0, 15, 104), AbstractC2142Sv.A2K, new C2143Sw(e10));
            return new W8();
        }
    }

    /* JADX WARN: Type inference failed for: r0v0, types: [com.facebook.ads.redexgen.X.6J] */
    public static C6J A01(C2503cu c2503cu) {
        return new WO(c2503cu) { // from class: com.facebook.ads.redexgen.X.6J
            ...
            private JSONArray A01(Cursor cursor) throws JSONException {
                ...
                while (cursor.moveToNext()) {
                    ...
                    jSONObject.put(A00(54, 2, 12), cursor.getString(C2502ct.A04.A00));
                    jSONObject.put(A00(82, 8, 79), cursor.getString(C2502ct.A09.A00));
                    jSONObject.put(A00(90, 4, 58), cursor.getString(C2502ct.A0A.A00));
                    jSONObject.put(A00(78, 4, 94), XG.A03(cursor.getDouble(C2502ct.A08.A00)));
                    jSONObject.put(A00(66, 12, 26), XG.A03(cursor.getDouble(C2502ct.A07.A00)));
                    jSONObject.put(A00(56, 10, 44), cursor.getString(C2502ct.A06.A00));
                    String string = cursor.getString(C2502ct.A03.A00);
                    jSONObject.put(A00(50, 4, 100), string != null ? new JSONObject(string) : new JSONObject());
                    jSONObject.put(A00(43, 7, 94), cursor.getString(C2502ct.A02.A00));
            ...
            public static JSONObject A03(Cursor cursor) throws JSONException {
                JSONObject jSONObject = new JSONObject();
                while (cursor.moveToNext()) {
                    jSONObject.put(cursor.getString(C2501cs.A03.A00), cursor.getString(C2501cs.A02.A00));
                }
                return jSONObject;
            }
            ...
            public final JSONArray A6k() {
                ...
                try {
                    ...
                    JSONArray jSONArrayA01 = cursorA0A.getCount() > 0 ? A01(cursorA0A) : null;
                    if (cursorA0A != null) {
                        cursorA0A.close();
                    }
                    return jSONArrayA01;
            ...
            public final JSONObject A6l() {
                ...
                try {
                    ...
                    JSONObject jSONObjectA03 = cursorA0B.getCount() > 0 ? A03(cursorA0B) : null;
                    if (cursorA0B != null) {
                        cursorA0B.close();
                    }
            ...
            public final String A7x(String str) {
                ...
                if (cursorA0D != null) {
                    ...
                    if (zMoveToNext && cursorA0D.getCount() > 0) {
                        string = cursorA0D.getString(cursorA0D.getColumnIndex(C2502ct.A0A.A01));
                    }
                    cursorA0D.close();
                }
                return string;
            ...
            public final void AKL(UP up2, AbstractC2153Tg<String> abstractC2153Tg) {
                this.A02.A0G(up2.A08(), up2.A05().A00, up2.A06().toString(), up2.A04(), up2.A03(), up2.A07(), up2.A09(), abstractC2153Tg);
            }
        };
    }
