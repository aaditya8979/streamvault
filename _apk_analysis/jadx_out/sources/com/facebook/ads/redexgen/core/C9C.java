...
public abstract class C9C extends Timeline {
    ...
    @Override // com.facebook.ads.androidx.media3.common.Timeline
    public C3177oN A0I(int i10, C3177oN c3177oN, boolean z10) {
        return this.A00.A0I(i10, c3177oN, z10);
    }

    @Override // com.facebook.ads.androidx.media3.common.Timeline
    public C3175oL A0L(int i10, C3175oL c3175oL, long j10) {
        return this.A00.A0L(i10, c3175oL, j10);
    }
