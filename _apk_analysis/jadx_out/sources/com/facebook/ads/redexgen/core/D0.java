...
public final class D0 extends ImageView implements InterfaceC2546dc {
    ...
    public final C2172Ua A03;
    public final DE A04;

    static {
        A06();
        A08 = (int) (AbstractC2232Wl.A02 * 40.0f);
        A07 = (int) (AbstractC2232Wl.A02 * 10.0f);
    }

    public D0(C2529dL c2529dL, C2172Ua c2172Ua) {
        super(c2529dL);
        ...
        A05();
        setOnClickListener(new ViewOnClickListenerC2563du(this));
    }
    ...
    public final void AJk(E1 e12) {
        if (this.A00 != null) {
            C2151Te<AbstractC2152Tf, C2150Td> eventBus = this.A00.getEventBus();
            DE de2 = this.A04;
            String[] strArr = A06;
