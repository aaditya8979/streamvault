...
public final class LZ implements InterfaceC2261Xo {
    ...
    public final DX A09 = new DX() { // from class: com.facebook.ads.redexgen.X.5v
        ...
        public final void A03(C14953d c14953d) {
            this.A00.A06.A4c(A00(0, 21, 51), c14953d);
        }
    };
    ...
    public LZ(C2529dL c2529dL, YT yt, US us2, InterfaceC2260Xn interfaceC2260Xn) {
        this.A04 = c2529dL;
        this.A05 = us2;
        this.A07 = yt;
        this.A08 = new E1(c2529dL);
        this.A08.A0i(new C3D(c2529dL));
        ...
        interfaceC2260Xn.A3x(this.A08, layoutParams);
        C2268Xv c2268Xv = new C2268Xv(c2529dL);
        c2268Xv.setOnClickListener(new YR(this));
        interfaceC2260Xn.A3x(c2268Xv, c2268Xv.getDefaultLayoutParams());
    }
    ...
    public final void AAl(Intent intent, Bundle bundle, R0 r02) {
        String strA02 = A02(8, 11, 127);
        if (bundle == null) {
            this.A03 = intent.getStringExtra(strA02);
        } else {
            this.A03 = bundle.getString(strA02);
        }
        String stringExtra = intent.getStringExtra(A02(19, 18, 7));
        if (stringExtra != null && !stringExtra.isEmpty()) {
            C2494cl c2494cl = new C2494cl(this.A04, stringExtra);
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
            int i10 = (int) (16.0f * AbstractC2232Wl.A02);
            layoutParams.setMargins(i10, i10, i10, i10);
            layoutParams.addRule(10);
            layoutParams.addRule(9);
            c2494cl.setOnClickListener(new YS(this));
            this.A06.A3x(c2494cl, layoutParams);
        }
        this.A00 = intent.getIntExtra(A02(77, 13, 119), 0);
        this.A02 = new C15003i(this.A04, this.A05, this.A08, this.A03, intent.getBundleExtra(A02(58, 11, 65)), null);
        if (U7.A1v(this.A04)) {
        ...
        if (intent.getBooleanExtra(A02(0, 8, 43), false)) {
            this.A08.A0h(EnumC2545db.A04, 17);
        }
    }
    ...
    public final void AF0(boolean z10) {
        ...
        this.A08.A0h(EnumC2545db.A04, 18);
    }
