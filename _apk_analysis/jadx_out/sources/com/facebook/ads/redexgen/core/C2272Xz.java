...
public final class C2272Xz extends AdNativeComponentView {
    public static final int A01 = (int) (AbstractC2232Wl.A02 * 1.0f);
    public final ImageView A00;

    public C2272Xz(C2529dL c2529dL) {
        super(c2529dL);
        this.A00 = new YM(c2529dL);
        this.A00.setScaleType(ImageView.ScaleType.CENTER_CROP);
        EnumC2237Wq.A04(this.A00, EnumC2237Wq.A0B);
