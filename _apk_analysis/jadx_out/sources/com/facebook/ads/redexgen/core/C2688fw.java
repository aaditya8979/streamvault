...
public class C2688fw implements InterfaceC2260Xn {
    ...
    public C2688fw(R0 r02) {
        this.A00 = new WeakReference<>(r02);
    }

    private void A00(R0 r02) {
        C2505cw c2505cwA07 = r02.A07();
        if (c2505cwA07 == null || r02.A04() == null) {
            return;
        }
        r02.A04().bringChildToFront(c2505cwA07);
    }
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2260Xn
    public void A4c(String str, C2150Td c2150Td) {
        if (this.A00.get() != null) {
            this.A00.get().A0E(str, c2150Td);
        }
    }
