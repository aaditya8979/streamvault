...
public abstract class KL extends AbstractC2320Zv {
    ...
    public final AbstractC2804hy A07;
    public final N9 A08;
    public final O2 A09;
    public final C2172Ua A0A;
    public final InterfaceC2260Xn A0B;
    ...
    public final C1990Mw A0R;
    public final C1992My A0S;
    public final C2529dL A0T;
    public final C1732Cw A0U;
    ...
    static {
        A0Y();
        A0i = (int) (AbstractC2232Wl.A02 * 44.0f);
        A0b = (int) (AbstractC2232Wl.A02 * 52.0f);
        A0s = (int) (AbstractC2232Wl.A02 * 4.0f);
        A0u = (int) (AbstractC2232Wl.A02 * 8.0f);
        A0j = (int) (AbstractC2232Wl.A02 * 12.0f);
        A0k = (int) (AbstractC2232Wl.A02 * 14.0f);
        A0l = (int) (AbstractC2232Wl.A02 * 16.0f);
        A0m = (int) (AbstractC2232Wl.A02 * 18.0f);
        A0n = (int) (AbstractC2232Wl.A02 * 20.0f);
        A0o = (int) (AbstractC2232Wl.A02 * 24.0f);
        A0p = (int) (AbstractC2232Wl.A02 * 26.0f);
        A0q = (int) (AbstractC2232Wl.A02 * 28.0f);
        A0r = (int) (AbstractC2232Wl.A02 * 32.0f);
        A0t = (int) (AbstractC2232Wl.A02 * 40.0f);
        A0f = (int) (AbstractC2232Wl.A02 * 48.0f);
        A0g = (int) (AbstractC2232Wl.A02 * 100.0f);
        A0h = (int) (AbstractC2232Wl.A02 * 112.0f);
        A0c = (int) (AbstractC2232Wl.A02 * 16.0f);
        A0e = OP.A02(-1, 128);
        A0d = OP.A02(-1, 17);
        A0v = (int) (AbstractC2232Wl.A02 * 12.0f);
    }

    public KL(C2529dL c2529dL, KE ke2, int i10, boolean z10, C1992My c1992My, boolean z11, String str, US us2, InterfaceC2260Xn interfaceC2260Xn, C2602eX c2602eX, XH xh2, AbstractC2804hy abstractC2804hy, C1732Cw c1732Cw, C2172Ua c2172Ua, boolean z12) {
        super(c2529dL, ke2, i10, c1992My, z11, str, us2, interfaceC2260Xn, c2602eX, xh2, abstractC2804hy.A21(), abstractC2804hy.A1c(), abstractC2804hy.A0x());
        this.A0W = new AtomicBoolean(true);
        this.A0V = new RunnableC2321Zw(this);
        this.A0D = new RunnableC2322Zx(this);
        this.A0C = new RunnableC2323Zy(this);
        this.A0A = c2172Ua;
        this.A07 = abstractC2804hy;
        this.A09 = O3.A00(c2529dL.A02());
        this.A0B = interfaceC2260Xn;
        this.A0E = abstractC2804hy.A25();
        this.A08 = abstractC2804hy.A23();
        this.A0S = c1992My;
        this.A0R = abstractC2804hy.A20().A0I();
        this.A0T = c2529dL;
        this.A0X = z10;
        this.A0Y = z12;
        ...
        if (this.A0Y) {
            ...
            this.A0I.setOnClickListener(AbstractC2354aV.A03(super.A08, A0R(6, 10, 11)));
        } else {
        ...
        this.A0K = A0J();
        XP.A0I(this.A0K);
        this.A0K.setOnClickListener(new ViewOnClickListenerC2324Zz(this));
        A0p(8);
        ...
        if (this.A07.A0v().equals(A0R(60, 14, 21)) && !abstractC2804hy.A1Z() && this.A06 > 0) {
            this.A04 = A0O();
            XP.A0I(this.A04);
        }
    ...
    private RelativeLayout A0L() {
        RelativeLayout relativeLayout = new RelativeLayout(this.A0T);
        new RelativeLayout.LayoutParams(-1, -2).addRule(16);
        XP.A0I(relativeLayout);
        return relativeLayout;
    }
    ...
    private TextView A0N() {
        ...
        textView.setText(this.A0Y ? this.A0R.A0F() : this.A0R.A0E());
    ...
    private TextView A0P() {
        TextView textView = new TextView(this.A0T);
        textView.setText(this.A0Y ? this.A0R.A0E() : this.A0R.A0F());
        textView.setTextColor(-1);
    ...
    private C1732Cw A0Q(C1732Cw c1732Cw) {
        if (c1732Cw == null) {
            c1732Cw = new C1732Cw(this.A0T, -1);
            c1732Cw.setVisibility(8);
        }
        c1732Cw.A08(A0e, A0d, true);
        c1732Cw.setPadding(0, 0, 0, 0);
        c1732Cw.setLayoutParams(new RelativeLayout.LayoutParams(-1, A0v));
        return c1732Cw;
    }
    ...
    public final void A0g() {
        super.A09.setOnClickListener(AbstractC2354aV.A03(super.A08, A0R(27, 4, 19)));
        this.A0Q.setOnClickListener(AbstractC2354aV.A03(super.A08, A0R(74, 5, 18)));
        this.A0P.setOnClickListener(AbstractC2354aV.A03(super.A08, A0R(16, 11, 125)));
        this.A0U.setOnClickListener(AbstractC2354aV.A03(super.A08, A0R(48, 12, 20)));
        if (this.A04 != null) {
            this.A04.setOnClickListener(AbstractC2354aV.A03(super.A08, A0R(31, 17, 106)));
        }
    }
    ...
    public final void A0m() {
        float height = super.A08.getHeight() * 0.1f;
        this.A00 = new AnimatorSet();
        String strA0R = A0R(79, 12, 27);
        ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(super.A08, strA0R, -height, 0.0f);
        ObjectAnimator objectAnimatorOfFloat2 = ObjectAnimator.ofFloat(this.A0I, strA0R, -height, 0.0f);
        objectAnimatorOfFloat.setInterpolator(new LinearInterpolator());
        objectAnimatorOfFloat2.setInterpolator(new LinearInterpolator());
        this.A00.playTogether(objectAnimatorOfFloat, objectAnimatorOfFloat2);
    ...
    public final void A0o(int i10) {
        if (this.A04 != null) {
            ...
            this.A04.setText(this.A07.A24().A02().replace(A0R(0, 6, 101), String.valueOf(iMax)));
        }
    }
    ...
    public final void A0t(ViewGroup viewGroup, boolean z10, boolean z11, int i10) {
        ...
        if (!z10) {
            this.A0U.setLayoutParams(new RelativeLayout.LayoutParams(-1, A0v));
            if (this.A04 != null) {
        ...
        if (i11 == 2 && z11) {
            ...
            viewGroup.addView(this.A0K);
            String[] strArr = A0a;
            if (strArr[0].charAt(21) == strArr[1].charAt(21)) {
                throw new RuntimeException();
            }
    ...
    public C1732Cw getProgressBarAnimation() {
        return this.A0U;
    }
    ...
    public void setPlaceHolderTextForRewardsConversion(String str) {
        if (this.A04 != null) {
            ...
            textView.setOnClickListener(AbstractC2354aV.A03(super.A08, A0R(31, 17, 106)));
        }
    }
}
