...
public class C2708gH extends AbstractC2071Qb {
    ...
    public C2708gH(Context context) {
    ...
    private final int A03(View view, int i10) {
        ...
        return A0N(qoA08.A0q(view) - qp2.topMargin, qoA08.A0l(view) + qp2.bottomMargin, qoA08.A0i(), qoA08.A0Z() - qoA08.A0f(), i10);
    }
    ...
    private final void A07(QZ qz) {
        ...
        qz.A04(i10, i11, (int) (iA0L * 1.2f), this.A05);
    }

    @Override // com.facebook.ads.redexgen.core.AbstractC2071Qb
    ...
    @Override // com.facebook.ads.redexgen.core.AbstractC2071Qb
    public final void A0H(int i10, int i11, C2073Qd c2073Qd, QZ qz) {
        if (A06() == 0) {
            A09();
            if (A07[2].length() != 19) {
                throw new RuntimeException();
    ...
    public int A0O(View view, int i10) {
        ...
        QP qp2 = (QP) view.getLayoutParams();
        return A0N(qoA08.A0m(view) - qp2.leftMargin, qoA08.A0p(view) + qp2.rightMargin, qoA08.A0g(), qoA08.A0j() - qoA08.A0h(), i10);
    }

    public PointF A0P(int i10) {
        Object objA08 = A08();
        if (objA08 instanceof InterfaceC2070Qa) {
            return ((InterfaceC2070Qa) objA08).A4y(i10);
        }
        Log.w(A04(0, 20, 26), A04(20, 93, 94) + InterfaceC2070Qa.class.getCanonicalName());
        return null;
    }
}
