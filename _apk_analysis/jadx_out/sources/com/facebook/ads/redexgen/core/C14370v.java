...
public final class C14370v extends AbstractC16037h {
    ...
    public int A03;
    public long A05;
    public List<C3157o2> A07;
    public List<C3157o2> A08;
    public boolean A09;
    public boolean A0A;
    public boolean A0B;
    ...
    static {
        ...
        A0P = new int[]{195, 227, 205, 204, 236, 210, 242, Sdk.SDKError.Reason.INVALID_ADUNIT_BID_PAYLOAD_VALUE, 245, 123, 125, 92, 94, 95, 124, 126, 196, 228, Sdk.SDKError.Reason.INVALID_GZIP_BID_PAYLOAD_VALUE, 246, Sdk.SDKError.Reason.STALE_CACHED_RESPONSE_VALUE, 165, 164, 9474, 197, 229, Sdk.SDKError.Reason.AD_RESPONSE_INVALID_TEMPLATE_TYPE_VALUE, 248, 9484, 9488, 9492, 9496};
    ...
    public C14370v(String str, int i10, long j10) {
    ...
    private List<C3157o2> A07() {
        int iMin = 2;
        int size = this.A0H.size();
        ArrayList arrayList = new ArrayList(size);
        for (int i10 = 0; i10 < size; i10++) {
            C3157o2 c3157o2A08 = this.A0H.get(i10).A08(Integer.MIN_VALUE);
            arrayList.add(c3157o2A08);
            if (c3157o2A08 != null) {
                iMin = Math.min(iMin, c3157o2A08.A08);
            }
        }
        ArrayList arrayList2 = new ArrayList(size);
        for (int i11 = 0; i11 < size; i11++) {
            C3157o2 c3157o2 = (C3157o2) arrayList.get(i11);
            if (c3157o2 != null) {
                if (c3157o2.A08 != iMin) {
                    c3157o2 = (C3157o2) C3M.A01(this.A0H.get(i11).A08(iMin));
                }
                arrayList2.add(c3157o2);
            }
        }
        return arrayList2;
    }
    ...
    public static void A09() {
        A0I = new byte[]{10, 44, 40, 127, 121, 113, 13, 44, ExifInterface.START_CODE, 38, 45, 44, 59, 90, 125, 101, 114, 127, 122, 119, 51, 112, 123, 114, 125, 125, 118, 127, 61, 51, 87, 118, 117, 114, 102, 127, 103, 122, 125, 116, 51, 103, 124, 51, 80, 80, 34, 61, 7, 22, 22, 10, 15, 5, 7, 18, 15, 9, 8, 73, 30, 75, 11, 22, 82, 75, 5, 3, 7, 75, 80, 86, 94};
    }

    private void A0A(byte b10) {
        this.A06.A0B(' ');
        this.A06.A0F((b10 >> 1) & 7, (b10 & 1) == 1);
    }
    ...
    private void A0C(byte b10, byte b11) {
        ...
        int i11 = (b11 >> 1) & 7;
        this.A06.A0F(z10 ? 8 : i11, (b11 & 1) == 1);
        if (z10) {
            this.A06.A02 = A0L[i11];
        }
    }
    ...
    private void A0E(int i10) {
        ...
        this.A02 = i10;
        if (i10 == 3) {
            for (int i12 = 0; i12 < this.A0H.size(); i12++) {
                this.A0H.get(i12).A0D(i10);
            }
            return;
        }
        A08();
    ...
    @Override // com.facebook.ads.redexgen.core.AbstractC16037h
    /* JADX INFO: renamed from: A0W */
    public final /* bridge */ /* synthetic */ C16057j A5j() throws C2944kM {
        return super.A5j();
    }

    @Override // com.facebook.ads.redexgen.core.AbstractC16037h, com.facebook.ads.redexgen.core.C5O
    /* JADX INFO: renamed from: A0X, reason: merged with bridge method [inline-methods] */
    public final AbstractC16047i A5l() throws C2944kM {
        AbstractC16047i abstractC16047iA0Y;
        AbstractC16047i abstractC16047iA5l = super.A5l();
        if (abstractC16047iA5l != null) {
            return abstractC16047iA5l;
        }
        if (!A0G() || (abstractC16047iA0Y = A0Y()) == null) {
            return null;
        }
        this.A07 = Collections.emptyList();
        this.A05 = -9223372036854775807L;
        abstractC16047iA0Y.A0C(A0V(), A0Z(), Long.MAX_VALUE);
        return abstractC16047iA0Y;
    }

    @Override // com.facebook.ads.redexgen.core.AbstractC16037h
    public final C2940kI A0Z() {
        this.A08 = this.A07;
        return new C2940kI((List) C3M.A01(this.A07));
    }

    @Override // com.facebook.ads.redexgen.core.AbstractC16037h
    /* JADX INFO: renamed from: A0a */
    public final /* bridge */ /* synthetic */ void AGZ(C16057j c16057j) throws C2944kM {
        super.AGZ(c16057j);
    }

    @Override // com.facebook.ads.redexgen.core.AbstractC16037h
    public final void A0b(C16057j c16057j) {
        ByteBuffer byteBuffer = (ByteBuffer) C3M.A01(c16057j.A02);
        this.A0G.A0j(byteBuffer.array(), byteBuffer.limit());
        boolean z10 = false;
        while (true) {
                    ...
                    if (A0S(this.A09, b10, b11)) {
                        ...
                        if (this.A0A && A0H(b10)) {
                            if (!A0I(b10)) {
                                ...
                                if ((b11 & 224) != 0) {
                                    this.A06.A0B(A00(b11));
                                }
                            } else if (A0Q(b10, b11)) {
                                this.A06.A0B(A03(b11));
                            } else if (A0M(b10, b11)) {
                                this.A06.A09();
                                this.A06.A0B(A04(b10, b11));
                            } else if (A0N(b10, b11)) {
                                A0A(b11);
                            } else if (A0P(b10, b11)) {
                                A0C(b10, b11);
    ...
    @Override // com.facebook.ads.redexgen.core.AbstractC16037h, com.facebook.ads.redexgen.core.InterfaceC2945kN
