...
public abstract class C3U {
    ...
    public static Pair<Integer, Integer> A00(byte[] bArr) {
        ...
        int iA0I = c4j.A0I();
        c4j.A0f(20);
        return Pair.create(Integer.valueOf(c4j.A0L()), Integer.valueOf(iA0I));
    }
    ...
    public static String A03(int i10, boolean z10, int i11, int i12, int[] iArr, int i13) {
        StringBuilder sb2 = new StringBuilder(AbstractC15184a.A0n(A02(25, 17, 35), A03[i10], Integer.valueOf(i11), Integer.valueOf(i12), Character.valueOf(z10 ? 'H' : 'L'), Integer.valueOf(i13)));
    ...
    public static byte[] A07(byte[] bArr, int i10, int i11) {
        ...
        System.arraycopy(bArr, i10, bArr2, A02.length, i11);
        return bArr2;
    }
}
