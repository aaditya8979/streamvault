...
public final class H2 {
    ...
    public final void A03(InterfaceC2995lN interfaceC2995lN) throws IOException {
        if (this.A05) {
            return;
        }
        interfaceC2995lN.AG9(this.A06, 0, 10);
    ...
    public final void A04(H1 h12, long j10, int i10, int i11, int i12, C1839Gz c1839Gz) {
    ...
    public final void A05(H1 h12, C1839Gz c1839Gz) {
        if (this.A02 > 0) {
            h12.AIA(this.A04, this.A00, this.A03, this.A01, c1839Gz);
            this.A02 = 0;
        }
    }
}
