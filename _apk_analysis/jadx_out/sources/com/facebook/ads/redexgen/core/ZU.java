...
public final class ZU extends LinearLayout {
    ...
    static {
        A02();
        A07 = (int) (AbstractC2232Wl.A03 * 2.0f);
        A06 = (int) (AbstractC2232Wl.A02 * 12.0f);
    }

    public ZU(C2529dL c2529dL) {
        super(c2529dL);
        this.A03 = c2529dL;
        A01();
    }
    ...
    public static String A00(int i10, int i11, int i12) {
        ...
        for (int i13 = 0; i13 < bArrCopyOfRange.length; i13++) {
            ...
            bArrCopyOfRange[i13] = (byte) ((b10 ^ i12) ^ 11);
        }
    ...
    public void setSubtitle(@Nullable String str) {
        if (!TextUtils.isEmpty(str)) {
            ...
            this.A01.setCompoundDrawablesRelativeWithIntrinsicBounds(A00(0, 5, 125).equals(uriA00.getScheme()) ? new BitmapDrawable(getResources(), getPadlockBitmap()) : null, (Drawable) null, (Drawable) null, (Drawable) null);
