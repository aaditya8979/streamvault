...
public class AY extends Exception {
    ...
    public AY(C3206or c3206or, Throwable th2, boolean z10, int i10) {
        this(A03(23, 22, 80) + i10 + A03(45, 3, 19) + c3206or, th2, c3206or.A0W, z10, null, A02(i10), null);
    }

    public AY(C3206or c3206or, Throwable th2, boolean z10, AR ar2) {
        this(A03(2, 21, 4) + ar2.A03 + A03(0, 2, 93) + c3206or, th2, c3206or.A0W, z10, ar2, AbstractC15184a.A02 >= 21 ? A04(th2) : null, null);
    }
    ...
    public static String A02(int i10) {
        return A03(48, 73, 15) + (i10 < 0 ? A03(121, 4, 59) : A03(0, 0, 98)) + Math.abs(i10);
    }
