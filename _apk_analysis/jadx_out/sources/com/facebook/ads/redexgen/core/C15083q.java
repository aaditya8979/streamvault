...
public final class C15083q extends NI {
    ...
    public AbstractC2804hy A03;
    public SF A04;
    public C14230h A05;
    public C2342aJ A06;
    public FH A07;
    public AbstractC2601eW A08;
    public C2602eX A09;
    public String A0A;
    public List<C2496cn> A0B;
    public boolean A0C;
    ...
    static {
        ...
        A0I = (int) (AbstractC2232Wl.A02 * 8.0f);
        A0J = (int) (AbstractC2232Wl.A02 * 8.0f);
        A0L = (int) (AbstractC2232Wl.A02 * 56.0f);
        A0K = (int) (AbstractC2232Wl.A02 * 12.0f);
    }

    public C15083q(C2529dL c2529dL, US us2, SF sf2, InterfaceC2260Xn interfaceC2260Xn, AnonymousClass73 anonymousClass73) {
        super(c2529dL, us2, interfaceC2260Xn, anonymousClass73);
        this.A0E = new XH();
        this.A0C = false;
        super.A07 = true;
        super.A06 = new C2526dI(c2529dL, new LX(), super.A0A.A1A(), interfaceC2260Xn);
        this.A04 = sf2;
        this.A0D = c2529dL;
    }

    public C15083q(C2529dL c2529dL, US us2, SF sf2, InterfaceC2260Xn interfaceC2260Xn, AnonymousClass77 anonymousClass77) {
        super(c2529dL, us2, interfaceC2260Xn, anonymousClass77);
        this.A0E = new XH();
        this.A0C = false;
        this.A04 = sf2;
        this.A0D = c2529dL;
    ...
    */
    public com.facebook.ads.redexgen.core.ME A01(java.lang.String r7) {
        /*
            r6 = this;
            com.facebook.ads.redexgen.X.ME r5 = com.facebook.ads.redexgen.core.ME.A09
        ...
        L7:
            ...
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C15083q.A0G
            r0 = 5
            r1 = r2[r0]
            r0 = 6
            r2 = r2[r0]
            ...
            com.facebook.ads.redexgen.X.Ev r3 = (com.facebook.ads.redexgen.core.C1783Ev) r3
            if (r3 == 0) goto L7d
            ...
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.C15083q.A0G
            r0 = 2
            r1 = r1[r0]
            r0 = 16
            char r1 = r1.charAt(r0)
        ...
        L91:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C15083q.A01(java.lang.String):com.facebook.ads.redexgen.X.ME");
    }

    private AbstractC2804hy A02(Intent intent) {
        return super.A07 ? (AbstractC2804hy) intent.getSerializableExtra(A0C(14, 25, 103)) : (AbstractC2804hy) intent.getSerializableExtra(A0C(0, 14, 36));
    }
    ...
    private final void A0G(int i10, Bundle bundle) {
        ...
        int i13 = AbstractC2232Wl.A04.widthPixels;
        int i14 = AbstractC2232Wl.A04.heightPixels;
        if (i10 == 1) {
            iMin = Math.min(i13 - (A0I * 4), i14 / 2);
            i11 = (i13 - iMin) / 8;
            i12 = i11 * 4;
        } else {
            iMin = i14 - ((A0L + A0H) + (A0I * 4));
            i11 = A0I;
            i12 = i11 * 2;
        }
        this.A08 = new F3(this);
        this.A09 = new C2602eX(this, 1, new WeakReference(this.A08), this.A0D);
        this.A09.A0W(this.A00);
        this.A09.A0X(this.A01);
        this.A05 = new C14230h(this.A0D);
        this.A05.setLayoutParams(new RelativeLayout.LayoutParams(-1, -2));
        this.A07 = new FH(this.A05, i10, this.A0B, this.A09, bundle);
        int i15 = iMin;
        this.A05.setAdapter(new F4(this.A0D, this.A0B, this.A03, super.A0C, this.A04, this.A09, this.A0E, getAudienceNetworkListener(), this.A0A, i15, i11, i12, i10, this.A07, super.A0E));
    ...
    private void A0H(AbstractC2804hy abstractC2804hy) {
        this.A03 = abstractC2804hy;
        this.A0A = this.A03.A25();
        this.A00 = this.A03.A0i();
        this.A01 = this.A03.A0j();
        List<C1983Mp> listA27 = this.A03.A27();
        this.A0B = new ArrayList(listA27.size());
        for (int i10 = 0; i10 < listA27.size(); i10++) {
            this.A0B.add(new C2496cn(i10, listA27.size(), listA27.get(i10)));
        }
    }

    private void A0I(FH fh2) {
        new C15776h().A0G(this.A05);
        fh2.A0Y(new F1(this));
        this.A06 = new C2342aJ(this.A0D, super.A05.A01(), this.A0B.size());
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(-1, A0J);
        layoutParams.setMargins(0, A0K, 0, 0);
        this.A06.setLayoutParams(layoutParams);
    }

    @Override // com.facebook.ads.redexgen.core.NI
    public final void A0W() {
        ME meA01 = A01(A0C(39, 4, 2));
        if (super.A0A.A2D() || meA01 == ME.A09 || meA01 == ME.A06) {
            return;
        }
        A0f();
    }
    ...
    public final void AAl(Intent intent, Bundle bundle, R0 r02) {
        AbstractC2804hy abstractC2804hyA02 = A02(intent);
        A0Z(r02);
        A0H(abstractC2804hyA02);
        A0G(r02.A05().getResources().getConfiguration().orientation, bundle);
        r02.A0A(new F0(this, r02));
        int iA04 = super.A0A.A20().A0H().A04();
        if (super.A07) {
            iA04 = super.A0A.A20().A0H().A03();
        }
        if (iA04 > 0) {
            A0X(iA04);
        }
        if (super.A0A.A20().A0H().A02() >= 0) {
            super.A0E.setToolbarActionMode(8);
        }
        if (super.A0A.A2K()) {
            super.A0E.setOnClickListener(new ViewOnClickListenerC2499cq(this));
        }
    }

    @Override // com.facebook.ads.redexgen.core.NI, com.facebook.ads.redexgen.core.InterfaceC2261Xo
    ...
    @Override // com.facebook.ads.redexgen.core.NI, android.view.View
    ...
    public final void onDestroy() {
        ...
        if (!TextUtils.isEmpty(this.A0A)) {
            super.A0C.AAt(this.A0A, new C2314Zp().A03(this.A09).A02(this.A0E).A05());
        }
        A0F();
        this.A09.A0V();
        this.A09 = null;
