...
public abstract class AbstractC2690fy extends QR {
    ...
    public C15766g A00;
    public Scroller A01;
    public final QT A02 = new C2691fz(this);

    static {
        A09();
    }

    private final C2708gH A05(QO qo2) {
        return A0E(qo2);
    }
    ...
    private boolean A0A(QO qo2, int i10, int i11) {
        C2708gH c2708gHA05;
        int iA0C;
        if (!(qo2 instanceof InterfaceC2070Qa) || (c2708gHA05 = A05(qo2)) == null || (iA0C = A0C(qo2, i10, i11)) == -1) {
            return false;
        }
        c2708gHA05.A0A(iA0C);
        qo2.A1N(c2708gHA05);
    ...
    @Deprecated
    public abstract C2708gH A0E(QO qo2);
    ...
    public final void A0G(C15766g c15766g) throws IllegalStateException {
        if (this.A00 == c15766g) {
            return;
        }
        C15766g c15766g2 = this.A00;
