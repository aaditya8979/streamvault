...
public final class C2121Sa extends SQLiteOpenHelper {
    ...
    static {
        A02();
        A03 = C2121Sa.class.getSimpleName();
    }

    public C2121Sa(C2503cu c2503cu, SZ sz) {
        super(c2503cu, A01(c2503cu), (SQLiteDatabase.CursorFactory) null, 4);
        if (sz == null) {
    ...
    public static String A01(C2503cu c2503cu) {
        ...
        String packageName = c2503cu.getPackageName();
        String processName = ProcessUtils.getProcessName(c2503cu);
        return (packageName.equals(processName) || TextUtils.isEmpty(processName)) ? str : String.format(Locale.US, strA00, '_' + processName);
    }

    public static void A02() {
        A01 = new byte[]{-105, 101, -119, -118, -117, -122, -102, -111, -103, 101, 117, 0, 11, 19, 4, 17, -33, 19, 0, 1, 11, 4, -33, 36, 53, 36, 45, 51, 50, -33, 0, 3, 3, -33, 2, 14, 11, 20, 12, 13, -33, -122, -87, -119, -90, -71, -90, -89, -90, -72, -86, -115, -86, -79, -75, -86, -73, 101, -88, -90, -77, 101, -77, -76, -71, 101, -89, -86, 101, -77, -70, -79, -79, -16, -2, -5, -4, -52, 0, -19, -18, -8, -15, -52, -11, -14, -52, -15, 4, -11, -1, 0, -1, -52, 15, 30, 13, 31, 20, 17, 31, -10, -8, -25, -19, -13, -25, -58, 12, 21, 24, 11, 15, 13, 20, 5, 17, 11, 31, 25, -58, -29, -58, -11, -12, ExifInterface.MARKER_APP1, -51, -48, -33, -111, -33, -102, -48, -50};
        if (A02[7].length() == 23) {
    ...
    public final void onCreate(SQLiteDatabase sQLiteDatabase) {
        for (AbstractC2124Sd abstractC2124Sd : this.A00.A0M()) {
            abstractC2124Sd.A07(sQLiteDatabase);
        }
    }
    ...
    public final void onDowngrade(SQLiteDatabase sQLiteDatabase, int i10, int i11) {
        for (AbstractC2124Sd abstractC2124Sd : this.A00.A0M()) {
            abstractC2124Sd.A08(sQLiteDatabase);
            abstractC2124Sd.A07(sQLiteDatabase);
        }
    }
