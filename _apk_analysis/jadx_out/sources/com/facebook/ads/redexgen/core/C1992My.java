...
public final class C1992My implements Serializable {
    ...
    public C1992My(int i10, int i11, int i12, int i13, int i14, int i15, int i16, int i17, int i18, int i19) {
        this.A00 = i10;
        this.A01 = i11;
        this.A02 = i12;
        this.A03 = i13;
    ...
    public static int A00(JSONObject jSONObject, String str, int i10) {
        return (jSONObject == null || !jSONObject.has(str)) ? i10 : Color.parseColor(jSONObject.optString(str));
    }

    public static C1992My A01(JSONObject jSONObject) {
        return new C1992My(A00(jSONObject, A02(37, 12, 27), A0B), A00(jSONObject, A02(57, 10, 112), A0C), A00(jSONObject, A02(152, 14, 101), ViewCompat.MEASURED_STATE_MASK), A00(jSONObject, A02(49, 8, 114), A0D), A00(jSONObject, A02(67, 9, 116), A0E), A00(jSONObject, A02(76, 20, 103), -1), A00(jSONObject, A02(113, 14, 73), -1), A00(jSONObject, A02(127, 25, 121), A0G), A00(jSONObject, A02(166, 11, 113), ViewCompat.MEASURED_STATE_MASK), A00(jSONObject, A02(96, 17, 106), A0E));
    }
