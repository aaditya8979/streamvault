...
public final class C0O extends AnonymousClass14 {
    ...
    public C0O(Context context, C2801hv c2801hv, MediaCodecRendererMetaParameters mediaCodecRendererMetaParameters, InterfaceC1678Ar interfaceC1678Ar, long j10, C9U c9u, boolean z10, boolean z11, Handler handler, InterfaceC1802Fo interfaceC1802Fo, int i10, int i11, int i12, int i13, int i14) {
        super(2, c2801hv, mediaCodecRendererMetaParameters, interfaceC1678Ar, c9u, z10, z11, i12, i13);
        this.A0e = true;
        this.A0Z = true;
        boolean z12 = false;
        this.A0f = false;
        ...
        this.A0c = false;
        this.A0h = false;
        this.A0w = MetaExoPlayerUpgradeConfig.A03(EnumC2805i2.A1r);
        this.A0h = MetaExoPlayerUpgradeConfig.A03(EnumC2805i2.A0w);
        this.A0p = j10;
        this.A0l = i10;
        this.A0m = i11;
        ...
        this.A0u = new C1801Fn(handler, interfaceC1802Fo);
        this.A0r = new FC(this.A0s, this, this.A0w);
        this.A0v = A0i();
        if (AbstractC15184a.A02 == 29 && AbstractC15184a.A06.startsWith(A0B(811, 6, 62))) {
            z12 = true;
        }
        this.A0a = z12;
    ...
    private int A00(C3206or c3206or) {
        if (c3206or.A0B == -1) {
            return A02(c3206or.A0W, c3206or.A0L, c3206or.A0A);
        }
        int length = 0;
        int size = c3206or.A0X.size();
        for (int i10 = 0; i10 < size; i10++) {
            length += c3206or.A0X.get(i10).length;
        }
        return c3206or.A0B + length;
    }
    ...
    */
    public static int A01(com.facebook.ads.redexgen.core.InterfaceC1678Ar r8, com.facebook.ads.redexgen.core.C3206or r9, boolean r10) throws com.facebook.ads.redexgen.core.C1682Av {
        /*
            Method dump skipped, instruction units count: 373
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C0O.A01(com.facebook.ads.redexgen.X.Ar, com.facebook.ads.redexgen.X.or, boolean):int");
    }
    ...
    */
    public static int A02(java.lang.String r7, int r8, int r9) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C0O.A02(java.lang.String, int, int):int");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public long A03(long j10, long j11, long j12, long j13, boolean z10) {
        long jA1f = (long) ((j13 - j10) / ((double) A1f()));
        return z10 ? jA1f - (j12 - j11) : jA1f;
    }

    public static Point A07(AR ar2, C3206or c3206or) throws C1682Av {
        boolean z10 = c3206or.A0A > c3206or.A0L;
        int i10 = z10 ? c3206or.A0A : c3206or.A0L;
        int i11 = z10 ? c3206or.A0L : c3206or.A0A;
        float f10 = i11 / i10;
        for (int i12 : A13) {
            int i13 = (int) (i12 * f10);
            if (i12 <= i10 || i13 <= i11) {
            ...
            if (AbstractC15184a.A02 >= 21) {
                ...
                Point pointA0N = ar2.A0N(i14, i12);
                if (ar2.A0R(pointA0N.x, pointA0N.y, c3206or.A01)) {
                    return pointA0N;
                }
            } else {
                int iA05 = AbstractC15184a.A05(i12, 16) * 16;
                int iA052 = AbstractC15184a.A05(i13, 16) * 16;
                if (iA05 * iA052 <= C1685Ay.A00()) {
                    int i15 = z10 ? iA052 : iA05;
                    if (!z10) {
                        iA05 = iA052;
                    }
    ...
    private final MediaFormat A08(C3206or c3206or, FA fa2, boolean z10, int i10) {
        MediaFormat mediaFormat = new MediaFormat();
        mediaFormat.setString(A0B(1462, 4, 83), c3206or.A0W);
        mediaFormat.setInteger(A0B(1755, 5, 79), c3206or.A0L);
        mediaFormat.setInteger(A0B(1307, 6, 73), c3206or.A0A);
        AnonymousClass46.A06(mediaFormat, c3206or.A0X);
        AnonymousClass46.A03(mediaFormat, A0B(1286, 10, 109), c3206or.A01);
        AnonymousClass46.A04(mediaFormat, A0B(1548, 16, 7), c3206or.A0F);
        AnonymousClass46.A02(mediaFormat, c3206or.A0N);
        mediaFormat.setInteger(A0B(1447, 9, 1), fa2.A02);
        mediaFormat.setInteger(A0B(1423, 10, 25), fa2.A00);
        ...
        AbstractC2783hY.A03(this.A11, mediaFormat);
        if (i10 != 0) {
            A0T(mediaFormat, i10);
        }
        return mediaFormat;
    ...
    private final FA A0A(AR ar2, C3206or c3206or, C3206or[] c3206orArr) throws C1682Av {
        int iMax = c3206or.A0L;
        int iMax2 = c3206or.A0A;
        int iA00 = A00(c3206or);
        if (c3206orArr.length == 1) {
            return new FA(iMax, iMax2, iA00);
        }
        boolean z10 = false;
        for (C3206or c3206or2 : c3206orArr) {
            if (A0v(ar2.A04, c3206or, c3206or2)) {
                z10 |= c3206or2.A0L == -1 || c3206or2.A0A == -1;
                int i10 = c3206or2.A0L;
                if (A12[6].charAt(29) == 'x') {
                    throw new RuntimeException();
                }
                A12[2] = "vHVCHU2tj4jzHHyhZwddXygsl3jVFph7";
                iMax = Math.max(iMax, i10);
                iMax2 = Math.max(iMax2, c3206or2.A0A);
                iA00 = Math.max(iA00, A00(c3206or2));
            }
        }
        if (z10) {
            ...
            AnonymousClass44.A07(strA0B2, string);
            Point pointA07 = A07(ar2, c3206or);
            if (pointA07 != null) {
                iMax = Math.max(iMax, pointA07.x);
                iMax2 = Math.max(iMax2, pointA07.y);
                iA00 = Math.max(iA00, A02(c3206or.A0W, iMax, iMax2));
                AnonymousClass44.A07(strA0B2, A0B(246, 34, 11) + iMax + strA0B + iMax2);
            }
        }
        return new FA(iMax, iMax2, iA00);
    }
    ...
    public static List<AR> A0C(InterfaceC1678Ar interfaceC1678Ar, C3206or c3206or) throws C1682Av {
        ArrayList arrayList = new ArrayList();
        String strA0P = C1685Ay.A0P(c3206or);
        if (strA0P == null) {
            return arrayList;
        }
        List<AR> listA7g = interfaceC1678Ar.A7g(strA0P, false, false);
        if (AbstractC15184a.A02 >= 26) {
            return (!A0B(1664, 18, 7).equals(c3206or.A0W) || listA7g.isEmpty()) ? arrayList : listA7g;
        }
        return arrayList;
    }

    public static List<AR> A0D(InterfaceC1678Ar interfaceC1678Ar, C3206or c3206or, boolean z10) throws C1682Av {
        String str = c3206or.A0W;
        return str == null ? Collections.emptyList() : Collections.unmodifiableList(interfaceC1678Ar.A7g(str, z10, false));
    }

    private void A0E() {
        AO aoA1j;
        this.A0i = false;
        if (AbstractC15184a.A02 < 23 || !this.A0k || (aoA1j = A1j()) == null) {
            return;
        }
        this.A00 = new C3007la(this, aoA1j);
    }
    ...
    private void A0G() {
        if (this.A0r.A0G() && MetaExoPlayerUpgradeConfig.A03(EnumC2805i2.A1p)) {
            this.A0r.A0A();
            throw null;
        }
    }
    ...
    private void A0J() {
        if (this.A09 > 0) {
            ...
            this.A0u.A01(this.A09, jElapsedRealtime - this.A0J);
            this.A09 = 0;
    ...
    private void A0K() {
        ...
        this.A0u.A07(new C3159o4(this.A08, this.A06, this.A07, this.A01));
        this.A0G = this.A08;
        this.A0E = this.A06;
        this.A0F = this.A07;
        this.A03 = this.A01;
    ...
    private void A0M() {
        ...
        this.A0u.A07(new C3159o4(this.A0G, this.A0E, this.A0F, this.A03));
    }

    private void A0N() {
        this.A0M = this.A0p > 0 ? SystemClock.elapsedRealtime() + this.A0p : -9223372036854775807L;
    }
    ...
    private final void A0R(long j10, long j11, float f10) {
        int iA01 = (int) AbstractC14641w.A01(j10);
        int iA012 = (int) AbstractC14641w.A01(j11);
        if (iA012 <= 1000 || iA012 >= 10000 || iA01 + iA012 <= this.A0A + this.A0B + 1000) {
            return;
        }
        if (iA01 > this.A0A && iA01 < this.A0A + this.A0B) {
            super.A0j.A0E += (int) (((double) (((iA01 + iA012) - (this.A0A + this.A0B)) * f10)) / 1000.0d);
        } else if (iA01 > this.A0A + this.A0B) {
            super.A0j.A0E += (int) (((double) (iA012 * f10)) / 1000.0d);
        }
        this.A0A = iA01;
        this.A0B = iA012;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void A0S(long j10, long j11, C3206or c3206or, MediaFormat mediaFormat) {
        if (this.A0X != null) {
            this.A0X.AFi(j10, j11, c3206or, mediaFormat);
        }
    }
    ...
    private void A0U(Surface surface) throws C9Y {
        if (surface == null) {
            if (this.A0T != null) {
                ...
                AR arA1k = A1k();
                if (arA1k != null && A0r(arA1k)) {
                    this.A0T = DummySurface.A01(this.A0q, arA1k.A06);
                    surface = this.A0T;
                }
            }
        }
        boolean zA03 = MetaExoPlayerUpgradeConfig.A03(EnumC2805i2.A0W);
        if (this.A0U == surface) {
        ...
        int iA92 = A92();
        boolean z10 = false;
        boolean z11 = this.A0f && AAV();
        if (iA92 == 1 || iA92 == 2) {
            AO aoA1j = A1j();
            if (!this.A0r.A0G()) {
                if (AbstractC15184a.A02 < 23 || aoA1j == null || surface == null || this.A0b) {
                    A1n();
                    A1p();
                } else if (zA03) {
                    try {
        ...
        if (this.A0r.A0G()) {
            if (MetaExoPlayerUpgradeConfig.A03(EnumC2805i2.A0j) && this.A0r.A06 != null) {
                z10 = true;
            }
            if (z10) {
                return;
    ...
    private void A0V(C3206or c3206or) {
        AO aoA1j = A1j();
        if (aoA1j == null || c3206or == null) {
            return;
        }
        Pair<Long, Integer> pairA8b = aoA1j.A8b();
        if (((Long) pairA8b.first).longValue() > 0) {
            super.A0j.A04(pairA8b);
            C1801Fn c1801Fn = this.A0u;
            if (A12[2].charAt(6) == 'n') {
                throw new RuntimeException();
            }
            A12[3] = "UGSzGWhN7NgjOmIm99IkQUILfPM9Cd";
            c1801Fn.A04(super.A0j.A00, c3206or);
        }
    }
    ...
    private final void A0X(AO ao2, int i10, long j10) {
        ...
        try {
            ...
            long jElapsedRealtime = SystemClock.elapsedRealtime();
            ao2.AGy(i10, true);
            super.A0h += SystemClock.elapsedRealtime() - jElapsedRealtime;
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private final void A0c(com.facebook.ads.redexgen.core.AO r11, int r12, long r13, long r15, boolean r17) {
        /*
            r10 = this;
            r6 = r15
            if (r17 == 0) goto L20
            ...
            r3 = r10
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.C0O.A12
            r0 = 3
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 21
            if (r1 == r0) goto L80
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C0O.A12
        ...
        L20:
            ...
            com.facebook.ads.redexgen.core.C4S.A02(r0)
            ...
            r0 = 0
            r2[r0] = r1
            com.facebook.ads.redexgen.core.C4S.A00()
        ...
        L80:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C0O.A0c(com.facebook.ads.redexgen.X.AO, int, long, long, boolean):void");
    }
    ...
    public static boolean A0h() {
        return AbstractC15184a.A02 >= 21;
    }

    public static boolean A0i() {
        return AbstractC15184a.A02 <= 22 && A0B(1280, 6, 87).equals(AbstractC15184a.A03) && A0B(725, 6, 88).equals(AbstractC15184a.A05);
    }
    ...
    private boolean A0r(AR ar2) {
        return AbstractC15184a.A02 >= 23 && this.A0e && !this.A0k && !A0u(ar2.A03) && (!ar2.A06 || DummySurface.A05(this.A0q));
    }
    ...
    */
    private final boolean A0u(java.lang.String r9) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C0O.A0u(java.lang.String):boolean");
    }

    public static boolean A0v(boolean z10, C3206or c3206or, C3206or c3206or2) {
        return c3206or.A0W.equals(c3206or2.A0W) && c3206or.A0F == c3206or2.A0F && (z10 || (c3206or.A0L == c3206or2.A0L && c3206or.A0A == c3206or2.A0A)) && AbstractC15184a.A1E(c3206or.A0N, c3206or2.A0N);
    }
    ...
    @Override // com.facebook.ads.redexgen.core.AnonymousClass14, com.facebook.ads.redexgen.core.C9Z
    public final void A1c(C3206or[] c3206orArr, long j10, long j11) throws C9Y {
    ...
    public final int A1g(AO ao2, AR ar2, C3206or c3206or, C3206or c3206or2) {
        if (AbstractC2783hY.A04(this.A11, c3206or.A0L, c3206or.A0A, c3206or2.A0L, c3206or2.A0A)) {
            return 0;
        }
        if (A21() && c3206or.A0W.equals(c3206or2.A0W) && c3206or.A0F == c3206or2.A0F) {
            return 1;
        }
        if (!A0v(ar2.A04, c3206or, c3206or2) || c3206or2.A0L > this.A0W.A02 || c3206or2.A0A > this.A0W.A00 || A00(c3206or2) > this.A0W.A01) {
            return 0;
        }
        boolean zA0A = c3206or.A0A(c3206or2);
        if (A12[2].charAt(6) == 'n') {
            throw new RuntimeException();
        }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final void A1r(com.facebook.ads.redexgen.core.C3206or r6) {
        /*
            r5 = this;
        ...
        L33:
            com.facebook.ads.redexgen.X.FC r0 = r5.A0r
            com.facebook.ads.redexgen.core.FC.A05(r0, r3)
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.C0O.A12
            r0 = 2
            r1 = r1[r0]
            r0 = 6
        ...
        L53:
            ...
            throw r0
        L59:
            com.facebook.ads.redexgen.X.i3 r0 = com.facebook.ads.redexgen.core.EnumC2806i3.A09
        ...
        L6c:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C0O.A1r(com.facebook.ads.redexgen.X.or):void");
    }

    @Override // com.facebook.ads.redexgen.core.AnonymousClass14
    public final void A1s(C3206or c3206or) throws C9Y {
        super.A1s(c3206or);
        this.A0u.A05(c3206or, null);
        this.A02 = c3206or.A02;
        this.A0D = c3206or.A0F;
    }

    @Override // com.facebook.ads.redexgen.core.AnonymousClass14
    public final void A1t(C3206or c3206or) throws C9Y {
        if (this.A0r.A0G()) {
            return;
        }
        this.A0r.A0J(c3206or, A1i());
    }

    @Override // com.facebook.ads.redexgen.core.AnonymousClass14
    public final void A1u(C3128nY c3128nY) {
        this.A04++;
        this.A0O = Math.max(c3128nY.A01, this.A0O);
        if (AbstractC15184a.A02 >= 23 || !this.A0k) {
            return;
        }
        A27();
    }
    ...
    public final void A1v(AO ao2, MediaFormat mediaFormat) {
        ...
        this.A08 = z10 ? (mediaFormat.getInteger(strA0B) - mediaFormat.getInteger(strA0B4)) + 1 : mediaFormat.getInteger(A0B(1755, 5, 79));
        this.A06 = z10 ? (mediaFormat.getInteger(strA0B3) - mediaFormat.getInteger(strA0B2)) + 1 : mediaFormat.getInteger(A0B(1307, 6, 73));
        this.A01 = this.A02;
        if (AbstractC15184a.A02 >= 21) {
        ...
        ao2.AJ8(this.A0H);
        this.A0V = new C3159o4(this.A08, this.A06, this.A07, this.A01);
        this.A0s.A0F(super.A0i.A01);
        if (this.A0r.A0G()) {
            this.A0r.A0D(super.A0i.A07().A0r(this.A08).A0f(this.A06).A0l(this.A07).A0Y(this.A01).A14());
            throw null;
        }
    }
    ...
    public final void A1w(AR ar2, AO ao2, C3206or c3206or, MediaCrypto mediaCrypto) throws C1682Av {
        this.A0W = A0A(ar2, c3206or, A1e());
        MediaFormat mediaFormatA08 = A08(c3206or, this.A0W, this.A0v, this.A0o);
        if (this.A0U == null) {
            C3M.A08(A0r(ar2));
            if (this.A0T == null) {
        ...
        boolean z13 = z11 && ar2.A00 != null && ar2.A00.isFeatureSupported(strA0B);
        if (ar2.A03.equals(A0B(1181, 28, 58)) && this.A11.A09) {
            z12 = true;
        }
        if ((AbstractC15184a.A02 >= 30 || this.A11.A0I) && z13 && !z12) {
        ...
        ao2.A50(mediaFormatA08, this.A0U, mediaCrypto, 0, this.A0Y);
    ...
    public final void A1z(String str, C3206or c3206or) throws C9Y {
        this.A0u.A0F(str);
        if (this.A0r.A0G()) {
            return;
        }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final boolean A23(long r38, long r40, com.facebook.ads.redexgen.core.AO r42, java.nio.ByteBuffer r43, int r44, int r45, long r46, boolean r48, boolean r49) throws com.facebook.ads.redexgen.core.C9Y {
        /*
            Method dump skipped, instruction units count: 754
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C0O.A23(long, long, com.facebook.ads.redexgen.X.AO, java.nio.ByteBuffer, int, int, long, boolean, boolean):boolean");
    }
    ...
    public final Pair<ColorInfo, ColorInfo> A26(ColorInfo colorInfo) {
        return !ColorInfo.A09(colorInfo) ? Pair.create(ColorInfo.A09, ColorInfo.A09) : colorInfo.A03 == 7 ? Pair.create(colorInfo, colorInfo.A0A().A02(6).A03()) : Pair.create(colorInfo, colorInfo);
    }
    ...
    public final boolean AAG() {
        ...
        return this.A0r.A0G() ? zAAG & this.A0r.A0I() : zAAG;
    }
    ...
    */
    public final boolean AAV() {
        ...
        L14:
            ...
            boolean r0 = r9.A0k
            if (r0 != 0) goto L22
            com.facebook.ads.redexgen.X.hX r0 = com.facebook.ads.redexgen.core.EnumC2782hX.A08
            r9.A0B = r0
        L22:
            boolean r0 = super.AAV()
            r8 = 1
        ...
        L3e:
            ...
            throw r0
        L59:
            java.lang.String[] r4 = com.facebook.ads.redexgen.core.C0O.A12
        ...
        L95:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C0O.AAV():boolean");
    }
