...
public final class RO implements NativeAdsManagerApi {
    ...
    public final void loadAds(NativeAdBase.MediaCacheFlag mediaCacheFlag) {
        V6 v62 = V6.A06;
        int i10 = this.A06;
        C2769hK c2769hK = this.A02;
        this.A02 = new C2769hK(this.A07, this.A08, v62, null, i10);
        if (this.A05) {
            this.A02.A06();
        }
        this.A02.A09(this.A03);
        this.A02.A08(new C2666fa(this, this.A07, mediaCacheFlag));
        this.A02.A07();
    }
    ...
    public final NativeAd nextNativeAd(NativeAdListener nativeAdListener) {
        ...
        int i10 = this.A00;
        this.A00 = i10 + 1;
        NativeAd nativeAd = this.A09.get(i10 % this.A09.size());
        if (nativeAdListener != null) {
            ((C2072Qc) nativeAd.getInternalNativeAd()).A1U(nativeAd, nativeAdListener);
        }
        return i10 >= this.A09.size() ? new NativeAd(this.A07, nativeAd) : nativeAd;
    }
