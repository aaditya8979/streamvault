...
public class C2771hM implements InterfaceC1973Me {
    ...
    public final /* synthetic */ C15926w A04;
    ...
    public C2771hM(C15926w c15926w, Runnable runnable, long j10, TC tc2) {
        this.A04 = c15926w;
        this.A06 = runnable;
        this.A03 = j10;
        this.A05 = tc2;
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC1973Me
    public final void AEH(C2825iN c2825iN) {
        if (c2825iN != this.A04.A00) {
            return;
        }
        ...
        this.A04.A01 = c2825iN;
        this.A04.A07.A0F(c2825iN);
        if (this.A02) {
            return;
        }
        this.A02 = true;
