...
public abstract class GB {
    ...
    public static int A00(C4I c4i) {
        int iA04 = c4i.A04(5);
        return iA04 == 31 ? c4i.A04(6) + 32 : iA04;
    }

    public static int A01(C4I c4i) throws C14742i {
        int iA04 = c4i.A04(4);
        if (iA04 != 15) {
            if (iA04 < 13) {
                return A03[iA04];
            }
            throw C14742i.A01(A04(28, 41, 57), null);
        }
        int iA01 = c4i.A01();
        if (A01[0].length() != 5) {
        ...
        throw C14742i.A01(A04(0, 28, 60), null);
    }

    public static GA A02(C4I c4i, boolean z10) throws C14742i {
        int iA00 = A00(c4i);
        int iA01 = A01(c4i);
        int iA04 = c4i.A04(4);
        ...
        if (z10) {
            switch (iA00) {
                ...
                case 23:
                    ...
                    switch (iA00) {
                        ...
                        case 23:
                            int iA042 = c4i.A04(2);
                            if (iA042 == 2 || iA042 == 3) {
                                throw C14742i.A00(A04(Sdk.SDKError.Reason.TPAT_RETRY_FAILED_VALUE, 22, 118) + iA042);
                            }
                    }
                    break;
                case 5:
                ...
                case 18:
                default:
                    throw C14742i.A00(A04(106, 31, 42) + iA00);
            }
        }
        int i10 = A02[iA04];
        if (i10 != -1) {
            return new GA(iA01, i10, str);
        }
        throw C14742i.A01(null, null);
    }

    public static GA A03(byte[] bArr) throws C14742i {
    ...
    public static void A05() {
        A00 = new byte[]{-10, -10, -8, -43, 29, 26, 22, 25, 26, 39, -43, 30, 35, 40, ExifInterface.START_CODE, 27, 27, 30, 24, 30, 26, 35, 41, -43, 25, 22, 41, 22, -13, -13, -11, -46, 26, 23, 19, 22, 23, 36, -46, 41, 36, 33, 32, 25, -46, 5, 19, 31, 34, 30, 27, 32, 25, -46, -8, 36, 23, 35, 39, 23, 32, 21, 43, -46, -5, 32, 22, 23, ExifInterface.START_CODE, 5, 37, 39, 25, 56, 45, 48, 16, 41, 32, 51, 43, 32, 30, 47, 32, 31, -37, 33, 45, 28, 40, 32, 7, 32, 41, 34, 47, 35, 1, 39, 28, 34, -37, -8, -37, -20, -8, 17, 22, 24, 19, 19, 18, 21, 23, 8, 7, -61, 4, 24, 7, 12, 18, -61, 18, 5, 13, 8, 6, 23, -61, 23, 28, 19, 8, -35, -61, 68, 93, 98, 100, 95, 95, 94, 97, 99, 84, 83, 15, 84, 95, 50, 94, 93, 85, 88, 86, 41, 15, -19, -16, -76, ExifInterface.MARKER_APP1, -82, -76, -80, -82};
    }
