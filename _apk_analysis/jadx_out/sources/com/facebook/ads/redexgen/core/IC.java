...
public final class IC {
    ...
    public static Pair<String, List<byte[]>> A02(C4J c4j) throws C14742i {
        try {
            c4j.A0g(16);
            long jA0O = c4j.A0O();
            if (jA0O == 1482049860) {
            ...
            for (int iA09 = c4j.A09() + 20; iA09 < bArrA0l.length - 4; iA09++) {
            ...
            throw C14742i.A01(A03(267, 45, 108), null);
        } catch (ArrayIndexOutOfBoundsException unused) {
            throw C14742i.A01(A03(166, 33, 80), null);
        }
    }
    ...
    public static List<byte[]> A05(byte[] bArr) throws C14742i {
        String strA03 = A03(233, 34, 43);
        try {
            if (bArr[0] != 2) {
                throw C14742i.A01(strA03, null);
            }
            int i10 = 1;
            int i11 = 0;
    ...
    public static boolean A09(C4J c4j) throws C14742i {
        try {
            ...
            c4j.A0f(24);
            if (c4j.A0P() == MatroskaExtractor.A0x.getMostSignificantBits()) {
                if (c4j.A0P() == MatroskaExtractor.A0x.getLeastSignificantBits()) {
                    return true;
                }
            }
            return false;
        } catch (ArrayIndexOutOfBoundsException unused) {
            throw C14742i.A01(A03(199, 34, 58), null);
        }
    }
    ...
    private byte[] A0C() {
        ...
        byteBufferOrder.putShort((short) ((this.A06 * 50000.0f) + 0.5f));
        byteBufferOrder.putShort((short) ((this.A07 * 50000.0f) + 0.5f));
        byteBufferOrder.putShort((short) ((this.A04 * 50000.0f) + 0.5f));
        byteBufferOrder.putShort((short) ((this.A05 * 50000.0f) + 0.5f));
        byteBufferOrder.putShort((short) ((this.A02 * 50000.0f) + 0.5f));
        byteBufferOrder.putShort((short) ((this.A03 * 50000.0f) + 0.5f));
        byteBufferOrder.putShort((short) ((this.A0B * 50000.0f) + 0.5f));
        byteBufferOrder.putShort((short) ((this.A0C * 50000.0f) + 0.5f));
        byteBufferOrder.putShort((short) (this.A00 + 0.5f));
        byteBufferOrder.putShort((short) (this.A01 + 0.5f));
        byteBufferOrder.putShort((short) this.A0O);
        byteBufferOrder.putShort((short) this.A0P);
        return bArr;
    }

    @EnsuresNonNull({"codecPrivate"})
    private byte[] A0D(String str) throws C14742i {
        if (this.A0j == null) {
            throw C14742i.A01(A03(329, 31, 93) + str, null);
        }
        byte[] bArr = this.A0j;
        if (A0q[1].charAt(11) != 'i') {
            throw new RuntimeException();
    ...
    */
    public final void A0G(com.facebook.ads.redexgen.core.GY r20, int r21) throws com.facebook.ads.redexgen.core.C14742i {
        /*
            Method dump skipped, instruction units count: 2498
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.IC.A0G(com.facebook.ads.redexgen.X.GY, int):void");
    }
}
