...
public class VD extends AbstractRunnableC2216Vt {
    ...
    public final void A07() {
        ...
        try {
            ...
            if (all.size() > 1) {
                C2175Ud.A06(this.A00, C2626ev.A00(this.A00), all);
            }
            ...
            this.A00.A08().AAy(A00(31, 14, 46), 3502, new C2143Sw(e10));
            sharedPreferences.edit().clear().apply();
        }
        synchronized (C2175Ud.class) {
            SharedPreferences.Editor editorEdit = sharedPreferences.edit();
            for (Map.Entry entry : C2175Ud.A02.entrySet()) {
