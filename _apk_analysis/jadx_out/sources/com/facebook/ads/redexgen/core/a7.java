...
public final class a7 extends View {
    ...
    static {
        A01();
        A0F = (int) (AbstractC2232Wl.A02 * 5.0f);
        A0G = (int) (AbstractC2232Wl.A02 * 4.0f);
        A0H = (int) (AbstractC2232Wl.A02 * 10.0f);
    }

    public a7(C2529dL c2529dL, boolean z10) {
        super(c2529dL);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.A01 >= 0) {
            ...
            canvas.drawText(str, (this.A0B.left + ((this.A0B.right - this.A0B.left) / 2.0f)) - (this.A0A.measureText(str) / 2.0f), this.A0B.top + A0G + ((this.A0B.bottom - this.A0B.top) / 2.0f), this.A0A);
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.A0B.set((f10 / 2.0f) + 0.0f + getPaddingLeft(), (f10 / 2.0f) + 0.0f + getPaddingTop(), (iMin - (f10 / 2.0f)) - getPaddingRight(), (iMin - (f10 / 2.0f)) - getPaddingBottom());
        int i12 = !this.A04 ? A0F : A0G;
        this.A0C.set(this.A0B.left + i12, this.A0B.top + i12, this.A0B.right - i12, this.A0B.bottom - i12);
    }
