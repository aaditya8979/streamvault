...
public class E3 {
    ...
    public final void A03(AnonymousClass92 anonymousClass92, Looper looper) {
        if (this.A00 == null && this.A01 == null) {
            ...
            spatializer.addOnSpatializerStateChangedListener(new ExecutorC16278l(handler), this.A00);
        }
    }
    ...
    public final boolean A07(C3212oy c3212oy, C3206or c3206or) {
        AudioFormat.Builder channelMask = new AudioFormat.Builder().setEncoding(2).setChannelMask(AbstractC15184a.A01((A01(5, 14, 28).equals(c3206or.A0W) && c3206or.A06 == 16) ? 12 : c3206or.A06));
        if (c3206or.A0G != -1) {
            channelMask.setSampleRate(c3206or.A0G);
        }
        Spatializer spatializer = this.A02;
        AudioAttributes audioAttributes = c3212oy.A01().A00;
