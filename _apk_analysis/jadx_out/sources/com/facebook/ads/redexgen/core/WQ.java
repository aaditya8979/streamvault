...
public abstract class WQ {
    ...
    public static Uri A00(String str) {
        ...
        if (c2503cuA00 != null && !U7.A2p(c2503cuA00)) {
            return uri;
        }
        if (!A0D(uri)) {
            return A01(str);
    ...
    public static boolean A0E(String str, String str2) {
        String strA05 = A05(0, 0, 3);
        return (str == null || str.equals(strA05)) ? str2 == null || str2.equals(strA05) : str.equals(str2);
    }

    public static boolean A0F(URI uri, Uri uri2) {
        String host = uri2.getHost();
        return uri.getHost() == null && host != null && host.contains(A05(62, 1, 17));
    }
}
