...
public final class C2136Sp {
    ...
    public static final List<C2137Sq> A07;
    public static final AtomicBoolean A08;
    public static final AtomicInteger A09;
    public static final AtomicReference<InterfaceC2134Sn> A0A;
    public static final AtomicReference<InterfaceC2135So> A0B;
    ...
    public static int A00(String str, int i10, SQ sq2) {
        if ((A01(462, 7, 5).equals(str) && AbstractC2142Sv.A20 == i10) || A01(TypedValues.CycleType.TYPE_CUSTOM_WAVE_SHAPE, 5, 90).equals(str) || A01(442, 6, 62).equals(str)) {
            return 200;
        }
    ...
    @Deprecated
    public static void A07(SQ sq2, String str, int i10, C2143Sw c2143Sw) {
        try {
            c2143Sw.A05(2);
            c2143Sw.A0A(false);
            c2143Sw.A06(1);
    ...
    @Deprecated
    public static void A08(SQ sq2, String str, int i10, C2143Sw c2143Sw) {
        try {
            c2143Sw.A05(2);
            c2143Sw.A08(false);
            A06(sq2, str, i10, c2143Sw);
    ...
    public static void A09(SQ sq2, String str, int i10, C2143Sw c2143Sw) {
        synchronized (C2136Sp.class) {
            if (A03) {
                A0A(sq2, str, i10, c2143Sw, true);
            } else {
                int iA01 = U9.A01(sq2);
                if (A09.getAndIncrement() < iA01 - 1) {
                    A07.add(new C2137Sq(str, i10, c2143Sw));
                } else if (A09.get() == iA01) {
                    A07.add(new C2137Sq(A01(427, 10, 35), AbstractC2142Sv.A2W, new C2143Sw(A01(140, 42, 70) + str + A01(47, 1, 91) + i10)));
                }
            }
        }
    }

    public static void A0A(SQ sq2, String str, int i10, C2143Sw c2143Sw, boolean z10) {
        InterfaceC2135So interfaceC2135So = A0B.get();
        boolean z11 = interfaceC2135So != null && interfaceC2135So.AAZ();
        boolean z12 = A08.get();
        String[] strArr = A05;
        ...
        if (z12 || z11) {
            int iA01 = c2143Sw.A01();
            String strA01 = A01(289, 17, 3);
            String strA012 = A01(31, 16, 108);
            if (iA01 == 0) {
                Log.e(strA01, A01(182, 37, 114) + str + strA012 + i10, c2143Sw);
            } else {
                Log.i(strA01, A01(306, 32, 102) + str + strA012 + i10 + A01(19, 12, 98) + c2143Sw.getMessage() + A01(0, 19, 12) + c2143Sw.A03());
            }
        }
        C2348aP c2348aP = new C2348aP(sq2, str, i10, c2143Sw, interfaceC2135So);
        if (z10) {
            A01.execute(c2348aP);
        } else {
            c2348aP.run();
    ...
    public static void A0C(C2503cu c2503cu, InterfaceC2135So interfaceC2135So, InterfaceC2134Sn interfaceC2134Sn, boolean z10) {
        A0A.set(interfaceC2134Sn);
        A0B.set(interfaceC2135So);
        A08.set(z10);
        synchronized (C2136Sp.class) {
            if (!A03) {
                A03 = true;
                A01.execute(new C2403bI(c2503cu));
            }
        }
    }
    ...
    public static void A0D(RuntimeException runtimeException) {
        if (A02) {
            new Handler(Looper.getMainLooper()).post(new RunnableC2133Sm(runtimeException));
        }
    }
    ...
    public static boolean A0H(SQ sq2) {
        ...
        return (bool == null || !bool.booleanValue()) && U9.A0A(sq2) != 0;
    }

    public static boolean A0I(SQ sq2) {
        Boolean bool = A0C.get();
        if (bool == null || !bool.booleanValue()) {
            return sq2.A09().A00() <= 1.0d / ((double) U9.A0A(sq2));
        }
        return false;
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:100:0x017b, code lost:
        ...
        com.facebook.ads.redexgen.core.C2136Sp.A0C.set(true);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:105:0x018c, code lost:
        ...
        r7 = r7 * r2;
        r2 = com.facebook.ads.redexgen.core.C2136Sp.A05;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:93:0x0164, code lost:
        ...
        r0 = com.facebook.ads.redexgen.core.C2136Sp.A0C.get();
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:98:0x0175, code lost:
        ...
        r0 = com.facebook.ads.redexgen.core.U9.A0A(r13);
     */
    ...
    */
    public static boolean A0J(com.facebook.ads.redexgen.core.SQ r13, java.lang.String r14, int r15, double r16, com.facebook.ads.redexgen.core.C2143Sw r18) {
        /*
            Method dump skipped, instruction units count: 633
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2136Sp.A0J(com.facebook.ads.redexgen.X.SQ, java.lang.String, int, double, com.facebook.ads.redexgen.X.Sw):boolean");
    }

    public static boolean A0K(SQ sq2, String str, int i10, C2143Sw c2143Sw) {
        if (!U9.A0P(sq2)) {
            return true;
        }
        int i11 = A00.get(i10);
        ...
        if (A06.contains(Integer.valueOf(i11)) && c2143Sw.A0D()) {
            A05(sq2, i10, i11);
        }
        A00.put(i10, i11 + 1);
        return true;
