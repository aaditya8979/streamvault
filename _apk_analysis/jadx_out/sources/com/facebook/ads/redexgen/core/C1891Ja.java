...
public final class C1891Ja {
    ...
    public C1891Ja(String str, int i10, Integer num, Integer num2, float f10, boolean z10, boolean z11, boolean z12, boolean z13, int i11) {
        this.A05 = str;
        this.A01 = i10;
        this.A04 = num;
        this.A03 = num2;
    ...
    public static float A00(String str) {
        try {
            ...
            AnonymousClass44.A0A(A06(261, 8, 80), A06(71, 28, 122) + str + A06(2, 1, 8), e10);
    ...
    public static C1891Ja A04(String str, JW jw) {
        ...
        if (length != i10) {
            AnonymousClass44.A07(strA062, AbstractC15184a.A0n(A06(157, 69, 114), Integer.valueOf(jw.A05), Integer.valueOf(strArrSplit.length), str));
            return null;
        }
        try {
            return new C1891Ja(strArrSplit[jw.A06].trim(), jw.A00 != -1 ? A01(strArrSplit[jw.A00].trim()) : -1, jw.A08 != -1 ? A05(strArrSplit[jw.A08].trim()) : null, jw.A07 != -1 ? A05(strArrSplit[jw.A07].trim()) : null, jw.A03 != -1 ? A00(strArrSplit[jw.A03].trim()) : -3.4028235E38f, jw.A01 != -1 && A0A(strArrSplit[jw.A01].trim()), jw.A04 != -1 && A0A(strArrSplit[jw.A04].trim()), jw.A0A != -1 && A0A(strArrSplit[jw.A0A].trim()), jw.A09 != -1 && A0A(strArrSplit[jw.A09].trim()), jw.A02 != -1 ? A02(strArrSplit[jw.A02].trim()) : -1);
    ...
    public static Integer A05(String str) {
        try {
            long j10 = str.startsWith(A06(0, 2, 80)) ? Long.parseLong(str.substring(2), 16) : Long.parseLong(str);
            C3M.A07(j10 <= 4294967295L);
            return Integer.valueOf(Color.argb(AD.A03(((j10 >> 24) & 255) ^ 255), AD.A03(j10 & 255), AD.A03((j10 >> 8) & 255), AD.A03((j10 >> 16) & 255)));
