...
public final class C2766hG implements InterfaceC1994Na {
    ...
    public final AbstractC2763hD A03;
    ...
    public C2766hG(C2529dL c2529dL, AbstractC2763hD abstractC2763hD) {
        this.A04 = c2529dL;
        this.A03 = abstractC2763hD;
    }
    ...
    private void A02(NZ nz, NZ nz2) {
        ...
        String str = A00(108, 5, 38) + nz + A00(0, 4, 124) + nz2;
        this.A04.A08().AAy(A00(139, 3, 61), AbstractC2142Sv.A0e, new C2143Sw(strA00, str));
        this.A04.A0F().AKP(strA00 + ' ' + str);
    }

    private void A03(String str, String str2, boolean z10) {
        AdSettings.IntegrationErrorMode integrationErrorModeA00 = NW.A00(this.A04);
        ...
        if (!z10) {
            Log.e(strA002, str3);
            this.A04.A08().AAy(strA00, AbstractC2142Sv.A0c, new C2143Sw(str3));
            this.A04.A0F().AKO(str3);
            return;
        }
        switch (NY.A00[integrationErrorModeA00.ordinal()]) {
            case 1:
                throw new C1995Nb(str3 + A00(4, 87, 3));
            case 2:
                this.A03.A08();
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC1994Na
