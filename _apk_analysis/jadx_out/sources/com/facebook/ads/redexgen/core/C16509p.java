...
public final class C16509p extends AbstractC3184oU {
    ...
    public static final C1R<C16509p> A04;
    ...
    static {
        A03();
        A05 = AbstractC15184a.A0h(1);
        A06 = AbstractC15184a.A0h(2);
        A04 = new C1R() { // from class: com.facebook.ads.redexgen.X.oT
            @Override // com.facebook.ads.redexgen.core.C1R
            public final C1S A6X(Bundle bundle) {
                return C16509p.A00(bundle);
            }
        };
    }

    public C16509p(int i10) {
        C3M.A09(i10 > 0, A02(0, 35, 26));
        this.A01 = i10;
        this.A00 = -1.0f;
    }

    public C16509p(int i10, float f10) {
        C3M.A09(i10 > 0, A02(0, 35, 26));
    ...
    public static C16509p A00(Bundle bundle) {
        C3M.A07(bundle.getInt(AbstractC3184oU.A02, -1) == 2);
        int i10 = bundle.getInt(A05, 5);
        float f10 = bundle.getFloat(A06, -1.0f);
        return f10 == -1.0f ? new C16509p(i10) : new C16509p(i10, f10);
    }
    ...
    public final boolean equals(Object obj) {
        if (!(obj instanceof C16509p)) {
            return false;
        }
        C16509p c16509p = (C16509p) obj;
        return this.A01 == c16509p.A01 && this.A00 == c16509p.A00;
    }
