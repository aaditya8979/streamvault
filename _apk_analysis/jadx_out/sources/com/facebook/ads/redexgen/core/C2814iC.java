...
public final class C2814iC extends MR {
    ...
    public EnumC1971Mc A03;
    public EnumC1972Md A04;
    public EnumC2190Us A05;
    public String A06;
    public WeakReference<C2689fx> A07;
    ...
    public boolean A0D;
    public boolean A0E;
    public final C2825iN A0F;

    static {
        A05();
    }

    public C2814iC(C2529dL c2529dL, MS ms2, C2602eX c2602eX, C2825iN c2825iN) {
        super(c2529dL, ms2, c2602eX);
        this.A03 = EnumC1971Mc.A03;
        this.A04 = null;
        this.A0F = c2825iN;
    }
    ...
    private JSONObject A04(View view) throws JSONException {
        ...
        if (view instanceof ViewGroup) {
            ...
            for (int i10 = 0; i10 < viewGroup.getChildCount(); i10++) {
                jSONArray.put(A04(viewGroup.getChildAt(i10)));
            }
            jSONObject.putOpt(A01(67, 4, 8), jSONArray);
        }
        return jSONObject;
    }

    public static void A05() {
        A0G = new byte[]{127, -88, -92, -93, 85, -102, -83, -104, -102, -91, -87, -98, -92, -93, -52, -38, ExifInterface.MARKER_APP1, -44, -50, -54, -40, -33, -46, -36, -126, -112, -105, -108, -118, 126, -111, -112, -112, -117, -118, -98, -89, -100, -82, -82, -33, -24, -27, -33, -25, -35, -34, -24, ExifInterface.MARKER_APP1, -104, -85, -89, -91, -108, -110, -101, -100, -95, -89, -90, -103, -108, -125, -121, 123, -127, 127, -119, -122, -112, -111, -82, -90, -91, -86, -94, -73, -86, -90, -72, -79, -92, -81, -80, -92, -69, -70, -17, -30, -19, -18, -22, -17, -8, -1, -14, -2, -7, -45, -58, -46, -36, -71, -84, -67, -84, -67, 2, -10, 11, -3, 10, -38, -44, -33, -38, -43, -30, -26, -27, -18, -42, -43, -34, -55, -40, -56, -50, -61, -10, -7, -16, -18, -16, -11, -63, -61, -74, -76, -78, -76, -71, -74, -80, -66, -74, -75, -70, -78, -115, -125, -108, 127, -90, -95, -108, -93, -90, -101, -94, -89, -28, -43, -24, -28, -18, -13, -22, -33, -85, -103, -84, -88, -35, -42, -45, -42, -41, -33, -42, -99, -112, -116, -98, -13, -26, -30, -12, -28, -17, -20, -14, -19, -78, -97, 113, 92, -101, 99, 87, -82, 113, 92, -101, -76, -51, -54, -116, 119, -74, 126, 114, -53, -116, 119, -74, -49};
    }
    ...
    private void A07(Map<String, String> map) {
        if (this.A02 == null || !(this.A02.getNativeAdLayoutApi() instanceof C2672fg)) {
            return;
        }
        C2672fg c2672fg = (C2672fg) this.A02.getNativeAdLayoutApi();
        if (c2672fg.A05()) {
            map.put(A01(87, 7, 108), Boolean.TRUE.toString());
        }
        boolean zA04 = c2672fg.A04();
        if (A0H[2].charAt(5) == '8') {
            throw new RuntimeException();
        }
        String[] strArr = A0H;
    ...
    public final void A08(Map<String, String> map) {
        ...
        if (this.A00 != null && this.A0F.A0T()) {
            ...
            String strA01 = A01(BaseTransientBottomBar.ANIMATION_FADE_DURATION, 4, 18);
            if (A0H[5].charAt(12) != 'y') {
                throw new RuntimeException();
            }
        ...
        if (this.A01 != null) {
            map.put(A01(98, 4, 80), String.valueOf((int) (this.A01.getWidth() / AbstractC2232Wl.A02)));
            map.put(A01(94, 4, 124), String.valueOf((int) (this.A01.getHeight() / AbstractC2232Wl.A02)));
        }
        if (this.A04 != null) {
    ...
    public final void A0C(EnumC1971Mc enumC1971Mc) {
        this.A03 = enumC1971Mc;
    }

    public final void A0D(EnumC1972Md enumC1972Md) {
        this.A04 = enumC1972Md;
    }

    public final void A0E(EnumC2190Us enumC2190Us) {
        this.A05 = enumC2190Us;
    }
    ...
    public final void A0G(WeakReference<C2689fx> weakReference) {
        this.A07 = weakReference;
    }

    public final void A0H(List<View> list) {
        this.A08 = list;
    }
