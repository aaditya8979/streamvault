...
public final class XU implements Executor {
    ...
    public XU(String str, int i10) {
        this.A02 = i10;
        int iAvailableProcessors = Runtime.getRuntime().availableProcessors();
        this.A01 = new ThreadPoolExecutor(Math.max(2, Math.min(iAvailableProcessors - 1, 4)), (iAvailableProcessors * 2) + 1, 30L, TimeUnit.SECONDS, new LinkedBlockingQueue(), new XT(this, str));
    ...
    public static ExecutorService A03() {
        ...
        return atomicBoolean.get() ? A0A : A0C;
    }

    public static void A04() {
        A04 = new byte[]{101, 119, 125, 106, 103, 43, 45, 61, 54, 39, 36, 60, 33, 56, 23, 45, 62, 33, 100, 121, 100, 18, 39, 53, 45, 53, 102, 55, 51, 35, 51, 35, 102, 50, 41, 41, 102, ExifInterface.START_CODE, 41, 40, 33, 104, 33, 35, 40, 35, 52, 47, 37};
    }
    ...
    public final void execute(Runnable runnable) {
        ...
        synchronized (XU.class) {
            ...
            if (size == A03) {
                ...
                if (c2503cuA00 != null) {
                    c2503cuA00.A08().AAy(A00(42, 7, 34), AbstractC2142Sv.A1d, new C2143Sw(A00(21, 21, 34), A00(14, 7, 32) + i10));
                }
            }
        }
