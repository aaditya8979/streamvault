...
public final class C3000lT implements InterfaceC1836Gw {
    ...
    public C3000lT(int[] iArr, long[] jArr, long[] jArr2, long[] jArr3) {
        this.A01 = iArr;
        this.A03 = jArr;
        this.A02 = jArr2;
        this.A04 = jArr3;
    ...
    private final int A00(long j10) {
        return AbstractC15184a.A0L(this.A04, j10, true, true);
    }
    ...
    public final C1835Gv A8t(long j10) {
        int iA00 = A00(j10);
        C1837Gx c1837Gx = new C1837Gx(this.A04[iA00], this.A03[iA00]);
        return (c1837Gx.A01 >= j10 || iA00 == this.A00 + (-1)) ? new C1835Gv(c1837Gx) : new C1835Gv(c1837Gx, new C1837Gx(this.A04[iA00 + 1], this.A03[iA00 + 1]));
    }
