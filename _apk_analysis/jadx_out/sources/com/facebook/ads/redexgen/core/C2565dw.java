...
public final class C2565dw implements S1 {
    ...
    public final Map<String, AbstractC2120Rz> A00 = new HashMap();
    ...
    public static void A01() {
        A01 = new byte[]{49, ExifInterface.START_CODE, 22, 49, 55, 44, 43, 34};
    }
    ...
    public final synchronized String AHr() {
        ...
        Iterator<AbstractC2120Rz> it = this.A00.values().iterator();
        if (it.hasNext()) {
            it.next();
