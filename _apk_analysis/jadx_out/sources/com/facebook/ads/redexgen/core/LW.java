...
public class LW implements InterfaceC2278Yf {
    ...
    public final /* synthetic */ AbstractC2276Yd A00;

    static {
        A01();
    }

    public LW(AbstractC2276Yd abstractC2276Yd) {
        this.A00 = abstractC2276Yd;
    }
    ...
    public static void A01() {
        A01 = new byte[]{1, 13, 15, 76, 4, 3, 1, 7, 0, 13, 13, 9, 76, 3, 6, 17, 76, 3, 6, 16, 7, 18, 13, 16, 22, 11, 12, 5, 76, 36, 43, 44, 43, 49, ExifInterface.START_CODE, 61, 35, 38, 61, 48, 39, 50, 45, 48, 54, 43, 44, 37, 61, 36, 46, 45, 53};
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC2278Yf
    ...
    public final void AEC(O4 o42) {
        O6 o6A0B;
        AbstractC2276Yd.A02(this.A00);
        this.A00.A01 = o42;
        if (this.A00.A01 == O4.A04) {
            o6A0B = this.A00.A04.A0A();
        } else {
            AbstractC2276Yd abstractC2276Yd = this.A00;
            if (A02[0].charAt(15) != 'S') {
                String[] strArr = A02;
                strArr[6] = "aVWWA7RlXQ4WxwD1lKH3adLgfY6YTeho";
                strArr[5] = "uW2I9G42iXHj1OU85KkNtz4HKFKkrOfh";
                o6A0B = abstractC2276Yd.A04.A0B();
            } else {
                o6A0B = abstractC2276Yd.A04.A0B();
            }
        }
        AbstractC2276Yd abstractC2276Yd2 = this.A00;
        String[] strArr2 = A02;
