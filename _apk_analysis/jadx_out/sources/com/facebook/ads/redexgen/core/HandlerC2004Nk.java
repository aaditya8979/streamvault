...
public final class HandlerC2004Nk extends Handler {
    ...
    public InterfaceC2242Wv A01;
    public boolean A02;
    public final ServiceConnection A03;
    public final Handler A04;
    public final Messenger A05;
    public final LH A06;
    public final C2503cu A07;
    public final AbstractRunnableC2216Vt A08;

    static {
        A06();
    }

    public HandlerC2004Nk(C2503cu c2503cu) {
        super(Looper.getMainLooper());
        this.A04 = new Handler(Looper.getMainLooper());
        this.A03 = new ServiceConnectionC2003Nj(this);
        this.A07 = c2503cu;
        this.A05 = new Messenger(this);
        LL llA00 = c2503cu.A00(c2503cu);
        if (llA00 != null) {
            this.A06 = llA00.ABn();
        } else {
            this.A06 = new C2865j3();
        }
        this.A08 = new C2740gp(this);
    }
    ...
    public void A07(Messenger messenger) {
        ...
        messageObtain.setData(AbstractC2013Nt.A00(this.A07));
        try {
    ...
    public final void A0A(String str, InterfaceC2242Wv interfaceC2242Wv, int i10) {
        if (!this.A02) {
            LH lh2 = this.A06;
    ...
    public final void A0B(boolean z10) {
        this.A06.AHa();
        this.A02 = C2002Ni.A04(this.A07, z10, this.A03);
        if (!this.A02) {
            TN.A05(this.A07);
            return;
        }
