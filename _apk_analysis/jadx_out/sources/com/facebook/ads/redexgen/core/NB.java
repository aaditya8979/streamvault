...
public final class NB implements Serializable {
    ...
    public static final EnumC2318Zt A0L;
    ...
    public NB(String str, String str2, int i10, String str3, String str4, EnumC2318Zt enumC2318Zt, int i11, boolean z10, boolean z11, NC nc2, boolean z12, String str5, boolean z13, boolean z14, int i12, String str6, String str7, boolean z15) {
        if (z12) {
    ...
    public static int A00(JSONObject jSONObject) {
        ...
        return jSONObject.has(strA03) ? jSONObject.optInt(strA03) : jSONObject.optInt(A03(391, 19, 109), 0);
    }
    ...
    public static NB A01(JSONObject jSONObject) {
        ...
        boolean zOptBoolean = jSONObjectOptJSONObject.optBoolean(A03(TTAdConstant.VIDEO_INFO_CODE, 30, 97), false);
        return new NB(jSONObjectOptJSONObject.optString(A03(410, 3, 112)), jSONObjectOptJSONObject.optString(A03(154, 19, 73)), A00(jSONObject), A05(jSONObjectOptJSONObject), A04(jSONObjectOptJSONObject), A02(jSONObjectOptJSONObject), jSONObjectOptJSONObject.optInt(A03(482, 32, 24), 5000), !zOptBoolean && jSONObjectOptJSONObject.optBoolean(A03(114, 17, 70), true), jSONObjectOptJSONObject.optBoolean(A03(99, 15, 46)), ncA00, jSONObjectOptJSONObject.optBoolean(A03(204, 25, 53)), jSONObject.optString(A03(81, 2, 72)), zOptBoolean, jSONObjectOptJSONObject.optBoolean(A03(314, 25, 20), false), jSONObjectOptJSONObject.optInt(A03(443, 39, 20), 5), jSONObject.optString(A03(290, 24, 27), A03(45, 11, 69)), jSONObject.optString(A03(268, 22, 46), A03(240, 15, 73)), jSONObjectOptJSONObject.optBoolean(A03(TTAdConstant.IMAGE_MODE_VERTICAL_IMG_173, 31, 28), false));
    }

    public static EnumC2318Zt A02(JSONObject jSONObject) {
        return EnumC2318Zt.A00(jSONObject.optInt(A03(229, 11, 36), A0L.A04()));
    }
