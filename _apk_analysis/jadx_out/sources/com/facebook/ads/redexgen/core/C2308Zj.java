...
public class C2308Zj extends WebViewClient {
    ...
    public final WeakReference<C1925Ki> A03;
    ...
    public final WeakReference<C2602eX> A07;
    ...
    public C2308Zj(C2529dL c2529dL, WeakReference<InterfaceC2306Zh> weakReference, WeakReference<C2602eX> weakReference2, WeakReference<XH> weakReference3, WeakReference<AtomicBoolean> weakReference4, WeakReference<C1925Ki> weakReference5, AtomicInteger atomicInteger, AtomicReference<String> atomicReference, boolean z10) {
        this.A02 = c2529dL;
    ...
    public static void A02() {
        byte[] bArr = {8, 38, 40, 45, ExifInterface.START_CODE, -14, 8, 52, 51, 57, 55, 52, 49, -69, -36, -27, -32, -36, -37, 28, 77, 56, 67, 76, 56, 75, 64, 69, 62, -9, 44, 41, 32, -9, 39, 56, 75, 63, -9, 61, 70, 73, -9, 29, 64, 67, 60, -9, 24, 58, 58, 60, 74, 74, -9, -46, 5, 1, -1, -18, -83, -15, -18, 1, -18, -57, -83, 60, 72, 72, 68, 20, 57, 102, 102, 99, 102, 59, 84, 89, 71, 76, 75, 6, 56, 75, 87, 91, 75, 89, 90, 6, 76, 85, 88, 6, 44, 79, 82, 75, 6, 39, 73, 73, 75, 89, 89, 6, 34, 59, 64, 46, 51, 50, -19, 31, 50, 62, 66, 50, 64, 65, -19, 51, 60, 63, -19, 19, 54, 57, 50, -19, 14, 48, 48, 50, 64, 64, -19, 49, 50, 59, 54, 50, 49, 67, 68, 77, 72, 68, 67, 62, 84, 81, 72, 62, 79, 64, 83, 71, 63, 76, 76, 73, 76, 57, 61, 73, 62, 63, 40, 53, 53, 50, 53, 34, 39, 40, 54, 38, 53, 44, 51, 55, 44, 50, 49, 15, 10, 31, 18, 12, 24, 23, -41, 18, 12, 24, 19, 22, 25, 18, 89, 99, 79, 103, 85, 82, 79, 98, 85, 99, 95, 101, 98, 83, 85, 79, 85, 98, 98, 95, 98, 70, 73, 59, 62, 67, 72, 65, 57, 78, 67, 71, 63, 57, 67, 72, 57, 71, 67, 70, 70, 67, 77, -3, -12, 3, -55, -55, -44, ExifInterface.MARKER_APP1, ExifInterface.MARKER_APP1, -18, -44, -36, -33, -29, -24, -18, ExifInterface.MARKER_APP1, -44, -30, -33, -34, -35, -30, -44, 46, 47, -19, 51, 52, 47, 50, 37, 66, 53, 65, 69, 53, 67, 68, 47, 57, 52, 101, 86, 105, 101, 32, 97, 93, 82, 90, 95, -8, -29, -18, -21, -26, ExifInterface.MARKER_APP1, -14, -29, -10, -22, 62, 44, 41, 38, 61, 48, 44, 62};
        String[] strArr = A0C;
    ...
    private void A03(int i10, CharSequence charSequence, long j10) {
        ...
        this.A02.A08().AAy(A01(306, 8, 81), AbstractC2142Sv.A2f, new C2143Sw(AdErrorType.WEB_VIEW_FAILED_TO_LOAD.getDefaultErrorMessage(), A01(55, 12, 23) + jSONObject.toString()));
    }
    ...
    public void A04(int i10, String str) {
        ...
        A03(i10, str, new Date().getTime() - this.A00.getTime());
    ...
    private final void A05(WebResourceRequest webResourceRequest, WebResourceResponse webResourceResponse) {
        ...
        this.A02.A0F().AKH(webResourceResponse.getStatusCode(), AbstractC2236Wp.A01(webResourceResponse.getStatusCode(), A01(67, 10, 126), A01(0, 0, 53) + webResourceRequest.getUrl()));
    }
    ...
    private void A07(String str, String str2) {
        ...
        if (this.A02 != null) {
            this.A02.A08().AAy(A01(306, 8, 81), AbstractC2142Sv.A2c, new C2143Sw(AdErrorType.WEB_VIEW_CACHE_FILE_WAS_DENIED.getDefaultErrorMessage(), A01(55, 12, 23) + jSONObject.toString()));
        }
    }
    ...
    */
    private boolean A08(android.net.Uri r8) {
        /*
            ...
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C2308Zj.A0C
            r0 = 3
            r1 = r2[r0]
            r0 = 6
            r0 = r2[r0]
        ...
        L6c:
            ...
            java.util.List r5 = com.facebook.ads.redexgen.core.SF.A09(r0)
            ...
            r0.toString()
        L98:
            java.lang.String r4 = com.facebook.ads.redexgen.core.C1925Ki.A01()
        ...
        Lbb:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2308Zj.A08(android.net.Uri):boolean");
    }
    ...
    public final void onPageStarted(WebView webView, String str, Bitmap bitmap) {
        ...
        this.A02.A0F().AKF();
        this.A00 = new Date();
        new Handler().postDelayed(new C1927Kk(this), this.A08.get());
    }
    ...
    public final void onReceivedError(WebView webView, WebResourceRequest webResourceRequest, WebResourceError webResourceError) {
        ...
        if (zA12 || webResourceRequest.isForMainFrame()) {
            ...
            this.A02.A0F().AKG(AbstractC2236Wp.A01(webResourceError.getErrorCode(), strA01 + ((Object) webResourceError.getDescription()), strA01 + webResourceRequest.getUrl()));
        }
    }
    ...
    public final boolean shouldOverrideUrlLoading(WebView webView, String str) {
        if (this.A04.get() != null) {
            this.A04.get().ACj(str, new C2314Zp().A03(this.A07.get()).A02(this.A06.get()).A05());
        }
