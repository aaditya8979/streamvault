...
public class QZ {
    ...
    public QZ(int i10, int i11) {
        this(i10, i11, Integer.MIN_VALUE, null);
    }

    public QZ(int i10, int i11, int i12, Interpolator interpolator) {
        this.A04 = -1;
        this.A06 = false;
        this.A00 = 0;
        this.A02 = i10;
    ...
    public final void A05(C15766g c15766g) {
        if (this.A04 >= 0) {
            int i10 = this.A04;
            this.A04 = -1;
            c15766g.A1U(i10);
        ...
        if (interpolator != null) {
            c15766g.A08.A0C(this.A02, this.A03, this.A01, this.A05);
        } else if (this.A01 == Integer.MIN_VALUE) {
            c15766g.A08.A0A(this.A02, this.A03);
        } else {
            RunnableC2075Qf runnableC2075Qf = c15766g.A08;
            int i11 = this.A02;
            int i12 = this.A03;
            if (A08[1].length() != 25) {
                runnableC2075Qf.A0B(i11, i12, this.A01);
            } else {
                String[] strArr2 = A08;
