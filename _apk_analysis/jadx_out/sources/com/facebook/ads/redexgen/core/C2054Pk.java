...
public class C2054Pk {
    ...
    public final int A03(int i10) {
        if (this.A01 != null) {
            return i10 < 64 ? Long.bitCount(this.A00 & ((1 << i10) - 1)) : this.A01.A03(i10 - 64) + Long.bitCount(this.A00);
        }
        if (i10 >= 64) {
    ...
    public final void A07(int i10, boolean z10) {
        ...
        long j10 = (1 << i10) - 1;
        this.A00 = (this.A00 & j10) | ((this.A00 & (~j10)) << 1);
        if (z10) {
            A06(i10);
        } else {
            A05(i10);
    ...
    public final boolean A09(int i10) {
        ...
        this.A00 &= ~j10;
        long j11 = j10 - 1;
        this.A00 = (this.A00 & j11) | Long.rotateRight(this.A00 & (~j11), 1);
        if (this.A01 != null) {
            if (this.A01.A08(0)) {
                A06(63);
            }
