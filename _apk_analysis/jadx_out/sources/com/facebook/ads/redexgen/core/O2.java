...
public final class O2 {
    ...
    private String A03(String str, String str2) {
        ...
        return (strA96 == null || strA96.equals(A02(586, 4, 33))) ? str2 : strA96;
    }
            ...
            if (!str.equals(A02(350, 2, 45))) {
                ...
                try {
                    ...
                    if (A04(jSONObject.getString(A02(670, 17, 10))).size() == 0) {
                        A08(AbstractC2142Sv.A28, new C2143Sw(A02(239, 20, 107)));
                        return null;
                    }
                    if (A04(jSONObject.getString(A02(503, 15, 8))).size() != 0) {
                        return map;
                    }
                    A08(AbstractC2142Sv.A25, new C2143Sw(A02(Sdk.SDKError.Reason.AD_LOAD_FAIL_RETRY_AFTER_VALUE, 18, 45)));
                    return null;
                } catch (JSONException e10) {
                    A08(AbstractC2142Sv.A27, new C2143Sw(e10));
                    return null;
                }
            }
        }
    ...
    public final O6 A0A() {
        O6 o62 = new O6(A00());
        try {
            Iterator<O6> it = A04(A03(A02(503, 15, 8), A02(0, 0, 48))).iterator();
            while (it.hasNext()) {
                o62.A06(it.next());
            }
        } catch (JSONException e10) {
            A07();
            A08(AbstractC2142Sv.A26, new C2143Sw(e10));
        }
        return o62;
    }
    ...
    public final O6 A0B() {
        O6 o62 = new O6(A01());
        try {
            Iterator<O6> it = A04(A03(A02(670, 17, 10), A02(0, 0, 48))).iterator();
            while (it.hasNext()) {
                o62.A06(it.next());
            }
        } catch (JSONException e10) {
            A07();
            A08(AbstractC2142Sv.A29, new C2143Sw(e10));
        }
        return o62;
    }
    ...
    public final void A0N(String str) {
        ...
        C2731gg c2731ggA6A = this.A00.A6A();
        for (String str2 : A03) {
            c2731ggA6A.A01(str2, mapA05.get(str2));
        }
        if (A02[1].length() == 0) {
            throw new RuntimeException();
        }
        ...
        strArr[5] = "LB7njF";
        c2731ggA6A.A00(A02(518, 22, 15), System.currentTimeMillis());
        c2731ggA6A.A02();
    }
