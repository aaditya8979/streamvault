...
public final class SF {
    public static InterfaceC1932Kp A0A;
    ...
    public static final Map<String, C1938Kv> A0F;
    ...
    public SF(SQ sq2) {
        ...
        this.A08 = U7.A2i(sq2);
        this.A09 = U7.A2r(sq2, C2584eF.A03());
    }

    public static synchronized InterfaceC1932Kp A03(C2503cu c2503cu) {
        if (A0A == null) {
            A0A = AbstractC1933Kq.A00(c2503cu, new C1939Kw().A00(U7.A06(c2503cu)).A02(c2503cu.A05().AAF()).A01(-1).A03(U7.A0p(c2503cu)).A04(U7.A2q(c2503cu)).A05(), A05(c2503cu));
        }
        return A0A;
    }

    public static C1938Kv A04(SQ sq2, String str) {
        C1938Kv c1938Kv = A0F.get(str);
        return (!SI.A06(sq2) || c1938Kv == null) ? new C1938Kv(str) : new C1938Kv(c1938Kv);
    }

    public static C2555dl A05(C2503cu c2503cu) {
        return new C2555dl(c2503cu);
    }
    ...
    public static void A0H(SQ sq2, String str) {
        ...
        if (sh2 != null) {
            ...
            C2503cu c2503cuA02 = sq2.A02();
            C2588eJ c2588eJA06 = C2588eJ.A06(c2503cuA02);
            String strA09 = C2588eJ.A09(c2503cuA02, WQ.A00(str));
            if (strA09 == null) {
                strA09 = str;
            }
            SI.A04(sq2, sh2, c2588eJA06.A0J(strA09));
        }
    }
    ...
    public static void A0J(List<String> list, SQ sq2) {
        A0K(list, C2884jO.A01(sq2));
        A0K(list, SG.A07(sq2));
    }

    public static void A0K(List<String> list, File file) {
        String path;
        if (file == null || (path = file.getPath()) == null || path == A08(0, 0, 103)) {
            return;
        }
        ...
        A0D[4] = "BAOa9xP";
        list.add(path.toLowerCase(locale));
    }
    ...
    public final Bitmap A0O(String str, int i10, int i11) {
        ...
        C1938Kv c1938KvA04 = A04(this.A04, str);
        c1938KvA04.A03 = A08(186, 4, 118);
        c1938KvA04.A01 = i11;
        c1938KvA04.A00 = i10;
        return A03(this.A04.A02()).AHu(c1938KvA04, true).A00();
    }

    public final File A0P(String str) {
        C1938Kv c1938KvA04 = A04(this.A04, str);
        c1938KvA04.A03 = A08(186, 4, 118);
        return A03(this.A04.A02()).AHv(c1938KvA04);
    }

    public final File A0Q(String str) {
        return this.A08 ? A0P(str) : this.A03.A0H(str);
    }

    public final String A0R(String str) {
        return this.A08 ? A0S(str) : this.A03.A0I(str);
    }

    public final String A0S(String str) {
        C1938Kv c1938KvA04 = A04(this.A04, str);
        c1938KvA04.A03 = A08(186, 4, 118);
        String strAHx = A03(this.A04.A02()).AHx(c1938KvA04);
    ...
    public final void A0X(S7 s72, S8 s82) {
        ...
        XU.A03().execute(new C2556dm(this, new ArrayList(this.A05), s82, s72, new ArrayList(this.A06)));
        this.A05.clear();
        this.A06.clear();
    }
    ...
    public final void A0e(C2172Ua c2172Ua) {
        this.A01 = c2172Ua;
    }
}
