...
public abstract class AbstractC2236Wp {
    ...
    public static String A01(int i10, String str, String str2) {
        ...
        try {
            ...
            jSONObject.put(A00(30, 3, 18), str2).toString();
    ...
    public static String A02(String str) {
        ...
        return TextUtils.isEmpty(fileExtensionFromUrl) ? strA00 : MimeTypeMap.getSingleton().getMimeTypeFromExtension(fileExtensionFromUrl);
    }
