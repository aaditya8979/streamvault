...
public final class D4 implements InterfaceC2546dc {
    public View A00;
    public E1 A01;
    public EnumC2560dr A02;
    public boolean A03;
    ...
    public D4(View view, EnumC2560dr enumC2560dr, boolean z10) {
        this(view, enumC2560dr, z10, false);
    }

    public D4(View view, EnumC2560dr enumC2560dr, boolean z10, boolean z11) {
        ...
        this.A07 = new DP() { // from class: com.facebook.ads.redexgen.X.32
            ...
            public final void A03(DQ dq2) {
                if (this.A00.A03) {
                    if (this.A00.A02 != EnumC2560dr.A02 && !this.A00.A09) {
                        this.A00.A06(0, 8);
                    } else {
                        this.A00.A02 = null;
                        this.A00.A05();
        ...
        this.A05 = new DX() { // from class: com.facebook.ads.redexgen.X.30
            ...
            public final void A03(C14953d c14953d) {
                if (this.A00.A02 != EnumC2560dr.A03) {
                    this.A00.A00.setAlpha(1.0f);
                    this.A00.A00.setVisibility(0);
                }
            }
        };
        this.A08 = new C14902y(this);
        this.A03 = true;
        this.A04 = new Handler();
        this.A09 = z10;
        this.A0A = z11;
        A08(view, enumC2560dr);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A05() {
        this.A00.animate().alpha(0.0f).setDuration(500L).setListener(new C2559dq(this));
    }
    ...
    private final void A08(View view, EnumC2560dr enumC2560dr) {
        this.A02 = enumC2560dr;
        this.A00 = view;
        this.A00.clearAnimation();
        if (enumC2560dr == EnumC2560dr.A03) {
