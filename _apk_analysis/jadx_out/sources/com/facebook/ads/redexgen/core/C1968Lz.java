...
public final class C1968Lz extends Y3 {
    public C15003i A00;
    public boolean A01;
    public boolean A02;
    ...
    public final D3 A0A;
    public final D1 A0B;
    public final AbstractC2601eW A0C;
    public final C2602eX A0D;

    public C1968Lz(C2529dL c2529dL, US us2, SF sf2, C2172Ua c2172Ua, View.OnClickListener onClickListener) {
        ...
        this.A07 = new DX() { // from class: com.facebook.ads.redexgen.X.63
            ...
            public final void A03(C14953d c14953d) {
                if (U7.A1S(((Y3) this.A00).A01)) {
                    this.A00.A06.A0h(EnumC2545db.A02, 30);
                }
            }
        };
        ...
        this.A0C = A00();
        this.A0D = A07();
        this.A03 = new FrameLayout(c2529dL);
        addView(this.A03, new RelativeLayout.LayoutParams(-1, -1));
        this.A06 = A01(c2172Ua);
        this.A0A = A04();
        this.A09 = A03();
        this.A0B = A06(c2172Ua);
        A0C();
    }
    ...
    private E1 A01(C2172Ua c2172Ua) {
        E1 e12 = new E1(super.A01);
        XP.A0I(e12);
        e12.setFunnelLoggingHandler(c2172Ua);
    ...
    private D1 A06(C2172Ua c2172Ua) {
        D1 d12 = new D1(super.A01, c2172Ua, true);
    ...
    private C2602eX A07() {
        return new C2602eX(this, 50, true, new WeakReference(this.A0C), super.A01);
    }
    ...
    public final boolean A0E() {
        return getMeasuredWidth() <= 0 || this.A06.getMeasuredWidth() <= 0 || ((int) (((double) (getMeasuredWidth() - this.A06.getMeasuredWidth())) / 2.0d)) > Y3.A05 + (Y3.A04 * 2);
    }

    public final C1968Lz A0F(String str, String str2, String str3, String str4, String str5) {
        this.A06.setVideoURI(this.A04.A0T(str2));
        this.A00 = new C15003i(super.A01, this.A05, this.A06, str);
