...
public final class GJ {
    ...
    public GJ(List<byte[]> list, int i10, int i11, int i12, float f10, String str) {
        this.A05 = list;
        this.A02 = i10;
        this.A03 = i11;
        this.A01 = i12;
    ...
    public static GJ A00(C4J c4j) throws C14742i {
        try {
            c4j.A0g(4);
            ...
            String strA01 = null;
            if (iA0I2 > 0) {
                C1829Gp c1829GpA09 = AbstractC1830Gq.A09((byte[]) arrayList.get(0), iA0I, ((byte[]) arrayList.get(0)).length);
                i12 = c1829GpA09.A0A;
                i13 = c1829GpA09.A03;
                f10 = c1829GpA09.A00;
                strA01 = C3U.A01(c1829GpA09.A08, c1829GpA09.A01, c1829GpA09.A04);
            }
            return new GJ(arrayList, iA0I, i12, i13, f10, strA01);
        } catch (ArrayIndexOutOfBoundsException e10) {
            throw C14742i.A01(A01(0, 24, 51), e10);
        }
    }
    ...
    public static byte[] A03(C4J c4j) {
        ...
        int iA09 = c4j.A09();
        c4j.A0g(iA0M);
        return C3U.A07(c4j.A0l(), iA09, iA0M);
    }
}
