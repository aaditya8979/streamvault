...
public abstract class C5Q extends AbstractC1882Ir implements Wf {
    ...
    public final C2228Wh A0C;
    public final InterfaceC2260Xn A0D;
    public final C2367ai A0E;
    public final DX A0F;
    public final DR A0G;
    public final DP A0H;
    public final DN A0I;
    ...
    static {
        A03();
        A0O = (int) (AbstractC2232Wl.A02 * 1.0f);
        A0P = (int) (AbstractC2232Wl.A02 * 4.0f);
        A0N = (int) (AbstractC2232Wl.A02 * 6.0f);
    }

    public C5Q(C2367ai c2367ai, boolean z10, String str, FH fh2) {
        super(c2367ai, z10);
        this.A09 = new Path();
        this.A0A = new RectF();
        ...
        this.A0D = c2367ai.A0D();
        this.A0E = c2367ai;
        this.A03 = fh2;
        this.A0K = str;
        this.A0B = c2367ai.A06();
        this.A0C = C2228Wh.A00(c2367ai.A06(), c2367ai.A05(), this);
        setGravity(17);
    ...
    public final void A1Q() {
        if (A1T()) {
            A1R();
            C2498cp c2498cp = this.A04;
            EnumC2545db enumC2545db = EnumC2545db.A02;
            if (A0M[2].length() == 4) {
                throw new RuntimeException();
            }
            A0M[2] = "GrzUS";
            c2498cp.A05(enumC2545db);
        }
    }
    ...
    public final void A1R() {
        ...
        if (!A1T() || volume == this.A04.getVolume()) {
            return;
        }
        C2498cp c2498cp = this.A04;
        if (A0M[5].length() == 9) {
    ...
    public abstract void A1V(C2529dL c2529dL);

    public final void A1W(Map<String, String> map) {
        this.A04.A02();
        if (A1T()) {
            this.A04.A04(getAdEventManager(), this.A0K, map);
        }
    }
    ...
    public void setCTAInfo(C1993Mz c1993Mz, Map<String, String> map) {
        getCtaButton().setCta(c1993Mz, this.A0K, map);
    }

    public void setImageUrl(String str) {
        this.A01.setVisibility(0);
        this.A04.setVisibility(8);
        new KZ(this.A01, this.A0B).A04().A06(new C1876Il(this)).A07(str);
    }
    ...
    public void setOnAssetsLoadedListener(InterfaceC2418bX interfaceC2418bX) {
        this.A02 = interfaceC2418bX;
    }

    public void setUpImageView(C2529dL c2529dL) {
        this.A01 = new YM(c2529dL);
        if (U7.A1I(c2529dL)) {
            AbstractC2317Zs.A00(this.A01, U7.A1J(c2529dL), new ViewOnClickListenerC2424bd(this));
        }
        A04(this.A01);
    }

    public void setUpMediaContainer(C2529dL c2529dL) {
        this.A00 = new RelativeLayout(c2529dL);
        A04(this.A00);
        C2227Wg c2227WgA02 = this.A0C.A02(this.A0E.A05());
        this.A0E.A06().A0H().A00(c2227WgA02.A01);
        getCtaButton().setCreativeAsCtaLoggingHelper(this.A0C);
        if (this.A0E.A05().A1W() && U7.A2o(this.A0B)) {
            this.A00.setOnClickListener(new ViewOnClickListenerC2423bc(this));
        } else if (c2227WgA02.A00) {
    ...
    public void setUpVideoView(C2529dL c2529dL) {
        this.A04 = new C2498cp(c2529dL, new C2172Ua(this.A0K, getAdEventManager()));
        if (U7.A1K(c2529dL)) {
            AbstractC2317Zs.A00(this.A04, U7.A1L(c2529dL), new ViewOnClickListenerC2425be(this));
        }
        A04(this.A04);
    }
