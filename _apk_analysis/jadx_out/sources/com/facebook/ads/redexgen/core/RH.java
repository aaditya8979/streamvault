...
public final class RH implements MediaViewVideoRendererApi {
    ...
    public final DP A0C = new DP() { // from class: com.facebook.ads.redexgen.X.6d
        ...
        public final void A03(DQ dq2) {
            if (this.A00.A08 != null) {
                C2072Qc.A0L(this.A00.A08.getInternalNativeAd()).A1f(true, true);
            }
    ...
    public final DV A0A = new DV() { // from class: com.facebook.ads.redexgen.X.6T
        ...
        public final void A03(DW dw) {
            if (this.A00.A08 != null) {
                C2072Qc.A0L(this.A00.A08.getInternalNativeAd()).A1f(false, true);
            }
    ...
    public final void A03() {
        ...
        if (this.A08 != null) {
            C2072Qc.A0L(this.A08.getInternalNativeAd()).A1f(false, false);
        }
        this.A08 = null;
        if (this.A04 != null) {
            InterfaceC2184Um interfaceC2184Um = this.A04;
            if (A0H[6].length() != 3) {
                throw new RuntimeException();
            }
            A0H[6] = "qaG";
            interfaceC2184Um.AJn();
        }
    }

    public final void A04(NativeAd nativeAd) {
        this.A08 = nativeAd;
        this.A03.A0L(((C2072Qc) nativeAd.getInternalNativeAd()).A12());
        RK rk2 = (RK) nativeAd.getNativeAdApi();
        this.A05.setClientToken(C2072Qc.A0L(nativeAd.getInternalNativeAd()).A1C());
        this.A05.setVideoMPD(rk2.A01());
        this.A05.setVideoURI(rk2.A02());
        C2825iN c2825iNA0z = C2072Qc.A0L(nativeAd.getInternalNativeAd()).A0z();
        if (c2825iNA0z != null) {
            this.A05.setVideoProgressReportIntervalMs(c2825iNA0z.A0B());
        }
        this.A05.setVideoCTA(nativeAd.getAdCallToAction());
        this.A05.setNativeAd(nativeAd);
        this.A01 = rk2.getVideoAutoplayBehavior();
        if (this.A04 != null) {
            this.A04.AIp(nativeAd);
        }
    }

    public final void A05(US us2) {
        this.A05.setAdEventManager(us2);
    }

    public final void A06(InterfaceC2184Um interfaceC2184Um) {
        this.A04 = interfaceC2184Um;
    }
    ...
    public final void engageSeek() {
        if (this.A06) {
            ...
            this.A06 = true;
            this.A07 = EnumC2599eU.A0A.equals(this.A05.getState());
    ...
    public final void initialize(AdViewConstructorParams adViewConstructorParams, MediaViewVideoRenderer mediaViewVideoRenderer) {
        ...
        C2529dL c2529dLA03 = context instanceof C2529dL ? (C2529dL) context : RB.A03(context);
        this.A03 = c2529dLA03;
        switch (adViewConstructorParams.getInitializationType()) {
            case 0:
                this.A05 = new AnonymousClass64(c2529dLA03);
                break;
            case 1:
                this.A05 = new AnonymousClass64(c2529dLA03, adViewConstructorParams.getAttributeSet());
                break;
            case 2:
                this.A05 = new AnonymousClass64(c2529dLA03, adViewConstructorParams.getAttributeSet(), adViewConstructorParams.getDefStyleAttr());
                break;
            case 3:
                this.A05 = new AnonymousClass64(c2529dLA03, adViewConstructorParams.getAttributeSet(), adViewConstructorParams.getDefStyleRes());
                break;
            default:
    ...
    public final boolean shouldAutoplay() {
        if (this.A05 == null || this.A05.getState() == EnumC2599eU.A06) {
            return false;
        }
