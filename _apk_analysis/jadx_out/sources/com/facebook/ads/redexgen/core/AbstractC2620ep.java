...
public abstract class AbstractC2620ep {
    ...
    public AbstractC2620ep(String str, C2622er c2622er, C2616el c2616el) {
        this.A03 = A00(0, 0, 34);
        if (str != null) {
            this.A03 = str;
        }
        if (c2622er != null && !c2622er.A06().isEmpty()) {
            this.A03 += A00(0, 1, 55) + c2622er.A06();
        }
        this.A00 = c2616el;
    }
    ...
    public final C2616el A02() {
        return this.A00;
    }

    public final EnumC2619eo A03() {
        return this.A01;
    }
