...
public class C2754h4 extends MQ {
    ...
    public final /* synthetic */ C2750gz A00;

    static {
        A01();
    }

    public C2754h4(C2750gz c2750gz) {
        this.A00 = c2750gz;
    }
    ...
    public final void A04() {
        ...
        if (this.A00.A03 != null && U7.A26(this.A00.A06)) {
            this.A00.A03.A0S(new C2755h5(this));
            this.A00.A03.A0N();
            this.A00.A03.A0K();
            this.A00.A03 = null;
        }
    ...
    public final void A0F(MP mp2) {
        if (this.A00.A03 == null) {
            this.A00.A06.A08().AAy(A00(0, 3, 98), AbstractC2142Sv.A0N, new C2143Sw(A00(3, 18, 46)));
            return;
        }
        this.A00.A05 = true;
        this.A00.A02 = this.A00.A03.A0I();
        if (this.A00.A02 instanceof AbstractC2804hy) {
            AbstractC2804hy abstractC2804hy = (AbstractC2804hy) this.A00.A02;
            if (abstractC2804hy.A1x() > 0) {
                WR wr2 = new WR();
                if (wr2.A09(this.A00.A06, this.A00.A08.A08(), abstractC2804hy.A1x())) {
                    wr2.A08(this.A00.A06, true);
                    this.A00.A01 = wr2.A06(this.A00.A06, this.A00.A08.A0A(), this.A00.A08.A08());
                } else {
                    C2750gz c2750gz = this.A00;
                    if (A02[1].charAt(2) != 'w') {
                        A02[7] = "alFbtn3b1";
                        wr2.A08(c2750gz.A06, false);
                    } else {
                        String[] strArr = A02;
                        strArr[6] = "OkLAbmcEeyte5Vfo";
                        strArr[5] = "zgaU15rF2mVDrexS";
                        wr2.A08(c2750gz.A06, false);
                    }
                }
            }
            C2750gz c2750gz2 = this.A00;
            if (A02[1].charAt(2) != 'w') {
                A02[1] = "23I4hcZMgJ395X2lYna8PMjzW0ozt3hz";
                if (c2750gz2.A01 != null) {
                    abstractC2804hy.A2A(true);
                    this.A00.A01.loadAd(this.A00.A01.buildLoadAdConfig().withAdListener(new C1997Nd(this, abstractC2804hy)).withCacheFlags(this.A00.A08.A0B()).withRewardData(this.A00.A08.A03()).build());
                    return;
                }
                C2750gz c2750gz3 = this.A00;
                String[] strArr2 = A02;
                if (strArr2[0].charAt(8) != strArr2[3].charAt(8)) {
                    c2750gz3.A07.onAdLoaded(this.A00.A08.A6c());
                    return;
                } else {
                    A02[2] = "joZPUUFug9Ts";
                    c2750gz3.A07.onAdLoaded(this.A00.A08.A6c());
            ...
            String[] strArr3 = A02;
            if (strArr3[0].charAt(8) == strArr3[3].charAt(8)) {
                String[] strArr4 = A02;
                strArr4[6] = "JHAXxmwzHKs3NajX";
                strArr4[5] = "FHZeNyejFCAXh3Vz";
