...
public final class C15615r extends KL {
    ...
    public static final int A01 = (int) (AbstractC2232Wl.A02 * 152.0f);

    public C15615r(C2529dL c2529dL, KE ke2, int i10, boolean z10, C1992My c1992My, String str, US us2, InterfaceC2260Xn interfaceC2260Xn, C2602eX c2602eX, XH xh2, AbstractC2804hy abstractC2804hy, C1732Cw c1732Cw, C2172Ua c2172Ua, boolean z11) {
    ...
    private void A01(int i10) {
        if (((AbstractC2320Zv) this).A08.getParent() != null) {
            KE ke2 = ((AbstractC2320Zv) this).A08;
            if (A00[6].length() != 21) {
        ...
        if (i10 == 1) {
            ...
            this.A0N.addView(((AbstractC2320Zv) this).A08);
    ...
    private void A06(int i10) {
        ...
        layoutParams.setMargins(i11, KL.A0u, i11, KL.A0l);
        layoutParams.addRule(14);
    ...
    private void A08(int i10) {
        ...
        if (i10 == 1) {
            ...
            layoutParams.removeRule(2);
            layoutParams.addRule(3, ((AbstractC2320Zv) this).A08.getId());
            layoutParams.setMargins(0, KL.A0l, 0, 0);
        }
    ...
    private void A09(int i10) {
        ...
        int i11 = i10 == 1 ? KL.A0r : 0;
        layoutParams.setMargins(i11, KL.A0l, i11, 0);
        layoutParams.addRule(14);
    ...
    public final void A0h(int i10) {
        super.A0h(i10);
        XP.A0Z(this.A0N, ((AbstractC2320Zv) this).A09, this.A0Q, this.A0U, ((KL) this).A04, this.A0P, this.A0K, this.A0J, this.A0I);
        A00();
        A07(i10);
        A0A(((KL) this).A04, i10);
        A08(i10);
