...
public final class C1945Lc extends RelativeLayout implements InterfaceC2261Xo {
    ...
    public boolean A0G;
    public boolean A0H;
    public final AbstractC2804hy A0I;
    public final NB A0J;
    public final R6 A0K;
    public final C2529dL A0L;
    public final US A0M;
    public final C2172Ua A0N;
    public final C2226Wd A0O;
    public final XC A0P;
    public final InterfaceC2260Xn A0Q;
    public final YY A0R;
    public final InterfaceC2340aH A0S;
    public final C2341aI A0T;
    public final C2513d4 A0U;
    public final AtomicBoolean A0V;
    public final AtomicBoolean A0W;
    public final boolean A0X;
    public final boolean A0Y;
    public final boolean A0Z;
    public final AbstractC2259Xm A0a;

    static {
        A0N();
        A0o = (int) (AbstractC2232Wl.A02 * 64.0f);
        A0g = (int) (AbstractC2232Wl.A02 * 16.0f);
        A0p = (int) (AbstractC2232Wl.A02 * 12.0f);
        A0e = (int) (AbstractC2232Wl.A02 * 10.0f);
        A0q = new RelativeLayout.LayoutParams(-1, -1);
        A0h = (int) (AbstractC2232Wl.A02 * 48.0f);
        A0i = (int) (AbstractC2232Wl.A02 * 16.0f);
        A0n = (int) (AbstractC2232Wl.A02 * 14.0f);
        A0l = (int) (AbstractC2232Wl.A02 * 12.0f);
        A0m = OP.A02(-1, 77);
        A0d = (int) (AbstractC2232Wl.A02 * 8.0f);
        A0j = (int) (AbstractC2232Wl.A02 * 20.0f);
        A0k = (int) (AbstractC2232Wl.A02 * 13.0f);
        A0f = (int) (AbstractC2232Wl.A02 * 8.0f);
    }

    public C1945Lc(C2529dL c2529dL, US us2, InterfaceC2260Xn interfaceC2260Xn, AbstractC2804hy abstractC2804hy, String str, YY yy, C2508cz c2508cz) {
        this(c2529dL, us2, interfaceC2260Xn, abstractC2804hy, str, yy, false, c2508cz);
    }

    public C1945Lc(C2529dL c2529dL, US us2, InterfaceC2260Xn interfaceC2260Xn, AbstractC2804hy abstractC2804hy, String str, YY yy, boolean z10, C2508cz c2508cz) {
        super(c2529dL);
        String strA0D = A0D(0, 0, 113);
        this.A0A = strA0D;
        this.A09 = strA0D;
        this.A0K = new C1963Lu(this);
        ...
        this.A0Z = z10;
        this.A0L = c2529dL;
        this.A0Q = interfaceC2260Xn;
        this.A0M = us2;
        this.A0I = abstractC2804hy;
        this.A0J = abstractC2804hy.A20().A0H().A07();
        this.A0N = new C2172Ua(this.A0I.A25(), this.A0M);
        this.A0R = yy;
        this.A08 = new C2526dI(c2529dL, this.A0R, str, this.A0Q);
        if (abstractC2804hy.A20().A0H().A07() != null) {
            this.A0D = abstractC2804hy.A20().A0H().A07().A0N();
            this.A0A = abstractC2804hy.A20().A0H().A07().A0H();
            this.A09 = abstractC2804hy.A20().A0H().A07().A0G();
        }
        ...
        int iA03 = this.A0J != null ? !this.A0J.A0P() ? (this.A0E && this.A0Y) ? this.A0I.A20().A0H().A03() : this.A0J.A07() : this.A0J.A08() : 0;
        this.A0W.set(!this.A0J.A0L());
        C1963Lu c1963Lu = null;
        this.A0O = new C2226Wd(iA03, new C1947Le(this, c1963Lu));
        this.A0X = U7.A0o(this.A0L);
        this.A0a = A07();
        if (this.A0J.A0P()) {
            this.A0a.A06();
        }
        this.A0U = new C2513d4(this.A0L, this.A0M, this.A0I);
        AbstractC2350aR.A00(c2529dL, this, abstractC2804hy.A20().A0H().A08());
        this.A0P = new XC(this);
        this.A0P.A05(XB.A02);
        if (U7.A2D(this.A0L)) {
            this.A0a.setProgressSpinnerInvisible(true);
        }
        C1946Ld c1946Ld = new C1946Ld(this, c1963Lu);
        if (c2508cz == null) {
            HashMap map = new HashMap();
            map.put(A0D(56, 9, 90), this.A0R.A8d());
            this.A07 = new C2508cz(this.A0L, this.A0I, this.A0J, this.A0M, c1946Ld, map);
        } else {
            this.A07 = c2508cz;
            this.A07.setPlayableAdsViewListener(c1946Ld);
        }
        A0K();
        this.A0Q.A3x(this, new RelativeLayout.LayoutParams(-1, -1));
        A0H();
        this.A0S = new C1960Lr(this);
        this.A0T = new C2341aI(this.A0L, this.A0a, this.A0I, (E1) null, this.A0Q, this.A0S, this.A06, this.A01, this.A07);
    ...
    private FullScreenAdToolbar A07() {
        ...
        fullScreenAdToolbar.setToolbarListener(new C1948Lf(this));
    ...
    private C2349aQ A0B() {
        C2529dL c2529dL = this.A0L;
        C1992My c1992MyA01 = this.A0I.A1z().A01();
        ...
        C2349aQ c2349aQ = new C2349aQ(c2529dL, c1992MyA01, true, i10, !z10 ? 14 : 13, 0);
        c2349aQ.A04(this.A0I.A20().A0I().A0F(), this.A0I.A20().A0I().A0E(), null, false, true);
        TextView descriptionTextView = c2349aQ.getDescriptionTextView();
        descriptionTextView.setAlpha(0.8f);
        descriptionTextView.setMaxLines(1);
        descriptionTextView.setEllipsize(TextUtils.TruncateAt.END);
        TextView titleTextView = c2349aQ.getTitleTextView();
    ...
    private void A0G() {
        ...
        C2343aK c2343aK = new C2343aK(this.A0L);
        XP.A0K(c2343aK, 0);
        XP.A0I(c2343aK);
        new KZ(c2343aK, this.A0L).A05(A0h, A0h).A07(this.A0I.A23().A01());
        ...
        C2345aM c2345aM = new C2345aM(this.A0L, !this.A0D ? A0n : A0l, 5, A0m, -1);
        ...
        if (this.A02 != null) {
            ...
            this.A02.addView(relativeLayout, layoutParams5);
            this.A02.addView(c2343aK, layoutParams);
        }
        ...
        c2345aM.setRating(Float.parseFloat(this.A0I.A20().A0I().A0B()));
        if (this.A0I.A20().A0I().A08() != null) {
            StringBuilder sb2 = new StringBuilder();
            sb2.append(A0D(0, 1, 63));
            sb2.append(!this.A0D ? NumberFormat.getNumberInstance().format(Integer.parseInt(this.A0I.A20().A0I().A08())) : AbstractC2241Wu.A01(Integer.parseInt(this.A0I.A20().A0I().A08())));
    ...
    public void A0I() {
        ...
        if (this.A0I.A20().A0S()) {
            this.A08.A05();
            this.A0Q.A4c(this.A0R.A6d(), new C14953d(0, 0));
        }
    }

    private void A0J() {
        C2480cX c2480cXA0F = new C2478cV(this.A0L, this.A0I.A20().A0I(), this.A0I.A23()).A0A(this.A0I.A1z().A01()).A0D(this.A0J.A0J()).A0C(this.A0J.A0E()).A09(2000).A0E(this.A0D).A0B(this.A0A).A0F();
        AbstractC2174Uc.A04(c2480cXA0F, this.A0N, UZ.A0U);
        addView(c2480cXA0F, A0q);
        c2480cXA0F.A04(new C1958Lp(this));
    }
    ...
    private void A0K() {
        ...
        if (this.A0X) {
            ...
            this.A02.addView(A0B(), new RelativeLayout.LayoutParams(-2, -2));
        }
        ...
        layoutParams5.setMargins(A0g, 0, A0g, 0);
        layoutParams5.addRule(3, this.A0a.getId());
        layoutParams5.addRule(2, this.A01.getId());
        this.A0a.setVisibility(4);
        this.A07.setVisibility(4);
        this.A01.setVisibility(4);
        addView(this.A0a, layoutParams4);
        addView(this.A07, layoutParams5);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void A0L() {
        new C2172Ua(this.A0I.A25(), this.A0M).A04(UZ.A0z, null);
        this.A0V.set(true);
        XP.A0R(this);
        XP.A0F(this.A07);
        ...
        XP.A0J(this.A06);
        Pair<EnumC2512d3, View> pairA03 = this.A0U.A03(this.A06);
        this.A00 = (View) pairA03.second;
        switch (YE.A00[((EnumC2512d3) pairA03.first).ordinal()]) {
            case 1:
                ...
                if (!this.A0D) {
                    ...
                    addView(new C2473cQ(this.A0L, this.A0I.A23(), this.A0I.A20().A0I(), A09(), this.A09, new YC(this)), new RelativeLayout.LayoutParams(-1, -1));
                    removeView(this.A0a);
                }
                break;
            case 2:
    ...
    public void A0M() {
        ...
        AbstractC2259Xm abstractC2259Xm = this.A0a;
        if (A0c[3].length() == 2) {
            throw new RuntimeException();
        }
        String[] strArr = A0c;
        ...
        abstractC2259Xm.setVisibility(0);
        this.A07.setVisibility(0);
        if (this.A01 != null) {
            this.A01.setVisibility(0);
        }
        if (this.A06 != null && this.A0I.A1w() > 0 && this.A05 == null) {
            this.A05 = new C2226Wd(this.A0I.A1w(), new C1949Lg(this));
            this.A05.A07();
        }
        this.A0O.A07();
    }
    ...
    public void A0O(int i10) {
        XP.A0X(this.A03, this.A0J.A0D().replace(A0D(2, 6, 75), String.valueOf(i10)), 49, 0, A0o);
    }
    ...
    public final void onDestroy() {
        ...
        if (this.A07 != null) {
            if (!TextUtils.isEmpty(this.A0I.A25())) {
                this.A0M.AAt(this.A0I.A25(), new C2314Zp().A03(this.A07.getViewabilityChecker()).A02(this.A07.getTouchDataRecorder()).A05());
            }
            this.A07.A0C();
        }
        this.A0O.A06();
