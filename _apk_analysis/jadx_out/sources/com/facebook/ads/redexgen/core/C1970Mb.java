...
public final class C1970Mb extends BroadcastReceiver {
    ...
    public C1970Mb(C2529dL c2529dL, String str, C2830iS c2830iS, InterfaceC1969Ma interfaceC1969Ma) {
        this.A02 = c2529dL;
        this.A03 = str;
        this.A01 = interfaceC1969Ma;
        this.A00 = c2830iS;
    }
    ...
    public static String A00(int i10, int i11, int i12) {
        ...
        for (int i13 = 0; i13 < bArrCopyOfRange.length; i13++) {
            int i14 = (bArrCopyOfRange[i13] - i12) - 35;
            String[] strArr = A05;
    ...
    public final void onReceive(Context context, Intent intent) {
        String str = intent.getAction().split(A00(0, 1, 64))[0];
        if (this.A01 == null || str == null) {
            return;
        }
        if (A00(98, 37, 113).equals(str)) {
            this.A01.ADY(this.A00, null, true);
            return;
        }
        if (A00(TTAdConstant.IMAGE_MODE_VERTICAL_IMG_173, 39, 10).equals(str)) {
            InterfaceC1969Ma interfaceC1969Ma = this.A01;
            C2830iS c2830iS = this.A00;
            if (A05[4].length() != 17) {
                throw new RuntimeException();
            }
            String[] strArr = A05;
            ...
            interfaceC1969Ma.ADZ(c2830iS);
            return;
        }
        if (A00(252, 39, 54).equals(str)) {
            this.A01.ADa(this.A00);
            return;
        }
        if (A00(448, 47, 47).equals(str)) {
            this.A01.ADd(this.A00);
            return;
        }
        if (A00(331, 35, 104).equals(str)) {
            if (U7.A1t(context)) {
        ...
        if (A00(1, 48, 124).equals(str)) {
            this.A01.onInterstitialActivityDestroyed();
            return;
        }
        if (A00(543, 36, 60).equals(str)) {
            this.A01.ADe();
        } else if (A00(719, 51, 52).equals(str)) {
            this.A01.ADg();
        } else if (A00(616, 51, 15).equals(str)) {
            this.A01.ADf();
        }
    }
}
