...
public abstract class AbstractC2124Sd {
    ...
    private String A00() {
        ...
        String strA01 = A01(0, 0, 12);
        for (int i10 = 0; i10 < sxArrA0A.length - 1; i10++) {
            strA01 = strA01 + sxArrA0A[i10].A02() + A01(20, 2, 43);
        }
        return strA01 + sxArrA0A[sxArrA0A.length - 1].A02();
    }
