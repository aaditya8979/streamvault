...
public final class FB {
    ...
    public static InterfaceC14973f A00(float f10) throws Exception {
        A04();
        Object objNewInstance = A00.newInstance(new Object[0]);
        A04.invoke(objNewInstance, Float.valueOf(f10));
        C3M.A01(A02.invoke(objNewInstance, new Object[0]));
        return null;
    }

    public static InterfaceC15204c A01() throws Exception {
        A04();
        C3M.A01(A03.invoke(A01.newInstance(new Object[0]), new Object[0]));
        return null;
    }
    ...
    public static void A04() throws Exception {
        ...
        if (constructor == null || A04 == null || A02 == null) {
            ...
            A04 = cls.getMethod(A02(183, 18, 97), Float.TYPE);
