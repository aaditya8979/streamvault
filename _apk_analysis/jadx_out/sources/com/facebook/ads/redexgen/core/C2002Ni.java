...
public final class C2002Ni {
    ...
    static {
        A01();
        A02 = C2002Ni.class.getSimpleName();
    }
    ...
    public static void A02(C2503cu c2503cu, Message message) {
        Bundle bundle = message.getData().getBundle(A00(55, 17, 118));
        if (bundle != null) {
            TN.A06(c2503cu, bundle.getString(A00(90, 23, 32)), bundle.getString(A00(72, 18, 123)));
        }
    }
    ...
    public static boolean A03(Context context, String str) {
        ...
        try {
            return FbValidationUtils.isFbSigningCertificateValid(FbValidationUtils.getSigningCertificate(packageManager.getPackageInfo(str, 64)));
    ...
    */
    public static boolean A04(com.facebook.ads.redexgen.core.C2503cu r7, boolean r8, android.content.ServiceConnection r9) {
        /*
            ...
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.C2002Ni.A01
            r0 = 1
            r1 = r1[r0]
            r0 = 26
            ...
            r0 = 53
            if (r1 == r0) goto La4
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C2002Ni.A01
        ...
        La4:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2002Ni.A04(com.facebook.ads.redexgen.X.cu, boolean, android.content.ServiceConnection):boolean");
    }
}
