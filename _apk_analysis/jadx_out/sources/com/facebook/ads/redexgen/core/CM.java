...
public final class CM extends TextureView implements TextureView.SurfaceTextureListener, InterfaceC2581eC, InterfaceC2597eS, InterfaceC2583eE {
    ...
    public EnumC2599eU A0E;
    public InterfaceC2600eV A0F;
    public String A0G;
    public boolean A0H;
    public boolean A0I;
    public boolean A0J;
    ...
    public CM(C2529dL c2529dL) {
        super(c2529dL);
        this.A0D = EnumC2599eU.A04;
        this.A0E = EnumC2599eU.A04;
        this.A0M = false;
        this.A0N = false;
        this.A0J = false;
        this.A03 = 0;
    ...
    public CM(C2529dL c2529dL, AttributeSet attributeSet) {
    ...
    public CM(C2529dL c2529dL, AttributeSet attributeSet, int i10) {
    ...
    */
    private void A04() {
        ...
        L4a:
            ...
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.CM.A0P
            r0 = 6
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 18
        ...
        L66:
            ...
            if (r1 == r0) goto L7f
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.CM.A0P
        ...
        La4:
            ...
            r2.A0F(r1, r0)
        Lb1:
            com.facebook.ads.redexgen.X.eU r0 = com.facebook.ads.redexgen.core.EnumC2599eU.A08
            r5.setVideoState(r0)
        ...
        Lc3:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.CM.A04():void");
    }

    private void A05() {
        C2582eD c2582eDA08;
        if (this.A0C == null || (c2582eDA08 = this.A0C.A08()) == null) {
            return;
        }
        A08(c2582eDA08.A01, c2582eDA08.A00);
    }
    ...
    private void setVideoState(EnumC2599eU enumC2599eU) {
        if (enumC2599eU != this.A0D) {
            if (this.A0A.A05().AAF()) {
                String str = A03(196, 23, 81) + enumC2599eU;
            }
            this.A0D = enumC2599eU;
            if (this.A0D == EnumC2599eU.A0A) {
                this.A0N = true;
            }
            if (this.A0F != null) {
                this.A0F.AFt(enumC2599eU);
            }
        }
    }
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2581eC
    public final void AEe(String str, Exception exc) {
        this.A0A.A0F().ABx(str);
        this.A0A.A0F().A3a(1);
        setVideoState(EnumC2599eU.A03);
        this.A0A.A08().AAy(A03(Sdk.SDKError.Reason.MRAID_JS_COPY_FAILED_VALUE, 7, 15), AbstractC2142Sv.A1N, new C2143Sw(exc));
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:19:0x005e, code lost:
        ...
        r3 = com.facebook.ads.redexgen.core.EnumC2599eU.A05;
        r2 = com.facebook.ads.redexgen.core.CM.A0P;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:21:0x0072, code lost:
        ...
        com.facebook.ads.redexgen.core.CM.A0P[6] = "dNFvbzP2EYglZVOCcO";
        setVideoState(r3);
     */
    ...
    */
    public final void AEf(boolean r8, int r9) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.CM.AEf(boolean, int):void");
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC2583eE
    ...
    public final void AJM(EnumC2545db enumC2545db, int i10) {
        ...
        this.A0M = false;
        this.A0E = EnumC2599eU.A0A;
        this.A0B = enumC2545db;
        if (this.A0C == null) {
            setup(this.A06);
            return;
        }
        if (this.A0D == EnumC2599eU.A07 || this.A0D == EnumC2599eU.A05 || this.A0D == EnumC2599eU.A06) {
            this.A0C.A0I(true);
            EnumC2599eU enumC2599eU = EnumC2599eU.A0A;
            String[] strArr = A0P;
    ...
    public final void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i10, int i11) {
        ...
        if (this.A0D != EnumC2599eU.A05 || this.A0M) {
            return;
        }
        AJM(this.A0B, 7);
    }
    ...
    public final void onSurfaceTextureUpdated(SurfaceTexture surfaceTexture) {
        if (U7.A1v(this.A0A)) {
            EnumC2599eU enumC2599eU = this.A0D;
            if (A0P[6].length() != 18) {
                throw new RuntimeException();
            }
            String[] strArr = A0P;
            strArr[0] = "Md";
            strArr[1] = "f0";
            if (enumC2599eU == EnumC2599eU.A08) {
                return;
            }
            if (!this.A0L) {
                this.A0L = true;
            ...
            if (this.A0F != null) {
                this.A0F.ADK(currentPosition, currentPosition2, jCurrentTimeMillis, volume);
            }
        }
    }
    ...
    public void setControlsAnchorView(View view) {
        this.A08 = view;
        view.setOnTouchListener(new ViewOnTouchListenerC2592eN(this));
    }
    ...
    public void setFullScreen(boolean z10) {
        ...
        setOnTouchListener(new ViewOnTouchListenerC2591eM(this));
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC2597eS
    public void setRequestedVolume(float f10) {
        this.A00 = f10;
        if (this.A0C == null || this.A0D == EnumC2599eU.A08 || this.A0D == EnumC2599eU.A04) {
            return;
        }
        this.A0C.A0C(f10);
    }
