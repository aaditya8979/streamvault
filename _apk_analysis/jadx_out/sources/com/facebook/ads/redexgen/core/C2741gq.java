...
public final class C2741gq implements TL {
    ...
    public C2741gq(String str, String str2, Bundle bundle) {
        this.A01 = str;
        this.A02 = str2;
        this.A00 = bundle;
    }
    ...
    @Override // com.facebook.ads.redexgen.core.TL
    public final C2125Se A7e(SQ sq2) {
        ...
        Integer numValueOf2 = Integer.valueOf(this.A00.getInt(A00(125, 33, 72), -1));
        if (numValueOf2.intValue() == -1) {
            numValueOf2 = null;
        }
        return new C2125Se(stringArray, numValueOf, numValueOf2);
    }
    ...
    public final String A98() {
        ...
        if (AdSettings.TestAdType.DEFAULT.getAdTypeString().equals(string)) {
            return null;
        }
        for (AdSettings.TestAdType testAdType : AdSettings.TestAdType.values()) {
            if (testAdType.getAdTypeString().equals(string)) {
                return testAdType.getAdTypeString();
            }
        }
        return null;
    }
