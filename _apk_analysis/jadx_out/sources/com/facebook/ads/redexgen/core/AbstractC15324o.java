...
public abstract class AbstractC15324o {
    ...
    public static int A00(SQLiteDatabase sQLiteDatabase, int i10, String str) throws C15294l {
        try {
        } catch (SQLException e10) {
            throw new C15294l(e10);
        }
        if (!AbstractC15184a.A19(sQLiteDatabase, A01(159, 17, 73))) {
            return -1;
        }
    ...
    public static void A03(SQLiteDatabase sQLiteDatabase, int i10, String str) throws C15294l {
        String strA01 = A01(159, 17, 73);
        try {
            if (AbstractC15184a.A19(sQLiteDatabase, strA01)) {
    ...
    public static void A04(SQLiteDatabase sQLiteDatabase, int i10, String str, int i11) throws C15294l {
        try {
