...
public final class YO extends LinearLayout {
    public static final int A08 = (int) (AbstractC2232Wl.A02 * 15.0f);
    public static final int A09 = (int) (AbstractC2232Wl.A02 * 10.0f);
    public static final int A0A = (int) (AbstractC2232Wl.A02 * 44.0f);
    public int A00;
    public boolean A01;
    public boolean A02;
    ...
    public YO(C2529dL c2529dL, int i10, boolean z10) {
        super(c2529dL);
        this.A01 = false;
        this.A06 = c2529dL;
        this.A02 = z10;
    ...
    private void A01() {
        int i10 = 8;
        this.A07.setVisibility((this.A00 == 2 || this.A00 == 6) ? this.A01 ? 4 : 0 : 8);
    ...
    public final void A04(C1992My c1992My, boolean z10, boolean z11) {
        int iA05 = c1992My.A05(z10);
        this.A07.A03(OP.A02(iA05, 77), iA05, 110);
        this.A03.setColorFilter(iA05);
        if (z11) {
            this.A05.setTextColor(OP.A02(-1, 110));
        } else {
