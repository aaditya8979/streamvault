...
public final class MV {
    ...
    private final synchronized N2 A00(String str, JSONObject jSONObject) throws C2143Sw, JSONException {
        N2 n22;
        if (!str.equals(jSONObject.optString(A01(29, 12, 70), null))) {
            C2143Sw c2143Sw = new C2143Sw(new IllegalArgumentException());
    ...
    private void A03(N2 n22, JSONObject jSONObject) throws JSONException {
        ...
        int iOptInt3 = jSONObject.optInt(A01(41, 23, 106), 50);
        ...
        if (jSONObject.has(strA012)) {
            n22.A04(jSONObject.optInt(strA012));
        }
        n22.A05(iOptInt, iOptInt2, jOptLong, iOptInt3);
    }
    ...
    public final synchronized void A0A(@Nullable String str) throws C2143Sw, JSONException {
        if (str != null) {
            if (!str.trim().isEmpty()) {
    ...
    public final synchronized void A0B(JSONObject jSONObject) throws JSONException {
        ...
        N2 n22 = (this.A00.has(strOptString) && (this.A00.get(strOptString) instanceof N2)) ? (N2) this.A00.get(strOptString) : new N2(strOptString);
        A03(n22, jSONObject);
        this.A00.put(strOptString, n22);
    }
}
