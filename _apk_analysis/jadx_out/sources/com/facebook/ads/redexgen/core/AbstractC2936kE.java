...
public abstract class AbstractC2936kE<T> implements Iterator<T> {
    ...
    public Iterator<V> A02 = AbstractC3115nL.A02();
    public final Iterator<Map.Entry<K, Collection<V>>> A03;
    public final /* synthetic */ AbstractC14501i A04;

    public AbstractC2936kE(AbstractC14501i abstractC14501i) {
        this.A04 = abstractC14501i;
        this.A03 = abstractC14501i.A01.entrySet().iterator();
    }

    public abstract T A00(@ParametricNullness K k10, @ParametricNullness V v10);
    ...
    public final T next() {
        ...
        return A00(AbstractC3180oQ.A01(this.A00), this.A02.next());
    }
