...
public final class C4A {
    ...
    public static void A02(Context context, C4D c4d) {
        try {
            ...
            AnonymousClass49 anonymousClass49 = new AnonymousClass49(c4d);
            telephonyManager.registerTelephonyCallback(context.getMainExecutor(), anonymousClass49);
            telephonyManager.unregisterTelephonyCallback(anonymousClass49);
