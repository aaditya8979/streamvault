...
public abstract class AbstractC3184oU implements C1S {
    ...
    public static final C1R<AbstractC3184oU> A03;

    static {
        A07();
        A02 = AbstractC15184a.A0h(0);
        A03 = new C1R() { // from class: com.facebook.ads.redexgen.X.oX
            @Override // com.facebook.ads.redexgen.core.C1R
            public final C1S A6X(Bundle bundle) {
                return AbstractC3184oU.A04(bundle);
            }
        };
    }

    public static AbstractC3184oU A04(Bundle bundle) {
        int i10 = bundle.getInt(A02, -1);
        switch (i10) {
            case 0:
                return (AbstractC3184oU) C16539s.A02.A6X(bundle);
            case 1:
                AbstractC3184oU abstractC3184oU = (AbstractC3184oU) C16519q.A02.A6X(bundle);
                if (A01[6].charAt(2) != 'F') {
                    String[] strArr = A01;
                    strArr[7] = "RK";
                    strArr[1] = "0";
                    return abstractC3184oU;
                }
                break;
            case 2:
                return (AbstractC3184oU) C16509p.A04.A6X(bundle);
            case 3:
                C1S c1sA6X = C16499o.A02.A6X(bundle);
                if (A01[6].charAt(2) != 'F') {
                    String[] strArr2 = A01;
                    strArr2[7] = "Vr";
                    strArr2[1] = "2";
                    return (AbstractC3184oU) c1sA6X;
                }
                break;
            default:
