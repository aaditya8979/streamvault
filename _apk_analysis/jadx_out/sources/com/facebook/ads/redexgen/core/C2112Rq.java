...
public final class C2112Rq {
    ...
    public final C2111Rp A02() {
        SharedPreferences sharedPreferences = this.A00;
        String strA00 = A00(0, 13, 55);
        if (!sharedPreferences.contains(strA00)) {
            return C2111Rp.A00();
        }
        return new C2111Rp(this.A00.getString(strA00, A00(0, 0, 75)), this.A00.getBoolean(A00(54, 15, 96), false), EnumC2110Ro.A08, this.A00.getLong(A00(26, 7, 65), -1L));
    }
    ...
    public final void A04(C2111Rp c2111Rp) {
        SharedPreferences.Editor editorEdit = this.A00.edit();
        editorEdit.putString(A00(0, 13, 55), c2111Rp.A03());
        editorEdit.putBoolean(A00(54, 15, 96), c2111Rp.A04());
        editorEdit.putLong(A00(26, 7, 65), c2111Rp.A01());
        editorEdit.apply();
    }
