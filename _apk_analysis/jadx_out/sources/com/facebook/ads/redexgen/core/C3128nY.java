...
public class C3128nY extends C5I {
    ...
    public C3128nY(int i10) {
        this(i10, 0);
    }

    public C3128nY(int i10, int i11) {
        this.A05 = new C5N();
        this.A06 = i10;
        this.A07 = i11;
    }

    public static C3128nY A02() {
        return new C3128nY(0);
    }
    ...
    private ByteBuffer A04(final int i10) {
        if (this.A06 == 1) {
            ...
            if (A09[2].length() != 11) {
                ...
                throw new IllegalStateException(iCapacity, i10) { // from class: com.facebook.ads.redexgen.X.5R
                    ...
                    {
                        super(A00(4, 18, 86) + iCapacity + A00(0, 3, 89) + i10 + A00(3, 1, 114));
                        this.A00 = iCapacity;
                        this.A01 = i10;
                    }
                    ...
                    public static String A00(int i12, int i13, int i14) {
                        ...
                        for (int i15 = 0; i15 < bArrCopyOfRange.length; i15++) {
                            bArrCopyOfRange[i15] = (byte) ((bArrCopyOfRange[i15] - i14) - 17);
                        }
                        return new String(bArrCopyOfRange);
                    }

                    public static void A01() {
                        A02 = new byte[]{-118, -90, -118, -84, -87, -36, -51, -51, -52, ExifInterface.MARKER_EOI, -121, -37, -42, -42, -121, -38, -44, -56, -45, -45, -121, -113};
                    }
                };
            }
        }
    ...
    public static void A05() {
        A08 = new byte[]{40, 32, 32, 40, 97, ExifInterface.START_CODE, 55, 32, 97, 43, ExifInterface.START_CODE, 44, 32, 43, ExifInterface.START_CODE, 61};
    }
    ...
    public final void A0C(int i10) {
        ...
        ByteBuffer byteBufferA04 = A04(i12);
