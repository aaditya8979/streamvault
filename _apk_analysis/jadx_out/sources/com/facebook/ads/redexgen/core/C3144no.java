...
public class C3144no extends SQLiteOpenHelper implements InterfaceC15304m {
    ...
    public C3144no(Context context) {
            ...
            try {
                ...
                if (!A00(88, 15, 125).equals(string2)) {
                    ...
                    try {
                        ...
                        AnonymousClass44.A08(A00(32, 18, 71), A00(16, 16, 55) + str, e10);
                    }
                }
            } catch (Throwable th2) {
                if (cursorQuery != null) {
