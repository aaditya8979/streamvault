...
public final class AnonymousClass90 implements InterfaceC2995lN {
    ...
    public final InterfaceC3141nl A05;
    public final byte[] A06;

    public AnonymousClass90(InterfaceC3141nl interfaceC3141nl, long j10, long j11) {
        this(interfaceC3141nl, j10, j11, false);
    }

    public AnonymousClass90(InterfaceC3141nl interfaceC3141nl, long j10, long j11, boolean z10) {
        this.A05 = interfaceC3141nl;
        this.A02 = j10;
        this.A04 = j11;
    ...
    private void A04(int i10) {
        ...
        if (i11 > this.A03.length) {
            this.A03 = Arrays.copyOf(this.A03, AbstractC15184a.A07(this.A03.length * 2, 65536 + i11, 524288 + i11));
        }
    }
    ...
    public final boolean A06(int i10, boolean z10) throws IOException {
        ...
        while (true) {
            ...
            iA00 = A02(this.A06, -iA00, Math.min(i10, this.A06.length + iA00), iA00, z10);
        }
        A03(iA00);
        return iA00 != -1;
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC2995lN
    ...
    */
    ...
    public final int AG8(byte[] bArr, int i10, int i11) throws IOException {
        ...
        System.arraycopy(this.A03, this.A01, bArr, i10, iMin);
        this.A01 += iMin;
        return iMin;
    }
    ...
    public final int AJG(int i10) throws IOException {
        int iA00 = A00(i10);
        if (iA00 == 0) {
            iA00 = A02(this.A06, 0, Math.min(i10, this.A06.length), 0, true);
        }
        A03(iA00);
        String[] strArr = A07;
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2995lN, com.facebook.ads.redexgen.core.AnonymousClass20
    public final int read(byte[] bArr, int i10, int i11) throws IOException {
        int iA01 = A01(bArr, i10, i11);
        if (iA01 == 0) {
            iA01 = A02(bArr, i10, i11, 0, true);
        }
        A03(iA01);
        return iA01;
    }
