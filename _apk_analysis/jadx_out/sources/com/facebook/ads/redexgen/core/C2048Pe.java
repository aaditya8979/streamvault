...
public class C2048Pe implements InterfaceC2609ee {
    ...
    public C2048Pe(VU vu, VR vr2, long j10) {
        this.A02 = vu;
        this.A01 = vr2;
        this.A00 = j10;
    }
    ...
    private final void A02(C2621eq c2621eq) {
        VQ.A06(this.A01);
        try {
            InterfaceC2607ec interfaceC2607ecA00 = c2621eq.A00();
            if (interfaceC2607ecA00 != null) {
                String strA6v = interfaceC2607ecA00.A6v();
                VX vxA07 = this.A02.A06.A07(this.A02.A05, strA6v, this.A00);
                if (vxA07.A01() == VW.A03) {
                    PV pv = (PV) vxA07;
            ...
            String message = c2621eq.getMessage();
            ...
            String message2 = c2621eq.getMessage();
            ...
            this.A02.A0E(V1.A01(adErrorType2, message2));
        }
    }
    ...
    public final void ACo(InterfaceC2607ec interfaceC2607ec) {
        ...
        if (interfaceC2607ec != null) {
            String strA6v = interfaceC2607ec.A6v();
    ...
    public final void ADC(Exception exc) {
        ...
        if (C2621eq.class.equals(exc.getClass())) {
            A02((C2621eq) exc);
            return;
        }
        AdErrorType adErrorType = AdErrorType.NETWORK_ERROR;
        String message = exc.getMessage();
        this.A02.A05.A0F().A3O(XG.A01(this.A02.A01), adErrorType.getErrorCode(), message, adErrorType.isPublicError());
        this.A02.A0E(V1.A01(adErrorType, message));
    }
}
