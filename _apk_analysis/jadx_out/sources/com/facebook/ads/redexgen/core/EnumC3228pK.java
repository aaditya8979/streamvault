...
public enum EnumC3228pK {
    ...
    public static EnumC3228pK[] valuesCustom() {
        EnumC3228pK[] enumC3228pKArrValuesCustom = values();
        if (A01[4].length() == 0) {
            throw new RuntimeException();
        }
        A01[5] = "kC8OQjnUJR";
        return (EnumC3228pK[]) enumC3228pKArrValuesCustom.clone();
    }
}
