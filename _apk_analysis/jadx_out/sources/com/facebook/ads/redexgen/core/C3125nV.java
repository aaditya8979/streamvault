...
public final class C3125nV implements C6S {
    ...
    public C3125nV() {
        this(new C3014lh(true, 65536), 50000, 50000, 2500, 5000, -1, false, 0, false);
    }

    public C3125nV(C3014lh c3014lh, int i10, int i11, int i12, int i13, int i14, boolean z10, int i15, boolean z11) {
        ...
        this.A08 = c3014lh;
        this.A07 = AbstractC15184a.A0O(i10);
        this.A06 = AbstractC15184a.A0O(i11);
        this.A05 = AbstractC15184a.A0O(i12);
        this.A04 = AbstractC15184a.A0O(i13);
        this.A02 = i14;
        this.A00 = this.A02 != -1 ? this.A02 : 13107200;
        this.A09 = z10;
        this.A03 = AbstractC15184a.A0O(i15);
        this.A0A = z11;
    }
    ...
    private final int A01(InterfaceC3016lj[] interfaceC3016ljArr) {
        int iA00 = 0;
        for (InterfaceC3016lj interfaceC3016lj : interfaceC3016ljArr) {
            if (interfaceC3016lj != null) {
                iA00 += A00(interfaceC3016lj.A9D().A02);
            }
        }
    ...
    private void A05(boolean z10) {
        this.A00 = this.A02 == -1 ? 13107200 : this.A02;
        this.A01 = false;
        if (z10) {
            this.A08.A01();
        }
    ...
    public final C3014lh A6n() {
        return this.A08;
    }

    @Override // com.facebook.ads.redexgen.core.C6S
    public final long A6s(C16087m c16087m) {
        return this.A03;
    }

    @Override // com.facebook.ads.redexgen.core.C6S
    public final void AEj(C16087m c16087m) {
        A05(false);
    }

    @Override // com.facebook.ads.redexgen.core.C6S
    public final void AEu(C16087m c16087m) {
        A05(true);
    }

    @Override // com.facebook.ads.redexgen.core.C6S
    public final void AFN(C16087m c16087m) {
        A05(true);
    }

    @Override // com.facebook.ads.redexgen.core.C6S
    public final void AFV(C6R c6r, C3043mA c3043mA, InterfaceC3016lj[] interfaceC3016ljArr) {
        this.A00 = this.A02 == -1 ? A01(interfaceC3016ljArr) : this.A02;
        this.A08.A02(this.A00);
    }

    @Override // com.facebook.ads.redexgen.core.C6S
    public final boolean AI3(C16087m c16087m) {
        return this.A0A;
    }
    ...
    public final boolean AJB(C6R c6r) {
        ...
        long jMin = this.A07;
        if (c6r.A00 > 1.0f) {
            jMin = Math.min(AbstractC15184a.A0Q(jMin, c6r.A00), this.A06);
        }
    ...
    @Override // com.facebook.ads.redexgen.core.C6S
    public final boolean AJE(long j10, float f10, boolean z10, boolean z11, long j11) {
        long jA0R = AbstractC15184a.A0R(j10, f10);
