...
public final class WB {
    ...
    public static final Set<C2529dL> A06;
    ...
    public static int A00(C2529dL c2529dL, Intent intent) throws W9 {
        Intent intentA01 = A01(intent);
        int i10 = 0;
        try {
            Activity activityA00 = ActivityUtils.A00();
            if (activityA00 == null) {
                activityA00 = c2529dL.A0E();
                i10 = 1;
            }
            if (activityA00 != null) {
            ...
            c2529dL.startActivity(intentA01);
            return 2;
    ...
    public static C2529dL A04(Intent intent) {
        String stringExtra = intent.getStringExtra(A03);
        if (stringExtra == null) {
            return null;
        }
        for (C2529dL c2529dL : A06) {
            if (stringExtra.equals(c2529dL.A0F().getId())) {
                return c2529dL;
            }
        }
        return null;
    ...
    public static AdActivityIntent A05(C2529dL c2529dL) {
        AdActivityIntent adActivityIntent = new AdActivityIntent(c2529dL.getApplicationContext(), A06());
        adActivityIntent.putExtra(A03, c2529dL.A0F().getId());
        A06.add(c2529dL);
    ...
    public static void A0B(C2529dL c2529dL, AdActivityIntent adActivityIntent) throws W9 {
        Activity activityA0E;
        Context applicationContext = c2529dL.getApplicationContext();
        if (U7.A2V(c2529dL) && (activityA0E = c2529dL.A0E()) != null) {
            applicationContext = activityA0E;
        ...
        try {
            if (!ProcessUtils.isRemoteRenderingProcess()) {
                ...
                if (A0I(c2529dL, adActivityIntent)) {
                    return;
                }
                c2529dL.A0F().AHS();
            }
    ...
    public static boolean A0D(C2529dL c2529dL, Intent intent) throws W9 {
        A07.get();
        return A0F(c2529dL, intent, null);
    }

    public static boolean A0E(C2529dL c2529dL, Intent intent) throws W9 {
        A07.get();
        if (0 != 0) {
            ...
            if (activityA0E != null) {
                ...
                try {
                    ...
                    c2529dL.A08().AAy(A07(90, 8, 57), AbstractC2142Sv.A07, new C2143Sw(e11));
                    return false;
                }
            }
        }
    ...
    public static boolean A0F(C2529dL c2529dL, Intent intent, WK wk2) throws W9 {
        if (A0C(intent, U7.A0Z(c2529dL))) {
            return false;
        }
        Activity activity = c2529dL;
        if (A01[1].charAt(5) == 'g') {
            throw new RuntimeException();
        }
        ...
        if (wk2 == null || A0C(intent, U7.A0b(c2529dL))) {
            try {
        ...
        try {
            ...
            c2529dL.A08().AAy(A07(90, 8, 57), AbstractC2142Sv.A08, new C2143Sw(e12));
            return false;
        }
    }

    public static boolean A0G(C2529dL c2529dL, Uri uri, String str) throws ActivityNotFoundException {
        A08.get();
        return A0H(c2529dL, uri, str, null);
    }

    public static boolean A0H(C2529dL c2529dL, Uri uri, String str, WM wm2) throws ActivityNotFoundException {
        if (wm2 == null || c2529dL.A0E() == null) {
            return false;
        }
    ...
    public static boolean A0I(C2529dL c2529dL, AdActivityIntent adActivityIntent) throws W9 {
        ...
        try {
            ...
            activityA00.startActivityForResult(intentA01, 0);
            return true;
        } catch (ActivityNotFoundException e10) {
            throw new W9(e10);
        }
