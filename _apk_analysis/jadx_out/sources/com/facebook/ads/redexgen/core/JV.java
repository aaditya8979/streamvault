...
public final class JV {
    ...
    public static JV A00(String str) {
        ...
        String[] strArrSplit = TextUtils.split(str.substring(strA01.length()), A01(0, 1, 53));
        int i14 = 0;
        while (true) {
            byte b10 = -1;
            if (i14 >= strArrSplit.length) {
                ...
                return new JV(i10, i11, i12, i13, strArrSplit.length);
            }
            String strA012 = AbstractC2836iY.A01(strArrSplit[i14].trim());
