...
public final class C6H extends OD implements View.OnClickListener, View.OnTouchListener {
    ...
    public C6H(R0 r02, C2529dL c2529dL, US us2, InterfaceC2260Xn interfaceC2260Xn, String str, int i10) {
        super(r02, c2529dL, us2, interfaceC2260Xn);
        this.A00 = 0;
        this.A01 = 0;
        this.A03 = false;
        this.A07 = new RunnableC2263Xq(this);
        this.A08 = str;
        this.A05 = new Handler(Looper.getMainLooper());
        this.A06 = (InputMethodManager) c2529dL.getSystemService(A05(112, 12, 70));
        this.A04 = i10;
    }
    ...
    private void A07() {
        ...
        if (AdPlacementType.NATIVE.name().equals(this.A08)) {
            ...
            super.A07.A0E(EnumC2551dh.A04.A03(), null);
        }
    }
    ...
    public static void A09() {
        A0E = new byte[]{94, 81, 84, 94, 86, 98, 78, 82, 72, 79, 94, 88, 36, 40, ExifInterface.START_CODE, 105, 33, 38, 36, 34, 37, 40, 40, 44, 105, 38, 35, 52, 105, 37, 38, 41, 41, 34, 53, 105, 36, 43, 46, 36, 44, 34, 35, 118, 122, 120, 59, 115, 116, 118, 112, 119, 122, 122, 126, 59, 116, 113, 102, 59, 124, 123, 97, 112, 103, 102, 97, 124, 97, 124, 116, 121, 59, 118, 121, 124, 118, 126, 112, 113, 2, 14, 12, 79, 7, 0, 2, 4, 3, 14, 14, 10, 79, 0, 5, 18, 79, 15, 0, 21, 8, 23, 4, 79, 0, 5, 62, 2, 13, 8, 2, 10, 53, 50, 44, 41, 40, 3, 49, 57, 40, 52, 51, 56, 30, 24, 14, 25, 52, 9, 30, 13, 13, 14, 25, 14, 15, 52, 8, 7, 2, 8, 0, 52, 2, 10, 9, 52, 8, 7, 2, 8, 0, 24, 81, 87, 65, 86, 123, 70, 81, 66, 66, 65, 86, 65, 64, 123, 71, 72, 77, 71, 79, 123, 77, 69, 70, 123, 80, 93, 84, 77, 74, 67};
    }
    ...
    @Override // com.facebook.ads.redexgen.core.OD
    public final ZY A0E() {
        return new C2028Ok(this);
    }
    ...
    public final void A0F() {
        ...
        RelativeLayout.LayoutParams layoutParams3 = new RelativeLayout.LayoutParams(-1, (int) (AbstractC2232Wl.A02 * 2.0f));
    ...
    public final void A0G() {
        ...
        translateAnimation.setAnimationListener(new AnimationAnimationListenerC2265Xs(this));
    ...
    @Override // com.facebook.ads.redexgen.core.OD, com.facebook.ads.redexgen.core.InterfaceC2261Xo
    public final void AAl(Intent intent, Bundle bundle, R0 r02) {
        super.AAl(intent, bundle, r02);
        this.A02 = new C2172Ua(super.A04, this.A09);
    }
    ...
    public final void onAttachedToWindow() {
        ...
        translateAnimation.setFillAfter(true);
        translateAnimation.setAnimationListener(new AnimationAnimationListenerC2264Xr(this));
        startAnimation(translateAnimation);
    }
