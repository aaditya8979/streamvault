...
public abstract class AbstractC3018ll {
    ...
    public static int A00(int i10, String str) {
        if (i10 >= 0) {
            return i10;
        }
        throw new IllegalArgumentException(str + A01(0, 29, 23) + i10);
    }
    ...
    public static void A03(Object obj, Object obj2) {
        if (obj == null) {
            throw new NullPointerException(A01(84, 24, 51) + obj2);
        }
        if (obj2 == null) {
            throw new NullPointerException(A01(108, 21, 38) + obj + A01(29, 5, 65));
        }
    }

    public static void A04(boolean z10) {
        AbstractC2871jA.A0F(z10, A01(34, 50, 57));
    }
}
