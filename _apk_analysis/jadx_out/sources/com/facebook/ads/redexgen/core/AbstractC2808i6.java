...
public abstract class AbstractC2808i6 extends QC<OB> {
    ...
    public InterfaceC1979Mk A00;
    public final List<C2072Qc> A01;
    public final int A02;
    public final C2529dL A03;
    public final AbstractC2601eW A04 = new C2811i9(this);

    public AbstractC2808i6(C0L c0l, List<C2072Qc> list, C2529dL c2529dL) {
        this.A03 = c2529dL;
    ...
    public final void A0O(ImageView imageView, int i10) {
        C2072Qc c2072Qc = this.A01.get(i10);
        C2187Up adCoverImage = c2072Qc.getAdCoverImage();
        if (adCoverImage != null) {
            KZ kzA04 = new KZ(imageView, this.A03).A04();
            kzA04.A06(new C2810i8(this, i10, c2072Qc));
            kzA04.A07(adCoverImage.getUrl());
        }
    }

    public final void A0P(InterfaceC1979Mk interfaceC1979Mk) {
        this.A00 = interfaceC1979Mk;
    }
