...
public final class C2876jF implements L9 {
    ...
    static {
        A04();
        A07 = C2876jF.class.getSimpleName();
    }

    public C2876jF(String str) {
        this(str, L7.A01(str));
    }

    public C2876jF(String str, int i10) {
        this(str);
        this.A00 = i10;
    }

    public C2876jF(String str, String str2) {
    ...
    */
    private java.net.HttpURLConnection A02(int r9, int r10) throws java.io.IOException, com.facebook.ads.redexgen.core.C2880jJ {
        /*
            Method dump skipped, instruction units count: 295
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2876jF.A02(int, int):java.net.HttpURLConnection");
    }

    private void A03() throws C2880jJ {
    ...
    private final void A05(int i10, int i11) throws C2880jJ {
        try {
            ...
            throw new C2880jJ(A01(154, 29, 90) + this.A03 + A01(19, 13, 66) + i10, e10);
        }
    }
    ...
    public final void close() throws C2880jJ {
        if (this.A02 != null) {
            try {
                ...
                throw new C2880jJ(A01(92, 37, 89), e10);
            }
        }
    }

    @Override // com.facebook.ads.redexgen.core.L9
    public final synchronized int length() throws C2880jJ {
    ...
    public final int read(byte[] bArr) throws C2880jJ {
        ...
        if (inputStream == null) {
            throw new C2880jJ(strA01 + this.A03 + A01(51, 23, 42));
        }
        try {
            return this.A01.read(bArr, 0, bArr.length);
        } catch (InterruptedIOException e10) {
            final String str = A01(278, 15, 60) + this.A03 + A01(0, 15, 15);
            throw new C2880jJ(str, e10) { // from class: com.facebook.ads.redexgen.X.7e
            };
        } catch (IOException e11) {
            throw new C2880jJ(strA01 + this.A03, e11);
        }
    }
