...
public abstract class WX {
    ...
    public static void A05(C2503cu c2503cu, InterfaceC2242Wv interfaceC2242Wv, String str) {
        if (str == null || A03.contains(str)) {
            return;
        }
        if (A08(c2503cu.getPackageManager(), str)) {
            interfaceC2242Wv.AEQ(str);
            return;
        }
        A03.add(str);
        A02.removeCallbacksAndMessages(null);
        A02.postDelayed(new WW(new int[]{0}, str, c2503cu, interfaceC2242Wv), 1000L);
    }
    ...
    */
    public static void A06(com.facebook.ads.redexgen.core.C2503cu r6, java.lang.String r7) {
        /*
            ...
            r5 = 49
            r3 = 22
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.WX.A01
            r0 = 1
            r1 = r2[r0]
            r0 = 0
            r2 = r2[r0]
        ...
        L4e:
            r2 = 0
            if (r0 == 0) goto L5c
            android.os.Handler r0 = com.facebook.ads.redexgen.core.WX.A02
            r0.removeCallbacksAndMessages(r2)
            java.util.Set<java.lang.String> r0 = com.facebook.ads.redexgen.core.WX.A03
            r0.remove(r7)
        L5b:
            return
        L5c:
            com.facebook.ads.redexgen.X.Nk r1 = com.facebook.ads.redexgen.core.AbstractC2005Nl.A00(r6)
            r0 = 5
            r1.A0A(r7, r2, r0)
            goto L5b
        L65:
            ...
            goto L4e
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.WX.A06(com.facebook.ads.redexgen.X.cu, java.lang.String):void");
    }

    public static void A07(C2503cu c2503cu, String str, InterfaceC2242Wv interfaceC2242Wv) {
        if (c2503cu.getPackageName().equals(A01(30, 19, 75)) || c2503cu.getPackageName().equals(A01(49, 22, 66))) {
            A05(c2503cu, interfaceC2242Wv, str);
        } else {
            AbstractC2005Nl.A00(c2503cu).A0A(str, interfaceC2242Wv, 4);
        }
    }
