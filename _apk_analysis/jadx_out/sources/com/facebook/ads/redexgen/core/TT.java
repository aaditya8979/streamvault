...
public final class TT {
    ...
    public static synchronized EnumC2229Wi A00(SQ sq2) {
        if (A01 == null) {
            A01 = C2230Wj.A00(sq2);
        }
        return A01;
    ...
    public static void A06(SQ sq2, String str, Map<String, String> map) {
        String strA03 = A0A(sq2) ? W4.A03(str) : A00;
        if (strA03 != null) {
            map.put(A02(1, 3, 28), strA03);
        }
    }
    ...
    public static void A07(SQ sq2, boolean z10) {
        if (A05.compareAndSet(0, 1)) {
            A00(sq2);
            try {
                SharedPreferences sharedPreferencesA00 = AbstractC2201Ve.A00(sq2);
                T6 t62 = new T6(sq2);
