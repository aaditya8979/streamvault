...
public final class TM {
    ...
    public static long A01(SQ sq2, String str) {
        try {
            ...
            if (A03.compareAndSet(false, true)) {
                sq2.A08().AAy(A02(144, 7, 94), AbstractC2142Sv.A1E, new C2143Sw(e10));
            }
            return -1L;
        }
    }
    ...
    public static String A03(Context context) {
        try {
            return (String) Class.forName(context.getPackageName() + A02(0, 12, 116)).getDeclaredField(A02(37, 10, 101)).get(null);
    ...
    public static String A04(Context context) {
        try {
            return String.valueOf(Class.forName(context.getPackageName() + A02(0, 12, 116)).getDeclaredField(A02(71, 5, 103)).getBoolean(null));
        } catch (Exception unused) {
            return A02(94, 3, 61);
        }
    }
    ...
    public static String A05(SQ sq2, String str) {
        ...
        A07(sq2, jSONObject, A02(BaseTransientBottomBar.ANIMATION_FADE_DURATION, 15, 21), String.valueOf(A00()));
        A07(sq2, jSONObject, A02(105, 18, 51), String.valueOf(W6.A00(sq2)));
        A07(sq2, jSONObject, A02(161, 13, 60), String.valueOf(A09(sq2)));
        A07(sq2, jSONObject, A02(Sdk.SDKError.Reason.OMSDK_JS_WRITE_FAILED_VALUE, 11, 111), A04(sq2));
        A07(sq2, jSONObject, A02(123, 10, 27), A03(sq2));
        return jSONObject.toString();
    }

    public static void A06() {
        A00 = new byte[]{108, 0, 55, 43, 46, 38, 1, 45, 44, 36, 43, 37, 105, 70, 76, 90, 71, 65, 76, 8, 123, 108, 99, 8, 74, 93, 65, 68, 92, 8, 78, 71, 90, 8, 80, 16, 30, 17, 6, 26, 31, 23, 12, 7, 10, 3, 22, 25, 53, 47, 54, 62, 122, 52, 53, 46, 122, 59, 62, 62, 122, ExifInterface.START_CODE, 59, 40, 59, 55, 63, 46, 63, 40, 96, 21, 20, 19, 4, 22, 99, 75, 83, 74, 71, 82, 73, 84, 20, 54, 61, ExifInterface.START_CODE, 62, 60, 39, 58, 60, 61, 69, 36, 74, 51, 34, 57, 13, 33, 59, 40, 55, 100, 117, 117, 90, 118, 113, 100, 119, 113, 96, 97, 90, 119, 96, 100, 118, 106, 107, 79, 88, 68, 65, 73, 114, 89, 84, 93, 72, 61, 60, 59, 44, 62, 6, 47, 56, 53, 44, 60, 15, 13, 6, 13, 26, 1, 11, 115, 123, 123, 115, 120, 113, 75, 103, 112, 127, 99, 121, 85, 110, 111, 104, 127, 109, 109, 107, 104, 102, 111, 12, 22, 58, 0, 8, 16, 87, 74, 78, 70, 89, 76, 77, 70, 124, 76, 69, 69, 80, 70, 87, 95, 68, 65, 68, 69, 93, 68};
    }
