...
public class C2436bp extends WebViewClient {
    ...
    public C2436bp(C2440bt c2440bt) {
        this.A00 = c2440bt;
    }
    ...
    private void A02(int i10, String str, String str2, boolean z10) {
        ...
        this.A00.A0E.A04(AbstractC2142Sv.A16, string);
    }
    ...
    public final void onReceivedHttpError(WebView webView, WebResourceRequest webResourceRequest, WebResourceResponse webResourceResponse) {
        ...
        A02(webResourceResponse != null ? webResourceResponse.getStatusCode() : -1, A00(39, 10, 68), A00(0, 0, 93) + webResourceRequest.getUrl(), false);
    }
    ...
    public final boolean onRenderProcessGone(WebView webView, RenderProcessGoneDetail renderProcessGoneDetail) {
        ...
        String string = jSONObject.toString();
        C2529dL c2529dL = this.A00.A0B;
        if (A02[5].charAt(10) == 'q') {
            A02[3] = "cKmn9F08G0LbJgt48cswTZGSotGQ5jj";
            c2529dL.A0F().A62(string);
            AbstractC2441bu.A04(this.A00.A09.A17());
    ...
    public final WebResourceResponse shouldInterceptRequest(WebView webView, WebResourceRequest webResourceRequest) {
        return C2451c4.A00(this.A00.A0B, this.A00.A0A, webResourceRequest, this.A00.A0H, this.A00.A09.A1O());
    }
}
