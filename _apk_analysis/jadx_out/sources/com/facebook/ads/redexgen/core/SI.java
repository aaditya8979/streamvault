...
public final class SI {
    ...
    static {
        ...
        A05 = AbstractC2142Sv.A0o;
        A06 = AbstractC2142Sv.A0s;
        A02 = AbstractC2142Sv.A0l;
        A01 = AbstractC2142Sv.A0k;
        A03 = AbstractC2142Sv.A0m;
        A00 = AbstractC2142Sv.A0i;
        A04 = AbstractC2142Sv.A0n;
        A07 = AbstractC2142Sv.A0t;
    }
    ...
    public static void A01() {
        A08 = new byte[]{-47, -17, -15, -10, -13, -82, -14, -9, 1, -7, -82, -12, -17, -9, -6, 3, 0, -13, -68, -72, -42, -40, -35, -38, -107, ExifInterface.MARKER_EOI, -34, -24, -32, -107, -24, -22, -40, -40, -38, -24, -24, -93, -7, 23, 25, 30, 27, -42, 26, 37, 45, 36, 34, 37, 23, 26, -42, 28, 23, 31, 34, 43, 40, 27, -28, -80, -50, -48, -43, -46, -115, -43, -42, ExifInterface.MARKER_APP1, -101, -63, -33, ExifInterface.MARKER_APP1, -26, -29, -98, -21, -25, -15, -15, -84, 19, 22, 17, 21, 36, 23, 19, 38, 27, 40, 23, 17, 37, 27, 44, 23, 17, 20, 43, 38, 23, 37, -33, -30, -35, ExifInterface.MARKER_APP1, -16, -29, -33, -14, -25, -12, -29, -35, -14, -9, -18, -29, 29, 32, 27, 34, 43, 46, 41, 29, 48, 27, 48, 53, 44, 33, -10, -7, -12, 7, -6, 6, 10, -6, 8, 9, -12, -2, -7, 67, 86, 86, 71, 79, 82, 86, 30, 28, 30, 35, 32, 63, 61, 63, 68, 65, 59, 63, 75, 74, 80, 65, 84, 80, -35, -40, -32, -29, -20, -23, -36, -42, -23, -36, -40, -22, -26, -27, 23, 27, 15, 21, 19, 28, 31, 17, 20, 15, 36, 25, 29, 21, 70, 67, 61};
    }
    ...
    public static void A02(SQ sq2, S8 s82, int i10, String str, long j10) {
        if (A06(sq2)) {
            try {
                ...
                c2143Sw.A05(1);
                sq2.A08().AAz(A00(154, 5, 84), i10, c2143Sw);
            } catch (Throwable th2) {
                sq2.A08().A4A(th2);
            }
        }
    ...
    public static void A04(SQ sq2, SH sh2, boolean z10) {
        if (A06(sq2)) {
            try {
                ...
                int i10 = z10 ? A05 : A06;
                C2143Sw c2143Sw = new C2143Sw(strA00);
                c2143Sw.A07(jSONObject);
                c2143Sw.A05(1);
                sq2.A08().AAz(A00(154, 5, 84), i10, c2143Sw);
            } catch (Throwable th2) {
    ...
    public static boolean A06(SQ sq2) {
        int iA06 = sq2.A05().AAF() ? 1 : U9.A06(sq2);
        if (iA06 == 0) {
            return false;
        }
        return iA06 <= 0 || sq2.A09().A00() <= 1.0d / ((double) iA06);
    }
}
