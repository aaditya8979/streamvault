...
public class C2661fV extends AbstractRunnableC2216Vt {
    ...
    public final /* synthetic */ C2101Rf A00;

    static {
        A01();
    }

    public C2661fV(C2101Rf c2101Rf) {
        this.A00 = c2101Rf;
    }
    ...
    public final void A07() {
        try {
            ...
            for (int i10 = 0; i10 < jSONArray.length(); i10++) {
                C2099Rd c2099RdA00 = C2099Rd.A00(jSONArray.getJSONObject(i10));
                this.A00.A09(c2099RdA00.A04, c2099RdA00);
            }
            this.A00.A02.A0X(new C2663fX(this), new S8(this.A00.A04, this.A00.A03));
        } catch (JSONException unused) {
            this.A00.A00.post(new C2662fW(this));
        }
    }
}
