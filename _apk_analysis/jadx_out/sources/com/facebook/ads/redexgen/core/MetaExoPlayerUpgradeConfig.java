...
public final class MetaExoPlayerUpgradeConfig {
    ...
    public static final Map<EnumC2805i2, Boolean> A02;
    public static final Map<EnumC2806i3, Integer> A03;
    public static final Map<EnumC2807i4, Long> A04;

    static {
        A02();
        A01 = new MetaExoPlayerUpgradeConfig();
        A02 = new EnumMap(EnumC2805i2.class);
        A03 = new EnumMap(EnumC2806i3.class);
        A04 = new EnumMap(EnumC2807i4.class);
        for (EnumC2805i2 enumC2805i2 : EnumC2805i2.valuesCustom()) {
            A02.put(enumC2805i2, false);
        }
        for (EnumC2806i3 enumC2806i3 : EnumC2806i3.valuesCustom()) {
            A03.put(enumC2806i3, -1);
        }
        for (EnumC2807i4 enumC2807i4 : EnumC2807i4.values()) {
            A04.put(enumC2807i4, -1L);
        }
        A02.put(EnumC2805i2.A0V, true);
        A02.put(EnumC2805i2.A0Q, true);
        A02.put(EnumC2805i2.A1f, true);
        A03.put(EnumC2806i3.A05, 100);
    }

    @JvmStatic
    public static final int A00(EnumC2806i3 enumC2806i3) {
        C3220p6.A09(enumC2806i3, A01(24, 17, 40));
        Integer num = A03.get(enumC2806i3);
        if (num != null) {
            return num.intValue();
        }
    ...
    @JvmStatic
    public static final boolean A03(EnumC2805i2 enumC2805i2) {
        C3220p6.A09(enumC2805i2, A01(24, 17, 40));
        return C3220p6.A0C(true, A02.get(enumC2805i2));
    }
}
