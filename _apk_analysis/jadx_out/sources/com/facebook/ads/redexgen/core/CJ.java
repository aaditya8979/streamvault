...
public final class CJ extends TextureView implements MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnVideoSizeChangedListener, MediaPlayer.OnSeekCompleteListener, TextureView.SurfaceTextureListener, InterfaceC2597eS {
    ...
    public EnumC2545db A0B;
    public EnumC2599eU A0C;
    public EnumC2599eU A0D;
    public InterfaceC2600eV A0E;
    public boolean A0F;
    public boolean A0G;
    public boolean A0H;
    public boolean A0I;
    ...
    public CJ(C2529dL c2529dL) {
        super(c2529dL);
        this.A0C = EnumC2599eU.A04;
        this.A0D = EnumC2599eU.A04;
        this.A0J = false;
        this.A03 = 0;
        this.A05 = 0;
        this.A04 = 0;
        ...
        this.A02 = 0;
        this.A0G = false;
        this.A0B = EnumC2545db.A03;
        this.A0M = new C2594eP(this);
        this.A0I = false;
        this.A0N = c2529dL;
    }

    public CJ(C2529dL c2529dL, AttributeSet attributeSet) {
    ...
    public CJ(C2529dL c2529dL, AttributeSet attributeSet, int i10) {
    ...
    private final void A05(MediaPlayer mediaPlayer, Uri uri) {
        ...
        try {
            ...
            AssetFileDescriptor assetFileDescriptorOpenFd = getContext().getAssets().openFd(path.substring(1));
    ...
    private boolean A06() {
        return (this.A0C == EnumC2599eU.A08 || this.A0C == EnumC2599eU.A07) ? false : true;
    }

    private boolean A07() {
        return this.A0C == EnumC2599eU.A07 || this.A0C == EnumC2599eU.A0A || this.A0C == EnumC2599eU.A05 || this.A0C == EnumC2599eU.A06;
    }
    ...
    private boolean A09() {
        ...
        try {
            ...
            this.A0N.A08().AAy(A03(384, 6, 110), AbstractC2142Sv.A2H, new C2143Sw(e10));
            return false;
        }
    }
    ...
    private boolean A0A(Surface surface) {
        ...
        try {
            ...
            this.A0N.A08().AAy(A03(384, 6, 110), AbstractC2142Sv.A2I, new C2143Sw(e10));
            return false;
        }
    }

    private void setVideoState(EnumC2599eU enumC2599eU) {
        if (enumC2599eU != this.A0C) {
            if (this.A0N.A05().AAF()) {
                String str = A03(356, 23, 106) + enumC2599eU;
            }
            this.A0C = enumC2599eU;
            if (this.A0E != null) {
                this.A0E.AFt(enumC2599eU);
            }
        }
    }
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2597eS
    ...
    public final void AG7(boolean z10, int i10) {
        ...
        this.A0D = EnumC2599eU.A05;
        if (this.A06 == null) {
            setVideoState(EnumC2599eU.A04);
            return;
        }
        if (A06()) {
            this.A0J = z10;
            this.A06.pause();
            if (this.A0C != EnumC2599eU.A06) {
                setVideoState(EnumC2599eU.A05);
            }
        }
    }
    ...
    public final void AJH(int i10) {
        ...
        setVideoState(EnumC2599eU.A09);
        AJU(5);
        this.A03 = 0;
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC2597eS
    public final void AJM(EnumC2545db enumC2545db, int i10) {
        this.A0N.A0F().A3h(i10);
        this.A0J = false;
        this.A0D = EnumC2599eU.A0A;
        this.A0B = enumC2545db;
        if (this.A0C == EnumC2599eU.A0A || this.A0C == EnumC2599eU.A07 || this.A0C == EnumC2599eU.A04 || this.A0C == EnumC2599eU.A05 || this.A0C == EnumC2599eU.A06) {
            if (this.A06 == null) {
                setup(this.A07);
            } else {
                if (this.A03 > 0) {
                ...
                this.A06.start();
                if (this.A0C != EnumC2599eU.A07 || this.A0K) {
                    setVideoState(EnumC2599eU.A0A);
                }
            }
        }
        if (isAvailable()) {
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2597eS
    public EnumC2545db getStartReason() {
        return this.A0B;
    }
    ...
    public EnumC2599eU getTargetState() {
        return this.A0D;
    }
    ...
    public final boolean onError(MediaPlayer mediaPlayer, int i10, int i11) {
        ...
        if (this.A01 <= 0 || getState() != EnumC2599eU.A0A) {
            setVideoState(EnumC2599eU.A03);
            this.A0N.A0F().A3a(1);
            AJU(7);
        } else {
    ...
    public final boolean onInfo(MediaPlayer mediaPlayer, int i10, int i11) {
        switch (i10) {
            case 3:
                this.A0K = true;
                if (this.A0D == EnumC2599eU.A0A) {
                    setVideoState(EnumC2599eU.A0A);
                }
                return true;
            case 701:
                setVideoState(EnumC2599eU.A02);
                return false;
            case 702:
                if (!A08()) {
                    return false;
    ...
    public final void onPrepared(MediaPlayer mediaPlayer) {
        ...
        if (this.A03 > 0) {
            int i10 = this.A03;
            int duration = ((MediaPlayer) AbstractC2706gF.A00(this.A06)).getDuration();
            if (A0P[3].length() != 17) {
                throw new RuntimeException();
            }
    ...
    public final void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i10, int i11) {
        ...
        if (!A0A(this.A08)) {
            ...
            if (this.A0C != EnumC2599eU.A05 || this.A0J) {
                return;
            }
            AJM(this.A0B, 7);
        }
    ...
    */
    public final void onWindowFocusChanged(boolean r6) {
        ...
        L15:
            ...
            com.facebook.ads.redexgen.X.eU r0 = com.facebook.ads.redexgen.core.EnumC2599eU.A05
            if (r1 == r0) goto La6
        ...
        L42:
            ...
            com.facebook.ads.redexgen.X.eU r3 = com.facebook.ads.redexgen.core.EnumC2599eU.A05
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.CJ.A0P
            r0 = 6
            r0 = r1[r0]
            int r1 = r0.length()
    ...
    public void setControlsAnchorView(View view) {
        this.A09 = view;
        view.setOnTouchListener(new ViewOnTouchListenerC2596eR(this));
    }
    ...
    public void setFullScreen(boolean z10) {
        ...
        setOnTouchListener(new ViewOnTouchListenerC2595eQ(this));
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC2597eS
    public void setRequestedVolume(float f10) {
        this.A00 = f10;
        if (this.A06 == null || this.A0C == EnumC2599eU.A08) {
            return;
        }
        EnumC2599eU enumC2599eU = this.A0C;
        String[] strArr = A0P;
        if (strArr[0].charAt(16) == strArr[7].charAt(16)) {
            throw new RuntimeException();
        }
        A0P[3] = "xC5rxgqNbqLUjjPrr";
        if (enumC2599eU != EnumC2599eU.A04) {
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2597eS
    public void setVideoStateChangeListener(InterfaceC2600eV interfaceC2600eV) {
        this.A0E = interfaceC2600eV;
    }
    ...
    public void setup(Uri uri) {
        ...
        try {
            if (((String) AbstractC2706gF.A00(uri.getScheme())).equals(A03(379, 5, 2))) {
                A05(mediaPlayer, uri);
            } else {
