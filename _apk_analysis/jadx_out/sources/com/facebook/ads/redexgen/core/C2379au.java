...
public final class C2379au {
    ...
    public final AbstractC2804hy A0F;
    public final C1980Ml A0G;
    public final C1990Mw A0H;
    public final N0 A0I;
    public final C2529dL A0J;
    public final C2172Ua A0K;
    public final InterfaceC2260Xn A0L;
    ...
    public C2379au(C2529dL c2529dL, AbstractC2804hy abstractC2804hy, C2172Ua c2172Ua, Handler handler, InterfaceC2260Xn interfaceC2260Xn) {
        this.A0J = c2529dL;
        this.A0L = interfaceC2260Xn;
        this.A0H = abstractC2804hy.A20().A0I();
        this.A0I = abstractC2804hy.A20().A0K();
        this.A0G = abstractC2804hy.A1z();
        this.A0E = handler;
        this.A0C = abstractC2804hy.A2K();
        this.A0M = abstractC2804hy.A2H();
        this.A0A = abstractC2804hy.A2G();
        this.A0D = AbstractC2521dC.A00(c2529dL.getResources().getDisplayMetrics());
        this.A0K = c2172Ua;
        this.A0F = abstractC2804hy;
        A02();
    }

    private ImageView A00(final KE ke2) {
        Bitmap bitmapCreateScaledBitmap = Bitmap.createScaledBitmap(XY.A01(XX.OTHER_SKIP), this.A04, this.A04, true);
    ...
    public static void A03() {
        A0N = new byte[]{109, 118, 126, 126, 126, 126, 126, 126, 126, 4, 97, 97, 23, 23, 23, 23, 23, 23, 37, 41, 43, 104, 32, 39, 37, 35, 36, 41, 41, 45, 104, 39, 34, 53, 104, 47, 40, 50, 35, 52, 53, 50, 47, 50, 47, 39, ExifInterface.START_CODE, 104, 32, 47, 40, 47, 53, 46, 25, 39, 37, 50, 47, 48, 47, 50, 63, ExifInterface.START_CODE, 50, 48, 41};
    }
    ...
    */
    private void A06(android.widget.FrameLayout r14, com.facebook.ads.redexgen.core.KE r15) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2379au.A06(android.widget.FrameLayout, com.facebook.ads.redexgen.X.KE):void");
    }
    ...
    public final View A0A(KE ke2, ImageView imageView) {
        ...
        C2349aQ c2349aQ = new C2349aQ(this.A0J, this.A0G.A01(), true, false, false);
        c2349aQ.A04(this.A0H.A0F(), this.A0H.A0D().toLowerCase(Locale.getDefault()), null, false, false);
        c2349aQ.setAlignment(17);
        c2349aQ.setTitleTextSize(28);
        c2349aQ.setDescriptionTextSize(13);
        c2349aQ.A02();
        c2349aQ.setPadding(this.A05, 0, this.A05, 0);
        LinearLayout linearLayout = new LinearLayout(this.A0J);
        linearLayout.setClickable(true);
        if (U7.A1C(this.A0J)) {
            linearLayout.setOnClickListener(new ViewOnClickListenerC2377as(this, ke2));
        }
