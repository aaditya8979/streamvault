...
public final class R0 implements AudienceNetworkActivityApi, Repairable {
    ...
    public EnumC2199Vb A07;
    public InterfaceC2261Xo A08;
    public AbstractC2276Yd A09;
    public C2505cw A0A;
    public String A0B;
    public String A0C;
    public boolean A0D;
    ...
    public final RA A0G;
    public final RJ A0H;
    public final C2098Rc A0I;
    public final C2529dL A0J;
    ...
    public R0(AudienceNetworkActivity audienceNetworkActivity, AudienceNetworkActivityApi audienceNetworkActivityApi) {
        ...
        this.A0I = new C2098Rc(this.A0J, this.A0E);
        this.A0G = new RA(this, this.A0J, this.A0E);
    }

    private String A00() {
        return (this.A07 == null || this.A07.A03() == null) ? A01(138, 4, 114) : this.A07.A03();
    }
    ...
    public static void A02() {
        A0L = new byte[]{3, 56, 55, 52, 58, 51, 118, 34, 57, 118, 63, 56, 48, 51, 36, 118, 32, 63, 51, 33, 2, 47, 38, 51, 118, 48, 36, 57, 59, 118, 63, 56, 34, 51, 56, 34, 118, 57, 36, 118, 37, 55, 32, 51, 50, 31, 56, 37, 34, 55, 56, 53, 51, 5, 34, 55, 34, 51, ExifInterface.START_CODE, 37, 20, ExifInterface.START_CODE, 40, 63, 34, 61, 34, 63, 50, 122, 120, 117, 117, 124, 107, 77, 96, 105, 124, 121, 118, 115, 127, 116, 110, 78, 117, 113, 127, 116, 116, 120, 122, 57, 113, 118, 116, 114, 117, 120, 120, 124, 57, 118, 115, 100, 57, 126, 121, 99, 114, 101, 100, 99, 126, 99, 126, 118, 123, 57, 115, 126, 100, 103, 123, 118, 110, 114, 115, 110, 99, 108, 102, 113, 97, 99, 114, 103, 62, 37, 60, 60, 49, 40, 59, 44, 44, 55, 58, 59, 26, 43, 51, 46, 45, 39, 45, 46, 49, 44, ExifInterface.START_CODE, 44, 63, 55, ExifInterface.START_CODE, 7, 5, 18, 19, 18, 17, 30, 25, 18, 19, 56, 5, 30, 18, 25, 3, 22, 3, 30, 24, 25, 60, 18, 14, 79, 87, 85, 76, 125, 90, 72, 89, 78, 111, 89, 95, 83, 82, 88, 79, 122, 97, 81, 97, 124, 103, 107, 96, 122, 111, 122, 103, 97, 96, 112, 107, 108, 116, 112, 96, 76, 97, 14, 17, 29, 15, 44, 1, 8, 29};
    }
    ...
    private void A03(Intent intent, Bundle bundle) {
        ...
        if (bundle != null) {
            ...
            this.A07 = (EnumC2199Vb) bundleA03.getSerializable(strA01);
            return;
        }
        this.A01 = intent.getIntExtra(strA013, -1);
        this.A0B = intent.getStringExtra(strA012);
        this.A07 = (EnumC2199Vb) intent.getSerializableExtra(strA01);
    ...
    public final void A0D(String str, N9 n92) {
        if (this.A08 == null) {
            return;
        }
        AbstractC2276Yd abstractC2276Yd = this.A09;
        if (A0M[6].charAt(30) != 'X') {
            throw new RuntimeException();
        }
        A0M[0] = "nOOhjPgmgj4ymGbfbhDfGuv2YA";
        if (abstractC2276Yd == null) {
            this.A09 = AbstractC2277Ye.A02(this.A0J, this.A0J.A0A(), str, n92, this.A08, new C2688fw(this));
    ...
    public final void A0E(String str, C2150Td c2150Td) {
        this.A0G.A08(str, c2150Td, this.A0B);
    }
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        if (this.A00 != configuration.orientation) {
            ...
            C2172Ua.A02(UZ.A0K, map, this.A08 == null ? A01(0, 0, 15) : this.A08.getCurrentClientToken(), this.A0J.A0A());
    ...
    public final void onCreate(Bundle bundle) {
        ...
        C2529dL c2529dLA04 = WB.A04(this.A05);
        if (c2529dLA04 != null) {
            this.A0J.A0M(c2529dLA04);
        }
        A03(this.A05, bundle);
        this.A0J.A0F().A36(String.valueOf(A05().hashCode()), A00());
        String stringExtra = this.A05.getStringExtra(A01(69, 10, 59));
        this.A0I.A08(this.A07, stringExtra == null || !(stringExtra.equals(AdPlacementType.INTERSTITIAL.name()) || stringExtra.equals(AdPlacementType.REWARDED_VIDEO.name())));
        this.A06 = new RelativeLayout(this.A0E);
        XP.A0K(this.A06, 0);
        this.A0E.setContentView(this.A06, new RelativeLayout.LayoutParams(-1, -1));
        this.A08 = new R5(this, this.A05, this.A0J.A0A(), this.A0J).A0N(this.A07, this.A06);
        if (this.A08 == null) {
            this.A0J.A08().AAy(A01(58, 11, 105), AbstractC2142Sv.A0A, new C2143Sw(A01(0, 58, 116)));
            A09();
            finish(7);
            return;
        }
        ...
        String strA01 = A01(79, 11, 56);
        if (bundle != null) {
            this.A0C = bundle.getString(strA01);
        } else {
            String stringExtra2 = this.A05.getStringExtra(strA01);
            if (A0M[7].length() != 21) {
    ...
    public final void onPause() {
        ...
        if (this.A08 != null) {
            ...
            C2172Ua.A02(UZ.A0E, null, this.A08.getCurrentClientToken(), this.A0J.A0A());
            this.A0D = true;
        }
    }
    ...
    public final void onResume() {
        ...
        if (this.A08 != null) {
            ...
            interfaceC2261Xo.AF0(false);
            if (this.A0D) {
                C2172Ua.A02(UZ.A0F, null, this.A08.getCurrentClientToken(), this.A0J.A0A());
            }
        }
    }
    ...
    public final void onStart() {
        ...
        if (this.A01 != -1) {
            AbstractC2255Xi.A02(this.A0E, this.A01, this.A0J);
        }
    }
