...
public final class C2294Yv extends LinearLayout {
    public static final int A03 = (int) (AbstractC2232Wl.A02 * 40.0f);
    public static final int A04 = (int) (AbstractC2232Wl.A02 * 20.0f);
    public static final int A05 = (int) (AbstractC2232Wl.A02 * 10.0f);
    public final O6 A00;
    public final C2529dL A01;
    public final InterfaceC2278Yf A02;

    public C2294Yv(C2529dL c2529dL, O6 o62, InterfaceC2278Yf interfaceC2278Yf, XX xx) {
        this(c2529dL, o62, interfaceC2278Yf, null, xx);
    }

    public C2294Yv(C2529dL c2529dL, O6 o62, InterfaceC2278Yf interfaceC2278Yf, String str, XX xx) {
        super(c2529dL);
        this.A01 = c2529dL;
        this.A00 = o62;
    ...
    private View A01(String str) {
        ...
        imageView.setOnClickListener(new ViewOnClickListenerC2292Yt(this));
        TextView textView = new TextView(getContext());
    ...
    private Z1 A03() {
        ...
        for (O6 o62 : this.A00.A05()) {
            C2280Yh c2280Yh = new C2280Yh(this.A01);
            c2280Yh.setData(o62.A04(), null);
            c2280Yh.setOnClickListener(new ViewOnClickListenerC2293Yu(this, c2280Yh, o62));
            z12.addView(c2280Yh);
        }
        return z12;
    }
