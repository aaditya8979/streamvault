...
public final class C2473cQ extends RelativeLayout {
    public KE A00;
    ...
    public static final int A0F = (int) (AbstractC2232Wl.A02 * 16.0f);
    public static final int A0D = (int) (AbstractC2232Wl.A02 * 20.0f);
    public static final int A0E = (int) (AbstractC2232Wl.A02 * 13.0f);
    public static final int A08 = (int) (AbstractC2232Wl.A02 * 72.0f);
    public static final int A0C = (int) (AbstractC2232Wl.A02 * 8.0f);
    public static final int A0A = (int) (AbstractC2232Wl.A02 * 24.0f);
    public static final int A09 = (int) (AbstractC2232Wl.A02 * 16.0f);

    public C2473cQ(C2529dL c2529dL, N9 n92, C1990Mw c1990Mw, KE ke2, String str, View.OnClickListener onClickListener) {
        super(c2529dL);
        this.A04 = c2529dL;
        this.A03 = n92;
        this.A02 = c1990Mw;
        ...
        this.A06 = new C2349aQ(this.A04, C1992My.A01(null), true, false, true);
        A00();
    }

    private void A00() {
        AbstractC2350aR.A00(this.A04, this, this.A03.A01());
