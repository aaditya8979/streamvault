...
public abstract class AbstractC2804hy extends AbstractC1982Mo implements Serializable {
    ...
    public AbstractC2804hy(List<C1983Mp> list) {
        this.A0L = list;
    }
    ...
    private void A0C(C1980Ml c1980Ml) {
        this.A06 = c1980Ml;
    }
    ...
    public final C1980Ml A1z() {
        return this.A06;
    }

    public final C1983Mp A20() {
    ...
    */
    public final void A28(com.facebook.ads.redexgen.core.InterfaceC2260Xn r5) {
        /*
            r4 = this;
        ...
        L10:
            ...
            r5.A4b(r0)
        L1d:
            com.facebook.ads.redexgen.X.dh r0 = com.facebook.ads.redexgen.core.EnumC2551dh.A08
        ...
        L39:
            ...
            goto Lc
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.AbstractC2804hy.A28(com.facebook.ads.redexgen.X.Xn):void");
    }
    ...
    public final void A29(JSONObject jSONObject) {
        ...
        String strA05 = A05(276, 4, 97);
        A0F(n8A06.A05(jSONObject.optJSONObject(strA05) != null ? jSONObject.optJSONObject(strA05).optString(A05(521, 3, 103)) : A05(0, 0, 15)).A04(jSONObject.optString(A05(0, 19, 64))).A07(NA.A03(jSONObject)).A08());
        JSONObject jSONObjectOptJSONObject = jSONObject.optJSONObject(A05(349, 6, 71));
        C1992My c1992MyA01 = C1992My.A01(jSONObjectOptJSONObject != null ? jSONObjectOptJSONObject.optJSONObject(A05(355, 8, 122)) : null);
        String[] strArr = A0P;
        ...
        A0C(new C1980Ml(c1992MyA01, C1992My.A01(jSONObjectOptJSONObject != null ? jSONObjectOptJSONObject.optJSONObject(A05(340, 9, 29)) : null)));
