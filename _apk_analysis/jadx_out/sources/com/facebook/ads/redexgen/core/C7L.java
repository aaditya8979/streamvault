...
public final class C7L<NativeViewabilityLogger> implements InterfaceC2841id {
    ...
    public US A05;
    public V4 A06;
    public InterfaceC2306Zh A08;
    public C1925Ki A09;
    public C5G A0A;
    public AbstractC2601eW A0B;
    public C2602eX A0C;
    public String A0E;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void A0C(int i10, TF tf2) {
        C2837iZ c2837iZ = new C2837iZ(this);
        this.A0A = new C5G(this.A04, this.A05, c2837iZ, this.A03, A08(0, 31, 79), 2, this.A07);
        this.A0B = new C2832iU(this);
        this.A0C = new C2602eX(this.A0A, tf2.A04(), tf2.A09(), true, new WeakReference(this.A0B), this.A04);
    ...
    private void A0F(TF tf2, JSONObject jSONObject, V4 v42) {
        this.A0G = false;
        final C2818iG c2818iGA00 = C2818iG.A00(this.A04, jSONObject);
        this.A0E = c2818iGA00.A7G();
        if (ML.A06(this.A04, c2818iGA00, this.A05)) {
            this.A04.A0F().A4u();
            this.A00.ADj(this, V1.A00(AdErrorType.NO_FILL));
            return;
        }
        this.A08 = new AbstractC1936Kt() { // from class: com.facebook.ads.redexgen.X.7M
            ...
            public final void ACj(String str, Map<String, String> map) {
                ...
                MH mhA00 = MI.A00(c6m, us2, strA7G, uriA00, map, n3A21);
                ME meA0G = ME.A09;
                if (mhA00 != null) {
                    try {
                        ...
                        Log.e(C7L.A0L, A00(0, 22, 111), e10);
                    }
                }
        ...
        this.A09 = new C1925Ki(this.A04, (WeakReference<InterfaceC2306Zh>) new WeakReference(this.A08), tf2.A04(), A7G());
        this.A09.A0L(tf2.A07(), tf2.A08());
        this.A02 = new C2816iE(this.A04, this.A05, this.A09, this.A09.getViewabilityChecker(), new C2831iT(this), v42);
        this.A02.A0A(c2818iGA00);
        this.A09.loadDataWithBaseURL(AbstractC2309Zk.A01(AdInternalSettings.getUrlPrefix()), c2818iGA00.A04(), A08(31, 9, 19), A08(40, 5, 12), null);
        this.A0F = true;
        A0A();
    }
    ...
    */
    private void A0G(com.facebook.ads.redexgen.core.V4 r11, com.facebook.ads.redexgen.core.TF r12) {
        ...
        L53:
            ...
            boolean r0 = com.facebook.ads.redexgen.core.C2101Rf.A0A(r0)
            if (r0 == 0) goto L7c
            r0 = 1
        L60:
            if (r0 != 0) goto L7e
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2841id
