...
public final class YA extends RelativeLayout {
    ...
    public static final int A08 = (int) (AbstractC2232Wl.A02 * 60.0f);
    public static final int A07 = (int) (AbstractC2232Wl.A02 * 8.0f);
    public static final int A09 = (int) (AbstractC2232Wl.A02 * 16.0f);
    public static final int A0A = (int) (AbstractC2232Wl.A02 * 24.0f);
    public static final int A06 = (int) (AbstractC2232Wl.A02 * 12.0f);

    public YA(C2529dL c2529dL, int i10, int i11, String str, String str2, String str3, String str4, Bitmap bitmap) {
        super(c2529dL);
        this.A05 = new TextView(c2529dL);
        this.A02 = new Button(c2529dL);
        this.A01 = new Button(c2529dL);
        ...
        int iA02 = OP.A02(i11, 20);
        XP.A0M(this.A02, i10, A07);
        XP.A0M(this.A01, iA02, A07);
        A00();
        setGravity(17);
    }
