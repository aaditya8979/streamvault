...
public final class C5K extends FrameLayout implements InterfaceC2261Xo, I3 {
    ...
    public R0 A00;
    public R6 A01;
    public InterfaceC2447c0 A02;
    public boolean A03;
    public boolean A04;
    public boolean A05;
    public final AbstractC2804hy A06;
    public final C2529dL A07;
    public final US A08;
    public final C2172Ua A09;
    public final XC A0A;
    public final XH A0B;
    public final InterfaceC2260Xn A0C;
    public final YY A0D;
    public final C2432bl A0E;
    public final C2440bt A0F;
    public final AbstractC2601eW A0G;
    public final C2602eX A0H;

    static {
        A0D();
    }

    public C5K(C2529dL c2529dL, US us2, InterfaceC2260Xn interfaceC2260Xn, AbstractC2804hy abstractC2804hy, YY yy, int i10) {
        super(c2529dL);
        this.A01 = new C1873Ii(this);
        this.A0G = new C1872Ih(this);
        this.A03 = true;
        this.A07 = c2529dL;
        this.A08 = us2;
        this.A0C = interfaceC2260Xn;
        this.A06 = abstractC2804hy;
        this.A0D = yy;
        ...
        if (c2440btA02 != null) {
            ...
            this.A0F = new C2440bt(this.A07, abstractC2804hy, us2, i10);
            this.A04 = false;
        }
        this.A09 = this.A0F.A0K();
        this.A0B = this.A0F.A0L();
        this.A0F.A0c(new C1868Id(this));
        XP.A0E(1003, this.A0F.A0O());
        if (this.A06.A1P()) {
            this.A0E = new C2432bl(this.A07, this.A08, this.A06, new SF(this.A07), this.A09, this.A0C, this.A0D, new C1866Ib(this));
            this.A0E.A0N();
            this.A0F.A0O().setOnTouchListener(new ViewOnTouchListenerC2428bh(this));
            addView(this.A0E, new FrameLayout.LayoutParams(-1, -1));
        } else {
            this.A0E = null;
        }
        ViewGroup mediaView = getMediaView();
        this.A0H = new C2602eX(mediaView, 1, new WeakReference(this.A0G), this.A07);
        ...
        if (U7.A1u(c2529dL)) {
            c2529dL.A0B().AK4(mediaView, abstractC2804hy.A25(), false, false, true);
        }
        try {
            JSONObject jSONObject = new JSONObject();
            boolean zA2C = abstractC2804hy.A2C();
            ...
            } else if (WR.A05(abstractC2804hy.A0u())) {
                jSONObject.put(strA0B4, true);
                jSONObject.put(strA0B3, 2);
            ...
            this.A0F.A0M().A04(AbstractC2142Sv.A15, A0B(0, 26, 113));
        }
    }
    ...
    private void A0C() {
        C2480cX c2480cXA0F = new C2478cV(this.A07, this.A06.A20().A0I(), this.A06.A23()).A0A(this.A06.A1z().A01()).A0F();
        addView(c2480cXA0F, new FrameLayout.LayoutParams(-1, -1));
        c2480cXA0F.A04(new IW(this));
    }
    ...
    private ViewGroup getMediaView() {
        return this.A0E != null ? this.A0E : this.A0F.A0O();
    }
    ...
    public final void A9c() {
        ...
        new C2526dI(this.A07, this.A0D, this.A06.A1A(), this.A0C).A05();
    }

    @Override // com.facebook.ads.redexgen.core.I3
    public final void AAd() {
        new Handler(Looper.getMainLooper()).post(new C1865Ia(this));
    }
    ...
    public final void AG4(String str) {
        String strA26 = this.A06.A26(str);
        if (strA26 == null) {
            return;
        }
        WN.A0O(new WN(), this.A07, WQ.A00(strA26), this.A06.A25());
    }
    ...
    public final void onDestroy() {
        ...
        this.A0A.A03();
        this.A08.AAt(this.A06.A25(), new C2314Zp().A02(this.A0B).A03(this.A0H).A05());
        this.A01 = null;
        this.A02 = null;
        this.A00 = null;
        AbstractC2441bu.A04(this.A06.A17());
        C2440bt.A0B().decrementAndGet();
    }
    ...
    public void setRtfActionsJavascriptListener(InterfaceC2447c0 interfaceC2447c0) {
        this.A02 = interfaceC2447c0;
    }
}
