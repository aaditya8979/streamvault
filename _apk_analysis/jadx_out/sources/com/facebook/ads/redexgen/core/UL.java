...
public final class UL implements AudienceNetworkExportedActivityApi {
    ...
    private boolean A03(UK uk2) {
        ...
        if (callingPackage != null && callingPackage.equals(uk2.A04)) {
        ...
        A02(12);
        if (uk2.A00 instanceof C2750gz) {
            ((C2750gz) uk2.A00).A0F().A0F().AHA();
        }
        if (!(uk2.A00 instanceof C2747gw)) {
            return false;
        }
        LH lhA0F = ((C2747gw) uk2.A00).A0H().A0F();
        if (A02[6].charAt(24) == 'N') {
    ...
    public final void onCreate(Bundle bundle) {
        C2529dL c2529dLA05 = RB.A05(this.A00, UUID.randomUUID().toString());
        ...
        InterfaceC1996Nc interfaceC1996Nc = ukA04 != null ? ukA04.A00 : null;
        if (ukA04 != null && (interfaceC1996Nc instanceof C2747gw)) {
            ...
            C2747gw c2747gw = (C2747gw) interfaceC1996Nc;
            c2747gw.A0G().A01().A0J(this.A00);
            c2747gw.A0M(this.A00.getIntent().getIntExtra(A00(0, 26, 101), -1), 0L);
        } else if (ukA04 == null || !(interfaceC1996Nc instanceof C2750gz)) {
            c2529dLA05.A0F().AHY();
            A02(13);
            return;
        } else {
            ...
            C2750gz c2750gz = (C2750gz) interfaceC1996Nc;
            c2750gz.A0E().A05().A0J(this.A00);
            c2750gz.A0J();
        }
