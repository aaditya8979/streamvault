...
public final class RZ implements RewardedVideoAdApi, Repairable {
    ...
    public RZ(Context context, String str, Ad ad2) {
        ...
        this.A03.A0F().A3L(AdPlacementType.REWARDED_VIDEO.toString(), str);
        this.A01 = new C2737gm(this.A03, str, this.A00, new C2761hB());
        this.A03.A0O(this);
        this.A02 = new C15856p(this.A01, string);
    }
    ...
    public final C2096Ra buildLoadAdConfig() {
        return new C2096Ra(this);
    }

    @Override // com.facebook.ads.internal.api.RewardedVideoAdApi, com.facebook.ads.FullScreenAd
    /* JADX INFO: renamed from: A03, reason: merged with bridge method [inline-methods] */
    public final C2097Rb buildShowAdConfig() {
        return new C2097Rb();
    }
    ...
    public final void loadAd(RewardedVideoAd.RewardedVideoLoadAdConfig rewardedVideoLoadAdConfig) {
        ((C2096Ra) rewardedVideoLoadAdConfig).A00();
    }
    ...
    public final boolean show() {
        ...
        return A08(new C2097Rb().withAppOrientation(-1).build());
    }
