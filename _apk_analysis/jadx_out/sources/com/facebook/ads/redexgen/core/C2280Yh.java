...
public final class C2280Yh extends LinearLayout {
    public boolean A00;
    public final ImageView A01;
    public final TextView A02;
    public static final int A04 = (int) (AbstractC2232Wl.A02 * 16.0f);
    public static final int A05 = (int) (AbstractC2232Wl.A02 * 12.0f);
    public static final int A06 = (int) (AbstractC2232Wl.A02 * 12.0f);
    public static final int A03 = (int) (AbstractC2232Wl.A02 * 16.0f);

    public C2280Yh(C2529dL c2529dL) {
        super(c2529dL);
        this.A00 = false;
        setOrientation(0);
    ...
    private void A00() {
        ...
        int i10 = this.A00 ? -1 : -10459280;
        this.A02.setTextColor(i10);
