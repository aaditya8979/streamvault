...
public final class C2996lO implements H1 {
    ...
    public final int AI6(AnonymousClass20 anonymousClass20, int i10, boolean z10, int i11) throws IOException {
        int i12 = anonymousClass20.read(this.A00, 0, Math.min(this.A00.length, i10));
        if (i12 != -1) {
            return i12;
        }
        if (z10) {
    ...
    @Override // com.facebook.ads.redexgen.core.H1
    public final void AIA(long j10, int i10, int i11, int i12, C1839Gz c1839Gz) {
    }
