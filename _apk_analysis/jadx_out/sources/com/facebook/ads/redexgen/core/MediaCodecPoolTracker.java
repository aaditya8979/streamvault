...
public abstract class MediaCodecPoolTracker {
    ...
    public final C2796ho A05(boolean z10, String str, EnumC2798hq enumC2798hq) {
        C3220p6.A09(str, A03(0, 9, 21));
        C3220p6.A09(enumC2798hq, A03(9, 6, 108));
        return new C2796ho(A02(), z10, str, enumC2798hq);
    }

    public abstract void A06(C2796ho c2796ho, int i10);

    public abstract void A07(EnumC2798hq enumC2798hq, int i10);

    public abstract void A08(EnumC2798hq enumC2798hq, int i10);

    public abstract void A09(EnumC2798hq enumC2798hq, int i10);

    public abstract void A0A(boolean z10, String str, EnumC2798hq enumC2798hq, int i10);
}
