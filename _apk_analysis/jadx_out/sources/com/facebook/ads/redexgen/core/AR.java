...
public final class AR {
    ...
    public AR(String str, String str2, String str3, MediaCodecInfo.CodecCapabilities codecCapabilities, boolean z10, boolean z11, boolean z12, boolean z13, boolean z14, boolean z15) {
        ...
        this.A08 = z14;
        this.A06 = z15;
        this.A0A = AbstractC14732h.A0F(str2);
    }
    ...
    */
    ...
    public static Point A01(MediaCodecInfo.VideoCapabilities videoCapabilities, int i10, int i11) {
        ...
        return new Point(AbstractC15184a.A05(i10, widthAlignment) * widthAlignment, AbstractC15184a.A05(i11, heightAlignment) * heightAlignment);
    }
    ...
    */
    ...
    public static void A04() {
        A0B = new byte[]{73, 29, 6, 73, 29, 17, 65, 77, 54, 46, 48, 2, 2, 4, 28, 20, 21, 60, 16, 9, 50, 25, 16, 31, 31, 20, 29, 48, 21, 27, 4, 2, 5, 28, 20, 31, 5, 75, 81, 14, 60, 60, 58, 34, ExifInterface.START_CODE, 43, 28, 58, 63, 63, 32, 61, 59, 111, 20, 19, 58, 49, 48, 41, 48, 127, 11, 29, 114, 7, 105, 111, 106, 98, 75, 64, 65, 88, 65, 14, 122, 108, 3, 118, 24, 30, 24, 86, 127, 116, 117, 108, 117, 58, 78, 88, 55, 66, 44, 43, 44, 52, 28, 29, 16, 24, 58, 22, 29, 28, 26, 48, 23, 31, 22, 28, 55, ExifInterface.START_CODE, 39, 33, 114, 99, 98, 126, 95, 99, 69, 64, 64, 95, 66, 68, 16, 107, 11, 0, 22, 11, 13, 0, 105, 28, 17, 119, 32, 34, 55, 65, ExifInterface.START_CODE, 23, 22, 1, 0, 28, 65, 46, 57, 44, 65, 43, 10, 12, 0, 11, 10, 29, 31, 29, 8, 126, 21, 40, 41, 62, 63, 35, 126, 17, 6, 19, 126, 20, 53, 51, 63, 52, 53, 34, 126, 35, 53, 51, 37, 34, 53, 84, 86, 67, 53, 86, 90, 73, 77, 94, 87, 87, 53, 77, 82, 95, 94, 84, 53, 83, 76, 53, 88, 84, 95, 90, 44, 46, 47, 41, 95, 94, 88, 84, 95, 94, 73, 11, 9, 28, 106, 9, 16, 15, 106, 18, 13, 0, 1, 11, 106, 0, 1, 7, 11, 0, 1, 22, 106, 12, 1, 18, 7, 16, 14, 110, 23, 113, 112, 115, 15, 102, 27, 96, 90, 95, 90, 75, 79, 82, 77, 94, 22, 75, 87, 90, 66, 89, 90, 88, 80, 29, 9, 24, 21, 19, 83, 79, 27, 12, 12, 74, 94, 79, 66, 68, 4, 74, 72, 24, 110, 122, 107, 102, 96, 32, 110, 98, 125, 34, 120, 109, 44, 56, 41, 36, 34, 98, 40, 44, 46, 126, 7, 19, 2, 15, 9, 73, 0, 10, 7, 5, 127, 107, 122, 119, 113, 49, 121, 41, 47, 47, 51, 127, 114, 127, 105, ExifInterface.START_CODE, 62, 47, 34, 36, 100, 44, 124, 122, 122, 102, 38, 39, ExifInterface.START_CODE, 60, 24, 12, 29, 16, 22, 86, 30, 10, 20, 78, 90, 75, 70, 64, 0, 66, 95, 27, 78, 2, 67, 78, 91, 66, 85, 65, 80, 93, 91, 27, 89, 68, 81, 83, 79, 91, 74, 71, 65, 1, 65, 94, 91, 93, 84, 64, 81, 92, 90, 26, 71, 84, 66, 111, 123, 106, 103, 97, 33, 120, 97, 124, 108, 103, 125, 126, 115, 110, 121, 125, 112, 5, 14, 7, 8, 8, 3, 10, 37, 9, 19, 8, 18, 72, 7, 37, 7, 22, 21, 66, 73, 64, 79, 79, 68, 77, 98, 78, 84, 79, 85, 15, 66, 64, 81, 82, 55, 60, 53, 58, 58, 49, 56, 23, 59, 33, 58, 32, 122, 39, 33, 36, 36, 59, 38, 32, 120, 116, 53, 57, 50, 51, 53, 120, 59, 63, 59, 51, 118, 107, 103, 108, 109, 107, 38, 120, 122, 103, 110, 97, 100, 109, 68, 109, 126, 109, 100, 36, 40, 126, 114, 97, 127, 122, 125, 36, ExifInterface.START_CODE, 63, 124, 40, 87, 69, 70, 86, 77, 74, 69, 77, 95, 87, 82, 88, 87, 77, 86, 49, 35, 47, 50, 46, 39, 16, 35, 54, 39, 108, 35, 1, 35, 50, 49, 109, 127, 115, 110, 114, 123, 76, 127, 106, 123, 48, 125, 127, 110, 109, 2, 16, 28, 1, 29, 20, 35, 16, 5, 20, 95, 2, 4, 1, 1, 30, 3, 5, 93, 81, 1, 23, 17, 7, 0, 23, 95, 2, 30, 19, 11, 16, 19, 17, 25, 102, 124, 111, 112, 84, 123, 113, 71, 116, 97, 112, 59, 118, 116, 101, 102, 64, 90, 73, 86, 114, 93, 87, 97, 82, 71, 86, 29, 80, 92, 69, 86, 65, 31, 19, 108, 118, 101, 122, 94, 113, 123, 77, 126, 107, 122, 49, 109, 112, 107, 126, 107, 122, 123, 51, 63, 24, 2, 17, 14, ExifInterface.START_CODE, 5, 15, 57, 10, 31, 14, 69, 24, 30, 27, 27, 4, 25, 31, 71, 75, 100, 126, 109, 114, 86, 121, 115, 69, 118, 99, 114, 57, 97, 84, 118, 103, 100, 4, 5, 30, 30, 21, 28, 21, 20, 93, 0, 28, 17, 9, 18, 17, 19, 27, 48, 47, 34, 35, 41, 105, 39, 48, 37, 114, 109, 96, 97, 107, 43, 96, 107, 104, 102, 125, 41, 114, 109, 119, 109, 107, 106, 21, 10, 7, 6, 12, 76, 11, 6, 21, 0, 82, 77, 64, 65, 75, 11, 92, 9, 82, 74, 64, 10, 75, 74, 22, 10, 82, 84, 29, 92};
    }

    private void A05(String str) {
        StringBuilder sbAppend = new StringBuilder().append(A03(39, 16, 85)).append(str);
        String strA03 = A03(261, 3, 33);
        AnonymousClass44.A04(A03(97, 14, 99), sbAppend.append(strA03).append(this.A03).append(A03(4, 2, 43)).append(this.A02).append(strA03).append(AbstractC15184a.A04).append(A03(260, 1, 72)).toString());
    }
    ...
    public static boolean A07() {
        return AbstractC15184a.A03.equals(A03(532, 7, 62)) || AbstractC15184a.A03.equals(A03(427, 6, 6)) || AbstractC15184a.A06.startsWith(A03(55, 14, 69)) || AbstractC15184a.A06.startsWith(A03(69, 14, 52)) || AbstractC15184a.A06.startsWith(A03(83, 14, 0));
    }

    public static boolean A09(MediaCodecInfo.CodecCapabilities codecCapabilities) {
        return AbstractC15184a.A02 >= 19 && A0A(codecCapabilities);
    }
    ...
    public static boolean A0B(MediaCodecInfo.CodecCapabilities codecCapabilities) {
        return AbstractC15184a.A02 >= 21 && A0C(codecCapabilities);
    }
    ...
    public static boolean A0D(MediaCodecInfo.CodecCapabilities codecCapabilities) {
        return AbstractC15184a.A02 >= 21 && A0E(codecCapabilities);
    }
    ...
    public static boolean A0F(MediaCodecInfo.VideoCapabilities videoCapabilities, int i10, int i11, double d10) {
        Point pointA01 = A01(videoCapabilities, i10, i11);
        int i12 = pointA01.x;
        int i13 = pointA01.y;
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private boolean A0G(com.facebook.ads.redexgen.core.C3206or r12, boolean r13) {
        /*
    ...
    public static boolean A0I(String str) {
        return AbstractC15184a.A06.startsWith(A03(253, 7, 89)) && A03(191, 36, 1).equals(str);
    }

    public static boolean A0J(String str) {
        if (AbstractC15184a.A02 <= 22) {
            if ((A03(130, 10, 94).equals(AbstractC15184a.A06) || A03(111, 8, 72).equals(AbstractC15184a.A06)) && (A03(140, 22, 117).equals(str) || A03(162, 29, 74).equals(str))) {
                return true;
            }
        }
        return false;
    ...
    public static boolean A0K(String str) {
        return (A03(227, 26, 94).equals(str) && A03(IronSourceError.ERROR_NON_EXISTENT_INSTANCE, 5, 83).equals(AbstractC15184a.A03)) ? false : true;
    }

    public static boolean A0L(String str, int i10) {
        if (A03(751, 10, 121).equals(str) && 2 == i10) {
            if (A03(539, 8, 36).equals(AbstractC15184a.A03) || A03(521, 6, 9).equals(AbstractC15184a.A03)) {
                return true;
            }
        }
        return false;
    ...
    public static MediaCodecInfo.CodecProfileLevel[] A0M(MediaCodecInfo.CodecCapabilities codecCapabilities) {
        ...
        if (iIntValue >= 180000000) {
            ...
            i10 = iIntValue >= 12000000 ? 32 : iIntValue >= 7200000 ? 16 : iIntValue >= 3600000 ? 8 : iIntValue >= 1800000 ? 4 : iIntValue >= 800000 ? 2 : 1;
        }
    ...
    public final C15535j A0O(C3206or c3206or, C3206or c3206or2) {
        int i10 = AbstractC15184a.A1E(c3206or.A0W, c3206or2.A0W) ? 0 : 0 | 8;
        if (this.A0A) {
            if (c3206or.A0F != c3206or2.A0F) {
                i10 |= 1024;
            }
            if (!this.A04 && (c3206or.A0L != c3206or2.A0L || c3206or.A0A != c3206or2.A0A)) {
                i10 |= 512;
            }
            if (!AbstractC15184a.A1E(c3206or.A0N, c3206or2.A0N)) {
                i10 |= 2048;
            }
            if (A0I(this.A03) && !c3206or.A0A(c3206or2)) {
                i10 |= 2;
            }
            if (i10 == 0) {
                String str = this.A03;
                int i11 = c3206or.A0A(c3206or2) ? 3 : 2;
                if (A0C[0].charAt(21) != 'A') {
                    throw new RuntimeException();
                }
                String[] strArr = A0C;
                ...
                return new C15535j(str, c3206or, c3206or2, i11, 0);
            }
        } else {
            if (c3206or.A06 != c3206or2.A06) {
                i10 |= 4096;
            }
            if (c3206or.A0G != c3206or2.A0G) {
                i10 |= 8192;
            }
            if (c3206or.A0C != c3206or2.A0C) {
                i10 |= 16384;
            }
            if (i10 == 0 && A03(371, 15, 53).equals(this.A02)) {
                Pair<Integer, Integer> pairA0B = C1685Ay.A0B(c3206or);
                Pair<Integer, Integer> pairA0B2 = C1685Ay.A0B(c3206or2);
                if (pairA0B != null && pairA0B2 != null) {
                    ...
                    if (iIntValue == 42 && iIntValue2 == 42) {
                        return new C15535j(this.A03, c3206or, c3206or2, 3, 0);
                    }
                }
            }
            if (!c3206or.A0A(c3206or2)) {
                i10 |= 32;
            }
            if (A0H(this.A02)) {
                i10 |= 2;
            ...
            if (i10 == 0) {
                return new C15535j(this.A03, c3206or, c3206or2, 1, 0);
            }
        }
        return new C15535j(this.A03, c3206or, c3206or2, 0, i10);
    }
    ...
    public final boolean A0S(C3206or c3206or) {
        String strA07;
        if (c3206or.A0R == null || this.A02 == null || (strA07 = AbstractC14732h.A07(c3206or.A0R)) == null) {
            return true;
        }
        if (this.A02.equals(strA07)) {
            return A0G(c3206or, true);
        }
        A06(A03(490, 11, 76) + c3206or.A0R + A03(4, 2, 43) + strA07);
        return false;
    }

    public final boolean A0T(C3206or c3206or) {
        if (!this.A0A) {
            Pair<Integer, Integer> pairA0B = C1685Ay.A0B(c3206or);
    ...
    @Deprecated
    public final boolean A0U(C3206or c3206or, C3206or c3206or2, boolean z10) {
        if (!z10 && c3206or.A0N != null) {
            ColorInfo colorInfo = c3206or2.A0N;
            String[] strArr = A0C;
            ...
            A0C[2] = "CiueF8sE";
            if (colorInfo == null) {
                c3206or2 = c3206or2.A07().A0t(c3206or.A0N).A14();
            }
        }
        int i10 = A0O(c3206or, c3206or2).A01;
        return i10 == 2 || i10 == 3;
    }
