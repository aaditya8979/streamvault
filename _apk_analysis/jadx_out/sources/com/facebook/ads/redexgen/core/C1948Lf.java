...
public class C1948Lf implements InterfaceC2258Xl {
    ...
    public C1948Lf(C1945Lc c1945Lc) {
        this.A00 = c1945Lc;
    }
    ...
    public final void ACC(AbstractC2259Xm abstractC2259Xm) {
        ...
        if (A01[4].charAt(5) == '8') {
            A01[1] = "011C";
            if (c1945Lc.A0X && !this.A00.A0V.get() && this.A00.A0V()) {
            ...
            InterfaceC2260Xn interfaceC2260Xn = this.A00.A0Q;
            C1945Lc c1945Lc2 = this.A00;
            if (A01[2].length() == 9) {
                A01[6] = "SsRiNY9tvP3hEWy4eyTF9NsffnrPtCfL";
                interfaceC2260Xn.A4b(c1945Lc2.A0R.A7o());
                return;
            }
        }
