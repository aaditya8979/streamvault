    ...
    */
    public static float A00(float r6, int r7) {
        /*
            ...
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.KA.A0C
            r0 = 2
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 32
            ...
            throw r0
        L25:
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.KA.A0C
        ...
        L3c:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.KA.A00(float, int):float");
    }
    ...
    public static float A02(int i10, float f10) {
        switch (i10) {
            case 0:
                return 1.0f - f10;
            case 1:
                return f10 <= 0.5f ? 2.0f * f10 : (1.0f - f10) * 2.0f;
            case 2:
                return f10;
            default:
    ...
    public static Layout.Alignment A04(int i10) {
        switch (i10) {
            ...
            default:
                AnonymousClass44.A07(A05(23, 15, 34), A05(0, 23, 23) + i10);
                return null;
        }
    }
    ...
    public final C3C A07() {
        ...
        int iA03 = this.A05 != Integer.MIN_VALUE ? this.A05 : A03(this.A06);
        C3C c3cA0B = new C3C().A0F(A04(this.A06)).A07(A00(this.A00, this.A04), this.A04).A09(this.A03).A04(fA01).A0A(iA03).A06(Math.min(this.A02, A02(iA03, fA01))).A0B(this.A07);
        if (this.A0A != null) {
            c3cA0B.A0G(this.A0A);
        }
        return c3cA0B;
