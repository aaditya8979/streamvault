...
public final class C3195og implements C1S {
    public final Uri A00;
    public final Uri A01;
    public final Bundle A02;
    public final AbstractC3184oU A03;
    public final AbstractC3184oU A04;
    ...
    public static final C3195og A0Z = new C2V().A11();
    public static final C1R<C3195og> A0Y = new C1R() { // from class: com.facebook.ads.redexgen.X.oh
        @Override // com.facebook.ads.redexgen.core.C1R
        public final C1S A6X(Bundle bundle) {
            return C3195og.A00(bundle);
        }
    };

    public C3195og(C2V c2v) {
        this.A0H = c2v.A0H;
        this.A08 = c2v.A08;
        this.A07 = c2v.A07;
        this.A06 = c2v.A06;
    ...
    public static C3195og A00(Bundle bundle) {
        Bundle bundle2;
        Bundle bundle3;
        C2V c2v = new C2V();
        c2v.A0n(bundle.getCharSequence(A02(0))).A0e(bundle.getCharSequence(A02(1))).A0d(bundle.getCharSequence(A02(2))).A0c(bundle.getCharSequence(A02(3))).A0j(bundle.getCharSequence(A02(4))).A0m(bundle.getCharSequence(A02(5))).A0i(bundle.getCharSequence(A02(6))).A0X((Uri) bundle.getParcelable(A02(7))).A10(bundle.getByteArray(A02(10)), bundle.containsKey(A02(29)) ? Integer.valueOf(bundle.getInt(A02(29))) : null).A0W((Uri) bundle.getParcelable(A02(11))).A0o(bundle.getCharSequence(A02(22))).A0g(bundle.getCharSequence(A02(23))).A0h(bundle.getCharSequence(A02(24))).A0k(bundle.getCharSequence(A02(27))).A0f(bundle.getCharSequence(A02(28))).A0l(bundle.getCharSequence(A02(30))).A0Y(bundle.getBundle(A02(1000)));
        if (bundle.containsKey(A02(8)) && (bundle3 = bundle.getBundle(A02(8))) != null) {
            c2v.A0a((AbstractC3184oU) AbstractC3184oU.A03.A6X(bundle3));
        }
        if (bundle.containsKey(A02(9)) && (bundle2 = bundle.getBundle(A02(9))) != null) {
            c2v.A0Z((AbstractC3184oU) AbstractC3184oU.A03.A6X(bundle2));
        }
    ...
    */
    public final boolean equals(java.lang.Object r6) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C3195og.equals(java.lang.Object):boolean");
    }
