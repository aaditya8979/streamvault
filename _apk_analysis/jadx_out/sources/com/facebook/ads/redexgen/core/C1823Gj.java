...
public final class C1823Gj {
    ...
    public C1823Gj(List<byte[]> list, int i10, int i11, int i12, float f10, String str, int i13, int i14, int i15) {
        this.A08 = list;
        this.A05 = i10;
        this.A06 = i11;
        this.A04 = i12;
    ...
    public static C1823Gj A00(C4J c4j) throws C14742i {
        try {
            c4j.A0g(21);
            int iA0I = c4j.A0I() & 3;
            int iA0I2 = c4j.A0I();
            ...
            for (int i19 = 0; i19 < iA0I2; i19++) {
                ...
                for (int i20 = 0; i20 < iA0M3; i20++) {
                    int iA0M4 = c4j.A0M();
                    System.arraycopy(AbstractC1830Gq.A03, 0, bArr, i13, AbstractC1830Gq.A03.length);
                    int length = i13 + AbstractC1830Gq.A03.length;
                    System.arraycopy(c4j.A0l(), c4j.A09(), bArr, length, iA0M4);
                    if (iA0I3 == 33 && i20 == 0) {
                        C1827Gn c1827GnA05 = AbstractC1830Gq.A05(bArr, length, length + iA0M4);
                        i14 = c1827GnA05.A0A;
                        i15 = c1827GnA05.A08;
                        i16 = c1827GnA05.A02;
                        i17 = c1827GnA05.A01;
                        i18 = c1827GnA05.A03;
                        f10 = c1827GnA05.A00;
                        strA03 = C3U.A03(c1827GnA05.A07, c1827GnA05.A0B, c1827GnA05.A06, c1827GnA05.A05, c1827GnA05.A0C, c1827GnA05.A04);
                    }
                    i13 = length + iA0M4;
                    c4j.A0g(iA0M4);
                }
            }
            return new C1823Gj(i10 == 0 ? Collections.emptyList() : Collections.singletonList(bArr), iA0I + 1, i14, i15, f10, strA03, i16, i17, i18);
        } catch (ArrayIndexOutOfBoundsException e10) {
            throw C14742i.A01(A01(0, 25, 126), e10);
        }
    }
