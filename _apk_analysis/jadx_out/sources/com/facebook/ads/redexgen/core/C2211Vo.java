...
public final class C2211Vo implements UQ {
    ...
    static {
        A01();
        A04 = C2211Vo.class.getSimpleName();
    }

    public C2211Vo(C2503cu c2503cu, C2212Vp c2212Vp) {
        this.A00 = c2503cu;
        this.A01 = c2212Vp;
    }
    ...
    public final void AD0(JSONArray jSONArray) {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            try {
                String string = jSONArray.getJSONObject(i10).getString(A00(403, 2, 94));
                if (C2144Sx.A0I(string)) {
                    C2144Sx.A0B(this.A00, string);
                } else {
                    hashSet.add(string);
                }
            } catch (JSONException e10) {
    ...
    public final boolean AD1(JSONArray jSONArray) {
        ...
        for (int i10 = 0; i10 < jSONArray.length(); i10++) {
            try {
                ...
                if (this.A00.A05().AAF()) {
                    Log.e(A04, A00(309, 44, 108) + i10 + strA00, e10);
                }
                z10 = false;
            }
        }
