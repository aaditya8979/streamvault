...
import com.facebook.ads.redexgen.core.AbstractC1830Gq;
import com.facebook.ads.redexgen.core.AnonymousClass44;
import com.facebook.ads.redexgen.core.AnonymousClass45;
import com.facebook.ads.redexgen.core.C14742i;
import com.facebook.ads.redexgen.core.C1833Gt;
import com.facebook.ads.redexgen.core.C2972kp;
import com.facebook.ads.redexgen.core.C2974kr;
import com.facebook.ads.redexgen.core.C2990lI;
import com.facebook.ads.redexgen.core.C3000lT;
...
import com.facebook.ads.redexgen.core.InterfaceC1836Gw;
import com.facebook.ads.redexgen.core.InterfaceC2995lN;
...
public final class MatroskaExtractor implements GX {
    ...
    public static final InterfaceC1815Gb A0v;
    ...
    static {
        A0B();
        A0v = new InterfaceC1815Gb() { // from class: com.facebook.ads.redexgen.X.kq
        ...
        A0y = AbstractC15184a.A1G(A06(729, 90, 38));
        ...
        map.put(A06(1321, 18, 92), Integer.valueOf(BaseTransientBottomBar.ANIMATION_FADE_DURATION));
        map.put(A06(1339, 18, 57), 270);
        A0w = Collections.unmodifiableMap(map);
    }
    ...
    public MatroskaExtractor(I9 i92, int i10) {
        ...
        this.A0m = new C4J(4);
        this.A0j = new C4J(AbstractC1830Gq.A03);
        this.A0i = new C4J(4);
        this.A0k = new C4J();
        this.A0n = new C4J();
        this.A0g = new C4J(8);
    ...
    private int A01(InterfaceC2995lN interfaceC2995lN, H1 h12, int i10) throws IOException {
        int iA07 = this.A0k.A07();
        if (iA07 <= 0) {
            return h12.AI5(interfaceC2995lN, i10, false);
        }
        int iMin = Math.min(i10, iA07);
        h12.AI7(this.A0k, iMin);
        return iMin;
    }
    ...
    */
    private int A02(com.facebook.ads.redexgen.core.InterfaceC2995lN r13, com.facebook.ads.redexgen.core.IC r14, int r15, boolean r16) throws java.io.IOException {
        /*
    ...
    private long A03(long j10) throws C14742i {
        if (this.A0O != -9223372036854775807L) {
            return AbstractC15184a.A0U(j10, this.A0O, 1000L);
        }
        throw C14742i.A01(A06(279, 54, 38), null);
    }

    @MetaExoPlayerCustomization("Adding support AR/VR eventListener")
    private InterfaceC1836Gw A04(AnonymousClass45 anonymousClass45, AnonymousClass45 anonymousClass452) {
        if (this.A0M == -1 || this.A0J == -9223372036854775807L || anonymousClass45 == null || anonymousClass45.A02() == 0 || anonymousClass452 == null || anonymousClass452.A02() != anonymousClass45.A02()) {
            return new C2990lI(this.A0J);
        }
        int iA02 = anonymousClass45.A02();
        int[] iArrCopyOf = new int[iA02];
        long[] jArrCopyOf = new long[iA02];
        long[] jArrCopyOf2 = new long[iA02];
        long[] jArrCopyOf3 = new long[iA02];
        for (int i10 = 0; i10 < iA02; i10++) {
            jArrCopyOf3[i10] = anonymousClass45.A03(i10);
            jArrCopyOf[i10] = this.A0M + anonymousClass452.A03(i10);
        }
        for (int i11 = 0; i11 < iA02 - 1; i11++) {
            iArrCopyOf[i11] = (int) (jArrCopyOf[i11 + 1] - jArrCopyOf[i11]);
            int i12 = i11 + 1;
            if (A0u[7].length() == 16) {
            ...
            jArrCopyOf2[i11] = jArrCopyOf3[i12] - jArrCopyOf3[i11];
        }
        iArrCopyOf[iA02 - 1] = (int) ((this.A0M + this.A0N) - jArrCopyOf[iA02 - 1]);
        jArrCopyOf2[iA02 - 1] = this.A0J - jArrCopyOf3[iA02 - 1];
        long j10 = jArrCopyOf2[iA02 - 1];
        if (j10 <= 0) {
            AnonymousClass44.A07(A06(869, 17, 79), A06(499, 52, 38) + j10);
            iArrCopyOf = Arrays.copyOf(iArrCopyOf, iArrCopyOf.length - 1);
            jArrCopyOf = Arrays.copyOf(jArrCopyOf, jArrCopyOf.length - 1);
            jArrCopyOf2 = Arrays.copyOf(jArrCopyOf2, jArrCopyOf2.length - 1);
            jArrCopyOf3 = Arrays.copyOf(jArrCopyOf3, jArrCopyOf3.length - 1);
        }
        return new C3000lT(iArrCopyOf, jArrCopyOf, jArrCopyOf2, jArrCopyOf3);
    }

    private final IC A05(int i10) throws C14742i {
        A0D(i10);
        return this.A0T;
    }
    ...
    public static void A0B() {
        A0t = new byte[]{90, 23, 15, 9, 14, 90, 24, 31, 90, 19, 20, 90, 27, 90, 57, 15, 31, 9, 96, 45, 53, 51, 52, 96, 34, 37, 96, 41, 46, 96, 33, 96, 20, 50, 33, 35, 43, 5, 46, 52, 50, 57, 19, 93, 92, 71, 19, 64, 70, 67, 67, 92, 65, 71, 86, 87, 111, 122, 123, 46, 112, 111, 122, 120, 46, 112, 111, 122, 120, 46, 112, 111, 122, 120, 46, 22, 3, 1, 87, 9, 22, 3, 1, 87, 9, 22, 3, 1, 87, 31, 22, 3, 0, 87, 19, 6, 4, 82, 12, 19, 6, 4, 82, 12, 19, 6, 4, 82, 24, 19, 6, 5, 82, 0, 4, 18, 18, 36, 53, 53, 40, 47, 38, 50, 2, 40, 49, 41, 36, 51, 12, 46, 37, 36, 97, 94, 64, 94, 94, 92, 23, 9, 23, 21, 101, 58, 36, 63, 47, 40, 58, 36, 63, 47, 40, 84, 62, 35, 43, 41, 62, 40, 40, 80, 78, 85, 69, 66, 62, 93, 94, 66, 66, 93, 84, 66, 66, 120, 102, 124, 120, 122, 10, 110, 112, 105, 99, 110, 108, 33, 63, 45, 48, 37, 39, 79, 44, 82, 2, 28, 14, 19, 6, 4, 108, 15, 112, 33, 63, 45, 51, 79, 33, 35, 45, 31, 1, 17, 14, 11, 13, 82, 76, 67, 80, 94, 60, 85, 95, 92, 82, 71, 60, 90, 86, 86, 86, 82, 76, 67, 80, 94, 60, 90, 93, 71, 60, 81, 90, 84, 12, 18, 29, 14, 0, 98, 4, 3, 25, 98, 1, 4, 25, 116, 106, 97, 103, 96, 112, 125, 113, 56, 38, 47, 54, 43, 59, 48, ExifInterface.START_CODE, 105, 75, 68, 13, 94, 10, 89, 73, 75, 70, 79, 10, 94, 67, 71, 79, 73, 69, 78, 79, 10, 90, 88, 67, 69, 88, 10, 94, 69, 10, 94, 67, 71
, 78, 67, 66, 72, 120, 85, 72, 83, 102, 10, 23, 23, 23, 52, 40, 63, 3, ExifInterface.START_CODE, 53, 56, 57, 51, 3, 46, 51, 40, 29, 113, 108, 101, 108, 56, 36, 51, 15, 38, 57, 52, 53, 63, 15, 34, 63, 36, 17, 125, 97, 104, 96, 93, 65, 86, 106, 67, 92, 81, 80, 90, 106, 71, 90, 65, 116, 24, 7, 2, 5, 34, 46, 59, 61, 32, 60, 36, 46, 56, 39, ExifInterface.START_CODE, 43, 33, 97, 57, 43, 44, 35, 21, 7, 0, 15};
    }

    @EnsuresNonNull({"cueTimesUs", "cueClusterPositions"})
    private void A0C(int i10) throws C14742i {
        if (this.A0R == null || this.A0Q == null) {
            throw C14742i.A01(A06(LevelPlayAdError.ERROR_CODE_SHOW_WHILE_LOAD, 8, 72) + i10 + A06(0, 18, 118), null);
        }
    }

    @EnsuresNonNull({"currentTrack"})
    private void A0D(int i10) throws C14742i {
        if (this.A0T == null) {
            throw C14742i.A01(A06(LevelPlayAdError.ERROR_CODE_SHOW_WHILE_LOAD, 8, 72) + i10 + A06(18, 24, 76), null);
        }
    }

    private void A0E(InterfaceC2995lN interfaceC2995lN, int i10) throws IOException {
        if (this.A0l.A0A() >= i10) {
            return;
        }
        if (this.A0l.A08() < i10) {
        ...
        interfaceC2995lN.readFully(this.A0l.A0l(), this.A0l.A0A(), i10 - this.A0l.A0A());
        this.A0l.A0e(i10);
    }

    private void A0F(InterfaceC2995lN interfaceC2995lN, byte[] bArr, int i10) throws IOException {
        int length = bArr.length + i10;
        if (this.A0n.A08() < length) {
            this.A0n.A0i(Arrays.copyOf(bArr, length + i10));
        } else {
            System.arraycopy(bArr, 0, this.A0n.A0l(), 0, bArr.length);
        }
        interfaceC2995lN.readFully(this.A0n.A0l(), bArr.length, i10);
        this.A0n.A0f(0);
        this.A0n.A0e(length);
    }

    private void A0G(InterfaceC2995lN interfaceC2995lN, byte[] bArr, int i10, int i11) throws IOException {
        int iMin = Math.min(i11, this.A0k.A07());
        interfaceC2995lN.readFully(bArr, i10 + iMin, i11 - iMin);
        if (iMin > 0) {
            this.A0k.A0k(bArr, i10, iMin);
        }
    }

    private final void A0H(IC ic2, int i10, InterfaceC2995lN interfaceC2995lN, int i11) throws IOException {
        if (i10 == 4) {
            if (A06(1280, 5, 88).equals(ic2.A0d)) {
                this.A0o.A0d(i11);
                interfaceC2995lN.readFully(this.A0o.A0l(), 0, i11);
                return;
            }
        }
        interfaceC2995lN.AJJ(i11);
    }
    ...
    */
    ...
    private final void A0J(IC ic2, InterfaceC2995lN interfaceC2995lN, int i10) throws IOException {
        if (ic2.A0n != 1685485123) {
            int i11 = ic2.A0n;
            String[] strArr = A0u;
        ...
        interfaceC2995lN.readFully(ic2.A0k, 0, i10);
    }
    ...
    */
    ...
    private boolean A0L(C1833Gt c1833Gt, long j10) {
        if (this.A0c) {
            this.A0L = j10;
            c1833Gt.A00 = this.A0H;
            this.A0c = false;
            return true;
        }
    ...
    */
    ...
    public static byte[] A0O(long j10, String str, long j11) {
        ...
        return AbstractC15184a.A1G(String.format(Locale.US, str, Integer.valueOf(i10), Integer.valueOf(i11), Integer.valueOf(i12), Integer.valueOf((int) ((j13 - (((long) i12) * 1000000)) / j11))));
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final void A0S(int r15) throws com.facebook.ads.redexgen.core.C14742i {
        /*
    ...
    public final void A0T(int i10, double d10) throws C14742i {
        switch (i10) {
            case 181:
                IC icA05 = A05(i10);
                int i11 = (int) d10;
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final void A0U(int r21, int r22, com.facebook.ads.redexgen.core.InterfaceC2995lN r23) throws java.io.IOException {
        /*
    ...
    public final void A0V(int i10, long j10) throws C14742i {
        ...
        switch (i10) {
            ...
            case 16980:
                ...
                throw C14742i.A01(A06(426, 16, 25) + j10 + strA06, null);
            case 17029:
                if (j10 < 1 || j10 > 2) {
                    throw C14742i.A01(A06(559, 19, 27) + j10 + strA06, null);
                }
                return;
            case 17143:
                if (j10 != 1) {
                    throw C14742i.A01(A06(615, 16, 122) + j10 + strA06, null);
                }
                return;
            case 18401:
                if (j10 != 5) {
                    throw C14742i.A01(A06(442, 15, 36) + j10 + strA06, null);
                }
                return;
            case 18408:
                if (j10 != 1) {
                    throw C14742i.A01(A06(113, 22, 77) + j10 + strA06, null);
                }
                return;
            case 20529:
                if (j10 != 0) {
                    throw C14742i.A01(A06(457, 21, 29) + j10 + strA06, null);
                }
                return;
            case 20530:
                if (j10 != 1) {
                    throw C14742i.A01(A06(478, 21, 16) + j10 + strA06, null);
                }
                return;
            case 21420:
    ...
    public final void A0W(int i10, long j10, long j11) throws C14742i {
        A09();
        switch (i10) {
            case 160:
                this.A0W = false;
            ...
            case 408125543:
                if (this.A0M != -1 && this.A0M != j10) {
                    throw C14742i.A01(A06(886, 39, 119), null);
                }
                this.A0M = j10;
                this.A0N = j11;
                return;
            ...
            case 524531317:
                ...
                if (this.A0s && this.A0H != -1) {
                    ...
                    this.A0S.AIN(new C2990lI(this.A0J));
                    this.A0e = true;
                    return;
                }
        }
    ...
    public final void A0X(int i10, String str) throws C14742i {
        switch (i10) {
            case 134:
                A05(i10).A0d = str;
                return;
            case 17026:
                if (!A06(1375, 4, 110).equals(str) && !A06(1357, 8, 67).equals(str)) {
                    throw C14742i.A01(A06(551, 8, 69) + str + A06(42, 14, 63), null);
                }
                return;
            case 17827:
                this.A0U = str;
    ...
    public final int AGb(InterfaceC2995lN interfaceC2995lN, C1833Gt c1833Gt) throws IOException {
        ...
        boolean zAGe = true;
        while (zAGe && !this.A0X) {
            zAGe = this.A0q.AGe(interfaceC2995lN);
            if (zAGe && A0L(c1833Gt, interfaceC2995lN.A8f())) {
                return 1;
            }
        }
        if (zAGe) {
        ...
        for (int i10 = 0; i10 < this.A0P.size(); i10++) {
            IC icValueAt = this.A0P.valueAt(i10);
            icValueAt.A06();
            icValueAt.A0E();
        }
        return -1;
    ...
    public final boolean AJL(InterfaceC2995lN interfaceC2995lN) throws IOException {
        return new ID().A01(interfaceC2995lN);
    }
}
