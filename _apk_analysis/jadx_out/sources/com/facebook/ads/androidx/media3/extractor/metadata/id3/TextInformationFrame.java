...
import com.facebook.ads.redexgen.core.C1847Hh;
...
public final class TextInformationFrame extends Id3Frame {
    ...
    public /* synthetic */ TextInformationFrame(Parcel parcel, C1847Hh c1847Hh) {
        this(parcel);
    }
    ...
    public TextInformationFrame(String str, String str2, List<String> list) {
        super(str);
        C3M.A07(!list.isEmpty());
        this.A00 = str2;
        this.A02 = MetaExoPlayerCustomizedCollections.A02((String[]) list.toArray(new String[0]));
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null) {
            ...
            if (cls == cls2) {
                ...
                if (AbstractC15184a.A1E(super.A00, ((Id3Frame) textInformationFrame).A00)) {
                    boolean zA1E = AbstractC15184a.A1E(this.A00, textInformationFrame.A00);
                    if (A04[5].length() == 10) {
                        throw new RuntimeException();
                    }
                    A04[7] = "aAA9QqK2VvJ";
    ...
    public final int hashCode() {
        return (((((17 * 31) + super.A00.hashCode()) * 31) + (this.A00 != null ? this.A00.hashCode() : 0)) * 31) + this.A02.hashCode();
    }
