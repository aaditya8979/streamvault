...
public class N {
    ...
    public void a() {
        this.f29876a.a(B0.SESSION_CAPPED, null);
    }
    ...
    public void a(String str) {
        ...
        this.f29876a.a(B0.AD_CLICKED, map);
    }
    ...
    public void a(String str, int i10, String str2, Ed ed2) {
        ...
        this.f29876a.a(B0.SHOW_AD_FAILED, map);
    }
    ...
    public void a(String str, String str2) {
        ...
        this.f29876a.a(B0.AD_CLOSED, map);
    }
    ...
    public void a(String str, String str2, int i10, long j10, String str3, long j11, Map<String, Object> map, String str4) {
        ...
        this.f29876a.a(B0.AD_REWARDED, map2, j10);
    }
    ...
    public void a(String str, String str2, boolean z10) {
        ...
        map.put(IronSourceConstants.EVENTS_EXT1, z10 ? "true" : com.ironsource.mediationsdk.metadata.a.f32683h);
        map.put(IronSourceConstants.EVENTS_PROVIDER, "Mediation");
        this.f29876a.a(B0.CHECK_PLACEMENT_CAPPED, map);
    }

    public void a(boolean z10) {
        HashMap map = new HashMap();
        map.put("status", z10 ? "true" : com.ironsource.mediationsdk.metadata.a.f32683h);
        this.f29876a.a(B0.SHOW_AD_CHANCE, map);
    }
    ...
    public void b(String str, String str2) {
        ...
        this.f29876a.a(B0.PLACEMENT_CAPPED, map);
    }

    public void c(String str) {
        HashMap map = new HashMap();
        map.put("placement", str);
        this.f29876a.a(B0.AD_DISMISS_SCREEN, map);
    }
    ...
    public void d(String str) {
        ...
        this.f29876a.a(B0.AD_ENDED, map);
    }
    ...
    public void e(String str) {
        ...
        this.f29876a.a(B0.AD_INFO_CHANGED, map);
    }

    public void f(String str) {
        HashMap map = new HashMap();
        map.put("placement", str);
        this.f29876a.a(B0.AD_LEFT_APPLICATION, map);
    }
    ...
    public void g(String str) {
        ...
        this.f29876a.a(B0.AD_OPENED, map);
    }

    public void h(String str) {
        HashMap map = new HashMap();
        map.put("placement", str);
        this.f29876a.a(B0.AD_PRESENT_SCREEN, map);
    }
    ...
    public void i(String str) {
        ...
        this.f29876a.a(B0.AD_STARTED, map);
    }

    public void j(String str) {
        HashMap map = new HashMap();
        map.put("placement", str);
        this.f29876a.a(B0.AD_VIEW_BOUND, map);
    }
    ...
    public void k(String str) {
        ...
        this.f29876a.a(B0.AD_VISIBLE, map);
    }
}
