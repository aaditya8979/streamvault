...
public class I4 extends SQLiteOpenHelper {
    ...
    private static H4 f29590a = new H4();

    public I4(Context context) {
        super(context, Z7.f30778b, (SQLiteDatabase.CursorFactory) null, 1);
    }

    public static Cursor a(int i10) throws Throwable {
        SQLiteDatabase sQLiteDatabase = null;
        try {
            SQLiteDatabase sQLiteDatabaseA = f29590a.a(new I4(C4228r4.d().a()));
            try {
    ...
    public static void a() {
        ...
        try {
            sQLiteDatabaseA = f29590a.a(true, new I4(C4228r4.d().a()));
    ...
    public static void a(P5 p52) {
        SQLiteDatabase sQLiteDatabase = null;
        try {
            SQLiteDatabase sQLiteDatabaseA = f29590a.a(true, new I4(C4228r4.d().a()));
            try {
                ...
                String strB = p52.b();
                String strD = p52.d();
                contentValues.put(Z7.f30781e, strE);
                contentValues.put(Z7.f30782f, strB);
                contentValues.put(Z7.f30790n, strD);
                sQLiteDatabaseA.insert(Z7.f30779c, null, contentValues);
    ...
    public static P5 b(int i10) throws Throwable {
        ...
        SQLiteDatabase sQLiteDatabase = null;
        try {
            sQLiteDatabaseA = f29590a.a(new I4(C4228r4.d().a()));
        } catch (Throwable th2) {
            th = th2;
        }
        try {
    ...
    public static List<P5> b() {
        SQLiteDatabase sQLiteDatabaseA;
        I4 i42 = new I4(C4228r4.d().a());
        ArrayList arrayList = new ArrayList();
        SQLiteDatabase sQLiteDatabase = null;
        try {
            sQLiteDatabaseA = f29590a.a(i42);
        } catch (Throwable th2) {
            th = th2;
        }
        try {
    ...
    public static Cursor c() throws Throwable {
        ...
        SQLiteDatabase sQLiteDatabase = null;
        try {
            SQLiteDatabase sQLiteDatabaseA = f29590a.a(i42);
            try {
                Cursor cursorRawQuery = sQLiteDatabaseA.rawQuery("SELECT * FROM REPORTS;", null);
                sQLiteDatabaseA.close();
                return cursorRawQuery;
