...
public class d extends m implements BannerSmashListener, InterfaceC3940b2 {

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    private C4122l5 f32472n;

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    private C4122l5 f32473o;
    ...
    private C3976d2 f32476r;

    /* JADX INFO: renamed from: s, reason: collision with root package name */
    private com.ironsource.mediationsdk.e f32477s;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    private ISDemandOnlyBannerLayout f32478t;

    /* JADX INFO: renamed from: u, reason: collision with root package name */
    private final P8 f32479u;

    /* JADX INFO: renamed from: v, reason: collision with root package name */
    private final P8.a f32480v;

    public class a implements Runnable {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public final /* synthetic */ com.ironsource.mediationsdk.i f32481a;
        ...
        public void run() {
            ...
            IronLog.INTERNAL.verbose("auction waterfallString = " + this.f32481a.r());
            d.this.a(83510, new Object[][]{new Object[]{IronSourceConstants.EVENTS_EXT1, this.f32481a.r()}});
            Context applicationContext = ContextProvider.getInstance().getApplicationContext();
            d dVar = d.this;
            dVar.f32477s.a(applicationContext, this.f32481a, dVar);
        }
    }
    ...
    public d(String str, String str2, NetworkSettings networkSettings, long j10, AbstractAdapter abstractAdapter, com.ironsource.mediationsdk.e eVar) {
        ...
        this.f32474p = str;
        this.f32475q = str2;
        this.f32476r = new C3976d2();
        this.f32545a.initBannerForBidding(str, str2, this.f32547c, this);
        this.f32477s = eVar;
    }
    ...
    public void a(int i10, Object[][] objArr) {
        ...
        J9.i().a(new C5(i10, new JSONObject(mapJ)));
    }
    ...
    public void a(IronSourceError ironSourceError) {
        ...
        if (a(m.a.LOAD_IN_PROGRESS, m.a.NOT_LOADED)) {
            p();
            a(ironSourceError, C4122l5.a(this.f32472n));
            a(this.f32476r.b(), IronSourceUtils.a());
            if (t()) {
                return;
            }
            this.f32478t.getListener().a(l(), ironSourceError);
        }
    }

    private void a(IronSourceError ironSourceError, long j10) {
        if (ironSourceError.getErrorCode() == 606) {
            a(b.C0397b.f32458i, new Object[][]{new Object[]{IronSourceConstants.EVENTS_ERROR_CODE, Integer.valueOf(ironSourceError.getErrorCode())}, new Object[]{"duration", Long.valueOf(j10)}});
        } else {
    ...
    private void c(String str) {
        ...
        if (a(m.a.LOAD_IN_PROGRESS)) {
            if (str == null) {
                ...
                a(83302, (Object[][]) null);
                this.f32473o = new C4122l5();
                this.f32545a.initBannerForBidding(this.f32474p, this.f32475q, this.f32547c, this);
                this.f32545a.loadBannerForDemandOnlyForBidding(this.f32547c, str, this.f32478t, this);
            }
        }
    }

    private boolean t() {
        ISDemandOnlyBannerLayout iSDemandOnlyBannerLayout = this.f32478t;
    ...
    public void a(int i10, String str, int i11, String str2, long j10) {
        ...
        this.f32551g = null;
        this.f32552h = null;
        a(b.c.f32465g, new Object[][]{new Object[]{IronSourceConstants.EVENTS_ERROR_CODE, Integer.valueOf(i10)}, new Object[]{"reason", str}, new Object[]{"duration", Long.valueOf(j10)}, new Object[]{IronSourceConstants.EVENTS_EXT1, k()}});
        if (a(m.a.LOAD_IN_PROGRESS)) {
    ...
    public void a(@Nullable d.a aVar, int i10, long j10, int i11, @Nullable String str) {
        ...
        a(b.c.f32466h, new Object[][]{new Object[]{"duration", Long.valueOf(j10)}});
        a(b.c.f32468j, new Object[][]{new Object[]{IronSourceConstants.EVENTS_EXT1, c0396a.b()}});
        if (a(m.a.LOAD_IN_PROGRESS)) {
            if (c0396a.isEmpty()) {
                IronSourceError ironSourceError = new IronSourceError(b.C0397b.f32458i, "There is no available ad to load");
                ironLog.error("loadBanner - empty waterfall");
                a(ironSourceError);
                return;
            }
            C4157n2 c4157n2 = c0396a.get(0);
            this.f32476r.a(c4157n2.b());
            this.f32476r.c(c4157n2.h());
            this.f32476r.b(c4157n2.g());
    ...
    public void a(ISDemandOnlyBannerLayout iSDemandOnlyBannerLayout) {
        ...
        if (iSDemandOnlyBannerLayout == null) {
            a(b.c.f32463e, new Object[][]{new Object[]{"reason", "bannerLayout is null | state: " + k()}});
            return;
        }
        ...
        if (aVarA == aVar || aVarA == m.a.SHOW_IN_PROGRESS) {
            if (iSDemandOnlyBannerLayout.isDestroyed()) {
                a(b.c.f32463e, new Object[][]{new Object[]{"reason", "bannerLayout is destroyed | state: " + k()}});
                return;
            }
            String str = "banner layout in blocking state | state: " + k();
            iSDemandOnlyBannerLayout.getListener().a(l(), new IronSourceError(619, str));
            a(b.c.f32463e, new Object[][]{new Object[]{"reason", str}});
            return;
        }
        v();
        a(3002, (Object[][]) null);
        ...
        this.f32478t = iSDemandOnlyBannerLayout;
        this.f32472n = new C4122l5();
        w();
        if (this.f32477s.a()) {
            u();
        } else {
    ...
    public void a(ISDemandOnlyBannerLayout iSDemandOnlyBannerLayout, o oVar) {
        ...
        try {
            d.a aVar2 = (d.a) oVar.a(new C4213q5());
            C4157n2 c4157n2A = new a.C0396a(aVar2.h()).a(h());
            if (c4157n2A == null) {
            ...
            a(aVar2.f());
            a(83302, (Object[][]) null);
            this.f32476r.a(c4157n2A.b());
            this.f32472n = new C4122l5();
            w();
            this.f32545a.initBannerForBidding(this.f32474p, this.f32475q, this.f32547c, this);
            this.f32545a.loadBannerForDemandOnlyForBidding(this.f32547c, strK, iSDemandOnlyBannerLayout, this);
        } catch (Exception e10) {
            C4228r4.d().a(e10);
    ...
    public Map<String, Object> j() {
        ...
        try {
            if (t()) {
                ...
                com.ironsource.mediationsdk.l.a(map, this.f32478t.getSize());
            }
            ...
            C4228r4.d().a(e10);
            IronLog.INTERNAL.error("Instance: " + h() + Z7.f30794r + e10.getMessage());
        }
        return map;
    }
    ...
    public void onBannerAdClicked() {
        ...
        this.f32478t.getListener().a(l());
    }

    @Override // com.ironsource.mediationsdk.sdk.BannerSmashListener
    public void onBannerAdLeftApplication() {
        IronLog.INTERNAL.verbose("smash - " + s());
        a(b.C0397b.f32456g, (Object[][]) null);
        if (t()) {
            return;
        }
        this.f32478t.getListener().b(l());
    }

    @Override // com.ironsource.mediationsdk.sdk.BannerSmashListener
    public void onBannerAdLoadFailed(IronSourceError ironSourceError) {
        IronLog.INTERNAL.verbose("smash - " + s());
        a(83300, new Object[][]{new Object[]{IronSourceConstants.EVENTS_ERROR_CODE, Integer.valueOf(ironSourceError.getErrorCode())}, new Object[]{"reason", ironSourceError.getErrorMessage()}, new Object[]{"duration", Long.valueOf(C4122l5.a(this.f32473o))}});
        a(ironSourceError);
    }
    ...
    public void onBannerAdLoaded(View view, FrameLayout.LayoutParams layoutParams) {
        ...
        int iA = p82.a(aVar);
        a(b.c.f32462d, new Object[][]{new Object[]{"sessionDepth", Integer.valueOf(iA)}, new Object[]{"duration", Long.valueOf(C4122l5.a(this.f32473o))}});
        if (a(m.a.LOAD_IN_PROGRESS, m.a.LOADED)) {
            p();
            if (!t()) {
                this.f32478t.a(view, layoutParams);
            }
            a(3005, new Object[][]{new Object[]{"sessionDepth", Integer.valueOf(iA)}, new Object[]{"duration", Long.valueOf(C4122l5.a(this.f32472n))}});
            this.f32480v.b(aVar);
            a(this.f32476r.c(), IronSourceUtils.a());
            if (t()) {
                return;
            }
            this.f32478t.getListener().c(l());
        }
    }
    ...
    public void onBannerAdShown() {
        if (a(m.a.LOADED, m.a.SHOW_IN_PROGRESS)) {
            IronLog.INTERNAL.verbose("smash - " + s());
            a(3009, (Object[][]) null);
            a(this.f32476r.a(), IronSourceUtils.a());
            if (t()) {
                return;
            }
            this.f32478t.getListener().d(l());
        }
    }

    @Override // com.ironsource.mediationsdk.sdk.BannerSmashListener
    public void onBannerInitFailed(IronSourceError ironSourceError) {
        IronLog.INTERNAL.verbose("smash - " + s() + Z7.f30794r + ironSourceError.toString());
    }
    ...
    public void r() {
        ...
        if (abstractAdapter == null) {
            ...
            abstractAdapter.destroyBanner(this.f32547c);
        }
        a(3305, (Object[][]) null);
    ...
    public String s() {
        return this.f32546b.h().isMultipleInstances() ? this.f32546b.h().getProviderTypeForReflection() : this.f32546b.h().getProviderName();
    }
}
