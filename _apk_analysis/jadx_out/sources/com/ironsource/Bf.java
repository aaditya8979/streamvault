...
public final class Bf {
    ...
    @NotNull
    public static final Bf f28863a = new Bf();

    private Bf() {
    }

    private final JSONArray a() {
        ConcurrentHashMap<String, List<String>> concurrentHashMapD = Kf.f29735a.d();
        if (concurrentHashMapD.containsKey(com.ironsource.mediationsdk.metadata.a.f32681f)) {
            return new JSONArray((Collection) concurrentHashMapD.get(com.ironsource.mediationsdk.metadata.a.f32681f));
        }
        return null;
    }
    ...
    private final void a(D5 d52, Integer num, String str) throws JSONException {
        ...
        if (num != null) {
            ...
            if (jSONArrayA != null) {
                jSONObjectA.put(com.ironsource.mediationsdk.metadata.a.f32681f, jSONArrayA);
            }
        }
        if (str != null) {
    ...
    public final void a(@NotNull String str) throws JSONException {
        tn.p.k(str, "errorReason");
        a(D5.TEST_SUITE_WEB_CONTROLLER_FAILED_TO_LOAD, Integer.valueOf(IronSourceConstants.errorCode_TEST_SUITE_WEB_CONTROLLER_NOT_LOADED), str);
    }
