...
public final class ft extends gl {
    ...
    private static char[] f2114 = {'c', 'o', 'm', '.', 'i', 'r', 'n', 's', 'u', 'e', 'a', 'd', 'q', 'l', 't', 'y', 'k', 'I', 'S', 'A', 'Q', 'h', 'v', 'f', 'g'};
    ...
    /* JADX INFO: renamed from: ﾇ, reason: contains not printable characters */
    private static String m6273(String str, int i10, byte b10) {
        String str2;
    ...
    public final String mo6277() {
        ...
        String strIntern = m6273("\u000b\f\u0011\f\u0014\u000b\u0006\u0005\f\u000b\f\u0015\u0004\n\u0099", mode, (byte) maximumDrawingCacheSize).intern();
        int i11 = f2115 + 89;
        f2116 = i11 % 128;
        if ((i11 % 2 == 0 ? (char) 25 : ',') != 25) {
            return strIntern;
        }
        throw null;
    }
