...
public final class b {
    ...
    private b(@Nullable String str, @Nullable String str2, long j10, long j11, @Nullable TtmlStyle ttmlStyle, @Nullable String[] strArr, String str3, @Nullable String str4, @Nullable b bVar) {
        this.tag = str;
        this.text = str2;
        this.imageId = str4;
    ...
    private void applyStyleToOutput(Map<String, TtmlStyle> map, Cue.Builder builder, int i10, int i11, int i12) {
        TtmlStyle ttmlStyleResolveStyle = d.resolveStyle(this.style, this.styleIds, map);
        ...
        if (ttmlStyleResolveStyle != null) {
            d.applyStylesToSpan(spannableStringBuilder2, i10, i11, ttmlStyleResolveStyle, this.parent, map, i12);
    ...
    public static b buildTextNode(String str) {
        return new b(null, d.applyTextElementSpacePolicy(str), -9223372036854775807L, -9223372036854775807L, null, null, "", null, null);
    }
    ...
    private void traverseForImage(long j10, String str, List<Pair<String, String>> list) {
        ...
        if (isActive(j10) && "div".equals(this.tag) && this.imageId != null) {
    ...
    private void traverseForStyle(long j10, Map<String, TtmlStyle> map, Map<String, c> map2, String str, Map<String, Cue.Builder> map3) {
        int i10;
        if (isActive(j10)) {
            ...
            while (true) {
                ...
                if (iIntValue != iIntValue2) {
                    applyStyleToOutput(map, (Cue.Builder) Assertions.checkNotNull(map3.get(key)), iIntValue, iIntValue2, ((c) Assertions.checkNotNull(map2.get(str2))).verticalType);
                }
            }
    ...
    private void traverseForText(long j10, boolean z10, String str, Map<String, Cue.Builder> map) {
        ...
        if (isActive(j10)) {
            ...
            boolean zEquals = "p".equals(this.tag);
            for (int i10 = 0; i10 < getChildCount(); i10++) {
                getChild(i10).traverseForText(j10, z10 || zEquals, str, map);
            }
            if (zEquals) {
                d.endParagraph(getRegionOutputText(str, map));
            }
    ...
    public List<Cue> getCues(long j10, Map<String, TtmlStyle> map, Map<String, c> map2, Map<String, String> map3) {
        ...
        for (Pair<String, String> pair : arrayList) {
            ...
            if (str != null) {
                ...
                arrayList2.add(new Cue.Builder().setBitmap(bitmapDecodeByteArray).setPosition(cVar.position).setPositionAnchor(0).setLine(cVar.line, 0).setLineAnchor(cVar.lineAnchor).setSize(cVar.width).setBitmapHeight(cVar.height).setVerticalType(cVar.verticalType).build());
            }
        }
        for (Map.Entry entry : treeMap.entrySet()) {
            ...
            builder.setLine(cVar2.line, cVar2.lineType);
            builder.setLineAnchor(cVar2.lineAnchor);
            builder.setPosition(cVar2.position);
            builder.setSize(cVar2.width);
            builder.setTextSize(cVar2.textSize, cVar2.textSizeType);
            builder.setVerticalType(cVar2.verticalType);
    ...
    public boolean isActive(long j10) {
        ...
        return (j11 == -9223372036854775807L && this.endTimeUs == -9223372036854775807L) || (j11 <= j10 && this.endTimeUs == -9223372036854775807L) || ((j11 == -9223372036854775807L && j10 < this.endTimeUs) || (j11 <= j10 && j10 < this.endTimeUs));
    }
}
