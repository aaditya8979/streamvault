...
public class d extends InternalGAMInterstitialAd {
    ...
    @Nullable
    private AdManagerInterstitialAd f85269a;

    public static final class a extends AdManagerInterstitialAdLoadCallback {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        @NonNull
        private final d f85270a;

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        @NonNull
        private final InternalLoadListener f85271b;

        public a(@NonNull d dVar, @NonNull InternalLoadListener internalLoadListener) {
            this.f85270a = dVar;
            this.f85271b = internalLoadListener;
        }

        @Override // com.google.android.gms.ads.AdLoadCallback
        public void onAdFailedToLoad(@NonNull LoadAdError loadAdError) {
            this.f85271b.onAdLoadFailed(this.f85270a, new BMError(BMError.NoFill, loadAdError.getCode(), loadAdError.getMessage()));
        }

        @Override // com.google.android.gms.ads.AdLoadCallback
        public void onAdLoaded(@NonNull AdManagerInterstitialAd adManagerInterstitialAd) {
            this.f85270a.f85269a = adManagerInterstitialAd;
            this.f85270a.onAdLoaded();
            this.f85271b.onAdLoaded(this.f85270a);
        }
    }
    ...
    public void destroyAd() {
        AdManagerInterstitialAd adManagerInterstitialAd = this.f85269a;
    ...
    public void loadAd(@NonNull Context context, @NonNull InternalLoadListener internalLoadListener) {
        AdManagerInterstitialAd.load(context, getAdUnitId(), th.a.a(getGamLoader(), getGamUnitData()), new a(this, internalLoadListener));
    }
