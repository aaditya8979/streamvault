...
public final class q {
    ...
    public static final Object f3664a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static final Object[][] f3665b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public static final Object[][] f3666c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public static final Object[][] f3667d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public static final Object[][] f3668e;
    ...
    public static String a(String str) throws NotFoundException {
        ...
        for (Object[] objArr : f3665b) {
            if (objArr[0].equals(strSubstring)) {
                Object obj = objArr[1];
                return obj == f3664a ? c(2, ((Integer) objArr[2]).intValue(), str) : b(2, ((Integer) obj).intValue(), str);
            }
        }
        if (str.length() < 3) {
            throw NotFoundException.getNotFoundInstance();
        ...
        for (Object[] objArr2 : f3666c) {
            if (objArr2[0].equals(strSubstring2)) {
                Object obj2 = objArr2[1];
                return obj2 == f3664a ? c(3, ((Integer) objArr2[2]).intValue(), str) : b(3, ((Integer) obj2).intValue(), str);
            }
        }
        for (Object[] objArr3 : f3667d) {
            if (objArr3[0].equals(strSubstring2)) {
                Object obj3 = objArr3[1];
                return obj3 == f3664a ? c(4, ((Integer) objArr3[2]).intValue(), str) : b(4, ((Integer) obj3).intValue(), str);
            }
        }
        if (str.length() < 4) {
            throw NotFoundException.getNotFoundInstance();
        ...
        for (Object[] objArr4 : f3668e) {
            if (objArr4[0].equals(strSubstring3)) {
                Object obj4 = objArr4[1];
                return obj4 == f3664a ? c(4, ((Integer) objArr4[2]).intValue(), str) : b(4, ((Integer) obj4).intValue(), str);
            }
        }
        throw NotFoundException.getNotFoundInstance();
    }
