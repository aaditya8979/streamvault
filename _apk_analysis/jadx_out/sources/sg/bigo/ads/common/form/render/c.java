...
public final class c {
    ...
    private static double a(int i10, int i11) {
        ...
        return (d10 < 0.25d || d10 > 1.0d) ? d10 < 0.25d ? 0.25d : 1.0d : d10;
    }
        ...
        if (viewFindViewById != null) {
            viewFindViewById.setOnClickListener(new View.OnClickListener() { // from class: sg.bigo.ads.common.form.render.c.4
                ...
                public final void onClick(View view2) {
                    privacyCheckBox.a(!r2.f82596a);
                }
            });
        }
        e.b bVarL = eVar.l();
        String str = bVarL != null ? bVarL.f81796a : "";
        final String str2 = bVarL != null ? bVarL.f81797b : "";
        String strReplace = "  ".concat(String.valueOf(sg.bigo.ads.common.utils.a.b(mixtureTextView.getContext(), R.string.bigo_ad_form_privacy_content, sg.bigo.ads.common.form.a.f82031b))).replace("{company_name}", str);
    ...
    public static void a(@NonNull ViewGroup viewGroup, Context context, @NonNull e eVar, a aVar, int i10) {
