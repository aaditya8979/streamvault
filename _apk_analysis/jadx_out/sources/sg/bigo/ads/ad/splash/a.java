...
public final class a {
    ...
    public static boolean f81560a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static boolean f81561b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static List<ObjectAnimator> f81562c;
    ...
    public static void a() {
        List<ObjectAnimator> list = f81562c;
        if (list != null) {
    ...
    public static void a(int i10, @NonNull sg.bigo.ads.ad.b.b bVar, @NonNull final ViewGroup viewGroup) {
        final int iA = i10 != 2 ? i10 != 3 ? i10 != 4 ? -1 : r.a(bVar, -1) : -7829368 : ViewCompat.MEASURED_STATE_MASK;
        if (iA != -1) {
    ...
    public static void a(View view, float f10) {
        ...
        ObjectAnimator objectAnimatorOfFloat3 = ObjectAnimator.ofFloat(view, "translationY", f10, -fA);
    ...
    */
    ...
    public static void a(@NonNull final ViewGroup viewGroup, final int i10) {
        ...
        viewGroup.post(new Runnable() { // from class: sg.bigo.ads.ad.splash.a.1
            @Override // java.lang.Runnable
            public final void run() {
                a.a(viewFindViewById, new b.e() { // from class: sg.bigo.ads.ad.splash.a.1.1
                    @Override // sg.bigo.ads.common.utils.b.e, android.animation.Animator.AnimatorListener
                    public final void onAnimationEnd(Animator animator) {
    ...
    private static void a(@NonNull final ViewGroup viewGroup, boolean z10) {
    ...
    public static void a(@NonNull final sg.bigo.ads.ad.b.b bVar, final ValueCallback<Bitmap> valueCallback) {
        n nVar = (n) bVar.f();
        if (!nVar.aR()) {
            ...
            if (q.a((CharSequence) strAT)) {
                ...
                sg.bigo.ads.common.p.e.a(bVar.f80021b.f81864e, strAT, nVar.al(), new g() { // from class: sg.bigo.ads.ad.splash.a.7
        ...
        String strB = o.b(bVar.f80021b.f81864e, nVar.aN());
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static void a(sg.bigo.ads.ad.interstitial.AdCountDownButton r4, int r5) {
        /*
            r0 = 1
            r1 = 2
            r2 = -1
        ...
        L21:
            if (r2 == r3) goto L30
            int r2 = sg.bigo.ads.R.layout.bigo_ad_item_inter_countdown_bg
            r4.a(r2)
            r4.setCloseImageResource(r3)
            if (r5 == r1) goto L30
            r4.setShowCloseButtonInCountdown(r0)
        L30:
            return
        */
    ...
    public static void b(ObjectAnimator objectAnimator) {
        if (f81562c == null) {
            f81562c = new ArrayList();
        }
        f81562c.add(objectAnimator);
    }
    ...
    public static void b(@NonNull ViewGroup viewGroup, int i10) {
        if (i10 == 2) {
    ...
    private static void b(@NonNull ViewGroup viewGroup, boolean z10) {
        int i10 = R.layout.bigo_ad_splash_item_click_guide;
        if (z10) {
            i10 = R.layout.bigo_ad_splash_endpage_item_click_guide;
        }
        View viewA = sg.bigo.ads.common.utils.a.a(viewGroup.getContext(), i10, viewGroup, false);
        if (viewA != null) {
            viewGroup.addView(viewA);
    ...
    public static /* synthetic */ void c(final ViewGroup viewGroup, int i10) {
        ...
        if (viewFindViewById != null) {
            ...
            ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(viewFindViewById, "translationY", 0.0f, fA2, fA2 * (-2.0f), 0.0f, 0.0f);
