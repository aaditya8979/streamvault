...
public class i extends g {
    ...
    public i(@NonNull sg.bigo.ads.ad.b.b bVar) {
        super(bVar);
    }

    public static /* synthetic */ void a(i iVar) {
        if (((b) iVar).f80637y == null || iVar.f80608w) {
            return;
        }
        final boolean zV = iVar.v();
        final boolean[] zArr = {false, false};
        Context context = ((b) iVar).f80637y.getContext();
        ...
        transitionSet.addListener((Transition.TransitionListener) new sg.bigo.ads.common.h() { // from class: sg.bigo.ads.ad.interstitial.d.i.3
            ...
            public final void onTransitionStart(final Transition transition) {
                sg.bigo.ads.common.w.b.a(((b) i.this).f80637y, -1, new b.a() { // from class: sg.bigo.ads.ad.interstitial.d.i.3.1
                ...
                sg.bigo.ads.ad.interstitial.multi_img.e.a(button, button, c0989aU.f80630a, zArr, zV, transition.getDuration());
            }
        });
        transitionSet.setDuration(300L);
        TransitionManager.beginDelayedTransition(iVar.f80603r, transitionSet);
        TextView textView = iVar.E;
        if (textView != null) {
            sg.bigo.ads.common.w.b.a(textView.getCurrentTextColor(), sg.bigo.ads.ad.interstitial.b.f80348a.f80354f, transitionSet.getDuration(), iVar.E);
        }
        TextView textView2 = iVar.F;
        if (textView2 != null) {
            sg.bigo.ads.common.w.b.a(textView2.getCurrentTextColor(), sg.bigo.ads.ad.interstitial.b.f80348a.f80355g, transitionSet.getDuration(), iVar.F);
        }
        ((b) iVar).f80637y.setOutlineProvider(new sg.bigo.ads.common.view.b.b(sg.bigo.ads.common.utils.e.a(context, 12)));
        ((b) iVar).f80637y.setPadding(iA, iA, iA, iA);
        ((b) iVar).f80637y.getLayoutParams().width = sg.bigo.ads.common.utils.e.a(((b) iVar).f80637y.getContext(), 288);
        ...
        int id2 = R.id.inter_text_layout;
        ...
        bVar.b(((b) iVar).f80637y);
        bVar.a(iVar.G);
        bVar.a(iVar.I);
        ((b) iVar).f80637y.requestLayout();
    }

    @Override // sg.bigo.ads.ad.interstitial.d.b
    public final void A() {
        if (((b) this).f80637y == null) {
            return;
        }
        ...
        a(iMax, new Runnable() { // from class: sg.bigo.ads.ad.interstitial.d.i.2
            @Override // java.lang.Runnable
            public final void run() {
                ((b) i.this).f80637y.post(new Runnable() { // from class: sg.bigo.ads.ad.interstitial.d.i.2.1
                    @Override // java.lang.Runnable
                    public final void run() {
                        if (i.this.N != null) {
                            ((RelativeLayout.LayoutParams) i.this.N.getLayoutParams()).width = (((b) i.this).f80637y.getMeasuredWidth() - ((b) i.this).f80637y.getPaddingLeft()) - ((b) i.this).f80637y.getPaddingRight();
                            i.this.N.requestLayout();
                        }
                        AnonymousClass2 anonymousClass2 = AnonymousClass2.this;
                        ((b) i.this).f80637y.post(runnable);
                    }
                });
            }
        });
