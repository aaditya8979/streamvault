...
public final class k extends e {
    ...
    public final List<View> a(@NonNull a aVar) {
        if (this.f80881b.size() != 1) {
            return super.a(aVar);
        }
        View viewA = sg.bigo.ads.common.utils.a.a(this.f80883d, R.layout.bigo_ad_layout_word_icon, this.f80880a, false);
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(-1, -2);
        layoutParams.gravity = 17;
        FrameLayout frameLayout = new FrameLayout(this.f80883d);
        frameLayout.setBackgroundColor(ViewCompat.MEASURED_STATE_MASK);
        View viewA2 = sg.bigo.ads.common.utils.a.a(this.f80883d, R.layout.bigo_ad_layout_word_icon_first_page, frameLayout, false);
        u.a(viewA2, frameLayout, layoutParams, -1);
        u.a(viewA, frameLayout, layoutParams, -1);
        u.a(frameLayout, this.f80880a, new LinearLayout.LayoutParams(-1, sg.bigo.ads.common.utils.e.a(this.f80883d, 32)), -1);
        Handler handler = new Handler(Looper.getMainLooper());
        c.AnonymousClass7 anonymousClass7 = new Runnable() { // from class: sg.bigo.ads.ad.interstitial.c.7

            /* JADX INFO: renamed from: a */
            public boolean f80401a = true;

            /* JADX INFO: renamed from: b */
            public final /* synthetic */ WeakReference f80402b;

            /* JADX INFO: renamed from: c */
            public final /* synthetic */ WeakReference f80403c;

            /* JADX INFO: renamed from: d */
            public final /* synthetic */ Handler f80404d;

            /* JADX INFO: renamed from: sg.bigo.ads.ad.interstitial.c$7$1 */
            public class AnonymousClass1 extends AnimatorListenerAdapter {

                /* JADX INFO: renamed from: a */
                public final /* synthetic */ View f80405a;
            ...
            public final void run() {
                ...
                animatorSet2.start();
                boolean z11 = !this.f80401a;
                this.f80401a = z11;
                handler.postDelayed(this, z11 ? 1000L : 2000L);
            }
        };
    ...
    public final void a(TextView textView) {
        if (textView != null) {
            textView.setMaxWidth(this.f80883d.getResources().getDisplayMetrics().widthPixels - sg.bigo.ads.common.utils.e.a(this.f80883d, 60));
        }
    }
}
