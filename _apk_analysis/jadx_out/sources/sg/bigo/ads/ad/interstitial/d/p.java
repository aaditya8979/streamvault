...
public final class p extends o {
    public p(@NonNull sg.bigo.ads.ad.b.b bVar) {
        super(bVar);
    }
    ...
    public final void b(int i10) {
        ...
        final View viewFindViewById = this.f80602q.findViewById(R.id.inter_btn_cta_layout);
        final Button button = (Button) this.f80602q.findViewById(R.id.inter_btn_cta);
        if (button == null) {
            return;
        }
        button.postDelayed(new Runnable() { // from class: sg.bigo.ads.ad.interstitial.d.p.1
            ...
            public final void run() {
                if (sg.bigo.ads.ad.c.a((sg.bigo.ads.ad.c) ((sg.bigo.ads.ad.interstitial.t) p.this).f81420c)) {
                    return;
                }
                a.C0989a c0989aU = p.this.u();
