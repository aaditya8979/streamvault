...
public final class a {
    ...
    @NonNull
    public final RealtimeBlurLinearLayout f80793a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    @NonNull
    public final ViewFlow f80794b;
    ...
    private a(RealtimeBlurLinearLayout realtimeBlurLinearLayout, int i10) {
        this.f80793a = realtimeBlurLinearLayout;
        this.f80794b = (ViewFlow) realtimeBlurLinearLayout.findViewById(R.id.inter_icon_ads_view_flow);
        this.f80795c = i10;
    }
    ...
    public static a a(Context context, @NonNull sg.bigo.ads.ad.interstitial.e.a.b bVar, @NonNull List<NativeAd> list, List<NativeAd> list2) {
        ...
        aVar.f80794b.setViewStyle(3);
        aVar.f80794b.setDividerWidth(0);
        if (!bVar.a()) {
            switch (bVar.e()) {
                case 1:
                case 3:
                    aVar.f80794b.setContentMaxWidthSpace(sg.bigo.ads.common.utils.e.a(context, 20));
                    break;
                case 2:
                case 4:
                    aVar.f80794b.setContentMaxWidthSpace(0);
                    break;
                case 5:
                case 6:
                    aVar.f80794b.setContentMaxWidthSpace(sg.bigo.ads.common.utils.e.a(context, 47));
                    ((ViewGroup.MarginLayoutParams) aVar.f80794b.getLayoutParams()).bottomMargin = 0;
                    break;
            }
        } else {
            aVar.f80794b.setContentMaxWidthSpace(0);
            ((LinearLayout.LayoutParams) aVar.f80794b.getLayoutParams()).bottomMargin = 0;
        }
        list2.clear();
        while (!sg.bigo.ads.common.utils.k.a((Collection) list)) {
            ...
            bVar2.f82684e = 48;
            bVar2.f82683d = 3;
            aVar.f80794b.addView(aVar2, bVar2);
        }
        return aVar;
    }
}
