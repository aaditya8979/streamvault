...
public final class r extends m {
    ...
    public final void J() {
        ...
        if (this.f80604s.f81494h) {
            ...
            sg.bigo.ads.ad.b.a.a(this.f80602q, this.G, 8, ((sg.bigo.ads.ad.interstitial.t) this).f81420c, this.f80604s.f81495i);
        } else {
            sg.bigo.ads.ad.b.a.a(this.f80602q, this.G, 8, sg.bigo.ads.ad.interstitial.q.F, 0);
        }
    ...
    public final void b(int i10) {
        super.b(i10);
        final int iA = sg.bigo.ads.common.utils.e.a(this.f80602q.getContext(), 16);
        final int iA2 = sg.bigo.ads.common.utils.e.a(this.f80602q.getContext(), 40);
        final int iA3 = sg.bigo.ads.common.utils.e.a(this.f80602q.getContext(), 72);
        final boolean zV = v();
        if (this.f80606u != null) {
            final boolean[] zArr = {false, false};
            this.f80602q.postDelayed(new Runnable() { // from class: sg.bigo.ads.ad.interstitial.d.r.1
                @Override // java.lang.Runnable
                public final void run() {
                    if (sg.bigo.ads.ad.c.a((sg.bigo.ads.ad.c) ((sg.bigo.ads.ad.interstitial.t) r.this).f81420c)) {
                        return;
                    }
                    r.b(r.this);
                    final a.C0989a c0989aU = r.this.u();
                    ...
                    TransitionManager.beginDelayedTransition(r.this.f80603r, transitionSet);
                    ...
                    r.this.M.setTextColor(c0989aU.f80630a);
                    ...
                    marginLayoutParams2.topMargin = sg.bigo.ads.common.utils.e.a(r.this.f80602q.getContext(), 4);
                    ...
                    r rVar = r.this;
                    rVar.f80600o.a(rVar.L);
                    r rVar2 = r.this;
                    rVar2.f80600o.a(rVar2.N);
                    r.this.L.setTextColor(sg.bigo.ads.ad.interstitial.d.f80589b);
                    r.this.N.setTextColor(sg.bigo.ads.ad.interstitial.d.f80589b);
                }
