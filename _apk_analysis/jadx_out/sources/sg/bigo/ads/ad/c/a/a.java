...
public abstract class a {
    ...
    public static final p f80062f = new p(Sdk.SDKError.Reason.WEBVIEW_ERROR_VALUE, 50);

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    public static final p f80063g = new p(300, 250);

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    @NonNull
    public final sg.bigo.ads.ad.b.b f80064a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    @NonNull
    public FrameLayout f80065b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public Context f80066c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public MediaView f80067d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public Bitmap f80068e;

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    private C0969a f80069h;

    /* JADX INFO: renamed from: i, reason: collision with root package name */
    private Bitmap f80070i;
        ...
        public final /* synthetic */ void onReceiveValue(Bitmap bitmap) {
            ...
            d.b(new Runnable() { // from class: sg.bigo.ads.ad.c.a.a.2.1
                ...
                public final void run() {
                    a aVar = a.this;
                    if (aVar.f80066c == null) {
                        return;
                    }
                    MediaView mediaView = aVar.f80067d;
                    View viewFindViewWithTag = mediaView != null ? mediaView.findViewWithTag("blur_image_view") : null;
                    if (viewFindViewWithTag instanceof C0969a) {
                        a.this.f80069h = (C0969a) viewFindViewWithTag;
                    } else {
                        a aVar2 = a.this;
                        a aVar3 = a.this;
                        aVar2.f80069h = aVar3.new C0969a(aVar3.f80066c);
                        a.this.f80069h.setLayoutParams(new ViewGroup.LayoutParams(-1, -1));
                        u.a(a.this.f80069h, a.this.f80067d, null, 0);
                        a.this.f80069h.setTag("blur_image_view");
                    }
                    if (a.this.f80069h != null) {
                        a.this.f80069h.setScaleType(ImageView.ScaleType.CENTER_CROP);
                        Bitmap bitmap3 = bitmap2;
                        sg.bigo.ads.common.utils.d.b(a.this.f80069h.getContext(), (bitmap3 == null || bitmap3.getWidth() <= 0 || bitmap2.getHeight() <= 0) ? a.this.g() : bitmap2, new ValueCallback<Bitmap>() { // from class: sg.bigo.ads.ad.c.a.a.2.1.1
                            @Override // android.webkit.ValueCallback
                            public final /* synthetic */ void onReceiveValue(Bitmap bitmap4) {
                                Bitmap bitmap5 = bitmap4;
                                if (a.this.f80069h != null) {
                                    a.this.f80069h.setImageBitmap(bitmap5);
                                }
                            }
                        });
                    }
    ...
    public class C0969a extends ImageView {
    ...
    public a(@NonNull sg.bigo.ads.ad.b.b bVar, @NonNull Context context) {
        this.f80064a = bVar;
        this.f80066c = context;
        d();
    }

    public static a a(@NonNull sg.bigo.ads.ad.b.b bVar, @NonNull Context context, h.b bVar2) {
        return f80063g.equals(new p(bVar2 != null ? bVar2.a() : 0, bVar2 != null ? bVar2.b() : 0)) ? new b(bVar, context) : new c(bVar, context);
    }
    ...
    public static /* synthetic */ void a(a aVar, ViewGroup viewGroup, View view, MediaView mediaView, ImageView imageView, int i10) {
        ...
        sg.bigo.ads.ad.b.b bVar = aVar.f80064a;
        bVar.H = i10;
    ...
    public synchronized void a(sg.bigo.ads.core.a.a aVar, final ValueCallback<Bitmap> valueCallback) {
        ...
        if (q.a((CharSequence) strAT)) {
            ...
            e.a(this.f80064a.f80021b.f81864e, strAT, aVar.al(), new g() { // from class: sg.bigo.ads.ad.c.a.a.4
    ...
    public final void a(View view, boolean z10) {
        FrameLayout frameLayout = this.f80065b;
    ...
    public final synchronized void a(final ValueCallback<Bitmap> valueCallback, boolean z10) {
        if (z10) {
            Bitmap bitmap = this.f80070i;
            if (bitmap != null) {
                valueCallback.onReceiveValue(bitmap);
                return;
            }
        }
        final sg.bigo.ads.core.a.a aVar = (sg.bigo.ads.core.a.a) this.f80064a.f();
        if (z10) {
            a(aVar, valueCallback);
            return;
        }
        String strB = o.b(this.f80064a.f80021b.f81864e, aVar.aN());
        if (q.a((CharSequence) strB)) {
            ...
            d.a(3, new Runnable() { // from class: sg.bigo.ads.ad.c.a.a.3
                @Override // java.lang.Runnable
                public final void run() {
                    Bitmap bitmapA = sg.bigo.ads.common.utils.d.a(Uri.parse(path).getPath(), a.this.f80064a.f80021b.f81864e);
                    if (bitmapA == null) {
                        a.this.a(aVar, (ValueCallback<Bitmap>) valueCallback);
                    } else {
                        a.this.f80070i = bitmapA;
    ...
    public final void a(final ImageView imageView, final int i10) {
        ...
        final View viewA = sg.bigo.ads.common.utils.a.a(this.f80066c, a(), this.f80065b, true);
        d.b(new Runnable() { // from class: sg.bigo.ads.ad.c.a.a.1
            ...
            public final void run() {
                ...
                if (view != null) {
                    a aVar = a.this;
                    a.a(aVar, aVar.f80065b, view, aVar.f80067d, imageView, i10);
                }
            }
        });
    }
    ...
    public void b(int i10) {
        ...
        if (frameLayout != null && (button = (Button) frameLayout.findViewById(R.id.inter_btn_cta)) != null) {
            new Handler(Looper.getMainLooper()).post(new Runnable() { // from class: sg.bigo.ads.ad.c.a.1
                ...
                public final /* synthetic */ Button f80047a;
        ...
        if (i10 == 1) {
            sg.bigo.ads.ad.c.a.a(this.f80065b, 2000L, 6);
        } else {
            if (i10 != 2) {
                return;
            }
            sg.bigo.ads.ad.c.a.a(this.f80065b, 2000L, 3, c());
        }
    }
    ...
    public final Bitmap g() {
        ...
        int height;
        Bitmap bitmapA;
        Bitmap bitmap2 = this.f80068e;
        if (bitmap2 != null) {
            return bitmap2;
        }
        BitmapDrawable bitmapDrawable = (BitmapDrawable) sg.bigo.ads.common.utils.a.a(this.f80066c, R.drawable.bigo_ad_default_base_image);
        ...
        sg.bigo.ads.ad.b.b bVar = this.f80064a;
    ...
    public final void h() {
        ...
        MediaView mediaView = this.f80067d;
        if (mediaView != null) {
            u.b(mediaView);
            this.f80067d.c();
            this.f80067d = null;
