...
public final class f implements Seeker {
    ...
    @Nullable
    public static f create(long j10, long j11, MpegAudioUtil.Header header, ParsableByteArray parsableByteArray) {
        int unsignedByte;
        ...
        return new f(jArr, jArr2, jScaleLargeTimestamp, j13, header.bitrate);
    }
