...
public final class RealImageLoader$execute$2$job$1 extends SuspendLambda implements p<l0, c<? super g>, Object> {
    ...
    public final Object mo2invoke(@NotNull l0 l0Var, @Nullable c<? super g> cVar) {
        return ((RealImageLoader$execute$2$job$1) create(l0Var, cVar)).invokeSuspend(r.f5635a);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i10 == 0) {
            ...
            f fVar = this.$request;
            this.label = 1;
            obj = realImageLoader.h(fVar, 1, this);
            if (obj == objG) {
                return objG;
            }
        } else {
