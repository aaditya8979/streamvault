...
public final class e {
    ...
    public boolean populate(ExtractorInput extractorInput, boolean z10) throws IOException {
        ...
        if (!ExtractorUtil.peekFullyQuietly(extractorInput, this.scratch.getData(), 0, 27, z10) || this.scratch.readUnsignedInt() != 1332176723) {
            return false;
        }
        ...
        if (!ExtractorUtil.peekFullyQuietly(extractorInput, this.scratch.getData(), 0, this.pageSegmentCount, z10)) {
            return false;
        }
    ...
    */
    public boolean skipToNextPage(io.bidmachine.media3.extractor.ExtractorInput r9, long r10) throws java.io.IOException {
        /*
            r8 = this;
        ...
        L11:
            ...
            io.bidmachine.media3.common.util.ParsableByteArray r0 = r8.scratch
            r3 = 4
            r0.reset(r3)
        L1a:
            r4 = -1
            ...
            if (r4 >= 0) goto L51
        L2b:
            io.bidmachine.media3.common.util.ParsableByteArray r4 = r8.scratch
            byte[] r4 = r4.getData()
            boolean r4 = io.bidmachine.media3.extractor.ExtractorUtil.peekFullyQuietly(r9, r4, r1, r3, r2)
            if (r4 == 0) goto L51
            io.bidmachine.media3.common.util.ParsableByteArray r0 = r8.scratch
            r0.setPosition(r1)
            io.bidmachine.media3.common.util.ParsableByteArray r0 = r8.scratch
        ...
        L63:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: vj.e.skipToNextPage(io.bidmachine.media3.extractor.ExtractorInput, long):boolean");
    }
}
