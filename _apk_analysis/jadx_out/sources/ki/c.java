...
/* JADX INFO: compiled from: CustomSpanBundler.java */
...
public final class c {
    ...
    private static Bundle spanToBundle(Spanned spanned, Object obj, int i10, @Nullable Bundle bundle) {
    ...
    public static void unbundleAndApplyCustomSpan(Bundle bundle, Spannable spannable) {
        ...
        if (i13 == 1) {
            spannable.setSpan(RubySpan.fromBundle((Bundle) Assertions.checkNotNull(bundle2)), i10, i11, i12);
        } else if (i13 == 2) {
            spannable.setSpan(TextEmphasisSpan.fromBundle((Bundle) Assertions.checkNotNull(bundle2)), i10, i11, i12);
        } else {
            if (i13 != 3) {
                return;
            }
            spannable.setSpan(new HorizontalTextInVerticalContextSpan(), i10, i11, i12);
        }
    }
}
