...
public final class Path implements Comparable<Path> {
    ...
    public final Path parent() {
        Path path;
        if (p.f(getBytes$okio(), okio.internal.Path.DOT) || p.f(getBytes$okio(), okio.internal.Path.SLASH) || p.f(getBytes$okio(), okio.internal.Path.BACKSLASH) || okio.internal.Path.lastSegmentIsDotDot(this)) {
            return null;
        }
        int indexOfLastSlash = okio.internal.Path.getIndexOfLastSlash(this);
    ...
    public final Path resolve(@NotNull String str, boolean z10) {
        p.k(str, "child");
        return okio.internal.Path.commonResolve(this, okio.internal.Path.toPath(new Buffer().writeUtf8(str), false), z10);
    }
    ...
    public final Path resolve(@NotNull ByteString byteString, boolean z10) {
        p.k(byteString, "child");
        return okio.internal.Path.commonResolve(this, okio.internal.Path.toPath(new Buffer().write(byteString), false), z10);
    }
    ...
    public final Path resolve(@NotNull Path path, boolean z10) {
        p.k(path, "child");
        return okio.internal.Path.commonResolve(this, path, z10);
    }
