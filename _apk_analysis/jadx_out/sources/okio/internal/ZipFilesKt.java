...
public final class ZipFilesKt {
    ...
    private static final Map<Path, ZipEntry> buildIndex(List<ZipEntry> list) {
        ...
        for (ZipEntry zipEntry : f0.X0(list, new Comparator() { // from class: okio.internal.ZipFilesKt$buildIndex$$inlined$sortedBy$1
    ...
    public static /* synthetic */ ZipFileSystem openZip$default(Path path, FileSystem fileSystem, l lVar, int i10, Object obj) throws IOException {
        if ((i10 & 4) != 0) {
            lVar = new l<ZipEntry, Boolean>() { // from class: okio.internal.ZipFilesKt.openZip.1
                @Override // sn.l
                @NotNull
    ...
    public static final ZipEntry readEntry(@NotNull final BufferedSource bufferedSource) throws IOException {
        ...
        readExtra(bufferedSource, shortLe4, new sn.p<Integer, Long, r>() { // from class: okio.internal.ZipFilesKt.readEntry.1
    ...
    private static final FileMetadata readOrSkipLocalHeader(final BufferedSource bufferedSource, FileMetadata fileMetadata) throws IOException {
        ...
        readExtra(bufferedSource, shortLe3, new sn.p<Integer, Long, r>() { // from class: okio.internal.ZipFilesKt.readOrSkipLocalHeader.1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(2);
            }
