...
public final class Buffer {
            ...
            while (i11 < i12) {
                ...
                if (b10 >= 48 && b10 <= 57) {
                    ...
                    if (j11 < -922337203685477580L || (j11 == -922337203685477580L && i13 < j10)) {
                        okio.Buffer bufferWriteByte = new okio.Buffer().writeDecimalLong(j11).writeByte((int) b10);
                        if (!z10) {
    ...
    */
    ...
    public static final <T> T seek(@NotNull okio.Buffer buffer, long j10, @NotNull sn.p<? super Segment, ? super Long, ? extends T> pVar) {
        p.k(buffer, "<this>");
        p.k(pVar, "lambda");
        Segment segment = buffer.head;
        if (segment == null) {
