...
public final class Path {
    ...
    public static final boolean commonEquals(@NotNull okio.Path path, @Nullable Object obj) {
        p.k(path, "<this>");
        return (obj instanceof okio.Path) && p.f(((okio.Path) obj).getBytes$okio(), path.getBytes$okio());
    }
    ...
    @NotNull
    public static final okio.Path commonResolve(@NotNull okio.Path path, @NotNull String str, boolean z10) {
        p.k(path, "<this>");
        p.k(str, "child");
    ...
    @NotNull
    public static final okio.Path commonResolve(@NotNull okio.Path path, @NotNull Buffer buffer, boolean z10) {
        p.k(path, "<this>");
        p.k(buffer, "child");
    ...
    @NotNull
    public static final okio.Path commonResolve(@NotNull okio.Path path, @NotNull ByteString byteString, boolean z10) {
        p.k(path, "<this>");
    ...
    @NotNull
    public static final okio.Path commonResolve(@NotNull okio.Path path, @NotNull okio.Path path2, boolean z10) {
        p.k(path, "<this>");
        p.k(path2, "child");
    ...
    @NotNull
    public static final okio.Path toPath(@NotNull Buffer buffer, boolean z10) throws EOFException {
