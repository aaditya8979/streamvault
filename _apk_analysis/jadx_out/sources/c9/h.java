...
public final class h {
    ...
    public static final float[][] f6544a = (float[][]) Array.newInstance((Class<?>) Float.TYPE, b9.a.f5498b.length, 8);

    static {
        int i10;
        int i11 = 0;
        while (true) {
            int[] iArr = b9.a.f5498b;
            if (i11 >= iArr.length) {
                return;
            }
            int i12 = iArr[i11];
