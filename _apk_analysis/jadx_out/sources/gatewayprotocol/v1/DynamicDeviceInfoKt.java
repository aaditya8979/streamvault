...
public final class DynamicDeviceInfoKt {
    ...
    public static final class AndroidKt {
        ...
        public static final class Dsl {
            ...
            public final NetworkCapabilityTransportsOuterClass.NetworkCapabilityTransports getNetworkCapabilityTransports() {
                ...
                p.j(networkCapabilityTransports, "_builder.getNetworkCapabilityTransports()");
            ...
            public final void setNetworkCapabilityTransports(@NotNull NetworkCapabilityTransportsOuterClass.NetworkCapabilityTransports networkCapabilityTransports) {
                p.k(networkCapabilityTransports, "value");
    ...
    public static final class Dsl {
        ...
        public final /* synthetic */ DynamicDeviceInfoOuterClass.DynamicDeviceInfo _build() {
            ...
            p.j(dynamicDeviceInfoBuild, "_builder.build()");
        ...
        public final String getNetworkOperatorName() {
            ...
            p.j(networkOperatorName, "_builder.getNetworkOperatorName()");
        ...
        public final String getTimeZone() {
            ...
            p.j(timeZone, "_builder.getTimeZone()");
            return timeZone;
        }
    ...
    public static final class IosKt {
        ...
        public static final class Dsl {
            ...
            public final String getCurrentRadioAccessTechnology() {
                ...
                p.j(currentRadioAccessTechnology, "_builder.getCurrentRadioAccessTechnology()");
            ...
            public final String getDeviceName() {
                ...
                p.j(deviceName, "_builder.getDeviceName()");
                return deviceName;
            }
            ...
            public final DslList<String, LocaleListProxy> getLocaleList() {
                ...
                p.j(localeListList, "_builder.getLocaleListList()");
            ...
            public final DslList<String, NwPathInterfacesProxy> getNwPathInterfaces() {
                ...
                p.j(nwPathInterfacesList, "_builder.getNwPathInterfacesList()");
            ...
            public final /* synthetic */ void setLocaleList(DslList dslList, int i10, String str) {
                p.k(dslList, "<this>");
                p.k(str, "value");
                this._builder.setLocaleList(i10, str);
            }
            ...
            public final /* synthetic */ void setNwPathInterfaces(DslList dslList, int i10, String str) {
                p.k(dslList, "<this>");
                p.k(str, "value");
                this._builder.setNwPathInterfaces(i10, str);
            }
    ...
    public final DynamicDeviceInfoOuterClass.DynamicDeviceInfo.Android m7488initializeandroid(@NotNull l<? super AndroidKt.Dsl, r> lVar) {
        p.k(lVar, "block");
    ...
    public final DynamicDeviceInfoOuterClass.DynamicDeviceInfo.Ios m7489initializeios(@NotNull l<? super IosKt.Dsl, r> lVar) {
        p.k(lVar, "block");
