...
public final class StaticDeviceInfoOuterClass {
    ...
    public static final class StaticDeviceInfo extends GeneratedMessageLite<StaticDeviceInfo, Builder> implements StaticDeviceInfoOrBuilder {
        ...
        public static final class Android extends GeneratedMessageLite<Android, Builder> implements AndroidOrBuilder {
            ...
            public static final class Builder extends GeneratedMessageLite.Builder<Android, Builder> implements AndroidOrBuilder {
                ...
                public Builder setDisplayScreenDensity(int i10) {
                    copyOnWrite();
                    ((Android) this.instance).setDisplayScreenDensity(i10);
                    return this;
                }
                ...
                public Builder setTotalDiskSpaceInternal(long j10) {
                    copyOnWrite();
                    ((Android) this.instance).setTotalDiskSpaceInternal(j10);
                    return this;
                }
            ...
            /* JADX INFO: Access modifiers changed from: private */
            public void setDisplayScreenDensity(int i10) {
                this.bitField0_ |= 524288;
                this.displayScreenDensity_ = i10;
            }
            ...
            /* JADX INFO: Access modifiers changed from: private */
            public void setTotalDiskSpaceInternal(long j10) {
                this.bitField0_ |= 262144;
                this.totalDiskSpaceInternal_ = j10;
            }
            ...
            public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
                a aVar = null;
                switch (a.f62342a[methodToInvoke.ordinal()]) {
                    case 1:
                        return new Android();
                    case 2:
        ...
        public static final class Ios extends GeneratedMessageLite<Ios, Builder> implements IosOrBuilder {
            ...
            public static final class Builder extends GeneratedMessageLite.Builder<Ios, Builder> implements IosOrBuilder {
                ...
                public Builder setUserInterfaceIdiomValue(int i10) {
                    copyOnWrite();
                    ((Ios) this.instance).setUserInterfaceIdiomValue(i10);
                    return this;
                }
            ...
            /* JADX INFO: Access modifiers changed from: private */
            public void setUserInterfaceIdiomValue(int i10) {
                this.bitField0_ |= 512;
                this.userInterfaceIdiom_ = i10;
            }
            ...
            public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
                ...
                switch (a.f62342a[methodToInvoke.ordinal()]) {
                    ...
                    case 2:
                        return new Builder(aVar);
                    case 3:
                        return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u000b\u0000\u0001\u0001\u000b\u000b\u0000\u0001\u0000\u0001ဂ\u0000\u0002ဇ\u0001\u0003ለ\u0002\u0004Ț\u0005ဋ\u0003\u0006ဇ\u0004\u0007ለ\u0005\bለ\u0006\tለ\u0007\nለ\b\u000bဌ\t", new Object[]{"bitField0_", "systemBootTime_", "simulator_", "builtSdkVersion_", "skadnetworkId_", "screenScale_", "canMakePayments_", "xcodeVersion_", "xcodeBuildVersion_", "xcodeSdkBuildVersion_", "bundleVersionFull_", "userInterfaceIdiom_"});
                    case 4:
                        return DEFAULT_INSTANCE;
                    case 5:
            ...
            @Override // gatewayprotocol.v1.StaticDeviceInfoOuterClass.StaticDeviceInfo.IosOrBuilder
            public UserInterfaceIdiom getUserInterfaceIdiom() {
                UserInterfaceIdiom userInterfaceIdiomForNumber = UserInterfaceIdiom.forNumber(this.userInterfaceIdiom_);
                return userInterfaceIdiomForNumber == null ? UserInterfaceIdiom.UNRECOGNIZED : userInterfaceIdiomForNumber;
            }
        ...
        public enum UserInterfaceIdiom implements Internal.EnumLite {
            ...
            public class a implements Internal.EnumLiteMap<UserInterfaceIdiom> {
                ...
                public UserInterfaceIdiom findValueByNumber(int i10) {
                    return UserInterfaceIdiom.forNumber(i10);
                }
            }
            ...
            public static final class b implements Internal.EnumVerifier {
                ...
                public static final Internal.EnumVerifier f62341a = new b();

                @Override // com.google.protobuf.Internal.EnumVerifier
                public boolean isInRange(int i10) {
                    return UserInterfaceIdiom.forNumber(i10) != null;
                }
            }

            UserInterfaceIdiom(int i10) {
                this.value = i10;
            }

            public static UserInterfaceIdiom forNumber(int i10) {
                switch (i10) {
                    case 0:
            ...
            @Deprecated
            public static UserInterfaceIdiom valueOf(int i10) {
                return forNumber(i10);
            }
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f62342a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f62342a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f62342a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f62342a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f62342a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f62342a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
