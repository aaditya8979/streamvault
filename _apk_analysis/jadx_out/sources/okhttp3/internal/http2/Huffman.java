...
public final class Huffman {
    ...
    private final void addCode(int i10, int i11, int i12) {
        ...
        p.h(children2);
        cn.p.v(children2, node, i15, (1 << i14) + i15);
    }

    public final void decode(@NotNull BufferedSource bufferedSource, long j10, @NotNull BufferedSink bufferedSink) throws IOException {
    ...
    public final void encode(@NotNull ByteString byteString, @NotNull BufferedSink bufferedSink) throws IOException {
        p.k(byteString, "source");
        p.k(bufferedSink, "sink");
        int size = byteString.size();
        long j10 = 0;
        int i10 = 0;
        for (int i11 = 0; i11 < size; i11++) {
            int iAnd = Util.and(byteString.getByte(i11), 255);
            int i12 = CODES[iAnd];
        ...
        if (i10 > 0) {
            bufferedSink.writeByte((int) ((j10 << (8 - i10)) | (255 >>> i10)));
        }
    }
