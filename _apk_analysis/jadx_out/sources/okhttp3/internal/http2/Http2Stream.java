...
public final class Http2Stream {
    ...
    private final boolean closeInternal(ErrorCode errorCode, IOException iOException) {
        ...
        synchronized (this) {
            ...
            r rVar = r.f5635a;
            this.connection.removeStream$okhttp(this.f76459id);
            return true;
        }
    }
    ...
    public final void close(@NotNull ErrorCode errorCode, @Nullable IOException iOException) throws IOException {
        ...
        if (closeInternal(errorCode, iOException)) {
            this.connection.writeSynReset$okhttp(this.f76459id, errorCode);
        }
    }
    ...
    public final void closeLater(@NotNull ErrorCode errorCode) {
        ...
        if (closeInternal(errorCode, null)) {
            this.connection.writeSynResetLater$okhttp(this.f76459id, errorCode);
        }
    }
    ...
    public final boolean isLocallyInitiated() {
        return this.connection.getClient$okhttp() == ((this.f76459id & 1) == 1);
    }
    ...
    public final void writeHeaders(@NotNull List<Header> list, boolean z10, boolean z11) throws IOException {
        ...
        this.connection.writeHeaders$okhttp(this.f76459id, z10, list);
        if (z11) {
