...
public final class MultipartBody extends RequestBody {
    ...
    public static final class Part {
        ...
        public final RequestBody m7628deprecated_body() {
            return this.body;
        }

        @Nullable
        /* JADX INFO: renamed from: -deprecated_headers, reason: not valid java name */
        public final Headers m7629deprecated_headers() {
            return this.headers;
        }
    ...
    public final String m7624deprecated_boundary() {
        return boundary();
    }

    @NotNull
    /* JADX INFO: renamed from: -deprecated_parts, reason: not valid java name */
    public final List<Part> m7625deprecated_parts() {
        return this.parts;
    }

    /* JADX INFO: renamed from: -deprecated_size, reason: not valid java name */
    public final int m7626deprecated_size() {
        return size();
    }

    @NotNull
    /* JADX INFO: renamed from: -deprecated_type, reason: not valid java name */
    public final MediaType m7627deprecated_type() {
        return this.type;
    }
