...
public final class ConnectionSpec {
    ...
    public static final class Builder {
        ...
        public final Builder cipherSuites(@NotNull CipherSuite... cipherSuiteArr) {
            p.k(cipherSuiteArr, "cipherSuites");
            if (!this.tls) {
                throw new IllegalArgumentException("no cipher suites for cleartext connections".toString());
            }
    ...
    private final ConnectionSpec supportedSpec(SSLSocket sSLSocket, boolean z10) {
        ...
        if (this.tlsVersionsAsString != null) {
            ...
            p.j(enabledProtocols2, "sslSocket.enabledProtocols");
            enabledProtocols = Util.intersect(enabledProtocols2, this.tlsVersionsAsString, b.f());
        } else {
    ...
    public final List<CipherSuite> m7573deprecated_cipherSuites() {
        return cipherSuites();
    }

    /* JADX INFO: renamed from: -deprecated_supportsTlsExtensions, reason: not valid java name */
    public final boolean m7574deprecated_supportsTlsExtensions() {
        return this.supportsTlsExtensions;
    }

    @Nullable
    /* JADX INFO: renamed from: -deprecated_tlsVersions, reason: not valid java name */
    public final List<TlsVersion> m7575deprecated_tlsVersions() {
        return tlsVersions();
    }
    ...
    public final boolean isCompatible(@NotNull SSLSocket sSLSocket) {
        p.k(sSLSocket, "socket");
        if (!this.isTls) {
            return false;
        }
        String[] strArr = this.tlsVersionsAsString;
        if (strArr != null && !Util.hasIntersection(strArr, sSLSocket.getEnabledProtocols(), b.f())) {
            return false;
        }
