...
public final class MediaType {
    ...
    public static final class Companion {
        ...
        public final MediaType m7622deprecated_get(@NotNull String str) {
            p.k(str, "mediaType");
            return get(str);
        }
        ...
        public final MediaType m7623deprecated_parse(@NotNull String str) {
            p.k(str, "mediaType");
            return parse(str);
        }
    ...
    public final String m7620deprecated_subtype() {
        return this.subtype;
    }

    @NotNull
    /* JADX INFO: renamed from: -deprecated_type, reason: not valid java name */
    public final String m7621deprecated_type() {
        return this.type;
    }
