...
public final class Handshake {
    ...
    public static final class Companion {
        ...
        public final Handshake m7593deprecated_get(@NotNull SSLSession sSLSession) throws IOException {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public Handshake(@NotNull TlsVersion tlsVersion, @NotNull CipherSuite cipherSuite, @NotNull List<? extends Certificate> list, @NotNull final a<? extends List<? extends Certificate>> aVar) {
        p.k(tlsVersion, "tlsVersion");
        p.k(cipherSuite, "cipherSuite");
        ...
        this.peerCertificates$delegate = b.b(new a<List<? extends Certificate>>() { // from class: okhttp3.Handshake.peerCertificates.2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(0);
